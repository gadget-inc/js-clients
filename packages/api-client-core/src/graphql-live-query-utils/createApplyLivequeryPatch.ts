...
export declare type ExecutionLivePatchResult<PatchPayload = unknown> = {
    ...
    <PatchPayload = unknown>(
        ...
        <TExecutionResult = Record<string, unknown>>(
            ...
            new Repeater<TExecutionResult>(async (push, stop) => {
                ...
                // @ts-expect-error Adopted from https://github.com/n1ru4l/graphql-live-query/blob/main/packages/graphql-live-query-patch/src/createApplyLiveQueryPatch.ts
