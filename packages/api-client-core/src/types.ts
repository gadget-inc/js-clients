...
export interface ActionResult {
  (action: { type: "action"; hasReturnType?: true; isBulkAction: false }): Promise<any>;

  <Shape extends RecordShape = any>(action: { type: "action"; hasReturnType?: false; isBulkAction: false }): Promise<
    Shape extends void ? void : GadgetRecord<Shape>
  >;

  <Shape extends RecordShape = any>(action: { type: "action"; isBulkAction: false }): Promise<
    Shape extends void ? void : GadgetRecord<Shape>
  >;

  <Shape extends RecordShape = any>(action: { type: "action"; isBulkAction: true }): Promise<
    Shape extends void ? void : GadgetRecord<Shape>[]
  >;

  (action: { type: "action"; isBulkAction: true; hasReturnType: true }): Promise<any[]>;

  <Shape extends RecordShape = any>(action: { type: "action"; isBulkAction: true; hasReturnType: false }): Promise<
    Shape extends void ? void : GadgetRecord<Shape>[]
  >;

  (action: { type: "globalAction" }): Promise<any>;
}
