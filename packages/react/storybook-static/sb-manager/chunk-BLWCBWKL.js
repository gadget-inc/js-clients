...
var applyStyles_default = { name: "applyStyles", enabled: !0, phase: "write", fn: applyStyles, effect, requires: ["computeStyles"] };
...
function getOffsetParent(element) {
  ...
  return offsetParent &&
    (getNodeName(offsetParent) === "html" || (getNodeName(offsetParent) === "body" && getComputedStyle(offsetParent).position === "static"))
    ? window2
...
function arrow(_ref) {
  ...
  if (!(!arrowElement || !popperOffsets2)) {
    var paddingObject = toPaddingObject(options.padding, state),
      ...
      endDiff = state.rects.reference[len] + state.rects.reference[axis] - popperOffsets2[axis] - state.rects.popper[len],
...
function effect2(_ref2) {
  ...
  arrowElement != null &&
    ((typeof arrowElement == "string" && ((arrowElement = state.elements.popper.querySelector(arrowElement)), !arrowElement)) ||
...
var eventListeners_default = { name: "eventListeners", enabled: !0, phase: "write", fn: function () {}, effect: effect3, data: {} },
...
function getDocumentRect(element) {
  ...
  return (
    getComputedStyle(body || html).direction === "rtl" && (x += max(html.clientWidth, body ? body.clientWidth : 0) - width),
    { width, height, x, y }
  );
}
...
function listScrollParents(element, list) {
  ...
  var scrollParent = getScrollParent(element),
    isBody = scrollParent === ((_element$ownerDocumen = element.ownerDocument) == null ? void 0 : _element$ownerDocumen.body),
...
function detectOverflow(state, options) {
  ...
  var _options = options,
    ...
    popperOffsets2 = computeOffsets({ reference: referenceClientRect, element: popperRect, strategy: "absolute", placement }),
...
function computeAutoPlacement(state, options) {
  ...
  var overflows = allowedPlacements.reduce(function (acc, placement2) {
    return (
      (acc[placement2] = detectOverflow(state, { placement: placement2, boundary, rootBoundary, padding })[getBasePlacement(placement2)]),
      acc
    );
  }, {});
...
var flip_default = { name: "flip", enabled: !0, phase: "main", fn: flip, requiresIfExists: ["offset"], data: { _skip: !1 } };
...
function offset(_ref2) {
  ...
  state.modifiersData.popperOffsets != null && ((state.modifiersData.popperOffsets.x += x), (state.modifiersData.popperOffsets.y += y)),
  ...
  if (popperOffsets2) {
    if (checkMainAxis) {
      var _offsetModifierState$,
        ...
        clientOffset = arrowOffsetParent ? (mainAxis === "y" ? arrowOffsetParent.clientTop || 0 : arrowOffsetParent.clientLeft || 0) : 0,
        offsetModifierValue = (_offsetModifierState$ = offsetModifierState?.[mainAxis]) != null ? _offsetModifierState$ : 0,
    ...
    if (checkAltAxis) {
      var _offsetModifierState$2,
        ...
        _offsetModifierValue = (_offsetModifierState$2 = offsetModifierState?.[altAxis]) != null ? _offsetModifierState$2 : 0,
...
var preventOverflow_default = { name: "preventOverflow", enabled: !0, phase: "main", fn: preventOverflow, requiresIfExists: ["offset"] };
...
function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
  ...
  return (
    (isOffsetParentAnElement || (!isOffsetParentAnElement && !isFixed)) &&
      ((getNodeName(offsetParent) !== "body" || isScrollParent(documentElement)) && (scroll = getNodeScroll(offsetParent)),
      ...
      popperOptions = React3.useMemo(
        function () {
          var newOptions = {
            ...
            modifiers: [].concat(optionsWithDefaults.modifiers, [updateStateModifier, { name: "applyStyles", enabled: !1 }]),
          };
      ...
      if (getLatest().finalConfig.closeOnOutsideClick) {
        var handleClickOutside = function (event) {
          var _event$composedPath,
            ...
            target =
              (event.composedPath == null || (_event$composedPath = event.composedPath()) == null ? void 0 : _event$composedPath[0]) ||
              event.target;
...
var match = (0, import_memoizerific.default)(1e3)((requests, actual, value, fallback = 0) =>
  ...
  Tooltip = import_react.default.forwardRef(
    ({ placement = "top", hasChrome = !0, children, arrowProps = {}, tooltipRef, color, withArrows, ...props }, ref) =>
  ...
  WithTooltipPure = ({
    ...
    let Container = svg ? TargetSvgContainer : TargetContainer,
      ...
      tooltipComponent = import_react.default.createElement(
        Tooltip,
        { placement: state?.placement, ref: setTooltipRef, hasChrome, arrowProps: getArrowProps(), withArrows, ...getTooltipProps() },
