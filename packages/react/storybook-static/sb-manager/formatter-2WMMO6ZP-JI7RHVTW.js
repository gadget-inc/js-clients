import { __toESM, require_memoizerific } from "./chunk-ZR5JZWHI.js";
  ...
  switch (Fe(t8)) {
    ...
    case be: {
      ...
      for (let r of t8) {
        ...
        typeof n == "string" && typeof me(!1, e, -1) == "string" ? (e[e.length - 1] += n) : e.push(n), e.push(...s);
      }
...
function ln(t8, e) {
  ...
  if (
    ...
    for (let n of e.parameters.children) li.has(t8.name) ? delete n.expression : (n.expression = n.expression.trim());
}
...
var Ne = hi,
  ...
  mn = "normal",
  dn = { listing: "pre", plaintext: "pre", pre: "pre", xmp: "pre", nobr: "nowrap", table: "initial", textarea: "pre-wrap" };
function fi(t8) {
...
function _t(t8, e) {
  return !!(
    (t8.type === "ieConditionalComment" && t8.lastChild && !t8.lastChild.isSelfClosing && !t8.lastChild.endSourceSpan) ||
...
function _n(t8, e) {
  ...
  function n() {
    return Pe(t8) || t8.type === "angularControlFlowBlock"
      ? !1
      : (t8.type === "text" || t8.type === "interpolation") && t8.prev && (t8.prev.type === "text" || t8.prev.type === "interpolation")
      ? !0
      ...
      : !(
          (!t8.prev &&
            (t8.parent.type === "root" || (ge(t8) && t8.parent) || V(t8.parent) || Ke(t8.parent, e) || !Ai(t8.parent.cssDisplay))) ||
...
function En(t8, e) {
  return Pe(t8) || t8.type === "angularControlFlowBlock"
    ? !1
    : (t8.type === "text" || t8.type === "interpolation") && t8.next && (t8.next.type === "text" || t8.next.type === "interpolation")
    ? !0
    : !t8.parent || t8.parent.cssDisplay === "none"
    ? !1
    : ge(t8.parent)
    ...
    : !(
        (!t8.next &&
          (t8.parent.type === "root" || (ge(t8) && t8.parent) || V(t8.parent) || Ke(t8.parent, e) || !Di(t8.parent.cssDisplay))) ||
...
function ur(t8) {
  return (
    t8.type === "element" &&
    t8.children.length > 0 &&
    (["html", "head", "ul", "ol", "select"].includes(t8.name) || (t8.cssDisplay.startsWith("table") && t8.cssDisplay !== "table-cell"))
  );
}
function Et(t8) {
...
function wn(t8) {
  return (
    ...
    (t8.next
      ...
      : t8.parent.type === "root" || (t8.parent.endSourceSpan && t8.parent.endSourceSpan.start.line > t8.sourceSpan.end.line))
  );
}
function bn(t8) {
  switch (t8.type) {
  ...
  t8.walk((n) => {
    if (n.children)
      for (let s = 0; s < n.children.length; s++) {
        ...
        !a ||
          a.type !== "text" ||
          ((a.value += i.value), (a.sourceSpan = new f(a.sourceSpan.start, i.sourceSpan.end)), n.removeChild(i), s--);
      }
  });
}
function Ii(t8) {
        ...
        for (let u = 0; u < o.length; u++, i = a) {
          ...
          (a = i.moveBy(p.length + 4)),
            n.insertChildBefore(s, {
              ...
              children: p.length === 0 ? [] : [{ type: "text", value: p, sourceSpan: new f(i.moveBy(2), a.moveBy(-2)) }],
            });
        }
        n.removeChild(s);
      }
    ...
    if (!r)
      for (let s = 0; s < e.children.length; s++) {
        ...
        o
          ...
          : (e.removeChild(i), s--, (a || u) && (p && (p.hasTrailingSpaces = !0), l && (l.hasLeadingSpaces = !0)));
      }
    ...
    e.isSelfClosing =
      ...
      (e.type === "element" &&
        (e.tagDefinition.isVoid ||
          (e.endSourceSpan && e.startSourceSpan.start === e.endSourceSpan.start && e.startSourceSpan.end === e.endSourceSpan.end)));
  });
}
function qi(t8, e) {
  t8.walk((r) => {
    r.type === "element" &&
      (r.hasHtmComponentClosingTag =
        r.endSourceSpan && /^<\s*\/\s*\/\s*>$/.test(e.originalText.slice(r.endSourceSpan.start.offset, r.endSourceSpan.end.offset)));
  });
}
function Hi(t8, e) {
  t8.walk((r) => {
    ...
    if (n) {
      ...
      for (let s = 0; s < n.length; s++) {
        ...
        (i.isLeadingSpaceSensitive = (s === 0 || i.prev.isTrailingSpaceSensitive) && i.isLeadingSpaceSensitive),
          (i.isTrailingSpaceSensitive = (s === n.length - 1 || i.next.isLeadingSpaceSensitive) && i.isTrailingSpaceSensitive);
      }
    }
  });
}
...
function Ee(t8) {
  var e;
  return (
    ((e = t8.lastChild) == null ? void 0 : e.isTrailingSpaceSensitive) && !t8.lastChild.hasTrailingSpaces && !N(At(t8.lastChild)) && !ge(t8)
  );
}
function Ae(t8) {
...
function ji(t8, e, r) {
  ...
  let s = ((m = n.prev) == null ? void 0 : m.type) === "comment" && Yi(n.prev.value),
    ...
    o = n.type === "element" && n.fullName === "script" && n.attrs.length === 1 && n.attrs[0].fullName === "src" && n.children.length === 0,
...
function Xi(t8, e) {
  ...
  return (
    t8.lastChild && Ae(t8.lastChild) ? (n += kt(t8, e).length) : Ee(t8) && (n -= _e(t8.lastChild, e).length), e.originalText.slice(r, n)
  );
}
var Ft = Xi;
function Hn(t8) {
...
function K(t8, e) {
  let r =
    t8.type === "NGRoot"
      ? t8.node.type === "NGMicrosyntax" && t8.node.body.length === 1 && t8.node.body[0].type === "NGMicrosyntaxExpression"
...
async function es(t8, e) {
  ...
  for (let [n, s] of t8.split(Sr).entries())
    if (n % 2 === 0) r.push(T(s));
      ...
      try {
        r.push(
          E(["{{", R([A, await x(s, e, { parser: "__ng_interpolation", __isInHtmlInterpolation: !0, trailingComma: "none" })]), A, "}}"])
        );
      } catch {
        r.push("{{", T(s), "}}");
      }
...
function ga(t8, e) {
  ...
  if (r.value) {
    if (
      /^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/.test(e.originalText.slice(r.valueSpan.start.offset, r.valueSpan.end.offset)) ||
...
function Ca(t8) {
  return async (e, r, n, s) => {
    ...
    if (i) return (i = Ct(i, (a) => (typeof a == "string" ? v(!1, a, '"', "&quot;") : a))), [n.node.rawName, '="', E(i), '"'];
  };
}
var rs = ga;
function Sa(t8, e, r, n) {
  ...
  return /^\s*$/.test(i) ? "" : x(i, t8, { parser: "__ng_directive", __isInHtmlAttribute: !1, trailingComma: "none" }, K);
}
var ns = Sa,
        ...
        if (n)
          return async (s) => {
            ...
            if (e.parser === "html" && n === "babel") {
              let o = "script",
                { attrMap: u } = r.parent;
              u && (u.type === "module" || (u.type === "text/babel" && u["data-type"] === "module")) && (o = "module"),
...
function rt(t8, e, r) {
  ...
  return Ge(n)
    ? [
        W(n, e),
        T(e.originalText.slice(se(n) + (n.prev && Je(n.prev) ? Bt(n).length : 0), ie(n) - (n.next && j(n.next) ? _e(n, e).length : 0))),
        U(n, e),
      ]
    : r();
}
...
function Oe(t8, e, r) {
  ...
  return t8.map((i, a) => {
    ...
    return (
      d && (Ye(o.prev) ? u.push(S, S) : d === S ? u.push(S) : N(o.prev) ? p.push(d) : p.push(fe("", b, { groupId: s[a - 1] }))),
...
function os(t8, e, r) {
  ...
  return (
    n.children.length > 0
      ? ((n.firstChild.hasLeadingSpaces = !0), (n.lastChild.hasTrailingSpaces = !0), s.push(R([S, Oe(t8, e, r)])), i && s.push(S, "}"))
      : i && s.push("}"),
    E(s, { shouldBreak: !0 })
  );
}
...
var Rt = class {},
  ...
  $t = class extends Rt {
    ...
    hasElement(e, r) {
      return r.some((n) => n.name === Dr.name) || (e.indexOf("-") > -1 && (vr(e) || yr(e) || r.some((n) => n.name === Ar.name)))
        ? !0
  ...
  Pr = class {
    constructor(e, r, n) {
      (this._getTagContentType = r),
        ...
        (this._leadingTriviaCodePoints = n.leadingTriviaChars && n.leadingTriviaChars.map((i) => i.codePointAt(0) || 0)),
...
`
    ...
    _getBlockName() {
      ...
      return this._attemptCharCodeUntilFn((n) => (wt(n) ? !e : xs(n) ? ((e = !0), !1) : !0)), this._cursor.getChars(r).trim();
    }
    ...
    _consumeRawText(e, r) {
      ...
      for (;;) {
        ...
        e && this._cursor.peek() === 38
          ? (this._endToken([this._processCarriageReturns(n.join(""))]), (n.length = 0), this._consumeEntity(6), this._beginToken(6))
    ...
    _consumePrefixAndName() {
      ...
      let n;
      this._cursor.peek() === 58 ? ((r = this._cursor.getChars(e)), this._cursor.advance(), (n = this._cursor.clone())) : (n = e),
    ...
    _consumeWithInterpolation(e, r, n, s) {
      ...
      for (; !n(); ) {
        ...
        this._interpolationConfig && this._attemptStr(this._interpolationConfig.start)
          ...
          ? (this._endToken([this._processCarriageReturns(i.join(""))]), (i.length = 0), this._consumeEntity(e), this._beginToken(e))
...
var Kt = class t3 {
  ...
  Nr = class t4 extends Kt {
    ...
    processEscapeSequence() {
      ...
      if (e() === 92)
        if (((this.internalState = { ...this.state }), this.advanceState(this.internalState), e() === 110)) this.state.peek = 10;
...
`
      ...
      for (; this._peek.type === 8 || this._peek.type === 5 || this._peek.type === 9; )
        (e = this._advance()),
          r.push(e),
          e.type === 8 ? (s += e.parts.join("").replace(/&([^;]+);/g, Is)) : e.type === 9 ? (s += e.parts[0]) : (s += e.parts.join(""));
      if (s.length > 0) {
        let i = e.sourceSpan;
    ...
    _consumeStartTag(e) {
      ...
      if (this._peek.type === 2) {
        ...
        this.canSelfClose ||
          ...
          Me(i) !== null ||
          C.isVoid ||
          this.errors.push(I.create(i, e.sourceSpan, `Only void, custom and foreign elements can be self closed "${e.parts[1]}"`));
      ...
      this._pushContainer(m, d instanceof z && this.getTagDefinition(d.name).isClosedByChild(m.name)),
        a
          ...
          : e.type === 4 && (this._popContainer(i, z, null), this.errors.push(I.create(i, u, `Opening tag "${i}" not terminated.`)));
    }
    _pushContainer(e, r) {
    ...
    _consumeAttr(e) {
      ...
      if (this._peek.type === 16)
        for (
          ...
          let m = this._advance();
          a.push(m),
            m.type === 17 ? (i += m.parts.join("").replace(/&([^;]+);/g, Is)) : m.type === 9 ? (i += m.parts[0]) : (i += m.parts.join("")),
...
function ho(t8) {
  ...
  let [o] = e;
  return {
    frontMatter: { type: "front-matter", lang: a, value: s, startDelimiter: r, endDelimiter: i, raw: o.replace(/\n$/, "") },
    content: v(!1, o, /[^\n]/g, " ") + t8.slice(o.length),
  };
}
var Rs = ho;
...
function Eo(t8) {
  if (t8.type === "block") {
    if (((t8.name = v(!1, t8.name.toLowerCase(), /\s+/g, " ").trim()), (t8.type = "angularControlFlowBlock"), !xt(t8.parameters))) {
...
function Vs(t8, e, r) {
  ...
  if (n === "vue") {
    if (l.some((w2) => (w2.type === "docType" && w2.value === "html") || (w2.type === "element" && w2.name.toLowerCase() === "html")))
      return Vs(t8, Ws, r);
    let g,
      y2 = () => g ?? (g = qr(t8, { canSelfClose: s, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: u })),
      $ = (w2) => y2().rootNodes.find(({ startSourceSpan: q2 }) => q2 && q2.start.offset === w2.startSourceSpan.start.offset) ?? w2;
  ...
  let d = (c) => {
      ...
      switch (c.type) {
        case "element":
          ...
          for (let g of c.attrs)
            d(g),
              g.valueSpan
                ? ((g.value = g.valueSpan.toString()), /["']/.test(g.value[0]) && (g.value = g.value.slice(1, -1)))
                : (g.value = null);
          break;
        case "comment":
    ...
    D = (c) => {
      if (
        c.type === "element" &&
        (i && (!c.namespace || c.namespace === c.tagDefinition.implicitNamespacePrefix || de(c)) && (c.name = _2(c.name, (g) => Os.has(g))),
        a)
      )
        for (let g of c.attrs)
          g.namespace || (g.name = _2(g.name, (y2) => Jt.has(c.name) && (Jt.get("*").has(y2) || Jt.get(c.name).has(y2))));
    },
    P2 = (c) => {
  ...
  let l = new er(p),
    m = (d, C) => {
      ...
      return (
        c.length === _2
          ? B.children.shift()
          : ((c.sourceSpan = new f(c.sourceSpan.start.moveBy(_2), c.sourceSpan.end)), (c.value = c.value.slice(_2))),
        B
      );
    };
  return (
...
var Ws = { name: "html", normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 },
  ...
  yo = tr({
    ...
    shouldParseAsRawText(t8, e, r, n) {
      return (
        t8.toLowerCase() !== "html" &&
        !r &&
        (t8 !== "template" || n.some(({ name: s, value: i }) => s === "lang" && i !== "html" && i !== "" && i !== void 0))
      );
    },
  }),
  ...
  bo = {
    ...
    vueIndentScriptAndStyle: { category: Gs, type: "boolean", default: !1, description: "Indent script and style tags in Vue files." },
  },
  Ys = bo,
  To = { html: fs },
  dh = Ur,
  ...
  nr2 = (e, t8, r, n) => {
    if ((t8 && typeof t8 == "object") || typeof t8 == "function")
      for (let o of Fu(t8)) !du.call(e, o) && o !== r && $e2(e, o, { get: () => t8[o], enumerable: !(n = fu(t8, o)) || n.enumerable });
    return e;
  },
  he2 = (e, t8, r) => (
    (r = e != null ? lu(pu(e)) : {}), nr2(t8 || !e || !e.__esModule ? $e2(r, "default", { value: e, enumerable: !0 }) : r, e)
  ),
...
var no2,
  ...
  yn2 = Me2((Ft2) => {
    ...
    var jt2;
    function io2(e) {
      return e ? (jt2 != null || (jt2 = new mn2.default.constructor({ enabled: !0, level: 1 })), jt2) : mn2.default;
    }
    var En2 = !1;
    function so2(e) {
  ...
  switch (U2(e)) {
    ...
    case j2: {
      ...
      for (let r of e) {
        ...
        typeof n == "string" && typeof y(!1, t8, -1) == "string" ? (t8[t8.length - 1] += n) : t8.push(n), t8.push(...o);
      }
...
function Pr2(e) {
  ...
  function n(u, i, s) {
    ...
    if (u.type === b2) return ((a = s?.[i - 1]) == null ? void 0 : a.type) === A2 && s[i - 1].hard ? void 0 : "breakParent";
...
function Ur2({ text: e, list: t8 }, r) {
  ...
  return (
    ...
    t8 &&
      n.push(
        [`- ${se2.default.blue(t8.title)}:`].concat(t8.values.map((o) => Ur2(o, r - $r2.length).replace(/^|\n/g, `$&${$r2}`))).join(`
`)
      ),
    zr(n, r)
  );
  ...
  lt = class {
      ...
      for (let i of o) {
        ...
        let a = ({ from: p, to: l }) => {
          ...
          c = ({ value: p, redirectTo: l }) => {
            ...
            if (F2 !== !1)
              if (F2 === !0) this._hasDeprecationWarned(i) || this._utils.logger.warn(this._deprecatedHandler(i, l, this._utils));
              else
    ...
    _applyRequiredCheck(t8) {
      for (let r of Object.keys(this._utils.schemas))
        if (this._identifyMissing(r, t8) && this._identifyRequired(r)) throw this._invalidHandler(r, tt2, this._utils);
    }
...
function Xu(e, { isCLI: t8, FlagSchema: r }) {
  ...
  for (let o of e)
    n.push(Zu(o, { isCLI: t8, optionInfos: e, FlagSchema: r })), o.alias && t8 && n.push(nt2.create({ name: o.alias, sourceName: o.name }));
  return n;
}
function Zu(e, { isCLI: t8, optionInfos: r, FlagSchema: n }) {
  ...
  switch (e.type) {
    ...
    case "choice":
      (i = Dt2),
        (u.choices = e.choices.map((D) => (D != null && D.redirect ? { ...D, redirect: { to: { key: e.name, value: D.redirect } } } : D)));
      break;
    case "boolean":
      i = it2;
      break;
  ...
  return e.array
    ? ot2.create({ ...(t8 ? { preprocess: (D) => (Array.isArray(D) ? D : [D]) } : {}), ...s, valueSchema: i.create(u) })
    : i.create({ ...u, ...s });
}
var sn2 = Ju;
function Rt2(e, t8) {
...
async function Qu(e, t8 = {}) {
  ...
  let n = et2({ plugins: e.plugins, showDeprecated: !0 }).options,
    o = { ...cn2, ...Object.fromEntries(n.filter((f2) => f2.default !== void 0).map((f2) => [f2.name, f2.default])) },
  ...
  r.printer = D;
  let a = s.defaultOptions ? Object.fromEntries(Object.entries(s.defaultOptions).filter(([, f2]) => f2 !== void 0)) : {},
    c = { ...o, ...a };
...
function Nn2(e, t8) {
  ...
  let n = [],
    ...
    f2 = r.map((p, l) => ({ ...On2(e, p, t8), comment: p, text: D, options: t8, ast: e, isLastComment: r.length - 1 === l }));
  for (let [p, l] of f2.entries()) {
    ...
    let $;
    if (
      (i ? ($ = [l]) : ((F2.enclosingNode = E2), (F2.precedingNode = m), (F2.followingNode = C), ($ = [F2, g, h2, B, Z])),
      Co2(g, h2, f2, p))
    )
...
function ko(e, t8) {
  let { originalText: r, [Symbol.for("comments")]: n, locStart: o, locEnd: u, [Symbol.for("printedComments")]: i } = t8,
    { node: s } = e,
    D = o(s),
    a = u(s);
...
function Yn2(e, t8, r, n, o) {
  ...
  let { node: u } = e,
    ...
    s;
  return (
    (D = i.hasPrettierIgnore) != null && D.call(i, e) ? (s = Rn2(e, t8)) : o.has(u) ? (s = o.get(u)) : (s = i.print(e, t8, r, n)),
...
async function Xt2(e, t8) {
  ...
  return (
    o.rangeStart > 0 || o.rangeEnd < n.length
      ? (u = await vo2(n, o))
      : (!o.requirePragma && o.insertPragma && o.printer.insertPragma && !(await Gn2(n, o)) && (n = o.printer.insertPragma(n)),
        (u = await qn2(n, o))),
