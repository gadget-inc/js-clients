        ...
        function validate(props, propName, componentName, location, propFullName) {
          for (var expectedTypes = [], i3 = 0; i3 < arrayOfTypeCheckers.length; i3++) {
            var checker2 = arrayOfTypeCheckers[i3],
              checkerResult = checker2(props, propName, componentName, location, propFullName, ReactPropTypesSecret);
          ...
          return new PropTypeError(
            "Invalid " + location + " `" + propFullName + "` supplied to " + ("`" + componentName + "`" + expectedTypesMessage + ".")
          );
        }
        return createChainableTypeChecker(validate);
      }
    ...
    function equal(a2, b2) {
      ...
      if (a2 && b2 && typeof a2 == "object" && typeof b2 == "object") {
        ...
        if (hasMap && a2 instanceof Map && b2 instanceof Map) {
          ...
          for (it = a2.entries(); !(i2 = it.next()).done; ) if (!equal(i2.value[1], b2.get(i2.value[0]))) return !1;
          return !0;
        }
        ...
        for (i2 = length; i2-- !== 0; )
          if (!((keys[i2] === "_owner" || keys[i2] === "__v" || keys[i2] === "__o") && a2.$$typeof) && !equal(a2[keys[i2]], b2[keys[i2]]))
            return !1;
        return !0;
      }
      return a2 !== a2 && b2 !== b2;
    ...
    (function (e3, t3) {
      ...
      return (function (e3) {
        ...
        return (
          ...
          (r3.r = function (e4) {
            typeof Symbol < "u" && Symbol.toStringTag && Object.defineProperty(e4, Symbol.toStringTag, { value: "Module" }),
              Object.defineProperty(e4, "__esModule", { value: !0 });
          }),
          (r3.t = function (e4, t4) {
            if ((1 & t4 && (e4 = r3(e4)), 8 & t4 || (4 & t4 && typeof e4 == "object" && e4 && e4.__esModule))) return e4;
            var n3 = Object.create(null);
            if ((r3.r(n3), Object.defineProperty(n3, "default", { enumerable: !0, value: e4 }), 2 & t4 && typeof e4 != "string"))
              for (var o3 in e4)
                r3.d(
                  n3,
                  o3,
              ...
              return (
                ...
                (r4 = [
                  ...
                  },
                  {
                    key: "_processKeys",
                    value: function (e5) {
                      if (((this._keyWeights = {}), (this._keyNames = []), e5.length && typeof e5[0] == "string"))
                        for (var t5 = 0, r5 = e5.length; t5 < r5; t5 += 1) {
                          var n4 = e5[t5];
                          (this._keyWeights[n4] = 1), this._keyNames.push(n4);
                        }
                      else {
                        for (var o4 = null, i3 = null, a4 = 0, s3 = 0, c3 = e5.length; s3 < c3; s3 += 1) {
                          var h3 = e5[s3];
                  ...
                  },
                  {
                    key: "search",
                    value: function (e5) {
                      var t5 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : { limit: !1 };
                      this._log(
                        `---------
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (this.options.tokenize)
                        for (var r5 = e5.split(this.options.tokenSeparator), n4 = 0, o4 = r5.length; n4 < o4; n4 += 1)
                      ...
                      if (typeof r5[0] == "string") {
                        for (var i3 = 0, a4 = r5.length; i3 < a4; i3 += 1)
                          this._analyze(
                            ...
                            { resultMap: n4, results: o4, tokenSearchers: e5, fullSearcher: t5 }
                          );
                        return o4;
                      }
...
Key: `.concat(n4 === "" ? "--" : n4)
                            ...
                            if ((r5._log('Full text: "'.concat(o5, '", score: ').concat(v3.score)), r5.options.tokenize)) {
                              for (
                                var d3 = o5.split(r5.options.tokenSeparator), y2 = d3.length, m2 = [], k2 = 0, b2 = u2.length;
                                k2 < b2;
                                k2 += 1
                              ) {
                                var S2 = u2[k2];
...
Pattern: "`.concat(S2.pattern, '"')
                                ...
                                for (var x2 = !1, M2 = 0; M2 < y2; M2 += 1) {
                                  var _2 = d3[M2],
                                    ...
                                    L2 = {};
                                  w2.isMatch
                                    ? ((L2[_2] = w2.score), (s4 = !0), (x2 = !0), m2.push(w2.score))
                              ...
                              h4 = m2[0];
                              for (var A2 = m2.length, O2 = 1; O2 < A2; O2 += 1) h4 += m2[O2];
...
Check Matches: `.concat(j2)
                              ...
                              var I2 = p2[a5];
                              I2 ? I2.output.push(P2) : ((p2[a5] = { item: i4, output: [P2] }), g2.push(p2[a5]));
                            }
                          } else if (c2(o5)) for (var F2 = 0, T2 = o5.length; F2 < T2; F2 += 1) e6(F2, o5[F2], i4, a5);
                        }
                      })(i3, a4, s3, h3);
                    },
                  },
...
Computing score:
`);
                      for (var t5 = this._keyWeights, r5 = !!Object.keys(t5).length, n4 = 0, o4 = e5.length; n4 < o4; n4 += 1) {
                        for (var i3 = e5[n4], a4 = i3.output, s3 = a4.length, c3 = 1, h3 = 0; h3 < s3; h3 += 1) {
                          var l3 = a4[h3],
                            u2 = l3.key,
                            f2 = r5 ? t5[u2] : 1,
                            v2 = l3.score === 0 && t5 && t5[u2] > 0 ? Number.EPSILON : l3.score;
                          c3 *= Math.pow(v2, f2);
                        }
...
`,
                          ...
                          for (var n4 = 0, o5 = r6.length; n4 < o5; n4 += 1) {
                            ...
                            if (i4.matchedIndices.length !== 0) {
                              ...
                              i4.key && (a5.key = i4.key),
                                i4.hasOwnProperty("arrayIndex") && i4.arrayIndex > -1 && (a5.arrayIndex = i4.arrayIndex),
                                t6.matches.push(a5);
                            }
                          }
                        }),
          ...
          e3.exports = function (e4, t4, r4, i2) {
            ...
            for (var A2 = [], O2 = 1, C2 = x2 + k2, j2 = 1 << (x2 <= 31 ? x2 - 1 : 30), P2 = 0; P2 < x2; P2 += 1) {
              for (var I2 = 0, F2 = C2; I2 < F2; )
                n3(t4, { errors: P2, currentLocation: m2 + F2, expectedLocation: m2, distance: h2 }) <= b2 ? (I2 = F2) : (C2 = F2),
              ...
              for (var E2 = N2; E2 >= T2; E2 -= 1) {
                ...
                if (
                  ...
                  z2[E2] & j2 && (O2 = n3(t4, { errors: P2, currentLocation: W2, expectedLocation: m2, distance: h2 })) <= b2)
                ) {
                  if (((b2 = O2), (S2 = W2) <= m2)) break;
                  T2 = Math.max(1, 2 * m2 - S2);
                }
              }
              if (n3(t4, { errors: P2 + 1, currentLocation: m2, expectedLocation: m2, distance: h2 }) > b2) break;
              A2 = z2;
            }
        ...
        function (e3, t3) {
          e3.exports = function () {
            for (
              ...
              var s2 = e4[i2];
              s2 && n3 === -1 ? (n3 = i2) : s2 || n3 === -1 || ((o3 = i2 - 1) - n3 + 1 >= t4 && r3.push([n3, o3]), (n3 = -1));
            }
        ...
        function (e3, t3) {
          var r3 = function (e4) {
              return Array.isArray ? Array.isArray(e4) : Object.prototype.toString.call(e4) === "[object Array]";
            },
            n3 = function (e4) {
              return e4 == null
                ? ""
              ...
              return (
                (function e5(t5, s2) {
                  if (s2) {
                    ...
                    if (u2 != null)
                      if (l3 || (!o3(u2) && !i2(u2)))
                        if (r3(u2)) for (var f2 = 0, v2 = u2.length; f2 < v2; f2 += 1) e5(u2[f2], l3);
                        else l3 && e5(u2, l3);
                      else a2.push(n3(u2));
                  } else a2.push(t5);
                })(e4, t4),
...
var require_toggle_selection = __commonJS({
  "../../node_modules/toggle-selection/index.js"(exports, module) {
    module.exports = function () {
      ...
      for (var active = document.activeElement, ranges = [], i2 = 0; i2 < selection.rangeCount; i2++) ranges.push(selection.getRangeAt(i2));
  ...
  "../../node_modules/copy-to-clipboard/index.js"(exports, module) {
    ...
    function copy2(text, options2) {
      ...
      try {
        ...
        selection && (typeof selection.removeRange == "function" ? selection.removeRange(range) : selection.removeAllRanges()),
...
var l = {
      ...
      .filter(function (e4) {
        return (
          ...
          (e4[t3] !== void 0 &&
            ...
            console.warn("Helmet: " + t3 + ' should be of type "Array". Instead found type "' + typeof e4[t3] + '"'),
          !1)
        );
      })
      .map(function (e4) {
        ...
        r4.filter(function (t5) {
          for (var r5, o4 = Object.keys(t5), a2 = 0; a2 < o4.length; a2 += 1) {
            ...
            e3.indexOf(c3) === -1 ||
              ...
              (r5 = c3),
              e3.indexOf(s3) === -1 || (s3 !== "innerHTML" && s3 !== "cssText" && s3 !== "itemprop") || (r5 = s3);
          }
  ...
  w = function (t3, e3) {
    return (
      ...
      e3 === !1
        ? String(t3)
        : String(t3).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;")
    );
  },
  x = function (t3) {
            ...
            return (function (t3, e4, r4) {
              return e4.reduce(function (e5, n4) {
                var i2 = Object.keys(n4)
                  ...
                  a2 = P.indexOf(t3) === -1;
                return e5 + "<" + t3 + ' data-rh="true" ' + i2 + (a2 ? "/>" : ">" + o3 + "</" + t3 + ">");
              }, "");
            })(e3, r3, n3);
          },
        };
...
var Y = function (t3, e3) {
  ...
  B = function (t3, e3) {
    ...
    if (r3) {
      for (
        var n3 = r3.getAttribute("data-rh"), i2 = n3 ? n3.split(",") : [], o3 = [].concat(i2), a2 = Object.keys(e3), s2 = 0;
        s2 < a2.length;
        s2 += 1
      ) {
        var c2 = a2[s2],
    ...
    return (
      ...
      (o3.mapNestedChildrenToProps = function (t3, e4) {
        ...
        switch (t3.type) {
          ...
          default:
            throw new Error(
              "<" + t3.type + " /> elements are self-closing and can not contain children. Refer to our API for more information."
            );
        }
      }),
          ...
          import_react.default.Children.forEach(e4, function (t3) {
            if (t3 && t3.props) {
              var e5 = t3.props,
                ...
                c2 = t3.type;
              switch ((typeof c2 == "symbol" ? (c2 = c2.toString()) : n3.warnOnInvalidChildren(t3, o4), c2)) {
                case l.FRAGMENT:
                ...
                case l.SCRIPT:
                case l.STYLE:
                  i2 = n3.flattenArrayTypeChildren({ child: t3, arrayTypeChildren: i2, newChildProps: s2, nestedChildren: o4 });
                  break;
                default:
                  r4 = n3.mapObjectTypeChildren({ child: t3, newProps: r4, newChildProps: s2, nestedChildren: o4 });
              }
            }
          }),
  ...
  Brand = withTheme(({ theme }) => {
    ...
    if (image === null)
      return title === null
        ? null
        : url
        ? import_react2.default.createElement(LogoLink, { href: url, target: targetValue, dangerouslySetInnerHTML: { __html: title } })
...
var SidebarIconButton = newStyled(IconButton)(({ highlighted, theme }) => ({
    ...
    ...(highlighted && {
      ...
      "&:hover:after, &:focus-visible:after": { boxShadow: `0 0 0 2px ${curriedTransparentize$1(0.88, theme.color.secondary)}` },
    }),
  })),
  ...
  SidebarMenu = ({ menu, isHighlighted, onClick }) => {
    ...
    return isMobile
      ? import_react5.default.createElement(
          ...
          import_react5.default.createElement(
            SidebarIconButton,
            { title: "About Storybook", "aria-label": "About Storybook", highlighted: isHighlighted, active: !1, onClick },
      ...
      : import_react5.default.createElement(
          ...
          import_react5.default.createElement(
            SidebarIconButton,
            { title: "Shortcuts", "aria-label": "Shortcuts", highlighted: isHighlighted, active: isTooltipVisible },
            import_react5.default.createElement(CogIcon, null)
          )
        );
  };
var BrandArea = newStyled.div(({ theme }) => ({
  ...
  SkipToCanvasLink = newStyled(Button)(({ theme }) => ({
    ...
    "@media (min-width: 600px)": {
      ...
      "&:focus": { width: "100%", height: "inherit", padding: "10px 15px", margin: 0, clip: "unset", overflow: "unset", opacity: 1 },
    },
  })),
  Heading = ({ menuHighlighted = !1, menu, skipLinkHref, extra, isLoading, onMenuClick, ...props }) =>
    import_react6.default.createElement(
      ...
      isLoading ? null : extra.map(({ id, render: Render }) => import_react6.default.createElement(Render, { key: id })),
      import_react6.default.createElement(SidebarMenu, { menu, isHighlighted: menuHighlighted, onClick: onMenuClick })
    );
...
var { window: globalWindow } = scope,
            ...
            isMain
              ? import_react8.default.createElement(
                  ...
                  import_react8.default.createElement(
                    ...
                    import_react8.default.createElement("li", null, "No stories are defined in your story files."),
                    import_react8.default.createElement("li", null, "You're using filter-functions, and all stories are filtered away.")
                  ),
                  " "
                )
              : import_react8.default.createElement(
  ...
  LoaderBlock = ({ isMain }) =>
    import_react8.default.createElement(Contained, null, import_react8.default.createElement(Loader2, { size: isMain ? 17 : 5 }));
...
var { document: document2, window: globalWindow2 } = scope,
  ...
  RefIndicator = import_react9.default.memo(
    (0, import_react9.forwardRef)(({ state, ...ref }, forwardedRef) => {
      let api = useStorybookApi(),
        ...
        componentCount = (0, import_react9.useMemo)(() => list.filter((v2) => v2.type === "component").length, [list]),
          ...
          WithTooltip,
          {
            ...
            tooltip: import_react9.default.createElement(
              ...
              import_react9.default.createElement(
                Spaced,
                { row: 0 },
                state === "loading" && import_react9.default.createElement(LoadingMessage, { url: ref.url }),
                (state === "error" || state === "empty") && import_react9.default.createElement(ErrorOccurredMessage, { url: ref.url }),
                state === "ready" && import_react9.default.createElement(ReadyMessage, { url: ref.url, componentCount, leafCount }),
                state === "auth" && import_react9.default.createElement(LoginRequiredMessage, { ...ref }),
                ref.type === "auto-inject" && state !== "error" && import_react9.default.createElement(PerformanceDegradedMessage, null),
                ...
                tooltip: (tooltip) =>
                  import_react9.default.createElement(TooltipLinkList, {
                    links: Object.entries(ref.versions).map(([id, href]) => ({
                      ...
                      href,
                      onClick: (event, item) => {
                        event.preventDefault(), api.changeRefVersion(ref.id, item.href), tooltip.onHide();
                      },
                    })),
                  }),
              },
    ...
    let theme = useTheme(),
      open = (0, import_react9.useCallback)((e3) => {
        ...
        let childWindow = globalWindow2.open(loginUrl, `storybook_auth_${id}`, "resizable,scrollbars"),
          timer = setInterval(() => {
            childWindow ? childWindow.closed && (clearInterval(timer), document2.location.reload()) : clearInterval(timer);
          }, 1e3);
      }, []);
    return import_react9.default.createElement(
      Message,
      ...
      import_react9.default.createElement(
        ...
        import_react9.default.createElement("div", null, "You need to authenticate to view this Storybook's components.")
      )
    );
  },
  ReadDocsMessage = () => {
  ...
  ErrorOccurredMessage = ({ url }) => {
    ...
    return import_react9.default.createElement(
      ...
      import_react9.default.createElement(
        ...
        import_react9.default.createElement("div", null, "This external Storybook didn't load. Debug it in a new tab now.")
      )
    );
  },
  LoadingMessage = ({ url }) => {
  ...
  PerformanceDegradedMessage = () => {
    ...
    return import_react9.default.createElement(
      Message,
      { href: "https://storybook.js.org/docs/react/sharing/storybook-composition#improve-your-storybook-composition", target: "_blank" },
...
var TypeIcon = newStyled.svg(({ theme, type }) => ({
  ...
  ComponentNode = import_react12.default.memo(function ({ theme, children, isExpanded, isExpandable, isSelected, ...props }) {
    return import_react12.default.createElement(
      BranchNode,
      { isExpandable, tabIndex: -1, ...props },
      import_react12.default.createElement(
...
var scrollIntoView = (element, center = !1) => {
  ...
  isAncestor = (element, maybeAncestor) =>
    !element || !maybeAncestor ? !1 : element === maybeAncestor ? !0 : isAncestor(element.parentElement, maybeAncestor),
  removeNoiseFromName = (storyName) => storyName.replaceAll(/(\s|-|_)/gi, ""),
  isStoryHoistable = (storyName, componentName) => removeNoiseFromName(storyName) === removeNoiseFromName(componentName);
var { document: document4 } = scope,
  initializeExpanded = ({ refId, data, initialExpanded, highlightedRef, rootIds }) => {
    let highlightedAncestors = highlightedRef.current?.refId === refId ? getAncestorIds(data, highlightedRef.current?.itemId) : [];
      ...
      updateExpanded = (0, import_react13.useCallback)(
        ({ ids, value }) => {
          if ((setExpanded({ ids, value }), ids.length === 1)) {
            let element = containerRef.current?.querySelector(`[data-item-id="${ids[0]}"][data-ref-id="${refId}"]`);
      ...
      (0, import_react13.useEffect)(() => {
        let menuElement = document4.getElementById("storybook-explorer-menu"),
          navigateTree = (0, import_throttle.default)((event) => {
            ...
            if (!isBrowsing || !containerRef.current || !highlightedItemId || event.repeat || !matchesModifiers(!1, event)) return;
            ...
            (isEnter || isSpace) && ["component", "story", "document"].includes(type) && onSelectStoryId(highlightedItemId);
            ...
            isArrowRight &&
              (isExpanded === "false"
                ...
                : isExpanded === "true" && updateExpanded({ ids: getDescendantIds(data, highlightedItemId, !0), value: !0 }));
          }, 60);
...
var SmallIcons = newStyled(CircleIcon)({ "&&&": { width: 6, height: 6 } }),
  ...
  statusMapping = {
    ...
    success: [import_react14.default.createElement(SmallIcons, { key: "icon", style: { color: "green" } }), "currentColor"],
    warn: [import_react14.default.createElement(SmallIcons, { key: "icon", style: { color: "orange" } }), "#A15C20"],
    error: [import_react14.default.createElement(SmallIcons, { key: "icon", style: { color: "red" } }), "brown"],
  },
  getHighestStatus = (statuses) => statusPriority.reduce((acc, status) => (statuses.includes(status) ? status : acc), "unknown");
  ...
  return Object.values(collapsedData).reduce((acc, item) => {
    if (item.type === "group" || item.type === "component") {
      let leafs = getDescendantIds(collapsedData, item.id, !1)
        ...
        combinedStatus = getHighestStatus(leafs.flatMap((story) => Object.values(status?.[story.id] || {})).map((s2) => s2.status));
...
var Container = newStyled.div((props) => ({ marginTop: props.hasOrphans ? 20 : 0, marginBottom: 20 })),
  ...
  SkipToContentLink = newStyled(Button)(({ theme }) => ({
    ...
    "@media (min-width: 600px)": {
      ...
      opacity: 0,
      padding: 0,
      "&:focus": { opacity: 1, padding: "5px 10px", background: "white", color: theme.color.secondary, width: "auto" },
    },
  })),
  Node2 = import_react15.default.memo(function ({
      ...
      return import_react15.default.createElement(
        ...
        isSelected &&
          import_react15.default.createElement(
            SkipToContentLink,
            { asChild: !0 },
            import_react15.default.createElement("a", { href: "#storybook-preview-wrapper" }, "Skip to canvas")
          ),
        icon
          ? import_react15.default.createElement(
              WithTooltip,
    ...
    if (item.type === "root")
      return import_react15.default.createElement(
        RootNode,
        { key: id, id, className: "sidebar-subheading", "data-ref-id": refId, "data-item-id": item.id, "data-nodetype": "root" },
        import_react15.default.createElement(
          CollapseButton,
          {
            type: "button",
    ...
    if (item.type === "component" || item.type === "group") {
      ...
      return import_react15.default.createElement(
        BranchNode2,
        {
          ...
          onMouseEnter: () => {
            item.type === "component" && api.emit(PRELOAD_ENTRIES, { ids: [item.children[0]], options: { target: refId } });
          },
        },
        item.renderLabel?.(item, api) || item.name
      );
  ...
  Root = import_react15.default.memo(function ({ setExpanded, isFullyExpanded, expandableDescendants, ...props }) {
    ...
    return import_react15.default.createElement(Node2, { ...props, setExpanded, isFullyExpanded, setFullyExpanded });
  }),
  Tree = import_react15.default.memo(function ({
    ...
    let containerRef = (0, import_react15.useRef)(null),
      ...
      singleStoryComponentIds = (0, import_react15.useMemo)(
        () =>
          Object.keys(data).filter((id) => {
            ...
            return onlyChild.type === "docs" ? !0 : onlyChild.type === "story" ? isStoryHoistable(onlyChild.name, name) : !1;
          }),
        [data]
      ),
        ...
        () =>
          singleStoryComponentIds.reduce(
            (acc, id) => {
              ...
              return (acc[childId] = { ...data[childId], name, parent, depth: data[childId].depth - 1 }), acc;
            },
            { ...data }
          ),
        [data]
      ...
      ancestry = (0, import_react15.useMemo)(
        () => collapsedItems.reduce((acc, id) => Object.assign(acc, { [id]: getAncestorIds(collapsedData, id) }), {}),
      ...
      groupStatus = (0, import_react15.useMemo)(() => getGroupStatus(collapsedData, status), [collapsedData, status]),
...
var Wrapper2 = newStyled.div(({ isMain }) => ({ position: "relative", marginTop: isMain ? void 0 : 0 })),
  ...
  RefTitle = newStyled.div({ textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1, overflow: "hidden", marginLeft: 2 }),
  CollapseButton2 = newStyled.button(({ theme }) => ({
    ...
    cursor: "pointer",
    overflow: "hidden",
    "&:focus": { borderColor: theme.color.secondary, "span:first-of-type": { borderLeftColor: theme.color.secondary } },
  })),
  Ref = import_react16.default.memo(function (props) {
    let { docsOptions } = useStorybookState(),
      ...
      isLoading = isLoadingMain || (type === "auto-inject" && !previewInitialized) || type === "server-checked" || type === "unknown",
    ...
    let handleClick = (0, import_react16.useCallback)(() => setExpanded((value) => !value), [setExpanded]),
      setHighlightedItemId = (0, import_react16.useCallback)((itemId) => setHighlighted({ itemId, refId }), [setHighlighted]),
    ...
    return (
      (0, import_react17.useEffect)(() => {
        ...
        if ((updateHighlighted(highlight), highlight)) {
          ...
          setTimeout(() => {
            scrollIntoView(containerRef.current?.querySelector(`[data-item-id="${itemId}"][data-ref-id="${refId}"]`), !0);
          }, 0);
        }
        ...
        let menuElement = document5.getElementById("storybook-explorer-menu"),
          ...
          navigateTree = (event) => {
            ...
            let requestId = globalWindow4.requestAnimationFrame(() => {
              ...
              let highlightable = Array.from(containerRef.current.querySelectorAll("[data-highlightable=true]")),
    ...
    styles: ({ color }) => {
      ...
      return {
        [`[data-ref-id="${refId}"][data-item-id="${itemId}"]:not([data-selected="true"])`]: {
          '&[data-nodetype="component"], &[data-nodetype="group"]': { background, "&:hover, &:focus": { background } },
...
var Explorer = import_react19.default.memo(function ({ isLoading, isBrowsing, dataset, selected }) {
  let containerRef = (0, import_react19.useRef)(null),
    [highlighted, setHighlighted, highlightedRef] = useHighlighted({ containerRef, isLoading, isBrowsing, dataset, selected });
...
var t2 = (t3) => typeof t3 == "object" && t3 != null && t3.nodeType === 1,
  ...
  r2 = (e3, r3) => {
    ...
    for (let t3 = 0; t3 < w2.length; t3++) {
      ...
      if (c2 === "if-needed" && x2 >= 0 && R2 >= 0 && I2 <= H2 && C2 <= b2 && x2 >= r4 && I2 <= s3 && R2 >= d3 && C2 <= i3) return L2;
...
function getNonDisabledIndex(start, backwards, items, isItemDisabled2, circular) {
  ...
  } else for (var _index = start; _index < count; _index++) if (!isItemDisabled2(items[_index], _index)) return _index;
    ...
    var Downshift2 = (function (_Component) {
        ...
        (_this = _Component.call(this, _props) || this),
          ...
          (_this.setHighlightedIndex = function (highlightedIndex, otherStateToSet) {
            highlightedIndex === void 0 && (highlightedIndex = _this.props.defaultHighlightedIndex),
              ...
              _this.internalSetState(_extends({ highlightedIndex }, otherStateToSet));
          }),
            ...
            return (
              ...
              _this.setState(
                  ...
                  return (
                    ...
                    Object.keys(newStateToSet).forEach(function (key) {
                      state[key] !== newStateToSet[key] && (onStateChangeArg[key] = newStateToSet[key]),
                        key !== "type" && (newStateToSet[key], isControlledProp(_this.props, key) || (nextState[key] = newStateToSet[key]));
                    }),
                    isStateToSetFunction &&
                ...
                function () {
                  ...
                  hasMoreStateThanType && _this.props.onStateChange(onStateChangeArg, _this.getStateAndHelpers()),
          ...
          (_this.keyDownHandlers = {
                ...
                this.internalSetState({ isOpen: !0, type: keyDownArrowDown }, function () {
                  ...
                  if (itemCount > 0) {
                    var _this2$getState = _this2.getState(),
                      ...
                      nextHighlightedIndex = getHighlightedIndex(highlightedIndex, 1, { length: itemCount }, _this2.isItemDisabled, !0);
                ...
                this.internalSetState({ isOpen: !0, type: keyDownArrowUp }, function () {
                  ...
                  if (itemCount > 0) {
                    var _this3$getState = _this3.getState(),
                      ...
                      nextHighlightedIndex = getHighlightedIndex(highlightedIndex, -1, { length: itemCount }, _this3.isItemDisabled, !0);
            ...
            Escape: function (event) {
              event.preventDefault(),
                this.reset(_extends({ type: keyDownEscape }, !this.state.isOpen && { selectedItem: null, inputValue: "" }));
            },
          }),
          ...
          (_this.inputKeyDownHandlers = _extends({}, _this.keyDownHandlers, {
            Home: function (event) {
              ...
              if (isOpen) {
                ...
                if (!(itemCount <= 0 || !isOpen)) {
                  var newHighlightedIndex = getNonDisabledIndex(0, !1, { length: itemCount }, this.isItemDisabled);
            ...
            End: function (event) {
              ...
              if (isOpen) {
                ...
                var itemCount = this.getItemCount();
                if (!(itemCount <= 0 || !isOpen)) {
                  var newHighlightedIndex = getNonDisabledIndex(itemCount - 1, !0, { length: itemCount }, this.isItemDisabled);
          ...
          (_this.getLabelProps = function (props) {
            return _extends({ htmlFor: _this.inputId, id: _this.labelId }, props);
          }),
            ...
            return _extends(
              {
                ...
                "aria-activedescendant":
                  isOpen && typeof highlightedIndex == "number" && highlightedIndex >= 0 ? _this.getItemId(highlightedIndex) : void 0,
      ...
      return (
        ...
        (_proto.getItemCount = function () {
          ...
          return (
            this.itemCount != null ? (itemCount = this.itemCount) : this.props.itemCount !== void 0 && (itemCount = this.props.itemCount),
            itemCount
          );
        }),
        ...
        (_proto.moveHighlightedIndex = function (amount, otherStateToSet) {
          ...
          if (itemCount > 0) {
            var nextHighlightedIndex = getHighlightedIndex(highlightedIndex, amount, { length: itemCount }, this.isItemDisabled, !0);
        ...
        (_proto.render = function () {
          ...
          if (isDOMElement(element)) return (0, import_react20.cloneElement)(element, this.getRootProps(getElementProps(element)));
...
function validateGetMenuPropsCalledCorrectly(node, _ref12) {
  ...
  node || console.error('downshift: The ref prop "' + refKey + '" from getMenuProps was not applied correctly on your menu element.');
}
...
function callOnChangeProps(action, state, newState) {
  ...
  Object.keys(state).forEach(function (key) {
    ...
    props.onStateChange && Object.keys(changes).length && props.onStateChange(_extends({ type }, changes));
}
function invokeOnChangeHandler(key, action, state, newState) {
  var props = action.props,
    type = action.type,
    handler = "on" + capitalizeString(key) + "Change";
  props[handler] && newState[key] !== void 0 && newState[key] !== state[key] && props[handler](_extends({ type }, newState));
}
    ...
    enhancedReducer = (0, import_react20.useCallback)(
      function (state2, action2) {
        ...
        var changes = reducer(state2, action2),
          newState = action2.props.stateReducer(state2, _extends({}, action2, { changes }));
        return newState;
      },
      [reducer]
    ),
...
function getHighlightedIndexOnOpen(props, state, offset) {
  ...
  return items.length === 0
    ? -1
    : initialHighlightedIndex !== void 0 && highlightedIndex === initialHighlightedIndex && !isItemDisabled2(items[initialHighlightedIndex])
...
useGetterPropsCalledChecker = function () {
  for (
    var isInitialMountRef = (0, import_react20.useRef)(!0), _len = arguments.length, propKeys = new Array(_len), _key = 0;
    _key < _len;
    _key++
  )
  ...
  var setGetterPropCallInfo = (0, import_react20.useCallback)(function (propKey, suppressRefError, refKey, elementRef) {
...
useControlPropsValidator = function (_ref4) {
  ...
  (0, import_react20.useEffect)(
    function () {
      isInitialMount || (validateControlledUnchanged(state, prevPropsRef.current, props), (prevPropsRef.current = props));
    },
...
function downshiftCommonReducer(state, action, stateChangeTypes2) {
  ...
  switch (type) {
    ...
    case stateChangeTypes2.FunctionToggleMenu:
      changes = { isOpen: !state.isOpen, highlightedIndex: state.isOpen ? -1 : getHighlightedIndexOnOpen(props, state, 0) };
      break;
...
function downshiftSelectReducer(state, action) {
  ...
  switch (type) {
    ...
    case ToggleButtonKeyDownEnd:
      changes = { highlightedIndex: getNonDisabledIndex(props.items.length - 1, !0, props.items, props.isItemDisabled), isOpen: !0 };
      break;
    case ToggleButtonKeyDownPageUp:
      changes = { highlightedIndex: getHighlightedIndex(state.highlightedIndex, -10, props.items, props.isItemDisabled) };
      break;
    ...
    case ToggleButtonBlur:
      changes = _extends(
        ...
        state.highlightedIndex >= 0 &&
          ((_props$items = props.items) == null ? void 0 : _props$items.length) && { selectedItem: props.items[state.highlightedIndex] }
      );
      break;
...
function useSelect(userProps) {
  ...
  var props = _extends({}, defaultProps$2, userProps),
    ...
    _useControlledReducer = useControlledReducer$1(downshiftSelectReducer, props, getInitialState$2, isDropdownsStateEqual),
  ...
  var toggleButtonKeyDownHandlers = (0, import_react20.useMemo)(
      function () {
        return {
          ...
          Enter: function (event) {
            event.preventDefault(), dispatch({ type: latest.current.state.isOpen ? ToggleButtonKeyDownEnter : ToggleButtonClick$1 });
          },
          PageUp: function (event) {
            latest.current.state.isOpen && (event.preventDefault(), dispatch({ type: ToggleButtonKeyDownPageUp }));
          },
          PageDown: function (event) {
            latest.current.state.isOpen && (event.preventDefault(), dispatch({ type: ToggleButtonKeyDownPageDown }));
          },
          " ": function (event) {
            event.preventDefault();
    ...
    getLabelProps = (0, import_react20.useCallback)(
      function (_temp) {
        ...
        return _extends(
          { id: elementIds.labelId, htmlFor: elementIds.toggleButtonId, onClick: callAllEventHandlers(onClick, labelHandleClick) },
          labelProps
        );
      },
      [elementIds]
      ...
      function (_temp2, _temp3) {
        ...
        return (
          ...
          _extends(
            ...
            (_extends2["aria-labelledby"] = rest && rest["aria-label"] ? void 0 : "" + elementIds.labelId),
      ...
      function (_temp4, _temp5) {
        ...
        var onKeyDown = _ref4.onKeyDown,
          ...
          toggleButtonHandleBlur = function () {
            latestState.isOpen && !mouseAndTouchTrackers.isMouseDown && dispatch({ type: ToggleButtonBlur });
          },
          ...
          toggleProps = _extends(
            ...
            (_extends3["aria-activedescendant"] =
              latestState.isOpen && latestState.highlightedIndex > -1 ? elementIds.getItemId(latestState.highlightedIndex) : ""),
    ...
    getItemProps = (0, import_react20.useCallback)(
      function (_temp6) {
        ...
        var _latest$current = latest.current,
          ...
          _getItemAndIndex = getItemAndIndex(itemProp, indexProp, latestProps.items, "Pass either item or index to getItemProps!"),
      ...
      function () {
        if (isControlledProp(props, "selectedItem")) {
          if (!isInitialMount) {
            ...
            shouldCallDispatch && dispatch({ type: ControlledPropUpdatedSelectedItem, inputValue: props.itemToString(props.selectedItem) });
          }
...
function downshiftUseComboboxReducer(state, action) {
  ...
  switch (type) {
    ...
    case InputKeyDownArrowDown:
      state.isOpen
        ? (changes = { highlightedIndex: getHighlightedIndex(state.highlightedIndex, 1, props.items, props.isItemDisabled, !0) })
        : (changes = {
    ...
    case InputKeyDownArrowUp:
      state.isOpen
        ? altKey
          ...
          : (changes = { highlightedIndex: getHighlightedIndex(state.highlightedIndex, -1, props.items, props.isItemDisabled, !0) })
        : (changes = { highlightedIndex: getHighlightedIndexOnOpen(props, state, -1), isOpen: props.items.length >= 0 });
      break;
    case InputKeyDownEnter:
      changes = getChangesOnSelection(props, state.highlightedIndex);
      break;
    case InputKeyDownEscape:
      changes = _extends({ isOpen: !1, highlightedIndex: -1 }, !state.isOpen && { selectedItem: null, inputValue: "" });
      break;
    case InputKeyDownPageUp:
      changes = { highlightedIndex: getHighlightedIndex(state.highlightedIndex, -10, props.items, props.isItemDisabled, !0) };
      break;
    ...
    case InputKeyDownEnd:
      changes = { highlightedIndex: getNonDisabledIndex(props.items.length - 1, !0, props.items, props.isItemDisabled) };
      break;
    case InputBlur:
      changes = _extends(
        { isOpen: !1, highlightedIndex: -1 },
      ...
      break;
    case InputChange:
      changes = { isOpen: !0, highlightedIndex: getDefaultValue$1(props, "highlightedIndex"), inputValue: action.inputValue };
      break;
    case InputClick:
      changes = { isOpen: !state.isOpen, highlightedIndex: state.isOpen ? -1 : getHighlightedIndexOnOpen(props, state, 0) };
      break;
...
function useCombobox(userProps) {
  ...
  var props = _extends({}, defaultProps$1, userProps),
    ...
    environment = props.environment,
    getA11yStatusMessage2 = props.getA11yStatusMessage,
    _useControlledReducer = useControlledReducer(downshiftUseComboboxReducer, props, getInitialState$1, isDropdownsStateEqual),
    state = _useControlledReducer[0],
    dispatch = _useControlledReducer[1],
    isOpen = state.isOpen,
    highlightedIndex = state.highlightedIndex,
  ...
  var inputKeyDownHandlers = (0, import_react20.useMemo)(
      function () {
        return {
          ...
          Escape: function (event) {
            ...
            (latestState.isOpen || latestState.inputValue || latestState.selectedItem || latestState.highlightedIndex > -1) &&
              (event.preventDefault(), dispatch({ type: InputKeyDownEscape }));
          },
          Enter: function (event) {
            var latestState = latest.current.state;
            !latestState.isOpen || event.which === 229 || (event.preventDefault(), dispatch({ type: InputKeyDownEnter }));
          },
          PageUp: function (event) {
    ...
    getLabelProps = (0, import_react20.useCallback)(
      function (labelProps) {
        return _extends({ id: elementIds.labelId, htmlFor: elementIds.inputId }, labelProps);
      },
      [elementIds]
    ),
    getMenuProps = (0, import_react20.useCallback)(
    ...
    getItemProps = (0, import_react20.useCallback)(
      function (_temp3) {
        ...
        return _extends(
          ...
          _extends3),
          !disabled && ((_ref4 = {}), (_ref4[onSelectKey] = callAllEventHandlers(customClickHandler, itemHandleClick)), _ref4),
          {
    ...
    getToggleButtonProps = (0, import_react20.useCallback)(
      function (_temp4) {
        ...
        return _extends(
          ...
          _extends4),
          !rest.disabled && _extends({}, { onClick: callAllEventHandlers(onClick, toggleButtonHandleClick) }),
          rest
        );
      },
...
function isKeyDownOperationPermitted(event) {
  ...
  return !(element instanceof HTMLInputElement && element.value !== "" && (element.selectionStart !== 0 || element.selectionEnd !== 0));
}
...
function downshiftMultipleSelectionReducer(state, action) {
  ...
  switch (type) {
    ...
    case FunctionReset:
      changes = { activeIndex: getDefaultValue(props, "activeIndex"), selectedItems: getDefaultValue(props, "selectedItems") };
      break;
    default:
      throw new Error("Reducer called without proper action type.");
  }
...
function useMultipleSelection(userProps) {
  ...
  var props = _extends({}, defaultProps, userProps),
    ...
    _useControlledReducer = useControlledReducer$1(downshiftMultipleSelectionReducer, props, getInitialState, isStateEqual),
    state = _useControlledReducer[0],
    dispatch = _useControlledReducer[1],
    activeIndex = state.activeIndex,
    selectedItems = state.selectedItems,
...
async function trySelectNewStory(selectStory, storyId, attempt = 1) {
  if (attempt > 10) throw new Error("We could not select the new story. Please try again.");
  try {
...
var FileListWrapper = newStyled("div")(({ theme }) => ({
  ...
  FileListItem = newStyled("div")(({ theme }) => ({ display: "flex", flexDirection: "column", position: "relative" })),
  FileListItemContentWrapper = newStyled.div(({ theme, selected, disabled, error }) => ({
    display: "flex",
    alignItems: "flex-start",
    gap: "8px",
    alignSelf: "stretch",
    ...
    ...(disabled && { cursor: "not-allowed", div: { color: `${theme.color.mediumdark} !important` } }),
    ...(error && { background: theme.base === "light" ? "#00000011" : "#00000033" }),
    "&:hover": {
      background: error ? "#00000022" : theme.base === "dark" ? "rgba(255,255,255,.1)" : theme.color.mediumlight,
      "> svg": { display: "flex" },
    },
  })),
  FileListUl = newStyled("ul")({ margin: 0, padding: "0 0 0 0", width: "100%", position: "relative" }),
  ...
  FileListIconWrapper = newStyled("div")(({ theme, error }) => ({ color: error ? theme.color.negativeText : theme.color.secondary })),
  ...
  FileListItemExport = newStyled("li")(({ theme, error }) => ({
    ...
    "> div > svg": { color: error ? theme.color.negativeText : theme.color.secondary },
  })),
      ...
      [1, 2, 3].map((result) =>
        import_react22.default.createElement(
          ...
          import_react22.default.createElement(
            ...
            null,
            import_react22.default.createElement(FileListIconWrapperSkeleton, null),
            import_react22.default.createElement(
              FileListItemContentSkeleton,
              null,
              import_react22.default.createElement(FileListItemSkeleton, { style: { width: "90px" } }),
              import_react22.default.createElement(FileListItemSkeleton, { style: { width: "300px" } })
            )
          )
        )
      )
...
function memo(getDeps, fn, opts) {
  ...
  return () => {
    ...
    let resultTime;
    if (
      (opts.key && (_b = opts.debug) != null && _b.call(opts) && (resultTime = Date.now()),
      (result = fn(...newDeps)),
...
var defaultKeyExtractor = (index) => index,
  ...
  observeElementRect = (instance, cb) => {
    ...
    if ((handler(element.getBoundingClientRect()), typeof ResizeObserver > "u")) return () => {};
  ...
  Virtualizer = class {
    constructor(opts) {
      (this.unsubs = []),
        ...
        (this.cleanup = () => {
          this.unsubs.filter(Boolean).forEach((d2) => d2()), (this.unsubs = []), (this.scrollElement = null);
        }),
        (this._didMount = () => (
              ...
              this.options.observeElementOffset(this, (offset) => {
                (this.scrollAdjustments = 0),
                  this.scrollOffset !== offset &&
                    (this.isScrollingTimeoutId !== null && (clearTimeout(this.isScrollingTimeoutId), (this.isScrollingTimeoutId = null)),
                    (this.isScrolling = !0),
        ...
        (this.memoOptions = memo(
          ...
          (count, paddingStart, scrollMargin, getItemKey) => (
            (this.pendingMeasuredCacheIndexes = []), { count, paddingStart, scrollMargin, getItemKey }
          ),
          { key: !1 }
        )),
        (this.getFurthestMeasurement = (measurements, index) => {
          ...
          for (let m2 = index - 1; m2 >= 0; m2--) {
            ...
            let previousFurthestMeasurement = furthestMeasurements.get(measurement.lane);
            if (
              (previousFurthestMeasurement == null || measurement.end > previousFurthestMeasurement.end
                ? furthestMeasurements.set(measurement.lane, measurement)
                : measurement.end < previousFurthestMeasurement.end && furthestMeasurementsFound.set(measurement.lane, !0),
              furthestMeasurementsFound.size === this.options.lanes)
            )
              break;
          }
          return furthestMeasurements.size === this.options.lanes
            ? Array.from(furthestMeasurements.values()).sort((a2, b2) => (a2.end === b2.end ? a2.index - b2.index : a2.end - b2.end))[0]
            : void 0;
        }),
          ...
          ({ count, paddingStart, scrollMargin, getItemKey }, itemSizeCache) => {
            ...
            for (let i2 = min; i2 < count; i2++) {
              let key = getItemKey(i2),
                furthestMeasurement = this.options.lanes === 1 ? measurements[i2 - 1] : this.getFurthestMeasurement(measurements, i2),
                start = furthestMeasurement ? furthestMeasurement.end + this.options.gap : paddingStart + scrollMargin,
                measuredSize = itemSizeCache.get(key),
                size = typeof measuredSize == "number" ? measuredSize : this.options.estimateSize(i2),
                end = start + size,
        ...
        (this.calculateRange = memo(
          ...
          (measurements, outerSize, scrollOffset) =>
            (this.range = measurements.length > 0 && outerSize > 0 ? calculateRange({ measurements, outerSize, scrollOffset }) : null),
        ...
        (this.getIndexes = memo(
          ...
          (rangeExtractor, range, overscan, count) => (range === null ? [] : rangeExtractor({ ...range, overscan, count })),
        ...
        (this.indexFromElement = (node) => {
          ...
          return indexStr
            ...
            : (console.warn(`Missing attribute name '${attributeName}={index}' on measured element.`), -1);
        }),
        (this._measureElement = (node, entry) => {
          let item = this.measurementsCache[this.indexFromElement(node)];
          if (!item || !node.isConnected) {
            this.measureElementCache.forEach((cached, key) => {
              cached === node && (this.observer.unobserve(node), this.measureElementCache.delete(key));
            });
            return;
          }
          let prevNode = this.measureElementCache.get(item.key);
          prevNode !== node &&
            (prevNode && this.observer.unobserve(prevNode), this.observer.observe(node), this.measureElementCache.set(item.key, node));
        ...
        (this.resizeItem = (item, size) => {
          ...
          delta !== 0 &&
            ((this.shouldAdjustScrollPositionOnItemSizeChange !== void 0
              ...
              this._scrollToOffset(this.scrollOffset, { adjustments: (this.scrollAdjustments += delta), behavior: void 0 })),
        ...
        (this.getVirtualItemForOffset = (offset) => {
          ...
          return notUndefined(
            measurements[findNearestBinarySearch(0, measurements.length - 1, (index) => notUndefined(measurements[index]).start, offset)]
          );
        }),
        (this.getOffsetForAlignment = (toOffset, align) => {
          ...
          let scrollSizeProp = this.options.horizontal ? "scrollWidth" : "scrollHeight",
            maxOffset =
              (this.scrollElement
        ...
        (this.getOffsetForIndex = (index, align = "auto") => {
          ...
          if (align === "auto")
            if (measurement.end >= this.scrollOffset + this.getSize() - this.options.scrollPaddingEnd) align = "end";
            else if (measurement.start <= this.scrollOffset + this.options.scrollPaddingStart) align = "start";
            else return [this.scrollOffset, align];
          let toOffset =
            align === "end" ? measurement.end + this.options.scrollPaddingEnd : measurement.start - this.options.scrollPaddingStart;
          ...
          this._scrollToOffset(toOffset, { adjustments: void 0, behavior }),
            behavior !== "smooth" &&
              ...
              (this.scrollToIndexTimeoutId = setTimeout(() => {
                if (((this.scrollToIndexTimeoutId = null), this.measureElementCache.has(this.options.getItemKey(index)))) {
                  let [toOffset2] = this.getOffsetForIndex(index, align);
                  approxEqual(toOffset2, this.scrollOffset) || this.scrollToIndex(index, { align, behavior });
        ...
        (this.scrollBy = (delta, { behavior } = {}) => {
          this.cancelScrollToIndex(),
            behavior === "smooth" &&
              this.isDynamicMode() &&
              console.warn("The `smooth` scroll behavior is not fully supported with dynamic size."),
            this._scrollToOffset(this.scrollOffset + delta, { adjustments: void 0, behavior });
        }),
        (this.getTotalSize = () => {
          var _a;
          let measurements = this.getMeasurements(),
            ...
            measurements.length === 0
              ...
              : (end =
                  this.options.lanes === 1
                    ? ((_a = measurements[measurements.length - 1]) == null ? void 0 : _a.end) ?? 0
                    : Math.max(...measurements.slice(-this.options.lanes).map((m2) => m2.end))),
...
function calculateRange({ measurements, outerSize, scrollOffset }) {
  let count = measurements.length - 1,
    startIndex = findNearestBinarySearch(0, count, (index) => measurements[index].start, scrollOffset),
    endIndex = startIndex;
  for (; endIndex < count && measurements[endIndex].end < scrollOffset + outerSize; ) endIndex++;
  return { startIndex, endIndex };
}
var useIsomorphicLayoutEffect2 = typeof document < "u" ? React18.useLayoutEffect : React18.useEffect;
    ...
    resolvedOptions = {
      ...
      onChange: (instance2, sync) => {
        ...
        sync ? (0, import_react_dom.flushSync)(rerender) : rerender(),
          (_a = options2.onChange) == null || _a.call(options2, instance2, sync);
      },
    },
...
function useVirtualizer(options2) {
  return useVirtualizerBase({ observeElementRect, observeElementOffset, scrollToFn: elementScroll, ...options2 });
}
    ...
    (0, import_react23.useEffect)(() => {
      let handleArrowKeys = (event) => {
        ...
        let maxIndex = rowVirtualizer.options.count,
          ...
          rowIndex = parseInt(activeElement.getAttribute("data-index") || "-1", 10),
          isActiveElementInput = activeElement.tagName === "INPUT",
          getFirstElement = () => document.querySelector('[data-index="0"]'),
          getLastElement = () => document.querySelector(`[data-index="${maxIndex - 1}"]`);
        if (event.code === "ArrowDown" && activeElement) {
          ...
          if (selectedItem === rowIndex) {
            document.querySelector(`[data-index-position="${selectedItem}_first"]`)?.focus();
            return;
          }
...
var ChevronRightIconStyled = newStyled(ChevronRightIcon)(({ theme }) => ({
  ...
  FileSearchList = (0, import_react24.memo)(function ({ isLoading, searchResults, onNewStory, errorItemId }) {
      ...
      sortedSearchResults = (0, import_react24.useMemo)(
        () =>
          [...(searchResults ?? [])].sort((a2, b2) => {
            let isALowPriority = a2.exportedComponents === null || a2.exportedComponents?.length === 0,
              hasAStory = a2.storyFileExists,
              isBLowPriority = b2.exportedComponents === null || b2.exportedComponents?.length === 0,
    ...
    let handleFileItemSelection = (0, import_react24.useCallback)(
        ({ virtualItem, searchResult, itemId }) => {
          searchResult?.exportedComponents?.length > 1
            ? setSelectedItem((sItem) => (sItem === virtualItem.index ? null : virtualItem.index))
            : searchResult?.exportedComponents?.length === 1 &&
              onNewStory({
          ...
          return import_react24.default.createElement(
            ...
            import_react24.default.createElement(
              ...
              import_react24.default.createElement(
                FileListItemContent,
                null,
                import_react24.default.createElement(FileListItemLabel, { error: itemError }, searchResult.filepath.split("/").at(-1)),
                import_react24.default.createElement(FileListItemPath, null, searchResult.filepath)
              ),
              itemSelected
                ? import_react24.default.createElement(ChevronDownIconStyled, null)
                : import_react24.default.createElement(ChevronRightIconStyled, null)
            ),
            searchResult?.exportedComponents?.length > 1 &&
              itemSelected &&
              import_react24.default.createElement(
                ...
                searchResult.exportedComponents?.map((component, itemExportId) => {
                  let itemExportError = errorItemId === `${searchResult.filepath}_${itemExportId}`,
                    position =
                      itemExportId === 0 ? "first" : itemExportId === searchResult.exportedComponents.length - 1 ? "last" : "middle";
                  return import_react24.default.createElement(
                    FileListItemExport,
                    {
                      tabIndex: 0,
                      ...
                      onClick: () => {
                        handleFileItemComponentSelection({ searchResult, component, id: `${searchResult.filepath}_${itemExportId}` });
                      },
                      onKeyUp: (event) => {
                        event.key === "Enter" &&
                          handleFileItemComponentSelection({ searchResult, component, id: `${searchResult.filepath}_${itemExportId}` });
                    ...
                    import_react24.default.createElement(
                      ...
                      component.default
                        ? import_react24.default.createElement(
                            ...
                            import_react24.default.createElement(DefaultExport, null, "Default export")
                          )
                        : component.name
                    ),
                    import_react24.default.createElement(ChevronRightIconStyled, null)
    ...
    return isLoading && (searchResults === null || searchResults?.length === 0)
      ? import_react24.default.createElement(FileSearchListLoadingSkeleton, null)
      : searchResults?.length === 0
      ? import_react24.default.createElement(
          NoResults,
          null,
          import_react24.default.createElement("p", null, "We could not find any file with that name"),
          import_react24.default.createElement(
            ...
            import_react24.default.createElement(
              ...
              rowVirtualizer.getVirtualItems().map((virtualItem) => {
                let searchResult = sortedSearchResults[virtualItem.index],
                  noExports = searchResult.exportedComponents === null || searchResult.exportedComponents?.length === 0,
                  itemProps = {};
                return import_react24.default.createElement(
                  FileListLi,
                  {
                    ...
                    onKeyUp: (event) => {
                      event.key === "Enter" && handleFileItemSelection({ virtualItem, itemId: searchResult.filepath, searchResult });
                    },
                  ...
                  noExports
                    ? import_react24.default.createElement(
                        WithTooltip,
                        {
                          ...
                          hasChrome: !1,
                          closeOnOutsideClick: !0,
                          tooltip: import_react24.default.createElement(TooltipNote, {
                            note: noExports
                              ? "We can't evaluate exports for this file. You can't create a story for it automatically"
                              : null,
                          }),
                        },
                        import_react24.default.createElement(ListItem, { searchResult, selected: selectedItem, virtualItem })
                      )
...
function useMeasure() {
  let [dimensions, setDimensions] = import_react25.default.useState({ width: null, height: null }),
    prevObserver = import_react25.default.useRef(null);
  return [
    import_react25.default.useCallback((node) => {
      if (
        (prevObserver.current && (prevObserver.current.disconnect(), (prevObserver.current = null)), node?.nodeType === Node.ELEMENT_NODE)
      ) {
...
var MODAL_HEIGHT = 418,
  ModalStyled = newStyled(Modal)(() => ({ boxShadow: "none", background: "transparent" })),
  ...
  ModalInput = newStyled(Form.Input)(({ theme }) => ({
    ...
    "&:invalid:not(:placeholder-shown)": { boxShadow: `${theme.color.negative} 0 0 0 1px inset` },
    "&::-webkit-search-decoration, &::-webkit-search-cancel-button, &::-webkit-search-results-button, &::-webkit-search-results-decoration":
      { display: "none" },
  })),
  SearchField = newStyled.div({ display: "flex", flexDirection: "column", flexGrow: 1, position: "relative" }),
  ...
  ModalErrorCloseIcon = newStyled(CloseAltIcon)({ position: "absolute", top: 4, right: -24, cursor: "pointer" }),
  FileSearchModal = ({
    open,
    onOpenChange,
    fileSearchQuery,
    ...
    let [modalContentRef, modalContentDimensions] = useMeasure(),
      [modalMaxHeight, setModalMaxHeight] = (0, import_react26.useState)(modalContentDimensions.height),
      [, startTransition] = (0, import_react26.useTransition)(),
      [searchInputValue, setSearchInputValue] = (0, import_react26.useState)(fileSearchQuery);
    return (
        ...
        import_react26.default.createElement(
          ...
          import_react26.default.createElement(
            ...
            import_react26.default.createElement(
              Modal.Header,
              null,
              import_react26.default.createElement(Modal.Title, null, "Add a new story"),
              import_react26.default.createElement(Modal.Description, null, "We will create a new story for your component")
            ),
            import_react26.default.createElement(
              SearchField,
              null,
              import_react26.default.createElement(SearchIconWrapper, null, import_react26.default.createElement(SearchIcon, null)),
              ...
              isLoading && import_react26.default.createElement(LoadingIcon, null, import_react26.default.createElement(SyncIcon, null))
            ),
...
var stringifyArgs = (args) => JSON.stringify(args, (_2, value) => (typeof value == "function" ? "__sb_empty_function_arg__" : value)),
  CreateNewStoryFileModal = ({ open, onOpenChange }) => {
    let [isLoading, setLoading] = (0, import_react27.useState)(!1),
      ...
      fileSearchQueryDeferred = (0, import_react27.useDeferredValue)(fileSearchQueryDebounced),
      ...
      handleSuccessfullyCreatedStory = (0, import_react27.useCallback)(
        (componentExportName) => {
          api.addNotification({
            ...
            content: { headline: "Story file created", subHeadline: `${componentExportName} was created` },
            duration: 8e3,
      ...
      handleStoryAlreadyExists = (0, import_react27.useCallback)(() => {
        api.addNotification({
          ...
          content: { headline: "Story already exists", subHeadline: "Successfully navigated to existing story" },
          duration: 8e3,
          icon: import_react27.default.createElement(CheckIcon, null),
        }),
          onOpenChange(!1);
      ...
      handleFileSearch = (0, import_react27.useCallback)(() => {
        ...
        let channel = addons.getChannel(),
          set = (data) => {
            data.id === fileSearchQueryDeferred &&
              (data.success ? setSearchResults(data.payload.files) : setError({ error: data.error }),
        ...
        return (
          ...
          fileSearchQueryDeferred !== "" && emittedValue.current !== fileSearchQueryDeferred
            ? ((emittedValue.current = fileSearchQueryDeferred),
              channel.emit(FILE_COMPONENT_SEARCH_REQUEST, { id: fileSearchQueryDeferred, payload: {} }))
      ...
      handleCreateNewStory = (0, import_react27.useCallback)(
        async ({ componentExportName, componentFilePath, componentIsDefaultExport, componentExportCount, selectedItemId }) => {
          try {
            let channel = addons.getChannel(),
              createNewStoryResult = await experimental_requestResponse(
                ...
                CREATE_NEW_STORYFILE_REQUEST,
                CREATE_NEW_STORYFILE_RESPONSE,
                { componentExportName, componentFilePath, componentIsDefaultExport, componentExportCount }
              );
            setError(null);
            let storyId = createNewStoryResult.storyId;
            await trySelectNewStory(api.selectStory, storyId);
            try {
              let argTypes = (await experimental_requestResponse(channel, ARGTYPES_INFO_REQUEST, ARGTYPES_INFO_RESPONSE, { storyId }))
                  .argTypes,
    ...
    return (
      ...
      (0, import_react27.useEffect)(() => handleFileSearch(), [handleFileSearch]),
...
var { document: document6 } = scope,
  ...
  SearchBar = newStyled.div({ display: "flex", flexDirection: "row", columnGap: 6 }),
  TooltipNoteWrapper = newStyled(TooltipNote)({ margin: 0 }),
  ScreenReaderLabel = newStyled.label({ position: "absolute", left: -1e4, top: "auto", width: 1, height: 1, overflow: "hidden" }),
  CreateNewStoryButton = newStyled(IconButton)(({ theme }) => ({ color: theme.color.mediumdark })),
  ...
  SearchField2 = newStyled.div({ display: "flex", flexDirection: "column", flexGrow: 1, position: "relative" }),
  ...
  Search = import_react28.default.memo(function ({
    ...
    let api = useStorybookApi(),
      ...
      [inputPlaceholder, setPlaceholder] = (0, import_react28.useState)("Find components"),
      ...
      [isFileSearchModalOpen, setIsFileSearchModalOpen] = (0, import_react28.useState)(!1),
            ...
            index &&
              acc.push(
                ...Object.values(index).map((item) => {
                  let statusValue =
                    status && status[item.id] ? getHighestStatus(Object.values(status[item.id] || {}).map((s2) => s2.status)) : null;
                  return { ...searchItem(item, dataset.hash[refId]), status: statusValue || groupStatus[item.id] || null };
                })
              ),
            acc
          );
        ...
        (input) => {
          ...
          let results = [],
            ...
            distinctResults = fuse
              .search(input)
              .filter(({ item }) =>
                !(item.type === "component" || item.type === "docs" || item.type === "story") || resultIds.has(item.parent)
                  ? !1
      ...
      onInputValueChange = (0, import_react28.useCallback)((inputValue, stateAndHelpers) => {
        showAllComponents(!1);
      }, []),
      stateReducer2 = (0, import_react28.useCallback)((state, changes) => {
        switch (changes.type) {
          case Downshift$1.stateChangeTypes.blurInput:
            return { ...changes, inputValue: state.inputValue, isOpen: state.inputValue && !state.selectedItem };
    ...
    return import_react28.default.createElement(
      ...
      ({
        ...
        return import_react28.default.createElement(
          ...
          null,
          import_react28.default.createElement(ScreenReaderLabel, { ...labelProps }, "Search for components"),
          import_react28.default.createElement(
            ...
            import_react28.default.createElement(
              ...
              import_react28.default.createElement(SearchIconWrapper2, null, import_react28.default.createElement(SearchIcon, null)),
                ...
                import_react28.default.createElement(
                  ...
                  searchShortcut === "\u2318 K"
                    ? import_react28.default.createElement(
                        import_react28.default.Fragment,
                        null,
                        import_react28.default.createElement(FocusKeyCmd, null, "\u2318"),
                        "K"
                      )
                    : searchShortcut
                ),
              ...
              import_react28.default.createElement(
                ...
                import_react28.default.createElement(
                  WithTooltip,
                  {
                    trigger: "hover",
                    hasChrome: !1,
                    tooltip: import_react28.default.createElement(TooltipNoteWrapper, { note: "Create a new story" }),
                  },
                  import_react28.default.createElement(
...
var { document: document7 } = scope,
    ...
    let { value, indices } = match,
      { nodes: result } = indices.reduce(
        ({ cursor, nodes }, [start, end], index, { length }) => (
          nodes.push(import_react29.default.createElement("span", { key: `${index}-1` }, value.slice(cursor, start))),
          nodes.push(import_react29.default.createElement(Mark, { key: `${index}-2` }, value.slice(start, end + 1))),
          index === length - 1 && nodes.push(import_react29.default.createElement("span", { key: `${index}-3` }, value.slice(end + 1))),
          { cursor: end + 1, nodes }
        ),
        { cursor: 0, nodes: [] }
      );
  ...
  Result = import_react29.default.memo(function ({ item, matches, onClick, ...props }) {
      ...
      import_react29.default.createElement(
        ...
        item.type === "component" &&
          import_react29.default.createElement(
            ...
            import_react29.default.createElement(UseSymbol, { type: "component" })
          ),
        item.type === "story" &&
          import_react29.default.createElement(
            TypeIcon,
        ...
        !(item.type === "component" || item.type === "story") &&
          import_react29.default.createElement(
            ...
            import_react29.default.createElement(UseSymbol, { type: "document" })
          )
      ),
      import_react29.default.createElement(
        ResultRowContent,
        { className: "search-result-item--label" },
        import_react29.default.createElement(Title, null, import_react29.default.createElement(Highlight, { match: nameMatch }, item.name)),
        import_react29.default.createElement(
          Path,
          null,
          item.path.map((group, index) =>
            import_react29.default.createElement(
              "span",
              { key: index },
              import_react29.default.createElement(Highlight, { match: pathMatches.find((match) => match.arrayIndex === index) }, group)
            )
          )
        )
      ),
  ...
  SearchResults = import_react29.default.memo(function ({
    ...
    let mouseOverHandler = (0, import_react29.useCallback)((event) => {
        ...
        item?.type === "component" &&
          api.emit(PRELOAD_ENTRIES, { ids: [item.isLeaf ? item.id : item.children[0]], options: { target: refId } });
      }, []),
      ...
      results.length === 0 &&
        ...
        import_react29.default.createElement(
          ...
          import_react29.default.createElement(
            NoResults2,
            null,
            import_react29.default.createElement("strong", null, "No components found"),
            import_react29.default.createElement("br", null),
            import_react29.default.createElement("small", null, "Find components by name or path.")
          )
        ),
...
var import_debounce = __toESM(require_debounce()),
  ...
  useLastViewed = (selection) => {
      ...
      updateLastViewed = (0, import_react30.useCallback)(
        (story) => {
          let items = lastViewedRef.current,
            index = items.findIndex(({ storyId, refId }) => storyId === story.storyId && refId === story.refId);
          index !== 0 &&
            (index === -1
    ...
    return (
      ...
      {
        getLastViewed: (0, import_react30.useCallback)(() => lastViewedRef.current, [lastViewedRef]),
...
var DEFAULT_REF_ID = "storybook_internal",
  ...
  Swap = import_react31.default.memo(function ({ children, condition }) {
    ...
    return import_react31.default.createElement(
      ...
      null,
      import_react31.default.createElement("div", { style: { display: condition ? "block" : "none" } }, a2),
      import_react31.default.createElement("div", { style: { display: condition ? "none" : "block" } }, b2)
    );
  }),
  useCombination = (index, indexError, previewInitialized, status, refs) => {
    let hash = (0, import_react31.useMemo)(
      () => ({
        [DEFAULT_REF_ID]: { index, indexError, previewInitialized, status, title: null, id: DEFAULT_REF_ID, url: "iframe.html" },
        ...refs,
      }),
      [refs, index, indexError, previewInitialized, status]
    );
    return (0, import_react31.useMemo)(() => ({ hash, entries: Object.entries(hash) }), [hash]);
  },
  Sidebar = import_react31.default.memo(function ({
    ...
    let selected = (0, import_react31.useMemo)(() => storyId && { storyId, refId }, [storyId, refId]),
    ...
    return import_react31.default.createElement(
      ...
      import_react31.default.createElement(
        ...
        import_react31.default.createElement(
          ...
          import_react31.default.createElement(
            Search,
            { dataset, enableShortcuts, showCreateStoryButton, ...lastViewedProps },
            ({ query, results, isBrowsing, closeMenu, getMenuProps, getItemProps, highlightedIndex }) =>
              import_react31.default.createElement(
                Swap,
                { condition: isBrowsing },
                import_react31.default.createElement(Explorer, { dataset, selected, isLoading, isBrowsing }),
      ...
      isLoading
        ...
        : import_react31.default.createElement(
            Bottom,
            { className: "sb-bar" },
            bottom.map(({ id, render: Render }) => import_react31.default.createElement(Render, { key: id }))
          )
    );
  });
  ...
  Shortcut = ({ keys }) =>
    import_react32.default.createElement(
      ...
      import_react32.default.createElement(
        Key,
        null,
        keys.map((key, index) => import_react32.default.createElement(KeyChild, { key }, shortcutToHumanString([key])))
      )
    ),
    ...
    let theme = useTheme(),
      ...
      whatsNew = (0, import_react32.useMemo)(
        () => ({
          ...
          right:
            ...
            isWhatsNewUnread &&
            import_react32.default.createElement(Badge, { status: "positive" }, "Check it out"),
      ...
      shortcuts = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.shortcutsPage }) : null,
      ...
      sidebarToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          active: isNavShown,
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.toggleNav }) : null,
          icon: isNavShown ? import_react32.default.createElement(CheckIcon, null) : null,
        }),
      ...
      toolbarToogle = (0, import_react32.useMemo)(
        () => ({
          ...
          active: showToolbar,
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.toolbar }) : null,
          icon: showToolbar ? import_react32.default.createElement(CheckIcon, null) : null,
        }),
      ...
      addonsToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          active: isPanelShown,
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.togglePanel }) : null,
          icon: isPanelShown ? import_react32.default.createElement(CheckIcon, null) : null,
        }),
      ...
      addonsOrientationToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.panelPosition }) : null,
        }),
      ...
      fullscreenToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          active: isFullscreen,
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.fullScreen }) : null,
          icon: isFullscreen ? import_react32.default.createElement(CheckIcon, null) : null,
        }),
      ...
      searchToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.search }) : null,
        }),
        [api, enableShortcuts, shortcutKeys]
      ),
      up = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.prevComponent }) : null,
        }),
        [api, enableShortcuts, shortcutKeys]
      ),
      down = (0, import_react32.useMemo)(
        () => ({
          ...
          onClick: () => api.jumpToComponent(1),
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.nextComponent }) : null,
        }),
        [api, enableShortcuts, shortcutKeys]
      ),
      prev = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.prevStory }) : null,
        }),
        [api, enableShortcuts, shortcutKeys]
      ),
      next = (0, import_react32.useMemo)(
        () => ({
          ...
          title: "Next story",
          onClick: () => api.jumpToStory(1),
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.nextStory }) : null,
        }),
        [api, enableShortcuts, shortcutKeys]
      ),
      collapse = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.collapseAll }) : null,
        }),
        [api, enableShortcuts, shortcutKeys]
      ),
      getAddonsShortcuts = (0, import_react32.useCallback)(() => {
        ...
        return Object.entries(addonsShortcuts)
          ...
          .map(([actionName, { label, action }]) => ({
            ...
            title: label,
            onClick: () => action(),
            right: enableShortcuts ? import_react32.default.createElement(Shortcut, { keys: keys[actionName] }) : null,
          }));
      }, [api, enableShortcuts, shortcutKeys]);
...
var Sidebar3 = import_react33.default.memo(function ({ onMenuClick }) {
    return import_react33.default.createElement(
      ManagerConsumer,
      {
        filter: ({ state, api }) => {
          let {
            ...
            menu = useMenu(state, api, showToolbar, api.getIsFullscreen(), api.getIsPanelShown(), api.getIsNavShown(), enableShortcuts),
            whatsNewNotificationsEnabled = state.whatsNewData?.status === "SUCCESS" && !state.disableWhatsNewNotifications,
            ...
            bottom = (0, import_react33.useMemo)(() => Object.values(bottomItems), [Object.keys(bottomItems).join("")]),
            top = (0, import_react33.useMemo)(() => Object.values(topItems), [Object.keys(topItems).join("")]);
          return {
            title: name,
            url,
            index,
      ...
      (fromState) => import_react33.default.createElement(Sidebar, { ...fromState, onMenuClick })
    );
  }),
...
var PreviewContainer = newStyled.main({ display: "flex", flexDirection: "column", width: "100%", height: "100%", overflow: "hidden" }),
...
var initialZoom = 1,
  Context = (0, import_react34.createContext)({ value: initialZoom, set: (v2) => {} }),
  ZoomProvider = class extends import_react34.Component {
    ...
    render() {
      let { children, shouldScale } = this.props,
        { set } = this,
        { value } = this.state;
      return import_react34.default.createElement(Context.Provider, { value: { value: shouldScale ? value : initialZoom, set } }, children);
    }
  },
...
var ZoomWrapper = (0, import_react34.memo)(function ({ set, value }) {
  ...
  return import_react34.default.createElement(Zoom2, { key: "zoom", zoomIn, zoomOut, reset });
});
...
var ApplyWrappers = ({ wrappers, id, storyId, children }) =>
    import_react35.default.createElement(
      ...
      wrappers.reduceRight(
        (acc, wrapper, index) => import_react35.default.createElement(wrapper.render, { index, children: acc, id, storyId }),
        children
      )
    ),
  defaultWrappers = [
    {
      ...
      render: (p2) => import_react35.default.createElement(IframeWrapper, { id: "storybook-preview-wrapper" }, p2.children),
    },
  ];
...
var { PREVIEW_URL, document: document8 } = scope,
  ...
  copyTool = {
    ...
    match: ({ viewMode, tabId }) => viewMode === "story" && !tabId,
    render: () =>
      import_react36.default.createElement(ManagerConsumer, { filter: copyMapper }, ({ baseUrl, storyId, queryParams }) =>
        storyId
...
var { PREVIEW_URL: PREVIEW_URL2 } = scope,
  ...
  ejectTool = {
    ...
    match: ({ viewMode, tabId }) => viewMode === "story" && !tabId,
    render: () =>
      import_react37.default.createElement(ManagerConsumer, { filter: ejectMapper }, ({ baseUrl, storyId, queryParams }) =>
        storyId
...
var StyledAnimatedIconButton = newStyled(IconButton)(({ theme, animating, disabled }) => ({
  ...
  remountTool = {
    ...
    match: ({ viewMode, tabId }) => viewMode === "story" && !tabId,
    render: () =>
      import_react39.default.createElement(ManagerConsumer, { filter: menuMapper2 }, ({ remount, storyId, api }) => {
...
var ToolbarComp = import_react40.default.memo(function ({ isShown, tools, toolsExtra, tabs, tabId, api }) {
          ...
          import_react40.default.createElement(
            ...
            import_react40.default.createElement(
              ...
              tabs.length > 1
                ...
                : null,
              import_react40.default.createElement(Tools, { key: "left", list: tools })
            ),
            import_react40.default.createElement(
              ToolbarRight,
              null,
              import_react40.default.createElement(Tools, { key: "right", list: toolsExtra })
            )
          )
        )
      : null;
  ...
  Tools = import_react40.default.memo(function ({ list }) {
    return import_react40.default.createElement(
      ...
      list
        .filter(Boolean)
        .map(({ render: Render, id, ...t3 }, index) => import_react40.default.createElement(Render, { key: id || t3.key || `f-${index}` }))
    );
  });
...
var Toolbar = newStyled.div(({ theme, shown }) => ({
  ...
  ToolbarLeft = newStyled.div({ display: "flex", whiteSpace: "nowrap", flexBasis: "auto", gap: 6, alignItems: "center" }),
...
var import_qs = __toESM(require_lib()),
  stringifyQueryParams = (queryParams) => import_qs.default.stringify(queryParams, { addQueryPrefix: !0, encode: !1 }).replace(/^\?/, "&");
var getActive = (refId, refs) => (refId && refs[refId] ? `storybook-ref-${refId}` : "storybook-preview-iframe"),
  ...
  styles = { '#root [data-is-storybook="false"]': { display: "none" }, '#root [data-is-storybook="true"]': { display: "block" } },
  FramesRenderer = ({ refs, scale, viewMode = "story", refId, queryParams = {}, baseUrl, storyId = "*" }) => {
    ...
    return (
      frames["storybook-preview-iframe"] ||
        (frames["storybook-preview-iframe"] = getStoryHref(baseUrl, storyId, { ...queryParams, ...(version && { version }), viewMode })),
      ...
      import_react42.default.createElement(
        ...
        Object.entries(frames).map(([id, src]) =>
          import_react42.default.createElement(
            import_react42.Fragment,
            { key: id },
            import_react42.default.createElement(IFrame, { active: id === active, key: id, id, title: id, src, allowFullScreen: !0, scale })
          )
        )
      )
    );
  ...
  Preview = import_react43.default.memo(function (props) {
    ...
    return (
      ...
      import_react43.default.createElement(
        ...
        null,
        previewId === "main" &&
          import_react43.default.createElement(W, { key: "description" }, import_react43.default.createElement("title", null, description)),
        import_react43.default.createElement(
          ZoomProvider,
          { shouldScale },
          import_react43.default.createElement(
            PreviewContainer,
            null,
            import_react43.default.createElement(ToolbarComp, { key: "tools", isShown: showToolbar, tabId, tabs, tools, toolsExtra, api }),
            import_react43.default.createElement(
              FrameWrap,
              { key: "frame" },
              tabContent && import_react43.default.createElement(IframeWrapper, null, tabContent({ active: !0 })),
              import_react43.default.createElement(
                CanvasWrap,
                { show: !tabId },
                import_react43.default.createElement(Canvas, { withLoader, baseUrl, wrappers })
              )
            )
          )
        )
...
var Canvas = ({ baseUrl, withLoader, wrappers }) =>
  import_react43.default.createElement(
    ...
    ({ entry, refs, customCanvas, storyId, refId, viewMode, queryParams, previewInitialized }) => {
      ...
      return import_react43.default.createElement(ZoomConsumer, null, ({ value: scale }) =>
        import_react43.default.createElement(
          ...
          withLoader &&
            ...
            import_react43.default.createElement(
              LoaderWrapper,
              null,
              import_react43.default.createElement(Loader, { id: "preview-loader", role: "progressbar", progress })
            ),
          import_react43.default.createElement(
            ApplyWrappers,
            ...
            customCanvas
              ...
              : import_react43.default.createElement(FramesRenderer, { baseUrl, refs, scale, entry, viewMode, refId, queryParams, storyId })
          )
        )
      );
    }
...
function filterTabs(panels, parameters) {
  ...
  if (previewTabs || parametersTabs) {
    ...
    return panels
      ...
      .map((panel) => {
        let t3 = arrTabs.find((tab) => tab.id === panel.id);
        return t3 ? { ...panel, title: t3.title || panel.title, disabled: t3.disabled, hidden: t3.hidden } : panel;
      });
  }
  return panels;
}
var import_react44 = __toESM(require_react());
var menuMapper3 = ({ api, state }) => ({ isVisible: api.getIsNavShown(), singleStory: state.singleStory, toggle: () => api.toggleNav() }),
  menuTool = {
    title: "menu",
    id: "menu",
    type: typesX.TOOL,
...
var defaultTabs = [createCanvasTab()],
  ...
  memoizedWrapper = (0, import_memoizerific2.default)(1)((_2, previewElements) => [...defaultWrappers, ...Object.values(previewElements)]),
  ...
  mapper = ({ api, state }) => {
    let { layout, location, customQueryParams, storyId, refs, viewMode, path, refId } = state,
      ...
      tools = memoizedTools(toolsList.length, api.getElements(Addon_TypesEnum.TOOL), [entry, viewMode, location, path, tabId]),
    ...
    return {
      ...
      tools,
      toolsExtra,
      tabs: memoizedTabs(tabsList.length, api.getElements(Addon_TypesEnum.TAB), entry ? entry.parameters : void 0, layout.showTabs),
  ...
  PreviewConnected = import_react45.default.memo(function (props) {
    return import_react45.default.createElement(ManagerConsumer, { filter: mapper }, (fromState) =>
      import_react45.default.createElement(Preview, { ...props, ...fromState })
    );
  }),
...
var SafeTab = class extends import_react46.Component {
    ...
    render() {
      let { hasError } = this.state,
        { children } = this.props;
      return hasError ? import_react46.default.createElement("h1", null, "Something went wrong.") : children;
    }
  },
    ...
    ({ panels, shortcuts, actions, selectedPanel = null, panelPosition = "right", absolute = !0 }) => {
      ...
      return import_react46.default.createElement(
            ...
            isDesktop
              ? import_react46.default.createElement(
                  ...
                  import_react46.default.createElement(
                    ...
                    panelPosition === "bottom"
                      ? import_react46.default.createElement(SidebarAltIcon, null)
                      : import_react46.default.createElement(BottomBarIcon, null)
                  ),
                  import_react46.default.createElement(
                    IconButton,
                    {
        ...
        Object.entries(panels).map(([k2, v2]) =>
          import_react46.default.createElement(
            SafeTab,
            { key: k2, id: k2, title: typeof v2.title == "function" ? import_react46.default.createElement(v2.title, null) : v2.title },
            v2.render
          )
        )
      );
...
var createPanelActions = (0, import_memoizerific3.default)(1)((api) => ({
  ...
  getPanels = (api) => {
    ...
    return (
      Object.entries(allPanels).forEach(([id, panel]) => {
        let { paramKey } = panel;
        (paramKey && parameters && parameters[paramKey] && parameters[paramKey].disable) || (filteredPanels[id] = panel);
      }),
      filteredPanels
    );
  },
  ...
  Panel = (props) =>
    import_react47.default.createElement(ManagerConsumer, { filter: mapper2 }, (customProps) =>
      import_react47.default.createElement(AddonPanel, { ...props, ...customProps })
    ),
  Panel_default = Panel;
        ...
        onDrag = (e3) => {
          ...
          setState((state) => {
            ...
            if (draggedElement === panelResizer) {
              let sizeAxisState = state.panelPosition === "bottom" ? "bottomPanelHeight" : "rightPanelWidth",
                panelDragSize = state.panelPosition === "bottom" ? e3.view.innerHeight - e3.clientY : e3.view.innerWidth - e3.clientX;
              ...
              if (state.panelPosition === "right" && panelDragSize <= RIGHT_PANEL_MIN_WIDTH_PX)
                return { ...state, [sizeAxisState]: interpolate(MIN_WIDTH_STIFFNESS, panelDragSize, RIGHT_PANEL_MIN_WIDTH_PX) };
              let sizeAxisMax = state.panelPosition === "bottom" ? e3.view.innerHeight : e3.view.innerWidth;
    ...
    return (
      ...
      (_proto.getTimeouts = function () {
        ...
        return (
          ...
          timeout2 != null &&
            ...
            ((exit = timeout2.exit), (enter = timeout2.enter), (appear = timeout2.appear !== void 0 ? timeout2.appear : enter)),
          { exit, enter, appear }
        );
      }),
      ...
      (_proto.performEnter = function (mounting) {
        var _this2 = this,
          ...
          _ref2 = this.props.nodeRef ? [appearing] : [import_react_dom3.default.findDOMNode(this), appearing],
          maybeNode = _ref2[0],
      ...
      (_proto.performExit = function () {
        var _this3 = this,
          ...
          timeouts = this.getTimeouts(),
          maybeNode = this.props.nodeRef ? void 0 : import_react_dom3.default.findDOMNode(this);
      ...
      (_proto.render = function () {
        ...
        return import_react50.default.createElement(
          ...
          typeof children == "function"
            ...
            : import_react50.default.cloneElement(import_react50.default.Children.only(children), childProps)
        );
      }),
      Transition2
    );
...
var UpgradeBlock = ({ onNavigateToWhatsNew }) => {
    ...
    return import_react51.default.createElement(
      Container3,
      null,
      import_react51.default.createElement("strong", null, "You are on Storybook ", api.getCurrentVersion().version),
      import_react51.default.createElement("p", null, "Run the following script to check for updates and upgrade to the latest version."),
      import_react51.default.createElement(
        Tabs2,
        null,
        import_react51.default.createElement(ButtonTab, { active: activeTab === "npm", onClick: () => setActiveTab("npm") }, "npm"),
        import_react51.default.createElement(ButtonTab, { active: activeTab === "pnpm", onClick: () => setActiveTab("pnpm") }, "pnpm")
      ),
      import_react51.default.createElement(
        Code,
        null,
      ...
      onNavigateToWhatsNew && import_react51.default.createElement(Link22, { onClick: onNavigateToWhatsNew }, "See what's new in Storybook")
    );
  },
      ...
      (state) =>
        import_react52.default.createElement(
          ...
          import_react52.default.createElement(
            ...
            import_react52.default.createElement(
              ...
              import_react52.default.createElement(
                ...
                import_react52.default.createElement("span", null, "Documentation")
              ),
              import_react52.default.createElement(ShareAltIcon, { width: 12 })
            )
          ),
          ...
          import_react52.default.createElement(
            ...
            " ",
            import_react52.default.createElement(Link22, { href: "https://chromatic.com", target: "_blank" }, "Chromatic"),
            " ",
            "and the",
            " ",
            import_react52.default.createElement(
        ...
        (state) =>
          import_react53.default.createElement(
            ...
            import_react53.default.createElement(
              ...
              (sidebarState) => import_react53.default.createElement(SidebarContainer, { ref: sidebarRef, state: sidebarState }, children)
            ),
...
var Container6 = newStyled.div(({ theme }) => ({
  ...
  MobileAddonsDrawer = ({ children }) => import_react54.default.createElement(Container6, null, children);
var useFullStoryName = () => {
    ...
    for (; "parent" in node && node.parent && index[node.parent] && fullStoryName.length < 24; )
      (node = index[node.parent]), (fullStoryName = `${node.renderLabel?.(node, api) || node.name}/${fullStoryName}`);
  ...
  Text2 = newStyled.p({ display: "-webkit-box", WebkitLineClamp: 1, WebkitBoxOrient: "vertical", overflow: "hidden" });
var import_react58 = __toESM(require_react());
var import_react57 = __toESM(require_react());
var import_react56 = __toESM(require_react());
var slideIn = keyframes({ "0%": { opacity: 0, transform: "translateY(30px)" }, "100%": { opacity: 1, transform: "translateY(0)" } }),
      ...
      !icon ||
        import_react56.default.createElement(
          ...
          import_react56.default.isValidElement(icon)
            ...
            : typeof icon == "object" &&
                "name" in icon &&
                import_react56.default.createElement(Icons, { icon: icon.name, color: icon.color || defaultColor })
        ),
      import_react56.default.createElement(
        NotificationTextWrapper,
        null,
        import_react56.default.createElement(Headline, { title: headline, hasIcon: !!icon }, headline),
        subHeadline && import_react56.default.createElement(SubHeadline, null, subHeadline)
      )
    );
  },
  ...
  NotificationItem = ({ notification: { content, duration, link, onClear, onClick, id, icon }, onDismissNotification }) => {
    ...
    (0, import_react56.useEffect)(() => {
      if (duration) return (timer.current = setTimeout(onTimeout, duration)), () => clearTimeout(timer.current);
    }, [duration, onTimeout]);
    ...
    return link
      ? import_react56.default.createElement(
          ...
          import_react56.default.createElement(DismissNotificationItem, { onDismiss })
        )
      : onClick
      ? import_react56.default.createElement(
          NotificationButton,
...
var mapper3 = ({ state, api }) => ({ notifications: state.notifications, clearNotification: api.clearNotification }),
  Notifications = (props) =>
    import_react58.default.createElement(ManagerConsumer, { filter: mapper3 }, (fromState) =>
      import_react58.default.createElement(NotificationList, { ...props, ...fromState })
    );
var MINIMUM_CONTENT_WIDTH_PX = 100,
  ...
  useLayoutSyncingState = ({ managerLayoutState, setManagerLayoutState, isDesktop, hasTab }) => {
    let prevManagerLayoutStateRef = import_react59.default.useRef(managerLayoutState),
      [internalDraggingSizeState, setInternalDraggingSizeState] = (0, import_react59.useState)({ ...managerLayoutState, isDragging: !1 });
    (0, import_react59.useEffect)(() => {
      ...
      (0, import_react59.useLayoutEffect)(() => {
        if (internalDraggingSizeState.isDragging || layoutStateIsEqual(managerLayoutState, internalDraggingSizeState)) return;
        let nextState = {
        ...
        (prevManagerLayoutStateRef.current = { ...prevManagerLayoutStateRef.current, ...nextState }), setManagerLayoutState(nextState);
    ...
    let isPagesShown = managerLayoutState.viewMode !== "story" && managerLayoutState.viewMode !== "docs",
      ...
      { panelResizerRef, sidebarResizerRef } = useDragging({ setState: setInternalDraggingSizeState, isPanelShown, isDesktop }),
  ...
  Layout = ({ managerLayoutState, setManagerLayoutState, hasTab, ...slots }) => {
    let { isDesktop, isMobile } = useLayout(),
      { navSize, rightPanelWidth, bottomPanelHeight, panelPosition, panelResizerRef, sidebarResizerRef, showPages, showPanel, isDragging } =
        useLayoutSyncingState({ managerLayoutState, setManagerLayoutState, isDesktop, hasTab });
    return import_react59.default.createElement(
      ...
      showPages && import_react59.default.createElement(PagesContainer, null, slots.slotPages),
      import_react59.default.createElement(Match, { path: /(^\/story|docs|onboarding\/|^\/$)/, startsWith: !1 }, ({ match }) =>
        import_react59.default.createElement(ContentContainer, { shown: !!match }, slots.slotMain)
      ),
      isDesktop &&
        import_react59.default.createElement(
          ...
          import_react59.default.createElement(
            SidebarContainer2,
            null,
            import_react59.default.createElement(Drag, { ref: sidebarResizerRef }),
            slots.slotSidebar
          ),
          showPanel &&
            import_react59.default.createElement(
      ...
      isMobile && import_react59.default.createElement(MobileNavigation, { menu: slots.slotSidebar, panel: slots.slotPanel, showPanel })
    );
  },
  LayoutContainer = newStyled.div(({ navSize, rightPanelWidth, bottomPanelHeight, viewMode, panelPosition, showPanel }) => ({
    width: "100%",
    height: ["100vh", "100dvh"],
    overflow: "hidden",
    display: "flex",
...
var App = ({ managerLayoutState, setManagerLayoutState, pages, hasTab }) => {
  ...
  return import_react60.default.createElement(
    ...
    import_react60.default.createElement(Layout, {
      ...
      slotMain: import_react60.default.createElement(Preview_default, { id: "main", withLoader: !0 }),
      slotSidebar: import_react60.default.createElement(Sidebar_default, { onMenuClick: () => setMobileAboutOpen((state) => !state) }),
      slotPanel: import_react60.default.createElement(Panel_default, null),
      slotPages: pages.map(({ id, render: Content2 }) => import_react60.default.createElement(Content2, { key: id })),
    })
  );
};
var Provider = class {
...
var Container8 = newStyled.div({ display: "flex", alignItems: "center", flexDirection: "column", marginTop: 40 }),
  ...
  Actions2 = newStyled.div({ display: "flex", flexDirection: "row", alignItems: "center", marginBottom: 24, marginTop: 24, gap: 16 }),
  StyledLink = newStyled(Link22)(({ theme }) => ({
    "&&": { fontWeight: theme.typography.weight.bold, color: theme.base === "light" ? theme.color.dark : theme.color.light },
  ...
  AboutScreen = ({ onNavigateToWhatsNew }) =>
    import_react61.default.createElement(
      Container8,
      null,
      import_react61.default.createElement(Header, null, import_react61.default.createElement(StorybookLogo, { alt: "Storybook" })),
      import_react61.default.createElement(UpgradeBlock, { onNavigateToWhatsNew }),
      import_react61.default.createElement(
        Footer,
        null,
        import_react61.default.createElement(
          ...
          import_react61.default.createElement(
            ...
            import_react61.default.createElement(
              ...
              import_react61.default.createElement(DocumentIcon, { style: { display: "inline", marginRight: 5 } }),
              "Documentation"
            )
          )
        ),
        import_react61.default.createElement(
          ...
          "Open source software maintained by",
          " ",
          import_react61.default.createElement(StyledLink, { href: "https://www.chromatic.com/" }, "Chromatic"),
          " and the",
          " ",
          import_react61.default.createElement(
            StyledLink,
...
var Header2 = newStyled.header(({ theme }) => ({
  ...
  GridWrapper = newStyled.div({ display: "grid", gridTemplateColumns: "1fr", gridAutoRows: "minmax(auto, auto)", marginBottom: 20 }),
  ...
  TextInput = newStyled(Form.Input)(
    ...
    { display: "flex", width: 80, flexDirection: "column", justifySelf: "flex-end", paddingLeft: 4, paddingRight: 4, textAlign: "center" }
  ),
  Fade = keyframes`
0%,100% { opacity: 0; }
  50% { opacity: 1; }
`,
  SuccessIcon = newStyled(CheckIcon)(
    ({ valid, theme }) => (valid === "valid" ? { color: theme.color.positive, animation: `${Fade} 2s ease forwards` } : { opacity: 0 }),
...
var ShortcutsScreen = class extends import_react64.Component {
  constructor(props) {
    ...
    this.onFocus = (focusedInput) => () => {
      ...
      this.setState({ activeFeature: focusedInput, shortcutKeys: { ...shortcutKeys, [focusedInput]: { shortcut: null, error: !1 } } });
    };
    this.onBlur = async () => {
    ...
    this.restoreDefault = async () => {
      ...
      return this.setState({ shortcutKeys: { ...shortcutKeys, ...toShortcutState({ [activeFeature]: defaultShortcut }) } });
    };
    ...
    this.renderKeyInput = () => {
      ...
      return Object.entries(shortcutKeys).map(([feature, { shortcut }]) =>
        import_react64.default.createElement(
          Row,
          { key: feature },
          import_react64.default.createElement(Description, null, shortcutLabels[feature] || addonsShortcutLabels[feature]),
          ...
          import_react64.default.createElement(SuccessIcon, { valid: this.displaySuccessMessage(feature) })
        )
      );
    };
    this.renderKeyForm = () =>
...
var ShortcutsPage = () =>
  import_react65.default.createElement(
    ManagerConsumer,
    null,
    ({ api: { getShortcutKeys, getAddonsShortcutLabels, setShortcut, restoreDefaultShortcut, restoreAllDefaultShortcuts } }) =>
...
var Centered = newStyled.div({ top: "50%", position: "absolute", transform: "translateY(-50%)", width: "100%", textAlign: "center" }),
  ...
  WhatsNewFooter = ({ isNotificationsEnabled, onToggleNotifications, onCopyLink }) => {
    ...
    return import_react66.default.createElement(
      ...
      import_react66.default.createElement(
        ...
        import_react66.default.createElement(HeartIcon, { color: theme.color.mediumdark }),
        import_react66.default.createElement("div", null, "Share this with your team."),
        import_react66.default.createElement(Button, { onClick: copyLink, size: "small", variant: "ghost" }, copyText)
      ),
  ...
  AlertIcon2 = newStyled((props) => import_react66.default.createElement(AlertIcon, { ...props }))(({ theme }) => ({
    color: theme.textMutedColor,
    width: 32,
    height: 32,
    margin: "0 auto",
  ...
  WhatsNewLoader = () =>
    import_react66.default.createElement(
      Centered,
      null,
      import_react66.default.createElement(LoaderWrapper2, null, import_react66.default.createElement(Loader, null)),
  ...
  MaxWaitTimeMessaging = () =>
    import_react66.default.createElement(
      ...
      import_react66.default.createElement(Message2, null, "The page couldn't be loaded. Check your internet connection and try again.")
    ),
  PureWhatsNewScreen = ({ didHitMaxWaitTime, isLoaded, onLoad, url, onCopyLink, onToggleNotifications, isNotificationsEnabled }) =>
    import_react66.default.createElement(
      import_react66.Fragment,
      null,
      !isLoaded && !didHitMaxWaitTime && import_react66.default.createElement(WhatsNewLoader, null),
      didHitMaxWaitTime
        ? import_react66.default.createElement(MaxWaitTimeMessaging, null)
        : import_react66.default.createElement(
            import_react66.default.Fragment,
            null,
            import_react66.default.createElement(Iframe, { isLoaded, onLoad, src: url, title: "What's new?" }),
            import_react66.default.createElement(WhatsNewFooter, { isNotificationsEnabled, onToggleNotifications, onCopyLink })
          )
    ),
  MAX_WAIT_TIME = 1e4,
  WhatsNewScreen = () => {
    let api = useStorybookApi(),
      ...
      [didHitMaxWaitTime, setDidHitMaxWaitTime] = (0, import_react66.useState)(!1);
    if (
    ...
    return import_react66.default.createElement(PureWhatsNewScreen, {
      ...
      onToggleNotifications: () => {
        isNotificationsEnabled
          ? scope.confirm("All update notifications will no longer be shown. Are you sure?") && api.toggleWhatsNewNotifications()
          : api.toggleWhatsNewNotifications();
      },
    });
  };
var WhatsNewPage = () => import_react67.default.createElement(WhatsNewScreen, null);
var { document: document9 } = scope,
  ...
  TabBarButton = import_react68.default.memo(function ({ changeTab, id, title }) {
  ...
  Pages = ({ changeTab, onClose, enableShortcuts = !0, enableWhatsNew }) => (
    import_react68.default.useEffect(() => {
      let handleEscape = (event) => {
        !enableShortcuts ||
          event.repeat ||
          (matchesModifiers(!1, event) && matchesKeyCode("Escape", event) && (event.preventDefault(), onClose()));
      };
    ...
    import_react68.default.createElement(
      ...
      import_react68.default.createElement(
        ...
        import_react68.default.createElement(
          TabBar,
          { role: "tablist" },
          import_react68.default.createElement(TabBarButton, { id: "about", title: "About", changeTab }),
          enableWhatsNew && import_react68.default.createElement(TabBarButton, { id: "whats-new", title: "What's new?", changeTab }),
          import_react68.default.createElement(TabBarButton, { id: "shortcuts", title: "Keyboard shortcuts", changeTab })
        ),
        import_react68.default.createElement(
          IconButton,
      ...
      import_react68.default.createElement(
        ...
        import_react68.default.createElement(Route2, { path: "about" }, import_react68.default.createElement(AboutPage, { key: "about" })),
        import_react68.default.createElement(
          Route2,
          { path: "whats-new" },
          import_react68.default.createElement(WhatsNewPage, { key: "whats-new" })
        ),
        import_react68.default.createElement(
          Route2,
          { path: "shortcuts" },
          import_react68.default.createElement(ShortcutsPage, { key: "shortcuts" })
        )
      )
    )
  ),
...
var Root3 = ({ provider }) =>
  ...
  Main = ({ provider }) => {
    ...
    return import_react69.default.createElement(Location, { key: "location.consumer" }, (locationData) =>
      import_react69.default.createElement(
        ManagerProvider,
...
function renderStorybookUI(domNode, provider) {
  ...
  (0, import_client.createRoot)(domNode).render(import_react69.default.createElement(Root3, { key: "root", provider }));
}
