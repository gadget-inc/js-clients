...
import { __commonJS, __export, __export2, __toESM, require_memoizerific } from "./chunk-ZR5JZWHI.js";
    ...
    var errorProto,
      ...
      getBaseIntrinsic = function (name2, allowMissing) {
        var intrinsicName = name2,
          alias;
        if (
          (hasOwn(LEGACY_ALIASES, intrinsicName) && ((alias = LEGACY_ALIASES[intrinsicName]), (intrinsicName = "%" + alias[0] + "%")),
...
var require_object_inspect = __commonJS({
  "../../node_modules/object-inspect/index.js"(exports, module) {
    var hasMap = typeof Map == "function" && Map.prototype,
      ...
      toStringTag =
        typeof Symbol == "function" && Symbol.toStringTag && (typeof Symbol.toStringTag === hasShammedSymbols || !0)
          ? Symbol.toStringTag
          : null,
    ...
    module.exports = function inspect_(obj, options2, depth, seen) {
      ...
      function inspect(value2, from, noIndent) {
        if ((from && ((seen = $arrSlice.call(seen)), seen.push(from)), noIndent)) {
          ...
          return has3(opts, "quoteStyle") && (newOpts.quoteStyle = opts.quoteStyle), inspect_(value2, newOpts, depth + 1, seen);
        }
      ...
      if (typeof obj == "function" && !isRegExp(obj)) {
        ...
        return (
          "[Function" + (name2 ? ": " + name2 : " (anonymous)") + "]" + (keys2.length > 0 ? " { " + $join.call(keys2, ", ") + " }" : "")
        );
      }
      if (isSymbol2(obj)) {
        ...
        var ys = arrObjKeys(obj, inspect),
          ...
          stringTag =
            !isPlainObject && toStringTag && Object(obj) === obj && toStringTag in obj
              ...
              : "",
          constructorTag =
            isPlainObject || typeof obj.constructor != "function" ? "" : obj.constructor.name ? obj.constructor.name + " " : "",
          tag =
            constructorTag +
    ...
    var GetIntrinsic = require_get_intrinsic(),
      ...
      listGetNode = function (list, key2) {
        for (var prev = list, curr; (curr = prev.next) !== null; prev = curr)
          if (curr.key === key2) return (prev.next = curr.next), (curr.next = list.next), (list.next = curr), curr;
      },
...
var require_utils = __commonJS({
  "../../node_modules/qs/lib/utils.js"(exports, module) {
    ...
    var formats = require_formats(),
      ...
      compactQueue = function (queue) {
        for (; queue.length > 1; ) {
          ...
          if (isArray2(obj)) {
            for (var compacted = [], j = 0; j < obj.length; ++j) typeof obj[j] < "u" && compacted.push(obj[j]);
            item.obj[item.prop] = compacted;
          }
        }
      },
      arrayToObject = function (source2, options2) {
        for (var obj = options2 && options2.plainObjects ? Object.create(null) : {}, i = 0; i < source2.length; ++i)
      ...
      merge = function merge2(target, source2, options2) {
        ...
        if (typeof source2 != "object") {
          if (isArray2(target)) target.push(source2);
            ...
            ((options2 && (options2.plainObjects || options2.allowPrototypes)) || !has3.call(Object.prototype, source2)) &&
              (target[source2] = !0);
        ...
        return (
          ...
          isArray2(target) && isArray2(source2)
            ...
            : Object.keys(source2).reduce(function (acc, key2) {
                ...
                return has3.call(acc, key2) ? (acc[key2] = merge2(acc[key2], value2, options2)) : (acc[key2] = value2), acc;
              }, mergeTarget)
        );
      },
      ...
      encode = function (str, defaultEncoder, charset, kind, format2) {
        ...
        var string = str;
        if (
          (typeof str == "symbol" ? (string = Symbol.prototype.toString.call(str)) : typeof str != "string" && (string = String(str)),
          charset === "iso-8859-1")
        )
      ...
      compact = function (value2) {
        for (var queue = [{ obj: { o: value2 }, prop: "o" }], refs2 = [], i = 0; i < queue.length; ++i)
          for (var item = queue[i], obj = item.obj[item.prop], keys2 = Object.keys(obj), j = 0; j < keys2.length; ++j) {
            var key2 = keys2[j],
              val = obj[key2];
            typeof val == "object" && val !== null && refs2.indexOf(val) === -1 && (queue.push({ obj, prop: key2 }), refs2.push(val));
          }
    ...
    module.exports = { arrayToObject, assign, combine, compact, decode, encode, isBuffer, isRegExp, maybeMap, merge };
  },
});
  ...
  "../../node_modules/qs/lib/stringify.js"(exports, module) {
    ...
    var getSideChannel = require_side_channel(),
      ...
      stringify2 = function stringify3(
        ...
        for (
          var adjustedPrefix = commaRoundTrip && isArray2(obj) && obj.length === 1 ? prefix2 + "[]" : prefix2, j = 0;
          j < objKeys.length;
          ++j
        ) {
          var key2 = objKeys[j],
      ...
      normalizeStringifyOptions = function (opts) {
        ...
        if (typeof opts.format < "u") {
          if (!has3.call(formats.formatters, opts.format)) throw new TypeError("Unknown format option provided.");
          format2 = opts.format;
        }
    ...
    module.exports = function (object, opts) {
      ...
      return (
        options2.charsetSentinel &&
          (options2.charset === "iso-8859-1" ? (prefix2 += "utf8=%26%2310003%3B&") : (prefix2 += "utf8=%E2%9C%93&")),
  ...
  "../../node_modules/qs/lib/parse.js"(exports, module) {
    ...
    var utils = require_utils(),
        ...
        for (i = 0; i < parts.length; ++i)
          if (i !== skipIndex) {
            var part = parts[i],
              ...
              val;
            pos === -1
              ? ((key2 = options2.decoder(part, defaults.decoder, charset, "key")), (val = options2.strictNullHandling ? null : ""))
              ...
              val && options2.interpretNumericEntities && charset === "iso-8859-1" && (val = interpretNumericEntities(val)),
      ...
      parseObject = function (chain, val, options2, valuesParsed) {
        for (var leaf = valuesParsed ? val : parseArrayValue(val, options2), i = chain.length - 1; i >= 0; --i) {
          var obj,
            root3 = chain[i];
      ...
      parseKeys = function (givenKey, val, options2, valuesParsed) {
        if (givenKey) {
          var key2 = options2.allowDots ? givenKey.replace(/\.([^.[]+)/g, "[$1]") : givenKey,
            ...
            keys2 = [];
          if (parent) {
            if (!options2.plainObjects && has3.call(Object.prototype, parent) && !options2.allowPrototypes) return;
            keys2.push(parent);
          }
          for (var i = 0; options2.depth > 0 && (segment = child.exec(key2)) !== null && i < options2.depth; ) {
            if (((i += 1), !options2.plainObjects && has3.call(Object.prototype, segment[1].slice(1, -1)) && !options2.allowPrototypes))
              return;
            keys2.push(segment[1]);
          }
          return segment && keys2.push("[" + key2.slice(segment.index) + "]"), parseObject(keys2, val, options2, valuesParsed);
        }
      },
      normalizeParseOptions = function (opts) {
        ...
        return {
          ...
          interpretNumericEntities:
            typeof opts.interpretNumericEntities == "boolean" ? opts.interpretNumericEntities : defaults.interpretNumericEntities,
...
var require_mapCacheClear = __commonJS({
  "../../node_modules/lodash/_mapCacheClear.js"(exports, module) {
    ...
    function mapCacheClear2() {
      (this.size = 0), (this.__data__ = { hash: new Hash2(), map: new (Map3 || ListCache2)(), string: new Hash2() });
    }
  ...
  "../../node_modules/lodash/_stackSet.js"(exports, module) {
    ...
    function stackSet(key2, value2) {
      ...
      if (data instanceof ListCache2) {
        ...
        if (!Map3 || pairs.length < LARGE_ARRAY_SIZE - 1) return pairs.push([key2, value2]), (this.size = ++data.size), this;
  ...
  "../../node_modules/lodash/_createBaseFor.js"(exports, module) {
    function createBaseFor(fromRight) {
      return function (object, iteratee, keysFunc) {
        for (var index3 = -1, iterable = Object(object), props = keysFunc(object), length = props.length; length--; ) {
...
var require_safeGet = __commonJS({
  "../../node_modules/lodash/_safeGet.js"(exports, module) {
    function safeGet(object, key2) {
      if (!(key2 === "constructor" && typeof object[key2] == "function") && key2 != "__proto__") return object[key2];
    }
...
var require_assignValue = __commonJS({
  "../../node_modules/lodash/_assignValue.js"(exports, module) {
    ...
    function assignValue(object, key2, value2) {
      ...
      (!(hasOwnProperty5.call(object, key2) && eq2(objValue, value2)) || (value2 === void 0 && !(key2 in object))) &&
        baseAssignValue(object, key2, value2);
    }
  ...
  "../../node_modules/lodash/_isIndex.js"(exports, module) {
    ...
    function isIndex(value2, length) {
      ...
      return (
        ...
        !!length && (type == "number" || (type != "symbol" && reIsUint.test(value2))) && value2 > -1 && value2 % 1 == 0 && value2 < length
      );
    }
  ...
  "../../node_modules/lodash/_baseKeysIn.js"(exports, module) {
    ...
    function baseKeysIn(object) {
      ...
      var isProto = isPrototype(object),
        result2 = [];
      for (var key2 in object) (key2 == "constructor" && (isProto || !hasOwnProperty5.call(object, key2))) || result2.push(key2);
      return result2;
    }
          ...
          isArr || isBuff || isTyped
            ...
            ? ((newValue = objValue),
              isArguments(objValue)
                ...
                : (!isObject4(objValue) || isFunction2(objValue)) && (newValue = initCloneObject(srcValue)))
            : (isCommon = !1);
      }
  ...
  "../../node_modules/lodash/_overRest.js"(exports, module) {
    ...
    function overRest(func, start, transform) {
      return (
        ...
        function () {
          for (var args2 = arguments, index3 = -1, length = nativeMax(args2.length - start, 0), array = Array(length); ++index3 < length; )
...
var require_isIterateeCall = __commonJS({
  "../../node_modules/lodash/_isIterateeCall.js"(exports, module) {
    ...
    function isIterateeCall(value2, index3, object) {
      ...
      return (type == "number" ? isArrayLike(object) && isIndex(index3, object.length) : type == "string" && index3 in object)
      ...
      return baseRest(function (object, sources) {
        ...
        for (
          customizer = assigner.length > 3 && typeof customizer == "function" ? (length--, customizer) : void 0,
            guard2 && isIterateeCall(sources[0], sources[1], guard2) && ((customizer = length < 3 ? void 0 : customizer), (length = 1)),
      ...
      var _ = {
          ...
          storeAPI: {
            ...
            setAll: function (data, overwrite) {
              var changed, val;
              for (var key2 in data) (val = data[key2]), this.set(key2, val, overwrite) !== val && (changed = !0);
              return changed;
            },
            ...
            _out: function (k2) {
              return this._ns ? (k2 && k2.indexOf(this._ns) === 0 ? k2.substring(this._ns.length) : void 0) : k2;
            },
          },
...
var require_arrayPush = __commonJS({
  "../../node_modules/lodash/_arrayPush.js"(exports, module) {
    function arrayPush(array, values) {
      for (var index3 = -1, length = values.length, offset = array.length; ++index3 < length; ) array[offset + index3] = values[index3];
      return array;
    }
...
var require_arrayFilter = __commonJS({
  "../../node_modules/lodash/_arrayFilter.js"(exports, module) {
    function arrayFilter(array, predicate) {
      for (var index3 = -1, length = array == null ? 0 : array.length, resIndex = 0, result2 = []; ++index3 < length; ) {
...
var require_baseKeys = __commonJS({
  "../../node_modules/lodash/_baseKeys.js"(exports, module) {
    ...
    function baseKeys(object) {
      ...
      var result2 = [];
      for (var key2 in Object(object)) hasOwnProperty5.call(object, key2) && key2 != "constructor" && result2.push(key2);
      return result2;
    }
  ...
  "../../node_modules/lodash/_matchesStrictComparable.js"(exports, module) {
    function matchesStrictComparable(key2, srcValue) {
      return function (object) {
        return object == null ? !1 : object[key2] === srcValue && (srcValue !== void 0 || key2 in Object(object));
      };
    }
  ...
  "../../node_modules/lodash/_isKey.js"(exports, module) {
    ...
    function isKey2(value2, object) {
      ...
      return type == "number" || type == "symbol" || type == "boolean" || value2 == null || isSymbol2(value2)
        ? !0
        : reIsPlainProp2.test(value2) || !reIsDeepProp2.test(value2) || (object != null && value2 in Object(object));
    }
...
var require_memoize = __commonJS({
  "../../node_modules/lodash/memoize.js"(exports, module) {
    ...
    function memoize6(func, resolver) {
      if (typeof func != "function" || (resolver != null && typeof resolver != "function")) throw new TypeError(FUNC_ERROR_TEXT2);
...
var require_baseGet = __commonJS({
  "../../node_modules/lodash/_baseGet.js"(exports, module) {
    ...
    function baseGet2(object, path) {
      ...
      for (var index3 = 0, length = path.length; object != null && index3 < length; ) object = object[toKey2(path[index3++])];
...
var require_baseSet = __commonJS({
  "../../node_modules/lodash/_baseSet.js"(exports, module) {
    ...
    function baseSet(object, path, value2, customizer) {
      ...
      path = castPath2(path, object);
      for (var index3 = -1, length = path.length, lastIndex = length - 1, nested = object; nested != null && ++index3 < length; ) {
        var key2 = toKey2(path[index3]),
          newValue = value2;
        ...
        if (index3 != lastIndex) {
          ...
          (newValue = customizer ? customizer(objValue, key2, nested) : void 0),
            newValue === void 0 && (newValue = isObject4(objValue) ? objValue : isIndex(path[index3 + 1]) ? [] : {});
        }
...
var import_memoizerific = __toESM(require_memoizerific(), 1),
  ...
  __toESM2 = (mod, isNodeMode, target) => (
    ...
    __copyProps(isNodeMode || !mod || !mod.__esModule ? __defProp(target, "default", { value: mod, enumerable: !0 }) : target, mod)
  ),
...
function dequal(foo, bar) {
  ...
  if (foo && bar && (ctor = foo.constructor) === bar.constructor) {
    ...
    if (ctor === Map) {
      if (foo.size !== bar.size) return !1;
      for (len of foo)
        if (((tmp = len[0]), (tmp && typeof tmp == "object" && ((tmp = find(bar, tmp)), !tmp)) || !dequal(len[1], bar.get(tmp)))) return !1;
      return !0;
    }
...
var splitPathRegex = /\/([^/]+)\/(?:(.*)_)?([^/]+)?/,
  ...
  deepDiff = (value2, update2) => {
    ...
    if (Array.isArray(value2) && Array.isArray(update2)) {
      ...
      return update2.length >= value2.length ? res : res.concat(new Array(value2.length - update2.length).fill(void 0));
    }
  ...
  validateArgs = (key2 = "", value2) =>
    key2 === null || key2 === "" || !VALIDATION_REGEXP.test(key2)
      ...
      ? !0
      : typeof value2 == "string"
      ? VALIDATION_REGEXP.test(value2) || NUMBER_REGEXP.test(value2) || HEX_REGEXP.test(value2) || COLOR_REGEXP.test(value2)
  ...
  encodeSpecialValues = (value2) =>
    value2 === void 0
      ...
      : (0, import_isPlainObject.default)(value2)
      ? Object.entries(value2).reduce((acc, [key2, val]) => Object.assign(acc, { [key2]: encodeSpecialValues(val) }), {})
      : value2,
  QS_OPTIONS = { encode: !1, delimiter: ";", allowDots: !0, format: "RFC1738", serializeDate: (date) => `!date(${date.toISOString()})` },
    ...
    (_extends3 = Object.assign
      ...
      : function (target) {
          for (var i = 1; i < arguments.length; i++) {
            ...
            for (var key2 in source2) Object.prototype.hasOwnProperty.call(source2, key2) && (target[key2] = source2[key2]);
          }
          return target;
        }),
...
function createBrowserHistory(options2) {
  ...
  index3 == null && ((index3 = 0), globalHistory.replaceState(_extends3({}, globalHistory.state, { idx: index3 }), ""));
  ...
  function getNextLocation(to, state) {
    return (
      ...
      readOnly(
        _extends3({ pathname: location3.pathname, hash: "", search: "" }, typeof to == "string" ? parsePath2(to) : to, {
          state,
          key: createKey(),
        })
      )
  ...
  function applyTx(nextAction) {
    ...
    (index3 = _getIndexAndLocation3[0]), (location3 = _getIndexAndLocation3[1]), listeners.call({ action, location: location3 });
  }
...
function Router(_ref3) {
  ...
  useInRouterContext() &&
    invariant(!1, "You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");
  ...
  return (
    ...
    location3 == null
      ...
      : (0, import_react.createElement)(
          ...
          (0, import_react.createElement)(LocationContext.Provider, { children, value: { location: location3, navigationType } })
        )
  );
}
function useHref(to) {
...
function _objectWithoutPropertiesLoose2(source2, excluded) {
  ...
  var target = {},
    ...
    key2,
    i;
  for (i = 0; i < sourceKeys.length; i++) (key2 = sourceKeys[i]), !(excluded.indexOf(key2) >= 0) && (target[key2] = source2[key2]);
  return target;
}
...
var NavLink = (0, import_react.forwardRef)(function (_ref4, ref) {
  ...
  return (0, import_react.createElement)(Link, _extends22({}, rest, { "aria-current": ariaCurrent, className, ref, style, to }));
});
...
var { document: document2 } = scope2,
  ...
  Link2 = ({ to, children, ...rest }) => import_react.default.createElement(Link, { to: `${getBase()}path=${to}`, ...rest }, children);
...
var Location = ({ children }) => {
  ...
  return import_react.default.createElement(
    ...
    null,
    children({ path: path || "/", location: location3, viewMode, storyId, refId, singleStory: singleStory === "true" })
  );
};
...
var __create2 = Object.create,
  ...
  __toESM3 = (mod, isNodeMode, target) => (
    ...
    __copyProps2(isNodeMode || !mod || !mod.__esModule ? __defProp2(target, "default", { value: mod, enumerable: !0 }) : target, mod)
  ),
  eventProperties = [
    "bubbles",
    "cancelBubble",
    ...
    "node_modules/get-intrinsic/index.js"(exports, module) {
      ...
      var throwTypeError = function () {
        ...
        INTRINSICS = {
          ...
          "%JSON%": typeof JSON == "object" ? JSON : undefined2,
          "%Map%": typeof Map > "u" ? undefined2 : Map,
          "%MapIteratorPrototype%": typeof Map > "u" || !hasSymbols ? undefined2 : getProto(new Map()[Symbol.iterator]()),
          "%Math%": Math,
          "%Number%": Number,
          "%Object%": Object,
          "%parseFloat%": parseFloat,
          ...
          "%RegExp%": RegExp,
          "%Set%": typeof Set > "u" ? undefined2 : Set,
          "%SetIteratorPrototype%": typeof Set > "u" || !hasSymbols ? undefined2 : getProto(new Set()[Symbol.iterator]()),
          "%SharedArrayBuffer%": typeof SharedArrayBuffer > "u" ? undefined2 : SharedArrayBuffer,
          "%String%": String,
    ...
    "node_modules/is-function/index.js"(exports, module) {
      ...
      function isFunction3(fn) {
        ...
        return (
          ...
          (typeof window < "u" && (fn === window.setTimeout || fn === window.alert || fn === window.confirm || fn === window.prompt))
        );
      }
    },
  }),
...
function hashSet(key2, value2) {
  var data = this.__data__;
  return (this.size += this.has(key2) ? 0 : 1), (data[key2] = nativeCreate_default && value2 === void 0 ? HASH_UNDEFINED2 : value2), this;
}
...
function mapCacheClear() {
  (this.size = 0),
    (this.__data__ = { hash: new Hash_default(), map: new (Map_default || ListCache_default)(), string: new Hash_default() });
}
...
function castPath(value2, object) {
  return isArray_default(value2) ? value2 : isKey_default(value2, object) ? [value2] : stringToPath_default(toString_default(value2));
}
...
function baseGet(object, path) {
  ...
  for (var index3 = 0, length = path.length; object != null && index3 < length; ) object = object[toKey_default(path[index3++])];
  return index3 && index3 == length ? object : void 0;
}
...
function convertUnconventionalData(data) {
  ...
  let result2 = data,
    wasMutated = !1;
  return (
    typeof Event < "u" && data instanceof Event && ((result2 = extractEventHiddenProperties(result2)), (wasMutated = !0)),
...
var replacer = function (options2) {
    ...
    return function (key2, value2) {
      try {
        if (key2 === "") return (keys2 = []), (objects = new Map([[value2, "[]"]])), (map2 = new Map()), (stack = []), value2;
        ...
        if (typeof value2 == "number")
          return value2 === -1 / 0 ? "_-Infinity_" : value2 === 1 / 0 ? "_Infinity_" : Number.isNaN(value2) ? "_NaN_" : value2;
        if (typeof value2 == "bigint") return `_bigint_${value2.toString()}`;
        if (typeof value2 == "string") return dateFormat.test(value2) ? (options2.allowDate ? `_date_${value2}` : void 0) : value2;
        if ((0, import_is_regex.default)(value2)) return options2.allowRegExp ? `_regexp_${value2.flags}|${value2.source}` : void 0;
        if ((0, import_is_function.default)(value2)) {
          if (!options2.allowFunction) return;
          let { name: name2 } = value2,
            stringified = value2.toString();
          return stringified.match(/(\[native code\]|WEBPACK_IMPORTED_MODULE|__webpack_exports__|__webpack_require__)/)
        ...
        if (stack.length >= options2.maxDepth) return Array.isArray(value2) ? `[Array(${value2.length})]` : "[Object]";
      ...
      if (
        (key === "" &&
          ...
          refs.forEach(({ target, container, replacement }) => {
            ...
            replacementArr.length === 0 ? (container[target] = root) : (container[target] = get_default(root, replacementArr));
          })),
    ...
    return function mutateUndefined(value2) {
      isObject3(value2) &&
        Object.entries(value2).forEach(([k2, v]) => {
          v === "_undefined_" ? (value2[k2] = void 0) : mutated.get(v) || (mutated.set(v, !0), mutateUndefined(v));
        }),
        Array.isArray(value2) &&
  ...
  PostMessageTransport = class {
    constructor(config) {
      if (
        ...
        (this.connected = !1),
        (this.buffer = []),
        typeof scope?.addEventListener == "function" && scope.addEventListener("message", this.handleEvent.bind(this), !1),
    ...
    setHandler(handler) {
      this.handler = (...args2) => {
        handler.apply(this, args2), !this.connected && this.getLocalFrame().length && (this.flush(), (this.connected = !0));
      };
    }
    send(event, options2) {
      let {
    ...
    getFrames(target) {
      if (this.config.page === "manager") {
        let list = Array.from(document22.querySelectorAll("iframe[data-is-storybook][data-is-loaded]")).flatMap((e) => {
          try {
    ...
    getCurrentFrames() {
      return this.config.page === "manager"
        ? Array.from(document22.querySelectorAll('[data-is-storybook="true"]')).flatMap((e) => (e.contentWindow ? [e.contentWindow] : []))
        : scope && scope.parent
        ? [scope.parent]
        : [];
    }
    getLocalFrame() {
      return this.config.page === "manager"
        ? Array.from(document22.querySelectorAll("#storybook-preview-iframe")).flatMap((e) => (e.contentWindow ? [e.contentWindow] : []))
        : scope && scope.parent
        ? [scope.parent]
        : [];
    }
    handleEvent(rawEvent) {
      try {
        let { data } = rawEvent,
          { key: key2, event, refId } = typeof data == "string" && isJSON(data) ? parse(data, scope.CHANNEL_OPTIONS || {}) : data;
        if (key2 === KEY) {
          let pageString =
...
var B = Object.create,
  ...
  I = (r, e, n, t) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let a of F(e)) !w.call(r, a) && a !== n && u(r, a, { get: () => e[a], enumerable: !(t = C(e, a)) || t.enumerable });
    return r;
  },
  k = (r, e, n) => ((n = r != null ? B(h(r)) : {}), I(e || !r || !r.__esModule ? u(n, "default", { value: r, enumerable: !0 }) : n, r)),
  x = E((T) => {
          ...
          return (function i(o, s, d) {
            ...
            switch (l.slice(8, -1)) {
              ...
              case "Array":
                ...
                for (p = 0; p < o.length; p++) if ((p in o || p in s) && (p in o != p in s || !i(o[p], s[p], d))) return !1;
                return !0;
              case "Object":
                return i(e(o), e(s), d);
              default:
...
function dequal2(foo, bar) {
  ...
  if (foo && bar && (ctor = foo.constructor) === bar.constructor) {
    ...
    if (ctor === Set) {
      if (foo.size !== bar.size) return !1;
      for (len of foo) if (((tmp = len), (tmp && typeof tmp == "object" && ((tmp = find2(bar, tmp)), !tmp)) || !bar.has(tmp))) return !1;
      return !0;
    }
    if (ctor === Map) {
      if (foo.size !== bar.size) return !1;
      for (len of foo)
        if (((tmp = len[0]), (tmp && typeof tmp == "object" && ((tmp = find2(bar, tmp)), !tmp)) || !dequal2(len[1], bar.get(tmp))))
          return !1;
      return !0;
    }
    if (ctor === ArrayBuffer) (foo = new Uint8Array(foo)), (bar = new Uint8Array(bar));
    ...
    if (!ctor || typeof foo == "object") {
      len = 0;
      for (ctor in foo)
        if ((has2.call(foo, ctor) && ++len && !has2.call(bar, ctor)) || !(ctor in bar) || !dequal2(foo[ctor], bar[ctor])) return !1;
      return Object.keys(bar).length === len;
    }
  }
  return foo !== foo && bar !== bar;
...
var React33 = __toESM(require_react(), 1),
  ...
  PhotoIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
  ...
  PhotoDragIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 14 15", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement("path", {
        fillRule: "evenodd",
        clipRule: "evenodd",
      ...
      React33.createElement("path", { d: "M0 10.004v-3h1v3H0zM0 13.504v-2.5h1v2h2v1H.5a.5.5 0 01-.5-.5zM7 14.004H4v-1h3v1z", fill: color2 })
    )
  ),
  ...
  GrowIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement("path", { d: "M1.5 1.004a.5.5 0 100 1H12v10.5a.5.5 0 001 0v-10.5a1 1 0 00-1-1H1.5z", fill: color2 }),
      React33.createElement("path", {
  ...
  StopIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement("path", { d: "M4.5 4a.5.5 0 00-.5.5v5a.5.5 0 00.5.5h5a.5.5 0 00.5-.5v-5a.5.5 0 00-.5-.5h-5z", fill: color2 }),
      React33.createElement("path", {
        fillRule: "evenodd",
        clipRule: "evenodd",
  ...
  MoonIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement(
        "g",
      ...
      React33.createElement(
        ...
        React33.createElement(
          ...
          React33.createElement("path", { fill: "#fff", transform: "scale(1.07124)", d: "M0 0h14.001v14.002H0z" })
        )
      )
    )
  ),
  ...
  PlusIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement("path", { d: "M7.5.5a.5.5 0 00-1 0v6h-6a.5.5 0 000 1h6v6a.5.5 0 001 0v-6h6a.5.5 0 000-1h-6v-6z", fill: color2 })
    )
  ),
  ...
  LockIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 14 15", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement("path", { d: "M8 8.004a1 1 0 01-.5.866v1.634a.5.5 0 01-1 0V8.87A1 1 0 118 8.004z", fill: color2 }),
      React33.createElement("path", {
        fillRule: "evenodd",
        clipRule: "evenodd",
  ...
  RSSIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      ...
      React33.createElement("path", { d: "M1.5 4.5A.5.5 0 012 4a8 8 0 018 8 .5.5 0 01-1 0 7 7 0 00-7-7 .5.5 0 01-.5-.5z", fill: color2 }),
      React33.createElement("path", {
        fillRule: "evenodd",
        clipRule: "evenodd",
  ...
  BasketIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement("path", { d: "M10.354 2.854a.5.5 0 10-.708-.708l-3 3a.5.5 0 10.708.708l3-3z", fill: color2 }),
      React33.createElement("path", {
  ...
  ChevronSmallRightIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement("path", {
  ...
  TimeIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement("path", { d: "M7 2a.5.5 0 01.5.5v4H10a.5.5 0 010 1H7a.5.5 0 01-.5-.5V2.5A.5.5 0 017 2z", fill: color2 }),
      React33.createElement("path", {
        fillRule: "evenodd",
        clipRule: "evenodd",
        d: "M7 14A7 7 0 107 0a7 7 0 000 14zm0-1A6 6 0 107 1a6 6 0 000 12z",
  ...
  AccessibilityAltIcon = React33.forwardRef(({ color: color2 = "currentColor", size = 14, ...props }, forwardedRef) =>
    React33.createElement(
      "svg",
      { width: size, height: size, viewBox: "0 0 15 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", ref: forwardedRef, ...props },
      React33.createElement("path", {
        fillRule: "evenodd",
        clipRule: "evenodd",
...
var __create3 = Object.create,
  ...
  __toESM4 = (mod, isNodeMode, target) => (
    ...
    __copyProps3(isNodeMode || !mod || !mod.__esModule ? __defProp3(target, "default", { value: mod, enumerable: !0 }) : target, mod)
  ),
  ...
  require_re = __commonJS4({
    "../../node_modules/semver/internal/re.js"(exports, module) {
      ...
      createToken("NUMERICIDENTIFIER", "0|[1-9]\\d*"),
        ...
        createToken(
          "XRANGEPLAINLOOSE",
          `[v=\\s]*(${src[t.XRANGEIDENTIFIERLOOSE]})(?:\\.(${src[t.XRANGEIDENTIFIERLOOSE]})(?:\\.(${src[t.XRANGEIDENTIFIERLOOSE]})(?:${
  ...
  require_parse_options = __commonJS4({
    "../../node_modules/semver/internal/parse-options.js"(exports, module) {
      var looseOption = Object.freeze({ loose: !0 }),
        ...
        parseOptions = (options2) => (options2 ? (typeof options2 != "object" ? looseOption : options2) : emptyOpts);
        ...
        SemVer = class _SemVer {
          constructor(version2, options2) {
            if (((options2 = parseOptions(options2)), version2 instanceof _SemVer)) {
              if (version2.loose === !!options2.loose && version2.includePrerelease === !!options2.includePrerelease) return version2;
          ...
          comparePre(other) {
            if (
              (other instanceof _SemVer || (other = new _SemVer(other, this.options)), this.prerelease.length && !other.prerelease.length)
            )
              return -1;
    ...
    "../../node_modules/semver/functions/inc.js"(exports, module) {
      var SemVer = require_semver(),
        inc = (version2, release, options2, identifier, identifierBase) => {
          typeof options2 == "string" && ((identifierBase = identifier), (identifier = options2), (options2 = void 0));
          try {
            return new SemVer(version2 instanceof SemVer ? version2.version : version2, options2).inc(release, identifier, identifierBase)
              .version;
          } catch {
            return null;
          }
    ...
    "../../node_modules/semver/functions/coerce.js"(exports, module) {
      var SemVer = require_semver(),
        ...
        coerce = (version2, options2) => {
          ...
          options2 = options2 || {};
          let match = null;
          if (!options2.rtl) match = version2.match(options2.includePrerelease ? re[t.COERCEFULL] : re[t.COERCE]);
          else {
          ...
          return parse22(`${major}.${minor}.${patch}${prerelease}${build}`, options2);
        };
  ...
  require_yallist = __commonJS4({
    "../../node_modules/yallist/yallist.js"(exports, module) {
      ...
      function insert(self2, node, value2) {
        ...
        return (
          inserted.next === null && (self2.tail = inserted), inserted.prev === null && (self2.head = inserted), self2.length++, inserted
        );
      }
    ...
    "../../node_modules/semver/node_modules/lru-cache/index.js"(exports, module) {
      var Yallist = require_yallist(),
        ...
        LRUCache = class {
          ...
          dump() {
            return this[LRU_LIST].map((hit) => (isStale(this, hit) ? !1 : { k: hit.key, v: hit.value, e: hit.now + (hit.maxAge || 0) }))
              .toArray()
              .filter((h2) => h2);
          }
          dumpLru() {
          ...
          set(key2, value2, maxAge) {
            ...
            return hit.length > this[MAX]
              ...
              : ((this[LENGTH] += hit.length), this[LRU_LIST].unshift(hit), this[CACHE].set(key2, this[LRU_LIST].head), trim(this), !0);
          }
          has(key2) {
        ...
        Entry = class {
          constructor(key2, value2, length, now, maxAge) {
            (this.key = key2), (this.value = value2), (this.length = length), (this.now = now), (this.maxAge = maxAge || 0);
          }
        },
      ...
      var Range = class _Range {
        constructor(range, options2) {
          if (((options2 = parseOptions(options2)), range instanceof _Range))
            return range.loose === !!options2.loose && range.includePrerelease === !!options2.includePrerelease
              ? range
          ...
          if (this.set.length > 1) {
            ...
            if (((this.set = this.set.filter((c2) => !isNullSet(c2[0]))), this.set.length === 0)) this.set = [first];
        ...
        parseRange(range) {
          ...
          loose &&
            (rangeList = rangeList.filter(
              (comp) => (debug("loose invalid filter", comp, this.options), !!comp.match(re[t.COMPARATORLOOSE]))
            )),
              ...
              range.set.some(
                (rangeComparators) =>
                  ...
                  thisComparators.every((thisComparator) =>
                    rangeComparators.every((rangeComparator) => thisComparator.intersects(rangeComparator, options2))
                  )
              )
          );
        }
        test(version2) {
          ...
          for (let i = 0; i < this.set.length; i++) if (testSet(this.set[i], version2, this.options)) return !0;
          return !1;
        }
      };
      ...
      var LRU = require_lru_cache(),
        ...
        isSatisfiable = (comparators, options2) => {
          ...
          for (; result2 && remainingComparators.length; )
            (result2 = remainingComparators.every((otherComparator) => testComparator.intersects(otherComparator, options2))),
              (testComparator = remainingComparators.pop());
          return result2;
        },
            ...
            return (
              ...
              xM
                ...
                ? (xm && (m2 = 0),
                  (p = 0),
                  gtlt === ">"
                    ? ((gtlt = ">="), xm ? ((M = +M + 1), (m2 = 0), (p = 0)) : ((m2 = +m2 + 1), (p = 0)))
        ...
        replaceStars = (comp, options2) => (debug("replaceStars", comp, options2), comp.trim().replace(re[t.STAR], "")),
        replaceGTE0 = (comp, options2) => (
          debug("replaceGTE0", comp, options2), comp.trim().replace(re[options2.includePrerelease ? t.GTE0PRE : t.GTE0], "")
        ),
          ...
          if (version2.prerelease.length && !options2.includePrerelease) {
            for (let i = 0; i < set2.length; i++)
              if ((debug(set2[i].semver), set2[i].semver !== Comparator.ANY && set2[i].semver.prerelease.length > 0)) {
                ...
                if (allowed.major === version2.major && allowed.minor === version2.minor && allowed.patch === version2.patch) return !0;
              }
            return !1;
          }
          return !0;
    ...
    "../../node_modules/semver/classes/comparator.js"(exports, module) {
      var ANY = Symbol("SemVer ANY"),
        Comparator = class _Comparator {
          ...
          test(version2) {
            if ((debug("Comparator.test", version2, this.options.loose), this.semver === ANY || version2 === ANY)) return !0;
            if (typeof version2 == "string")
              try {
                version2 = new SemVer(version2, this.options);
              } catch {
          ...
          intersects(comp, options2) {
            ...
            return this.operator === ""
              ...
              : ((options2 = parseOptions(options2)),
                (options2.includePrerelease && (this.value === "<0.0.0-0" || comp.value === "<0.0.0-0")) ||
                (!options2.includePrerelease && (this.value.startsWith("<0.0.0") || comp.value.startsWith("<0.0.0")))
                  ? !1
                  : !!(
                      (this.operator.startsWith(">") && comp.operator.startsWith(">")) ||
                      (this.operator.startsWith("<") && comp.operator.startsWith("<")) ||
                      (this.semver.version === comp.semver.version && this.operator.includes("=") && comp.operator.includes("=")) ||
                      (cmp(this.semver, "<", comp.semver, options2) && this.operator.startsWith(">") && comp.operator.startsWith("<")) ||
                      (cmp(this.semver, ">", comp.semver, options2) && this.operator.startsWith("<") && comp.operator.startsWith(">"))
                    ));
          }
        };
    ...
    "../../node_modules/semver/ranges/max-satisfying.js"(exports, module) {
      var SemVer = require_semver(),
        ...
        maxSatisfying = (versions, range, options2) => {
          ...
          return (
            versions.forEach((v) => {
              rangeObj.test(v) && (!max || maxSV.compare(v) === -1) && ((max = v), (maxSV = new SemVer(max, options2)));
            }),
            max
          );
        };
    ...
    "../../node_modules/semver/ranges/min-satisfying.js"(exports, module) {
      var SemVer = require_semver(),
        ...
        minSatisfying = (versions, range, options2) => {
          ...
          return (
            versions.forEach((v) => {
              rangeObj.test(v) && (!min || minSV.compare(v) === 1) && ((min = v), (minSV = new SemVer(min, options2)));
            }),
            min
          );
        };
  ...
  require_intersects = __commonJS4({
    "../../node_modules/semver/ranges/intersects.js"(exports, module) {
      var Range = require_range2(),
        intersects = (r1, r2, options2) => ((r1 = new Range(r1, options2)), (r2 = new Range(r2, options2)), r1.intersects(r2, options2));
      ...
      var Range = require_range2(),
        ...
        simpleSubset = (sub, dom, options2) => {
          ...
          for (let eq2 of eqSet) {
            if ((gt && !satisfies(eq2, String(gt), options2)) || (lt && !satisfies(eq2, String(lt), options2))) return null;
          ...
          let higher,
            ...
            hasDomLT,
            hasDomGT,
            needDomLTPre = lt && !options2.includePrerelease && lt.semver.prerelease.length ? lt.semver : !1,
            needDomGTPre = gt && !options2.includePrerelease && gt.semver.prerelease.length ? gt.semver : !1;
          needDomLTPre &&
...
var Store = class {
    ...
    async setState(inputPatch, cbOrOptions, inputOptions) {
      ...
      typeof cbOrOptions == "function" ? ((callback = cbOrOptions), (options2 = inputOptions)) : (options2 = cbOrOptions);
...
var init = ({ provider, fullAPI }) => ({
  ...
  addons_exports = {};
__export3(addons_exports, { ensurePanel: () => ensurePanel, init: () => init2 });
...
var init2 = ({ provider, store: store2, fullAPI }) => {
    let api = {
      ...
      setAddonState(addonId, newStateOrMerger, options2) {
        ...
        return store2
          .setState((s) => ({ ...s, addons: { ...s.addons, [addonId]: merger(s.addons[addonId]) } }), options2)
    ...
    return {
      api,
      state: { selectedPanel: ensurePanel(api.getElements(Addon_TypesEnum.PANEL), store2.getState().selectedPanel), addons: {} },
    };
  },
  channel_exports = {};
    ...
    api: {
      ...
      emit: (type, data, ...args2) => {
        data?.options?.target &&
          ...
          (data.options.target =
            data.options.target !== "storybook_internal" ? `storybook-ref-${data.options.target}` : "storybook-preview-iframe"),
    ...
    api: {
      addNotification: (newNotification) => {
        store2.setState(({ notifications }) => {
          let [existing, others] = (0, import_partition.default)(notifications, (n) => n.id === newNotification.id);
          return (
      ...
      clearNotification: (notificationId) => {
        store2.setState(({ notifications }) => {
          let [matching, others] = (0, import_partition.default)(notifications, (n) => n.id === notificationId);
          return (
...
var refs_exports = {};
__export3(refs_exports, { defaultStoryMapper: () => defaultStoryMapper, getSourceType: () => getSourceType, init: () => init6 });
var TITLE_PATH_SEPARATOR = /\s*\/\s*/,
  ...
  transformStoryIndexV2toV3 = (index3) => ({
    ...
    stories: Object.values(index3.stories).reduce(
      (acc, entry) => (
        (acc[entry.id] = { ...entry, title: entry.kind, name: entry.name || entry.story, importPath: entry.parameters.fileName || "" }), acc
      ),
      {}
    ),
  }),
  transformStoryIndexV3toV4 = (index3) => {
    ...
    return {
      ...
      entries: Object.values(index3.stories).reduce((acc, entry) => {
        let type = "story";
        return (
          (entry.parameters?.docsOnly || (entry.name === "Page" && countByTitle[entry.title] === 1)) && (type = "docs"),
          (acc[entry.id] = { type, ...(type === "docs" && { tags: ["stories-mdx"], storiesImports: [] }), ...entry }),
  ...
  transformStoryIndexV4toV5 = (index3) => ({
    ...
    entries: Object.values(index3.entries).reduce(
      (acc, entry) => ((acc[entry.id] = { ...entry, tags: entry.tags ? ["dev", "test", ...entry.tags] : ["dev"] }), acc),
      {}
    ),
  }),
  ...
  getSourceType = (source2, refId) => {
    ...
    return localFull === sourceFull ? ["local", sourceFull] : refId || source2 ? ["external", sourceFull] : [null, null];
  },
  defaultStoryMapper = (b, a) => ({ ...a, kind: a.kind.replace("|", "/") }),
  addRefIds = (input, ref) => Object.entries(input).reduce((acc, [id, item]) => ({ ...acc, [id]: { ...item, refId: ref.id } }), {});
  ...
  init6 = ({ store: store2, provider, singleStory, docsOptions = {} }, { runCheck = !0 } = {}) => {
    let api = {
        ...
        checkRef: async (ref) => {
          ...
          if (!indexResult.indexError || !storiesResult.indexError) {
            let metadata = await handleRequest(
              fetch(`${urlParseResult.url}/metadata.json${query}`, { headers, credentials, cache: "no-cache" }).catch(() => !1)
            );
            Object.assign(loadedData, { ...(indexResult.indexError ? storiesResult : indexResult), ...(!metadata.indexError && metadata) });
          } else
            isPublic ||
        ...
        setRef: async (id, { storyIndex, setStoriesData, ...rest }, ready = !1) => {
          ...
          (storyIndex || setStoriesData) &&
            ((internal_index = setStoriesData
              ? transformSetStoriesStoryDataToPreparedStoryIndex(map(setStoriesData, ref, { storyMapper }))
              : storyIndex),
            (index3 = transformStoryIndexToStoriesHash(storyIndex, { provider, docsOptions, filters, status: {} }))),
        ...
        updateRef: async (id, data) => {
          let { [id]: ref, ...updated } = api.getRefs();
          updated[id] = { ...ref, ...data };
          let ordered = Object.keys(initialState).reduce((obj, key2) => ((obj[key2] = updated[key2]), obj), {});
...
var init7 = ({ fullAPI, store: store2, navigate, provider, storyId: initialStoryId, viewMode: initialViewMode, docsOptions = {} }) => {
    let api = {
      storyId: N,
      ...
      resolveStory: (storyId, refId) => {
        ...
        if (!(refId && !refs2[refId]))
          return refId ? (refs2[refId].index ? refs2[refId].index[storyId] : void 0) : index3 ? index3[storyId] : void 0;
      },
      getCurrentStoryData: () => {
      ...
      getParameters: (storyIdOrCombo, parameterName) => {
        let { storyId, refId } = typeof storyIdOrCombo == "string" ? { storyId: storyIdOrCombo, refId: void 0 } : storyIdOrCombo,
      ...
      selectStory: (titleOrId = void 0, name2 = void 0, options2 = {}) => {
        ...
        if (hash)
          if (name2)
            ...
            let entry = titleOrId ? hash[titleOrId] || hash[O(titleOrId)] : hash[kindSlug];
      ...
      updateStory: async (storyId, update2, ref) => {
        if (ref) {
          ...
          (index3[storyId] = { ...index3[storyId], ...update2 }), await fullAPI.updateRef(refId, { index: index3 });
        } else {
          let { index: index3 } = store2.getState();
          if (!index3) return;
      ...
      updateDocs: async (docsId, update2, ref) => {
        if (ref) {
          let { id: refId, index: index3 } = ref;
          (index3[docsId] = { ...index3[docsId], ...update2 }), await fullAPI.updateRef(refId, { index: index3 });
        } else {
          let { index: index3 } = store2.getState();
          if (!index3) return;
    ...
    provider.channel?.on(STORY_SPECIFIED, function ({ storyId, viewMode }) {
      ...
      if (sourceType === "local") {
        ...
        isCanvasRoute &&
          (stateHasSelection && stateSelectionDifferent && !(type === "root" || type === "component" || type === "group")
            ? provider.channel?.emit(SET_CURRENT_STORY, { storyId: state.storyId, viewMode: state.viewMode })
      ...
      provider.channel?.on(STORY_PREPARED, function ({ id, ...update2 }) {
        ...
        if (sourceType === "local") {
          ...
          let toBePreloaded = Array.from(
            new Set([api.findSiblingStoryId(storyId, index3, 1, !0), api.findSiblingStoryId(storyId, index3, -1, !0)])
          ).filter(Boolean);
      ...
      provider.channel?.on(SELECT_STORY, function ({ kind, title = kind, story, name: name2 = story, storyId, ...rest }) {
        let { ref } = getEventMetadata(this, fullAPI);
        ref ? fullAPI.selectStory(storyId || title, name2, { ...rest, ref: ref.id }) : fullAPI.selectStory(storyId || title, name2, rest);
      }),
      ...
      provider.channel?.on(SET_CONFIG, () => {
        ...
        config2?.sidebar?.filters && store2.setState({ filters: { ...store2.getState().filters, ...config2?.sidebar?.filters } });
      });
    ...
    let api = {
          ...
          return store2.setState(
            (state) => {
              ...
              return shouldShowNav === isNavShown
                ...
                : { layout: { ...state.layout, navSize: 0, recentVisibleSizes: getRecentVisibleSizes(state.layout) } };
            },
            { persistence: "session" }
          );
        },
        ...
        setSizes({ navSize, bottomPanelHeight, rightPanelWidth }) {
          return store2.setState(
            (state) => {
              ...
              return { layout: { ...nextLayoutState, recentVisibleSizes: getRecentVisibleSizes(nextLayoutState) } };
            },
            { persistence: "session" }
          );
        },
        ...
        getInitialOptions() {
          ...
          return {
            ...
            ui: { ...defaultLayoutState.ui, ...(0, import_pick.default)(options2, Object.keys(defaultLayoutState.ui)) },
...
var { navigator } = scope,
  ...
  shortcutMatchesShortcut = (inputShortcut, shortcut) =>
    ...
    (inputShortcut.join("").startsWith("shift/") && inputShortcut.shift(), inputShortcut.length !== shortcut.length)
      ? !1
      : !inputShortcut.find((input, i) => (Array.isArray(input) ? !input.includes(shortcut[i]) : input !== shortcut[i])),
  ...
  isMacLike2 = () => (navigator2 && navigator2.platform ? !!navigator2.platform.match(/(Mac|iPhone|iPod|iPad)/i) : !1),
...
var init9 = ({ store: store2, fullAPI, provider }) => {
    let api = {
        ...
        async setAddonShortcut(addon, shortcut) {
          let shortcuts = api.getShortcutKeys();
          return (
            await api.setShortcuts({ ...shortcuts, [`${addon}-${shortcut.actionName}`]: shortcut.defaultShortcut }),
...
var { window: globalWindow } = scope,
  ...
  initialUrlSupport = ({ state: { location: location22, path, viewMode, storyId: storyIdFromUrl }, singleStory }) => {
    let { full, panel, nav, shortcuts, addonPanel, tabs, path: queryPath, ...otherParams } = queryFromLocation(location22),
      navSize,
      bottomPanelHeight,
      rightPanelWidth;
    parseBoolean(full) === !0
      ...
      singleStory || (parseBoolean(nav) === !0 && (navSize = defaultLayoutState.layout.navSize), parseBoolean(nav) === !1 && (navSize = 0)),
    ...
    return (
      (prevParams = customQueryParams), { viewMode, layout, ui, selectedPanel, location: location22, path, customQueryParams, storyId }
    );
  },
  init10 = (moduleArgs) => {
    let { store: store2, navigate, provider, fullAPI } = moduleArgs,
      ...
      api = {
        ...
        setQueryParams(input) {
          let { customQueryParams } = store2.getState(),
            ...
            update2 = {
              ...customQueryParams,
              ...Object.entries(input).reduce((acc, [key2, value2]) => (value2 !== null && (acc[key2] = value2), acc), queryParams),
            };
          dequal2(customQueryParams, update2) ||
            (store2.setState({ customQueryParams: update2 }), provider.channel?.emit(UPDATE_QUERY_PARAMS, update2));
        },
      ...
      updateArgsParam = () => {
        ...
        navigateTo(path, { ...queryParams, args: argsString }, { replace: !0 }), api.setQueryParams({ args: argsString });
      };
    ...
    return (
      ...
      provider.channel?.on(GLOBALS_UPDATED, ({ globals, initialGlobals }) => {
        ...
        navigateTo(path, { ...queryParams, globals: globalsString }, { replace: !0 }), api.setQueryParams({ globals: globalsString });
      }),
  ...
  init12 = ({ fullAPI, store: store2, provider }) => {
    ...
    let api = {
      ...
      toggleWhatsNewNotifications() {
        state.whatsNewData?.status === "SUCCESS" &&
          (setWhatsNewState({ ...state.whatsNewData, disableWhatsNewNotifications: !state.whatsNewData.disableWhatsNewNotifications }),
...
var init13 = ({ store: store2, fullAPI, provider }) => {
  let api = {
      ...
      updateGlobals(newGlobals) {
        provider.channel?.emit(UPDATE_GLOBALS, { globals: newGlobals, options: { target: "storybook-preview-iframe" } });
      },
    },
  ...
  return (
    provider.channel?.on(GLOBALS_UPDATED, function ({ globals }) {
      let { ref } = getEventMetadata(this, fullAPI);
      ref ? logger.warn("received a GLOBALS_UPDATED from a non-local ref. This is not currently supported.") : updateGlobals(globals);
    }),
    provider.channel?.on(SET_GLOBALS, function ({ globals, globalTypes }) {
      let { ref } = getEventMetadata(this, fullAPI),
        currentGlobals = store2.getState()?.globals;
      ref
        ? Object.keys(globals).length > 0 && logger.warn("received globals from a non-local ref. This is not currently supported.")
      ...
      let request = { id: Math.random().toString(16).slice(2), payload },
        responseHandler = (response) => {
          response.id === request.id &&
            ...
            response.success ? resolve(response.payload) : reject(new RequestResponseError(response.error, response.payload)));
        };
  ...
  ManagerProvider = class extends import_react2.Component {
    ...
    static getDerivedStateFromProps(props, state) {
      return state.path !== props.path
        ? { ...state, location: props.location, path: props.path, refId: props.refId, viewMode: props.viewMode, storyId: props.storyId }
        : null;
    }
...
function ManagerConsumer({ filter = defaultFilter, children }) {
  ...
  if (typeof renderer.current != "function") return import_react2.default.createElement(import_react2.Fragment, null, renderer.current);
...
function useStorybookState() {
  ...
  return {
    ...
    get storiesConfigured() {
      return deprecate("state.storiesConfigured is deprecated, please use state.previewInitialized"), this.previewInitialized;
    },
    get storiesFailed() {
...
function useSharedState(stateId, defaultState) {
  let api = useStorybookApi(),
    ...
    quicksync = !1;
  state === defaultState && defaultState !== void 0 && ((STORYBOOK_ADDON_STATE[stateId] = defaultState), (quicksync = !0)),
    (0, import_react2.useEffect)(() => {
      ...
      let stateChangeHandlers = {
        ...
        stateInitializationHandlers = {
          [SET_STORIES]: async () => {
            ...
            currentState
              ? ((STORYBOOK_ADDON_STATE[stateId] = currentState), api.emit(`${SHARED_STATE_SET}-manager-${stateId}`, currentState))
...
function useArgs() {
  let { getCurrentStoryData, updateStoryArgs, resetStoryArgs } = useStorybookApi(),
    ...
    updateArgs = (0, import_react2.useCallback)((newArgs) => updateStoryArgs(data, newArgs), [data, updateStoryArgs]),
    resetArgs = (0, import_react2.useCallback)((argNames) => resetStoryArgs(data, argNames), [data, resetStoryArgs]);
...
var Category = ((Category2) => (
  ...
  UncaughtManagerError = class extends StorybookError {
    constructor(data) {
      super(data.error.message), (this.data = data), (this.category = "MANAGER_UNCAUGHT"), (this.code = 1), (this.stack = data.error.stack);
    }
    template() {
      return this.message;
    }
...
function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
  ...
  function Provider(props) {
    let { children, ...context } = props,
      value2 = (0, import_react3.useMemo)(() => context, Object.values(context));
    return (0, import_react3.createElement)(Context.Provider, { value: value2 }, children);
  }
  ...
  return (Provider.displayName = rootComponentName + "Provider"), [Provider, useContext3];
}
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
  ...
  let createScope = () => {
    ...
    return function (scope3) {
      ...
      return (0, import_react3.useMemo)(() => ({ [`__scope${scopeName}`]: { ...scope3, [scopeName]: contexts } }), [scope3, contexts]);
    };
  };
  return (
    (createScope.scopeName = scopeName),
    [$c512c27ab02ef895$export$fd42f52fd3ae11092, $c512c27ab02ef895$var$composeContextScopes(createScope, ...createContextScopeDeps)]
  );
}
...
var import_react4 = __toESM(require_react(), 1),
  $9f79659886946c16$export$e5c5a5f917a5871c = globalThis?.document ? import_react4.useLayoutEffect : () => {};
...
function $71cd76cc60e0454e$export$6f32135080cb4c3({ prop, defaultProp, onChange = () => {} }) {
  let [uncontrolledProp, setUncontrolledProp] = $71cd76cc60e0454e$var$useUncontrolledState({ defaultProp, onChange }),
    ...
    setValue = (0, import_react6.useCallback)(
      (nextValue) => {
        if (isControlled) {
          let value2 = typeof nextValue == "function" ? nextValue(prop) : nextValue;
...
function $71cd76cc60e0454e$var$useUncontrolledState({ defaultProp, onChange }) {
  ...
  return (
    (0, import_react6.useEffect)(() => {
      prevValueRef.current !== value2 && (handleChange(value2), (prevValueRef.current = value2));
  ...
  $8927f6f2acc4f386$export$250ffa63cdc0d034 = $8927f6f2acc4f386$var$NODES.reduce((primitive, node) => {
    let Node = (0, import_react7.forwardRef)((props, forwardedRef) => {
      ...
      return (
        ...
        (0, import_react7.createElement)(Comp2, _extends2({}, primitiveProps, { ref: forwardedRef }))
      );
    });
...
var $5cb92bef7577960e$var$CONTEXT_UPDATE = "dismissableLayer.update",
  ...
  $5cb92bef7577960e$var$DismissableLayerContext = (0, import_react9.createContext)({
    layers: new Set(),
    layersWithOutsidePointerEventsDisabled: new Set(),
    branches: new Set(),
  }),
  $5cb92bef7577960e$export$177fb62ff3ec1f22 = (0, import_react9.forwardRef)((props, forwardedRef) => {
    ...
    let {
      ...
      context = (0, import_react9.useContext)($5cb92bef7577960e$var$DismissableLayerContext),
      [node1, setNode] = (0, import_react9.useState)(null),
      ownerDocument =
        (_node$ownerDocument = node1?.ownerDocument) !== null && _node$ownerDocument !== void 0
          ? _node$ownerDocument
          : globalThis?.document,
      [, force] = (0, import_react9.useState)({}),
      composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) => setNode(node)),
      ...
      isPointerEventsEnabled = index3 >= highestLayerWithOutsidePointerEventsDisabledIndex,
    ...
    return (
      ...
      (0, import_react9.useEffect)(() => {
        ...
        return (
          ...
          () => document.removeEventListener($5cb92bef7577960e$var$CONTEXT_UPDATE, handleUpdate)
        );
      }, []),
      (0, import_react9.createElement)(
        ...
        _extends2({}, layerProps, {
          ref: composedRefs,
          style: { pointerEvents: isBodyPointerEventsDisabled ? (isPointerEventsEnabled ? "auto" : "none") : void 0, ...props.style },
...
function $5cb92bef7577960e$var$usePointerDownOutside(onPointerDownOutside, ownerDocument = globalThis?.document) {
  let handlePointerDownOutside = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onPointerDownOutside),
...
function $5cb92bef7577960e$var$useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
  let handleFocusOutside = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onFocusOutside),
  ...
  return (
    ...
    { onFocusCapture: () => (isFocusInsideReactTreeRef.current = !0), onBlurCapture: () => (isFocusInsideReactTreeRef.current = !1) }
  );
}
...
var $d3863c46a17e8a28$export$20e40289641fbbb6 = (0, import_react10.forwardRef)((props, forwardedRef) => {
  let {
    ...
    onMountAutoFocus = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onMountAutoFocusProp),
    onUnmountAutoFocus = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onUnmountAutoFocusProp),
    lastFocusedElementRef = (0, import_react10.useRef)(null),
    composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) => setContainer(node)),
    ...
    if (trapped) {
      let handleFocusIn = function (event) {
          ...
          container1.contains(target)
            ...
            : $d3863c46a17e8a28$var$focus(lastFocusedElementRef.current, { select: !0 });
        },
        handleFocusOut = function (event) {
          if (focusScope.paused || !container1) return;
          let relatedTarget = event.relatedTarget;
          relatedTarget !== null &&
            (container1.contains(relatedTarget) || $d3863c46a17e8a28$var$focus(lastFocusedElementRef.current, { select: !0 }));
        },
      ...
      return (
        container1 && mutationObserver.observe(container1, { childList: !0, subtree: !0 }),
        () => {
          ...
          container1.addEventListener($d3863c46a17e8a28$var$AUTOFOCUS_ON_MOUNT, onMountAutoFocus),
            ...
            mountEvent.defaultPrevented ||
              ($d3863c46a17e8a28$var$focusFirst(
                $d3863c46a17e8a28$var$removeLinks($d3863c46a17e8a28$var$getTabbableCandidates(container1)),
                { select: !0 }
              ),
          ...
          container1.removeEventListener($d3863c46a17e8a28$var$AUTOFOCUS_ON_MOUNT, onMountAutoFocus),
            setTimeout(() => {
              ...
              container1.addEventListener($d3863c46a17e8a28$var$AUTOFOCUS_ON_UNMOUNT, onUnmountAutoFocus),
                ...
                unmountEvent.defaultPrevented || $d3863c46a17e8a28$var$focus(previouslyFocusedElement ?? document.body, { select: !0 }),
      ...
      if (isTabKey && focusedElement) {
        ...
        first && last
          ? !event.shiftKey && focusedElement === last
            ? (event.preventDefault(), loop && $d3863c46a17e8a28$var$focus(first, { select: !0 }))
            : event.shiftKey &&
              focusedElement === first &&
              (event.preventDefault(), loop && $d3863c46a17e8a28$var$focus(last, { select: !0 }))
  ...
  return (0, import_react10.createElement)(
    $8927f6f2acc4f386$export$250ffa63cdc0d034.div,
    _extends2({ tabIndex: -1 }, scopeProps, { ref: composedRefs, onKeyDown: handleKeyDown })
  );
});
function $d3863c46a17e8a28$var$focusFirst(candidates, { select = !1 } = {}) {
  let previouslyFocusedElement = document.activeElement;
  for (let candidate of candidates)
    if (($d3863c46a17e8a28$var$focus(candidate, { select }), document.activeElement !== previouslyFocusedElement)) return;
}
...
function $d3863c46a17e8a28$var$findVisible(elements, container) {
  for (let element of elements) if (!$d3863c46a17e8a28$var$isHidden(element, { upTo: container })) return element;
}
...
var $f1701beae083dbae$export$602eac185826482c = (0, import_react11.forwardRef)((props, forwardedRef) => {
  ...
  let {
    container = globalThis == null || (_globalThis$document = globalThis.document) === null || _globalThis$document === void 0
      ? void 0
  ...
  return container
    ? import_react_dom2.default.createPortal(
        (0, import_react11.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends2({}, portalProps, { ref: forwardedRef })),
        container
      )
    : null;
});
...
var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
  let { present, children } = props,
    ...
    child = typeof children == "function" ? children({ present: presence.isPresent }) : import_react12.Children.only(children),
    ref = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(presence.ref, child.ref);
  return typeof children == "function" || presence.isPresent ? (0, import_react12.cloneElement)(child, { ref }) : null;
};
    ...
    $9f79659886946c16$export$e5c5a5f917a5871c(() => {
      ...
      if (wasPresent !== present) {
        let prevAnimationName = prevAnimationNameRef.current,
          currentAnimationName = $921a889cee6df7e8$var$getAnimationName(styles2);
        present
          ? send("MOUNT")
    ...
    $9f79659886946c16$export$e5c5a5f917a5871c(() => {
      if (node1) {
        let handleAnimationEnd = (event) => {
            ...
            event.target === node1 && isCurrentAnimation && (0, import_react_dom3.flushSync)(() => send("ANIMATION_END"));
          },
  ...
  (0, import_react13.useEffect)(() => {
    ...
    return (
      document.body.insertAdjacentElement(
        "afterbegin",
        (_edgeGuards$ = edgeGuards[0]) !== null && _edgeGuards$ !== void 0 ? _edgeGuards$ : $3db38b7d1fb3fe6a$var$createFocusGuard()
      ),
      document.body.insertAdjacentElement(
        "beforeend",
        (_edgeGuards$2 = edgeGuards[1]) !== null && _edgeGuards$2 !== void 0 ? _edgeGuards$2 : $3db38b7d1fb3fe6a$var$createFocusGuard()
      ),
      $3db38b7d1fb3fe6a$var$count++,
      () => {
        $3db38b7d1fb3fe6a$var$count === 1 && document.querySelectorAll("[data-radix-focus-guard]").forEach((node) => node.remove()),
          $3db38b7d1fb3fe6a$var$count--;
      }
    );
  }, []);
...
var nothing = function () {},
  RemoveScroll = React5.forwardRef(function (props, parentRef) {
    var ref = React5.useRef(null),
      _a = React5.useState({ onScrollCapture: nothing, onWheelCapture: nothing, onTouchMoveCapture: nothing }),
      callbacks = _a[0],
      setCallbacks = _a[1],
    ...
    return React5.createElement(
      ...
      forwardProps
        ? React5.cloneElement(React5.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef }))
        : React5.createElement(Container3, __assign({}, containerProps, { className, ref: containerRef }), children)
    );
  });
...
`
  ...
  RemoveScrollBar = function (props) {
    ...
    return (
      ...
      React7.createElement(Style, { styles: getStyles(gap, !noRelative, gapMode, noImportant ? "" : "!important") })
    );
  };
...
var alwaysContainsScroll = function (node) {
  ...
  handleScroll = function (axis, endTarget, event, sourceDelta, noOverscroll) {
    ...
    return (
      ((isDeltaPositive && ((noOverscroll && availableScroll === 0) || (!noOverscroll && delta > availableScroll))) ||
        (!isDeltaPositive && ((noOverscroll && availableScrollTop === 0) || (!noOverscroll && -delta > availableScrollTop)))) &&
...
function RemoveScrollSideCar(props) {
  ...
  React8.useEffect(function () {
    return (
      ...
      props.setCallbacks({ onScrollCapture: scrollWheel, onWheelCapture: scrollWheel, onTouchMoveCapture: scrollTouchMove }),
        ...
        Array.prototype.forEach.call(parent.children, function (node) {
          if (elementsToKeep.has(node)) deep(node);
            ...
            counterMap.set(node, counterValue),
              ...
              counterValue === 1 && alreadyHidden && uncontrolledNodes.set(node, !0),
    ...
    return (
      ...
      function () {
        hiddenNodes.forEach(function (node) {
          ...
          counterMap.set(node, counterValue),
            markerCounter.set(node, markerValue),
            counterValue || (uncontrolledNodes.has(node) || node.removeAttribute(controlAttribute), uncontrolledNodes.delete(node)),
            markerValue || node.removeAttribute(markerName);
        }),
          lockCount--,
          lockCount || ((counterMap = new WeakMap()), (counterMap = new WeakMap()), (uncontrolledNodes = new WeakMap()), (markerMap = {}));
      }
    );
  },
...
var $5d3850c4d0b4e6c7$var$DIALOG_NAME = "Dialog",
  [$5d3850c4d0b4e6c7$var$createDialogContext, $5d3850c4d0b4e6c7$export$cc702773b8ea3e41] =
    $c512c27ab02ef895$export$50c7b4e9d9f19c1($5d3850c4d0b4e6c7$var$DIALOG_NAME),
  [$5d3850c4d0b4e6c7$var$DialogProvider, $5d3850c4d0b4e6c7$var$useDialogContext] =
    $5d3850c4d0b4e6c7$var$createDialogContext($5d3850c4d0b4e6c7$var$DIALOG_NAME),
  $5d3850c4d0b4e6c7$export$3ddf2d174ce01153 = (props) => {
    let { __scopeDialog, children, open: openProp, defaultOpen, onOpenChange, modal = !0 } = props,
      triggerRef = (0, import_react15.useRef)(null),
      contentRef = (0, import_react15.useRef)(null),
      [open = !1, setOpen] = $71cd76cc60e0454e$export$6f32135080cb4c3({ prop: openProp, defaultProp: defaultOpen, onChange: onOpenChange });
    return (0, import_react15.createElement)(
      $5d3850c4d0b4e6c7$var$DialogProvider,
      {
        ...
        onOpenToggle: (0, import_react15.useCallback)(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
        modal,
      },
      children
    );
  ...
  $5d3850c4d0b4e6c7$export$2e1e1122cf0cba88 = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let { __scopeDialog, ...triggerProps } = props,
      context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$TRIGGER_NAME, __scopeDialog),
      composedTriggerRef = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, context.triggerRef);
    return (0, import_react15.createElement)(
      ...
      _extends2(
        ...
        triggerProps,
        { ref: composedTriggerRef, onClick: $e42e1063c40fb3ef$export$b9ecd428b558ff10(props.onClick, context.onOpenToggle) }
      )
    );
  }),
  $5d3850c4d0b4e6c7$var$PORTAL_NAME = "DialogPortal",
  [$5d3850c4d0b4e6c7$var$PortalProvider, $5d3850c4d0b4e6c7$var$usePortalContext] = $5d3850c4d0b4e6c7$var$createDialogContext(
  ...
  $5d3850c4d0b4e6c7$export$dad7c95542bacce0 = (props) => {
    let { __scopeDialog, forceMount, children, container } = props,
      context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$PORTAL_NAME, __scopeDialog);
    return (0, import_react15.createElement)(
      ...
      import_react15.Children.map(children, (child) =>
        (0, import_react15.createElement)(
          ...
          (0, import_react15.createElement)($f1701beae083dbae$export$602eac185826482c, { asChild: !0, container }, child)
        )
      )
    );
  },
  $5d3850c4d0b4e6c7$var$OVERLAY_NAME = "DialogOverlay",
  $5d3850c4d0b4e6c7$export$bd1d06c79be19e17 = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let portalContext = $5d3850c4d0b4e6c7$var$usePortalContext($5d3850c4d0b4e6c7$var$OVERLAY_NAME, props.__scopeDialog),
      { forceMount = portalContext.forceMount, ...overlayProps } = props,
      context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$OVERLAY_NAME, props.__scopeDialog);
    return context.modal
      ? (0, import_react15.createElement)(
          $921a889cee6df7e8$export$99c2b779aa4e8b8b,
          { present: forceMount || context.open },
          (0, import_react15.createElement)($5d3850c4d0b4e6c7$var$DialogOverlayImpl, _extends2({}, overlayProps, { ref: forwardedRef }))
        )
      : null;
  }),
  $5d3850c4d0b4e6c7$var$DialogOverlayImpl = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let { __scopeDialog, ...overlayProps } = props,
      context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$OVERLAY_NAME, __scopeDialog);
    return (0, import_react15.createElement)(
      Combination_default,
      { as: $5e63c961fc1ce211$export$8c6ed5c666ac1360, allowPinchZoom: !0, shards: [context.contentRef] },
      (0, import_react15.createElement)(
        $8927f6f2acc4f386$export$250ffa63cdc0d034.div,
        _extends2({ "data-state": $5d3850c4d0b4e6c7$var$getState(context.open) }, overlayProps, {
          ref: forwardedRef,
  ...
  $5d3850c4d0b4e6c7$export$b6d9565de1e068cf = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let portalContext = $5d3850c4d0b4e6c7$var$usePortalContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog),
      { forceMount = portalContext.forceMount, ...contentProps } = props,
      context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog);
    return (0, import_react15.createElement)(
      $921a889cee6df7e8$export$99c2b779aa4e8b8b,
      { present: forceMount || context.open },
      context.modal
        ? (0, import_react15.createElement)($5d3850c4d0b4e6c7$var$DialogContentModal, _extends2({}, contentProps, { ref: forwardedRef }))
        : (0, import_react15.createElement)($5d3850c4d0b4e6c7$var$DialogContentNonModal, _extends2({}, contentProps, { ref: forwardedRef }))
    );
  }),
  $5d3850c4d0b4e6c7$var$DialogContentModal = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog),
      contentRef = (0, import_react15.useRef)(null),
      composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, context.contentRef, contentRef);
    return (
  ...
  $5d3850c4d0b4e6c7$var$DialogContentNonModal = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog),
    ...
    return (0, import_react15.createElement)(
      ...
      _extends2({}, props, {
        ...
        onInteractOutside: (event) => {
          ...
          let target = event.target;
          ((_context$triggerRef$c3 = context.triggerRef.current) === null || _context$triggerRef$c3 === void 0
            ? void 0
            : _context$triggerRef$c3.contains(target)) && event.preventDefault(),
            event.detail.originalEvent.type === "focusin" && hasPointerDownOutsideRef.current && event.preventDefault();
        },
      })
    );
  }),
  $5d3850c4d0b4e6c7$var$DialogContentImpl = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let { __scopeDialog, trapFocus, onOpenAutoFocus, onCloseAutoFocus, ...contentProps } = props,
      context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, __scopeDialog),
      contentRef = (0, import_react15.useRef)(null),
      composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, contentRef);
    return (
      ...
      (0, import_react15.createElement)(
        ...
        (0, import_react15.createElement)(
          ...
          { asChild: !0, loop: !0, trapped: trapFocus, onMountAutoFocus: onOpenAutoFocus, onUnmountAutoFocus: onCloseAutoFocus },
          (0, import_react15.createElement)(
  ...
  $5d3850c4d0b4e6c7$export$16f7638e4a34b909 = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let { __scopeDialog, ...titleProps } = props,
      context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$TITLE_NAME, __scopeDialog);
    return (0, import_react15.createElement)(
  ...
  $5d3850c4d0b4e6c7$export$94e94c2ec2c954d5 = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let { __scopeDialog, ...descriptionProps } = props,
      context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$DESCRIPTION_NAME, __scopeDialog);
    return (0, import_react15.createElement)(
      $8927f6f2acc4f386$export$250ffa63cdc0d034.p,
      _extends2({ id: context.descriptionId }, descriptionProps, { ref: forwardedRef })
    );
  }),
  $5d3850c4d0b4e6c7$var$CLOSE_NAME = "DialogClose",
  $5d3850c4d0b4e6c7$export$fba2fb7cd781b7ac = (0, import_react15.forwardRef)((props, forwardedRef) => {
    let { __scopeDialog, ...closeProps } = props,
      context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CLOSE_NAME, __scopeDialog);
    return (0, import_react15.createElement)(
      $8927f6f2acc4f386$export$250ffa63cdc0d034.button,
      _extends2({ type: "button" }, closeProps, {
        ref: forwardedRef,
        onClick: $e42e1063c40fb3ef$export$b9ecd428b558ff10(props.onClick, () => context.onOpenChange(!1)),
      })
    );
  });
...
var $5d3850c4d0b4e6c7$var$TITLE_WARNING_NAME = "DialogTitleWarning",
  [$5d3850c4d0b4e6c7$export$69b62a49393917d6, $5d3850c4d0b4e6c7$var$useWarningContext] = $c512c27ab02ef895$export$fd42f52fd3ae1109(
    $5d3850c4d0b4e6c7$var$TITLE_WARNING_NAME,
    { contentName: $5d3850c4d0b4e6c7$var$CONTENT_NAME, titleName: $5d3850c4d0b4e6c7$var$TITLE_NAME, docsSlug: "dialog" }
  );
...
var nameSpaceClassNames = ({ ...props }, key2) => {
  ...
  return delete props.class, (props.className = ["sbdocs", `sbdocs-${key2}`, ...classes].filter(Boolean).join(" ")), props;
};
...
var PolishedError = (function (_Error) {
  ...
  function PolishedError2(code) {
    for (var _this, _len2 = arguments.length, args2 = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++)
...
var isRgb = function (color2) {
  ...
  isRgba = function (color2) {
    return (
      typeof color2.red == "number" && typeof color2.green == "number" && typeof color2.blue == "number" && typeof color2.alpha == "number"
    );
  },
...
function transparentize(amount, color2) {
  ...
  var parsedColor = parseToRgb(color2),
    ...
    colorWithAlpha = _extends({}, parsedColor, { alpha: guard(0, 1, +(alpha * 100 - parseFloat(amount) * 100).toFixed(2) / 100) });
...
var curriedTransparentize = curry(transparentize),
  ...
  Code = ({ className, children, ...props }) => {
    ...
    return childrenArray.filter(isReactChildString).some((child) => child.match(isInlineCodeRegex))
      ...
      : import_react16.default.createElement(DefaultCodeBlock, { ...props, className }, childrenArray);
  },
  ...
  H6 = newStyled.h6(withReset, headerCommon, ({ theme }) => ({ fontSize: `${theme.typography.size.s2}px`, color: theme.color.dark })),
  HR = newStyled.hr(({ theme }) => ({ border: "0 none", borderTop: `1px solid ${theme.appBorderColor}`, height: 4, padding: 0 })),
  ...
  Table = newStyled.table(withReset, withMargin, ({ theme }) => ({
    ...
    "& tr": { borderTop: `1px solid ${theme.appBorderColor}`, backgroundColor: theme.appContentBg, margin: 0, padding: 0 },
    ...
    "& tr td": { border: `1px solid ${theme.appBorderColor}`, color: theme.color.defaultText, margin: 0, padding: "6px 13px" },
  ...
  components = {
    ...
    pre: (props) => import_react16.default.createElement(Pre, { ...nameSpaceClassNames(props, "pre") }),
    ...
    code: (props) => import_react16.default.createElement(Code, { ...nameSpaceClassNames(props, "code") }),
  ...
  LinkInner = newStyled.span(
    ({ withArrow }) =>
      withArrow
        ...
        : {},
    ({ containsIcon }) =>
      containsIcon ? { svg: { height: "1em", width: "1em", verticalAlign: "middle", position: "relative", bottom: 0, marginRight: 0 } } : {}
  ),
  A2 = newStyled.a(
    ({ theme }) => ({
      display: "inline-block",
    ...
    ({ nochrome }) => (nochrome ? { color: "inherit", "&:hover, &:active": { color: "inherit", textDecoration: "underline" } } : {}),
    ({ theme, inverse }) =>
      inverse
        ? {
        ...
        : {},
    ({ isButton: isButton2 }) => (isButton2 ? { border: 0, borderRadius: 0, background: "none", padding: 0, fontSize: "inherit" } : {})
  ),
  Link22 = ({ cancel = !0, children, onClick = void 0, withArrow = !1, containsIcon = !1, className = void 0, style = void 0, ...rest }) =>
    import_react16.default.createElement(
      A2,
      ...
      import_react16.default.createElement(
        ...
        children,
        withArrow && import_react16.default.createElement(ChevronRightIcon, null)
      )
    ),
  DocumentWrapper = newStyled.div(({ theme }) => ({
    ...
    table: {
      ...
      "& tr": {
        ...
        margin: 0,
        padding: 0,
        "& th": { fontWeight: "bold", border: `1px solid ${theme.appBorderColor}`, textAlign: "left", margin: 0, padding: "6px 13px" },
        "& td": { border: `1px solid ${theme.appBorderColor}`, textAlign: "left", margin: 0, padding: "6px 13px" },
  ...
  LazySyntaxHighlighter = (0, import_react16.lazy)(async () => {
    let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-BP7B2CQK-WOJYHKQR.js");
    return (
      languages.length > 0 &&
      ...
      { default: (props) => import_react16.default.createElement(SyntaxHighlighter3, { ...props }) }
    );
  }),
  LazySyntaxHighlighterWithFormatter = (0, import_react16.lazy)(async () => {
    ...
    return (
      languages.length > 0 &&
        ...
        (languages = [])),
      Comp === null && (Comp = SyntaxHighlighter3),
      { default: (props) => import_react16.default.createElement(SyntaxHighlighter3, { ...props, formatter }) }
    );
  }),
  SyntaxHighlighter22 = (props) =>
    import_react16.default.createElement(
      ...
      props.format !== !1
        ? import_react16.default.createElement(LazySyntaxHighlighterWithFormatter, { ...props })
        : import_react16.default.createElement(LazySyntaxHighlighter, { ...props })
    );
...
var StyledButton = newStyled("button", { shouldForwardProp: (prop) => isPropValid(prop) })(
    ({ theme, variant, size, disabled, active, animating, animation, padding }) => ({
      ...
      ...(variant === "ghost"
        ? {
            ".sb-bar &": {
              ...
              "&:hover": { color: theme.barHoverColor, background: curriedTransparentize$1(0.86, theme.barHoverColor) },
              "&:active": { color: theme.barSelectedColor, background: curriedTransparentize$1(0.9, theme.barSelectedColor) },
      ...
      "> svg": { animation: animating && animation !== "none" ? `${theme.animation[animation]} 1000ms ease-out` : "" },
    })
  ),
  IconButton = (0, import_react16.forwardRef)(({ padding = "small", variant = "ghost", ...props }, ref) =>
    import_react16.default.createElement(Button, { padding, variant, ref, ...props })
  );
...
var fadeIn = keyframes({ from: { opacity: 0 }, to: { opacity: 1 } }),
  ...
  CloseButton = (props) =>
    import_react16.default.createElement(
      ...
      { asChild: !0 },
      import_react16.default.createElement(IconButton, { ...props }, import_react16.default.createElement(CrossIcon, null))
    ),
  Content = newStyled.div({ display: "flex", flexDirection: "column", margin: 16, gap: 16 }),
  Row = newStyled.div({ display: "flex", justifyContent: "space-between", gap: 16 }),
  ...
  Title2 = newStyled($5d3850c4d0b4e6c7$export$f99233281efd08a0)(({ theme }) => ({
    margin: 0,
    fontSize: theme.typography.size.s3,
    fontWeight: theme.typography.weight.bold,
  })),
  Description2 = newStyled($5d3850c4d0b4e6c7$export$393edc798c47379d)(({ theme }) => ({
    position: "relative",
    zIndex: 1,
    margin: 0,
    fontSize: theme.typography.size.s2,
  })),
  Actions = newStyled.div({ display: "flex", flexDirection: "row-reverse", gap: 8 }),
  ...
  Error2 = ({ children, ...props }) =>
    import_react16.default.createElement(ErrorWrapper, { ...props }, import_react16.default.createElement("div", null, children));
function BaseModal({
  children,
  width,
  height,
  ...
  return import_react16.default.createElement(
    ...
    import_react16.default.createElement(
      ...
      import_react16.default.createElement(
        ...
        import_react16.default.createElement(Container, { className, width, height }, children)
      )
    )
  );
}
var Modal = Object.assign(BaseModal, Modal_styled_exports, { Dialog: dist_exports7 }),
  ...
  Container2 = newStyled.div(
    ({ theme, col, row = 1 }) =>
      col
        ...
        : { "& > *": { marginTop: row * theme.layoutMargin }, [`& > *:first-child${ignoreSsrWarning}`]: { marginTop: 0 } },
    ({ theme, outer, col, row }) => {
      switch (!0) {
        case !!(outer && col):
  ...
  Title3 = newStyled.div(({ theme }) => ({ fontWeight: theme.typography.weight.bold })),
  Desc = newStyled.div(),
  ...
  var evaluateSubscription = (0, import_react16.useCallback)(
    function () {
      var cbElement = cbElementRef.current,
        ...
        element = cbElement || (refOrElement2 ? (refOrElement2 instanceof Element ? refOrElement2 : refOrElement2.current) : null);
      (lastReportRef.current && lastReportRef.current.element === element && lastReportRef.current.subscriber === subscriber) ||
  ...
  var previous = (0, import_react16.useRef)({ width: void 0, height: void 0 }),
    refCallback = useResolvedElement(
      (0, import_react16.useCallback)(
        function (element) {
          return (
            (!resizeObserverRef.current || resizeObserverRef.current.box !== opts.box || resizeObserverRef.current.round !== round) &&
                ...
                instance: new ResizeObserver(function (entries) {
                  ...
                  if (previous.current.width !== newWidth || previous.current.height !== newHeight) {
                    ...
                    (previous.current.width = newWidth),
                      ...
                      onResizeRef.current ? onResizeRef.current(newSize) : didUnmount.current || setSize(newSize);
                  }
                }),
              }),
...
function ZoomElement({ scale, children }) {
  ...
  return (
    ...
    import_react16.default.createElement(
      ZoomElementWrapper,
      { scale, elementHeight },
      import_react16.default.createElement("div", { ref: componentWrapperRef, className: "innerZoomElementWrapper" }, children)
    )
  );
}
var ZoomIFrame = class extends import_react16.Component {
  ...
  ErrorFormatter = ({ error }) => {
    if (!error) return import_react16.default.createElement(import_react16.Fragment, null, "This error has no stack or message");
    if (!error.stack)
...
${input}`);
    ...
    if (!match) return import_react16.default.createElement(import_react16.Fragment, null, input);
    let [, type, name2] = match,
      rawLines = input.split(/\n/).slice(1),
      [, ...lines] = rawLines
        .map((line) => {
          let result2 = line.match(linesRegexChromium) || line.match(linesRegexFirefox) || line.match(linesRegexSafari);
          return result2
            ? { name: (result2[1] || "").replace("/<", ""), location: result2[2].replace(document24.location.origin, "") }
            : null;
        })
        .filter(Boolean);
    return import_react16.default.createElement(
      ...
      lines.map((l, i) =>
        l.name
          ? import_react16.default.createElement(
              ...
              "  ",
              "at ",
              import_react16.default.createElement(ErrorImportant, null, l.name),
              " (",
              import_react16.default.createElement(ErrorDetail, null, l.location),
              ")",
              import_react16.default.createElement("br", null)
            )
          : import_react16.default.createElement(
  ...
  Field = ({ label, children, ...props }) =>
    import_react16.default.createElement(
      Wrapper,
      { ...props },
      label ? import_react16.default.createElement(Label, null, import_react16.default.createElement("span", null, label)) : null,
      children
    ),
...
var useWindowResizeListener = function (listener) {
  ...
  TextareaAutosize = function (_ref, userRef) {
    var cacheMeasurements = _ref.cacheMeasurements,
      ...
      resizeTextarea = function () {
        var node = libRef.current,
          nodeSizingData = cacheMeasurements && measurementsCacheRef.current ? measurementsCacheRef.current : getSizingData$1(node);
        if (nodeSizingData) {
    ...
    return (
      ...
      React32.createElement("textarea", _extends({}, props, { onChange: handleChange, ref }))
    );
  },
  ...
  Input = Object.assign(
    newStyled(
      (0, import_react16.forwardRef)(function ({ size, valid, align, ...props }, ref) {
  ...
  Form = Object.assign(newStyled.form({ boxSizing: "border-box", width: "100%" }), { Field, Input, Select, Textarea, Button }),
  LazyWithTooltip = (0, import_react16.lazy)(() =>
    import("./WithTooltip-KJL26V4Q-5LS5AN27.js").then((mod) => ({ default: mod.WithTooltip }))
  ),
  WithTooltip = (props) =>
    import_react16.default.createElement(
      import_react16.Suspense,
  ...
  LazyWithTooltipPure = (0, import_react16.lazy)(() =>
    import("./WithTooltip-KJL26V4Q-5LS5AN27.js").then((mod) => ({ default: mod.WithTooltipPure }))
  ),
  ...
  Title4 = newStyled.div(({ theme }) => ({ fontWeight: theme.typography.weight.bold })),
      ...
      links &&
        import_react16.default.createElement(
          ...
          links.map(({ title: linkTitle, ...other }) =>
            import_react16.default.createElement(Link22, { ...other, key: linkTitle }, linkTitle)
          )
        )
    ),
  ...
  TooltipNote = ({ note, ...props }) => import_react16.default.createElement(Note, { ...props }, note),
  Title5 = newStyled(({ active, loading, disabled, ...rest }) => import_react16.default.createElement("span", { ...rest }))(
    ({ theme }) => ({ color: theme.color.defaultText, fontWeight: theme.typography.weight.regular }),
    ({ active, theme }) => (active ? { color: theme.color.secondary, fontWeight: theme.typography.weight.bold } : {}),
    ({ loading, theme }) => (loading ? { display: "inline-block", flex: "none", ...theme.animation.inlineGlow } : {}),
  ...
  Center = newStyled.span({ flex: 1, textAlign: "left", display: "flex", flexDirection: "column" }, ({ isIndented }) =>
    isIndented ? { marginLeft: 24 } : {}
  ),
  ...
  ListItem = ({
    ...
    return import_react16.default.createElement(
      ...
      icon && import_react16.default.createElement(Left, { ...commonProps }, icon),
      title || center
        ? import_react16.default.createElement(
            Center,
            { isIndented: !icon && isIndented },
            title && import_react16.default.createElement(Title5, { ...commonProps, loading }, title),
            center && import_react16.default.createElement(CenterText, { ...commonProps }, center)
          )
        : null,
      right && import_react16.default.createElement(Right, { ...commonProps }, right)
    );
  },
  ListItem_default = ListItem,
  List = newStyled.div({ minWidth: 180, overflow: "hidden", overflowY: "auto", maxHeight: 15.5 * 32 }, ({ theme }) => ({
    borderRadius: theme.appBorderRadius,
  })),
  Item2 = (props) => {
  ...
  TooltipLinkList = ({ links, LinkWrapper = null }) => {
    ...
    return import_react16.default.createElement(
      ...
      links.map(({ isGatsby, ...p }) =>
        import_react16.default.createElement(Item2, { key: p.id, LinkWrapper: isGatsby ? LinkWrapper : null, isIndented: hasIcon, ...p })
      )
    );
  },
...
function ForwardRefFunction({ children, ...rest }, ref) {
  ...
  if (isLink(o)) return import_react16.default.createElement("a", { ref: o.ref, ...o.props }, children);
  if (isButton(o)) return import_react16.default.createElement("button", { ref: o.ref, type: "button", ...o.props }, children);
...
var TabButton = newStyled(ButtonOrLink, { shouldForwardProp: isPropValid })(
  ...
  ({ active, textColor, theme }) =>
    active
      ...
      : { color: textColor || theme.barTextColor, borderBottomColor: "transparent", "&:hover": { color: theme.barHoverColor } }
);
...
var IconPlaceholder = newStyled.div(({ theme }) => ({
  ...
  IconButtonSkeleton = () =>
    import_react16.default.createElement(IconButtonSkeletonWrapper, null, import_react16.default.createElement(IconPlaceholder, null)),
  Side = newStyled.div(
...
var UnstyledBar = ({ children, className, scrollable }) =>
    scrollable
      ? import_react16.default.createElement(ScrollArea, { vertical: !1, className }, children)
  ...
  Bar = newStyled(UnstyledBar)(
    ...
    ({ theme, border = !1 }) => (border ? { boxShadow: `${theme.appBorderColor}  0 -1px 0 0 inset`, background: theme.barBg } : {})
  );
Bar.displayName = "Bar";
  ...
  FlexBar = ({ children, backgroundColor, className, ...rest }) => {
    ...
    return import_react16.default.createElement(
      ...
      import_react16.default.createElement(
        ...
        import_react16.default.createElement(Side, { scrollable: rest.scrollable, left: !0 }, left),
        right ? import_react16.default.createElement(Side, { right: !0 }, right) : null
      )
    );
  };
...
var VisuallyHidden = newStyled.div(({ active }) => (active ? { display: "block" } : { display: "none" })),
  childrenToList = (children) =>
    import_react16.Children.toArray(children).map(({ props: { title, id, color: color2, children: childrenOfChild } }) => {
      ...
      return {
        ...
        render:
          typeof content == "function"
            ? content
            : ({ active }) => import_react16.default.createElement(VisuallyHidden, { active, role: "tabpanel" }, content),
      };
    }),
...
function useList(list) {
    ...
    AddonTab = (0, import_react16.useCallback)(
      ({ menuName, actions }) => {
        let isAddonsActive = invisibleList.some(({ active }) => active),
          [isTooltipVisible, setTooltipVisible] = (0, import_react16.useState)(!1);
        return import_react16.default.createElement(
  ...
  return (
    (0, import_react16.useLayoutEffect)(setTabLists, [setTabLists, tabBarWidth]),
...
var Wrapper2 = newStyled.div(({ theme }) => ({
  ...
  Content3 = newStyled.div({ display: "flex", flexDirection: "column", gap: 4, maxWidth: 415 }),
  ...
  EmptyTabContent = ({ title, description, footer }) =>
    import_react16.default.createElement(
      ...
      import_react16.default.createElement(
        ...
        description && import_react16.default.createElement(Description3, null, description)
      ),
      footer
    ),
  ignoreSsrWarning2 =
  ...
  Wrapper3 = newStyled.div(
    ({ theme, bordered }) =>
      bordered
        ...
        : {},
    ({ absolute }) =>
      absolute ? { width: "100%", height: "100%", boxSizing: "border-box", display: "flex", flexDirection: "column" } : { display: "block" }
  ),
  TabBar = newStyled.div({ overflow: "hidden", "&:first-of-type": { marginLeft: -3 }, whiteSpace: "nowrap", flexGrow: 1 });
TabBar.displayName = "TabBar";
var Content4 = newStyled.div(
    { display: "block", position: "relative" },
    ({ theme }) => ({ fontSize: theme.typography.size.s2 - 1, background: theme.background.content }),
    ({ bordered, theme }) => (bordered ? { borderRadius: `0 0 ${theme.appBorderRadius - 1}px ${theme.appBorderRadius - 1}px` } : {}),
    ({ absolute, bordered }) =>
      absolute
        ? {
  ...
  TabWrapper = ({ active, render, children }) =>
    import_react16.default.createElement(VisuallyHidden, { active }, render ? render() : children),
  Tabs = (0, import_react16.memo)(
    ({
      ...
      let list = (0, import_react16.useMemo)(
          () => childrenToList(children).map((i, index3) => ({ ...i, active: selected ? i.id === selected : index3 === 0 })),
          [children, selected]
        ),
        { visibleList, tabBarRef, tabRefs, AddonTab } = useList(list),
        EmptyContent = emptyState ?? import_react16.default.createElement(EmptyTabContent, { title: "Nothing found" });
              ...
              import_react16.default.createElement(
                ...
                visibleList.map(({ title, id, active, color: color2 }, index3) => {
                  ...
                  return import_react16.default.createElement(
                    ...
                    typeof title == "function" ? import_react16.default.createElement("title", null) : title
                  );
                }),
                import_react16.default.createElement(AddonTab, { menuName, actions })
              ),
              tools
            ),
            import_react16.default.createElement(
              ...
              list.length
                ? list.map(({ id, active, render }) => import_react16.default.createElement(render, { key: id, active }, null))
                : EmptyContent
            )
          );
    }
...
var TabsState = class extends import_react16.Component {
  constructor(props) {
    super(props), (this.handlers = { onSelect: (id) => this.setState({ selected: id }) }), (this.state = { selected: props.initial });
  }
  render() {
...
TabsState.defaultProps = { children: [], initial: null, absolute: !1, bordered: !1, backgroundColor: "", menuName: void 0 };
...
var interleaveSeparators = (list) =>
      ...
      (acc, item, index3) =>
        item
          ? import_react16.default.createElement(
              ...
              acc,
              index3 > 0 ? import_react16.default.createElement(Separator, { key: `s-${index3}` }) : null,
              item.render() || item
            )
          : acc,
      null
  ...
  AddonPanel = ({ active, children }) => import_react16.default.createElement("div", { hidden: !active }, useUpdate(active, children)),
...
`,
  ...
  Symbols = (0, import_react16.memo)(function ({ icons: keys2 = Object.keys(icons) }) {
    return import_react16.default.createElement(
      Svg,
      { viewBox: "0 0 14 14", style: { position: "absolute", width: 0, height: 0 }, "data-chromatic": "ignore" },
      keys2.map((key2) => import_react16.default.createElement("symbol", { id: `icon--${key2}`, key: key2 }, icons[key2]))
    );
  }),
  icons = {
    user: "UserIcon",
  ...
  StorybookLogo = ({ alt, ...props }) =>
    import_react16.default.createElement(
      ...
      import_react16.default.createElement(
        ...
        import_react16.default.createElement("use", { fill: "#FF4785", fillRule: "nonzero", xlinkHref: "#a" }),
        import_react16.default.createElement("path", {
...
`,
  ...
  ErrorIcon = newStyled(LightningOffIcon)(({ theme }) => ({ width: 20, height: 20, marginBottom: "0.5rem", color: theme.textMutedColor })),
  ellipsis = keyframes`
  from { content: "..." }
  33% { content: "." }
  66% { content: ".." }
  ...
  Loader = ({ progress, error, size, ...props }) => {
    if (error)
      return import_react16.default.createElement(
        ...
        import_react16.default.createElement(ProgressMessage, null, error.message)
      );
    if (progress) {
      ...
      return (
        ...
        import_react16.default.createElement(
          ...
          import_react16.default.createElement(
            ProgressTrack,
            null,
            import_react16.default.createElement(ProgressBar, { style: { width: `${value2 * 100}%` } })
          ),
          import_react16.default.createElement(
            ProgressMessage,
            null,
            message,
            value2 < 1 && import_react16.default.createElement(Ellipsis, { key: message })
          )
        )
      );
    }
...
var getStoryHref = (baseUrl, storyId, additionalParams = {}) => {
    let [url, paramsStr] = baseUrl.split("?"),
      params = paramsStr ? { ...parseQuery(paramsStr), ...additionalParams, id: storyId } : { ...additionalParams, id: storyId };
...
`,
  ClipboardCode = ({ code, ...props }) => import_react16.default.createElement(Code2, { id: "clipboard-code", ...props }, code),
  components2 = components,
  resetComponents = {};
Object.keys(components).forEach((key2) => {
  resetComponents[key2] = (0, import_react16.forwardRef)((props, ref) => (0, import_react16.createElement)(key2, { ...props, ref }));
});
export {
  ARGTYPES_INFO_REQUEST,
  ARGTYPES_INFO_RESPONSE,
