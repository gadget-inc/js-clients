import { _extends, _objectWithoutPropertiesLoose, logger, newStyled, require_react, require_react_dom, scope } from "./chunk-B3YDJJJH.js";
import { __commonJS2 as __commonJS, __toESM, __toESM2, require_memoizerific } from "./chunk-ZR5JZWHI.js";
        ...
        (Prism2.languages.markdown = Prism2.languages.extend("markup", {})),
          Prism2.languages.insertBefore("markdown", "prolog", {
            "front-matter-block": {
              ...
              inside: {
                punctuation: /^---|---$/,
                "front-matter": { pattern: /\S+(?:\s+\S+)*/, alias: ["yaml", "language-yaml"], inside: Prism2.languages.yaml },
              },
            },
            ...
            table: {
              ...
              inside: {
                "table-data-rows": {
                  ...
                  lookbehind: !0,
                  inside: { "table-data": { pattern: RegExp(tableCell), inside: Prism2.languages.markdown }, punctuation: /\|/ },
                },
                "table-line": {
    ...
    function yaml(Prism) {
      (function (Prism2) {
        ...
        (Prism2.languages.yaml = {
          ...
          boolean: { pattern: createValuePattern(/false|true/.source, "i"), lookbehind: !0, alias: "important" },
          ...
          Prism2.languages.insertBefore(
            ...
            "special-attr",
            {
              script: {
                ...
                inside: { "script-punctuation": { pattern: /^=(?=\{)/, alias: "punctuation" }, rest: Prism2.languages.jsx },
              },
            },
            Prism2.languages.jsx.tag
          );
...
var require_immutable = __commonJS({
    ...
    "../../node_modules/hastscript/node_modules/property-information/find.js"(exports, module) {
      ...
      function find(schema, value) {
        ...
        return normal in schema.normal
          ...
          : (normal.length > 4 &&
              ...
              valid.test(value) &&
              (value.charAt(4) === "-" ? (prop = datasetToProperty(value)) : (value = datasetToAttribute(value)), (Type = DefinedInfo)),
            new Type(prop, value));
      }
      ...
      function datasetToAttribute(property) {
        ...
        return dash.test(value)
          ? property
          : ((value = value.replace(cap, kebab)), value.charAt(0) !== "-" && (value = "-" + value), data + value);
      }
      function kebab($0) {
  ...
  require_hast_util_parse_selector = __commonJS({
    "../../node_modules/hast-util-parse-selector/index.js"(exports, module) {
      ...
      function parse(selector, defaultTagName) {
        for (
          var value = selector || "", name = defaultTagName || "div", props = {}, start = 0, subvalue, previous, match;
          start < value.length;
      ...
      function factory(schema, defaultTagName, caseSensitive) {
        ...
        function h(selector, properties) {
          ...
          return (
            ...
            node.tagName === "template" && ((node.content = { type: "root", children: node.children }), (node.children = [])),
            node
          );
        }
        function addProperty(properties, key, value) {
          ...
          value == null ||
            ...
            property === "className" && properties.className && (result = properties.className.concat(result)),
      ...
      function isNode(tagName, value) {
        ...
        return tagName === "input" || !type || typeof type != "string"
          ...
          : ((type = type.toLowerCase()),
            tagName === "button" ? type !== "menu" && type !== "submit" && type !== "reset" && type !== "button" : "value" in value);
      }
    ...
    "../../node_modules/refractor/node_modules/parse-entities/decode-entity.browser.js"(exports, module) {
      ...
      function decodeEntity(characters) {
        ...
        return (
          ...
          (el.innerHTML = entity),
          (char = el.textContent),
          (char.charCodeAt(char.length - 1) === semicolon && characters !== "semi") || char === entity ? !1 : char
        );
      }
    },
  }),
              ...
              start = index + 1,
                ...
                following === numberSign
                  ? ((end = ++begin),
                    ...
                    following === uppercaseX || following === lowercaseX ? ((type = hexa), (end = ++begin)) : (type = deci))
                  : (type = name),
                entityCharacters = "",
                entity = "",
                characters = "",
  ...
  require_prism_core = __commonJS({
    "../../node_modules/refractor/node_modules/prismjs/components/prism-core.js"(exports, module) {
          ...
          var lang = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
            ...
            _ = {
              ...
              tokenize: function (text, grammar) {
                ...
                return (
                  addAfter(tokenList, tokenList.head, text), matchGrammar(text, tokenList, grammar, tokenList.head, 0), toArray(tokenList)
                );
              },
              hooks: {
                all: {},
            ...
            for (var token in grammar)
              if (!(!grammar.hasOwnProperty(token) || !grammar[token])) {
                ...
                for (var j = 0; j < patterns.length; ++j) {
                  ...
                  for (
                    var pattern = patternObj.pattern || patternObj, currentNode = startNode.next, pos = startPos;
      ...
      typeof module < "u" && module.exports && (module.exports = Prism), typeof global < "u" && (global.Prism = Prism);
    },
  }),
    ...
    function bash(Prism) {
      (function (Prism2) {
        var envVars =
          ...
          commandAfterHeredoc = { pattern: /(^(["']?)\w+\2)[ \t]+\S.*/, lookbehind: !0, alias: "punctuation", inside: null },
          insideString = {
        ...
        (Prism2.languages.bash = {
          ...
          "assign-left": {
            pattern: /(^|[\s;|&]|[<>]\()\w+(?=\+?=)/,
            inside: { environment: { pattern: RegExp("(^|[\\s;|&]|[<>]\\()" + envVars), lookbehind: !0, alias: "constant" } },
            alias: "variable",
            lookbehind: !0,
          },
          string: [
  ...
  "../../node_modules/refractor/lang/js-extras.js"(exports, module) {
    ...
    function jsExtras(Prism) {
      (function (Prism2) {
        ...
        for (
          var maybeClassNameTokens = ["function", "function-variable", "method", "method-variable", "property-access"], i = 0;
...
var $5e63c961fc1ce211$export$8c6ed5c666ac1360 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react2.createElement)($5e63c961fc1ce211$var$SlotClone, _extends2({}, slotProps, { ref: forwardedRef }), children);
});
...
var $5e63c961fc1ce211$export$d9f1ccf0bdb05d45 = ({ children }) => (0, import_react2.createElement)(import_react2.Fragment, null, children);
...
function AllLineNumbers(_ref2) {
  var codeString = _ref2.codeString,
    ...
    containerStyle = _ref2$containerStyle === void 0 ? { float: "left", paddingRight: "10px" } : _ref2$containerStyle,
...
function createLineElement(_ref3) {
  ...
  return (
    wrapLongLines & showLineNumbers && (properties.style = _objectSpread2(_objectSpread2({}, properties.style), {}, { display: "flex" })),
...
function highlight_default(defaultAstGenerator, defaultStyle) {
  return function (_ref7) {
    ...
    if (
      (wrapLongLines
        ? (codeTagProps.style = _objectSpread2(_objectSpread2({}, codeTagProps.style), {}, { whiteSpace: "pre-wrap" }))
        : (codeTagProps.style = _objectSpread2(_objectSpread2({}, codeTagProps.style), {}, { whiteSpace: "pre" })),
      !astGenerator)
    )
      return import_react3.default.createElement(
        PreTag,
...
var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
  let { present, children } = props,
    ...
    child = typeof children == "function" ? children({ present: presence.isPresent }) : import_react3.Children.only(children),
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
  ...
  let createScope = () => {
    ...
    return function (scope2) {
      ...
      return (0, import_react3.useMemo)(() => ({ [`__scope${scopeName}`]: { ...scope2, [scopeName]: contexts } }), [scope2, contexts]);
    };
  };
  return (
    (createScope.scopeName = scopeName),
    [$c512c27ab02ef895$export$fd42f52fd3ae1109, $c512c27ab02ef895$var$composeContextScopes(createScope, ...createContextScopeDeps)]
  );
}
...
var $57acba87d6e25586$var$SCROLL_AREA_NAME = "ScrollArea",
  [$57acba87d6e25586$var$createScrollAreaContext, $57acba87d6e25586$export$488468afe3a6f2b1] = $c512c27ab02ef895$export$50c7b4e9d9f19c1(
    $57acba87d6e25586$var$SCROLL_AREA_NAME
  ),
  [$57acba87d6e25586$var$ScrollAreaProvider, $57acba87d6e25586$var$useScrollAreaContext] = $57acba87d6e25586$var$createScrollAreaContext(
    $57acba87d6e25586$var$SCROLL_AREA_NAME
  ),
  $57acba87d6e25586$export$ccf8d8d7bbf3c2cc = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let { __scopeScrollArea, type = "hover", dir, scrollHideDelay = 600, ...scrollAreaProps } = props,
      ...
      composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d052(forwardedRef, (node) => setScrollArea(node)),
  ...
  $57acba87d6e25586$export$a21cbf9f11fca853 = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let { __scopeScrollArea, children, ...viewportProps } = props,
      context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$VIEWPORT_NAME, __scopeScrollArea),
      ref = (0, import_react3.useRef)(null),
      composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d052(forwardedRef, ref, context.onViewportChange);
    return (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)(
        ...
        (0, import_react3.createElement)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" } }, children)
      )
    );
  }),
  ...
  $57acba87d6e25586$export$2fabd85d0eba3c57 = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let { forceMount, ...scrollbarProps } = props,
      context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, props.__scopeScrollArea),
  ...
  $57acba87d6e25586$var$ScrollAreaScrollbarAuto = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, props.__scopeScrollArea),
  ...
  $57acba87d6e25586$var$ScrollAreaScrollbarVisible = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let { orientation = "vertical", ...scrollbarProps } = props,
      ...
      [sizes, setSizes] = (0, import_react3.useState)({ content: 0, viewport: 0, scrollbar: { size: 0, paddingStart: 0, paddingEnd: 0 } }),
            ...
            onThumbPositionChange: () => {
              if (context.viewport && thumbRef.current) {
                let scrollPos = context.viewport.scrollLeft,
                  offset = $57acba87d6e25586$var$getThumbOffsetFromScroll(scrollPos, sizes, context.dir);
  ...
  $57acba87d6e25586$var$ScrollAreaScrollbarX = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let { sizes, onSizesChange, ...scrollbarProps } = props,
      ...
      ref = (0, import_react3.useRef)(null),
      composeRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d052(forwardedRef, ref, context.onScrollbarXChange);
    return (
      (0, import_react3.useEffect)(() => {
          ...
          onWheelScroll: (event, maxScrollPos) => {
            if (context.viewport) {
              ...
              props.onWheelScroll(scrollPos),
                $57acba87d6e25586$var$isScrollingWithinScrollbarBounds(scrollPos, maxScrollPos) && event.preventDefault();
            }
          },
          onResize: () => {
            ref.current &&
  ...
  $57acba87d6e25586$var$ScrollAreaScrollbarY = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let { sizes, onSizesChange, ...scrollbarProps } = props,
      ...
      [computedStyle, setComputedStyle] = (0, import_react3.useState)(),
      ref = (0, import_react3.useRef)(null),
      composeRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d052(forwardedRef, ref, context.onScrollbarYChange);
    return (
      (0, import_react3.useEffect)(() => {
        ref.current && setComputedStyle(getComputedStyle(ref.current));
      }, [ref]),
  ...
  [$57acba87d6e25586$var$ScrollbarProvider, $57acba87d6e25586$var$useScrollbarContext] = $57acba87d6e25586$var$createScrollAreaContext(
  ...
  $57acba87d6e25586$var$ScrollAreaScrollbarImpl = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let {
      ...
      context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, __scopeScrollArea),
      [scrollbar, setScrollbar] = (0, import_react3.useState)(null),
      composeRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d052(forwardedRef, (node) => setScrollbar(node)),
        ...
        (0, import_react3.createElement)(
          ...
          _extends({}, scrollbarProps, {
            ...
            onPointerUp: $e42e1063c40fb3ef$export$b9ecd428b558ff10(props.onPointerUp, (event) => {
              let element = event.target;
              element.hasPointerCapture(event.pointerId) && element.releasePointerCapture(event.pointerId),
  ...
  $57acba87d6e25586$export$9fba1154677d7cd2 = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let { forceMount, ...thumbProps } = props,
      scrollbarContext = $57acba87d6e25586$var$useScrollbarContext($57acba87d6e25586$var$THUMB_NAME, props.__scopeScrollArea);
    return (0, import_react3.createElement)(
      $921a889cee6df7e8$export$99c2b779aa4e8b8b,
      { present: forceMount || scrollbarContext.hasThumb },
      (0, import_react3.createElement)($57acba87d6e25586$var$ScrollAreaThumbImpl, _extends({ ref: forwardedRef }, thumbProps))
    );
  }),
  $57acba87d6e25586$var$ScrollAreaThumbImpl = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let { __scopeScrollArea, style, ...thumbProps } = props,
      scrollAreaContext = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$THUMB_NAME, __scopeScrollArea),
      scrollbarContext = $57acba87d6e25586$var$useScrollbarContext($57acba87d6e25586$var$THUMB_NAME, __scopeScrollArea),
      { onThumbPositionChange } = scrollbarContext,
      composedRef = $6ed0406888f73fc4$export$c7b2cbe3552a0d052(forwardedRef, (node) => scrollbarContext.onThumbChange(node)),
    ...
    return (
      ...
      (0, import_react3.createElement)(
        ...
        _extends({ "data-state": scrollbarContext.hasThumb ? "visible" : "hidden" }, thumbProps, {
          ref: composedRef,
          style: { width: "var(--radix-scroll-area-thumb-width)", height: "var(--radix-scroll-area-thumb-height)", ...style },
  ...
  $57acba87d6e25586$export$56969d565df7cc4b = (0, import_react3.forwardRef)((props, forwardedRef) => {
    let context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$CORNER_NAME, props.__scopeScrollArea),
      hasBothScrollbarsVisible = !!(context.scrollbarX && context.scrollbarY);
    return context.type !== "scroll" && hasBothScrollbarsVisible
      ? (0, import_react3.createElement)($57acba87d6e25586$var$ScrollAreaCornerImpl, _extends({}, props, { ref: forwardedRef }))
      : null;
  }),
...
var $57acba87d6e25586$export$be92b6f5f03c0fe9 = $57acba87d6e25586$export$ccf8d8d7bbf3c2cc,
  ...
  ScrollArea = (0, import_react3.forwardRef)(
    ({ children, horizontal = !1, vertical = !1, offset = 2, scrollbarSize = 6, className }, ref) =>
      import_react3.default.createElement(
        ScrollAreaRoot,
        { scrollbarsize: scrollbarSize, offset, className },
        import_react3.default.createElement(ScrollAreaViewport, { ref }, children),
        horizontal &&
          import_react3.default.createElement(
            ScrollAreaScrollbar,
            { orientation: "horizontal", offset, horizontal: horizontal.toString(), vertical: vertical.toString() },
            import_react3.default.createElement(ScrollAreaThumb, null)
          ),
        vertical &&
          import_react3.default.createElement(
            ScrollAreaScrollbar,
            { orientation: "vertical", offset, horizontal: horizontal.toString(), vertical: vertical.toString() },
            import_react3.default.createElement(ScrollAreaThumb, null)
          ),
        horizontal && vertical && import_react3.default.createElement($57acba87d6e25586$export$ac61190d9fc311a9, null)
      )
  );
...
var Wrapper = newStyled.div(
    ...
    ({ theme, bordered }) =>
      bordered
        ? { border: `1px solid ${theme.appBorderColor}`, borderRadius: theme.borderRadius, background: theme.background.content }
        : {},
    ({ showLineNumbers }) =>
      showLineNumbers ? { ".react-syntax-highlighter-line-number::before": { content: "attr(data-line-number)" } } : {}
  ),
  ...
  defaultRenderer2 = ({ rows, stylesheet, useInlineStyles }) =>
    rows.map((node, i) => createElement({ node: processLineNumber(node), stylesheet, useInlineStyles, key: `code-segement${i}` })),
