try {
  (() => {
    ...
    var E = ((e) =>
      typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (o, a) => (typeof require < "u" ? require : o)[a] }) : e)(
      function (e) {
    ...
    var se = (e, o, a, r) => {
      if ((o && typeof o == "object") || typeof o == "function")
        for (let c of re(o)) !ie.call(e, c) && c !== a && F(e, c, { get: () => o[c], enumerable: !(r = te(o, c)) || r.enumerable });
      return e;
    };
    var le = (e, o, a) => (
      (a = e != null ? ne(ce(e)) : {}), se(o || !e || !e.__esModule ? F(a, "default", { value: e, enumerable: !0 }) : a, e)
    );
    var I = x(() => {});
    var d = x(() => {});
    var m = x(() => {});
              ...
              function (r, c, h) {
                ...
                (s.prototype.get = function (t) {
                  ...
                  (s.prototype.forEach = function (t, n) {
                    var l;
                    for (l = 0; l < this.size; l++) t.call(n || this, this.list[l].val, this.list[l].key, this);
                  }),
              ...
              function (r, c, h) {
                  ...
                  return function (b) {
                    var p = function () {
                      ...
                      return (
                        ...
                        i > 0 && ((B[T] = { cacheItem: g, arg: arguments[T] }), A ? t(u, B) : u.push(B), u.length > i && n(u.shift())),
                        (p.wasMemoized = A),
                        (p.numArgs = T + 1),
                        w
                      );
                ...
                function n(i) {
                  var f = i.length,
                    ...
                    b,
                    p;
                  for (u.cacheItem.delete(u.arg), p = f - 2; p >= 0 && ((u = i[p]), (b = u.cacheItem.get(u.arg)), !b || !b.size); p--)
      ...
      var c = r.reduce(function (t, n) {
        ...
        return l
          ? t.concat(
              l.map(function (i) {
                var f, u;
                return (u = (f = i.match(/[\t ]/g)) === null || f === void 0 ? void 0 : f.length) !== null && u !== void 0 ? u : 0;
              })
            )
          : t;
      }, []);
...
`)),
    ...
    var ee = "storybook/background",
        ...
        return e.disable
          ...
          : C.createElement(
              ...
              C.createElement(
                ...
                C.createElement(
                  N,
                  { key: "background", title: "Change the background of the preview", active: s !== "transparent" || o },
      ...
      fe = L(function () {
        ...
        return C.createElement(
          N,
          { key: "background", active: r, title: "Apply a grid to the preview", onClick: () => o({ [v]: { ...e[v], grid: !r } }) },
    ...
    P.register(ee, () => {
      P.add(ee, {
        ...
        render: () => C.createElement(R, null, C.createElement(pe, null), C.createElement(fe, null)),
      });
    });
  })();
} catch (e) {
