  ...
  (() => {
    ...
    var ue = (e, t, r, s) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let a of ae(t)) !le.call(e, a) && a !== r && H(e, a, { get: () => t[a], enumerable: !(s = ce(t, a)) || s.enumerable });
      return e;
    };
    var pe = (e, t, r) => (
      (r = e != null ? ie(se(e)) : {}), ue(t || !e || !e.__esModule ? H(r, "default", { value: e, enumerable: !0 }) : r, e)
    );
    var d = P(() => {});
    var h = P(() => {});
    var m = P(() => {});
            ...
            2: [
              function (s, a, S) {
                ...
                (u.prototype.get = function (i) {
                  ...
                  if (((o = this.indexOf(i)), o >= 0)) return (this.lastItem = this.list[o]), this.list[o].val;
                }),
                    ...
                    return this.lastItem && this.isEqual(this.lastItem.key, i)
                      ...
                      : ((f = this.indexOf(i)),
                        f >= 0
                          ...
                          : ((this.lastItem = { key: i, val: o }), this.list.push(this.lastItem), this.size++, this));
                  }),
                  (u.prototype.delete = function (i) {
                    var o;
                    if ((this.lastItem && this.isEqual(this.lastItem.key, i) && (this.lastItem = void 0), (o = this.indexOf(i)), o >= 0))
                  ...
                  (u.prototype.forEach = function (i, o) {
                    var f;
                    for (f = 0; f < this.size; f++) i.call(o || this, this.list[f].val, this.list[f].key, this);
                  }),
              ...
              function (s, a, S) {
                  ...
                  return function (g) {
                    var n = function () {
                      ...
                      return (
                        ...
                        c > 0 && ((E[y] = { cacheItem: p, arg: arguments[y] }), x ? i(l, E) : l.push(E), l.length > c && o(l.shift())),
                        (n.wasMemoized = x),
                        (n.numArgs = y + 1),
                        R
                      );
                    };
                    return (n.limit = c), (n.wasMemoized = !1), (n.cache = I), (n.lru = l), n;
                  };
                };
                function i(c, I) {
                  var l = c.length,
                ...
                function o(c) {
                  var I = c.length,
                    ...
                    g,
                    n;
                  for (l.cacheItem.delete(l.arg), n = I - 2; n >= 0 && ((l = c[n]), (g = l.cacheItem.get(l.arg)), !g || !g.size); n--)
    ...
    var k = "storybook/viewport",
      ...
      be = (0, N.default)(50)((e) => [...ye, ...Object.entries(e).map(([t, { name: r, ...s }]) => ({ ...s, id: t, title: r }))]),
      ...
      Ae = F(
        Q(({ theme: e }) => {
          let [t, r] = Y(),
            { viewports: s = we, defaultOrientation: a, defaultViewport: S, disable: u } = j(he, {}),
            i = be(s),
            o = K(),
            [f, c] = G(!1);
          S &&
            ...
            L(() => {
              let n = a === "landscape";
              ((S && t.viewport !== S) || (a && t.viewportRotated !== n)) && r({ viewport: S, viewportRotated: n });
            }, [a, S, r]);
          let I = i.find((n) => n.id === t.viewport) || i.find((n) => n.id === S) || i.find((n) => n.default) || B,
            l = q(),
              ...
              : w.createElement(
                  ...
                  w.createElement(
                    ...
                    w.createElement(
                      ...
                      g ? w.createElement(xe, null, t.viewportRotated ? `${I.title} (L)` : `${I.title} (P)`) : null
                    )
                  ),
                  g
                    ? w.createElement(
                        ...
                        null,
                        w.createElement(J, {
                          styles: { 'iframe[data-is-storybook="true"]': { ...(g || { width: "100%", height: "100%" }) } },
                        }),
                        ...
                        w.createElement(ne, { title: "Viewport height" }, g.height.replace("px", ""))
                      )
                    : null
                )
          );
