  ...
  (() => {
    ...
    function Co(e, t = {}) {
      ...
      function N(m, g) {
        ...
        P("--xlp", Dt(bt(Dn(g, 90) - 180), 0, 180, -u / 2, u / 2) + "px"), P("--dc", r - rt(1e3 * be()) + "ms");
    ...
    function Bn({ targetSelector: e, pulsating: t = !1 }) {
      ...
      `,
              ...
              (o.id = "sb-onboarding-pulsating-effect"), (o.innerHTML = r), document.head.appendChild(o);
    ...
    function Ee(e, t) {
      return C.plainObject(e) || C.array(e) ? (C.string(t) ? t.split(".").reduce((n, r) => n && n[r], e) : C.number(t) ? e[t] : e) : e;
    }
    function Ot(e, t) {
      if ([e, t].some(C.nullOrUndefined)) throw new Error("Missing required parameters");
      if (![e, t].every((n) => C.plainObject(n) || C.array(n))) throw new Error("Expected plain objects or array");
      return {
        added: (n, r) => {
          try {
    ...
    function He(e) {
      ...
      for (var t = qe(10) ? document.body : null, n = e.offsetParent || null; n === t && e.nextElementSibling; )
    ...
    function Jt(e, t) {
      ...
      var u = xe({ top: i.top - a.top - l, left: i.left - a.left - p, width: i.width, height: i.height });
      if (((u.marginTop = 0), (u.marginLeft = 0), !r && o)) {
        var d = parseFloat(c.marginTop),
          f = parseFloat(c.marginLeft);
        (u.top -= l - d), (u.bottom -= l - d), (u.left -= p - f), (u.right -= p - f), (u.marginTop = d), (u.marginLeft = f);
      }
      ...
      if (r === "viewport") i = li(a, o);
        ...
        if (s.nodeName === "HTML" && !_r(a)) {
          var l = Pr(e.ownerDocument),
            p = l.height,
            u = l.width;
          (i.top += c.top - c.marginTop), (i.bottom = p + c.top), (i.left += c.left - c.marginLeft), (i.right = u + c.left);
        } else i = c;
      }
      n = n || 0;
    ...
    function Lr(e, t, n) {
      ...
      var r = kr(e),
        ...
        c = i ? "height" : "width",
        l = i ? "width" : "height";
      return (o[a] = t[a] + t[c] / 2 - r[c] / 2), n === s ? (o[s] = t[s] - r[l]) : (o[s] = t[Tt(s)]), o;
    }
    function st(e, t) {
    ...
    function Mr(e, t, n) {
      ...
      return (
        r.forEach(function (o) {
          ...
          o.enabled && Rr(i) && ((t.offsets.popper = xe(t.offsets.popper)), (t.offsets.reference = xe(t.offsets.reference)), (t = i(t, o)));
        }),
        t
      );
    }
    function pi() {
      if (!this.state.isDestroyed) {
        ...
        (e.offsets.reference = Nr(this.state, this.popper, this.reference, this.options.positionFixed)),
          (e.placement = Ar(
    ...
    function fi(e, t, n, r) {
      ...
      var o = at(e);
      return Fr(o, "scroll", n.updateBound, n.scrollParents), (n.scrollElement = o), (n.eventsEnabled = !0), n;
    }
    function hi() {
      this.state.eventsEnabled || (this.state = fi(this.reference, this.options, this.state, this.scheduleUpdate));
    }
    function mi(e, t) {
      return (
    ...
    function vi(e, t, n, r, o) {
      ...
      return t.setAttribute("x-placement", a), Gt(t, { position: n.positionFixed ? "fixed" : "absolute" }), n;
    }
    function Ei(e, t) {
      var n = e.offsets,
        r = n.popper,
        ...
        h = t ? (p || u || d ? i : a) : s,
        b = t ? i : s;
      return { left: h(f && !u && t ? r.left - 1 : r.left), top: b(r.top), bottom: b(r.bottom), right: h(r.right) };
    }
    function Oi(e, t) {
      var n = t.x,
        r = t.y,
      ...
      var a = i !== void 0 ? i : t.gpuAcceleration,
        ...
        b = void 0;
      if (
        (u === "bottom" ? (s.nodeName === "HTML" ? (b = -s.clientHeight + p.bottom) : (b = -c.height + p.bottom)) : (b = p.top),
        d === "right" ? (s.nodeName === "HTML" ? (h = -s.clientWidth + p.right) : (h = -c.width + p.right)) : (h = p.left),
        a && f)
      )
        (l[f] = "translate3d(" + h + "px, " + b + "px, 0)"), (l[u] = 0), (l[d] = 0), (l.willChange = "transform");
      else {
        var N = u === "bottom" ? -1 : 1,
          v = d === "right" ? -1 : 1;
    ...
    function Ii(e, t) {
      if (jr(e.instance.modifiers, "inner") || (e.flipped && e.placement === e.originalPlacement)) return e;
      var n = Xt(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
      ...
      return (
        a.forEach(function (s, c) {
          ...
          var l = e.offsets.popper,
            ...
            v = (r === "left" && f) || (r === "right" && h) || (r === "top" && b) || (r === "bottom" && N),
            T = ["top", "bottom"].indexOf(r) !== -1,
            m =
              !!t.flipVariations &&
              ((T && i === "start" && f) || (T && i === "end" && h) || (!T && i === "start" && b) || (!T && i === "end" && N)),
            g =
              !!t.flipVariationsByContent &&
              ((T && i === "start" && h) || (T && i === "end" && f) || (!T && i === "start" && N) || (!T && i === "end" && b)),
            O = m || g;
          (d || v || O) &&
            ((e.flipped = !0),
            (d || v) && (r = a[c + 1]),
            O && (i = Ti(i)),
            (e.placement = r + (i ? "-" + i : "")),
            (e.offsets.popper = se({}, e.offsets.popper, Lr(e.instance.popper, e.offsets.reference, e.placement))),
    ...
    function Pi(e, t, n, r) {
      ...
      var c = /\s*,\s*|\s+/,
        l = s !== -1 ? [a.slice(0, s).concat([a[s].split(c)[0]]), [a[s].split(c)[1]].concat(a.slice(s + 1))] : [a];
      return (
    ...
    function xi(e, t) {
      ...
      var l = t.priority,
        ...
        u = {
          primary: function (d) {
            var f = p[d];
            return p[d] < c[d] && !t.escapeWithReference && (f = Math.max(p[d], c[d])), ze({}, d, f);
          },
          secondary: function (d) {
            var f = d === "right" ? "left" : "top",
              h = p[f];
            return p[d] > c[d] && !t.escapeWithReference && (h = Math.min(p[f], c[d] - (d === "right" ? p.width : p.height))), ze({}, f, h);
          },
        };
      return (
    ...
    function ki(e) {
      ...
      return (o[a ? "left" : "top"] = i[n] - (s ? o[a ? "width" : "height"] : 0)), (e.placement = Tt(t)), (e.offsets.popper = xe(o)), e;
    }
    function Pt(e) {
    ...
    function Xi(e, t) {
      ...
      var n = function (u, d) {
        ...
        i = function (u, d) {
          return A.defined(u) ? (console.warn("`changedTo` is deprecated! Replace it with `change`"), r(u, d)) : !1;
        },
        a = function (u, d, f) {
          if (!A.defined(u)) return !1;
          try {
      ...
      return { added: n, changed: r, changedFrom: o, changedTo: i, decreased: a, emptied: s, filled: c, increased: l, removed: p };
    }
    function sr(e, t) {
      var n = Object.keys(e);
    ...
    function ct(e, t, n) {
      return t && lr(e.prototype, t), n && lr(e, n), Object.defineProperty(e, "prototype", { writable: !1 }), e;
    }
    function re(e, t, n) {
      return (
        (t = zr(t)), t in e ? Object.defineProperty(e, t, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : (e[t] = n), e
      );
    }
    function ut(e, t) {
    ...
    function cr(e, t, n) {
      return (
        ...
        function (r, o, i) {
          ...
          return ia(t, r, o, i) ? (aa(r, o) ? e.apply(void 0, [r, o, i].concat(s)) : sa(r, o, i, n)) : e.apply(void 0, [r, o, i].concat(s));
        }
      );
    }
    function ve() {
    ...
    function Vr(e) {
      var t = e.content,
        ...
        s = e.title,
        c = e.styles,
        l = { content: y.isValidElement(t) ? t : y.createElement("div", { className: "__floater__content", style: c.content }, t) };
      return (
        s && (l.title = y.isValidElement(s) ? s : y.createElement("div", { className: "__floater__title", style: c.title }, s)),
        n && (l.footer = y.isValidElement(n) ? n : y.createElement("div", { className: "__floater__footer", style: c.footer }, n)),
        (a || i) && !A.boolean(o) && (l.close = y.createElement($r, { styles: c.close, handleClick: r })),
        y.createElement("div", { className: "__floater__container", style: c.container }, l.close, l.title, l.content, l.footer)
      );
    }
    function ha(e) {
    ...
    function Ea(e = !0) {
      ...
      if (!t || !n) return 0;
      if (e) {
        let r = [t.scrollHeight, t.offsetHeight, n.clientHeight, n.scrollHeight, n.offsetHeight].sort((i, a) => i - a),
    ...
    function ot(e, t = "fixed") {
      ...
      let { nodeName: n } = e,
        r = Sa(e);
      return n === "BODY" || n === "HTML" ? !1 : r && r.position === t ? !0 : e.parentNode ? ot(e.parentNode, t) : !1;
    }
    function wa(e) {
      var t;
      if (!e) return !1;
    ...
    function Ta(e, t, n) {
      ...
      let o = Xr(e),
        ...
        c = (r = o?.top) != null ? r : 0;
      return (
        i instanceof HTMLElement && ((s = i.scrollTop), !a && !ot(e) && (c += s), i.isSameNode(je()) || (c += je().scrollTop)),
        Math.floor(c - t)
      );
    }
    function Ia(e, t, n) {
      ...
      t &&
        (n && e
          ? (console.groupCollapsed(`%creact-joyride: ${n}`, "color: #ff0044; font-weight: bold; font-size: 12px;"),
            Array.isArray(e)
              ? e.forEach((i) => {
                  C.plainObject(i) && i.key ? o.apply(console, [i.key, i.value]) : o.apply(console, [i]);
                })
              : o.apply(console, [e]),
            console.groupEnd())
    ...
    function ja(e, t) {
      ...
      window.innerWidth > 480 && (f = 380),
        "width" in u && (f = typeof u.width == "number" && window.innerWidth < u.width ? window.innerWidth - 30 : u.width);
      let h = { bottom: 0, left: 0, overflow: "hidden", position: "absolute", right: 0, top: 0, zIndex: u.zIndex },
        b = {
          beacon: {
            ...nt,
          ...
          buttonClose: { ...nt, color: u.textColor, height: 14, padding: 15, position: "absolute", right: 0, top: 0, width: 14 },
          ...
          spotlightLegacy: { ...fr, boxShadow: `0 0 0 9999px ${u.overlayColor}, ${u.spotlightShadow}` },
          floaterStyles: {
            arrow: { color: (a = (i = (o = l?.styles) == null ? void 0 : o.arrow) == null ? void 0 : i.color) != null ? a : u.arrowColor },
    ...
    function Ue(e, t) {
      ...
      let c = t ?? {},
        ...
        d = vt.default.all([Na, (n = e.floaterProps) != null ? n : {}, (r = l.floaterProps) != null ? r : {}]);
      return (
        (d.offset = l.offset),
        (d.styles = (0, vt.default)((o = d.styles) != null ? o : {}, p.floaterStyles)),
        (d.offset += (a = (i = e.spotlightPadding) != null ? i : l.spotlightPadding) != null ? a : 0),
    ...
    function to(e, t = !1) {
      return C.plainObject(e)
        ? e.target
          ? !0
          : (Ae({ title: "validateStep", data: "target is missing from the step", warn: !0, debug: t }), !1)
    ...
    function Wa({ styles: e }) {
      return q("div", { key: "JoyrideSpotlight", className: "react-joyride__spotlight", "data-test-id": "spotlight", style: e });
    }
    ...
    function Va(e) {
      let {
        ...
        H = { primary: O };
      return (
        r && ((H.primary = i ? B : P), N && (H.primary = q("span", null, H.primary, " (", o + 1, "/", s, ")"))),
        H.primary && (H.primary = q("button", { "data-test-id": "button-primary", style: T.buttonNext, type: "button", ...a }, H.primary)),
        v &&
          !i &&
          (H.skip = q("button", { "aria-live": "off", "data-test-id": "button-skip", style: T.buttonSkip, type: "button", ...c }, V)),
        !d && o > 0 && (H.back = q("button", { "data-test-id": "button-back", style: T.buttonBack, type: "button", ...t }, g)),
        (H.close = !f && q($a, { "data-test-id": "button-close", styles: T.buttonClose, ...n })),
        q(
          "div",
          { key: "JoyrideTooltip", "aria-label": Pe(m) || Pe(u), className: "react-joyride__tooltip", style: T.tooltip, ...p },
          q(
            "div",
          ...
          !h && q("div", { style: T.tooltipFooter }, q("div", { style: T.tooltipFooterSpacer }, H.skip), H.back, H.primary),
          H.close
        )
      );
    }
      ...
      return (
        ...
        o === null
          ...
          : y.createElement(Qa, {
              ...
              tooltipComponent: ls,
              styles: {
                overlay: { mixBlendMode: "unset", backgroundColor: t[o]?.target === "body" ? "rgba(27, 28, 29, 0.2)" : "none" },
                spotlight: {
                ...
                options: { zIndex: 9998, primaryColor: a.color.secondary, arrowColor: a.color.secondary },
              },
            })
      );
    }
    function ws({ api: e }) {
      let [t, n] = ue(!0),
        ...
        v = Je(() => {
          e.emit(Wn, { step: "6:FinishedOnboarding", type: "telemetry" }), b("configure-your-project--docs"), N();
        }, [e, b, N]);
      if (
        (ae(() => {
        ...
        ae(
          () =>
            e.on(un, ({ payload: P, success: V }) => {
              !V || !P?.newStoryName || (h(P), o(!0), a("5:StoryCreated"), setTimeout(() => e.clearNotification("save-story-success")));
            }),
          [e]
        ),
        ...
        B = [
          ...
          },
          {
            ...
            content: y.createElement(
              ...
              y.createElement(Bn, { targetSelector: "button[aria-label='Create new story with these settings']" })
            ),
            offset: 6,
            placement: "top",
            disableBeacon: !0,
            ...
            content: y.createElement(
              ...
              g &&
                y.createElement(
                  kt,
                  { theme: Lt(gn.dark) },
                  y.createElement(Ss, null, y.createElement(mn, { language: "jsx", showLineNumbers: !0, startingLineNumber: O }, g))
                )
            ),
            offset: 12,
            placement: "right",
        ...
        (po = Object.create),
          ...
          (yo = (e, t, n, r) => {
            if ((t && typeof t == "object") || typeof t == "function")
              for (let o of br(t)) !mo.call(e, o) && o !== n && gr(e, o, { get: () => t[o], enumerable: !(r = fo(t, o)) || r.enumerable });
            return e;
          }),
          (De = (e, t, n) => (
            (n = e != null ? po(ho(e)) : {}), yo(t || !e || !e.__esModule ? gr(n, "default", { value: e, enumerable: !0 }) : n, e)
          )),
          (go = le({
            "../../node_modules/scroll/index.js"(e, t) {
              ...
              function a(l) {
                return function (p, u, d, f) {
                  (d = d || {}), typeof d == "function" && ((f = d), (d = {})), typeof f != "function" && (f = c);
                  var h = i(),
                    b = p[l],
                    N = d.ease || s,
          ...
          ($t = le({
            "../../node_modules/deepmerge/dist/cjs.js"(e, t) {
              ...
              function b(m, g) {
                return h(m, g) && !(Object.hasOwnProperty.call(m, g) && Object.propertyIsEnumerable.call(m, g));
              }
              function N(m, g, O) {
                var B = {};
                return (
                  ...
                  f(g).forEach(function (P) {
                    b(m, P) || (h(m, P) && O.isMergeableObject(g[P]) ? (B[P] = u(P, O)(m[P], g[P], O)) : (B[P] = l(g[P], O)));
                  }),
                  B
                );
              }
            ...
            "../../node_modules/prop-types/factoryWithTypeCheckers.js"(e, t) {
              ...
              t.exports = function (l, p) {
                ...
                function T(E) {
                  ...
                  function D(G, M, F, z, K, Y, w) {
                    ...
                    return M[F] == null
                      ? G
                        ? M[F] === null
                          ? new v("The " + K + " `" + Y + "` is marked as required " + ("in `" + z + "`, but its value is `null`."))
                          : new v("The " + K + " `" + Y + "` is marked as required in " + ("`" + z + "`, but its value is `undefined`."))
                        : null
                      : E(M, F, z, K, Y);
                  }
                  var L = D.bind(null, !1);
                ...
                function m(E) {
                  function x(W, D, L, G, M, F) {
                    ...
                    if (K !== E) {
                      var Y = Re(z);
                      return new v(
                        "Invalid " + G + " `" + M + "` of type " + ("`" + Y + "` supplied to `" + L + "`, expected ") + ("`" + E + "`."),
                        { expectedType: E }
                      );
                    }
                    return null;
                ...
                function O(E) {
                  function x(W, D, L, G, M) {
                    if (typeof E != "function")
                      return new v("Property `" + M + "` of component `" + L + "` has invalid PropType notation inside arrayOf.");
                    var F = W[D];
                    if (!Array.isArray(F)) {
                      var z = he(F);
                      return new v("Invalid " + G + " `" + M + "` of type " + ("`" + z + "` supplied to `" + L + "`, expected an array."));
                    }
                ...
                function B() {
                  function E(x, W, D, L, G) {
                    ...
                    if (!l(M)) {
                      var F = he(M);
                      return new v(
                        "Invalid " + L + " `" + G + "` of type " + ("`" + F + "` supplied to `" + D + "`, expected a single ReactElement.")
                      );
                    }
                    return null;
                  }
                    ...
                    if (!n.isValidElementType(M)) {
                      ...
                      return new v(
                        "Invalid " +
                          ...
                          G +
                          "` of type " +
                          ("`" + F + "` supplied to `" + D + "`, expected a single ReactElement type.")
                      );
                    }
                    return null;
                  }
                ...
                function te(E) {
                  function x(W, D, L, G, M) {
                    if (typeof E != "function")
                      return new v("Property `" + M + "` of component `" + L + "` has invalid PropType notation inside objectOf.");
                    var F = W[D],
                      z = he(F);
                    if (z !== "object")
                      return new v("Invalid " + G + " `" + M + "` of type " + ("`" + z + "` supplied to `" + L + "`, expected an object."));
                    for (var K in F)
                      if (i(F, K)) {
                        var Y = E(F, K, L, G, M + "." + K, o);
                        if (Y instanceof Error) return Y;
                ...
                function Ne(E) {
                  if (!Array.isArray(E)) return s("Invalid argument supplied to oneOfType, expected an instance of array."), c;
                ...
                function Ve() {
                  function E(x, W, D, L, G) {
                    return Te(x[W]) ? null : new v("Invalid " + L + " `" + G + "` supplied to " + ("`" + D + "`, expected a ReactNode."));
                  }
                  return T(E);
                }
                ...
                function Be(E) {
                  function x(W, D, L, G, M) {
                    var F = W[D],
                      z = he(F);
                    if (z !== "object")
                      return new v("Invalid " + G + " `" + M + "` of type `" + z + "` " + ("supplied to `" + L + "`, expected `object`."));
                    for (var K in E) {
                      var Y = E[K];
...
Valid keys: ` +
                ...
                function he(E) {
                  var x = typeof E;
                  return Array.isArray(E) ? "array" : E instanceof RegExp ? "object" : Ie(x, E) ? "symbol" : x;
                }
                function Re(E) {
        ...
        (Ln = 200),
          ...
          (jn = (e, t) => Array.from({ length: e }, (n, r) => ({ color: t[r % t.length], degree: (360 * r) / e }))),
          ...
          (No = 6),
          (ko = (e) => e !== 1 && Or());
        (Mo = ee.div({ zIndex: 9999, position: "fixed", top: 0, left: "50%", width: "50%", height: "100%" })),
          (jo = y.memo(function ({
            timeToFade: e = 5e3,
        ...
        I.domElement = (e) => I.object(e) && !I.plainObject(e) && e.nodeType === 1 && I.string(e.nodeName) && Vo.every((t) => t in e);
        I.empty = (e) =>
        ...
        (Vn = it && !!(window.MSInputMethodContext && document.documentMode)), (Kn = it && /MSIE 10/.test(navigator.userAgent));
        (ai = function (e, t) {
          if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
        }),
          (si = (function () {
        ...
        (Li = {
          ...
          computeStyle: { order: 850, enabled: !0, fn: Oi, gpuAcceleration: !0, x: "bottom", y: "right" },
            ...
            function e(t, n) {
              ...
              ai(this, e),
                ...
                Object.keys(se({}, e.Defaults.modifiers, o.modifiers)).forEach(function (a) {
                  r.options.modifiers[a] = se({}, e.Defaults.modifiers[a] || {}, o.modifiers ? o.modifiers[a] : {});
                }),
                ...
                this.modifiers.forEach(function (a) {
                  a.enabled && Rr(a.onLoad) && a.onLoad(r.reference, r.popper, r.options, a, r.state);
                }),
                this.update();
        ...
        (na = { flip: { padding: 20 }, preventOverflow: { padding: 10 } }),
          (ra = "The typeValidator argument must be a function with the signature function(props, propName, componentName)."),
          (oa = "The error message is optional, but must be a string if provided.");
        (U = { INIT: "init", IDLE: "idle", OPENING: "opening", OPEN: "open", CLOSING: "closing", ERROR: "error" }),
            ...
            ct(n, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var a = Me.unstable_renderSubtreeIntoContainer(this, o.length > 1 ? y.createElement("div", null, o) : o[0], this.node);
                  return i(a), null;
                },
              },
              {
                  ...
                  return (
                    ...
                    y.createElement(
                      ...
                      y.createElement(
                        ...
                        y.createElement(
                          "svg",
                          { width: N, height: v, version: "1.1", xmlns: "http://www.w3.org/2000/svg" },
        ...
        $r.propTypes = { handleClick: S.default.func.isRequired, styles: S.default.object.isRequired };
        Vr.propTypes = {
            ...
            ct(n, [
              {
                ...
                value: function () {
                  ...
                  return d
                    ? y.createElement("span", { ref: l, style: J(J({}, u), p), onClick: i, onMouseEnter: a, onMouseLeave: s }, d)
                    : null;
                },
              },
            ]),
              ...
              return (
                ...
                re(we(o), "handleClick", function () {
                  ...
                  if (!A.boolean(s)) {
                    ...
                    (o.event === "click" || (o.event === "hover" && l)) &&
                      (St({ title: "click", data: [{ event: a, status: p === U.OPEN ? "closing" : "opening" }], debug: o.debug }),
                      o.toggle());
                  }
                }),
                re(we(o), "handleMouseEnter", function () {
                  ...
                  if (!(A.boolean(s) || Wt())) {
                    ...
                    o.event === "hover" &&
                      c === U.IDLE &&
                      (St({ title: "mouseEnter", data: [{ key: "originalEvent", value: a }], debug: o.debug }),
                ...
                re(we(o), "handleMouseLeave", function () {
                  ...
                  if (!(A.boolean(c) || Wt())) {
                    var l = o.state,
                      ...
                      u = l.positionWrapper;
                    o.event === "hover" &&
                      (St({ title: "mouseLeave", data: [{ key: "originalEvent", value: a }], debug: o.debug }),
                      s
              ...
              ct(n, [
                ...
                },
                {
                  ...
                  value: function (r, o) {
                    if (ve()) {
                      ...
                      (r.wrapperOptions.position !== l.position || r.target !== c) && this.changeWrapperPosition(this.props),
                        d("status", U.IDLE) && s ? this.toggle(U.OPEN) : u("status", U.INIT, U.IDLE) && a && this.toggle(U.OPEN),
                ...
                },
                {
                  ...
                  value: function () {
                    var r = this,
                      ...
                      u = a.placement,
                      d = a.wrapperOptions,
                      f = u === "top" || u === "bottom" ? "flip" : ["right", "bottom-end", "top-end", "left", "top-start", "bottom-start"];
                    if (u === "center") this.setState({ status: U.IDLE });
                      ...
                      new Zn(o, this.floaterRef, {
                        ...
                        onCreate: function (g) {
                          var O;
                          if (((r.popper = g), !((O = r.floaterRef) !== null && O !== void 0 && O.isConnected))) {
                            r.setState({ needsUpdate: !0 });
                            return;
                          }
                          c(g, "floater"),
                            r._isMounted && r.setState({ currentPlacement: g.placement, status: U.IDLE }),
                            u !== g.placement &&
                              setTimeout(function () {
                                g.instance.update();
                              }, 1);
                        ...
                        onUpdate: function (g) {
                          ...
                          r._isMounted && g.placement !== O && r.setState({ currentPlacement: g.placement });
                        },
                      });
                    }
                    if (i) {
                      ...
                      new Zn(this.target, this.wrapperRef, {
                        ...
                        modifiers: { arrow: { enabled: !1 }, offset: { offset: "0, ".concat(m, "px") }, flip: { enabled: !1 } },
                        onCreate: function (g) {
                          (r.wrapperPopper = g),
                ...
                },
                {
                  ...
                  get: function () {
                    ...
                    return r || (ve() && "ReactFloaterDebug" in window && !!window.ReactFloaterDebug);
                  },
                },
                {
                  key: "event",
                ...
                },
                {
                  ...
                  get: function () {
                    ...
                    if (a) {
                      var p;
                      [U.IDLE].indexOf(i) === -1 || [U.IDLE].indexOf(s) === -1 ? (p = l.wrapperPosition) : (p = this.wrapperPopper.styles),
                ...
                },
                {
                  ...
                  get: function () {
                    ...
                    return r ? (A.domElement(r) ? r : document.querySelector(r)) : this.childRef || this.wrapperRef;
                  },
                },
                {
                  key: "render",
        ...
        (ga = De(To(), 1)),
          ...
          (va = (e, t, n) => (t in e ? ba(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n))),
        ...
        tt = mt !== void 0;
        (Na = { options: { preventOverflow: { boundariesElement: "scrollParent" } }, wrapperOptions: { offset: -18, position: !0 } }),
          (eo = { back: "Back", close: "Close", last: "Last", next: "Next", open: "Open the dialog", skip: "Skip" }),
          (ka = {
            event: "click",
            placement: "bottom",
            offset: 10,
        ...
        (no = { action: "init", controlled: !1, index: 0, lifecycle: k.INIT, origin: null, size: 0, status: j.IDLE }),
          ...
          (Fa = class {
            constructor(e) {
              _(this, "beaconPopper"),
                ...
                _(this, "setSteps", (o) => {
                  ...
                  this.data.set("steps", o), a === j.WAITING && !i && o.length && (s.status = j.RUNNING), this.setState(s);
                }),
                _(this, "getPopper", (o) => (o === "beacon" ? this.beaconPopper : this.tooltipPopper)),
                ...
                _(this, "close", (o = null) => {
                  ...
                  a === j.RUNNING && this.setState({ ...this.getNextState({ action: $.CLOSE, index: i + 1, origin: o }) });
                }),
                _(this, "go", (o) => {
                  let { controlled: i, status: a } = this.getState();
                  if (i || a !== j.RUNNING) return;
                  let s = this.getSteps()[o];
                  this.setState({ ...this.getNextState({ action: $.GO, index: o }), status: s ? a : j.FINISHED });
                }),
                _(this, "info", () => this.getState()),
                _(this, "next", () => {
                  let { index: o, status: i } = this.getState();
                  i === j.RUNNING && this.setState(this.getNextState({ action: $.NEXT, index: o + 1 }));
                }),
                _(this, "open", () => {
                  let { status: o } = this.getState();
                  o === j.RUNNING && this.setState({ ...this.getNextState({ action: $.UPDATE, lifecycle: k.TOOLTIP }) });
                }),
                _(this, "prev", () => {
                  let { index: o, status: i } = this.getState();
                  i === j.RUNNING && this.setState({ ...this.getNextState({ action: $.PREV, index: o - 1 }) });
                }),
                _(this, "reset", (o = !1) => {
                  let { controlled: i } = this.getState();
                  i || this.setState({ ...this.getNextState({ action: $.RESET, index: 0 }), status: o ? j.RUNNING : j.READY });
                }),
                _(this, "skip", () => {
                  let { status: o } = this.getState();
                  o === j.RUNNING && this.setState({ action: $.SKIP, lifecycle: k.INIT, status: j.SKIPPED });
                }),
                _(this, "start", (o) => {
                ...
                _(this, "stop", (o = !1) => {
                  ...
                  [j.FINISHED, j.SKIPPED].includes(a) ||
                    this.setState({ ...this.getNextState({ action: $.STOP, index: i + (o ? 1 : 0) }), status: j.PAUSED });
                }),
                _(this, "update", (o) => {
                  var i, a;
                  if (!Ca(o, mr)) throw new Error(`State is not valid. Valid keys: ${mr.join(", ")}`);
                  this.setState({
                    ...this.getNextState(
                      {
                        ...this.getState(),
            ...
            setState(e, t = !1) {
              let n = this.getState(),
                { action: r, index: o, lifecycle: i, origin: a = null, size: s, status: c } = { ...n, ...e };
        ...
        (Ua = Wa),
          (Ha = class extends Le {
            ...
            get overlayStyles() {
              ...
              return (
                ...
                { cursor: t ? "default" : "pointer", height: Ea(), pointerEvents: e ? "none" : "auto", ...o }
              );
            }
            get spotlightStyles() {
              var e, t, n;
              let { showSpotlight: r } = this.state,
                { disableScrollParentFix: o = !1, spotlightClicks: i, spotlightPadding: a = 0, styles: s, target: c } = this.props,
                l = _e(c),
                p = Xr(l),
                u = ot(l),
                d = Ta(l, a, o);
            ...
            render() {
              ...
              return q(
                "div",
                { className: "react-joyride__overlay", "data-test-id": "overlay", onClick: t, role: "presentation", style: o },
                a
              );
            }
          }),
          (Ga = class extends Le {
            ...
            componentWillUnmount() {
              !Ce() ||
                !this.node ||
                (tt || ln(this.node), this.node.parentNode === document.body && (document.body.removeChild(this.node), (this.node = null)));
            }
            renderReact15() {
              if (!Ce()) return;
            ...
            constructor(e, t) {
              if (
                ...
                _(this, "canHaveFocus", (n) => {
                  ...
                  return ((r.test(o) && !n.getAttribute("disabled")) || (o === "a" && !!n.getAttribute("href"))) && this.isVisible(n);
                }),
                _(this, "findValidTabElements", () => [].slice.call(this.element.querySelectorAll("*"), 0).filter(this.canBeTabbed)),
                ...
                _(this, "isHidden", (n) => {
                  ...
                  return r && !n.innerHTML
                    ? !0
                    : (r && o.getPropertyValue("overflow") !== "visible") || o.getPropertyValue("display") === "none";
                }),
                _(this, "isVisible", (n) => {
                  let r = n;
                  for (; r; )
      ...
      `)
            ...
            render() {
              let {
                ...
                p = { "aria-label": l, onClick: i, onMouseEnter: i, ref: this.setBeaconRef, title: l },
                u;
              return (
                e
        ...
        (Ka = Va),
          (Ja = class extends Le {
              ...
              super(...arguments),
                ...
                _(this, "getElementsProps", () => {
                  ...
                  return (
                    t && (l = a),
                    {
                      backProps: { "aria-label": o, "data-action": "back", onClick: this.handleClickBack, role: "button", title: o },
                      closeProps: { "aria-label": i, "data-action": "close", onClick: this.handleClickClose, role: "button", title: i },
                      primaryProps: {
                        "aria-label": l,
                        "data-action": "primary",
            ...
            render() {
              let { continuous: e, index: t, isLastStep: n, setTooltipRef: r, size: o, step: i } = this.props,
                { beaconComponent: a, tooltipComponent: s, ...c } = i,
                l;
              if (s) {
                let p = { ...this.getElementsProps(), continuous: e, index: t, isLastStep: n, size: o, step: c, setTooltipRef: r };
                l = q(s, { ...p });
              } else l = q(Ka, { ...this.getElementsProps(), continuous: e, index: t, isLastStep: n, size: o, step: i });
              return l;
            }
          }),
          (Xa = class extends Le {
              ...
              super(...arguments),
                ...
                _(this, "setPopper", (e, t) => {
                  ...
                  t === "wrapper" ? a.setPopper("beacon", e) : a.setPopper("tooltip", e),
                    a.getPopper("beacon") && a.getPopper("tooltip") && o === k.INIT && a.update({ action: r, lifecycle: k.READY }),
            ...
            componentDidUpdate(e) {
              ...
              let {
                ...
                g = i && c === e.index;
              if (
                (m && (T || g) && r({ ...b, index: e.index, lifecycle: k.COMPLETE, step: e.step, type: pe.STEP_AFTER }),
                u.placement === "center" &&
                  p === j.RUNNING &&
                  f("index") &&
                  n !== $.START &&
                ...
                let O = _e(u.target),
                  B = !!O;
                B && wa(O)
                  ? (h("status", j.READY, j.RUNNING) || h("lifecycle", k.INIT, k.READY)) && r({ ...b, step: u, type: pe.STEP_BEFORE })
                  : (console.warn(B ? "Target not visible" : "Target not mounted", u),
                    r({ ...b, type: pe.TARGET_NOT_FOUND, step: u }),
                    i || d.update({ index: c + (n === $.PREV ? -1 : 1) }));
              }
              h("lifecycle", k.INIT, k.READY) && d.update({ lifecycle: pr(u) || N ? k.TOOLTIP : k.BEACON }),
                f("index") && Ae({ title: `step:${l}`, data: [{ key: "props", value: this.props }], debug: a }),
                f("lifecycle", k.BEACON) && r({ ...b, step: u, type: pe.BEACON }),
                f("lifecycle", k.TOOLTIP) &&
                  (r({ ...b, step: u, type: pe.TOOLTIP }),
                  this.tooltip && ((this.scope = new za(this.tooltip, { selector: "[data-action=primary]" })), this.scope.setFocus())),
                h("lifecycle", [k.TOOLTIP, k.INIT], k.INIT) && ((t = this.scope) == null || t.removeScope(), d.cleanupPoppers());
            }
            componentWillUnmount() {
              var e;
            ...
            render() {
              let { continuous: e, debug: t, index: n, nonce: r, shouldScroll: o, size: i, step: a } = this.props,
                s = _e(a.target);
          ...
          (ro = class extends Le {
            constructor(e) {
              super(e),
                ...
                _(this, "handleKeyboard", (a) => {
                  let { index: s, lifecycle: c } = this.state,
                    { steps: l } = this.props,
                    p = l[s];
                  c === k.TOOLTIP && a.code === "Escape" && p && !p.disableCloseOnEsc && this.store.close("keyboard");
                }),
              ...
              (this.store = Ba({ ...e, controlled: r && C.number(o) })), (this.helpers = this.store.getHelpers());
            ...
            componentDidMount() {
              ...
              let { debug: e, disableCloseOnEsc: t, run: n, steps: r } = this.props,
                { start: o } = this.store;
              hr(r, e) && n && o(), t || document.body.addEventListener("keydown", this.handleKeyboard, { passive: !0 });
            }
            componentDidUpdate(e, t) {
              ...
              let { action: n, controlled: r, index: o, lifecycle: i, status: a } = this.state,
                ...
                V = _e(O.target);
              if ((B && (hr(p, s) ? h(p) : console.warn("Steps are not valid", p)), T("run") && (c ? b(l) : N()), P)) {
                let te = C.number(u) && u < l ? $.NEXT : $.PREV;
                n === $.STOP && (te = $.START),
                  [j.FINISHED, j.SKIPPED].includes(a) || v({ action: n === $.CLOSE ? $.CLOSE : te, index: l, lifecycle: k.INIT });
              }
              !r &&
                a === j.RUNNING &&
                o === 0 &&
                !V &&
                (this.store.update({ index: o + 1 }), this.callback({ ...this.state, type: pe.TARGET_NOT_FOUND, step: O }));
              let H = { ...this.state, index: o, step: O };
              if (m("action", [$.NEXT, $.PREV, $.SKIP, $.CLOSE]) && m("status", j.PAUSED)) {
                let te = Ue(this.props, p[t.index]);
                this.callback({ ...H, index: t.index, lifecycle: k.COMPLETE, step: te, type: pe.STEP_AFTER });
              }
              if (m("status", [j.FINISHED, j.SKIPPED])) {
                let te = Ue(this.props, p[t.index]);
                r || this.callback({ ...H, index: t.index, lifecycle: k.COMPLETE, step: te, type: pe.STEP_AFTER }),
                ...
                g("status", [j.IDLE, j.READY], j.RUNNING)
                  ...
                  : (m("status") || m("action", $.RESET)) && this.callback({ ...H, type: pe.TOUR_STATUS });
              this.scrollToStep(t),
                O.placement === "center" && a === j.RUNNING && i === k.INIT && this.store.update({ lifecycle: k.READY });
            }
            componentWillUnmount() {
            ...
            scrollToStep(e) {
              let { index: t, lifecycle: n, status: r } = this.state,
                ...
                p = Ue(this.props, l[t]),
                u = _e(p.target),
                d = Aa({ isFirstStep: t === 0, lifecycle: n, previousLifecycle: e.lifecycle, scrollToFirstStep: c, step: p, target: u });
              if (r === j.RUNNING && d) {
                let f = dt(u, i),
                  h = _t(u, i),
                ...
                if (n === k.BEACON && N) {
                  ...
                  ["top", "right", "left"].includes(g) && !T && !f ? (b = Math.floor(m.popper.top - s)) : (b -= p.spotlightPadding);
                }
                (b = b >= 0 ? b : 0),
                  r === j.RUNNING &&
            ...
            render() {
              ...
              let { index: e, lifecycle: t, status: n } = this.state,
                { continuous: r = !1, debug: o = !1, nonce: i, scrollToFirstStep: a = !1, steps: s } = this.props,
                c = n === j.RUNNING,
                l = {};
              if (c && s[e]) {
                ...
                (l.step = q(Xa, {
                  ...
                  (l.overlay = q(
                    ...
                    q(Ha, { ...p, continuous: r, debug: o, lifecycle: t, onClickOverlay: this.handleClickOverlay })
                  ));
              }
  ...
  &:hover {
    background-color: ${({ theme: e, variant: t }) =>
      t === "primary"
        ? "#0b94eb"
        : t === "secondary"
        ? "#eef4f9"
...
`),
  ...
  font-size: 13px;
`),
          (ls = ({ index: e, size: t, step: n, closeProps: r, primaryProps: o, tooltipProps: i }) => (
            ae(() => {
            ...
            y.createElement(
              ...
              y.createElement(
                ...
                y.createElement(
                  ...
                  y.createElement(hn, { ...r, onClick: r.onClick, variant: "solid" }, y.createElement(Sn, null))
                ),
              ...
              y.createElement(
                ...
                !n.hideNextButton &&
                  y.createElement(es, { ...o, onClick: n.onNextButtonClick || o.onClick, variant: "white" }, e + 1 === t ? "Done" : "Next")
              )
            )
          ));
        (us = Xe({ from: { opacity: 0 }, to: { opacity: 1 } })),
          (oo = Xe({ from: { transform: "translate(0, 20px)", opacity: 0 }, to: { transform: "translate(0, 0)", opacity: 1 } })),
          (ps = Xe({ from: { opacity: 0, transform: "scale(0.8)" }, to: { opacity: 1, transform: "scale(1)" } })),
          (ds = Xe({ "0%": { transform: "rotate(0deg)" }, "100%": { transform: "rotate(360deg)" } })),
          (fs = ee.div(({ visible: e }) => ({
            position: "fixed",
            top: 0,
            left: 0,
              ...
              y.createElement(
                ...
                y.createElement(
                  ...
                  y.createElement(
                    ...
                    y.createElement(yr, { xmlns: "http://www.w3.org/2000/svg" }, y.createElement("circle", null)),
                    y.createElement(
                      yr,
                      { xmlns: "http://www.w3.org/2000/svg", progress: !0 },
                      y.createElement("circle", { strokeDashoffset: Math.PI * 48 * (1 - Math.max(0, Math.min(n, 100)) / 100) })
                    )
                  )
                )
              )
    ...
    fn.register("@storybook/addon-onboarding", async (e) => {
      ...
      e.once(pn, () => {
        ...
        (r.id = "storybook-addon-onboarding"),
          ...
          Me.render(y.createElement(rn, { fallback: y.createElement("div", null) }, y.createElement(Ts, { api: e })), r);
      });
    });
  })();
} catch (e) {
