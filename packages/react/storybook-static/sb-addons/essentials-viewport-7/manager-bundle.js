try {
  (() => {
    ...
    var O = ((e) =>
      typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (t, a) => (typeof require < "u" ? require : t)[a] }) : e)(
      function (e) {
    ...
    var ye = (e, t, a, s) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let c of fe(t)) !we.call(e, c) && c !== a && J(e, c, { get: () => t[c], enumerable: !(s = me(t, c)) || s.enumerable });
      return e;
    };
    var Se = (e, t, a) => (
      (a = e != null ? he(ge(e)) : {}), ye(t || !e || !e.__esModule ? J(a, "default", { value: e, enumerable: !0 }) : a, e)
    );
    var f = H(() => {});
    var g = H(() => {});
    var w = H(() => {});
                    ...
                    return this.lastItem && this.isEqual(this.lastItem.key, o)
                      ...
                      : ((h = this.indexOf(o)),
                        h >= 0
                          ...
                          : ((this.lastItem = { key: o, val: i }), this.list.push(this.lastItem), this.size++, this));
                  }),
                  (p.prototype.delete = function (o) {
                    var i;
                    if ((this.lastItem && this.isEqual(this.lastItem.key, o) && (this.lastItem = void 0), (i = this.indexOf(o)), i >= 0))
              ...
              function (s, c, b) {
                  ...
                  return function (u) {
                    var I = function () {
                      ...
                      return (
                        ...
                        n > 0 && ((M[S] = { cacheItem: m, arg: arguments[S] }), A ? o(r, M) : r.push(M), r.length > n && i(r.shift())),
                        (I.wasMemoized = A),
                        (I.numArgs = S + 1),
                        k
                      );
                ...
                function i(n) {
                  var d = n.length,
                    ...
                    u,
                    I;
                  for (r.cacheItem.delete(r.arg), I = d - 2; I >= 0 && ((r = n[I]), (u = r.cacheItem.get(r.arg)), !u || !u.size); I--)
    ...
    var $ = Se(le()),
      ...
      Le = ({ api: e }) => {
        ...
        if (typeof r.styles == "function")
          return console.warn("Addon Viewport no longer supports dynamic styles using a function, use css calc() instead"), null;
      ...
      Be = l.memo(function (e) {
        ...
        return l.createElement(
          ...
          l.createElement(Y, { styles: { 'iframe[data-is-storybook="true"]': { width: h, height: n } } }),
          t !== P
            ? l.createElement(
                Ae,
                null,
      ...
      Pe = (0, $.default)(50)((e) => [...Me, ...Object.entries(e).map(([t, { name: a, ...s }]) => ({ ...s, id: t, title: a }))]),
      ...
      Fe = Q(function () {
        ...
        c &&
          ...
          _(() => {
            let u = s === "landscape";
            ((c && e.viewport !== c) || (s && e.viewportRotated !== u)) && t({ viewport: c, viewportRotated: u });
          }, [s, c, t]);
        let n = p.find((u) => u.id === e.viewport) || p.find((u) => u.id === c) || p.find((u) => u.default) || D,
          d = ee(),
            ...
            : l.createElement(
                ...
                l.createElement(
                  ...
                  l.createElement(
                    ...
                    l.createElement(j, null),
                    r ? l.createElement(ze, null, e.viewportRotated ? `${n.title} (L)` : `${n.title} (P)`) : null
                  )
                ),
                r
                  ? l.createElement(
                      ...
                      null,
                      l.createElement(Y, {
                        styles: { 'iframe[data-is-storybook="true"]': { ...(r || { width: "100%", height: "100%" }) } },
                      }),
