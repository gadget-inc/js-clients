try {
  (() => {
    ...
    function L(e, t) {
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of e) if (((a = n), (a && typeof a == "object" && ((a = Ue(t, a)), !a)) || !t.has(a))) return !1;
          return !0;
        }
        if (r === Map) {
          if (e.size !== t.size) return !1;
          for (n of e) if (((a = n[0]), (a && typeof a == "object" && ((a = Ue(t, a)), !a)) || !L(n[1], t.get(a)))) return !1;
          return !0;
        }
        ...
        if (!r || typeof e == "object") {
          n = 0;
          for (r in e) if ((je.call(e, r) && ++n && !je.call(t, r)) || !(r in t) || !L(e[r], t[r])) return !1;
    ...
    var gt = /^#[a-fA-F0-9]{6}$/,
      ...
      yt = /^rgb(?:a)?\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i,
      Ot = /^hsl\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*\)$/i,
      Tt =
    ...
    function _t(e) {
      var t = e.red / 255,
        ...
        s = (a + i) / 2;
      if (a === i)
        return e.alpha !== void 0 ? { hue: 0, saturation: 0, lightness: s, alpha: e.alpha } : { hue: 0, saturation: 0, lightness: s };
      var l,
        u = a - i,
      ...
      return (
        (l *= 60), e.alpha !== void 0 ? { hue: l, saturation: c, lightness: s, alpha: e.alpha } : { hue: l, saturation: c, lightness: s }
      );
    }
    function A(e) {
      return _t(I(e));
    ...
    function At(e, t, r, n) {
      ...
      if (typeof e == "object" && t === void 0 && r === void 0 && n === void 0)
        return e.alpha >= 1 ? $(e.hue, e.saturation, e.lightness) : "rgba(" + H(e.hue, e.saturation, e.lightness) + "," + e.alpha + ")";
      throw new _(2);
    }
    function ue(e, t, r) {
      if (typeof e == "number" && typeof t == "number" && typeof r == "number") return le("#" + w(e) + w(t) + w(r));
      if (typeof e == "object" && t === void 0 && r === void 0) return le("#" + w(e.red) + w(e.green) + w(e.blue));
      throw new _(6);
    }
    function Y(e, t, r, n) {
      if (typeof e == "string" && typeof t == "number") {
        ...
        if (typeof e == "object" && t === void 0 && r === void 0 && n === void 0)
          return e.alpha >= 1 ? ue(e.red, e.green, e.blue) : "rgba(" + e.red + "," + e.green + "," + e.blue + "," + e.alpha + ")";
      }
      throw new _(7);
    }
    var Ct = function (t) {
    ...
    var nl = v(jt);
    function Ut(e, t) {
      return t === "transparent" ? t : C(O({}, A(t), { lightness: parseFloat(e) }));
    }
    var al = v(Ut);
    function kt(e, t) {
      return t === "transparent" ? t : C(O({}, A(t), { saturation: parseFloat(e) }));
    }
    var ol = v(kt);
    function Gt(e, t) {
    ...
    var $t = Object.create,
      ...
      Zt = (e, t, r, n) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let a of et(t)) !qt.call(e, a) && a !== r && ge(e, a, { get: () => t[a], enumerable: !(n = Yt(t, a)) || n.enumerable });
        return e;
      },
      Kt = (e, t, r) => (
        (r = e != null ? $t(Jt(e)) : {}), Zt(t || !e || !e.__esModule ? ge(r, "default", { value: e, enumerable: !0 }) : r, e)
      ),
      Qt = be({
      ...
      X = {};
    Xt(X, { chromeDark: () => rr, chromeLight: () => nr });
    var rr = {
      ...
      J = (e) => ({
        ...
        TreeNode: {
          ...
          treeNodePlaceholder: { whiteSpace: "pre", fontSize: e.ARROW_FONT_SIZE, marginRight: e.ARROW_MARGIN_RIGHT, ...ce },
          treeNodeArrow: {
            base: {
              color: e.ARROW_COLOR,
              ...
              ...(parseFloat(e.ARROW_ANIMATION_DURATION) > 0 ? { transition: `transform ${e.ARROW_ANIMATION_DURATION} ease 0s` } : {}),
              ...ce,
            },
        ...
        TableInspectorHeaderContainer: {
          ...
          table: { tableLayout: "fixed", borderSpacing: 0, borderCollapse: "separate", height: "100%", width: "100%", margin: 0 },
        },
        ...
        TableInspectorTH: {
          ...
          div: { whiteSpace: "nowrap", textOverflow: "ellipsis", overflow: "hidden", fontSize: e.BASE_FONT_SIZE, lineHeight: "120%" },
        },
        TableInspectorLeftBorder: { none: { borderLeft: "none" }, solid: { borderLeft: `1px solid ${e.TABLE_BORDER_COLOR}` } },
      ...
      he =
        ...
        ({ theme: t = pe, ...r }) => {
          ...
          return o.createElement(rt.Provider, { value: n }, o.createElement(e, { ...r }));
        },
      ar = ({ expanded: e, styles: t }) => o.createElement("span", { style: { ...t.base, ...(e ? t.expanded : t.collapsed) } }, "\u25B6"),
      or = k((e) => {
        e = {
          expanded: !0,
        ...
        let { expanded: t, onClick: r, children: n, nodeRenderer: a, title: i, shouldShowArrow: s, shouldShowPlaceholder: l } = e,
          u = S("TreeNode"),
          c = a;
    ...
    var ir = (e) => Array.from({ length: e }, (t, r) => [Z].concat(Array.from({ length: r }, () => "*")).join(".")),
      sr = (e, t, r, n, a) => {
        let i = []
            .concat(ir(n))
            .concat(r)
          ...
          i.forEach((l) => {
            let u = l.split("."),
              c = (p, d, f) => {
                ...
                else if (E === Xe) for (let { name: m, data: y } of t(p)) q(y, t) && c(y, `${d}.${m}`, f + 1);
                else {
                  let m = p[E];
                  q(m, t) && c(m, `${d}.${E}`, f + 1);
                }
      ...
      nt = k((e) => {
        ...
        return o.createElement(
          or,
          { expanded: c, onClick: p, shouldShowArrow: u, shouldShowPlaceholder: a > 0, nodeRenderer: i, ...e },
          c
            ? [...r(t)].map(({ name: d, data: f, ...E }) =>
                o.createElement(nt, { name: d, data: f, depth: a + 1, path: `${n}.${d}`, key: d, dataIterator: r, nodeRenderer: i, ...E })
              )
            : null
        );
      }),
      at = k(({ name: e, data: t, dataIterator: r, nodeRenderer: n, expandPaths: a, expandLevel: i }) => {
        let s = S("TreeView"),
          l = G({}),
          [, u] = l;
        return (
          xe(() => u((c) => sr(t, r, a, i, c)), [t, r, a, i]),
          o.createElement(
            tt.Provider,
            { value: l },
            o.createElement(
              ...
              o.createElement(nt, { name: e, data: t, dataIterator: r, depth: 0, path: Z, nodeRenderer: n })
            )
          )
        );
      }),
    ...
    var de = ({ data: e }) => {
        let t = S("ObjectPreview"),
          r = e;
        if (typeof r != "object" || r === null || r instanceof Date || r instanceof RegExp) return o.createElement(j, { object: r });
        if (Array.isArray(r)) {
          ...
          for (let s in r)
            if (ot.call(r, s)) {
              let l;
              a.length === n - 1 && Object.keys(r).length > n && (l = o.createElement("span", { key: "ellipsis" }, "\u2026"));
              let u = fe(r, s);
              if (
                (a.push(
                  o.createElement(
      ...
      cr = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
        ...
        return o.createElement(
          "span",
          null,
          typeof e == "string" ? o.createElement(Ee, { name: e, dimmed: r }) : o.createElement(de, { data: e }),
          o.createElement("span", null, ": "),
      ...
      pr = (e, t) =>
        function* (r) {
          ...
          if (!n && r[Symbol.iterator]) {
            ...
            e && r !== Object.prototype && (yield { name: "__proto__", data: Object.getPrototypeOf(r), isNonenumerable: !0 });
          }
        },
      fr = ({ depth: e, name: t, data: r, isNonenumerable: n }) =>
        e === 0 ? o.createElement(ur, { name: t, data: r }) : o.createElement(cr, { name: t, data: r, isNonenumerable: n }),
      dr = ({ showNonenumerable: e = !1, sortObjectKeys: t, nodeRenderer: r, ...n }) => {
        let a = pr(e, t),
          i = r || fr;
    ...
    function gr(e) {
      if (typeof e == "object") {
        ...
        let r = t.reduce((n, a) => {
          let i = e[a];
          return typeof i == "object" && i !== null && Object.keys(i).reduce((s, l) => (s.includes(l) || s.push(l), s), n), n;
        }, []);
    ...
    var br = ({ rows: e, columns: t, rowsData: r }) => {
                ...
                o.createElement(
                  ...
                  t.map((l) => {
                    ...
                    return typeof u == "object" && u !== null && ot.call(u, l)
                      ? o.createElement("td", { key: l, style: { ...n.td, ...a.solid } }, o.createElement(j, { object: u[l] }))
      ...
      Ke = ({ sortAscending: e = !1, sorted: t = !1, onClick: r = void 0, borderStyle: n = {}, children: a, ...i }) => {
        ...
        return o.createElement(
          "th",
          { ...i, style: { ...s.base, ...n, ...(l ? s.base[":hover"] : {}) }, onMouseEnter: c, onMouseLeave: p, onClick: r },
          o.createElement("div", { style: s.div }, a),
          t && o.createElement(hr, null, o.createElement(Er, { sortAscending: e }))
        );
      },
      yr = ({
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                "tr",
                null,
                o.createElement(Ke, { borderStyle: c.none, sorted: r && n, sortAscending: i, onClick: l }, e),
                t.map((p) =>
                  o.createElement(Ke, { borderStyle: c.solid, key: p, sorted: r && a === p, sortAscending: i, onClick: s.bind(null, p) }, p)
                )
              )
            )
          )
        ...
        if (
          ...
          let m = (T, N) => (ut, ct) => {
              ...
              if (Te === _e) M = ve(ye, Oe);
                ...
                let P = { string: 0, number: 1, object: 2, symbol: 3, boolean: 4, undefined: 5, function: 6 };
                M = ve(P[Te], P[_e]);
              }
              return N || (M = -M), M;
            },
      ...
      it = (e) =>
        ...
        (e.childNodes.length === 1 && e.childNodes[0].nodeType === Node.TEXT_NODE && e.textContent.length < _r),
      ...
      Rr = ({ isCloseTag: e, data: t, expanded: r }) => {
        ...
        if (e) return o.createElement(Qe, { styles: n.htmlCloseTag, isChildNode: !0, tagName: t.tagName });
        switch (t.nodeType) {
          case Node.ELEMENT_NODE:
            return o.createElement(
              "span",
              null,
              o.createElement(vr, { tagName: t.tagName, attributes: t.attributes, styles: n.htmlOpenTag }),
      ...
      Ar = function* (e) {
        if (e && e.childNodes) {
          ...
          for (let t = 0; t < e.childNodes.length; t++) {
            ...
            (r.nodeType === Node.TEXT_NODE && r.textContent.trim().length === 0) || (yield { name: `${r.tagName}[${t}]`, data: r });
          }
          e.tagName && (yield { name: "CLOSE_TAG", data: { tagName: e.tagName }, isCloseTag: !0 });
        }
      },
      Cr = (e) => o.createElement(at, { nodeRenderer: Rr, dataIterator: Ar, ...e }),
      wr = he(Cr),
      Nr = Kt(tr()),
      ...
      st = we(({ children: e, className: t }, r) => o.createElement(ze, { ref: r, horizontal: !0, vertical: !0, className: t }, e));
    st.displayName = "UnstyledWrapped";
    var Mr = B(st)({ margin: 0, padding: "10px 5px 20px" }),
      Pr = ke(({ theme: e, ...t }) => o.createElement(xr, { theme: e.addonActionsTheme || "chromeLight", table: !1, ...t })),
              ...
              e.map((i) =>
                o.createElement(
                  ...
                  o.createElement(
                    Dr,
                    null,
                    o.createElement(Pr, { sortObjectKeys: !0, showNonenumerable: !1, name: i.data.name, data: i.data.args ?? i.data })
                  )
                )
              )
            ),
            o.createElement(Be, { actionItems: [{ title: "Clear", onClick: t }] })
          )
        );
      },
      Fr = "actions",
          ...
          super(e),
            ...
            (this.addAction = (t) => {
              this.setState((r) => {
                ...
                return a && Hr(a.data, t.data) ? a.count++ : ((t.count = 1), n.push(t)), { actions: n.slice(0, t.options.limit) };
              });
            }),
            (this.clearActions = () => {
      ...
      return (
        ...
        o.createElement(
          ...
          o.createElement(
            He,
            { col: 1 },
            o.createElement("span", { style: { display: "inline-block", verticalAlign: "middle" } }, "Actions"),
    ...
    ee.register(U, (e) => {
      ee.add(zr, { title: Ur, type: De.PANEL, render: ({ active: t }) => o.createElement(jr, { api: e, active: !!t }), paramKey: Fr });
    });
  })();
} catch (e) {
