try {
  (() => {
    ...
    function L(e, t) {
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of e) if (((a = n), (a && typeof a == "object" && ((a = Fe(t, a)), !a)) || !t.has(a))) return !1;
          return !0;
        }
        if (r === Map) {
          if (e.size !== t.size) return !1;
          for (n of e) if (((a = n[0]), (a && typeof a == "object" && ((a = Fe(t, a)), !a)) || !L(n[1], t.get(a)))) return !1;
          return !0;
        }
    ...
    function Rt(e, t, r) {
      ...
      if (typeof e == "object" && t === void 0 && r === void 0) return V(e.hue, e.saturation, e.lightness);
      throw new _(1);
    }
    function At(e, t, r, n) {
      ...
      if (typeof e == "object" && t === void 0 && r === void 0 && n === void 0)
        return e.alpha >= 1 ? V(e.hue, e.saturation, e.lightness) : "rgba(" + F(e.hue, e.saturation, e.lightness) + "," + e.alpha + ")";
      throw new _(2);
    }
    function oe(e, t, r) {
      if (typeof e == "number" && typeof t == "number" && typeof r == "number") return ae("#" + N(e) + N(t) + N(r));
      if (typeof e == "object" && t === void 0 && r === void 0) return ae("#" + N(e.red) + N(e.green) + N(e.blue));
      throw new _(6);
    }
    function $(e, t, r, n) {
      if (typeof e == "string" && typeof t == "number") {
        ...
        if (typeof e == "object" && t === void 0 && r === void 0 && n === void 0)
          return e.alpha >= 1 ? oe(e.red, e.green, e.blue) : "rgba(" + e.red + "," + e.green + "," + e.blue + "," + e.alpha + ")";
      }
      throw new _(7);
    }
    var Ct = function (t) {
    ...
    var $t = "actions",
      ...
      Qt = (e, t, r, n) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let a of tt(t)) !Zt.call(e, a) && a !== r && pe(e, a, { get: () => t[a], enumerable: !(n = qt(t, a)) || n.enumerable });
        return e;
      },
      er = (e, t, r) => (
        (r = e != null ? Jt(Xt(e)) : {}), Qt(t || !e || !e.__esModule ? pe(r, "default", { value: e, enumerable: !0 }) : r, e)
      ),
      tr = fe({
    ...
    var ar = {
      ...
      Y = (e) => ({
        ...
        TreeNode: {
          ...
          treeNodePlaceholder: { whiteSpace: "pre", fontSize: e.ARROW_FONT_SIZE, marginRight: e.ARROW_MARGIN_RIGHT, ...ie },
          treeNodeArrow: {
            base: {
              color: e.ARROW_COLOR,
      ...
      ir = ({ expanded: e, styles: t }) => o.createElement("span", { style: { ...t.base, ...(e ? t.expanded : t.collapsed) } }, "\u25B6"),
      sr = U((e) => {
        e = {
          expanded: !0,
    ...
    var lr = (e) => Array.from({ length: e }, (t, r) => [X].concat(Array.from({ length: r }, () => "*")).join(".")),
      ur = (e, t, r, n, a) => {
        let i = []
            .concat(lr(n))
            .concat(r)
          ...
          i.forEach((l) => {
            let u = l.split("."),
              c = (p, d, f) => {
                ...
                else if (E === Xe) for (let { name: m, data: y } of t(p)) J(y, t) && c(y, `${d}.${m}`, f + 1);
                else {
                  let m = p[E];
                  J(m, t) && c(m, `${d}.${E}`, f + 1);
                }
        ...
        return o.createElement(
          ...
          c
            ? [...r(t)].map(({ name: d, data: f, ...E }) =>
                o.createElement(at, { name: d, data: f, depth: a + 1, path: `${n}.${d}`, key: d, dataIterator: r, nodeRenderer: i, ...E })
              )
            : null
        );
      }),
      ot = U(({ name: e, data: t, dataIterator: r, nodeRenderer: n, expandPaths: a, expandLevel: i }) => {
        let s = S("TreeView"),
          l = j({}),
          [, u] = l;
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(at, { name: e, data: t, dataIterator: r, depth: 0, path: X, nodeRenderer: n })
            )
          )
        );
      }),
    ...
    var ce = ({ data: e }) => {
        let t = S("ObjectPreview"),
          r = e;
        if (typeof r != "object" || r === null || r instanceof Date || r instanceof RegExp) return o.createElement(H, { object: r });
        if (Array.isArray(r)) {
      ...
      fr = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
        ...
        return o.createElement(
          "span",
          null,
          typeof e == "string" ? o.createElement(me, { name: e, dimmed: r }) : o.createElement(ce, { data: e }),
          o.createElement("span", null, ": "),
      ...
      mr = ({ depth: e, name: t, data: r, isNonenumerable: n }) =>
        e === 0 ? o.createElement(pr, { name: t, data: r }) : o.createElement(fr, { name: t, data: r, isNonenumerable: n }),
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
                ...
                o.createElement(
                  ...
                  t.map((l) => {
                    ...
                    return typeof u == "object" && u !== null && it.call(u, l)
                      ? o.createElement("td", { key: l, style: { ...n.td, ...a.solid } }, o.createElement(H, { object: u[l] }))
      ...
      st = (e) =>
        ...
        (e.childNodes.length === 1 && e.childNodes[0].nodeType === Node.TEXT_NODE && e.textContent.length < Sr),
        ...
        switch (t.nodeType) {
          case Node.ELEMENT_NODE:
            return o.createElement(
              "span",
              null,
              o.createElement(Rr, { tagName: t.tagName, attributes: t.attributes, styles: n.htmlOpenTag }),
      ...
      lt = Se(({ children: e, className: t }, r) => o.createElement(Le, { ref: r, horizontal: !0, vertical: !0, className: t }, e));
    lt.displayName = "UnstyledWrapped";
    var Br = B(lt)({ margin: 0, padding: "10px 5px 20px" }),
      Fr = He(({ theme: e, ...t }) => o.createElement(Ir, { theme: e.addonActionsTheme || "chromeLight", table: !1, ...t })),
              ...
              e.map((i) =>
                o.createElement(
                  ...
                  o.createElement(
                    Pr,
                    null,
                    o.createElement(Fr, { sortObjectKeys: !0, showNonenumerable: !1, name: i.data.name, data: i.data.args ?? i.data })
                  )
                )
              )
            ),
          ...
          super(e),
            ...
            (this.addAction = (t) => {
              this.setState((r) => {
                ...
                return a && zr(a.data, t.data) ? a.count++ : ((t.count = 1), n.push(t)), { actions: n.slice(0, t.options.limit) };
              });
            }),
            (this.clearActions = () => {
    ...
    Q.register(z, (e) => {
      Q.add(Yt, { title: jr, type: De.PANEL, render: ({ active: t }) => o.createElement(Ur, { api: e, active: !!t }), paramKey: $t });
    });
  })();
} catch (e) {
