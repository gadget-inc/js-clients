try {
  (() => {
    ...
    var E = ((e) =>
      typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (o, c) => (typeof require < "u" ? require : o)[c] }) : e)(
      function (e) {
    ...
    var ue = (e, o, c, r) => {
      if ((o && typeof o == "object") || typeof o == "function")
        for (let i of ae(o)) !le.call(e, i) && i !== c && Y(e, i, { get: () => o[i], enumerable: !(r = ie(o, i)) || r.enumerable });
      return e;
    };
    var Ie = (e, o, c) => (
      (c = e != null ? re(ce(e)) : {}), ue(o || !e || !e.__esModule ? Y(c, "default", { value: e, enumerable: !0 }) : c, e)
    );
    var p = M(() => {});
    var h = M(() => {});
    var f = M(() => {});
    var X = se((Q, V) => {
      ...
      (function (e) {
        if (typeof Q == "object" && typeof V < "u") V.exports = e();
          ...
          var o;
          typeof window < "u" || typeof window < "u" ? (o = window) : typeof self < "u" ? (o = self) : (o = this), (o.memoizerific = e());
        }
      })(function () {
        var e, o, c;
                    ...
                    return this.lastItem && this.isEqual(this.lastItem.key, t)
                      ...
                      : ((u = this.indexOf(t)),
                        u >= 0
                          ...
                          : ((this.lastItem = { key: t, val: n }), this.list.push(this.lastItem), this.size++, this));
                  }),
                  (l.prototype.delete = function (t) {
                    var n;
                    if ((this.lastItem && this.isEqual(this.lastItem.key, t) && (this.lastItem = void 0), (n = this.indexOf(t)), n >= 0))
              ...
              function (r, i, d) {
                  ...
                  return function (C) {
                    var m = function () {
                      ...
                      return (
                        ...
                        a > 0 && ((x[_] = { cacheItem: b, arg: arguments[_] }), O ? t(s, x) : s.push(x), s.length > a && n(s.shift())),
                        (m.wasMemoized = O),
                        (m.numArgs = _ + 1),
                        R
                      );
                ...
                function n(a) {
                  var I = a.length,
                    ...
                    C,
                    m;
                  for (s.cacheItem.delete(s.arg), m = I - 2; m >= 0 && ((s = a[m]), (C = s.cacheItem.get(s.arg)), !C || !C.size); m--)
    ...
    var ne = "storybook/background",
      ...
      pe = w(function (e) {
        ...
        return g.createElement(
          ...
          g.createElement(
            B,
            { key: "grid", active: n, disabled: t, title: "Apply a grid to the preview", onClick: () => a({ value: l, grid: !n }) },
          ...
          c > 0
            ? g.createElement(
                ...
                g.createElement(
                  B,
                  { disabled: t, key: "background", title: "Change the background of the preview", active: !!o || u },
      ...
      he = ee.span(
        ({ background: e }) => ({ borderRadius: "1rem", display: "block", height: "1rem", width: "1rem", background: e }),
      ...
      ge = (0, W.default)(10)((e, o, c) => {
        ...
        return o !== "transparent" ? [te("reset", "Clear background", "transparent", null, c, !1), ...r] : r;
      }),
      ...
      Ce = w(function () {
        ...
        return e.disable
          ...
          : g.createElement(
              ...
              g.createElement(
                B,
                { key: "background", title: "Change the background of the preview", active: l !== "transparent" || o },
                g.createElement(z, null)
              )
            );
      }),
      Se = w(function () {
        ...
        return g.createElement(
          B,
          { key: "background", active: r, title: "Apply a grid to the preview", onClick: () => o({ [y]: { ...e[y], grid: !r } }) },
          g.createElement(q, null)
        );
      });
    N.register(ne, () => {
