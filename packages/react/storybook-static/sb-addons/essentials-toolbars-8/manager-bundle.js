  ...
  (() => {
    ...
    var K = { type: "item", value: "" },
      Y = (o, t) => ({
        ...
        toolbar: {
          ...
          items: t.toolbar.items.map((e) => {
            ...
            return r.type === "reset" && t.toolbar.icon && ((r.icon = t.toolbar.icon), (r.hideIcon = !0)), { ...K, ...r };
          }),
        },
      }),
      $ = ["reset"],
      ...
      U = (o) => (t) => {
        ...
        return (
          g(() => {
            a && z(c, e, { next: { ...a.next, action: I }, previous: { ...a.previous, action: O }, reset: { ...a.reset, action: v } });
          }, [c, e, a, I, O, v]),
          g(() => {
            l.current = q(r);
          }, []),
      ...
      W = ({ currentValue: o, items: t }) => o != null && t.find((e) => e.value === o && e.type !== "reset"),
      ...
      Q = ({ right: o, title: t, value: e, icon: r, hideIcon: a, onClick: c, disabled: T, currentValue: i }) => {
        let l = r && n.createElement(A, { style: { opacity: 1 }, icon: r, __suppressDeprecationWarning: !0 }),
          u = { id: e ?? "_reset", active: i === e, right: o, title: t, disabled: T, onClick: c };
        return r && !a && (u.icon = l), u;
      },
      X = U(({ id: o, name: t, description: e, toolbar: { icon: r, items: a, title: c, preventDynamicIcon: T, dynamicTitle: i } }) => {
        let [l, u, v] = h(),
          [I, O] = B(!1),
          s = l[o],
          m = !!s,
        ...
        return n.createElement(
          ...
          n.createElement(J, { active: I || m, disabled: d, description: e || "", icon: p, title: b || "" })
        );
      }),
      ee = () => {
        let o = M(),
    ...
    k.register(S, () => k.add(S, { title: S, type: P.TOOL, match: ({ tabId: o }) => !o, render: () => n.createElement(ee, null) }));
  })();
} catch (e) {
