  ...
  (() => {
    ...
    var W = ({ active: o, title: t, icon: e, description: r, onClick: a }) =>
      ...
      $ = (o) => (t) => {
        ...
        return (
          x(() => {
            a && Y(d, e, { next: { ...a.next, action: O }, previous: { ...a.previous, action: u }, reset: { ...a.reset, action: v } });
          }, [d, e, a, O, u, v]),
          x(() => {
            l.current = K(r);
          }, []),
      ...
      j = $(({ id: o, name: t, description: e, toolbar: { icon: r, items: a, title: d, preventDynamicIcon: S, dynamicTitle: s } }) => {
        let [l, p] = h(),
          [v, O] = L(!1),
          u = l[o],
          m = !!u,
      ...
      J = (o, t) => ({
        ...
        toolbar: {
          ...
          items: t.toolbar.items.map((e) => {
            ...
            return r.type === "reset" && t.toolbar.icon && ((r.icon = t.toolbar.icon), (r.hideIcon = !0)), { ...Z, ...r };
          }),
        },
      }),
      Q = () => {
    ...
    g.register(b, () => g.add(b, { title: b, type: B.TOOL, match: ({ tabId: o }) => !o, render: () => n.createElement(Q, null) }));
  })();
} catch (e) {
