...
var __require = ((x2) =>
  typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(x2, { get: (a, b) => (typeof require < "u" ? require : a)[b] }) : x2)(
  function (x2) {
  ...
  "../../node_modules/memoizerific/memoizerific.js"(exports, module) {
    ...
    (function (f3) {
      if (typeof exports == "object" && typeof module < "u") module.exports = f3();
        ...
        var g;
        typeof window < "u" ? (g = window) : typeof global < "u" ? (g = global) : typeof self < "u" ? (g = self) : (g = this),
          (g.memoizerific = f3());
      }
    })(function () {
            ...
            function (_dereq_, module3, exports3) {
              ...
              (Similar.prototype.get = function (key2) {
                  ...
                  return this.lastItem && this.isEqual(this.lastItem.key, key2)
                    ...
                    : ((index = this.indexOf(key2)),
                      index >= 0
                        ...
                        : ((this.lastItem = { key: key2, val }), this.list.push(this.lastItem), this.size++, this));
                }),
                (Similar.prototype.delete = function (key2) {
                  var index;
                  if (
                    (this.lastItem && this.isEqual(this.lastItem.key, key2) && (this.lastItem = void 0),
                    (index = this.indexOf(key2)),
                    index >= 0)
                  )
                ...
                (Similar.prototype.has = function (key2) {
                  ...
                  return this.lastItem && this.isEqual(this.lastItem.key, key2)
                    ? !0
                    : ((index = this.indexOf(key2)), index >= 0 ? ((this.lastItem = this.list[index]), !0) : !1);
                }),
            ...
            function (_dereq_, module3, exports3) {
                ...
                return function (fn) {
                  var memoizerific = function () {
                    ...
                    for (i = 0; i < argsLengthMinusOne; i++) {
                      if (((lruPath[i] = { cacheItem: currentCache, arg: arguments[i] }), currentCache.has(arguments[i]))) {
              ...
              function removeCachedResult(removedLru) {
                ...
                for (
                  ...
                  i >= 0 && ((currentLru = removedLru[i]), (tmp = currentLru.cacheItem.get(currentLru.arg)), !tmp || !tmp.size);
                  i--
                )
...
var require_baseGet = __commonJS({
  "../../node_modules/lodash/_baseGet.js"(exports, module) {
    ...
    function baseGet2(object, path) {
      ...
      for (var index = 0, length = path.length; object != null && index < length; ) object = object[toKey2(path[index++])];
      ...
      for (var index = -1, length = path.length, lastIndex = length - 1, nested = object; nested != null && ++index < length; ) {
        ...
        if (index != lastIndex) {
          ...
          (newValue = customizer ? customizer(objValue, key2, nested) : void 0),
            newValue === void 0 && (newValue = isObject5(objValue) ? objValue : isIndex(path[index + 1]) ? [] : {});
        }
  ...
  "../../node_modules/lodash/_overRest.js"(exports, module) {
    ...
    function overRest(func, start, transform) {
      return (
        ...
        function () {
          for (var args2 = arguments, index = -1, length = nativeMax(args2.length - start, 0), array = Array(length); ++index < length; )
  ...
  "../../node_modules/lodash/_getSymbolsIn.js"(exports, module) {
    ...
    var arrayPush = require_arrayPush(),
      ...
      getSymbolsIn = nativeGetSymbols
        ? function (object) {
            for (var result2 = []; object; ) arrayPush(result2, getSymbols(object)), (object = getPrototype(object));
            return result2;
          }
        : stubArray;
    ...
    module.exports = function inspect_(obj, options2, depth, seen) {
      ...
      if (!isDate(obj) && !isRegExp(obj)) {
        var ys = arrObjKeys(obj, inspect),
          isPlainObject2 = gPO ? gPO(obj) === Object.prototype : obj instanceof Object || obj.constructor === Object,
          ...
          stringTag =
            !isPlainObject2 && toStringTag && Object(obj) === obj && toStringTag in obj
              ...
              : "",
          constructorTag =
            isPlainObject2 || typeof obj.constructor != "function" ? "" : obj.constructor.name ? obj.constructor.name + " " : "",
          tag =
            constructorTag +
      ...
      merge = function merge2(target, source2, options2) {
        ...
        if (typeof source2 != "object") {
          if (isArray2(target)) target.push(source2);
            ...
            ((options2 && (options2.plainObjects || options2.allowPrototypes)) || !has2.call(Object.prototype, source2)) &&
              (target[source2] = !0);
        ...
        return (
          ...
          isArray2(target) && isArray2(source2)
            ...
            : Object.keys(source2).reduce(function (acc, key2) {
                ...
                return has2.call(acc, key2) ? (acc[key2] = merge2(acc[key2], value2, options2)) : (acc[key2] = value2), acc;
              }, mergeTarget)
        );
      },
    ...
    var getSideChannel = require_side_channel(),
      ...
      normalizeStringifyOptions = function (opts) {
        ...
        if (typeof opts.format < "u") {
          if (!has2.call(formats.formatters, opts.format)) throw new TypeError("Unknown format option provided.");
          format = opts.format;
        }
      ...
      parseKeys = function (givenKey, val, options2, valuesParsed) {
        if (givenKey) {
          var key2 = options2.allowDots ? givenKey.replace(/\.([^.[]+)/g, "[$1]") : givenKey,
            ...
            keys = [];
          if (parent) {
            if (!options2.plainObjects && has2.call(Object.prototype, parent) && !options2.allowPrototypes) return;
            keys.push(parent);
          }
          for (var i = 0; options2.depth > 0 && (segment = child.exec(key2)) !== null && i < options2.depth; ) {
            if (((i += 1), !options2.plainObjects && has2.call(Object.prototype, segment[1].slice(1, -1)) && !options2.allowPrototypes))
              return;
            keys.push(segment[1]);
          }
          return segment && keys.push("[" + key2.slice(segment.index) + "]"), parseObject(keys, val, options2, valuesParsed);
        }
      },
  ...
  "../../node_modules/browser-dtector/browser-dtector.umd.min.js"(exports, module) {
    ...
    (function (e, o) {
      ...
      var o = {
        ...
        n = function (e2) {
          var o2 = new RegExp("^-?\\d+(?:.\\d{0,".concat(arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : -1, "})?")),
        ...
        t = (function () {
          function t2(e2) {
            ...
            (function (e3, o3) {
              ...
              (this.userAgent = e2 || ((o2 = i()) === null || o2 === void 0 ? void 0 : o2.userAgent) || null);
          }
          var a, l, s;
          return (
            (a = t2),
            (l = [
              {
                ...
                value: function (e2) {
                  var t3,
                    ...
                    b = i();
                  p === "chrome" &&
                    typeof (b == null || (t3 = b.brave) === null || t3 === void 0 ? void 0 : t3.isBrave) == "function" &&
                    (p = "brave"),
                    p && (s2[p] = !0),
                    w2 && (s2[w2] = !0);
                  var v2 = !!(s2.tablet || s2.android || s2.androidTablet),
                    m2 = !!(s2.ipad || s2.tablet || s2.androidTablet),
                    g = !!(s2.android || s2.androidTablet || s2.tablet || s2.ipad || s2.ipod || s2.iphone || s2["windows phone"]),
                    h2 = !!(s2.cros || s2.mac || s2.linux || s2.win),
                    y = !!(s2.brave || s2.chrome || s2.crios || s2.opr || s2.safari || s2.edg || s2.electron),
                    A = !!(s2.msie || s2.rv);
                  return {
...
var replacer = function (options2) {
    ...
    return function (key2, value2) {
      try {
        if (key2 === "") return (keys = []), (objects = new Map([[value2, "[]"]])), (map2 = new Map()), (stack = []), value2;
    ...
    return function mutateUndefined(value2) {
      isObject3(value2) &&
        Object.entries(value2).forEach(([k2, v2]) => {
          v2 === "_undefined_" ? (value2[k2] = void 0) : mutated.get(v2) || (mutated.set(v2, !0), mutateUndefined(v2));
        }),
        Array.isArray(value2) &&
  ...
  PostMessageTransport = class {
    ...
    getCurrentFrames() {
      return this.config.page === "manager"
        ? Array.from(document2.querySelectorAll('[data-is-storybook="true"]')).flatMap((e) => (e.contentWindow ? [e.contentWindow] : []))
        : scope && scope.parent
        ? [scope.parent]
        : [];
    }
    getLocalFrame() {
      return this.config.page === "manager"
        ? Array.from(document2.querySelectorAll("#storybook-preview-iframe")).flatMap((e) => (e.contentWindow ? [e.contentWindow] : []))
        : scope && scope.parent
        ? [scope.parent]
        : [];
    }
...
`
  ...
  NextjsRouterMocksNotAvailable = class extends StorybookError {
    constructor(data) {
      super(), (this.data = data), (this.category = "FRAMEWORK_NEXTJS"), (this.code = 2);
    }
    template() {
      return esm_default`
    ...
    "../../node_modules/ansi-to-html/node_modules/entities/lib/decode_codepoint.js"(exports) {
      ...
      function decodeCodePoint(codePoint) {
        return (codePoint >= 55296 && codePoint <= 57343) || codePoint > 1114111
          ? "\uFFFD"
          : (codePoint in decode_json_1.default && (codePoint = decode_json_1.default[codePoint]), fromCodePoint(codePoint));
      }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      var entities = require_lib2(),
        defaults = { fg: "#FFF", bg: "#000", newline: !1, escapeXML: !1, stream: !1, colors: getDefaultColors() };
      ...
      function handleDisplay(stack, code, options2) {
        ...
        return (
          codeMap[code]
            ...
            : 99 < code && code < 108 && (result2 = pushBackgroundColor(stack, options2.colors[8 + (code - 100)])),
          result2
        );
      }
      ...
      function categoryForCode(code) {
        ...
        return (
          code === 0
            ...
            : ((39 < code && code < 48) || code === 49 || (99 < code && code < 108)) && (result2 = "background-color"),
          result2
        );
      }
...
Previous: ${hook.deps}
Incoming: ${deps}`),
      (deps == null || hook.deps == null || !areDepsEqual(deps, hook.deps)) && (callback(hook), (hook.deps = deps)),
      hook
    );
  }
...
function useArgs() {
  let channel = addons.getChannel(),
    ...
    updateArgs = useCallback((updatedArgs) => channel.emit(UPDATE_STORY_ARGS, { storyId, updatedArgs }), [channel, storyId]),
    resetArgs = useCallback((argNames) => channel.emit(RESET_STORY_ARGS, { storyId, argNames }), [channel, storyId]);
...
var makeDecorator = ({ name: name2, parameterName, wrapper, skipIfNoParametersOrOptions = !1 }) => {
    ...
    return (...args2) =>
      typeof args2[0] == "function"
        ? decorator()(...args2)
        : (...innerArgs) => {
            if (innerArgs.length > 1) return args2.length > 1 ? decorator(args2)(...innerArgs) : decorator(...args2)(...innerArgs);
  ...
  getImportPathMap = (0, import_memoizerific2.default)(1)((entries) =>
    Object.values(entries).reduce((acc, entry) => ((acc[entry.importPath] = acc[entry.importPath] || entry), acc), {})
  ),
  ...
  combineArgs = (value2, update) =>
    Array.isArray(value2) && Array.isArray(update)
      ? update
          .reduce((acc, upd, index) => ((acc[index] = combineArgs(value2[index], update[index])), acc), [...value2])
          .filter((v2) => v2 !== void 0)
  ...
  validateOptions = (args2, argTypes) =>
    Object.entries(argTypes).reduce((acc, [key2, { options: options2 }]) => {
      ...
      let field = isArray2 ? `${key2}[${invalidIndex}]` : key2,
        supportedOptions = options2.map((opt) => (typeof opt == "string" ? `'${opt}'` : String(opt))).join(", ");
...
var ArgsStore = class {
  ...
  getValuesFromArgTypes = (argTypes = {}) =>
    Object.entries(argTypes).reduce((acc, [arg, { defaultValue }]) => (typeof defaultValue < "u" && (acc[arg] = defaultValue), acc), {}),
  GlobalsStore = class {
      ...
      return Object.entries(globals).reduce(
        (acc, [key2, value2]) => (
          this.allowedGlobalNames.has(key2)
            ? (acc[key2] = value2)
            : logger.warn(`Attempted to set a global (${key2}) that is not defined in initial globals or globalTypes`),
          acc
        ),
        {}
      );
  ...
  normalizeInputType = (inputType, key2) => {
    ...
    return (
      ...
      control ? (normalized.control = normalizeControl(control)) : control === !1 && (normalized.control = { disable: !0 }),
      normalized
    );
  },
...
function normalizeStory(key2, storyAnnotations, meta) {
  ...
  let exportName = M(key2),
    name2 = (typeof storyObject != "function" && storyObject.name) || storyObject.storyName || story?.name || exportName,
...
function preparePartialAnnotations(storyAnnotations, componentAnnotations, projectAnnotations) {
  ...
  contextForEnhancers.initialArgs = argsEnhancers.reduce(
    (accumulatedArgs, enhancer) => ({ ...accumulatedArgs, ...enhancer({ ...contextForEnhancers, initialArgs: accumulatedArgs }) }),
      ...
      `),
        ...
        : (visited.add(value2),
          Array.isArray(value2)
            ? {
                name: "array",
                value: value2.length > 0 ? inferType(value2[0], name2, new Set(visited)) : { name: "other", value: "unknown" },
              }
            : { name: "object", value: (0, import_mapValues.default)(value2, (field) => inferType(field, name2, new Set(visited))) })
      : { name: "object", value: {} };
  },
...
function composeConfigs(moduleExportList) {
  ...
  return {
    ...
    decorators: getArrayField(moduleExportList, "decorators", { reverseFileOrder: !(scope.FEATURES?.legacyDecoratorFileOrder ?? !1) }),
...
function composeStory(storyAnnotations, componentAnnotations, projectAnnotations, defaultConfig, exportsName) {
  ...
  let normalizedComponentAnnotations = normalizeComponentAnnotations(componentAnnotations),
    ...
    playFunction = story.playFunction
      ? async (extraContext) =>
          story.playFunction({ ...context, ...extraContext, canvasElement: extraContext?.canvasElement ?? globalThis.document?.body })
      : void 0,
  ...
  return Object.assign(
    function (extraArgs) {
      if (((context.args = { ...context.initialArgs, ...extraArgs }), cleanups.length > 0 && !previousCleanupsDone)) {
        ...
        story.title !== DEFAULT_STORY_TITLE && (humanReadableIdentifier = `${story.title} - ${humanReadableIdentifier}`),
    ...
    },
    {
      ...
      load: async () => {
        ...
        (context.loaded = loadedContext.loaded),
          cleanups.push(...(await story.applyBeforeEach(context)).filter(Boolean).map((callback) => ({ storyName, callback })));
      },
      args: story.initialArgs,
...
var CSF_CACHE_SIZE = 1e3,
  ...
  StoryStore = class {
          ...
          return {
            ...
            stories: (0, import_mapValues.default)(value2.stories, (story) => {
              ...
              return {
                ...
                kind: story.title,
                story: story.name,
                parameters: { ...(0, import_pick.default)(story.parameters, allowedParameters), fileName: importPath },
              };
            }),
          };
        }),
    ...
    async cleanupStory(story) {
      ...
      if (callbacks) for (let callback of [...callbacks].reverse()) await callback();
    ...
    fromId(storyId) {
      if ((deprecate("StoryStore.fromId() is deprecated and will be removed in 9.0, please use loadStory() instead"), !this.cachedCSFFiles))
...
var userOrAutoTitleFromSpecifier = (fileName, entry, userTitle) => {
      ...
      for (; storyTitleA[depth] || storyTitleB[depth]; ) {
        ...
        if (nameA !== nameB) {
          ...
          return indexA !== -1 || indexB !== -1
            ...
            : method === "configure"
            ? 0
            : nameA.localeCompare(nameB, options2.locales ? options2.locales : void 0, { numeric: !0, sensitivity: "accent" });
        }
  ...
  sortStoriesCommon = (stories, storySortParameter, fileNameOrder) => {
    if (storySortParameter) {
      let sortFn;
      typeof storySortParameter == "function" ? (sortFn = storySortParameter) : (sortFn = storySort(storySortParameter)),
        stories.sort(sortFn);
...
var StoryRender = class {
    ...
    async runPhase(signal, phase, phaseFn) {
      (this.phase = phase),
        ...
        signal.aborted &&
          ((this.phase = "aborted"), this.channel.emit(STORY_RENDER_PHASE_CHANGED, { newPhase: this.phase, storyId: this.id }));
    }
    async prepare() {
      if (
        ...
        if (this.renderOptions.autoplay && forceRemount && playFunction && this.phase !== "errored") {
          ...
          if (
            (!ignoreUnhandledErrors &&
              ...
              this.channel.emit(UNHANDLED_ERRORS_WHILE_PLAYING, Array.from(unhandledErrors).map(serializeError)),
            (this.disableKeyListeners = !1),
  ...
  Preview = class {
    ...
    async getProjectAnnotationsOrRenderError() {
      try {
        ...
        if (((this.renderToCanvas = projectAnnotations.renderToCanvas), !this.renderToCanvas)) throw new MissingRenderToCanvasError();
    ...
    emitGlobals() {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "emitGlobals" });
      let payload = {
    ...
    async onStoriesChanged({ importFn, storyIndex }) {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "onStoriesChanged" });
      await this.storyStoreValue.onStoriesChanged({ importFn, storyIndex });
    }
    async onUpdateGlobals({ globals }) {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "onUpdateGlobals" });
    ...
    async onUpdateArgs({ storyId, updatedArgs }) {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "onUpdateArgs" });
      this.storyStoreValue.args.update(storyId, updatedArgs),
        await Promise.all(this.storyRenders.filter((r) => r.id === storyId && !r.renderOptions.forceInitialArgs).map((r) => r.rerender())),
    ...
    async onRequestArgTypesInfo({ id, payload }) {
      try {
        ...
        this.channel.emit(ARGTYPES_INFO_RESPONSE, { id, success: !0, payload: { argTypes: story?.argTypes || {} }, error: null });
      } catch (e) {
        this.channel.emit(ARGTYPES_INFO_RESPONSE, { id, success: !1, error: e?.message });
      }
    }
    async onResetArgs({ storyId, argNames }) {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "onResetArgs" });
      let story = this.storyRenders.find((r) => r.id === storyId)?.story || (await this.storyStoreValue.loadStory({ storyId })),
        updatedArgs = (
          argNames || [...new Set([...Object.keys(story.initialArgs), ...Object.keys(this.storyStoreValue.args.get(storyId))])]
    ...
    async loadStory({ storyId }) {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "loadStory" });
      return this.storyStoreValue.loadStory({ storyId });
    }
    getStoryContext(story, { forceInitialArgs = !1 } = {}) {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "getStoryContext" });
      return this.storyStoreValue.getStoryContext(story, { forceInitialArgs });
    }
    async extract(options2) {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "extract" });
...
var PreviewWithSelection = class extends Preview {
    ...
    async setInitialGlobals() {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "setInitialGlobals" });
    ...
    async selectSpecifiedStory() {
      if (!this.storyStoreValue) throw new CalledPreviewMethodBeforeInitializationError({ methodName: "selectSpecifiedStory" });
      ...
      if (!entry) {
        storySpecifier === "*"
          ...
          : this.renderStoryLoadingException(storySpecifier, new NoStoryMatchError({ storySpecifier: storySpecifier.toString() }));
        return;
      }
    ...
    async onPreloadStories({ ids }) {
      await this.storeInitializationPromise,
        this.storyStoreValue && (await Promise.allSettled(ids.map((id) => this.storyStoreValue?.loadEntry(id))));
    }
    async renderSelection({ persistedArgs } = {}) {
      ...
      entry.type === "story"
        ...
        : isMdxEntry(entry)
        ? (render = new MdxDocsRender(this.channel, this.storyStoreValue, entry, this.mainStoryCallbacks(storyId)))
        : (render = new CsfDocsRender(this.channel, this.storyStoreValue, entry, this.mainStoryCallbacks(storyId)));
      ...
      if (
        (persistedArgs &&
          ...
          (invariant(!!render.story), this.storyStoreValue.args.updateFromPersisted(render.story, persistedArgs)),
      ...
      if (
        ...
        this.channel.emit(STORY_PREPARED, { id: storyId, parameters, initialArgs, argTypes, args: unmappedArgs });
      } else {
    ...
    renderException(storyId, error) {
      ...
      this.channel.emit(STORY_THREW_EXCEPTION, { name: name2, message, stack }),
        ...
        error.message?.startsWith("ignoredException") ||
          (this.view.showErrorDisplay(error), logger.error(`Error rendering story '${storyId}':`), logger.error(error));
    }
...
var getQueryString = ({ selection, extraParams }) => {
  ...
  getSelectionSpecifierFromPath = () => {
    if (typeof document22 < "u") {
      let query = import_qs.default.parse(document22.location.search, { ignoreQueryPrefix: !0 }),
      ...
      if (storyId) return { storySpecifier: storyId, args: args2, globals, viewMode };
    }
    return null;
  },
  UrlStore = class {
  ...
  WebView = class {
    constructor() {
      if (((this.testing = !1), typeof document3 < "u")) {
        let { __SPECIAL_TEST_PARAMETER__ } = import_qs.default.parse(document3.location.search, { ignoreQueryPrefix: !0 });
...
function insertScript($script, callback, $scriptRoot) {
  ...
  (scriptEl.type = $script.type === "module" ? "module" : "text/javascript"),
    ...
    $scriptRoot ? $scriptRoot.appendChild(scriptEl) : document4.head.appendChild(scriptEl),
...
function simulatePageLoad($container) {
  ...
  $scriptsRoot
    ...
    : (($scriptsRoot = document4.createElement("div")), ($scriptsRoot.id = SCRIPTS_ROOT_ID), document4.body.appendChild($scriptsRoot));
