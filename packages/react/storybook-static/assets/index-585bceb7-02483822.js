...
import { B as j, _ as k, C as z } from "./PolarisAutoRichTextInput-c5e8a199.js";
import "./apis-d6201c92.js";
import { S as T } from "./base-80a1f760-2864de52.js";
import { b as F, c as U, E as _, a as q } from "./consoleHook-59e792cb-f30916d2.js";
...
var P = Object.create,
  ...
  M = (i, e) => {
    for (var a in e) u(i, a, { get: e[a], enumerable: !0 });
  },
  v = (i, e, a, n) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let s of d(e)) !C.call(i, s) && s !== a && u(i, s, { get: () => e[s], enumerable: !(n = S(e, s)) || n.enumerable });
    return i;
  },
  I = (i, e, a) => ((a = i != null ? P(E(i)) : {}), v(e || !i || !i.__esModule ? u(a, "default", { value: i, enumerable: !0 }) : a, i)),
  O = (i) => v(u({}, "__esModule", { value: !0 }), i),
  A = x({
    "node_modules/.pnpm/mime-db@1.52.0/node_modules/mime-db/db.json"(i, e) {
      e.exports = {
  ...
  R = x({
    "node_modules/.pnpm/mime-db@1.52.0/node_modules/mime-db/index.js"(i, e) {
      e.exports = A();
    },
  }),
  b = {};
M(b, { PreviewController: () => D, getExtension: () => h, joinFilepath: () => g, normalizeFilepath: () => m });
var L = O(b),
  l = "$CSB_RELAY",
  $ = I(R()),
  f = new Map(),
  H = Object.entries($.default);
for (const [i, e] of H) {
  const a = e.extensions;
  if (a != null && a.length) for (const n of a) f.set(n, i);
}
var N = f,
  W = 0;
function B() {
  const i = Date.now(),
    e = Math.round(Math.random() * 1e4),
    a = (W += 1);
  return (+`${i}${e}${a}`).toString(16);
}
function m(i) {
  return "/" + i.split("/").filter(Boolean).join("/");
}
function g(i, e) {
  return m(i + "/" + e);
}
...
var D = class {
    constructor(i) {
      (this.initPromise = null),
        (this.baseUrl = new URL(i.baseUrl)),
        (this.getFileContent = i.getFileContent),
        (this.indexFiles = i.indexFiles ?? ["index.html", "index.html"]);
    }
    async getIndexAtPath(i) {
      for (const e of this.indexFiles)
        try {
          return await this.getFileContent(g(i, e));
        } catch {}
      throw new Error("No index file not found");
    }
    async handleWorkerRequest(i) {
      if (!this.initPromise) throw new Error("Init promise is null");
      const [e, a] = await this.initPromise;
      try {
        const n = m(new URL(i.url, e).pathname);
        let s = null;
        const c = {};
        try {
          s = await this.getFileContent(n);
        } catch {}
        if ((s == null && ((s = await this.getIndexAtPath(n)), (c["Content-Type"] = "text/html; charset=utf-8")), s == null))
        ...
        const o = { $channel: l, $type: "preview/response", id: i.id, headers: c, status: 200, body: s };
        a.postMessage(o);
      } catch {
        const s = {
          $channel: l,
    ...
    getRelayUrl(i) {
      const e = new URL(i);
      return (e.pathname = "/__csb_relay/"), e.toString();
    }
    async _initPreview() {
      const i = B(),
        e = new URL(this.baseUrl);
      (e.hostname = i + "-" + e.hostname), (e.pathname = "/");
      const a = this.getRelayUrl(e.toString()),
        n = document.createElement("iframe");
      n.setAttribute("src", a.toString()), (n.style.display = "none"), document.body.appendChild(n);
      const s = new MessageChannel(),
        c = n.contentWindow;
      if (!c) throw new Error("Could not get iframe contentWindow");
      return new Promise((o) => {
        const t = s.port1;
        (t.onmessage = (p) => {
          if (typeof p.data == "object" && p.data.$channel === l)
            switch (p.data.$type) {
              case "preview/ready":
                o([e.toString(), t, n]);
                break;
              case "preview/request":
                this.handleWorkerRequest(p.data);
                break;
            }
        }),
          (n.onload = () => {
            const p = { $channel: l, $type: "preview/init" };
            c.postMessage(p, "*", [s.port2]);
          });
      });
    }
    initPreview() {
      return this.initPromise || (this.initPromise = this._initPreview()), this.initPromise.then((i) => i[0]);
    }
    destroy() {
      this.initPromise &&
        (this.initPromise.then((e) => {
          e[1].close();
          const a = this.getRelayUrl(e[0]);
          document.body.querySelectorAll(`src="${a}"`).forEach((s) => s.remove());
        }),
        (this.initPromise = null));
    }
  },
  ...
  w = function (i) {
    return typeof i == "string" ? i : new TextDecoder().decode(i);
  },
  Y = function (i) {
    var e = w(i),
      a = new DOMParser(),
      n = a.parseFromString(e, "text/html");
    n.documentElement.getAttribute("lang") || n.documentElement.setAttribute("lang", "en");
    var s = n.documentElement.outerHTML;
    return `<!DOCTYPE html>
`.concat(s);
  },
  pa = (function (i) {
    ...
    function e(a, n, s) {
      s === void 0 && (s = {});
      var c,
        o = i.call(this, a, n, s) || this;
      if (
        ((o.files = new Map()),
        (o.status = "initializing"),
        (o.emitter = new _()),
        (o.previewController = new L.PreviewController({
          baseUrl: (c = s.bundlerURL) !== null && c !== void 0 ? c : "https://preview.sandpack-static-server.codesandbox.io",
          getFileContent: function (p) {
            ...
            if (p.endsWith(".html") || p.endsWith(".htm"))
              try {
                (r = Y(r)),
                  (r = o.injectProtocolScript(r)),
                  (r = o.injectExternalResources(r, s.externalResources)),
                  (r = o.injectScriptIntoHead(r, { script: U, scope: { channelId: F() } }));
              } catch (y) {
                console.error("Runtime injection failed", y);
              }
            return r;
          },
        })),
        ...
        (o.element = t), (o.iframe = document.createElement("iframe"));
      } else (o.element = a), (o.iframe = a);
      return (
        o.iframe.getAttribute("sandbox") ||
          (o.iframe.setAttribute(
            "sandbox",
        ...
        (o.eventListener = o.eventListener.bind(o)),
        typeof window < "u" && window.addEventListener("message", o.eventListener),
        o.updateSandbox(),
        o
      );
    }
    return (
      (e.prototype.injectContentIntoHead = function (a, n) {
        var s;
        return (
          (a = w(a)),
          (a =
...
` +
      ...
      (e.prototype.injectProtocolScript = function (a) {
        var n = `<script>
...
<\/script>`;
        return this.injectContentIntoHead(a, n);
      }),
      (e.prototype.injectExternalResources = function (a, n) {
        n === void 0 && (n = []);
        var s = n.map(function (c) {
          var o = c.match(/\.([^.]*)$/),
            t = o == null ? void 0 : o[1];
          if (t === "css" || c.includes("fonts.googleapis")) return '<link rel="stylesheet" href="'.concat(c, '">');
          if (t === "js") return '<script src="'.concat(c, '"></script>');
          throw new Error("Unable to determine file type for external resource: ".concat(c));
        }).join(`
`);
        return this.injectContentIntoHead(a, s);
      }),
      (e.prototype.injectScriptIntoHead = function (a, n) {
        var s = n.script,
          c = n.scope,
          o = c === void 0 ? {} : c,
          t = `
    ...
    `
            ...
            .trim();
        return this.injectContentIntoHead(a, t);
      }),
      (e.prototype.updateSandbox = function (a, n) {
        a === void 0 && (a = this.sandboxSetup);
        var s = q(a.files);
        this.dispatch({ codesandbox: !0, modules: s, template: a.template, type: "compile" });
      }),
      (e.prototype.compile = function (a) {
        return j(this, void 0, void 0, function () {
          var n;
          return z(this, function (s) {
            switch (s.label) {
              case 0:
                return (this.files = new Map(Object.entries(a))), [4, this.previewController.initPreview()];
              case 1:
                return (
                  (n = s.sent()),
                  ...
                  this.dispatch({ type: "urlchange", url: n, back: !1, forward: !1 }),
                  [2]
                );
            }
          });
      ...
      (e.prototype.eventListener = function (a) {
        if (a.source === this.iframe.contentWindow) {
          var n = a.data;
          n.codesandbox && this.dispatch(n);
        }
      }),
      (e.prototype.dispatch = function (a) {
        var n;
        switch (a.type) {
          case "compile":
            this.compile(a.modules);
            break;
          default:
            (n = this.iframe.contentWindow) === null || n === void 0 || n.postMessage(a, "*"), this.emitter.dispatch(a);
        }
      }),
      (e.prototype.listen = function (a) {
        return this.emitter.listener(a);
      }),
      (e.prototype.destroy = function () {
        this.emitter.cleanup(), typeof window < "u" && window.removeEventListener("message", this.eventListener);
      }),
      e
    );
  })(T);
export { pa as SandpackStatic };
