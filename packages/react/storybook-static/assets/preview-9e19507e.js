...
function J() {
  ...
  P(s.canvas, s.context, { width: o, height: t }), (s.width = o), (s.height = t);
}
function Q() {
  var o;
  s.canvas && (C(), (o = s.canvas.parentNode) == null || o.removeChild(s.canvas), (s = {}));
}
var w = { margin: "#f6b26b", border: "#ffe599", padding: "#93c47d", content: "#6fa8dc", text: "#232020" },
  p = 6;
...
function ot(o, t) {
  return Math.abs(o.x - t.x) < Math.abs(o.w + t.w) / 2 && Math.abs(o.y - t.y) < Math.abs(o.h + t.h) / 2;
}
function et(o, t, e) {
  return (
    o === "top"
...
function k(o, t) {
  (o.font = "600 12px monospace"), (o.textBaseline = "middle"), (o.textAlign = "center");
...
function it(o, t, { type: e, position: l = "center", text: i }, n, f = !1) {
  let { x: r, y: a } = x(l, t),
    { offsetX: h, offsetY: u } = tt(e, l, t, p + 1, f);
  (r += h), (a += u);
  let { w: c, h: m } = k(o, i);
  if (n && ot({ x: r, y: a, w: c, h: m }, n)) {
    let E = et(l, { x: r, y: a, w: c, h: m }, n);
    (r = E.x), (a = E.y);
  }
...
function lt(o, { w: t, h: e }) {
  let l = t * 0.5 + p,
    i = e * 0.5 + p;
  return { offsetX: (o.x === "left" ? -1 : 1) * l, offsetY: (o.y === "top" ? -1 : 1) * i };
}
function nt(o, t, { type: e, text: l }) {
  let { floatingAlignment: i, extremities: n } = t,
    ...
    r = n[i.y],
    { w: a, h } = k(o, l),
    { offsetX: u, offsetY: c } = lt(i, { w: a, h });
  return (f += u), (r += c), X(o, e, { x: f, y: r, w: a, h }, l);
}
function v(o, t, e, l) {
  let i = [];
  e.forEach((n, f) => {
    let r = l && n.position === "center" ? nt(o, t, n) : it(o, t, n, i[f - 1], l);
    i[f] = r;
  });
}
function rt(o, t, e, l) {
  let i = e.reduce((n, f) => {
    var r;
    return Object.prototype.hasOwnProperty.call(n, f.position) || (n[f.position] = []), (r = n[f.position]) == null || r.push(f), n;
  }, {});
  i.top && v(o, t, i.top, l),
...
function ft(o) {
  ...
  return { x: e.left > e.right ? "left" : "right", y: e.top > e.bottom ? "top" : "bottom" };
}
function at(o) {
  let t = d.getComputedStyle(o),
    { top: e, left: l, right: i, bottom: n, width: f, height: r } = o.getBoundingClientRect(),
    {
      marginTop: a,
      marginBottom: h,
      marginLeft: u,
  ...
  (e = e + d.window.scrollY), (l = l + d.window.scrollX), (n = n + d.window.scrollY), (i = i + d.window.scrollX);
  let y = { top: g(a), bottom: g(h), left: g(u), right: g(c) },
    z = { top: g(m), bottom: g(E), left: g(F), right: g(I) },
    j = { top: g($), bottom: g(D), left: g(N), right: g(q) },
    T = { top: e - y.top, bottom: n + y.bottom, left: l - y.left, right: i + y.right };
  return {
    margin: y,
    padding: z,
    border: j,
...
function ht(o, { margin: t, width: e, height: l, top: i, left: n, bottom: f, right: r }) {
...
function st(o, { padding: t, border: e, width: l, height: i, top: n, left: f, bottom: r, right: a }) {
...
function ut(o, { border: t, width: e, height: l, top: i, left: n, bottom: f, right: r }) {
...
function dt(o, { padding: t, border: e, width: l, height: i, top: n, left: f }) {
  let r = l - e.left - e.right - t.left - t.right,
    a = i - t.top - t.bottom - e.top - e.bottom;
  return (
...
var pt = (o, t) => {
    ...
    return (
      ...
      W(() => {
        ...
        return (
          t.viewMode === "story" &&
            e &&
            (document.addEventListener("pointerover", l), V(), window.addEventListener("resize", i), Y(M.x, M.y)),
          () => {
  ...
  wt = [pt],
  bt = { [G]: !1 };
export { wt as decorators, bt as initialGlobals };
