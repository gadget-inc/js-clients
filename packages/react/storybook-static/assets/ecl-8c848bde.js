...
var g = l(
  ...
  w = l("apply assert build buildindex evaluate fail keydiff keypatch loadxml nothor notify output parallel sequential soapcall wait"),
  x = l(
...
const z = {
  ...
  token: function (e, n) {
    ...
    if ((t.align == null && (t.align = !0), (o == ";" || o == ":") && t.type == "statement")) u(n);
      ...
      o == t.type
        ? u(n)
        : (t.type == "}" || t.type == "top" || (t.type == "statement" && o == "newstatement")) && c(n, e.column(), "statement");
