...
var p = (e, r, t) => (ie(e, typeof r != "symbol" ? r + "" : r, t), t),
  T = (e, r, t) => {
    if (!r.has(e)) throw TypeError("Cannot " + t);
  };
var C = (e, r, t) => (T(e, r, "read from private field"), t ? t.call(e) : r.get(e)),
  R = (e, r, t) => {
...
import { w as A, B as E, u as K, z as N, C as P, _ as se } from "./PolarisAutoRichTextInput-c5e8a199.js";
import "./apis-d6201c92.js";
import { S as oe } from "./base-80a1f760-2864de52.js";
import { w as B, r as U, c as ae, f as ce, a as de, b as le, E as ue, g as z } from "./consoleHook-59e792cb-f30916d2.js";
...
var he = Object.create,
  ...
  ve = (e, r, t) => (r in e ? q(e, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (e[r] = t)),
  b = (e, r) =>
    function () {
  ...
  we = (e, r, t, n) => {
    if ((r && typeof r == "object") || typeof r == "function")
      for (let s of X(r)) !me.call(e, s) && s !== t && q(e, s, { get: () => r[s], enumerable: !(n = fe(r, s)) || n.enumerable });
    return e;
  },
  j = (e, r, t) => ((t = e != null ? he(pe(e)) : {}), we(r || !e || !e.__esModule ? q(t, "default", { value: e, enumerable: !0 }) : t, e)),
  ge = (e, r, t) => (ve(e, typeof r != "symbol" ? r + "" : r, t), t),
  H = (e, r, t) => {
    if (!r.has(e)) throw TypeError("Cannot " + t);
  },
  y = (e, r, t) => (H(e, r, "read from private field"), t ? t.call(e) : r.get(e)),
  O = (e, r, t) => {
    if (r.has(e)) throw TypeError("Cannot add the same private member more than once");
    r instanceof WeakSet ? r.add(e) : r.set(e, t);
  },
  k = (e, r, t, n) => (H(e, r, "write to private field"), n ? n.call(e, t) : r.set(e, t), t),
  _ = (e, r, t) => (H(e, r, "access private method"), t),
  Q = b({
  ...
  ye = b({
    "../../node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/lib/fingerprint.browser.js"(e, r) {
      var t = Q(),
        n = typeof window == "object" ? window : self,
        s = Object.keys(n).length,
        i = navigator.mimeTypes ? navigator.mimeTypes.length : 0,
        o = t((i + navigator.userAgent.length).toString(36) + s.toString(36), 4);
      r.exports = function () {
        return o;
      };
    },
  ...
  _e = b({
    "../../node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/lib/getRandomValue.browser.js"(e, r) {
      var t,
        n = (typeof window < "u" && (window.crypto || window.msCrypto)) || (typeof self < "u" && self.crypto);
      n
        ? ((s = Math.pow(2, 32) - 1),
          (t = function () {
    ...
    "../../node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/index.js"(e, r) {
      ...
      (f.slug = function () {
        var w = new Date().getTime().toString(36),
          S = h().toString(36).slice(-4),
          d = t().slice(0, 1) + t().slice(-1),
          u = l().slice(-2);
        ...
        t =
          ((o = class extends Promise {
            constructor(c = null) {
              ...
              p(this, "resolve");
              p(this, "reject");
              V(this, n, l), (this.resolve = C(this, n).resolve), (this.reject = C(this, n).reject);
            }
            get state() {
              return C(this, n).state;
            }
            get rejectionReason() {
              return C(this, n).rejectionReason;
            }
            then(c, l) {
    ...
    "../../node_modules/.pnpm/@open-draft+deferred-promise@2.1.0/node_modules/@open-draft/deferred-promise/build/index.js"(e) {
      var r =
        ...
        t =
          (e && e.__exportStar) ||
          function (n, s) {
            for (var i in n) i !== "default" && !Object.prototype.hasOwnProperty.call(s, i) && r(s, n, i);
          };
  ...
  te = b({
    "../../node_modules/.pnpm/strict-event-emitter@0.4.3/node_modules/strict-event-emitter/lib/MemoryLeakError.js"(e) {
      ...
      var r = class extends Error {
        constructor(n, s, i) {
          super(
            `Possible EventEmitter memory leak detected. ${i} ${s.toString()} listeners added. Use emitter.setMaxListeners() to increase limit`
          );
          p(this, "emitter");
          p(this, "type");
          p(this, "count");
        ...
        w = class {
          constructor() {
            O(this, i),
              ...
              O(this, s, void 0),
              k(this, t, new Map()),
              k(this, n, w.defaultMaxListeners),
              k(this, s, !1);
          }
          ...
          prependListener(d, u) {
            ...
            if (m.length > 0) {
              const M = [u].concat(m);
              y(this, t).set(d, M);
            } else y(this, t).set(d, m.concat(u));
            return this;
          }
          ...
          removeListener(d, u) {
            const m = _(this, i, o).call(this, d);
            return (
              m.length > 0 && (_(this, a, c).call(this, m, u), y(this, t).set(d, m), _(this, f, v).call(this, "removeListener", d, u)), this
            );
          }
          off(d, u) {
...
var je = class extends Error {
  ...
  L = (e, r, ...t) => {
    if (!e) throw new je(r, ...t);
  };
L.as = (e, r, t, ...n) => {
  if (!r) throw e.prototype.name != null ? new e(g(t, n)) : e(g(t, n));
};
var W = j($()),
  Ce = window.localStorage.CSB_EMULATOR_DEBUG,
  ke = "\x1B[0m",
  Fe = "\x1B[32;1m",
  Ae = "\x1B[31m",
  xe = "\x1B[34m",
  ...
  Te = "\x1B[35;1m",
  G = "\x1B[36;1m",
  Re = { preview: De, emulator: Te, runtime: G, bridge: xe, "runtime:worker": G };
function re(e) {
  return function (t, ...n) {
    if (Ce === "true") {
      const s = () => (t.includes("sender") ? `${Fe}sender` : t.includes("receiver") ? `${Ae}receiver` : ""),
        i = t.replace(/\[.+\]:/, "");
      console.debug(`${Re[e]}${e}:${s()}${ke}:${i}`, ...n);
    }
  };
}
var I = re("emulator"),
  Ue = class {
    constructor(e) {
      ...
      window.addEventListener("message", t),
        ...
        (this.receiverReadyPromise = r),
        (this.receiverPort.onmessage = (n) => {
          const s = n.data;
          s.type != null &&
            (I('[message-sender]: emitting "%s" event...', s.type, s.payload),
            this.emitter.dispatchEvent(new MessageEvent(s.type, { data: s.payload })));
        });
    }
    async handshake() {
      const e = new W.DeferredPromise();
      await this.receiverReadyPromise,
        I("[message-sender]: sending handshake"),
    ...
    on(e, r, t) {
      I('[message-sender]: add listener "%s"', e),
    ...
    async send(e, ...r) {
      const t = new W.DeferredPromise(),
        n = (0, Se.default)(),
        s = r[0] || {};
      I('[message-sender]: send "%s" (%s)', e, n, s),
        this.receiverPort.postMessage({ type: e, payload: { operationId: n, payload: s } }),
        I('[message-sender]: adding done listener for "%s" (%s)', e, n);
      const i = (a) => {
          const { data: c } = a;
          if (c.operationId === n) {
            const l = c.listenerPayload || {};
            I('[message-sender]: resolving "%s (%s) promise!', e, n), t.resolve({ ...l, operationId: c.operationId });
          }
        },
        o = (a) => {
          const { data: c } = a;
      ...
      return (
        this.on("internal/operation/done", i),
        this.on("internal/operation/failed", o),
        t.finally(() => {
  ...
  We = class {
    ...
    async writeFile(e, r, t) {
      let n,
        s = !1;
      typeof t == "object" ? ((n = t.encoding), (s = !!t.recursive)) : typeof t == "string" && (n = t),
        await this.channel.send("fs/writeFile", { path: e, content: r, encoding: n, recursive: s }).catch((i) => {
    ...
    async readdir(e) {
      ...
      if (!r) throw new Error("Directory not found");
      return r.data;
    }
    async mkdir(e, r) {
    ...
    async watch(e, r, t) {
      const n = (0, Be.default)();
      return (
        await this.channel.send("fs/watch", { watcherId: n, includes: e, excludes: r }),
        this.channel.on("fs/watch-event", ({ data: s }) => {
          if (s.watcherId === n && t) {
            const i = { ...s };
  ...
  qe = class {
    constructor(e) {
      ...
      (this.channel = e),
        (this.state = "running"),
        (this.stdout = new Y.Emitter()),
        (this.stderr = new Y.Emitter()),
        (this.stdin = {
          write: (r) => {
            if (!this.id) throw new Error("Failed to write to stdin, no process is currently running");
    ...
    async runCommand(e, r, t = {}) {
      ...
      return (
        L(n, 'Failed to run "runCommand" on a ShellProcess: was not able to retrieve a running process.'),
        (this.id = n.id),
        (this.state = "running"),
        n
      );
    ...
    async kill() {
      L(this.id, 'Failed to run "kill" on a ShellProcess: there is no process running. Did you forget to run it?'),
        (this.state = "idle"),
        await this.channel.send("shell/exit", { id: this.id }).catch((e) => {
  ...
  Ve = class {
    ...
    async waitFor(e, r, t = $e) {
      const n = new He.DeferredPromise(),
        s = setTimeout(() => {
          n.reject();
        }, t),
        i = await this.channel.send("preview/get/info", e).catch((a) => {
          n.reject(new Error(g('Failed to look up preview information for shell ID "%s" (port: %d)', e.sourceShellId, e.port)));
        }),
        o = i && r(i);
      return (
        o && n.resolve({ url: i.url, port: i.port, sourceShellId: i.sourceShellId }),
        this.channel.on("preview/port/ready", ({ data: a }) => {
          !o && r(a) && n.resolve({ url: a.url, port: a.port, sourceShellId: a.sourceShellId });
        }),
        n.finally(() => {
          clearTimeout(s);
        })
  ...
  ze = "https://nodebox-runtime.codesandbox.io",
  x = re("emulator"),
  Ge = class {
    constructor(e) {
      p(this, "channel", null);
      ...
      (this.options = e),
        ...
        (this.url = this.options.runtimeUrl || ze),
        (this.isConnected = !1);
    }
    async connect() {
      ...
      this.url || t.reject(new Error("Nodebox URL is missing. Did you forget to provide it when creating this Nodebox instance?")),
        L(e.contentWindow, "Failed to create a MessageChannel with the Nodebox iframe: no content window found"),
      ...
      return (
        ...
        await n,
        x("[message-sender]: IFrame loaded..."),
        await this.channel.handshake(),
        x("[message-sender]: Handshake completed..."),
        this.channel.send("connect", { cdnUrl: r }),
    ...
    get fs() {
      return (
        L(this.isConnected, 'Failed to access the File System API: consumer is not connected. Did you forget to run "connect()"?'),
        this.fileSystemApi ? this.fileSystemApi : ((this.fileSystemApi = new We(this.channel)), this.fileSystemApi)
      );
    }
    get shell() {
      return (
        L(this.isConnected, 'Failed to access the Shell API: consumer is not connected. Did you forget to run "connect()"?'),
        this.shellApi ? this.shellApi : ((this.shellApi = new Ne(this.channel)), this.shellApi)
      );
    }
    get preview() {
      return (
        L(this.isConnected, 'Failed to access the Preview API: consumer is not connected. Did you forget to run "connect()"?'),
        this.previewApi ? this.previewApi : ((this.previewApi = new Ve(this.channel)), this.previewApi)
      );
    }
  },
  Je = "INJECT_AND_INVOKE",
  Ye = "PREVIEW_LOADED";
function Ke(e, r) {
  return E(this, void 0, void 0, function () {
    ...
    return P(this, function (a) {
      return (
        (t = e.contentWindow),
        N(t, "Failed to await preview iframe: no content window found"),
        (n = 9e4),
        (s = 20),
        (i = 0),
        [
...
var Xe = function (e, r) {
  (e.style.border = "0"),
    (e.style.width = r.width || "100%"),
    (e.style.height = r.height || "100%"),
    (e.style.overflow = "hidden"),
    (e.allow = "cross-origin-isolated");
};
function Qe(e) {
  var r = e.scope,
    t = window.history.__proto__,
    n = [],
    s = 0,
    i = function (c) {
      parent.postMessage({ type: "urlchange", url: c, back: s > 0, forward: s < n.length - 1, channelId: r.channelId }, "*");
    };
  function o(c, l) {
...
function Ze(e) {
  ...
  function s() {
    var a = n();
    t !== a && window.parent.postMessage({ type: "resize", height: a, codesandbox: !0, channelId: r.channelId }, "*"), (t = a);
  }
  s();
  var i,
  ...
  o.observe(document, { attributes: !0, childList: !0, subtree: !0 }), setInterval(s, 300);
}
var et = [
    { code: Qe.toString(), id: "historyListener" },
    {
      code:
        "function consoleHook({ scope }) {" +
        ae +
        `
};`,
      id: "consoleHook",
  ...
  tt = function (e, r) {
    et.forEach(function (t) {
      var n,
        s = t.code,
        i = t.id,
        o = { uid: i, type: Je, code: "exports.activate = ".concat(s), scope: { channelId: r } };
  ...
  vt = (function (e) {
    ...
    function r(t, n, s) {
      ...
      return (
        (i._modulesCache = new Map()),
        (i.messageChannelId = le()),
        (i._initPromise = null),
        (i.emitter = new ue()),
        i.manageIframes(t),
        (i.emulator = new Ge({ iframe: i.emulatorIframe, runtimeUrl: i.options.bundlerURL })),
        i.updateSandbox(n),
        i
      );
    }
    return (
            ...
            switch (i.label) {
              case 0:
                return (
                  ...
                  this._initPromise || (this._initPromise = this._init(t)),
                  [4, this._initPromise]
                );
              case 1:
              ...
              case 5:
                return (
                  (s = i.sent()),
                  this.dispatch({ type: "action", action: "notification", notificationType: "error", title: z(s) }),
          ...
          return P(this, function (o) {
            switch (o.label) {
              case 0:
                return (
                  (n = U(t["/package.json"])),
                  (this.emulatorCommand = ce(n)),
                  (this.emulatorShellProcess = this.emulator.shell.create()),
                  [
                    4,
                    this.emulatorShellProcess.on("exit", function (a) {
                      i.dispatch({
                        type: "action",
                        action: "notification",
              ...
              case 1:
                return (
                  ...
                  [
                    4,
                    this.emulatorShellProcess.on("progress", function (a) {
                      var c, l;
              ...
              case 2:
                return (
                  o.sent(),
                  this.emulatorShellProcess.stdout.on("data", function (a) {
        ...
        return E(this, void 0, void 0, function () {
          ...
          return P(this, function (i) {
            switch (i.label) {
              ...
              case 1:
                return (
                  (s = i.sent().url), (this.iframePreviewUrl = s + ((n = this.options.startRoute) !== null && n !== void 0 ? n : "")), [2]
                );
            }
          });
        });
      ...
      (r.prototype.manageIframes = function (t) {
        ...
        if (typeof t == "string") {
          ...
          N(s, "The element '".concat(t, "' was not found")),
            (this.iframe = document.createElement("iframe")),
            s == null || s.appendChild(this.iframe);
        } else this.iframe = t;
        Xe(this.iframe, this.options),
          N(this.iframe.parentNode, "The given iframe does not have a parent."),
          (this.emulatorIframe = document.createElement("iframe")),
          this.emulatorIframe.classList.add("sp-bridge-frame"),
          (n = this.iframe.parentNode) === null || n === void 0 || n.appendChild(this.emulatorIframe);
      }),
      ...
      (r.prototype.dispatchDoneMessage = function () {
        (this.status = "done"),
          ...
          this.iframePreviewUrl && this.dispatch({ type: "urlchange", url: this.iframePreviewUrl, back: !1, forward: !1 });
      }),
              ...
              case 0:
                return (
                  window.addEventListener("message", function (s) {
                    s.data.type === Ye && tt(t.iframe, t.messageChannelId),
                      s.data.type === "urlchange" && s.data.channelId === t.messageChannelId
                        ? t.dispatch({ type: "urlchange", url: s.data.url, back: s.data.back, forward: s.data.forward })
                        ...
                        return E(t, void 0, void 0, function () {
                          ...
                          return P(this, function (v) {
                            switch (v.label) {
                              case 0:
                                return s
                                  ? ((i = s), (o = "newPath" in i ? i.newPath : "path" in i ? i.path : ""), [4, this.emulator.fs.stat(o)])
                                  : [2];
                              case 1:
                                if (((a = v.sent().type), a !== "file")) return [2, null];
                                v.label = 2;
                              case 2:
                              ...
                              case 4:
                                return (
                                  (l = v.sent()),
                                  this.dispatch({ type: "fs/change", path: i.path, content: l }),
                                  this._modulesCache.set(i.path, B(l)),
                                  [3, 9]
                                );
                              case 5:
                                return this.dispatch({ type: "fs/remove", path: i.path }), this._modulesCache.delete(i.path), [3, 9];
                              case 6:
                                return (
                                  this.dispatch({ type: "fs/remove", path: i.oldPath }),
                                  this._modulesCache.delete(i.oldPath),
                                  [4, this.emulator.fs.readFile(i.newPath, "utf8")]
                                );
                              case 7:
                                return (
                                  (h = v.sent()),
                                  this.dispatch({ type: "fs/change", path: i.newPath, content: h }),
                                  this._modulesCache.set(i.newPath, B(h)),
                                  [3, 9]
                                );
                              case 8:
                                return [3, 9];
                              ...
                              case 10:
                                return (
                                  (f = v.sent()),
                                  this.dispatch({ type: "action", action: "notification", notificationType: "error", title: z(f) }),
                                  [3, 11]
                                );
                              case 11:
                                return [2];
            ...
            switch (n.label) {
              case 0:
                return this.emulatorShellProcess && this.emulatorCommand
                  ? (this.dispatch({ type: "start", firstLoad: !0 }), (this.status = "initializing"), [4, this.emulatorShellProcess.kill()])
                  : [3, 3];
              case 1:
                return (
                  n.sent(),
                  (t = this.iframe) === null || t === void 0 || t.removeAttribute("attr"),
                  this.emulator.fs.rm("/node_modules/.vite", { recursive: !0, force: !0 }),
      ...
      (r.prototype.updateSandbox = function (t) {
        ...
        this.dispatch({ codesandbox: !0, modules: i, template: t.template, type: "compile" }),
          Object.entries(i).forEach(function (o) {
            var a = o[0],
              c = o[1];
            n._modulesCache.set(a, B(c));
          });
      }),
        ...
        return E(this, void 0, void 0, function () {
          ...
          return P(this, function (o) {
            switch (o.label) {
              ...
              case 4:
                return (
                  (s = (n = this.iframe) === null || n === void 0 ? void 0 : n.contentWindow) === null ||
                    s === void 0 ||
                    s.postMessage(t, "*"),
                  [3, 8]
                );
