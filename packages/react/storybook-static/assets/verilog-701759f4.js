  ...
  hooks: {
    ...
    token: function (i, o) {
      ...
      if (i.sol() && !o.tlvInBlockComment) {
        i.peek() == "\\" &&
          ((u = "def"), i.skipToEnd(), i.string.match(/\\SV/) ? (o.tlvCodeActive = !1) : i.string.match(/\\TLV/) && (o.tlvCodeActive = !0)),
      ...
      if (o.tlvCodeActive) {
        ...
        if (u === void 0)
          ...
          else if ((c = i.match(G)) && !o.tlvInBlockComment) c[0] == "//" ? i.skipToEnd() : (o.tlvInBlockComment = !0), (u = "comment");
          else if ((c = i.match(q))) {
            var b = c[1],
              I = c[2];
