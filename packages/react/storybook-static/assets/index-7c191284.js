    ...
    if (typeof n != "string" && !Array.isArray(n)) {
      for (const u in n)
        if (u !== "default" && !(u in e)) {
          ...
          c && Object.defineProperty(e, u, c.get ? c : { enumerable: !0, get: () => n[u] });
        }
    }
  }
...
var R = {
  ...
  k = {};
function p(e, t, r) {
  (this.props = e), (this.context = t), (this.refs = k), (this.updater = r || R);
}
...
function A(e, t, r) {
  var n,
    ...
    s = null;
  if (t != null)
    for (n in (t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = "" + t.key), t))
  ...
  if (e && e.defaultProps) for (n in ((f = e.defaultProps), f)) u[n] === void 0 && (u[n] = f[n]);
  ...
  if (s)
    return (
      ...
      E(u)
        ...
        : u != null &&
          (g(u) && (u = W(u, r + (!u.key || (s && s.key === u.key) ? "" : ("" + u.key).replace(j, "$&/") + "/") + e)), t.push(u)),
      1
    );
  if (((s = 0), (n = n === "" ? "." : n + ":"), E(e)))
    ...
    for (e = i.call(e), f = 0; !(c = e.next()).done; ) (c = c.value), (i = n + m(c, f++)), (s += _(c, t, r, i, u));
  else if (c === "object")
    throw (
      ((t = String(e)),
      Error(
...
var l = { current: null },
  h = { transition: null },
  Q = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: S };
o.Children = {
  map: d,
...
o.StrictMode = F;
o.Suspense = z;
o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Q;
o.cloneElement = function (e, t, r) {
  ...
  var n = $({}, e.props),
    ...
    s = e._owner;
  if (t != null) {
    if ((t.ref !== void 0 && ((c = t.ref), (s = S.current)), t.key !== void 0 && (u = "" + t.key), e.type && e.type.defaultProps))
      var f = e.type.defaultProps;
    for (i in t) P.call(t, i) && !x.hasOwnProperty(i) && (n[i] = t[i] === void 0 && f !== void 0 ? f[i] : t[i]);
  }
...
var D = O.exports;
const Y = T(D),
  ee = I({ __proto__: null, default: Y }, [D]);
export { ee as $, Y as R, Z as a, X as c, T as g, D as r };
