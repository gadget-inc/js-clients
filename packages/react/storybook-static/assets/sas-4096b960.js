var t = {},
  l = { eq: "operator", lt: "operator", le: "operator", gt: "operator", ge: "operator", in: "operator", ne: "operator", or: "operator" },
  c = /(<=|>=|!=|<>)/,
  p = /[=\(:\),{}.*<>+\-\/^\[\]]/;
function s(e, r, o) {
...
function d(e, r) {
  ...
  if (r.nextword) return e.match(/[\w]+/), e.peek() === "." && e.skipTo(" "), (r.nextword = !1), "variableName.special";
