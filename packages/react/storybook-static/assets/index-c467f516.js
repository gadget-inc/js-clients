  ...
  R = s.define({
    ...
    parser: _.configure({
      props: [
        ...
        S.add({
          "Block SwitchBlock ClassBody ElementValueArrayInitializer ModuleBody EnumBody ConstructorBody InterfaceBody ArrayInitializer": o,
          BlockComment(Q) {
...
export { u as java, R as javaLanguage };
