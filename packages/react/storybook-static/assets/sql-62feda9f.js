function s(a) {
  ...
  function g(t, i) {
    ...
    if (o.hexNumber && ((r == "0" && t.match(/^[xX][0-9a-fA-F]+/)) || ((r == "x" || r == "X") && t.match(/^'[0-9a-fA-F]*'/))))
      return "number";
    if (o.binaryNumber && (((r == "b" || r == "B") && t.match(/^'[01]+'/)) || (r == "0" && t.match(/^b[01]*/)))) return "number";
    ...
    if ((o.commentHash && r == "#") || (r == "-" && t.eat("-") && (!o.commentSpaceRequired || t.eat(" ")))) return t.skipToEnd(), "comment";
    ...
    if (r == ".") {
      ...
      if (r == "{" && (t.match(/^( )*(d|D|t|T|ts|TS)( )*'[^']*'( )*}/) || t.match(/^( )*(d|D|t|T|ts|TS)( )*"[^"]*"( )*}/))) return "number";
      t.eatWhile(/^[_\w\d]/);
  ...
  return {
    ...
    token: function (t, i) {
      if ((t.sol() && i.context && i.context.align == null && (i.context.align = !1), i.tokenize == g && t.eatSpace())) return null;
    ...
    languageData: {
      commentTokens: { line: o.commentSlashSlash ? "//" : o.commentHash ? "#" : "--", block: { open: "/*", close: "*/" } },
