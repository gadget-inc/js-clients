import { c as bn } from "./index-7c191284.js";
var ge = { exports: {} };
(function (n, a) {
  (function (o, i) {
    i(a);
    ...
    class u extends Error {
      constructor(t) {
        super(`The parsing ended early. The next token was: ${i(t)}`), (this.token = t), Object.setPrototypeOf(this, u.prototype);
      }
      getToken() {
        return this.token;
      }
    ...
    const E = /[$_\p{ID_Start}]|\\u\p{Hex_Digit}{4}|\\u\{0*(?:\p{Hex_Digit}{1,5}|10\p{Hex_Digit}{4})\}/u,
      N = /[$\-\p{ID_Continue}\u200C\u200D]|\\u\p{Hex_Digit}{4}|\\u\{0*(?:\p{Hex_Digit}{1,5}|10\p{Hex_Digit}{4})\}/u;
    function ae(e) {
      let t = e[0];
    ...
    class U {
      constructor(t, r, s) {
        (this.grammar = t), typeof r == "string" ? (this._lexer = D.create(r)) : (this._lexer = r), (this.baseParser = s);
      }
      get lexer() {
        return this._lexer;
      }
    ...
    const H = g({
        ...
        parsePrefix: (e) => (e.consume("="), { type: "JsdocTypeOptional", element: e.parseType(f.OPTIONAL), meta: { position: "prefix" } }),
        parseInfix: (e, t) => (e.consume("="), { type: "JsdocTypeOptional", element: w(t), meta: { position: "suffix" } }),
      }),
      z = g({
        name: "numberParslet",
        accept: (e) => e === "Number",
      ...
      Ct = g({
        ...
        parsePrefix: (e) => (
          e.consume("!"), { type: "JsdocTypeNotNullable", element: e.parseType(f.NULLABLE), meta: { position: "prefix" } }
        ),
        parseInfix: (e, t) => (e.consume("!"), { type: "JsdocTypeNotNullable", element: w(t), meta: { position: "suffix" } }),
      });
    ...
    function Z({ allowSquareBracketsOnAnyType: e, allowJsdocNamePaths: t, pathGrammar: r }) {
      return function (c, d, T) {
        ...
        const J = c.lexer.current.type,
          k = c.lexer.next.type;
        if (!((J === "." && k !== "<") || (J === "[" && (e || T.type === "JsdocTypeName")) || (t && (J === "~" || J === "#")))) return null;
        let x,
          ne = !1;
        c.consume(".")
          ? (x = "property")
        ...
        switch (O.type) {
          ...
          case "JsdocTypeSpecialNamePath":
            ...
            break;
          default:
            throw new y(O, "Expecting 'JsdocTypeName', 'JsdocTypeNumber', 'JsdocStringValue' or 'JsdocTypeSpecialNamePath'");
        }
        if (ne && !c.consume("]")) {
    ...
    function ue({ allowNamedParameters: e, allowNoReturnType: t, allowWithoutParenthesis: r, allowNewAsFunctionKeyword: s }) {
      return g({
    ...
    function ye({ allowPostfix: e, allowEnclosingBrackets: t }) {
      return g({
        ...
        parseInfix: e
          ? (r, s) => (r.consume("..."), { type: "JsdocTypeVariadic", element: w(s), meta: { position: "suffix", squareBrackets: !1 } })
          : void 0,
      });
    }
    const _e = g({
        ...
        parsePrefix: (r) => {
          ...
          if (!r.consume("}")) {
            ...
            for (;;) {
              ...
              } else if (T.type === "JsdocTypeObjectField" || T.type === "JsdocTypeJsdocObjectField") s.elements.push(T);
              else throw new y(T);
            ...
            if (((s.meta.separator = c ?? "comma"), !r.consume("}"))) throw new Error("Unterminated record type. Missing '}'");
          }
          return s;
        },
      });
        ...
        parseInfix: (c, d) => {
          ...
          if (
            ...
            return (
              ...
              { type: "JsdocTypeObjectField", key: ie(d) ? d : d.value.toString(), right: ne, optional: J, readonly: k, meta: { quote: x } }
            );
          } else {
            if (!t) throw new y(d);
            v.consume(":");
    ...
    const je = [
        ...ce,
        ue({ allowWithoutParenthesis: !0, allowNamedParameters: ["this", "new"], allowNoReturnType: !0, allowNewAsFunctionKeyword: !1 }),
        $,
      ...
      Le = g({
        name: "typeOfParslet",
        accept: (e) => e === "typeof",
        parsePrefix: (e) => (e.consume("typeof"), { type: "JsdocTypeTypeof", element: w(e.parseType(f.KEY_OF_TYPE_OF)) }),
      }),
      Ht = [
      ...
      zt = [
        ...
        Le,
        ue({ allowWithoutParenthesis: !1, allowNamedParameters: ["this", "new"], allowNoReturnType: !0, allowNewAsFunctionKeyword: !1 }),
      ...
      Zt = g({
        ...
        parsePrefix: (e) => {
          ...
          if (t.type !== "JsdocTypeName") throw new y(t, "A typescript asserts always has to have a name on the left side.");
    ...
    function en({ allowQuestionMark: e }) {
      return g({
        ...
        parsePrefix: (t) => {
          ...
          if (!e && r.elements.some((c) => c.type === "JsdocTypeUnknown")) throw new Error("Question mark in tuple not allowed");
          return r;
        },
      });
    }
    const tn = g({
      ...
      rn = g({
        ...
        accept: (e) => e === "readonly",
        parsePrefix: (e) => (e.consume("readonly"), { type: "JsdocTypeReadonlyProperty", element: e.parseType(f.KEY_VALUE) }),
      }),
      an = g({
      ...
      sn = g({
        ...
        accept: (e) => e === "is",
        parseInfix: (e, t) => {
          if (t.type !== "JsdocTypeName") throw new y(t, "A typescript predicate always has to have a name on the left side.");
      ...
      return {
        ...
        JsdocTypeFunction: (e, t) => {
          if (e.arrow) {
            ...
            return (
              e.parenthesis && ((r += `(${e.parameters.map(t).join(", ")})`), e.returnType !== void 0 && (r += `: ${t(e.returnType)}`)), r
            );
          }
        },
        ...
        JsdocTypeKeyValue: (e, t) => {
          let r = e.key;
          return e.optional && (r += "?"), e.variadic && (r = "..." + r), e.right === void 0 ? r : r + `: ${t(e.right)}`;
        },
    ...
    const fn = {
      ...
      JsdocTypeGeneric: (e, t) => ({ type: "TypeApplication", applications: e.elements.map((r) => t(r)), expression: t(e.left) }),
      ...
      JsdocTypeKeyValue: (e, t) => ({ type: "FieldType", key: R(e.key), value: e.right === void 0 ? void 0 : t(e.right) }),
      JsdocTypeNamePath: (e, t) => {
        const r = t(e.left);
        let s;
        e.right.type === "JsdocTypeSpecialNamePath" ? (s = t(e.right).name) : (s = A(e.right.value, e.right.meta.quote));
      ...
      JsdocTypeSymbol: (e) => {
        let t = "",
          ...
          s = !1;
        return (
          (r == null ? void 0 : r.type) === "JsdocTypeVariadic" && (r.meta.position === "prefix" ? (t = "...") : (s = !0), (r = r.element)),
    ...
    const gn = {
      ...
      JsdocTypeVariadic: (e, t) => {
        const r = {
          type: "VARIADIC",
          meta: { syntax: e.meta.position === "prefix" ? "PREFIX_DOTS" : e.meta.position === "suffix" ? "SUFFIX_DOTS" : "ONLY_DOTS" },
        };
          ...
          s = {
            ...
            params: r.params.map((c) => {
              if (c.type === "JsdocTypeKeyValue") {
                if (c.right === void 0) throw new Error("Function parameter without ':' is not expected to be 'KEY_VALUE'");
      ...
      JsdocTypeGeneric: (e, t) => {
        const r = {
          ...
          meta: { syntax: e.meta.brackets === "square" ? "SQUARE_BRACKET" : e.meta.dot ? "ANGLE_BRACKET_WITH_DOT" : "ANGLE_BRACKET" },
        };
        return (
      ...
      JsdocTypeObjectField: (e, t) => {
        if (typeof e.key != "string") throw new Error("Index signatures and mapped types are not supported");
        if (e.right === void 0) return { type: "RECORD_ENTRY", key: e.key, quoteStyle: j(e.meta.quote), value: null, readonly: !1 };
        let r = t(e.right);
        return (
      ...
      JsdocTypeKeyValue: (e, t) => {
        if (e.right === void 0) return { type: "RECORD_ENTRY", key: e.key, quoteStyle: "none", value: null, readonly: !1 };
        let r = t(e.right);
        return (
          e.optional && (r = { type: "OPTIONAL", value: r, meta: { syntax: "SUFFIX_KEY_QUESTION_MARK" } }),
      ...
      JsdocTypeObject: (e, t) => {
        const r = [];
        for (const s of e.elements) (s.type === "JsdocTypeObjectField" || s.type === "JsdocTypeJsdocObjectField") && r.push(t(s));
    ...
    function wn() {
      return {
        ...
        JsdocTypeOptional: (e, t) => ({ type: "JsdocTypeOptional", element: t(e.element), meta: { position: e.meta.position } }),
        JsdocTypeObject: (e, t) => ({ type: "JsdocTypeObject", meta: { separator: "comma" }, elements: e.elements.map(t) }),
        JsdocTypeNumber: (e) => e,
        JsdocTypeNull: (e) => e,
        JsdocTypeNotNullable: (e, t) => ({ type: "JsdocTypeNotNullable", element: t(e.element), meta: { position: e.meta.position } }),
        ...
        JsdocTypeJsdocObjectField: (e, t) => ({ type: "JsdocTypeJsdocObjectField", left: t(e.left), right: t(e.right) }),
        JsdocTypeKeyValue: (e, t) => ({
        ...
        JsdocTypeVariadic: (e, t) => {
          const r = { type: "JsdocTypeVariadic", meta: { position: e.meta.position, squareBrackets: e.meta.squareBrackets } };
          return e.element !== void 0 && (r.element = t(e.element)), r;
        },
...
var Rn = l((n) => {
  ...
  _n = ((n) => ((n.JAVASCRIPT = "JavaScript"), (n.FLOW = "Flow"), (n.TYPESCRIPT = "TypeScript"), (n.UNKNOWN = "Unknown"), n))(_n || {}),
  Fn = ["null", "undefined"];
function re(n) {
...
function et({ fence: n = "```" } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let y of i) Ln.test(y.tokens.description) && !u ? p.push([y]) : p[p.length - 1].push(y), (u = o(y.tokens.description, u));
    return p;
  }, "parseBlock");
}
l(et, "getParser");
  ...
  return l(function (p) {
    ...
    if (
      ...
      o === null &&
        ...
        ((o = []), (y.delimiter = u.slice(0, a.start.length)), (u = u.slice(a.start.length)), ([y.postDelimiter, u] = L(u))),
      o === null)
    )
      return i++, null;
...
function rt({ tokenizers: n }) {
  return l(function (a) {
    var o;
    let i = ze({ source: a });
    for (let p of n) if (((i = p(i)), !((o = i.problems[i.problems.length - 1]) === null || o === void 0) && o.critical)) break;
    return i;
  }, "parseSpec");
}
l(rt, "getParser");
function at() {
  return (n) => {
    ...
    return o === null
      ? (n.problems.push({ code: "spec:tag:prefix", message: 'tag should start with "@" symbol', line: n.source[0].number, critical: !0 }),
        n)
...
function ot(n = "compact") {
  ...
  return (o) => {
    ...
    if (i !== 0)
      return (
        o.problems.push({ code: "spec:type:unpaired-curlies", message: "unpaired curlies", line: o.source[0].number, critical: !0 }), o
      );
    let u = [],
...
function it() {
  ...
  return (a) => {
    ...
    if (u !== 0)
      return (
        a.problems.push({ code: "spec:name:unpaired-brackets", message: "unpaired brackets", line: a.source[0].number, critical: !0 }), a
      );
    let E = y;
    if (y[0] === "[" && y[y.length - 1] === "]") {
      (m = !0), (y = y.slice(1, -1));
      ...
      if (((y = N[0].trim()), N[1] !== void 0 && (h = N.slice(1).join("=").trim()), y === ""))
        return a.problems.push({ code: "spec:name:empty-name", message: "empty name", line: a.source[0].number, critical: !0 }), a;
      if (h === "")
        return (
          a.problems.push({ code: "spec:name:empty-default", message: "empty default value", line: a.source[0].number, critical: !0 }), a
        );
      if (!Vn(h) && /=(?!>)/.test(h))
        return (
          a.problems.push({
...
var Kn = l((n, { tokens: a }, o) => (a.type === "" ? n : o), "lineNo"),
  Dn = l(({ tokens: n }) => (n.delimiter === "" ? n.start : n.postDelimiter.slice(1)) + n.description, "getDescription");
function pt(n, a = _) {
...
function _t(n) {
  return n
    ? n.name === "string"
      ? !0
      : n.name === "enum"
      ? Array.isArray(n.value) && n.value.every(({ value: a }) => typeof a == "string" && a[0] === '"' && a[a.length - 1] === '"')
      : !1
    : !1;
}
l(_t, "isStringValued");
...
function G(n, a) {
  ...
  if (a != null && a.includesJsDoc) {
    ...
    let u = {
      ...p,
      params:
        (o = p == null ? void 0 : p.params) == null ? void 0 : o.map((y) => ({ name: y.getPrettyName(), description: y.description })),
    };
...
var Gn = l((n, a, o) => {
  ...
  Hn = l((n) => {
    ...
    return n.map((i) => {
      var u;
      let p = i;
      return (u = i.type) != null && u.elements && (p = { ...i, type: { ...i.type, value: i.type.elements } }), Ie(p.name, p, a, o);
    });
...
function Ie(n, a, o, i) {
  ...
  return p.includesJsDoc && p.ignore ? null : { propDef: i(n, a, p), jsDocTags: p.extractedTags, docgenInfo: a, typeSystem: o };
}
l(Ie, "extractProp");
function Zn(n) {
  return n != null ? We(n) : "";
