...
function v(o, t, e, l) {
  let i = [];
  e.forEach((n, f) => {
    let r = l && n.position === "center" ? lt(o, t, n) : et(o, t, n, i[f - 1], l);
    i[f] = r;
  });
}
function nt(o, t, e, l) {
...
function at(o, { margin: t, width: e, height: l, top: i, left: n, bottom: f, right: r }) {
...
function ht(o, { padding: t, border: e, width: l, height: i, top: n, left: f, bottom: r, right: a }) {
...
function st(o, { border: t, width: e, height: l, top: i, left: n, bottom: f, right: r }) {
...
function ut(o, { padding: t, border: e, width: l, height: i, top: n, left: f }) {
  let r = l - e.left - e.right - t.left - t.right,
    a = i - t.top - t.bottom - e.top - e.bottom;
  return (
