...
import { q as S, b, t as e, s as l, n as m, p as n, L as p, o as r, a as u } from "./PolarisAutoRichTextInput-c5e8a199.js";
...
const c = b.deserialize({
    ...
    tokenizers: [
      ...
      new r("!k~RQvwX#o#p!_~^TU~Opmq!]m!^;'Sm;'S;=`!X<%lOm~pUOpmq!]m!]!^!S!^;'Sm;'S;=`!X<%lOm~!XOU~~![P;=`<%lm~!bP#o#p!e~!jOk~~", 72, 2),
      new r("[~RPwxU~ZOp~~", 11, 15),
      new r("[~RPrsU~ZOn~~", 11, 14),
      new r("!e~RQvwXwx!_~^Tc~Opmq!]m!^;'Sm;'S;=`!X<%lOm~pUOpmq!]m!]!^!S!^;'Sm;'S;=`!X<%lOm~!XOc~~![P;=`<%lm~!dOt~~", 66, 35),
      new r("!e~RQrsXvw^~^Or~~cTb~Oprq!]r!^;'Sr;'S;=`!^<%lOr~uUOprq!]r!]!^!X!^;'Sr;'S;=`!^<%lOr~!^Ob~~!aP;=`<%lr~", 66, 33),
    ],
    topRules: { Content: [0, 1], Attribute: [1, 7] },
    tokenPrec: 157,
  }),
  P = S.parser.configure({ top: "SingleExpression" }),
  o = c.configure({
    props: [
      l({
        Text: e.content,
...
function E(O = {}) {
  ...
  return new u(t.language == a.language ? T : i(t.language), [t.support, t.language.data.of({ closeBrackets: { brackets: ["{", '"'] } })]);
}
export { E as vue, T as vueLanguage };
