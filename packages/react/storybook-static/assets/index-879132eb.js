...
import { f as $, t as O, a as P, E as S, s as X, b as c, i, j as m, c as n, L as r, h as y } from "./PolarisAutoRichTextInput-c5e8a199.js";
...
const W = new S((T, Q) => {
    if (T.next == 40) {
      let a = T.peek(-1);
      (e(a) || p(a) || a == 95 || a == 45) && T.acceptToken(f, 1);
    }
  }),
  d = new S((T) => {
    if (t.indexOf(T.peek(-1)) > -1) {
      let { next: Q } = T;
      (e(Q) || Q == 95 || Q == 35 || Q == 46 || Q == 91 || Q == 58 || Q == 45) && T.acceptToken(s);
    }
  }),
  Z = new S((T) => {
  ...
  o = r.define({
    name: "less",
    parser: g.configure({ props: [i.add({ Declaration: n() }), $.add({ Block: y })] }),
    languageData: { commentTokens: { block: { open: "/*", close: "*/" }, line: "//" }, indentOnInput: /^\s*\}$/, wordChars: "@-" },
  }),
  u = m((T) => T.name == "VariableName" || T.name == "AtKeyword");
function C() {
  return new P(o, o.data.of({ autocomplete: u }));
}
export { C as less, u as lessCompletionSource, o as lessLanguage };
