...
const g = {
  ...
  token: function (e, n) {
    if ((e.sol() && (n.context && n.context.align == null && (n.context.align = !1), (n.indent = e.indentation())), e.eatSpace()))
      return null;
    var t = n.tokenize(e, n);
    if ((t != "comment" && n.context && n.context.align == null && n.context.type != "pattern" && (n.context.align = !0), r == "("))
      l(n, ")", e.column());
      ...
      r == "." && n.context && n.context.type == "pattern"
        ...
        : /atom|string|variable/.test(t) &&
          ...
          (/[\}\]]/.test(n.context.type)
            ...
            : n.context.type == "pattern" && !n.context.align && ((n.context.align = !0), (n.context.col = e.column())));
    return t;
  },
