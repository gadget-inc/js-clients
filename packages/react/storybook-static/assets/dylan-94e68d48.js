...
var f = "[-_a-zA-Z?!*@<>$%]+",
  v = new RegExp("^" + f),
  a = { symbolKeyword: f + ":", symbolClass: "<" + f + ">", symbolGlobal: "\\*" + f + "\\*", symbolConstant: "\\$" + f },
  w = { symbolKeyword: "atom", symbolClass: "tag", symbolGlobal: "variableName.standard", symbolConstant: "variableName.constant" };
...
function s(e, i) {
  ...
  return /[+\-*\/^=<>&|]/.test(n)
    ...
    ? "def"
    : (e.eatWhile(/[\w\-]/),
      y.hasOwnProperty(e.current()) ? k[e.current()] : e.current().match(v) ? "variable" : (e.next(), "variableName.standard"));
}
function D(e, i) {
