    ...
    if (typeof u != "string" && !Array.isArray(u)) {
      for (const o in u)
        if (o !== "default" && !(o in e)) {
          ...
          c && Object.defineProperty(e, o, c.get ? c : { enumerable: !0, get: () => u[o] });
        }
    }
  }
...
function I(e, t, n) {
  ...
  if (t != null)
    for (u in (t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = "" + t.key), t))
      P.call(t, u) && !x.hasOwnProperty(u) && (o[u] = t[u]);
  ...
  return { $$typeof: y, type: e, key: c, ref: s, props: o, _owner: b.current };
}
function W(e, t) {
  ...
  if (s)
    return (
      ...
      E(o)
        ...
        : o != null &&
          (w(o) && (o = W(o, n + (!o.key || (s && s.key === o.key) ? "" : ("" + o.key).replace(R, "$&/") + "/") + e)), t.push(o)),
      1
    );
  if (((s = 0), (u = u === "" ? "." : u + ":"), E(e)))
    ...
    for (e = i.call(e), f = 0; !(c = e.next()).done; ) (c = c.value), (i = u + v(c, f++)), (s += _(c, t, n, i, o));
  else if (c === "object")
    throw (
      ((t = String(e)),
      Error(
...
var l = { current: null },
  h = { transition: null },
  Q = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: b };
r.Children = {
  map: d,
...
r.cloneElement = function (e, t, n) {
  ...
  var u = j({}, e.props),
    ...
    s = e._owner;
  if (t != null) {
    if ((t.ref !== void 0 && ((c = t.ref), (s = b.current)), t.key !== void 0 && (o = "" + t.key), e.type && e.type.defaultProps))
      var f = e.type.defaultProps;
    for (i in t) P.call(t, i) && !x.hasOwnProperty(i) && (u[i] = t[i] === void 0 && f !== void 0 ? f[i] : t[i]);
  }
...
var T = k.exports;
const Y = D(T),
  Z = A({ __proto__: null, default: Y }, [T]);
export { Y as R, Z as a, X as c, D as g, T as r };
