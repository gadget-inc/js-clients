...
var A = N.keywords,
  U = N.fileNCtrlMaskOptions,
  R = N.externalCommands,
  u = N.multiLineStrings,
  S = N.indentStatements !== !1,
  O = /[\|]/,
  t;
function P(e, n) {
  var T = e.next();
  if (T == '"' || T == "'") return (n.tokenize = L(T)), n.tokenize(e, n);
