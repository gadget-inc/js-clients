...
function L(i) {
  var s = i.keywords || o.keywords,
    ...
    R = i.multiLineStrings || o.multiLineStrings,
    y = i.indentStatements !== !1,
    A = /[\|\^]/,
    E;
  function D(e, n) {
    var t = e.next();
    if (t == '"' || t == "'") return (n.tokenize = g(t)), n.tokenize(e, n);
  ...
  return {
    ...
    token: function (e, n) {
      ...
      if ((t.align == null && (t.align = !0), (E == ";" || E == ":" || E == ",") && t.type == "statement")) S(n);
