import { c as R, g as V } from "./index-7c191284.js";
function z(w, d) {
    ...
    if (typeof y != "string" && !Array.isArray(y)) {
      for (const h in y)
        if (h !== "default" && !(h in w)) {
          ...
          p && Object.defineProperty(w, h, p.get ? p : { enumerable: !0, get: () => y[h] });
        }
    }
  }
...
var O = { exports: {} };
(function (w, d) {
  var b = (typeof globalThis < "u" && globalThis) || (typeof self < "u" && self) || (typeof R < "u" && R),
    y = (function () {
      function p() {
  ...
  (function (p) {
    (function (u) {
      var a = (typeof p < "u" && p) || (typeof self < "u" && self) || (typeof a < "u" && a),
        f = {
            ...
            (this.bodyUsed = this.bodyUsed),
              ...
              e
                ? typeof e == "string"
                  ...
                  : f.arrayBuffer && f.blob && j(e)
                  ? ((this._bodyArrayBuffer = D(e.buffer)), (this._bodyInit = new Blob([this._bodyArrayBuffer])))
                  : f.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(e) || F(e))
...
`) === 0
      ...
      x.call(l.prototype),
        (l.prototype.clone = function () {
          return new l(this._bodyInit, { status: this.status, statusText: this.statusText, headers: new s(this.headers), url: this.url });
        }),
        (l.error = function () {
      ...
      function B(e, t) {
        return new Promise(function (r, n) {
          var i = new m(e, t);
          if (i.signal && i.signal.aborted) return n(new u.DOMException("Aborted", "AbortError"));
          var o = new XMLHttpRequest();
          function _() {
            o.abort();
          }
          (o.onload = function () {
            var c = { status: o.status, statusText: o.statusText, headers: k(o.getAllResponseHeaders() || "") };
          ...
          o.open(i.method, G(i.url), !0),
            i.credentials === "include" ? (o.withCredentials = !0) : i.credentials === "omit" && (o.withCredentials = !1),
            "responseType" in o &&
              (f.blob
                ? (o.responseType = "blob")
                : f.arrayBuffer &&
                  i.headers.get("Content-Type") &&
                  i.headers.get("Content-Type").indexOf("application/octet-stream") !== -1 &&
                  (o.responseType = "arraybuffer")),
            t && typeof t.headers == "object" && !(t.headers instanceof s)
            ...
            i.signal &&
              (i.signal.addEventListener("abort", _),
      ...
      return (
        (B.polyfill = !0),
        a.fetch || ((a.fetch = B), (a.Headers = s), (a.Request = m), (a.Response = l)),
        (u.Headers = s),
        (u.Request = m),
        (u.Response = l),
        (u.fetch = B),
  ...
  (d = h.fetch),
    ...
    (d.Headers = h.Headers),
    (d.Request = h.Request),
    (d.Response = h.Response),
    (w.exports = d);
})(O, O.exports);
var U = O.exports;
const $ = V(U),
  J = z({ __proto__: null, default: $ }, [U]);
export { J as b };
