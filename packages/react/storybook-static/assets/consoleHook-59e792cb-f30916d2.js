import { u as h, v as M } from "./PolarisAutoRichTextInput-c5e8a199.js";
var k = (function () {
  function t() {
...
function E(t) {
  var r = 0,
    e = [];
  function s() {
    for (var n = ""; v(t[r]) && r < t.length; ) (n += t[r]), r++;
    return { type: a.Command, value: n };
  }
  function f() {
    for (var n = ""; y(t[r]) && r < t.length; ) (n += t[r]), r++;
    return O.get(n);
  }
  function d() {
    for (var n = ""; (g(t[r]) || b(t[r])) && r < t.length; ) (n += t[r]), r++;
    return { type: a.Argument, value: n };
  }
  function c() {
    var n = t[r],
      u = t[r];
    for (r++; t[r] !== n && r < t.length; ) (u += t[r]), r++;
  ...
  function p() {
    for (
      var n = {},
        u = function () {
          for (var l = "", o = ""; t[r] !== "=" && r < t.length; ) (l += t[r]), r++;
          for (t[r] === "=" && r++; t[r] !== " " && r < t.length; ) (o += t[r]), r++;
          n[l] = o;
        };
      _(t[r]) && r < t.length;
...
var A = function (t) {
          ...
          if ((e[c] in r)) {
            ...
            return (
              E(i).forEach(function (o) {
                var m = u === "";
                o.type === a.EnvVar && (n = o.value),
                  o.type === a.Command && m && (u = o.value),
                  (o.type === a.Argument || (!m && o.type === a.Command)) && l.push(o.value);
              }),
              { value: [u, l, { env: n }] }
            );
          }
  ...
  N = function (t) {
    return typeof t == "string"
      ? t
      : typeof t == "object" && "message" in t
      ? t.message
      : h("The server could not be reached. Make sure that the node script is running and that a port has been started.");
  },
...
`;
export { D as a, z as b, P as c, k as E, I as f, N as g, C as r, A as w };
