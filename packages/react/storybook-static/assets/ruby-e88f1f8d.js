...
const E = {
  ...
  startState: function (e) {
    return { tokenize: [p], indented: 0, context: { type: "top", indented: -e }, continuedLine: !1, lastTok: null, varList: !1 };
  },
  token: function (e, i) {
      ...
      (n =
        ...
        n == "keyword" &&
          ...
          z.propertyIsEnumerable(r)
            ...
            ? (o = "dedent")
            : (((r == "if" || r == "unless") && e.column() == e.indentation()) || (r == "do" && i.context.indented < i.indented)) &&
              (o = "indent"));
    }
    return (
