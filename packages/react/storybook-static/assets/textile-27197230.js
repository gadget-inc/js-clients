...
function h(i, e) {
  (e.mode = r.newLayout),
    (e.tableHeading = !1),
    e.layoutType === "definitionList" && e.spanningLayout && i.match(l("definitionListEnd"), !1) && (e.spanningLayout = !1);
}
function s(i, e, n) {
...
var t = {
  ...
  createRe: function (i) {
    switch (i) {
      ...
      case "allAttributes":
        return t.choiceRe(t.attributes.selector, t.attributes.css, t.attributes.lang, t.attributes.align, t.attributes.pad);
      default:
