...
function u(e, n) {
  ...
  if (e.match(/^-?[0-9\.]/, !1)) {
    ...
    var o = !1;
    if (
      (e.match(/^-?0x[0-9a-f]+/i) && (o = !0), e.match(/^-?[1-9]\d*(e[\+\-]?\d+)?/) && (o = !0), e.match(/^-?0(?![\dx])/i) && (o = !0), o)
    )
      return "number";
  }
  if (e.match(b)) return (n.tokenize = t(e.current(), !1, "string")), n.tokenize(e, n);
  if (e.match(A)) {
    if (e.current() != "/" || e.match(/^.*\//, !1)) return (n.tokenize = t(e.current(), !0, "string.special")), n.tokenize(e, n);
    e.backUp(1);
  }
