function fr(x) {
    ...
    if (hr.test(t))
      return (
        (t != ">" || !e.lexical || e.lexical.type != ">") &&
          (r.eat("=") ? (t == "!" || t == "=") && r.eat("=") : /[<>*+\-|&?]/.test(t) && (r.eat(t), t == ">" && r.eat(t))),
  ...
  function Mr(r, e, t, f, u) {
    var c = r.cc;
    for (
      i.state = r, i.stream = u, i.marked = null, i.cc = c, i.style = e, r.lexical.hasOwnProperty("align") || (r.lexical.align = !0);
      ;
  ...
  function w(r, e) {
    return r == "var"
      ...
      ? n()
      : r == "if"
      ? (i.state.lexical.info == "else" && i.state.cc[i.state.cc.length - 1] == a && i.state.cc.pop()(), n(s("form"), sr, w, a, jr))
      : r == "function"
      ? n(_)
      : r == "for"
      ? n(s("form"), Y, zr, w, T, a)
      ...
      ? k && e == "declare"
        ...
        ? ((i.marked = "keyword"),
          e == "enum" ? n($r) : e == "type" ? n(_r, l("operator"), d, l(";")) : n(s("form"), V, l("{"), s("}"), rr, a, a))
        : k && e == "namespace"
  ...
  function d(r, e) {
    if (e == "keyof" || e == "typeof" || e == "infer" || e == "readonly") return (i.marked = "keyword"), n(e == "typeof" ? g : d);
  ...
  function nr(r, e) {
    ...
    if (e == "extends" || e == "implements" || (k && r == ",")) return e == "implements" && (i.marked = "keyword"), n(k ? d : p, nr);
    if (r == "{") return n(s("}"), j, a);
  }
  function j(r, e) {
    if (
      r == "async" ||
      (r == "variable" && (e == "static" || e == "get" || e == "set" || (k && X(e))) && i.stream.match(/^\s+#?[\w$\xa1-\uffff]/, !1))
    )
  ...
  function ce(r, e, t) {
    return (
      (e.tokenize == S && /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(e.lastType)) ||
  ...
  return {
    ...
    token: function (r, e) {
      if (
        (r.sol() && (e.lexical.hasOwnProperty("align") || (e.lexical.align = !1), (e.indented = r.indentation()), ar(r, e)),
