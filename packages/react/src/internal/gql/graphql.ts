...
export type BackgroundActionResult = AddInventoryWidgetResult | CreateGamePlayerResult | CreateGameRoundResult | CreateGameStadiumResult | CreateGizmoResult | CreateModelAResult | CreateSectionResult | CreateTestDataResult | CreateWidgetResult | DeleteGamePlayerResult | DeleteGameRoundResult | DeleteGameStadiumResult | DeleteGizmoResult | DeleteModelAResult | DeleteSectionResult | DeleteUserResult | DeleteWidgetResult | SignOutUserResult | UpdateGamePlayerResult | UpdateGameRoundResult | UpdateGameStadiumResult | UpdateGizmoResult | UpdateModelAResult | UpdateSectionResult | UpdateUserResult | UpdateWidgetResult;
...
export type RolesMetadataQuery = { __typename?: 'Query', gadgetMeta: { __typename?: 'GadgetApplicationMeta', roles: Array<{ __typename?: 'GadgetRole', name: string, selectable: boolean }> } };
