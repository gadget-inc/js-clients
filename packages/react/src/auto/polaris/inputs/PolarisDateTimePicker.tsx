...
import type { DateTimeState } from "./PolarisTimePicker.tsx";
import PolarisTimePicker from "./PolarisTimePicker.tsx";
...
export const PolarisDateTimePicker = (props: {
  ...
  const localTime = useMemo(() => {
    return value ? utcToZonedTime(value, localTz) : fieldProps.value ? new Date(fieldProps.value) : new Date();
