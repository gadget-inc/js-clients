 ...
 */
export const PolarisWCDismissibleBadge = (props: ComponentProps<"s-badge"> & { onDismiss?: () => void }) => {
  return (
    <s-badge {...props}>
      <div style={{ display: "flex", alignItems: "center", gap: "2px" }}>
        {props.children}
        {props.onDismiss && <DismissIconButton onDismiss={props.onDismiss} />}
      </div>
    </s-badge>
  );
};
 ...
 */
const DismissIconButton = ({ onDismiss }: { onDismiss: () => void }) => {
