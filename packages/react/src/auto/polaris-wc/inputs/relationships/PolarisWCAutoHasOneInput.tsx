 ...
 */
export const PolarisWCAutoHasOneInput = autoInput((props: AutoRelationshipInputProps) => {
    ...
    return (
      <div style={{ display: "flex", flexWrap: "wrap", gap: "4px", marginTop: "6px" }}>
        <PolarisWCDismissibleBadge
          onDismiss={() => selectedRecord && onRemoveRecord(selectedRecord)}
          key={`selectedRecordTag_${selectedOption.id}`}
        >
          {selectedOption.primary ?? `id: ${selectedOption.id}`}
        </PolarisWCDismissibleBadge>
      </div>
    );
