...
import type { AccordionItemProps, AccordionProps, MyAccordionComponentProps } from "./types/accordionTypes.js";
...
export interface ShadcnElements {
  ...
  Accordion: React.ForwardRefExoticComponent<AccordionProps & MyAccordionComponentProps & React.RefAttributes<HTMLDivElement>>;
  ...
  AccordionTrigger: React.ForwardRefExoticComponent<{ asChild?: boolean } & React.HTMLAttributes<HTMLDivElement>>;
  /** The AccordionContent component from shadcn */
  AccordionContent: React.ComponentType<{ asChild?: boolean; forceMount?: boolean } & React.HTMLAttributes<HTMLDivElement>>;
