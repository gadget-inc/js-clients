...
export type TableProps = React.HTMLAttributes<HTMLTableElement> & React.RefAttributes<HTMLTableElement>;
...
export type TableCellProps = React.TdHTMLAttributes<HTMLTableCellElement> & React.RefAttributes<HTMLTableCellElement>;
export type TableFooterProps = React.HTMLAttributes<HTMLTableSectionElement> & React.RefAttributes<HTMLTableSectionElement>;
export type TableHeadProps = React.HTMLAttributes<HTMLTableCellElement> & React.RefAttributes<HTMLTableCellElement>;
export type TableHeaderProps = React.HTMLAttributes<HTMLTableSectionElement> & React.RefAttributes<HTMLTableSectionElement>;
export type TableRowProps = React.HTMLAttributes<HTMLTableRowElement> & React.RefAttributes<HTMLTableRowElement>;
