...
export const MUIAutoJSONInput = (props: {
  ...
  const { onStringValueChange, stringValue, originalController } = useJSONInputController(props);
  ...
  return (
    <>
      ...
      >
        <SharedCodeEditor value={stringValue} onChange={onStringValueChange} testId={`mui-json-input-${props.field}`} />
      </div>
    </>
  );
};
