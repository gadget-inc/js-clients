...
export const validateFindByObjectWithMetadata = (
  ...
  if (typeof findBy !== "object" || Array.isArray(findBy) || Object.keys(findBy).length !== 1) {
    throw new Error("The findBy prop in AutoForm must be an object containing a unique Gadget field API identifier as a key.");
  }
