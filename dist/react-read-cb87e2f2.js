...
const re = Symbol.for("g/f"), et = Symbol.for("g/if"), tt = Symbol.for("g/pf"), rt = Symbol.for("g/fk"), qt = Symbol.for("g/t"), N = Symbol.for("g/s");
class So {
  constructor(t) {
    var r, n;
...
class zi {
  constructor(t) {
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof or < "u" && or.fetch ? this._fetchImplementation = or.fetch.bind(or) : this._fetchImplementation = async (...s) => {
      let l = await import("./browser-ponyfill-dd0552c3.js").then((d) => d.b);
