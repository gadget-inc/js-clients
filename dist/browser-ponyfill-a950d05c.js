function C(b, l) {
  for (var p = 0; p < l.length; p++) {
    ...
    if (typeof c != "string" && !Array.isArray(c)) {
      for (const h in c)
        if (h !== "default" && !(h in b)) {
          const n = Object.getOwnPropertyDescriptor(c, h);
...
var k = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, B = { exports: {} };
(function(b, l) {
  var p = typeof self < "u" ? self : k, c = function() {
    function n() {
    ...
    (function(f) {
      ...
      function D() {
        return this.bodyUsed = !1, this._initBody = function(e) {
          ...
          return this._bodyArrayBuffer ? g(this) || Promise.resolve(this._bodyArrayBuffer) : this.blob().then(j);
        }), this.text = function() {
          var e = g(this);
          if (e)
            return e;
      ...
      function A(e, t) {
        return new Promise(function(r, a) {
          ...
          }, o.open(s.method, s.url, !0), s.credentials === "include" ? o.withCredentials = !0 : s.credentials === "omit" && (o.withCredentials = !1), "responseType" in o && u.blob && (o.responseType = "blob"), s.headers.forEach(function(w, E) {
            o.setRequestHeader(E, w);
      ...
      return A.polyfill = !0, n.fetch || (n.fetch = A, n.Headers = i, n.Request = y, n.Response = d), f.Headers = i, f.Request = y, f.Response = d, f.fetch = A, Object.defineProperty(f, "__esModule", { value: !0 }), f;
    })({});
  })(c), c.fetch.ponyfill = !0, delete c.fetch.polyfill;
  var h = c;
  l = h.fetch, l.default = h.fetch, l.fetch = h.fetch, l.Headers = h.Headers, l.Request = h.Request, l.Response = h.Response, b.exports = l;
})(B, B.exports);
var N = B.exports;
const z = /* @__PURE__ */ C({
  __proto__: null
