...
function Ki(e) {
  return Xi(e) || ba(e) || ga(e) || va(e) || Zi(e) || er(e) || tr(e) || Ce(e);
}
function Xi(e) {
  return $e(e, ut);
}
...
new ut({
  ...
  parseValue(e) {
    ...
    if (typeof e == "number" && Number.isInteger(e))
      return e.toString();
    throw new j(`ID cannot represent value: ${R(e)}`);
  },
  parseLiteral(e) {
...
function mi(e) {
  e.state >= Nn || (e.state < Gt && gt(e), e.state = Nn);
}
function Ha(e, t) {
...
var Rt = /* @__PURE__ */ new WeakMap(), Tt = (
  /** @class */
  function() {
    function e(t, n) {
      Rt.set(this, {
    ...
    return e.prototype.next = function(t) {
      ...
      if (n === void 0)
        throw new Error("WeakMap error");
      return n.state <= hn || n.state >= ze || typeof n.buffer < "u" && !n.buffer.empty ? (gt(n), n.err == null && (n.err = t), Le(n, tt(n))) : this.next(Promise.reject(t));
...
function as() {
  ...
  const n = [];
  function i(s) {
    e.type === "running" && (n.push(s), t.resolve(), t = bi());
  }
...
var L, O;
function re(e) {
  return new Pn(`Syntax Error: Unexpected token at ${O} in ${e}`);
}
function Ae(e) {
...
var Ds = (...e) => {
  for (var t = e[0], n = 1, i = e.length; n < i; n++)
    t = e[n](t);
  return t;
}, Cs = (e) => e && e.message && (e.extensions || e.name === "GraphQLError") ? e : typeof e == "object" && e.message ? new Pn(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : new Pn(e);
...
`) : e, Oi = (e) => e.split(Vs).map(Ms).join("").trim(), Ai = /* @__PURE__ */ new Map(), Lt = /* @__PURE__ */ new Map(), Jn = (e) => {
  var t;
  return typeof e == "string" ? t = Oi(e) : e.loc && Lt.get(e.__key) === e ? t = e.loc.source.body : (t = Ai.get(e) || Oi(Ee(e)), Ai.set(e, t)), typeof e != "string" && !e.loc && (e.loc = {
    start: 0,
    end: t.length,
    source: {
      body: t,
...
var $s = (e, t) => {
  ...
  if (t && !(e.kind === "query" && e.context.preferGetMethod)) {
    var n = Ht(t), i = ((o) => {
      ...
      return (Yt !== st || Kt !== st) && (Qe.clear(), kn(l, "variables", o)), l;
    })(t.variables);
    if (i.size) {
      var r = new FormData();
...
`)) {
    ...
    for await (var l of o)
      r = r ? xn(r, l, a) : Tn(e, l, a), i = !1, yield r, i = !0;
    r || (yield r = Tn(e, {}, a));
  } catch (u) {
    if (!i)
      throw u;
...
function Ws(e, t, n) {
  var i;
  return typeof AbortController < "u" && (n.signal = (i = new AbortController()).signal), br(() => {
    i && i.abort();
  })(ye((r) => !!r)(vr(zs(e, t, n))));
}
var jn = (e, t) => {
  if (Array.isArray(e))
    ...
    for (var i in e)
      i === "__typename" && typeof e[i] == "string" ? t.add(e[i]) : jn(e[i], t);
  return t;
}, Fn = (e) => {
  var t = !1;
  if ("definitions" in e) {
  ...
  return e;
}, Ti = /* @__PURE__ */ new Map(), Js = (e) => {
  var t = Sr(e), n = Ti.get(t.__key);
  return n || (Ti.set(t.__key, n = Fn(t)), Object.defineProperty(n, "__key", {
    value: t.__key,
    enumerable: !1
  })), n;
}, Dn = (e, t) => {
...
function _i(e) {
  var t = (n) => e(n);
  return t.toPromise = () => Fs(gr(1)(ye((n) => !n.stale && !n.hasNext)(t))), t.then = (n, i) => t.toPromise().then(n, i), t.subscribe = (n) => Jt(n)(t), t;
}
function ot(e, t, n) {
  return {
    ...t,
...
var xi = (e, t) => ot(e.kind, e, {
  ...
  return (o) => {
    var l = nt((c) => {
      ...
      }), c.context.requestPolicy === "cache-and-network" && (d.stale = !0, ji(t, c)), d;
    })(ye((c) => !mn(c) && s(c))(o)), u = sn((c) => {
      var { operation: f } = c;
      if (f) {
        var d = f.context.additionalTypenames || [];
        if (c.operation.kind !== "subscription" && (d = ((b) => [...jn(b, /* @__PURE__ */ new Set())])(c.data).concat(d)), c.operation.kind === "mutation" || c.operation.kind === "subscription") {
          ...
          for (var F of h.values())
            i.has(F) && (f = i.get(F).operation, i.delete(F), ji(t, f));
...
}, ji = (e, t) => e.reexecuteOperation(ot(t.kind, t, {
  requestPolicy: "network-only"
})), bn = ({ forwardSubscription: e, enableAllOperations: t, isSubscriptionOperation: n }) => ({ client: i, forward: r }) => {
        ...
        return Wn(({ next: p, complete: g }) => {
          ...
          return Promise.resolve().then(() => {
            I || (_ = h.subscribe({
              ...
              complete() {
                I || (I = !0, d.kind === "subscription" && i.reexecuteOperation(ot("teardown", d, d.context)), F && F.hasNext && p(xn(F, {
                  hasNext: !1
                })), g());
              }
            }));
  ...
  var d = (y) => {
    var w = zn(ye((b) => b.kind === "teardown" && b.key === y.key)(l.source))(ye((b) => b.operation.kind === y.kind && b.operation.key === y.key && (!b.operation.context._instance || b.operation.context._instance === y.context._instance))(A));
    return y.kind !== "query" ? w = ks((b) => !!b.hasNext, !0)(w) : w = vi((b) => {
      var G = vt(b);
      return b.stale || b.hasNext ? G : at([G, nt(() => (b.stale = !0, b))(gr(1)(ye((We) => We.key === y.key)(l.source)))]);
    })(w), y.kind !== "mutation" ? w = br(() => {
    ...
    executeRequestOperation(y) {
      return y.kind === "mutation" ? _i(d(y)) : _i(Ts(() => {
        var w = r.get(y.key);
        w || r.set(y.key, w = d(y)), w = gi(() => {
          f(y);
        })(w);
        var b = i.get(y.key);
        return y.kind === "query" && b && (b.stale || b.hasNext) ? vi(vt)(at([w, ye((G) => G === i.get(y.key))(vt(b))])) : w;
      }));
    },
    executeQuery(y, w) {
    ...
    query: (y, w, b) => p.executeQuery(yn(y, w), b),
    subscription: (y, w, b) => p.executeSubscription(yn(y, w), b),
    mutation: (y, w, b) => p.executeMutation(yn(y, w), b)
  }), g = Hs;
  if (process.env.NODE_ENV !== "production") {
    var { next: I, source: _ } = Si();
    p.subscribeToDebugTarget = (y) => Jt(y)(_), g = I;
  }
  var F = Xs(t.exchanges), A = Nt(F({
    client: p,
    dispatchDebug: g,
    forward: Zs({
      dispatchDebug: g
...
function io(e) {
  ...
  let b, G = 0, We, dn = !1, Ft = 0, ti = !1;
  async function ni() {
    clearTimeout(We);
    const [E, ae] = await (b ?? (b = new Promise((ee, qe) => (async () => {
      if (dn) {
        if (await c(Ft), !G)
          return b = void 0, qe({ code: 1e3, reason: "All Subscriptions Gone" });
        Ft++;
      }
      y.emit("connecting");
      ...
      w((pe) => {
        b = void 0, clearTimeout(Je), clearTimeout(pt), qe(pe), Ut(pe) && pe.code === 4499 && (V.close(4499, "Terminated"), V.onerror = null, V.onclose = null);
        ...
        try {
          ...
          y.emit("error", pe), V.close(ve.InternalClientError, Di(pe instanceof Error ? pe.message : new Error(pe).message, "Internal client error"));
        }
      };
      let He = !1;
      V.onmessage = ({ data: pe }) => {
        try {
          ...
          clearTimeout(Je), He = !0, y.emit("connected", V, he.payload), dn = !1, Ft = 0, ee([
            V,
            new Promise((Bu, Mr) => w(Mr))
          ]);
        } catch (he) {
          V.onmessage = null, y.emit("error", he), V.close(ve.BadResponse, Di(he instanceof Error ? he.message : new Error(he).message, "Bad response"));
        }
      };
    })())));
...
class Ci extends Error {
  constructor(t) {
    let n;
    Vn(t) ? n = `GraphQL websocket closed unexpectedly by the server with error code ${t.code} and reason "${t.reason}"` : n = "GraphQL websocket closed unexpectedly by the server", super(n), Object.defineProperty(this, "code", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: "GGT_UNKNOWN"
...
}, Vn = (e) => (e == null ? void 0 : e.type) == "close", De = (e, t) => typeof e != "string" ? "" : un(e, t), Ri = (e) => {
...
}, yo = (e) => `${un(e)}Sort`, mo = (e) => `${un(e)}Filter`, bo = (e, t, n) => new Er(`More than one record found for ${e}.${t} = ${n}. Please confirm your unique validation is not reporting an error.`), Ve = (e, t, n = !1) => {
  var i;
  if (e.error)
...
`)), e.error;
  ...
  var t;
  return e.code == "GGT_INVALID_RECORD" ? new fo(e.message, e.validationErrors, (t = e.model) === null || t === void 0 ? void 0 : t.apiIdentifier, e.record) : e.code == "GGT_UNKNOWN" && e.message.includes("duplicate key value violates unique constraint") ? new Er(e.message) : new on(e.message, e.code);
}, Ge = (e, t) => {
  const n = Ve(e, t);
  if (!n.success) {
    const i = n.errors && n.errors[0];
    throw i ? kr(i) : new on("Gadget API operation not successful.", "GGT_UNKNOWN");
  }
  return n;
}, Tr = (e) => {
  var t, n, i, r;
...
const wo = 2, Oo = 4800, Ao = 1e4, No = [ve.ConnectionAcknowledgementTimeout, ve.ConnectionInitialisationTimeout], Li = Symbol.for("gadget/connection"), Po = "token", Eo = typeof btoa < "u" ? btoa : (e) => Buffer.from(e).toString("base64");
var se;
(function(e) {
...
class xr {
    ...
    if (Object.defineProperty(this, "options", {
      ...
      value: async (o, l) => {
        ...
        try {
          ...
          h[Li] = this, d = new go(h, f), this.currentTransaction = d, await d.start();
          const p = await u(d);
      ...
      value: async (o, l = {}) => {
        var u;
        o = ko(o, (u = this.options.baseRouteURL) !== null && u !== void 0 ? u : this.options.endpoint), this.isGadgetRequest(o) && (l.headers = { ...this.requestHeaders(), ...l.headers }, this.authenticationMode == se.Custom && await this.options.authenticationMode.custom.processFetch(o, l));
  ...
  enableSessionMode(t) {
    ...
    let i;
    n == bt.Durable && Mi("localStorage") ? i = window.localStorage : n == bt.Session && Mi("sessionStorage") ? i = window.sessionStorage : i = new vo(), t !== null && typeof t == "object" && "initialToken" in t && t.initialToken && i.setItem(this.sessionStorageKey, t.initialToken), this.sessionTokenStore = i, this.resetClients();
  }
  close() {
  ...
  requestHeaders() {
    ...
    if (this.authenticationMode == se.InternalAuthToken)
      n.authorization = "Basic " + Eo("gadget-internal:" + this.options.authenticationMode.internalAuthToken);
...
class Pt extends Array {
  ...
  async nextPage() {
    var t;
    if (!this.hasNextPage)
      throw new Cn("Cannot request next page because there isn't one, should check 'hasNextPage' to see if it exists");
  ...
  async previousPage() {
    ...
    if (!this.hasPreviousPage)
      throw new Cn("Cannot request previous page because there isn't one, should check 'hasPreviousPage' to see if it exists");
...
const ct = (e, t) => new Kn(e, t), fe = (e) => new Xn(e.type + (e.required ? "!" : ""), e.name, e.value), _o = (e) => {
  var t;
  const n = To(e), i = e.directives && e.directives.length > 0 ? ` ${e.directives.join(" ")}` : "";
...
class Te {
  constructor(t, n, i) {
    Object.defineProperty(this, "apiIdentifier", {
      ...
      writable: !0,
      value: void 0
    }), this.capitalizedApiIdentifier = un(t);
  }
  validateRecord(t) {
  ...
  async findOne(t, n, i = !0) {
    const r = await this.connection.currentClient.query(xo(this.apiIdentifier), { id: t, select: Fr(n == null ? void 0 : n.select) }).toPromise(), s = (i ? Ve : St)(r, ["internal", this.apiIdentifier]);
    return It(r, s);
  }
  /**
   ...
   */
  async findMany(t) {
    const n = Fo(this.apiIdentifier, t), i = await this.connection.currentClient.query(n.query, n.variables).toPromise(), r = St(i, ["internal", `list${this.capitalizedApiIdentifier}`]), a = Zt(i, r);
  ...
  async findFirst(t, n = !0) {
    const i = jo(this.apiIdentifier, t), r = await this.connection.currentClient.query(i.query, i.variables).toPromise();
    let a;
   ...
   */
  async create(t) {
    const n = await this.connection.currentClient.mutation(Do(this.apiIdentifier), {
  ...
  async bulkCreate(t) {
    ...
    if (!(!((n = this.options) === null || n === void 0) && n.pluralApiIdentifier))
      throw new Cn("Cannot perform bulkCreate without a pluralApiIdentifier");
    const i = De(this.options.pluralApiIdentifier), r = await this.connection.currentClient.mutation(Co(this.apiIdentifier, this.options.pluralApiIdentifier), {
      records: t
