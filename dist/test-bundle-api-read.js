...
function wn(e, t) {
  ...
  for (const r of e.body.matchAll(qr)) {
    if (typeof r.index == "number" || zi(!1), r.index >= t)
      break;
...
let j = class Ji extends Error {
  ...
  constructor(t, ...n) {
    ...
    super(t), this.name = "GraphQLError", this.path = u ?? void 0, this.originalError = c ?? void 0, this.nodes = si(
      Array.isArray(s) ? s : s ? [s] : void 0
    );
    const d = si(
      (i = this.nodes) === null || i === void 0 ? void 0 : i.map((p) => p.loc).filter((p) => p != null)
    );
    this.source = o ?? (d == null || (r = d[0]) === null || r === void 0 ? void 0 : r.source), this.positions = l ?? (d == null ? void 0 : d.map((p) => p.start)), this.locations = l && o ? l.map((p) => wn(o, p)) : d == null ? void 0 : d.map((p) => wn(p.source, p.start));
    const h = wt(
    ...
    this.extensions = (a = f ?? h) !== null && a !== void 0 ? a : /* @__PURE__ */ Object.create(null), Object.defineProperties(this, {
      ...
      writable: !0,
      configurable: !0
    }) : Error.captureStackTrace ? Error.captureStackTrace(this, Ji) : Object.defineProperty(this, "stack", {
      value: Error().stack,
      writable: !0,
      configurable: !0
    });
...
function Wr(e) {
  return Yi(e) || Qr(e) || e === 95;
}
function Jr(e, t) {
  const n = e.replace(/"""/g, '\\"""'), i = n.split(/\r\n|[\n\r]/g), r = i.length === 1, a = i.length > 1 && i.slice(1).every((h) => h.length === 0 || li(h.charCodeAt(0))), s = n.endsWith('\\"""'), o = e.endsWith('"') && !s, l = e.endsWith("\\"), u = o || l, c = !(t != null && t.minimize) && // add leading and trailing new lines only if it improves readability
  (!r || e.length > 70 || u || a || s);
  let f = "";
  const d = r && li(e.charCodeAt(0));
  return (c && !d || a) && (f += `
`), f += n, (c || u) && (f += `
`), '"""' + f + '"""';
}
...
function Xr(e, t) {
  ...
  return n.length === 0 ? "{}" : t.length > Ki ? "[" + ea(e) + "]" : "{ " + n.map(
    ([r, a]) => r + ": " + tn(a, t)
  ).join(", ") + " }";
}
function Zr(e, t) {
...
function ia(e, t) {
  ...
  for (; n < e.length && i < t.length; ) {
    ...
    if (Ct(r) && Ct(a)) {
      let s = 0;
      do
        ++n, s = s * 10 + r - On, r = e.charCodeAt(n);
      while (Ct(r) && s > 0);
      let o = 0;
      do
        ++i, o = o * 10 + a - On, a = t.charCodeAt(i);
      while (Ct(a) && o > 0);
      if (s < o)
        return -1;
      if (s > o)
...
class sa {
  constructor(t) {
    this._input = t, this._inputLowerCase = t.toLowerCase(), this._inputArray = di(this._inputLowerCase), this._rows = [
...
function fa(e, t, n = Hi) {
  ...
  do {
    o++;
    const _ = o === s.length, F = _ && l.length !== 0;
    if (_) {
      if (c = h.length === 0 ? void 0 : d[d.length - 1], u = f, f = h.pop(), F)
        if (a) {
          u = u.slice();
          let y = 0;
          for (const [w, b] of l) {
            const G = w - y;
            b === null ? (u.splice(G, 1), y++) : u[G] = b;
          }
        } else {
    ...
    if (!Array.isArray(u)) {
      var p, g;
      oi(u) || X(!1, `Invalid AST Node: ${M(u)}.`);
      const y = _ ? (p = i.get(u.kind)) === null || p === void 0 ? void 0 : p.leave : (g = i.get(u.kind)) === null || g === void 0 ? void 0 : g.enter;
...
`)
  ...
  OperationDefinition: {
    leave(e) {
      const t = P("(", v(e.variableDefinitions, ", "), ")"), n = v(
        [
          e.operation,
          v([e.name, t]),
          v(e.directives, " ")
  ...
  VariableDefinition: {
    leave: ({ variable: e, type: t, defaultValue: n, directives: i }) => e + ": " + t + P(" = ", n) + P(" ", v(i, " "))
  },
  SelectionSet: {
...
`)), `
  ...
  // Fragments
  FragmentSpread: {
    leave: ({ name: e, directives: t }) => "..." + e + P(" ", v(t, " "))
  },
  InlineFragment: {
  ...
  // Directive
  Directive: {
    leave: ({ name: e, arguments: t }) => "@" + e + P("(", v(t, ", "), ")")
  },
  // Type
  NamedType: {
    leave: ({ name: e }) => e
...
`, Bt(v(n, `
`)), `
)`) : P("(", v(n, ", "), ")")) + (i ? " repeatable" : "") + " on " + v(r, " | ")
  },
  SchemaExtension: {
    leave: ({ directives: e, operationTypes: t }) => v(
      ["extend schema", v(e, " "), ke(t)],
      " "
    )
  },
  ScalarTypeExtension: {
  ...
  EnumTypeExtension: {
    leave: ({ name: e, directives: t, values: n }) => v(["extend enum", e, v(t, " "), ke(n)], " ")
  },
  InputObjectTypeExtension: {
    leave: ({ name: e, directives: t, fields: n }) => v(["extend input", e, v(t, " "), ke(n)], " ")
  }
};
function v(e, t = "") {
  var n;
...
function ma(e) {
  if (e === "true" || e === "false" || e === "null")
    throw new j(`Enum values cannot be named: ${e}`);
  return xe(e);
}
function Xi(e) {
  return Zi(e) || ba(e) || ga(e) || va(e) || er(e) || tr(e) || nr(e) || Ce(e);
}
function Zi(e) {
  return qe(e, ut);
}
...
class Ia {
  constructor(t) {
    Xi(t) || X(!1, `Expected ${M(t)} to be a GraphQL type.`), this.ofType = t;
  }
  get [Symbol.toStringTag]() {
    return "GraphQLList";
  }
...
class rn {
  constructor(t) {
    wa(t) || X(
      !1,
      `Expected ${M(t)} to be a GraphQL nullable type.`
    ), this.ofType = t;
  }
  get [Symbol.toStringTag]() {
...
class ut {
  constructor(t) {
    var n, i, r, a;
    const s = (n = t.parseValue) !== null && n !== void 0 ? n : ci;
    this.name = xe(t.name), this.description = t.description, this.specifiedByURL = t.specifiedByURL, this.serialize = (i = t.serialize) !== null && i !== void 0 ? i : ci, this.parseValue = s, this.parseLiteral = (r = t.parseLiteral) !== null && r !== void 0 ? r : (o, l) => s(An(o, l)), this.extensions = _e(t.extensions), this.astNode = t.astNode, this.extensionASTNodes = (a = t.extensionASTNodes) !== null && a !== void 0 ? a : [], t.specifiedByURL == null || typeof t.specifiedByURL == "string" || X(
      !1,
      `${this.name} must provide "specifiedByURL" as a string, but got: ${M(t.specifiedByURL)}.`
...
class Oa {
  constructor(t) {
    var n;
    this.name = xe(t.name), this.description = t.description, this.isTypeOf = t.isTypeOf, this.extensions = _e(t.extensions), this.astNode = t.astNode, this.extensionASTNodes = (n = t.extensionASTNodes) !== null && n !== void 0 ? n : [], this._fields = () => sr(t), this._interfaces = () => ar(t), t.isTypeOf == null || typeof t.isTypeOf == "function" || X(
      !1,
      `${this.name} must provide "isTypeOf" as a function, but got: ${M(t.isTypeOf)}.`
    );
  }
  get [Symbol.toStringTag]() {
...
function sr(e) {
  ...
  return et(t) || X(
    ...
    et(n) || X(
      ...
      !1,
      `${e.name}.${i} field resolver must be a function if provided, but got: ${M(n.resolve)}.`
    );
...
class Aa {
  constructor(t) {
    var n;
    this.name = xe(t.name), this.description = t.description, this.resolveType = t.resolveType, this.extensions = _e(t.extensions), this.astNode = t.astNode, this.extensionASTNodes = (n = t.extensionASTNodes) !== null && n !== void 0 ? n : [], this._fields = sr.bind(void 0, t), this._interfaces = ar.bind(void 0, t), t.resolveType == null || typeof t.resolveType == "function" || X(
      !1,
      `${this.name} must provide "resolveType" as a function, but got: ${M(t.resolveType)}.`
    );
  }
  get [Symbol.toStringTag]() {
...
class Na {
  constructor(t) {
    var n;
    this.name = xe(t.name), this.description = t.description, this.resolveType = t.resolveType, this.extensions = _e(t.extensions), this.astNode = t.astNode, this.extensionASTNodes = (n = t.extensionASTNodes) !== null && n !== void 0 ? n : [], this._types = Pa.bind(void 0, t), t.resolveType == null || typeof t.resolveType == "function" || X(
      !1,
      `${this.name} must provide "resolveType" as a function, but got: ${M(t.resolveType)}.`
    );
  }
...
class Ea {
  ...
  constructor(t) {
    var n;
    this.name = xe(t.name), this.description = t.description, this.extensions = _e(t.extensions), this.astNode = t.astNode, this.extensionASTNodes = (n = t.extensionASTNodes) !== null && n !== void 0 ? n : [], this._values = ka(this.name, t.values), this._valueLookup = new Map(
      this._values.map((i) => [i.value, i])
    ), this._nameLookup = Ln(this._values, (i) => i.name);
  }
  get [Symbol.toStringTag]() {
  ...
  serialize(t) {
    ...
    if (n === void 0)
      throw new j(
        `Enum "${this.name}" cannot represent value: ${M(t)}`
      );
    return n.name;
  }
  parseValue(t) {
...
function ka(e, t) {
  return et(t) || X(
    ...
    !1,
    `${e}.${n} must refer to an object with a "value" key representing an internal value but got: ${M(i)}.`
  ), {
    name: ma(n),
...
const hn = 2147483647, yn = -2147483648, xa = new ut({
  name: "Int",
  ...
  serialize(e) {
    ...
    if (typeof t == "string" && t !== "" && (n = Number(t)), typeof n != "number" || !Number.isInteger(n))
      throw new j(
        `Int cannot represent non-integer value: ${M(t)}`
      );
    if (n > hn || n < yn)
      throw new j(
        "Int cannot represent non 32-bit signed integer value: " + M(t)
      );
    return n;
  },
  parseValue(e) {
    if (typeof e != "number" || !Number.isInteger(e))
      throw new j(
        `Int cannot represent non-integer value: ${M(e)}`
      );
    if (e > hn || e < yn)
      throw new j(
  ...
  parseLiteral(e) {
    if (e.kind !== C.INT)
      throw new j(
        `Int cannot represent non-integer value: ${Ue(e)}`,
        {
          nodes: e
        }
      );
...
new ut({
  ...
  serialize(e) {
    ...
    if (typeof t == "string" && t !== "" && (n = Number(t)), typeof n != "number" || !Number.isFinite(n))
      throw new j(
        `Float cannot represent non numeric value: ${M(t)}`
      );
    return n;
  },
  parseValue(e) {
    if (typeof e != "number" || !Number.isFinite(e))
      throw new j(
        `Float cannot represent non numeric value: ${M(e)}`
      );
    return e;
  },
  parseLiteral(e) {
    if (e.kind !== C.FLOAT && e.kind !== C.INT)
      throw new j(
        `Float cannot represent non numeric value: ${Ue(e)}`,
        e
      );
    return parseFloat(e.value);
  }
...
const cr = new ut({
  ...
  serialize(e) {
    ...
    if (typeof t == "number" && Number.isFinite(t))
      return t.toString();
    throw new j(
      `String cannot represent value: ${M(e)}`
    );
  },
  parseValue(e) {
    if (typeof e != "string")
      throw new j(
        `String cannot represent a non string value: ${M(e)}`
      );
    return e;
  },
  parseLiteral(e) {
    if (e.kind !== C.STRING)
      throw new j(
        `String cannot represent a non string value: ${Ue(e)}`,
        {
          nodes: e
        }
      );
  ...
  serialize(e) {
    ...
    if (Number.isFinite(t))
      return t !== 0;
    throw new j(
      `Boolean cannot represent a non boolean value: ${M(t)}`
    );
  },
  parseValue(e) {
    if (typeof e != "boolean")
      throw new j(
        `Boolean cannot represent a non boolean value: ${M(e)}`
      );
    return e;
  },
  parseLiteral(e) {
    if (e.kind !== C.BOOLEAN)
      throw new j(
        `Boolean cannot represent a non boolean value: ${Ue(e)}`,
        {
          nodes: e
        }
      );
...
new ut({
  ...
  parseValue(e) {
    ...
    if (typeof e == "number" && Number.isInteger(e))
      return e.toString();
    throw new j(`ID cannot represent value: ${M(e)}`);
  },
  parseLiteral(e) {
    if (e.kind !== C.STRING && e.kind !== C.INT)
      throw new j(
        "ID cannot represent a non-string and non-integer value: " + Ue(e),
        {
          nodes: e
        }
      );
...
function yt(e, t, n) {
  if (e) {
    if (e.kind === C.VARIABLE) {
      const i = e.name.value;
      if (n == null || n[i] === void 0)
        return;
      const r = n[i];
      return r === null && Ce(t) ? void 0 : r;
    }
    if (Ce(t))
      return e.kind === C.NULL ? void 0 : yt(e, t.ofType, n);
    if (e.kind === C.NULL)
      return null;
    if (nr(t)) {
      const i = t.ofType;
    ...
    if (tr(t)) {
      if (e.kind !== C.OBJECT)
        return;
      const i = /* @__PURE__ */ Object.create(null), r = Ln(e.fields, (a) => a.name.value);
    ...
    zi(!1, "Unexpected input type: " + M(t));
  }
}
function pi(e, t) {
  return e.kind === C.VARIABLE && (t == null || t[e.name.value] === void 0);
}
function Fa(e, t, n) {
  var i;
  const r = {}, a = (i = t.arguments) !== null && i !== void 0 ? i : [], s = Ln(a, (o) => o.name.value);
  for (const o of e.args) {
    ...
    if (!c) {
      if (o.defaultValue !== void 0)
        ...
        throw new j(
          `Argument "${l}" of required type "${M(u)}" was not provided.`,
          {
            nodes: t
          }
        );
    ...
    if (f.kind === C.VARIABLE) {
      ...
      if (n == null || !Ca(n, p)) {
        if (o.defaultValue !== void 0)
          ...
          throw new j(
            `Argument "${l}" of required type "${M(u)}" was provided the variable "$${p}" which was not provided a runtime value.`,
            {
              nodes: f
            }
          );
    ...
    if (d && Ce(u))
      throw new j(
        `Argument "${l}" of non-null type "${M(u)}" must not be null.`,
        {
          nodes: f
        }
      );
    ...
    if (h === void 0)
      throw new j(
        `Argument "${l}" has invalid value ${Ue(f)}.`,
        {
          nodes: f
        }
      );
...
function Qa(e) {
  ...
  for (a = a.sort(yi.numerically), t = a.length - 1; t >= 0; t--) {
    n = a[t];
  ...
  s = s.sort(yi.numericallyBy("index"));
  let l = s.length;
  for (t = 0; t < l; t++) {
    let c = s[t];
...
var mn = 0, mi = 1, We = 2, Gt = 3, En = 4, Qt = 1024, zt = function() {
};
function tt(e) {
...
function Ge(e, t) {
  ...
  return Promise.resolve(t).then(function(i) {
    return !n && e.state >= En ? tt(e).then(function(r) {
      return {
        value: r,
        done: !0
      };
...
function zn(e, t) {
  var n, i;
  if (!(e.state >= We))
    if (e.state = We, e.onnext(), e.onstop(), e.err == null && (e.err = t), e.pushes.length === 0 && (typeof e.buffer > "u" || e.buffer.empty))
      gt(e);
    else
      try {
...
function gt(e) {
  var t, n;
  if (!(e.state >= Gt)) {
    e.state < We && zn(e), e.state = Gt, e.buffer = void 0;
    try {
...
function bi(e) {
  e.state >= En || (e.state < Gt && gt(e), e.state = En);
}
function Ha(e, t) {
  if (Pn(t), e.pushes.length >= Qt)
    throw new fr("No more than " + Qt + " pending calls to push are allowed on a single repeater.");
  if (e.state >= We)
  ...
  n = n.catch(function(l) {
    e.state < We && (e.err = l), bi(e);
  });
  var i;
  if (e.nexts.length) {
    var r = e.nexts.shift();
    r.resolve(Ge(e, n)), e.nexts.length ? i = Promise.resolve(e.nexts[0].value) : i = new Promise(function(l) {
      return e.onnext = l;
    });
  } else
...
function Ya(e) {
  var t = zn.bind(null, e), n = new Promise(function(i) {
    return e.onstop = i;
  });
...
var Mt = /* @__PURE__ */ new WeakMap(), Tt = (
  /** @class */
  function() {
    function e(t, n) {
      Mt.set(this, {
    ...
    return e.prototype.next = function(t) {
      ...
      if (n.nexts.length >= Qt)
        throw new fr("No more than " + Qt + " pending calls to next are allowed on a single repeater.");
      if (n.state <= mn && Ka(n), n.onnext(t), typeof n.buffer < "u" && !n.buffer.empty) {
        var i = Ge(n, n.buffer.remove());
        if (n.pushes.length) {
        ...
        return n.onnext = a.resolve, Ge(n, a.value);
      } else if (n.state >= We)
        return gt(n), Ge(n, tt(n));
      ...
      if (n === void 0)
        throw new Error("WeakMap error");
      return gt(n), n.execution = Promise.resolve(n.execution).then(function() {
        return t;
      }), Ge(n, tt(n));
      ...
      if (n === void 0)
        throw new Error("WeakMap error");
      return n.state <= mn || n.state >= We || typeof n.buffer < "u" && !n.buffer.empty ? (gt(n), n.err == null && (n.err = t), Ge(n, tt(n))) : this.next(Promise.reject(t));
...
function Xa(e) {
  var t = this, n = an(e, { returnValues: !0 });
  return new Tt(function(i, r) {
            ...
            f.trys.push([1, , 5, 7]), l = void 0, u = 0, c = function() {
              ...
              return $e(this, function(F) {
                switch (F.label) {
                  case 0:
                    ...
                    try {
                      for (h = (I = void 0, lt(n)), p = h.next(); !p.done; p = h.next())
                        g = p.value, Promise.resolve(g.next()).then(function(A) {
                  ...
                  case 1:
                    return l = F.sent(), l === void 0 ? [3, 3] : [4, i(l.value)];
                  case 2:
                    F.sent(), F.label = 3;
                  case 3:
                    return [
...
function Za(e) {
  var t = this, n = an(e, { yieldValues: !0 });
  return new Tt(function(i, r) {
    return it(t, void 0, void 0, function() {
      var a, s, o, l = this;
        ...
        switch (f.label) {
          case 0:
            ...
            s = [], o = !1, r.then(function() {
              ...
              a();
              try {
                for (var p = lt(s), g = p.next(); !g.done; g = p.next()) {
                  var I = g.value;
                  I();
                }
              } catch (_) {
              ...
              return it(c, void 0, void 0, function() {
                ...
                return $e(this, function(g) {
                  switch (g.label) {
                    ...
                    case 2:
                      return p = g.sent(), p === void 0 ? [2, l[h].value] : p.done ? [2, p.value] : (u[h] = p.value, [4, i(u.slice())]);
                    case 3:
                      return g.sent(), [3, 1];
                    case 4:
                      return [
...
var L, O;
function re(e) {
  return new kn(`Syntax Error: Unexpected token at ${O} in ${e}`);
}
function Ae(e) {
...
`), n = "", i = 0, r = 0, a = t.length - 1, s = 0; s < t.length; s++)
    Rt.lastIndex = 0, Rt.test(t[s]) && (s && (!i || Rt.lastIndex < i) && (i = Rt.lastIndex), r = r || s, a = s);
  for (var o = r; o <= a; o++)
    o !== r && (n += `
...
var ls = /(?:null|true|false)/y, hr = /\$[_A-Za-z]\w*/y, cs = /-?\d+/y, ds = /(?:\.\d+)?[eE][+-]?\d+|\.\d+/y, fs = /\\/g, ps = /"""(?:"""|(?:[\s\S]*?[^\\])""")/y, hs = /"(?:"|[^\r\n]*?[^\\]")/y;
function Wt(e) {
  var t, n;
  if (n = Ae(ls))
    t = n === "null" ? {
...
var Pe = (e) => !(!e || !e.length), me = {
  OperationDefinition(e) {
    if (e.operation === "query" && !e.name && !Pe(e.variableDefinitions) && !Pe(e.directives))
      return me.SelectionSet(e.selectionSet);
    var t = e.operation;
    return e.name && (t += " " + e.name.value), Pe(e.variableDefinitions) && (e.name || (t += " "), t += "(" + e.variableDefinitions.map(me.VariableDefinition).join(", ") + ")"), Pe(e.directives) && (t += " " + e.directives.map(me.Directive).join(" ")), t + " " + me.SelectionSet(e.selectionSet);
  },
  VariableDefinition(e) {
    var t = me.Variable(e.variable) + ": " + Ee(e.type);
    return e.defaultValue && (t += " = " + Ee(e.defaultValue)), Pe(e.directives) && (t += " " + e.directives.map(me.Directive).join(" ")), t;
  },
  Field(e) {
...
`).replace(/\n/g, `
  `) + `
    ...
    return Pe(e.directives) && (t += " " + e.directives.map(me.Directive).join(" ")), e.selectionSet ? t + " " + me.SelectionSet(e.selectionSet) : t;
  },
  ...
  ListValue: (e) => "[" + e.values.map(Ee).join(", ") + "]",
  ObjectValue: (e) => "{" + e.fields.map(me.ObjectField).join(", ") + "}",
  ObjectField: (e) => e.name.value + ": " + Ee(e.value),
  Document: (e) => Pe(e.definitions) ? e.definitions.map(Ee).join(`

`) : "",
  SelectionSet: (e) => `{
  ` + e.selections.map(Ee).join(`
`).replace(/\n/g, `
  `) + `
}`,
  Argument: (e) => e.name.value + ": " + Ee(e.value),
  FragmentSpread(e) {
    var t = "..." + e.name.value;
    return Pe(e.directives) && (t += " " + e.directives.map(me.Directive).join(" ")), t;
  },
  InlineFragment(e) {
    var t = "...";
    return e.typeCondition && (t += " on " + e.typeCondition.name.value), Pe(e.directives) && (t += " " + e.directives.map(me.Directive).join(" ")), t + " " + Ee(e.selectionSet);
  },
  FragmentDefinition(e) {
    var t = "fragment " + e.name.value;
    return t += " on " + e.typeCondition.name.value, Pe(e.directives) && (t += " " + e.directives.map(me.Directive).join(" ")), t + " " + Ee(e.selectionSet);
  },
  Directive(e) {
    var t = "@" + e.name.value;
    return Pe(e.arguments) && (t += "(" + e.arguments.map(me.Argument).join(", ") + ")"), t;
  },
  NamedType: (e) => e.name.value,
  ListType: (e) => "[" + Ee(e.type) + "]",
  NonNullType: (e) => Ee(e.type) + "!"
};
function Ee(e) {
...
function _s(e) {
  return e[Symbol.asyncIterator] ? Sr(e) : (t) => {
...
function Ii() {
  var e, t;
  return {
    source: Nt(Hn((n) => (e = n.next, t = n.complete, Wn))),
    next(n) {
      e && e(n);
    },
    complete() {
...
var Ds = (...e) => {
  for (var t = e[0], n = 1, i = e.length; n < i; n++)
    t = e[n](t);
  return t;
}, Cs = (e) => e && e.message && (e.extensions || e.name === "GraphQLError") ? e : typeof e == "object" && e.message ? new kn(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : new kn(e);
class xt extends Error {
  constructor(t) {
    var n = (t.graphQLErrors || []).map(Cs), i = ((r, a) => {
      var s = "";
      if (r)
...
var Tn = (e, t) => {
  ...
  return n;
}, ze = /* @__PURE__ */ new Set(), Oi = /* @__PURE__ */ new WeakMap(), Ke = (e) => {
  if (e === null || ze.has(e))
    return "null";
  if (typeof e != "object")
    return JSON.stringify(e) || "";
  ...
  for (var s of i) {
    var o = Ke(e[s]);
    o && (a.length > 1 && (a += ","), a += Ke(s) + ":" + o);
  }
  return ze.delete(e), a += "}";
}, _n = (e, t, n) => {
  if (!(n == null || typeof n != "object" || n.toJSON || ze.has(n)))
    if (Array.isArray(n))
...
var Yt = typeof File < "u" ? File : st, Kt = typeof Blob < "u" ? Blob : st, Vs = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g, Ms = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g, Rs = (e, t) => t % 2 == 0 ? e.replace(Ms, `
`) : e, Ai = (e) => e.split(Vs).map(Rs).join("").trim(), Ni = /* @__PURE__ */ new Map(), Lt = /* @__PURE__ */ new Map(), un = (e) => {
  var t;
  return typeof e == "string" ? t = Ai(e) : e.loc && Lt.get(e.__key) === e ? t = e.loc.source.body : (t = Ni.get(e) || Ai(Ee(e)), Ni.set(e, t)), typeof e != "string" && !e.loc && (e.loc = {
    start: 0,
    end: t.length,
    source: {
      body: t,
...
# ${n}`, t));
  ...
  var t, n;
  return typeof e == "string" ? (t = Pi(e), n = Lt.get(t) || Os(e)) : (t = e.__key || Pi(e), n = Lt.get(t) || e), n.loc || un(n), n.__key = t, Lt.set(t, n), n;
}, bn = (e, t, n) => {
  var i = t || {}, r = Xt(e), a = Ht(i), s = r.__key;
  return a !== "{}" && (s = Tn(a, s)), {
    key: s,
    query: r,
    variables: i,
  ...
  for (var t of e.definitions)
    if (t.kind === Me.OPERATION_DEFINITION)
  ...
  if (s)
    for (var l of s) {
      ...
      if (l.items)
        for (var h = +u >= 0 ? u : 0, p = 0, g = l.items.length; p < g; p++)
          c[h + p] = jn(c[h + p], l.items[p]);
      else
        l.data !== void 0 && (c[u] = jn(c[u], l.data));
    }
  else
...
var $s = (e, t) => {
  ...
  if (t && !(e.kind === "query" && e.context.preferGetMethod)) {
    var n = Ht(t), i = ((o) => {
      ...
      return (Yt !== st || Kt !== st) && (ze.clear(), _n(l, "variables", o)), l;
    })(t.variables);
    if (i.size) {
      var r = new FormData();
  ...
  try {
    ...
    if (/multipart\/mixed/i.test(s))
      o = async function* (c, f) {
        var d = c.match(Gs), h = "--" + (d ? d[1] : "-"), p = !0, g;
...
` + h)) {
          ...
          try {
            yield g = JSON.parse(I.slice(I.indexOf(`\r
\r
`) + 4));
          } catch (F) {
            if (!g)
...
`)) {
    ...
    for await (var l of o)
      r = r ? Fn(r, l, a) : xn(e, l, a), i = !1, yield r, i = !0;
    r || (yield r = xn(e, {}, a));
  } catch (u) {
    if (!i)
      throw u;
...
var Dn = (e, t) => {
  if (Array.isArray(e))
    ...
    for (var i in e)
      i === "__typename" && typeof e[i] == "string" ? t.add(e[i]) : Dn(e[i], t);
  return t;
}, Cn = (e) => {
  var t = !1;
  if ("definitions" in e) {
    ...
    var a = [], s = e.kind === Me.OPERATION_DEFINITION;
    if (e.selectionSet) {
      for (var o of e.selectionSet.selections || []) {
        s = s || o.kind === Me.FIELD && o.name.value === "__typename" && !o.alias;
        var l = Cn(o);
        t = t || l !== o, a.push(l);
      }
      if (s || (t = !0, a.push({
  ...
  return e;
}, _i = /* @__PURE__ */ new Map(), Js = (e) => {
  var t = Xt(e), n = _i.get(t.__key);
  return n || (_i.set(t.__key, n = Cn(t)), Object.defineProperty(n, "__key", {
    value: t.__key,
    enumerable: !1
  })), n;
}, Vn = (e, t) => {
...
function xi(e) {
  var t = (n) => e(n);
  return t.toPromise = () => Fs(vr(1)(ye((n) => !n.stale && !n.hasNext)(t))), t.then = (n, i) => t.toPromise().then(n, i), t.subscribe = (n) => Jt(n)(t), t;
}
function ot(e, t, n) {
  return {
    ...t,
...
function Ys(e) {
  for (var t = /* @__PURE__ */ new Map(), n = [], i = [], r = Array.isArray(e) ? e[0] : e || "", a = 1; a < arguments.length; a++) {
    var s = arguments[a];
    s && s.definitions ? i.push(s) : r += s, r += arguments[0][a];
  }
  i.unshift(Xt(r));
  for (var o of i)
    for (var l of o.definitions)
      if (l.kind === Me.FRAGMENT_DEFINITION) {
        var u = l.name.value, c = un(l);
        t.has(u) ? process.env.NODE_ENV !== "production" && t.get(u) !== c && console.warn("[WARNING: Duplicate Fragment] A fragment with name `" + u + "` already exists in this document.\nWhile fragment names may not be unique across your source, each name must be unique per document.") : (t.set(u, c), n.push(l));
      } else
        n.push(l);
  return Xt({
    kind: Me.DOCUMENT,
...
var gn = ({ kind: e }) => e !== "mutation" && e !== "query", Ks = ({ forward: e, client: t, dispatchDebug: n }) => {
  ...
  return (o) => {
    ...
    })(ye((c) => !gn(c) && s(c))(o)), u = on((c) => {
      var { operation: f } = c;
      if (f) {
        var d = f.context.additionalTypenames || [];
        if (c.operation.kind !== "subscription" && (d = ((b) => [...Dn(b, /* @__PURE__ */ new Set())])(c.data).concat(d)), c.operation.kind === "mutation" || c.operation.kind === "subscription") {
          ...
          for (var p = 0; p < d.length; p++) {
            var g = d[p], I = r.get(g);
            I || r.set(g, I = /* @__PURE__ */ new Set());
            for (var _ of I.values())
              h.add(_);
            I.clear();
          }
          for (var F of h.values())
            i.has(F) && (f = i.get(F).operation, i.delete(F), Fi(t, f));
    ...
    })(e(ye((c) => c.kind !== "query" || c.context.requestPolicy !== "cache-only")(nt((c) => process.env.NODE_ENV !== "production" ? ji(c, {
      cacheOutcome: "miss"
    }) : c)(at([nt(a)(ye((c) => !gn(c) && !s(c))(o)), ye((c) => gn(c))(o)])))));
    return at([l, u]);
  };
}, Fi = (e, t) => e.reexecuteOperation(ot(t.kind, t, {
  requestPolicy: "network-only"
})), vn = ({ forwardSubscription: e, enableAllOperations: t, isSubscriptionOperation: n }) => ({ client: i, forward: r }) => {
        ...
        return Hn(({ next: p, complete: g }) => {
          ...
          return Promise.resolve().then(() => {
            I || (_ = h.subscribe({
              ...
              complete() {
                I || (I = !0, d.kind === "subscription" && i.reexecuteOperation(ot("teardown", d, d.context)), F && F.hasNext && p(Fn(F, {
                  hasNext: !1
                })), g());
              }
            }));
...
}, Xs = ({ forward: e, dispatchDebug: t }) => (n) => {
  var i = At((a) => {
    ...
    var u = Jn(ye((c) => c.kind === "teardown" && c.key === a.key)(n))(Ws(a, o, l));
    return process.env.NODE_ENV !== "production" ? on((c) => {
  ...
  return at([i, r]);
}, Zs = (e) => ({ client: t, forward: n, dispatchDebug: i }) => e.reduceRight((r, a) => {
  var s = !1;
  return a({
    client: t,
    forward(o) {
  ...
  var s = t && t(a) || a;
  return "then" in s ? wi(s) : vt(s);
})(i(At((a) => {
  var s = e && e(a) || a;
  return "then" in s ? wi(s) : vt(s);
})(r))), eo = ({ dispatchDebug: e }) => (t) => (process.env.NODE_ENV !== "production" && (t = on((n) => {
  ...
  var d = (y) => {
    var w = Jn(ye((b) => b.kind === "teardown" && b.key === y.key)(l.source))(ye((b) => b.operation.kind === y.kind && b.operation.key === y.key && (!b.operation.context._instance || b.operation.context._instance === y.context._instance))(A));
    return y.kind !== "query" ? w = ks((b) => !!b.hasNext, !0)(w) : w = Si((b) => {
      var G = vt(b);
      return b.stale || b.hasNext ? G : at([G, nt(() => (b.stale = !0, b))(vr(1)(ye((Je) => Je.key === y.key)(l.source)))]);
    })(w), y.kind !== "mutation" ? w = gr(() => {
      a.delete(y.key), i.delete(y.key), r.delete(y.key), c = !1;
      for (var b = s.length - 1; b >= 0; b--)
        s[b].key === y.key && s.splice(b, 1);
      u(ot("teardown", y, y.context));
    })(on((b) => {
      if (b.stale) {
        for (var G of s)
          if (G.key === b.operation.key) {
            a.delete(G.key);
            break;
          }
      } else
        b.hasNext || a.delete(y.key);
      i.set(y.key, b);
    })(w)) : w = vi(() => {
      u(y);
    })(w), t.maskTypename && (w = nt((b) => ({
      ...b,
      data: Vn(b.data, !0)
    }))(w)), Nt(w);
    ...
    createRequestOperation(y, w, b) {
      ...
      return ot(y, w, {
        ...
        ...o,
        ...b,
        requestPolicy: b.requestPolicy || o.requestPolicy,
        suspense: b.suspense || b.suspense !== !1 && p.suspense
      });
    },
    executeRequestOperation(y) {
      return y.kind === "mutation" ? xi(d(y)) : xi(Ts(() => {
        var w = r.get(y.key);
        w || r.set(y.key, w = d(y)), w = vi(() => {
          f(y);
        })(w);
        var b = i.get(y.key);
        return y.kind === "query" && b && (b.stale || b.hasNext) ? Si(vt)(at([w, ye((G) => G === i.get(y.key))(vt(b))])) : w;
      }));
    },
    executeQuery(y, w) {
      var b = p.createRequestOperation("query", y, w);
      return p.executeRequestOperation(b);
    },
    executeSubscription(y, w) {
      var b = p.createRequestOperation("subscription", y, w);
      return p.executeRequestOperation(b);
    },
    executeMutation(y, w) {
      var b = p.createRequestOperation("mutation", y, w);
      return p.executeRequestOperation(b);
    },
    readQuery(y, w, b) {
      var G = null;
      return Jt((Je) => {
        G = Je;
      })(p.query(y, w, b)).unsubscribe(), G;
    },
    query: (y, w, b) => p.executeQuery(bn(y, w), b),
    subscription: (y, w, b) => p.executeSubscription(bn(y, w), b),
    mutation: (y, w, b) => p.executeMutation(bn(y, w), b)
  }), g = Hs;
  if (process.env.NODE_ENV !== "production") {
    var { next: I, source: _ } = Ii();
    p.subscribeToDebugTarget = (y) => Jt(y)(_), g = I;
  }
  var F = Zs(t.exchanges), A = Nt(F({
    client: p,
    dispatchDebug: g,
    forward: eo({
      dispatchDebug: g
...
function Nr(e) {
  ...
  switch (e.type) {
    ...
    case te.Ping:
    case te.Pong: {
      if (e.payload != null && !Le(e.payload))
    ...
    case te.Subscribe: {
      ...
      if (e.payload.variables != null && !Le(e.payload.variables))
      ...
      if (e.payload.extensions != null && !Le(e.payload.extensions))
...
function ro(e) {
  ...
  if (p) {
    ...
    typeof WebSocket < "u" ? F = WebSocket : typeof global < "u" ? F = global.WebSocket || // @ts-expect-error: Support more browsers
    global.MozWebSocket : typeof window < "u" && (F = window.WebSocket || // @ts-expect-error: Support more browsers
    window.MozWebSocket);
  if (!F)
  ...
  const A = F, y = (() => {
    const E = (() => {
      ...
      message: h != null && h.message ? [E.emit, h.message] : [E.emit],
  ...
  let b, G = 0, Je, pn = !1, Ft = 0, ni = !1;
  async function ii() {
    clearTimeout(Je);
    const [E, ae] = await (b ?? (b = new Promise((ee, Be) => (async () => {
      if (pn) {
        if (await c(Ft), !G)
          return b = void 0, Be({ code: 1e3, reason: "All Subscriptions Gone" });
        Ft++;
      }
      y.emit("connecting");
      const V = new A(typeof t == "function" ? await t() : t, no);
      let He, pt;
      function Dt() {
      ...
      w((pe) => {
        b = void 0, clearTimeout(He), clearTimeout(pt), Be(pe), Ut(pe) && pe.code === 4499 && (V.close(4499, "Terminated"), V.onerror = null, V.onclose = null);
        ...
        try {
          ...
          }, I)), isFinite(l) && l > 0 && (He = setTimeout(() => {
      ...
      V.onmessage = ({ data: pe }) => {
        try {
          ...
          if (y.emit("message", he), he.type === "ping" || he.type === "pong") {
            y.emit(he.type, !0, he.payload), he.type === "pong" ? Dt() : o || (V.send(ht(he.payload ? {
              type: te.Pong,
              payload: he.payload
            } : {
              type: te.Pong
          ...
          clearTimeout(He), Ye = !0, y.emit("connected", V, he.payload), pn = !1, Ft = 0, ee([
            V,
            new Promise((Gu, Rr) => w(Rr))
          ]);
        } catch (he) {
    ...
    E.readyState === A.CLOSING && await ae;
    let U = () => {
    };
    ...
    return [
      ...
      Promise.race([
        ...
        x.then(() => {
          if (!G) {
            const ee = () => E.close(1e3, "Normal Closure");
            isFinite(a) && a > 0 ? Je = setTimeout(() => {
              E.readyState === A.OPEN && ee();
            }, a) : ee();
          }
        }),
        // or
  ...
  return i || (async () => {
    ...
    subscribe(E, ae) {
      ...
      return (async () => {
        for (G++; ; )
          try {
            const [V, He, pt] = await ii();
            if (x)
              return He();
            const Dt = y.onMessage(U, (Ye) => {
              switch (Ye.type) {
                case te.Next: {
                  ae.next(Ye.payload);
                  return;
                ...
                case te.Error: {
                  ee = !0, x = !0, ae.error(Ye.payload), Be();
                  return;
                }
                case te.Complete: {
                  x = !0, Be();
...
function Ut(e) {
  return Le(e) && "code" in e && "reason" in e;
}
function ao(e) {
  return [
    1e3,
...
var Xe = null;
typeof WebSocket < "u" ? Xe = WebSocket : typeof MozWebSocket < "u" ? Xe = MozWebSocket : typeof global < "u" ? Xe = global.WebSocket || global.MozWebSocket : typeof window < "u" ? Xe = window.WebSocket || window.MozWebSocket : typeof self < "u" && (Xe = self.WebSocket || self.MozWebSocket);
const oo = Xe;
function we(e) {
  if (typeof e != "object")
    return e;
...
class uo {
  constructor(t) {
    Object.defineProperty(this, "__gadget", {
      ...
      writable: !0,
      value: !1
    }), this.__gadget.instantiatedFields = we(t), this.__gadget.persistedFields = we(t), Object.assign(this.__gadget.fields, t), !t || Object.keys(t).length === 0 ? this.empty = !0 : (this.__gadget.fieldKeys = Object.keys(this.__gadget.fields), this.__gadget.fieldKeys.forEach((i) => this.__gadget.fieldKeysTracker[i] = !0));
    const n = {
      get: (i, r) => {
        if (r in this)
          return this[r];
  ...
  hasChanges(t = ge.SinceLoaded) {
    if (this.__gadget.touched)
      return !0;
    const n = t == ge.SinceLoaded ? this.__gadget.instantiatedFields : this.__gadget.persistedFields;
  ...
  changes(t, n = ge.SinceLoaded) {
    const r = (typeof t == "string" ? n : t || n) == ge.SinceLoaded ? this.__gadget.instantiatedFields : this.__gadget.persistedFields;
  ...
  toChangedJSON(t = ge.SinceLoaded) {
    const n = t == ge.SinceLoaded ? this.__gadget.instantiatedFields : this.__gadget.persistedFields, i = {};
  ...
  flushChanges(t = ge.SinceLoaded) {
    t == ge.SinceLoaded ? this.__gadget.instantiatedFields = we(this.__gadget.fields) : t == ge.SinceLastPersisted && (this.__gadget.persistedFields = we(this.__gadget.fields)), this.__gadget.touched = !1;
  }
  ...
  revertChanges(t = ge.SinceLoaded) {
    let n;
    t == ge.SinceLoaded ? n = Object.keys(this.__gadget.instantiatedFields) : n = Object.keys(this.__gadget.persistedFields);
    for (const i of this.__gadget.fieldKeys)
      n.includes(i) || delete this.__gadget.fields[i];
    t == ge.SinceLoaded ? Object.assign(this.__gadget.fields, we(this.__gadget.instantiatedFields)) : Object.assign(this.__gadget.fields, we(this.__gadget.persistedFields)), this.__gadget.touched = !1;
  }
  /** Returns a JSON representation of all fields on this record. */
  toJSON() {
    return Un({ ...this.__gadget.fields });
  }
  touch() {
...
class Vi extends Error {
  constructor(t) {
    let n;
    Rn(t) ? n = `GraphQL websocket closed unexpectedly by the server with error code ${t.code} and reason "${t.reason}"` : n = "GraphQL websocket closed unexpectedly by the server", super(n), Object.defineProperty(this, "code", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: "GGT_UNKNOWN"
...
class po extends Error {
  constructor(t, n, i, r) {
    ...
    super(t ?? `GGT_INVALID_RECORD: ${i ?? "Record"} is invalid and can't be saved. ${a.map(({ apiIdentifier: o, message: l }) => `${o} ${l}`).join(", ")}${s}.`), Object.defineProperty(this, "code", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
...
}, Rn = (e) => (e == null ? void 0 : e.type) == "close", De = (e, t) => typeof e != "string" ? "" : cn(e, t), Ri = (e) => {
...
}, mo = (e) => `${cn(e)}Sort`, bo = (e) => `${cn(e)}Filter`, go = (e, t, n) => new Er(`More than one record found for ${e}.${t} = ${n}. Please confirm your unique validation is not reporting an error.`), Ve = (e, t, n = !1) => {
  var i;
  if (e.error)
...
`)), e.error;
  const r = Zt(e.data, t), a = Zt(r, ["edges"]), s = a ?? r;
  if (r === void 0)
    throw new lo(`Internal Error: Gadget API didn't return expected data. Nothing found in response at ${t.join(".")}`);
  if (r === null || n && Array.isArray(s) && s.length === 0)
    throw new ho(`Record Not Found Error: Gadget API returned no data at ${t.join(".")}`);
  return r;
}, St = (e, t) => {
  var n;
  if (e.error)
...
`)), e.error;
  ...
  var t;
  return e.code == "GGT_INVALID_RECORD" ? new po(e.message, e.validationErrors, (t = e.model) === null || t === void 0 ? void 0 : t.apiIdentifier, e.record) : e.code == "GGT_UNKNOWN" && e.message.includes("duplicate key value violates unique constraint") ? new Er(e.message) : new ln(e.message, e.code);
}, Qe = (e, t) => {
  const n = Ve(e, t);
  if (!n.success) {
    const i = n.errors && n.errors[0];
    throw i ? kr(i) : new ln("Gadget API operation not successful.", "GGT_UNKNOWN");
  }
  return n;
}, Tr = (e) => {
  var t, n, i, r;
  ...
  const n = Tr(e);
  return n && (t = n.apply(t)), new Pr(t);
}, Yn = (e, t) => {
  const n = Tr(e);
  return n && (t = n.apply(t)), t == null ? void 0 : t.map((i) => new Pr(i));
}, en = (e, t) => {
  const n = t.edges.map((i) => i.node);
  return Yn(e, n);
}, vo = (e, t) => {
  var n, i;
  const r = (i = (n = e.data) === null || n === void 0 ? void 0 : n.gadgetMeta) === null || i === void 0 ? void 0 : i.allHydrations;
  if (!r)
    return t;
...
}, $i = Object.prototype.toString, qi = Object.getPrototypeOf, Bi = Object.getOwnPropertySymbols ? (e) => Object.keys(e).concat(Object.getOwnPropertySymbols(e)) : Object.keys, mt = (e, t, n) => {
  if (e === t)
    return !0;
  if (e == null || t == null)
    return !1;
  if (n.indexOf(e) > -1 && n.indexOf(t) > -1)
    return !0;
  const i = $i.call(e), r = $i.call(t);
  let a, s, o;
  if (n.push(e, t), i != r || (a = Bi(e), s = Bi(t), a.length != s.length || a.some(function(l) {
    return !mt(e[l], t[l], n);
  })))
    return !1;
  switch (i.slice(8, -1)) {
...
const wo = (e) => {
  ...
  onOperation: (e) => {
    var t, n;
    (t = (n = e.context).operationName) !== null && t !== void 0 || (n.operationName = wo(e.query) || "unknown");
  }
}), Oo = Ar({
  onOperation: (e) => {
...
const Ao = 2, No = 4800, Po = 1e4, Eo = [ve.ConnectionAcknowledgementTimeout, ve.ConnectionInitialisationTimeout], Gi = Symbol.for("gadget/connection"), ko = "token", To = typeof btoa < "u" ? btoa : (e) => Buffer.from(e).toString("base64");
var se;
(function(e) {
...
class xr {
  constructor(t) {
    ...
    if (Object.defineProperty(this, "options", {
      ...
      value: async (o, l) => {
        ...
        try {
          ...
          h[Gi] = this, d = new So(h, f), this.currentTransaction = d, await d.start();
          const p = await u(d);
      ...
      value: async (o, l = {}) => {
        var u;
        o = _o(o, (u = this.options.baseRouteURL) !== null && u !== void 0 ? u : this.options.endpoint), this.isGadgetRequest(o) && (l.headers = { ...this.requestHeaders(), ...l.headers }, this.authenticationMode == se.Custom && await this.options.authenticationMode.custom.processFetch(o, l));
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof window < "u" && window.fetch ? this._fetchImplementation = window.fetch.bind(window) : this._fetchImplementation = async (...o) => {
      ...
      return await l(...o);
    }, this.websocketImplementation = (i = (n = t.websocketImplementation) !== null && n !== void 0 ? n : globalThis == null ? void 0 : globalThis.WebSocket) !== null && i !== void 0 ? i : oo, this.websocketsEndpoint = (r = t.websocketsEndpoint) !== null && r !== void 0 ? r : t.endpoint + "/batch", this.websocketsEndpoint = this.websocketsEndpoint.replace(/^http/, "ws"), this.environment = (a = t.environment) !== null && a !== void 0 ? a : "Development", this.requestPolicy = (s = t.requestPolicy) !== null && s !== void 0 ? s : "cache-and-network", this.exchanges = {
      beforeAll: [],
      beforeAsync: [],
      afterAll: [],
      ...t.exchanges
  ...
  async getCurrentModels() {
    ...
    try {
      const t = await this.currentClient.query(Ys`{
        gadgetMeta {
          allHydrations
        }
      }`, {});
      return this.allModels = vo(t, this.allModels), this.allModels;
    } catch (t) {
      return console.error(t), this.allModels;
    }
  }
  ...
  enableSessionMode(t) {
    ...
    const n = !t || typeof t == "boolean" ? bt.Durable : t.storageType;
    let i;
    n == bt.Durable && Ui("localStorage") ? i = window.localStorage : n == bt.Session && Ui("sessionStorage") ? i = window.sessionStorage : i = new Io(), t !== null && typeof t == "object" && "initialToken" in t && t.initialToken && i.setItem(this.sessionStorageKey, t.initialToken), this.sessionTokenStore = i, this.resetClients();
  }
  close() {
  ...
  isGadgetRequest(t) {
    let n;
    if (typeof t == "string" ? n = t : typeof t == "object" && "url" in t ? n = t.url : n = String(t), qn(this.options.endpoint))
      return !!qn(n);
  ...
  newBaseClient() {
    const t = [...this.exchanges.beforeAll, Li, Oo];
    typeof window < "u" && t.push(Ks), t.push(
      ...this.exchanges.beforeAsync,
  ...
  requestHeaders() {
    ...
    if (this.authenticationMode == se.InternalAuthToken)
      n.authorization = "Basic " + To("gadget-internal:" + this.options.authenticationMode.internalAuthToken);
  ...
  async waitForOpenedConnection(t) {
    ...
    const a = t.connectionGlobalTimeoutMs || Po, s = () => {
      i.forEach((o) => o()), i = [];
    };
    return await new Promise((o, l) => {
      const u = setTimeout(() => {
        this.disposeClient(n), f(new co("Timeout opening websocket connection to Gadget API"));
      }, a), c = (p) => {
        if (Rn(p)) {
          if (p.code == $n.TooManyRequests)
            return s(), f(new fo(p.reason));
          if (Eo.includes(p.code) && r > 0) {
            r -= 1, this.disposeClient(n), n = this.newSubscriptionClient(t), h();
            return;
          }
        }
        clearTimeout(u), l(new Vi(p));
      }, f = (p) => {
        clearTimeout(u), l(p);
      }, d = () => {
        clearTimeout(u), o(n);
...
Object.defineProperty(xr, "version", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: "0.15.12"
...
class Pt extends Array {
  ...
  async nextPage() {
    var t;
    if (!this.hasNextPage)
      throw new Mn("Cannot request next page because there isn't one, should check 'hasNextPage' to see if it exists");
  ...
  async previousPage() {
    ...
    if (!this.hasPreviousPage)
      throw new Mn("Cannot request previous page because there isn't one, should check 'hasPreviousPage' to see if it exists");
...
const Bn = (e) => Object.entries(e).flatMap(([t, n]) => {
  if (typeof n == "boolean")
    return n ? t : !1;
  if (n instanceof Xn) {
    let i = "";
    const r = Object.entries(n.args).filter(([a, s]) => s != null).map(([a, s]) => {
      var o;
      return `${a}: ${s instanceof Zn ? `$${(o = s.name) !== null && o !== void 0 ? o : a}` : JSON.stringify(s)}`;
    });
    return r.length > 0 && (i = `(${r.join(", ")})`), n.subselection ? [`${t}${i} {`, ...Bn(n.subselection), "}"] : `${t}${i}`;
  } else
    return [`${t} {`, ...Bn(n), "}"];
}).filter((t) => !!t).map((t) => "  " + t), Kn = (e) => {
  const t = {}, n = (i) => {
    let r = 1;
    if (t[i]) {
      for (; t[`${i}${r}`]; )
  ...
  return Object.entries(e).forEach(([i, r]) => {
    r instanceof Xn ? Object.entries(r.args).forEach(([a, s]) => {
      var o;
      s instanceof Zn && (t[(o = s.name) !== null && o !== void 0 ? o : n(a)] = s);
    }) : typeof r == "object" && r !== null && Object.assign(t, Kn(r));
  }), t;
}, xo = (e) => {
  const t = Kn(e.fields);
...
const ct = (e, t) => new Xn(e, t), fe = (e) => new Zn(e.type + (e.required ? "!" : ""), e.name, e.value), jo = (e) => {
  var t;
  const n = xo(e), i = e.directives && e.directives.length > 0 ? ` ${e.directives.join(" ")}` : "";
...
`, Fo = (e) => `
    query InternalFind${De(e)}($id: GadgetID!, $select: [String!]) {
      ${ft(e)}
      internal {
  ...
  select: t != null && t.select ? fe({ value: Fr(t == null ? void 0 : t.select), type: "[String!]" }) : void 0
}), Do = (e, t) => {
  const n = De(e), i = jr(n, t);
  return dt({
    type: "query",
...
class Te {
  constructor(t, n, i) {
    Object.defineProperty(this, "apiIdentifier", {
      ...
      writable: !0,
      value: void 0
    }), this.capitalizedApiIdentifier = cn(t);
  }
  validateRecord(t) {
  ...
  async findOne(t, n, i = !0) {
    const r = await this.connection.currentClient.query(Fo(this.apiIdentifier), { id: t, select: Fr(n == null ? void 0 : n.select) }).toPromise(), s = (i ? Ve : St)(r, ["internal", this.apiIdentifier]);
    return It(r, s);
  }
  /**
   ...
   */
  async findMany(t) {
    const n = Co(this.apiIdentifier, t), i = await this.connection.currentClient.query(n.query, n.variables).toPromise(), r = St(i, ["internal", `list${this.capitalizedApiIdentifier}`]), a = en(i, r);
    return Pt.boot(this, a, { options: t, pageInfo: r.pageInfo });
  }
  /**
  ...
  async findFirst(t, n = !0) {
    const i = Do(this.apiIdentifier, t), r = await this.connection.currentClient.query(i.query, i.variables).toPromise();
    let a;
    n === !1 ? a = St(r, ["internal", `list${this.capitalizedApiIdentifier}`]) : a = Ve(r, ["internal", `list${this.capitalizedApiIdentifier}`], n);
    const s = en(r, a);
    return Pt.boot(this, s, { options: t, pageInfo: a.pageInfo })[0];
  }
  /**
   ...
   */
  async create(t) {
    const n = await this.connection.currentClient.mutation(Vo(this.apiIdentifier), {
      record: this.getRecordFromData(t, "create")
    }).toPromise(), i = Qe(n, ["internal", `create${this.capitalizedApiIdentifier}`]);
  ...
  async bulkCreate(t) {
    ...
    if (!(!((n = this.options) === null || n === void 0) && n.pluralApiIdentifier))
      throw new Mn("Cannot perform bulkCreate without a pluralApiIdentifier");
    const i = De(this.options.pluralApiIdentifier), r = await this.connection.currentClient.mutation(Mo(this.apiIdentifier, this.options.pluralApiIdentifier), {
      records: t
    }).toPromise(), a = Qe(r, ["internal", `bulkCreate${i}`]);
    return Yn(r, a[this.options.pluralApiIdentifier]);
  }
  /**
   ...
   */
  async update(t, n) {
    Mi(t, "Can't update a record without an ID passed");
    const i = await this.connection.currentClient.mutation(Ro(this.apiIdentifier), {
      id: t,
      record: this.getRecordFromData(n, "update")
    }).toPromise(), r = Qe(i, ["internal", `update${this.capitalizedApiIdentifier}`]);
   ...
   */
  async delete(t) {
    Mi(t, "Can't delete a record without an ID");
    const n = await this.connection.currentClient.mutation(Uo(this.apiIdentifier), { id: t }).toPromise();
    Qe(n, ["internal", `delete${this.capitalizedApiIdentifier}`]);
  }
  /**
   ...
   */
  async deleteMany(t) {
    const n = await this.connection.currentClient.mutation($o(this.apiIdentifier), t).toPromise();
    Qe(n, ["internal", `deleteMany${this.capitalizedApiIdentifier}`]);
  }
}
function Fr(e) {
  if (!e)
...
const ei = (e) => ({
  ...
  return typeof t < "u" && (a.id = fe({ type: "GadgetID!", value: t })), dt({
    ...
    name: e,
    fields: {
      [e]: ct(a, ti((r == null ? void 0 : r.select) || n, !0)),
      ...ei(i)
    },
    directives: dn(r)
  });
}, Bo = (e, t, n, i, r, a) => Dr(e, i, r, {
  ...a,
  first: 2,
  filter: {
    [t]: {
  ...
  fields: {
    [e]: ct({
      ...
      sort: i != null && i.sort ? fe({ value: i.sort, type: `[${mo(n)}!]` }) : void 0,
      filter: i != null && i.filter ? fe({ value: i.filter, type: `[${bo(n)}!]` }) : void 0,
      search: i != null && i.search ? fe({ value: i.search, type: "String" }) : void 0
    }, {
      pageInfo: { hasNextPage: !0, hasPreviousPage: !0, startCursor: !0, endCursor: !0 },
      edges: {
        cursor: !0,
        node: ti((i == null ? void 0 : i.select) || t, !0)
      }
    }),
    ...ei(n)
  },
...
}, Vr = (e) => Object.fromEntries(Object.entries(e).map(([t, n]) => [t, fe(n)])), Lo = (e, t, n, i, r, a, s, o, l) => {
  ...
  const o = qo(t, n, i, r, a), l = await e.connection.currentClient.query(o.query, o.variables).toPromise(), c = (s ? Ve : St)(l, [t]);
  return It(l, c);
}, fn = async (e, t, n, i, r, a, s) => {
  const o = Bo(t, n, i, r, a, s), l = await e.connection.currentClient.query(o.query, o.variables).toPromise(), u = Ve(l, [t]), c = en(l, u);
  if (c.length > 1)
    throw go(a, n, i);
  return c[0];
}, T = async (e, t, n, i, r, a) => {
  const s = Dr(t, n, i, r), o = await e.connection.currentClient.query(s.query, s.variables).toPromise();
  let l;
  a === !1 ? l = St(o, [t]) : l = Ve(o, [t], a);
  const u = en(o, l);
  return Pt.boot(e, u, { options: r, pageInfo: l.pageInfo });
}, m = async (e, t, n, i, r, a, s, o, l, u) => {
  const c = Lo(t, n, i, r, s, o, l, a, u), f = await e.connection.currentClient.mutation(c.query, c.variables).toPromise(), d = l ? [l, t] : [t];
  if (a) {
    const h = Zt(f.data, d), p = h[r] && n ? Yn(f, h[r]) : void 0;
    if (h.errors) {
      const g = h.errors.map((I) => kr(I));
      throw new yo(g, p);
    }
    return p;
  } else {
  ...
  const r = Go(t, n, i), a = await e.currentClient.mutation(r.query, r.variables).toPromise();
...
var Mr;
const In = "production", qt = "development", $u = Symbol.for("gadget/modelRelationships"), qu = () => {
  try {
...
class Bu {
  constructor(t) {
    ...
    const n = (t == null ? void 0 : t.environment) ?? qu() ?? qt;
    let i = n.toLocaleLowerCase();
    i != qt && i != In && (console.warn("Invalid environment", n, "defaulting to development"), i = qt);
    ...
    if (this.connection = new xr({
      endpoint: new URL("api/graphql", i == In ? this.productionApiRoot : this.developmentApiRoot).toString(),
      applicationId: this.applicationId,
      authenticationMode: (t == null ? void 0 : t.authenticationMode) ?? (typeof window > "u" ? { anonymous: !0 } : { browserSession: !0 }),
      ...t,
      exchanges: r,
      environment: i == In ? "Production" : "Development"
    ...
    this.user = new Ho(this.connection), this.session = new Xo(this.connection), this.productPairing = new nu(this.connection), this.unambiguous = new su(this.connection), this.shopifyProduct = new cu(this.connection), this.shopifyProductImage = new hu(this.connection), this.shopifyProductOption = new gu(this.connection), this.shopifyProductVariant = new wu(this.connection), this.shopifyShop = new ku(this.connection), this.shopifySync = new ju(this.connection), this.ambiguous = new Vu(this.connection), this.currentSession = new Uu(this.connection), this.internal = {
...
Mr = $u;
const Lu = new Bu(), Qu = async () => {
  await Lu.shopifyProduct.findMany();
};
export {
  Qu as read
};
