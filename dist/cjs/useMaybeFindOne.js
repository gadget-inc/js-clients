...
const useMaybeFindOne = (manager, id, options) => {
    ...
    const plan = (0, react_1.useMemo)(() => {
        return (0, api_client_core_1.findOneOperation)(manager.findOne.operationName, id, manager.findOne.defaultSelection, manager.findOne.modelApiIdentifier, memoizedOptions, manager.findOne.namespace);
    ...
    const result = (0, react_1.useMemo)(() => {
        ...
        if (data) {
            const dataPath = (0, api_client_core_1.namespaceDataPath)([manager.findOne.operationName], manager.findOne.namespace);
            const value = (0, api_client_core_1.get)(rawResult.data, dataPath);
            data = value && "id" in value ? (0, api_client_core_1.hydrateRecord)(rawResult, value, manager) : null;
        }
