import { FieldSelection } from "tiny-graphql-query-compiler";
...
export interface ComputedViewFunction<VariablesT extends VariablesOptions, SelectionsT extends FieldSelection, ResultT> {
    ...
    variablesType: VariablesOptions;
    selections: SelectionsT;
}
