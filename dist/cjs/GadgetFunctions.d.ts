...
export type ComputedViewFunctionWithoutVariables<Result> = <Available extends AvailableSelection2<Result> & FieldSelection, Options extends {
    select?: Available | null;
}, Defaults extends AllFieldsSelected<Available>>(options?: Options) => Promise<Select2<Result, DefaultSelection2<Available, Options, Defaults>>>;
...
export type ComputedViewFunctionWithVariables<Variables, Result> = <Available extends AvailableSelection2<Result> & FieldSelection, Options extends {
    select?: Available | null;
}, Defaults extends AllFieldsSelected<Available>>(variables: Variables, options?: Options) => Promise<Select2<Result, DefaultSelection2<Available, Options, Defaults>>>;
