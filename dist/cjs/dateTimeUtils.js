...
exports.getTimeString = exports.formatDate = exports.getDateFromDateTimeObject = exports.getDateTimeObjectFromDate = exports.copyTime = exports.timeFormatRegex = exports.tzParseTimezone = exports.utcToZonedTime = exports.zonedTimeToUtc = exports.isValidDate = exports.formatLongDateTimeString = exports.formatShortDateString = void 0;
/**
 ...
 */
const formatShortDateString = (date) => {
    if (!date)
        return "";
...
exports.formatShortDateString = formatShortDateString;
/**
 ...
 * @returns Formatted date string, if date is undefined, formatShortDateString returns an empty string
 */
const formatLongDateTimeString = (date, includeTime) => {
    if (!date)
        return "";
...
exports.formatLongDateTimeString = formatLongDateTimeString;
/**
 *
 * @param date
 * @returns
 ...
 */
const zonedTimeToUtc = (date, timeZone) => {
    ...
    const offsetMilliseconds = (0, exports.tzParseTimezone)(timeZone, new Date(utc));
...
const utcToZonedTime = (date, timeZone) => {
    const offsetMilliseconds = (0, exports.tzParseTimezone)(timeZone, date, true);
...
const tzParseTimezone = (timezoneString, date, isUtcDate) => {
    // Empty string
    if (!timezoneString) {
        return 0;
    }
 ...
 */
exports.timeFormatRegex = new RegExp(/((1[0-2]|0?[1-9]):([0-5][0-9]) ?([AaPp][Mm]))/);
/**
 ...
 * @returns
 */
const getDateTimeObjectFromDate = (dateTime, use24Hour = false) => {
    return {
...
const formatDate = (date, includeTime, use24Hour = false) => {
 ...
 * @returns
 */
const getTimeString = (dateTime, use24Hour = false) => {
    if (use24Hour) {
