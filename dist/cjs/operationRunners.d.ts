...
export declare const computedViewRunner: (connection: GadgetConnection, operation: string, variables: VariablesOptions, defaultSelection: FieldSelection, namespace?: string | string[] | null) => Promise<{
    plan: {
        query: string;
        variables: Record<string, any>;
    };
    response: OperationResult<any, Record<string, any>>;
}>;
