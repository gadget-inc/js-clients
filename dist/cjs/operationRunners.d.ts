...
export declare const findOneByFieldRunner: <Shape extends RecordShape = any, Options extends FindManyOptions = {}>(modelManager: {
    connection: GadgetConnection;
}, operation: string, fieldName: string, fieldValue: string, defaultSelection: FieldSelection, modelApiIdentifier: string, options?: Options | null) => LiveResultForOptions<import("./GadgetRecord.js").GadgetRecordImplementation<Shape> & Shape, Options>;
