...
export declare const computedViewRunner: <VariablesT extends VariablesOptions, SelectionsT extends FieldSelection>(connection: GadgetConnection, operation: string, variables: VariablesT, selections: SelectionsT, namespace?: string | string[] | null) => Promise<any>;
