...
export declare const enqueueActionRunner: <Action extends AnyActionFunction>(connection: GadgetConnection, action: Action, variables: Action["variablesType"], options?: EnqueueBackgroundActionOptions<Action_1>) => Promise<BackgroundActionHandle<Action>>;
export declare const actionResultRunner: <Action extends AnyActionFunction, Options extends ActionFunctionOptions<Action>, Shape extends RecordShape = any>(connection: GadgetConnection, id: string, action: Action, options?: Options | undefined) => Promise<BackgroundActionResult>;
