...
export declare const computedViewRunner: (connection: GadgetConnection, operation: string, variables: VariablesOptions, defaultSelection: FieldSelection, selection?: FieldSelection, namespace?: string | string[] | null) => Promise<any>;
