...
export interface ActionRunner {
    <Shape extends RecordShape = any>(modelManager: {
        connection: GadgetConnection;
    }, operation: string, defaultSelection: FieldSelection | null, modelApiIdentifier: string, modelSelectionField: string, isBulkAction: false, variables: VariablesOptions, options?: BaseFindOptions | null, namespace?: string | string[] | null, hasReturnType?: HasReturnType): Promise<Shape>;
    <Shape extends RecordShape = any>(modelManager: {
        connection: GadgetConnection;
    ...
    <Shape extends RecordShape = any>(modelManager: {
        connection: GadgetConnection;
    }, operation: string, defaultSelection: FieldSelection | null, modelApiIdentifier: string, modelSelectionField: string, isBulkAction: true, variables: VariablesOptions, options?: BaseFindOptions | null, namespace?: string | string[] | null, hasReturnType?: HasReturnType): Promise<Shape[]>;
    <Shape extends RecordShape = any>(modelManager: {
        connection: GadgetConnection;
