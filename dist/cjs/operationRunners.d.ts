...
}, operation: string, id: string | undefined, defaultSelection: FieldSelection, modelApiIdentifier: string, options?: Options | null | undefined, throwOnEmptyData?: boolean) => Promise<LiveResultForOptions<GadgetRecord<Shape>, Options>>;
...
export declare const findManyRunner: <Shape extends RecordShape = any, Options extends FindManyOptions = {
    live: false;
}>(modelManager: AnyModelManager, operation: string, defaultSelection: FieldSelection, modelApiIdentifier: string, options?: Options | undefined, throwOnEmptyData?: boolean) => Promise<LiveResultForOptions<GadgetRecordList<Shape>, Options>>;
