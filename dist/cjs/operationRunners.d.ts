...
export declare const enqueueActionRunner: <Action extends AnyActionFunction>(connection: GadgetConnection, action: Action, variables: Action["variablesType"], options?: EnqueueBackgroundActionOptions<Action>) => Promise<BackgroundActionHandle<Action>>;
