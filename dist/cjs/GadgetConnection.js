...
class GadgetConnection {
    constructor(options) {
        ...
        Object.defineProperty(this, "rateLimitExchange", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.rateLimitExchange = (0, rateLimitExchange_js_1.rateLimitExchange)({
            enabled: false,
    ...
    newBaseClient() {
        ...
        exchanges.push(this.rateLimitExchange, core_1.fetchExchange, (0, core_1.subscriptionExchange)({
            forwardSubscription: (request) => {
                return {
                    subscribe: (sink) => {
                        const input = { ...request, query: request.query || "" };
