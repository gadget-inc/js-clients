...
class GadgetConnection {
    constructor(options) {
        ...
        this.authenticationModeOptions = (0, support_js_1.maybeGetAuthenticationModeOptionsFromConnectionOptions)(options);
...
Object.defineProperty(GadgetConnection, "availableAuthenticationModes", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: support_js_1.availableAuthenticationModes
});
