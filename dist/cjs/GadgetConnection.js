            ...
            forwardSubscription: (request) => {
                return {
                    subscribe: (sink) => {
                        const input = { ...request, query: request.query || "" };
                        return {
                            unsubscribe: (0, push_pull_async_iterable_iterator_1.applyAsyncIterableIteratorToSink)((0, index_js_1.applyLiveQueryJSONDiffPatch)((0, push_pull_async_iterable_iterator_1.makeAsyncIterableIteratorFromSink)((sink) => this.getBaseSubscriptionClient().subscribe(input, sink))), sink),
                        };
                    },
                };
            },
