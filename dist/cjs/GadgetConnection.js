...
(function (AuthenticationMode) {
    ...
    AuthenticationMode["PublicShopTenant"] = "public-shop-tenant";
...
class GadgetConnection {
    ...
    async requestHeaders() {
        ...
        if (this.authenticationMode == AuthenticationMode.Internal || this.authenticationMode == AuthenticationMode.InternalAuthToken) {
            ...
            const shopId = (_e = (_d = this.options.authenticationMode) === null || _d === void 0 ? void 0 : _d.publicShopTenant) === null || _e === void 0 ? void 0 : _e.shopId;
            if (shopId) {
