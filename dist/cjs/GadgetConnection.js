...
const liveQueryExchange = ({ forward }) => {
    ...
    return operations$ => {
        ...
        const live = (0, wonka_1.pipe)(operations$, (0, wonka_1.filter)(op => op.query.definitions.some(isLiveQueryOperationDefinitionNode)), (0, wonka_1.filter)(op => !executed.has(op.key)), (0, wonka_1.tap)((op) => {
            executed.add(op.key);
        }));
