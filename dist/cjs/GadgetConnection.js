...
class GadgetConnection {
    ...
    async waitForOpenedConnection(options) {
        ...
        return await new Promise((resolve, reject) => {
            console.log("we're in a promise");
            const timeout = setTimeout(() => {
                console.log("we are going to timeout");
            ...
            const retryOnClose = (event) => {
                ...
                if ((0, support_js_1.isCloseEvent)(event)) {
                    if (event.code == 4429) {
                        wrappedReject(new support_js_1.GadgetTooManyRequestsError("Too many concurrent requests sent to the Gadget API"));
                    }
