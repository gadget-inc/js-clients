...
class GadgetConnection {
    constructor(options) {
        ...
        Object.defineProperty(this, "ssrExchange", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    newBaseClient() {
        this.ssrExchange = (0, core_1.ssrExchange)({
            isClient: typeof window !== "undefined",
            initialState: typeof window !== "undefined" ? window.__URQL_DATA__ : undefined,
        });
        console.log("where - gadget connection, ssrExchange", this.ssrExchange);
        const exchanges = [...this.exchanges.beforeAll, operationNameExchange_js_1.operationNameExchange, urlParamExchange_js_1.urlParamExchange, this.ssrExchange];
