...
class GadgetConnection {
    constructor(options) {
        ...
        // the token bucket used to rate limit graphql operations via http and websockets
    ...
    newBaseClient() {
        const exchanges = [urlParamExchange_js_1.urlParamExchange];
