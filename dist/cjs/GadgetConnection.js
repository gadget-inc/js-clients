...
const cacheControlExchange = ({ forward }) => {
    ...
    return operations$ => {
        const cacheable = (0, wonka_1.pipe)(operations$, (0, wonka_1.filter)(op => !op.query.definitions.some(isLiveQueryOperationDefinitionNode)));
        const uncacheable = (0, wonka_1.pipe)(operations$, (0, wonka_1.filter)(op => op.query.definitions.some(isLiveQueryOperationDefinitionNode)), (0, wonka_1.map)((op) => {
        ...
        return forward((0, wonka_1.merge)([cacheable, uncacheable]));
    };
};
/**
