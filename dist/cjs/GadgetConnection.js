...
const otelExchange_js_1 = require("./otelExchange.js");
const rateLimitExchange_js_1 = require("./rateLimitExchange.js");
const support_js_1 = require("./support.js");
const urlParamExchange_js_1 = require("./urlParamExchange.js");
...
class GadgetConnection {
    constructor(options) {
        ...
        // the token bucket used to rate limit graphql operations
        Object.defineProperty(this, "operationBucket", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "transaction", {
            ...
            configurable: true,
            writable: true,
            value: (0, support_js_1.traceFunction)("api-client.transaction", async (optionsOrRun, maybeRun) => {
                var _a;
                let run;
                let options;
                if (maybeRun) {
                ...
                (_a = (0, support_js_1.getCurrentSpan)()) === null || _a === void 0 ? void 0 : _a.setAttributes({ applicationId: this.options.applicationId, environmentName: this.environment });
                ...
                try {
                    ...
                    const client = new core_1.Client({
                        ...
                        exchanges: [
                            otelExchange_js_1.otelExchange,
                            (0, rateLimitExchange_js_1.rateLimitExchange)(this.operationBucket),
                            (0, core_1.subscriptionExchange)({
                                forwardSubscription(request) {
                                    const input = { ...request, query: request.query || "" };
                                    return {
                                        subscribe: (sink) => {
                                            return (0, support_js_1.withSpan)("api-client.ws", (span) => {
                                                const sinkWrapper = {
                                                    next: (value) => {
                                                        sink.next(value);
                                                    },
                                                    error: (error) => {
                                                        (0, support_js_1.onSpanError)(span, error);
                                                        sink.error(error);
                                                    },
                                                    complete: () => {
                                                        span.end();
                                                ...
                                                const dispose = subscriptionClient.subscribe(input, sinkWrapper);
                                                return {
                                                    unsubscribe: dispose,
                                                };
                                            });
        ...
        Object.defineProperty(this, "fetch", {
            ...
            configurable: true,
            writable: true,
            value: (0, support_js_1.traceFunction)("api-client.fetch", async (input, init = {}) => {
                var _a;
        ...
        this.operationBucket = new support_js_1.TokenBucket({
            name: "operation-bucket",
            ...options.operationBucketOptions,
        });
    ...
    newBaseClient() {
        const exchanges = [otelExchange_js_1.otelExchange, urlParamExchange_js_1.urlParamExchange];
        // apply urql's default caching behaviour when client side (but skip it server side)
        if (typeof window != "undefined") {
            exchanges.push(core_1.cacheExchange);
        }
        exchanges.push((0, rateLimitExchange_js_1.rateLimitExchange)(this.operationBucket), core_1.fetchExchange, (0, core_1.subscriptionExchange)({
            forwardSubscription: (request) => {
                return {
                    subscribe: (sink) => {
                        const input = { ...request, query: request.query || "" };
