...
class GadgetConnection {
    constructor(options) {
        ...
        Object.defineProperty(this, "requestBucket", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
            ...
            value: (0, support_js_1.traceFunction)("api-client.transaction", async (optionsOrRun, maybeRun) => {
                ...
                try {
                    ...
                    const client = new core_1.Client({
                        ...
                        exchanges: [
                            (0, rateLimitExchange_js_1.rateLimitExchange)(this.requestBucket),
        ...
        Object.defineProperty(this, "fetch", {
            ...
            value: (0, support_js_1.traceFunction)("api-client.fetch", async (input, init = {}) => {
                ...
                if (this.isGadgetRequest(input)) {
                    await this.requestBucket.consume();
        ...
        this.requestBucket = new support_js_1.TokenBucket({
            name: "request-bucket",
    ...
    newBaseClient() {
        ...
        exchanges.push((0, rateLimitExchange_js_1.rateLimitExchange)(this.requestBucket), core_1.fetchExchange, (0, core_1.subscriptionExchange)({
            forwardSubscription: (request) => {
                return {
                    subscribe: (sink) => {
                        const input = { ...request, query: request.query || "" };
