...
class GadgetConnection {
            ...
            value: (0, support_js_1.traceFunction)("api-client.transaction", async (optionsOrRun, maybeRun) => {
                ...
                try {
                    ...
                    const client = new core_1.Client({
                        ...
                        exchanges: [
                            (0, rateLimitExchange_js_1.rateLimitExchange)(this.options.rateLimitOptions),
    ...
    newBaseClient() {
        ...
        exchanges.push((0, rateLimitExchange_js_1.rateLimitExchange)(this.options.rateLimitOptions), core_1.fetchExchange, (0, core_1.subscriptionExchange)({
            forwardSubscription: (request) => {
                return {
                    subscribe: (sink) => {
                        const input = { ...request, query: request.query || "" };
