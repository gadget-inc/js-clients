...
class GadgetConnection {
    ...
    newBaseClient() {
        const exchanges = [...this.exchanges.beforeAll, operationNameExchange_js_1.operationNameExchange, urlParamExchange_js_1.urlParamExchange, this.ssr];
