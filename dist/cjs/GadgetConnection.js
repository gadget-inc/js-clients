...
class GadgetConnection {
    ...
    newBaseClient() {
        const exchanges = [...this.exchanges.beforeAll, operationNameExchange_js_1.operationNameExchange, otelExchange_js_1.otelExchange, urlParamExchange_js_1.urlParamExchange];
        // apply urql's default caching behaviour when client side (but skip it server side)
        if (typeof window != "undefined") {
            exchanges.push(core_1.cacheExchange);
        }
        exchanges.push(...this.exchanges.beforeAsync, core_1.fetchExchange, (0, core_1.subscriptionExchange)({
            forwardSubscription: (request) => {
                return {
                    subscribe: (sink) => {
                        const input = { ...request, query: request.query || "" };
