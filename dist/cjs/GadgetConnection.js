...
const exchanges_js_1 = require("./exchanges.js");
...
class GadgetConnection {
    ...
    newBaseClient() {
        const exchanges = [exchanges_js_1.urlParamExchange];
        ...
        (0, core_1.subscriptionExchange)({
            isSubscriptionOperation: (request) => {
                return request.query.definitions.some((definition) => (0, graphql_live_query_1.isLiveQueryOperationDefinitionNode)(definition, request.variables));
            },
            forwardSubscription: (request) => {
                return {
                    subscribe: (sink) => {
                        const input = { ...request, query: request.query || "" };
                        return {
                            unsubscribe: (0, push_pull_async_iterable_iterator_1.applyAsyncIterableIteratorToSink)((0, graphql_live_query_patch_jsondiffpatch_1.applyLiveQueryJSONDiffPatch)((0, push_pull_async_iterable_iterator_1.makeAsyncIterableIteratorFromSink)((sink) => this.baseSubscriptionClient.subscribe(input, sink))), sink),
                        };
                    },
                };
            },
