...
const cacheControlExchange = ({ forward }) => {
    return operations$ => {
        ...
        const uncacheable = (0, wonka_1.pipe)(operations$, (0, wonka_1.filter)(op => op.query.definitions.some(isLiveQueryOperationDefinitionNode)), (0, wonka_1.tap)((op) => op.context.requestPolicy = "network-only") // Update the network policy so they are never cached
        );
