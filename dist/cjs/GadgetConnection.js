...
exports.isLiveQueryOperationDefinitionNode = exports.GadgetConnection = exports.AuthenticationMode = exports.$gadgetConnection = exports.$transaction = exports.GadgetGraphQLCloseCode = void 0;
...
const liveQueryExchange_js_1 = require("./exchanges/liveQueryExchange.js");
...
class GadgetConnection {
    ...
    enableSessionMode(options) {
        ...
        const desiredMode = !options || typeof options == "boolean" || !("storageType" in options) ? ClientOptions_js_1.BrowserSessionStorageType.Durable : options.storageType;
    ...
    newBaseClient() {
        ...
        if (typeof window != "undefined") {
            ...
            exchanges.push(liveQueryExchange_js_1.liveQueryExchange);
        }
        ...
        (0, core_1.subscriptionExchange)({
            isSubscriptionOperation: (request) => {
                return request.query.definitions.some((definition) => (0, exports.isLiveQueryOperationDefinitionNode)(definition));
            },
            forwardSubscription: (request) => {
                return {
                    subscribe: (sink) => {
        ...
        return this.createSubscriptionClient({
            ...
            on: {
                connected: (socket, payload, wasRetry) => {
                    ...
                    (_d = (_c = (_b = this.subscriptionClientOptions) === null || _b === void 0 ? void 0 : _b.on) === null || _c === void 0 ? void 0 : _c.connected) === null || _d === void 0 ? void 0 : _d.call(_c, socket, payload, wasRetry);
                    (_f = (_e = overrides === null || overrides === void 0 ? void 0 : overrides.on) === null || _e === void 0 ? void 0 : _e.connected) === null || _f === void 0 ? void 0 : _f.call(_e, socket, payload, wasRetry);
                    activeSocket = socket;
                },
                ping: (received) => {
                    if (!received) {
                        timedOut = setTimeout(() => {
                            if (activeSocket.readyState === isomorphic_ws_1.default.OPEN) {
    ...
    async requestHeaders() {
        ...
        if (this.authenticationMode == AuthenticationMode.Internal || this.authenticationMode == AuthenticationMode.InternalAuthToken) {
            ...
            if (this.authenticationMode == AuthenticationMode.Internal && this.options.authenticationMode.internal.actAsSession) {
                ...
                const sessionId = await ((_b = (_a = this.options.authenticationMode.internal).getSessionId) === null || _b === void 0 ? void 0 : _b.call(_a));
                if (sessionId) {
