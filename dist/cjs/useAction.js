    ...
    if (result.data) {
        ...
        if (mutationData) {
            ...
            if (errors && errors[0]) {
                ...
                data = (0, api_client_core_1.processActionResponse)(action.defaultSelection, result, mutationData, action.modelSelectionField, action.hasReturnType, action.modelManager);
            }
        }
    }
