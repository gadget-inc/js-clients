...
let useActionImpl = (0, createHooks_js_1.createHookStub)("useAction");
(0, createHooks_js_1.createHookStub)("useAction", (adapter, coreHooks) => {
...
const useAction = (action, options) => useActionImpl(action, options);
