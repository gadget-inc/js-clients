...
const InnerGadgetProvider = (0, react_2.memo)(({ children, gadgetAppUrl, originalQueryParams, api, type, host, isReady, isRootFrameRequest }) => {
    ...
    if (fetchOrInstallShopData) {
        ...
        redirectToOauth = fetchOrInstallShopData.shopifyFetchOrInstallShop.redirectToOauth;
        isAuthenticated = fetchOrInstallShopData.shopifyFetchOrInstallShop.isAuthenticated;
    }
