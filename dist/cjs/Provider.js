...
const Provider = ({ type, children, api, }) => {
    ...
    return (react_2.default.createElement(react_1.Provider, { api: api }, shopifyGlobalDefined && coalescedType === AppType.Embedded ? (react_2.default.createElement(InnerGadgetProvider, { gadgetAppUrl: gadgetAppUrl, api: api, originalQueryParams: originalQueryParams, type: coalescedType, host: host, isReady: isReady, isRootFrameRequest: isRootFrameRequest }, children)) : (react_2.default.createElement(index_js_1.GadgetAuthContext.Provider, { value: {
            isAuthenticated: false,
            isEmbedded: false,
            canAuth: false,
            loading: false,
