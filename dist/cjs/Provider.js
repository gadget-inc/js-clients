...
const app_bridge_react_1 = tslib_1.__importDefault(require("@shopify/app-bridge-react"));
const context_js_1 = require("@shopify/app-bridge-react/context.js");
const app_bridge_utils_1 = require("@shopify/app-bridge-utils");
const index_js_1 = require("@shopify/app-bridge/actions/index.js");
...
const InnerGadgetProvider = (0, react_2.memo)(({ children, forceRedirect, isEmbedded, gadgetAppUrl, originalQueryParams, api, isRootFrameRequest, type, isInstallRequest, }) => {
    const appBridge = (0, react_2.useContext)(context_js_1.AppBridgeContext);
        ...
        api.connection.setAuthenticationMode({
            custom: {
                ...
                async processTransactionConnectionParams(params) {
                    params.auth.shopifySessionToken = await (0, app_bridge_utils_1.getSessionToken)(appBridge);
                },
            },
        });
    ...
    (0, react_2.useEffect)(() => {
        ...
        if (isEmbedded && appBridge) {
            index_js_1.Redirect.create(appBridge).dispatch(index_js_1.Redirect.Action.REMOTE, redirectURLWithOAuthParams);
        }
        else {
    ...
    return react_2.default.createElement(index_js_2.GadgetAuthContext.Provider, { value: context }, children);
});
const Provider = ({ type, children, shopifyApiKey, api, router, }) => {
    ...
    let app = (react_2.default.createElement(react_1.Provider, { api: api },
    ...
    if (shouldMountAppBridge) {
        app = (react_2.default.createElement(app_bridge_react_1.default.Provider, { config: {
