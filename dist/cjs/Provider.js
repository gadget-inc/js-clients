...
const InnerGadgetProvider = (0, react_2.memo)(({ children, gadgetAppUrl, originalQueryParams, api, type, host, isReady, isRootFrameRequest, shopifyInstallState, }) => {
    ...
    const maybeGetShopifyInstallState = (0, react_2.useCallback)(() => {
...
const Provider = ({ type, children, api, location: _location, }) => {
