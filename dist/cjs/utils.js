...
exports.transformData = exports.set = exports.get = exports.disambiguateActionVariables = exports.useQueryArgs = exports.useMemoizedQueryOptions = exports.ErrorWrapper = exports.noProviderErrorMessage = void 0;
const api_client_core_1 = require("@gadgetinc/api-client-core");
const api_client_core_2 = require("@gadgetinc/api-client-core");
...
class ErrorWrapper extends Error {
    ...
    static forErrorsResponse(errors, response) {
        return new ErrorWrapper({
            executionErrors: errors.map(api_client_core_2.gadgetErrorFor),
            response,
        });
    }
    /** @private */
    ...
    static errorIfDataAbsent(result, dataPath, paused = false) {
        const nonNullableError = (0, api_client_core_2.getNonNullableError)(result, dataPath);
...
exports.set = set;
async function transformData(client, defaultValues, data) {
