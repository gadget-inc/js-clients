...
exports.getErrorMessage = exports.countNumberOfDecimals = exports.getStepFromNumberOfDecimals = exports.groupPaths = exports.getFlattenedObjectKeys = exports.deepFlattenObject = exports.deepMerge = exports.humanizeCamelCase = exports.isRoleAssignmentsArray = exports.getPropsWithoutRef = exports.sortByProperty = exports.getModelManager = exports.debounce = exports.omit = exports.unset = exports.compact = exports.uniq = exports.uniqByProperty = exports.set = exports.get = void 0;
/**
 ...
 * From https://youmightnotneed.com/lodash
 */
const omit = (obj, omittedProperties, safe = false) => {
    obj = { ...obj };
...
const getModelManager = (apiClient, coreImplementation, apiIdentifier, namespace) => {
    return (0, exports.get)(apiClient, coreImplementation.namespaceDataPath([apiIdentifier], namespace).join("."));
};
exports.getModelManager = getModelManager;
const sortByProperty = (arr, property, options) => {
...
const groupPaths = (paths, uniquePaths = true) => {
    const groups = {};
...
exports.getStepFromNumberOfDecimals = getStepFromNumberOfDecimals;
/**
...
exports.countNumberOfDecimals = countNumberOfDecimals;
/**
