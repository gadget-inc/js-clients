...
const useSignOut = (opts) => {
    ...
    const context = (0, react_1.useContext)(GadgetProvider_js_1.GadgetApiContext);
    ...
    if (signOutActionApiIdentifier && api.user[signOutActionApiIdentifier]) {
        ...
        // @ts-ignore
        const [{ error }, signOutAction] = (0, hooks_js_1.useAction)(api.user[signOutActionApiIdentifier], { suspense: true });
        if (error)
            throw error;
