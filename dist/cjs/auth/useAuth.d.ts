import type { DefaultSelection, GadgetRecord, OptionsType, ReadOperationOptions, Select } from "@gadgetinc/api-client-core";
...
export declare const useAuth: <SessionGivenOptions extends OptionsType, SessionSchemaT, UserGivenOptions extends OptionsType, UserSchemaT, SessionOptions extends Client["currentSession"]["get"]["optionsType"] & ReadOperationOptions, UserOptions extends Client["user"]["findMany"]["optionsType"] & ReadOperationOptions, Client extends ClientWithSessionAndUserManagers<SessionGivenOptions, SessionSchemaT, UserGivenOptions, UserSchemaT>, ClientType extends Client | undefined>(client?: Client) => {
    session: GadgetRecord<Select<Exclude<Exclude<ClientType, undefined>["currentSession"]["get"]["schemaType"], null | undefined>, DefaultSelection<Exclude<ClientType, undefined>["currentSession"]["get"]["selectionType"], SessionOptions, Exclude<ClientType, undefined>["currentSession"]["get"]["defaultSelection"] & {
        user: Exclude<ClientType, undefined>["user"]["findMany"]["defaultSelection"];
    }>>> | GadgetSession;
    user: GadgetRecord<Select<Exclude<Exclude<ClientType, undefined>["user"]["findMany"]["schemaType"], null | undefined>, DefaultSelection<Exclude<ClientType, undefined>["user"]["findMany"]["selectionType"], UserOptions, Exclude<ClientType, undefined>["user"]["findMany"]["defaultSelection"]>>> | GadgetUser;
    isSignedIn: boolean;
