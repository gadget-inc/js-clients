 ...
 * }
 */
export declare const useEnqueue: <Action extends AnyActionFunction>(action: Action, baseBackgroundOptions?: EnqueueBackgroundActionOptions<Action>) => EnqueueHookResult<Action>;
