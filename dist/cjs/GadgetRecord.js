...
class GadgetRecordImplementation {
    constructor(data) {
        ...
        this.__gadget.instantiatedFields = (0, klona_1.klona)(data);
        this.__gadget.persistedFields = (0, klona_1.klona)(data);
    ...
    hasChanges(tracking = ChangeTracking.SinceLoaded) {
        ...
        return this.__gadget.fieldKeys.some((key) => !(0, support_js_1.isEqual)(diffFields[key], this.__gadget.fields[key]));
    }
    ...
    changes(prop, tracking = ChangeTracking.SinceLoaded) {
        ...
        if (prop && typeof prop == "string") {
            ...
            const changed = !(0, support_js_1.isEqual)(current, previous);
            ...
            for (let index = 0; index < this.__gadget.fieldKeys.length; index++) {
                ...
                if (!(0, support_js_1.isEqual)(diffFields[key], this.__gadget.fields[key])) {
    ...
    flushChanges(tracking = ChangeTracking.SinceLoaded) {
        if (tracking == ChangeTracking.SinceLoaded) {
            this.__gadget.instantiatedFields = (0, klona_1.klona)(this.__gadget.fields);
        }
        else if (tracking == ChangeTracking.SinceLastPersisted) {
            this.__gadget.persistedFields = (0, klona_1.klona)(this.__gadget.fields);
        }
    ...
    revertChanges(tracking = ChangeTracking.SinceLoaded) {
        ...
        if (tracking == ChangeTracking.SinceLoaded) {
            Object.assign(this.__gadget.fields, (0, klona_1.klona)(this.__gadget.instantiatedFields));
        }
        else {
            Object.assign(this.__gadget.fields, (0, klona_1.klona)(this.__gadget.persistedFields));
        }
        this.__gadget.touched = false;
    }
    /** Returns a JSON representation of all fields on this record. */
    toJSON() {
        return (0, support_js_1.toPrimitiveObject)({ ...this.__gadget.fields });
    }
    touch() {
