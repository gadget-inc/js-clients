...
const AnyModelManager_js_1 = require("./AnyModelManager.js");
...
class GadgetRecord_ {
    constructor(data, modelManager) {
        ...
        this[kInstantiatedFields] = (_g = (0, klona_1.klona)(data)) !== null && _g !== void 0 ? _g : {};
        this[kPersistedFields] = (_h = (0, klona_1.klona)(data)) !== null && _h !== void 0 ? _h : {};
    ...
    async reload(options) {
        ...
        if ((0, AnyModelManager_js_1.isPublicModelManager)(modelManager)) {
            return await modelManager.findOne(this.getField("id"), options);
        }
        if ((0, AnyModelManager_js_1.isPublicSingletonModelManager)(modelManager)) {
            return await modelManager.get(options);
        }
        throw new Error("Record can not be reloaded");
    }
}
exports.GadgetRecord_ = GadgetRecord_;
_a = kFields, _b = kInstantiatedFields, _c = kPersistedFields, _d = kFieldKeys, _e = kTouched, _f = kModelManager;
/**
