...
exports.GadgetRecord = exports.GadgetRecord_ = exports.ChangeTracking = void 0;
...
class GadgetRecord_ {
    constructor(data) {
        ...
        this[kInstantiatedFields] = (_f = (0, klona_1.klona)(data)) !== null && _f !== void 0 ? _f : {};
        this[kPersistedFields] = (_g = (0, klona_1.klona)(data)) !== null && _g !== void 0 ? _g : {};
    ...
    hasChanges(tracking = ChangeTracking.SinceLoaded) {
        ...
        return [...this[kFieldKeys]].some((key) => !(0, support_js_1.isEqual)(diffFields[key], this[kFields][key]));
    }
