...
const processActionResponse = (defaultSelection, response, record, modelSelectionField, hasReturnType) => {
    ...
    if (!hasReturnType) {
        ...
        const innerReturnType = Object.entries(hasReturnType).find(([key]) => key == `... on ${record.__typename}`);
        return processActionResponse(defaultSelection, response, record, modelSelectionField, innerReturnType === null || innerReturnType === void 0 ? void 0 : innerReturnType[1].hasReturnType);
    }
};
