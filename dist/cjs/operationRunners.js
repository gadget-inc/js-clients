...
const findOneRunner = (modelManager, operation, id, defaultSelection, modelApiIdentifier, options, throwOnEmptyData = true, namespace) => {
    ...
    return maybeLiveStream($results, (response) => {
        ...
        return (0, support_js_1.hydrateRecord)(response, record, modelManager);
    }, options);
};
...
const actionRunner = async (modelManager, operation, defaultSelection, modelApiIdentifier, modelSelectionField, isBulkAction, variables, options, namespace, hasReturnType) => {
    ...
    if (!isBulkAction) {
        ...
        return (0, exports.processActionResponse)(defaultSelection, response, mutationTriple, modelSelectionField, hasReturnType, modelManager);
    }
    else {
...
const processBulkActionResponse = (defaultSelection, response, records, modelSelectionField, hasReturnType, modelManager) => {
    if (defaultSelection == null)
        return;
    if (!hasReturnType) {
        return (0, support_js_1.hydrateRecordArray)(response, records[modelSelectionField], modelManager);
    }
        ...
        return Object.entries(hasReturnType).flatMap(([returnTypeField, innerHasReturnType]) => {
            ...
            return results.map((result) => {
                ...
                if (!returnTypeForResult) {
                    return (0, support_js_1.hydrateRecord)(response, result, modelManager);
                }
                else {
...
const processActionResponse = (defaultSelection, response, record, modelSelectionField, hasReturnType, modelManager) => {
    ...
    if (defaultSelection == null)
        return;
    if (!hasReturnType) {
        return (0, support_js_1.hydrateRecord)(response, record[modelSelectionField], modelManager);
    }
    else if (typeof hasReturnType == "boolean") {
        ...
        return (0, exports.processActionResponse)(defaultSelection, response, record, modelSelectionField, innerReturnType, modelManager);
    }
};
...
const backgroundActionResultRunner = async (connection, id, action, options, modelManager) => {
    ...
    switch (action.type) {
        case "action": {
            backgroundAction.result = (0, exports.processActionResponse)(action.defaultSelection, response.data, backgroundAction.result, action.isBulk ? action.modelApiIdentifier : action.modelSelectionField, action.hasReturnType, modelManager);
            break;
        }
        case "globalAction": {
