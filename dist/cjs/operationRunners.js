...
const actionResultRunner = async (connection, id, action, options) => {
    ...
    const response = await (0, wonka_1.pipe)(subscription, (0, wonka_1.filter)((operation) => { var _a, _b; return (_b = (_a = operation.data) === null || _a === void 0 ? void 0 : _a.backgroundAction) === null || _b === void 0 ? void 0 : _b.outcome; }), (0, wonka_1.take)(1), wonka_1.toPromise);
