...
const computedViewRunner = async (connection, operation, variables, selections, namespace) => {
    const plan = (0, operationBuilders_js_1.computedViewOperation)(operation, variables, selections, namespace);
