...
const computedViewRunner = async (connection, operation, variables, defaultSelection, selection, namespace) => {
    const plan = (0, operationBuilders_js_1.computedViewOperation)(operation, variables, defaultSelection, selection, namespace);
