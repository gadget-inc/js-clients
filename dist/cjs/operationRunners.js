...
const computedViewRunner = async (connection, operation, variables, defaultSelection, namespace) => {
    const plan = (0, operationBuilders_js_1.computedViewOperation)(operation, variables, defaultSelection, namespace);
    const response = await connection.currentClient.query(plan.query, plan.variables);
    const dataPath = (0, support_js_1.namespaceDataPath)([operation], namespace);
    console.log(response);
    return (0, support_js_1.assertOperationSuccess)(response, dataPath).result;
};
