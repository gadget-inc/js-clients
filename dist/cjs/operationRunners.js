...
exports.actionResultRunner = exports.cancelBackgroundActionRunner = exports.backgroundActionResultRunner = exports.enqueueActionRunner = exports.globalActionRunner = exports.processActionResponse = exports.actionRunner = exports.findManyRunner = exports.findOneByFieldRunner = exports.findOneRunner = void 0;
...
const cancelBackgroundActionRunner = async (connection, id) => {
    const plan = (0, operationBuilders_js_1.cancelBackgroundActionOperation)(id);
    const response = await connection.currentClient.mutation(plan.query, plan.variables).toPromise();
    (0, support_js_1.assertMutationSuccess)(response, ["background", "cancel"]);
};
exports.cancelBackgroundActionRunner = cancelBackgroundActionRunner;
