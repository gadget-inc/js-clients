...
exports.actionResultRunner = exports.backgroundActionResultRunner = exports.enqueueActionRunner = exports.computedViewRunner = exports.globalActionRunner = exports.actionRunner = exports.findManyRunner = exports.findOneByFieldRunner = exports.findOneRunner = void 0;
...
const computedViewRunner = async (connection, operation, variables, defaultSelections, selections, namespace) => {
    const plan = (0, operationBuilders_js_1.computedViewOperation)(operation, variables, defaultSelections, selections, namespace);
    const response = await connection.currentClient.query(plan.query, plan.variables);
    const dataPath = (0, support_js_1.namespaceDataPath)([operation], namespace);
    return (0, support_js_1.assertOperationSuccess)(response, dataPath);
};
exports.computedViewRunner = computedViewRunner;
