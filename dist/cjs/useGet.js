...
const useGet = (manager, options) => {
    ...
    const plan = (0, react_1.useMemo)(() => {
        return (0, api_client_core_1.findOneOperation)(manager.get.operationName, undefined, manager.get.defaultSelection, manager.get.modelApiIdentifier, memoizedOptions, manager.get.namespace);
    }, [manager, memoizedOptions]);
    const [rawResult, refresh] = (0, useGadgetQuery_js_1.useGadgetQuery)((0, utils_js_1.useQueryArgs)(plan, options));
    const dataPath = (0, api_client_core_1.namespaceDataPath)([manager.get.operationName], manager.get.namespace);
    const result = (0, react_1.useMemo)(() => {
        let data = null;
        const rawRecord = rawResult.data && (0, api_client_core_1.get)(rawResult.data, dataPath);
        if (rawRecord) {
