...
let useGetImpl = (0, createHooks_js_1.createHookStub)("useGet");
(0, createHooks_js_1.createHookStub)("useGet", (adapter, coreHooks) => {
...
const useGet = (manager, options) => useGetImpl(manager, options);
