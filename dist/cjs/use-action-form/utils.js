    ...
    function transform(input, context) {
        ...
        if (path && Array.isArray(input)) {
            ...
            for (const key of Object.keys(input)) {
                ...
                console.log({ fieldType, relationships, currentPath });
            ...
            const belongsToRelationships = fieldRelationships // grab the belongsTo relationships from the fieldRelationships object
                ...
                : null;
            console.log({ path, depth, belongsToRelationships, fieldRelationships });
            ...
            console.log({ belongsTo, depth, fieldType, rest, path });
            if (belongsTo) {
                console.log({ depth, rest, belongsTo });
