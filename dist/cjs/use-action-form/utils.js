...
exports.extractModifiablePaths = exports.transformContextAwareToSelect = exports.reshapeDataForGraphqlApi = exports.disambiguateDefaultValues = exports.toDefaultValues = exports.processDefaultValues = exports.useFindExistingRecord = void 0;
...
const reshapeDataForGraphqlApi = async (client, defaultValues, data) => {
    ...
    function transform(input, context) {
        ...
        if (path && Array.isArray(input)) {
            ...
            // { productVariantId: "443", shopId: "445", quantity: 1}
            // { create: { productVariant: { _link: "443"}}, shopId: "445", quantity: 1}
            if (belongsTo) {
...
function extractModifiablePaths(obj, prefix = "") {
    let paths = [];
    for (const key in obj) {
        ...
        if (obj[key] === true) {
            ...
            paths = paths.concat(extractModifiablePaths(obj[key], currentPath));
        }
    }
    return paths;
}
exports.extractModifiablePaths = extractModifiablePaths;
