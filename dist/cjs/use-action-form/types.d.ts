...
import type { ActionFunction, ActionWithIdAndNoVariables, ActionWithIdAndVariables, AnyErrorWrapper, BulkActionWithIdsAndNoVariables, DefaultSelection, GadgetRecord, GlobalActionFunction, Select } from "@gadgetinc/core";
...
type ServerSideError<F extends ActionFunction<any, any, any, any, any> | GlobalActionFunction<any>> = F extends ActionFunction<any, any, any, any, any> ? {
    [key in F["modelApiIdentifier"]]?: {
        [key in keyof F["selectionType"] | keyof ExcludeNullish<F["variablesType"]> | ExcludeNullish<F["modelApiIdentifier"] extends "user" ? "password" : never>]?: {
            message: string;
        };
    };
} : {
    [key in keyof ExcludeNullish<F["variablesType"]>]: {
        message: string;
    };
};
...
export type AnyUpsertAction = {
    variablesType: {
        on?: (string | null)[];
    } | undefined;
    hasReturnType: Record<string, any>;
};
