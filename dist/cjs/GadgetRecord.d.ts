...
declare const kModelManager: unique symbol;
 ...
 **/
export declare const GadgetRecord: new <Shape extends RecordShape>(data: Shape, modelManager?: AnyModelManager) => GadgetRecord_<Shape> & Shape;
/**
