...
export interface AnyConnection {
    ...
    enqueue: {
        plan: (operation: string, variables: VariablesOptions, namespace?: string | string[] | null, options?: EnqueueBackgroundActionOptions<any> | null, isBulk?: boolean) => BuildOperationResult;
