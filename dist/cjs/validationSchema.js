...
exports.isAutoFileFieldValue = exports.validationSchema = exports.isFailedJSONParse = exports.RequiredValidationSpecId = void 0;
...
const validatorForField = (field, pathsToValidate = [], currentFieldPath = "") => {
    ...
    switch (field.fieldType) {
        ...
        case graphql_js_1.GadgetFieldType.Json: {
            validator = (0, yup_1.mixed)().test("is-valid-json", function (value) {
                if (typeof value == "undefined")
                    return true;
                const { path, createError } = this;
                if ((0, exports.isFailedJSONParse)(value)) {
        ...
        case graphql_js_1.GadgetFieldType.Object: {
            const config = field.configuration;
            validator = (0, exports.validationSchema)(config.fields, pathsToValidate, path);
            break;
        }
        ...
        case graphql_js_1.GadgetFieldType.HasOne: {
            ...
            validator = (0, yup_1.object)(childValidators);
            break;
        }
        case graphql_js_1.GadgetFieldType.HasManyThrough:
        case graphql_js_1.GadgetFieldType.HasMany: {
            const childValidators = childValidatorsForField(path, field, pathsToValidate);
            validator = (0, yup_1.array)((0, yup_1.object)(childValidators));
            break;
        }
        case graphql_js_1.GadgetFieldType.Array: {
...
const applyValidationsToInputField = (field, validator, pathRequiresValidation) => {
    if (field.requiredArgumentForInput && pathRequiresValidation) {
        if (field.fieldType === graphql_js_1.GadgetFieldType.RichText) {
            validator = (0, yup_1.object)({ markdown: (0, yup_1.string)().required() });
        }
...
const isFailedJSONParse = (value) => {
    return value && typeof value == "object" && "$failedParse" in value;
};
exports.isFailedJSONParse = isFailedJSONParse;
/**
 ...
 */
const validationSchema = (fields, pathsToValidate = [], currentPath = "") => {
    const validators = {};
    for (const field of fields) {
        validators[field.apiIdentifier] = validatorForField(field, pathsToValidate, currentPath);
    }
    const validator = (0, yup_1.object)(validators);
    return validator;
};
