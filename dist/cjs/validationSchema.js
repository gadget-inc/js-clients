...
const graphql_1 = require("./internal/gql/graphql");
...
const validatorForField = (field) => {
    ...
    switch (field.fieldType) {
        case graphql_1.GadgetFieldType.Boolean: {
            validator = (0, yup_1.boolean)();
            break;
        }
        case graphql_1.GadgetFieldType.Code:
        case graphql_1.GadgetFieldType.Password:
        case graphql_1.GadgetFieldType.EncryptedString:
        case graphql_1.GadgetFieldType.Color:
        case graphql_1.GadgetFieldType.String: {
            validator = (0, yup_1.string)();
            break;
        }
        case graphql_1.GadgetFieldType.DateTime: {
            validator = (0, yup_1.date)();
            break;
        }
        case graphql_1.GadgetFieldType.Email: {
            validator = (0, yup_1.string)().email();
            break;
        }
        case graphql_1.GadgetFieldType.Url: {
            validator = (0, yup_1.string)().url();
            break;
        }
        case graphql_1.GadgetFieldType.Enum: {
        ...
        case graphql_1.GadgetFieldType.File: {
            validator = fileInputValidator;
            break;
        }
        case graphql_1.GadgetFieldType.Number: {
            validator = (0, yup_1.number)();
            break;
        }
        case graphql_1.GadgetFieldType.Id: {
            validator = (0, yup_1.string)();
            break;
        }
        case graphql_1.GadgetFieldType.RecordState:
        case graphql_1.GadgetFieldType.Any:
        case graphql_1.GadgetFieldType.Json: {
            validator = (0, yup_1.mixed)();
            break;
        }
        case graphql_1.GadgetFieldType.Money: {
            validator = (0, yup_1.string)();
            break;
        }
        case graphql_1.GadgetFieldType.Object: {
            const config = field.configuration;
            validator = (0, exports.validationSchema)(config.fields);
            break;
        }
        case graphql_1.GadgetFieldType.RichText: {
            validator = richTextInputValidator;
            break;
        }
        case graphql_1.GadgetFieldType.RoleAssignments: {
            validator = (0, yup_1.array)((0, yup_1.string)());
            break;
        }
        case graphql_1.GadgetFieldType.Vector: {
            validator = (0, yup_1.array)((0, yup_1.number)());
            break;
        }
        case graphql_1.GadgetFieldType.BelongsTo:
        case graphql_1.GadgetFieldType.HasOne:
        case graphql_1.GadgetFieldType.HasManyThrough:
        case graphql_1.GadgetFieldType.HasMany: {
