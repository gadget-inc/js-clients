...
exports.isAutoFileFieldValue = exports.validationSchema = void 0;
                        ...
                        if ((0, exports.isAutoFileFieldValue)(value) && value.$invalidFileSize) {
                            if (min) {
                                if (max) {
                                    return createError({
                                        path,
                                        message: `must be a file between ${(0, filesize_1.filesize)(min)} and ${(0, filesize_1.filesize)(max)} big, and this file's size is ${(0, filesize_1.filesize)(value.$invalidFileSize)}.`,
                                    });
                                }
                                else {
                                    return createError({
                                        path,
                                        message: `must be a file larger than than ${(0, filesize_1.filesize)(min)}, and this file's size is ${(0, filesize_1.filesize)(value.$invalidFileSize)}.`,
                                    });
                                }
                            }
                            else {
                                if (max) {
                                    return createError({
                                        path,
                                        message: `must be a file smaller than ${(0, filesize_1.filesize)(max)}, and this file's size is ${(0, filesize_1.filesize)(value.$invalidFileSize)}.`,
                                    });
                                }
                            }
                        }
