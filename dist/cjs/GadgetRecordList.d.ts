...
export declare class GadgetRecordList<Shape extends RecordShape> extends Array<GadgetRecord<Shape>> {
    ...
    static boot<Shape extends RecordShape>(modelManager: AnyPublicModelManager | InternalModelManager, records: GadgetRecord<Shape>[], pagination: PaginationConfig): GadgetRecordList<Shape>;
