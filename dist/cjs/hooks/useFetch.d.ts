...
export declare const createUseFetch: (adapter: RuntimeAdapter, coreHooks: CoreHooks) => {
    /**
    ...
    useFetch: {
        ...
        (path: string, options: {
            stream: true;
        } & FetchHookOptions): FetchHookResult<ReadableStream<Uint8Array>, ReadableStream<Uint8Array>>;
        <T extends Record<string, any>>(url: string, options: {
            json: true;
        } & FetchHookOptions): FetchHookResult<T, T>;
        (path: string, options?: FetchHookOptions): FetchHookResult<string, string>;
    };
};
