import type { FindManyFunction } from "../GadgetFunctions.js";
...
import { ReadHookResult, type OptionsType, type ReadOperationOptions } from "./utils.js";
export declare const createUseFindMany: (adapter: RuntimeAdapter, coreHooks: CoreHooks) => {
    /**
     ...
     * ```
     */
    useFindMany: <GivenOptions extends OptionsType, SchemaT, F extends FindManyFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(manager: {
        findMany: F;
