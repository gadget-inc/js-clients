...
export declare const createUseFindOne: (adapter: RuntimeAdapter, coreHooks: CoreHooks) => {
    /**
     ...
     * ```
     */
    useFindOne: <GivenOptions extends OptionsType, SchemaT, F extends FindOneFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(manager: {
        findOne: F;
