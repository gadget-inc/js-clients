...
import type { AnyActionFunction, AnyBulkActionFunction, AnyClient, AnyModelManager, BackgroundActionHandle, EnqueueBackgroundActionOptions, FieldSelection, GadgetError, InvalidFieldError } from "@gadgetinc/api-client-core";
 ...
 **/
export type ActionHookResult<Data = any, Variables extends AnyVariables = AnyVariables> = RequiredKeysOf<Variables> extends never ? ActionHookResultWithOptionalCallbackVariables<Data, Variables> : Variables extends Record<string, never> ? ActionHookResultWithOptionalCallbackVariables<Data, Variables> : ActionHookResultWithRequiredCallbackVariables<Data, Variables>;
type ActionHookResultWithOptionalCallbackVariables<Data = any, Variables extends AnyVariables = AnyVariables> = [
...
type ActionHookResultWithRequiredCallbackVariables<Data = any, Variables extends AnyVariables = AnyVariables> = [
    ActionHookState<Data, Variables>,
    (variables: Variables, context?: Partial<OperationContext>) => Promise<ActionHookState<Data, Variables>>
];
/**
