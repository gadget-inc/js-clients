import type { ActionFunction, AnyModelManager, BulkActionFunction, FieldSelection, GadgetError, InvalidFieldError } from "@gadgetinc/api-client-core";
...
export declare function hasNested(data: any): boolean;
export declare function transformDataRedux(modelManager: AnyModelManager | undefined, defaultValues: any, data: any): Promise<any>;
export {};
