...
class GadgetTransaction {
    ...
    async rollback() {
        (0, support_js_1.assertOperationSuccess)(await this.client.mutation(`mutation RollbackTransaction { internal { rollbackTransaction }}`, {}).toPromise(), [
            "internal",
            "rollbackTransaction",
        ]);
        this.open = false;
     ...
     */
    async start() {
        (0, support_js_1.assertOperationSuccess)(await this.client.mutation(`mutation StartTransaction { internal { startTransaction }}`, {}).toPromise(), [
            "internal",
            "startTransaction",
        ]);
        this.open = true;
     ...
     */
    async commit() {
        (0, support_js_1.assertOperationSuccess)(await this.client.mutation(`mutation CommitTransaction { internal { commitTransaction }}`, {}).toPromise(), [
            "internal",
            "commitTransaction",
        ]);
        this.open = false;
