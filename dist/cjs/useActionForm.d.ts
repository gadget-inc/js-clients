...
declare const OmittedKeys: readonly ["id", "createdAt", "updatedAt"];
...
export type FormInput<InputT> = InputT extends (infer Element)[] ? FormInput<Element>[] : InputT extends {
    create?: unknown;
    update?: unknown;
} ? FormInput<InputT["create"]> | FormInput<InputT["update"]> : InputT extends object ? {
    [K in keyof InputT]: FormInput<InputT[K]>;
} : InputT;
export type UseActionFormResult<GivenOptions extends OptionsType, SchemaT, ActionFunc extends ActionFunction<GivenOptions, any, any, SchemaT, any> | GlobalActionFunction<any>, FormVariables extends FieldValues, FormContext = any> = Omit<UseFormReturn<FormVariables, FormContext>, "handleSubmit" | "formState"> & {
 ...
 */
export declare const useActionForm: <GivenOptions extends OptionsType, SchemaT, ActionFunc extends GlobalActionFunction<any> | ActionFunction<GivenOptions, any, any, SchemaT, any>, ExtraFormVariables = {}, FormContext = any, ActionResultData = UseActionFormHookStateData<ActionFunc>, DefaultValues = ActionFunc["variablesType"] & ExtraFormVariables>(action: ActionFunc, options?: (Omit<Partial<{
...
}) | undefined) => UseActionFormResult<GivenOptions, SchemaT, ActionFunc, ActionFunc["variablesType"] & ExtraFormVariables, FormContext>;
