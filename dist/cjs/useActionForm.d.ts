import type { ActionFunction, DefaultSelection, GadgetRecord, Select } from "@gadgetinc/api-client-core";
...
export declare const useActionForm: <GivenOptions extends OptionsType, SchemaT, ActionFunc extends ActionFunction<GivenOptions, any, any, SchemaT, any>, FormContext = any>(action: ActionFunc, options?: (Partial<{
     ...
     *
     */
    record?: (ActionFunc["hasReturnType"] extends true ? any : Partial<GadgetRecord<Select<Exclude<ActionFunc["schemaType"], null | undefined>, DefaultSelection<ActionFunc["selectionType"], ActionFunc["optionsType"], ActionFunc["defaultSelection"]>>>>) | undefined;
    /**
