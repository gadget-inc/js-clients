...
export type FormInput<InputT> = IsAny<InputT> extends true ? any : InputT extends (infer Element)[] ? FormInput<Element>[] : InputT extends {
    create?: unknown;
    update?: unknown;
...
}) | undefined) => UseActionFormResult<GivenOptions, SchemaT, ActionFunc, FormInput<ActionFunc["variablesType"]> & ExtraFormVariables, FormContext>;
