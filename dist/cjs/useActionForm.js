...
const useActionForm = (action, options) => {
    ...
    // eslint-disable-next-line react-hooks/rules-of-hooks
    const [actionResult, runAction] = "modelApiIdentifier" in action ? (0, useAction_js_1.useAction)(action, { select: options?.select }) : (0, useGlobalAction_js_1.useGlobalAction)(action);
