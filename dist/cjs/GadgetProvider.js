 ...
 *
 **/
exports.GadgetUrqlClientContext = globalThis.__gadgetUrqlClientContext || react_1.default.createContext(undefined);
/**
 ...
 */
try {
    if (!globalThis.__gadgetUrqlClientContext) {
        globalThis.__gadgetUrqlClientContext = react_1.default.createContext(undefined);
    }
}
catch (error) {
