...
export declare const computedViewOperation: <VariablesT extends VariablesOptions, SelectionsT extends FieldSelection>(operation: string, variables: VariablesT, selections: SelectionsT, namespace?: string | string[] | null) => {
    query: string;
    variables: Record<string, any>;
};
