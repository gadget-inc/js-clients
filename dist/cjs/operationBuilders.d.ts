...
export declare const computedViewOperation: (operation: string, variables: VariablesOptions, defaultSelection: FieldSelection, selection?: FieldSelection, namespace?: string | string[] | null) => {
    query: string;
    variables: Record<string, any>;
};
