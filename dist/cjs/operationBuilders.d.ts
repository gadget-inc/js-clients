...
export declare const computedViewOperation: (operation: string, variables: VariablesOptions, defaultSelections: FieldSelection, selections?: FieldSelection, namespace?: string | string[] | null) => {
    query: string;
    variables: Record<string, any>;
};
