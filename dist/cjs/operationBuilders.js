...
const computedViewOperation = (operation, variables, defaultSelection, namespace) => {
    let fields = {
        [operation]: (0, tiny_graphql_query_compiler_1.Call)(variableOptionsToVariables(variables), fieldSelectionToQueryCompilerFields(defaultSelection, true)),
    };
    if (namespace) {
        fields = (0, support_js_1.namespacify)(namespace, fields);
    }
