...
exports.enqueueActionOperation = exports.graphqlizeBackgroundOptions = exports.computedViewOperation = exports.globalActionOperation = exports.actionResultOperation = exports.backgroundActionResultOperation = exports.actionOperation = exports.findManyOperation = exports.findOneByFieldOperation = exports.findOneOperation = void 0;
...
const computedViewOperation = (operation, defaultSelection, variables, selection, namespace) => {
    let fields = {
        [operation]: (0, tiny_graphql_query_compiler_1.Call)(variables ? variableOptionsToVariables(variables) : {}, fieldSelectionToQueryCompilerFields(selection !== null && selection !== void 0 ? selection : defaultSelection, true)),
    };
    if (namespace) {
        fields = (0, support_js_1.namespacify)(namespace, fields);
    }
    return variables
        ? (0, tiny_graphql_query_compiler_1.compileWithVariableValues)({ type: "query", name: operation, fields })
        : { query: (0, tiny_graphql_query_compiler_1.compile)({ type: "query", name: operation, fields }), variables: {} };
};
exports.computedViewOperation = computedViewOperation;
