...
exports.enqueueActionOperation = exports.graphqlizeBackgroundOptions = exports.globalActionOperation = exports.actionResultOperation = exports.actionOperation = exports.findManyOperation = exports.findOneByFieldOperation = exports.findOneOperation = void 0;
...
const actionResultFieldSelection = (modelSelectionField, selection, isBulkAction, hasReturnType) => {
    return {
        success: true,
...
const actionResultOperation = (id, action, options) => {
    let fields = {};
    switch (action.type) {
        case "action": {
            const selection = (options === null || options === void 0 ? void 0 : options.select) || action.defaultSelection;
            fields = {
                [`... on ${(0, support_js_1.camelize)(action.operationName)}Result`]: actionResultFieldSelection(action.modelApiIdentifier, selection, action.isBulk, action.hasReturnType),
            };
            break;
        }
        case "globalAction": {
            fields = {
                [`... on ${(0, support_js_1.camelize)(action.operationName)}Result`]: globalActionFieldSelection(),
            };
        }
    }
...
exports.actionResultOperation = actionResultOperation;
...
const graphqlizeBackgroundOptions = (options) => {
    ...
    for (const key of Object.keys(obj)) {
        if (["id", "retries", "queue", "priority", "startsAt"].includes(key))
            continue;
        delete obj[key];
    }
    return obj;
