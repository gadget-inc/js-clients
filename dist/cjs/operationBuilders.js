...
const computedViewOperation = (operation, variables, defaultSelections, selections, namespace) => {
    let fields = {
        [operation]: (0, tiny_graphql_query_compiler_1.Call)(variableOptionsToVariables(variables), fieldSelectionToQueryCompilerFields(selections !== null && selections !== void 0 ? selections : defaultSelections, true)),
    };
    if (namespace) {
        fields = (0, support_js_1.namespacify)(namespace, fields);
    }
