...
const FieldSelection_js_1 = require("./FieldSelection.js");
...
const findOneOperation = (operation, id, defaultSelection, modelApiIdentifier, options) => {
    ...
    return (0, gql_query_builder_1.query)([
        {
            operation,
            fields: (0, FieldSelection_js_1.fieldSelectionToGQLBuilderFields)((options === null || options === void 0 ? void 0 : options.select) || defaultSelection, true),
            variables,
        },
    ...
    return (0, gql_query_builder_1.query)([
        {
            ...
            fields: [
                ...
                {
                    edges: ["cursor", { node: (0, FieldSelection_js_1.fieldSelectionToGQLBuilderFields)((options === null || options === void 0 ? void 0 : options.select) || defaultSelection, true) }],
                },
            ],
            variables: {
                ...
                ...((options === null || options === void 0 ? void 0 : options.sort) && { sort: { value: options === null || options === void 0 ? void 0 : options.sort, type: (0, support_js_1.sortTypeName)(modelApiIdentifier) + "!", list: true } }),
                ...((options === null || options === void 0 ? void 0 : options.filter) && { filter: { value: options === null || options === void 0 ? void 0 : options.filter, type: (0, support_js_1.filterTypeName)(modelApiIdentifier) + "!", list: true } }),
...
const actionOperation = (operation, defaultSelection, modelApiIdentifier, modelSelectionField, variables, options, namespace) => {
    ...
    if (selection) {
        actionOperation.fields.push({ [modelSelectionField]: (0, FieldSelection_js_1.fieldSelectionToGQLBuilderFields)(selection, true) });
    }
    if (namespace) {
        actionOperation = {
            operation: namespace,
