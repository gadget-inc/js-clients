import type { ActionFunction, ActionFunctionMetadata, AnyActionFunction, AnyBackgroundActionHandle, AnyBulkActionFunction, AnyClient, AnyConnection, AnyCoreImplementation, AnyErrorWrapper, BulkActionFunction, DefaultSelection, EnqueueBackgroundActionOptions, FieldSelection, FindFirstFunction, FindManyFunction, FindOneFunction, GadgetRecord, GadgetRecordList, GetFunction, GlobalActionFunction, LimitToKnownKeys, Select, ViewFunction, ViewFunctionWithVariables, ViewFunctionWithoutVariables, ViewResult } from "@gadgetinc/core";
 ...
 **/
export type ActionHookResult<Data = any, Variables extends AnyVariables = AnyVariables> = RequiredKeysOf<Variables> extends never ? ActionHookResultWithOptionalCallbackVariables<Data, Variables> : ActionHookResultWithRequiredCallbackVariables<Data, Variables>;
...
export type UseGadgetQuery = <Data = any, Variables extends AnyVariables = AnyVariables>(args: UseGadgetQueryArgs<Variables, Data>) => UseQueryResponse<Data, Variables>;
export type UseGadgetMutation = <Data = any, Variables extends AnyVariables = AnyVariables>(query: DocumentInput<Data, Variables>) => UseMutationResponse<Data, Variables>;
 ...
 **/
export type EnqueueHookResult<Action extends AnyActionFunction> = RequiredKeysOf<Exclude<Action["variablesType"], null | undefined>> extends never ? [
    EnqueueHookState<Action>,
    (variables?: Action["variablesType"], backgroundOptions?: EnqueueBackgroundActionOptions<Action>, context?: Partial<OperationContext>) => Promise<EnqueueHookState<Action>>
] : [
    EnqueueHookState<Action>,
    (variables: Action["variablesType"], backgroundOptions?: EnqueueBackgroundActionOptions<Action>, context?: Partial<OperationContext>) => Promise<EnqueueHookState<Action>>
];
 ...
 * }
 */
export type UseAction = <GivenOptions extends OptionsType, SchemaT, F extends ActionFunction<GivenOptions, any, any, SchemaT, any>, Options extends F["optionsType"]>(action: F, options?: LimitToKnownKeys<Options, F["optionsType"]>) => ActionHookResult<F["hasReturnType"] extends true ? any : GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>, Exclude<F["variablesType"], null | undefined>>;
/**
 ...
 * }
 */
export type UseBulkAction = <GivenOptions extends OptionsType, SchemaT, F extends BulkActionFunction<GivenOptions, any, any, SchemaT, any>, Options extends F["optionsType"]>(action: F, options?: LimitToKnownKeys<Options, F["optionsType"]>) => ActionHookResult<F["hasReturnType"] extends true ? any[] : GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>[], Exclude<F["variablesType"], null | undefined>>;
/**
 ...
 * }
 */
export type UseEnqueue = <Action extends AnyActionFunction>(action: Action, baseBackgroundOptions?: EnqueueBackgroundActionOptions<Action>) => EnqueueHookResult<Action>;
 ...
 * }
 */
export type UseFindBy = <GivenOptions extends OptionsType, SchemaT, F extends FindOneFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(finder: F, value: string, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions>) => ReadHookResult<GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
/**
 ...
 * ```
 */
export type UseFindFirst = <GivenOptions extends OptionsType, SchemaT, F extends FindFirstFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findFirst: F;
 ...
 * ```
 */
export type UseFindMany = <GivenOptions extends OptionsType, SchemaT, F extends FindManyFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findMany: F;
}, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions>) => ReadHookResult<GadgetRecordList<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
/**
 ...
 * ```
 */
export type UseFindOne = <GivenOptions extends OptionsType, SchemaT, F extends FindOneFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findOne: F;
}, id: string, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions>) => ReadHookResult<GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
/**
 ...
 * ```
 */
export type UseGet = <GivenOptions extends OptionsType, SchemaT, F extends GetFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    get: F;
}, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions>) => ReadHookResult<GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
/**
 ...
 * }
 */
export type UseGlobalAction = <F extends GlobalActionFunction<any>>(action: F) => ActionHookResultWithOptionalCallbackVariables<any, Exclude<F["variablesType"], null | undefined>>;
/**
 ...
 * ```
 */
export type UseMaybeFindFirst = <GivenOptions extends OptionsType, SchemaT, F extends FindFirstFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findFirst: F;
}, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions>) => ReadHookResult<null | GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
/**
 ...
 * ```
 */
export type UseMaybeFindOne = <GivenOptions extends OptionsType, // currently necessary for Options to be a narrow type (e.g., `true` instead of `boolean`)
SchemaT, F extends FindOneFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findOne: F;
}, id: string, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions>) => ReadHookResult<null | GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
export interface UseView {
     ...
     * ```
     */
    <F extends ViewFunctionWithVariables<any, any>>(view: F, variables: F["variablesType"], options?: Omit<ReadOperationOptions, "live">): ReadHookResult<ViewResult<F>>;
    /**
     ...
     * ```
     */
    (gellyQuery: string, variables?: Record<string, unknown>, options?: Omit<ReadOperationOptions, "live">): ReadHookResult<ViewResult<ViewFunction<unknown, unknown>>>;
}
