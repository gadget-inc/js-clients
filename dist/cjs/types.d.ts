 ...
 */
export type DefaultSelection<SelectionType extends FieldSelection, Options extends {
    select?: SelectionType | null;
}, Defaults extends SomeFieldsSelected<SelectionType>> = Options["select"] extends SelectionType ? Options["select"] : Defaults;
/**
