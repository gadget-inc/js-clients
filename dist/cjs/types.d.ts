 ...
 * }
 */
export type AvailableSelection<Schema> = Schema extends string | number | bigint | null | undefined ? boolean | null | undefined : Schema extends Array<infer T> ? AvailableSelection<T> : {
    [key in keyof Schema]?: AvailableSelection<Schema[key]>;
};
export type AvailableSelection2<Schema> = Schema extends Array<infer T> ? AvailableSelection2<T> : Schema extends object ? {
