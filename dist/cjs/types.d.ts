...
export type DefaultSelection2<Available extends FieldSelection, Options extends {
...
type InnerSelect2<Schema, Selection extends FieldSelection | null | undefined> = IfAny<Selection, never, Selection extends null | undefined ? never : Schema extends (infer T)[] ? InnerSelect2<T, Selection>[] : Schema extends null ? InnerSelect2<Exclude<Schema, null>, Selection> | null : {
    [Key in keyof Selection & keyof Schema]: Selection[Key] extends true ? Schema[Key] : Selection[Key] extends FieldSelection ? InnerSelect2<Schema[Key], Selection[Key]> : never;
}>;
/**
