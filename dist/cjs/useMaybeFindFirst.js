...
let useMaybeFindFirstImpl = (0, createHooks_js_1.createHookStub)("useMaybeFindFirst");
(0, createHooks_js_1.createHookStub)("useMaybeFindFirst", (adapter, coreHooks) => {
...
const useMaybeFindFirst = (manager, options) => useMaybeFindFirstImpl(manager, options);
