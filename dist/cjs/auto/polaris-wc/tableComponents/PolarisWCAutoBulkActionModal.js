...
const PolarisWCAutoBulkActionModal = (props) => {
    ...
    const modalTitle = (0, react_1.useMemo)(() => (0, utils_js_1.humanizeCamelCase)(modelActionDetails.apiIdentifier).replace("Bulk ", ""), [modelActionDetails.apiIdentifier]);
    return (react_1.default.createElement(PolarisWCModal_js_1.PolarisWCModal, { id: modalId, heading: modalTitle },
        react_1.default.createElement("s-box", { padding: "base" },
            react_1.default.createElement(GadgetBulkActionModalContent, { model: model, modelActionDetails: modelActionDetails, actionLabel: modalTitle, ids: ids, close: clearSelection, modalId: modalId }))));
};
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("s-box", null,
            react_1.default.createElement("s-stack", { direction: "inline", gap: "small", justifyContent: "end" },
                react_1.default.createElement("s-button", { variant: "secondary", commandFor: modalId, command: "--hide", onClick: close }, "Close"),
