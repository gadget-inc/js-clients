...
exports.PolarisWCAutoJSONInput = (0, AutoInput_js_1.autoInput)((props) => {
    ...
    const label = typeof props.label === "string" ? props.label : String(controllerLabel ?? "");
    ...
    return (react_1.default.createElement("s-text-area", { id: id, label: label, value: value ?? "", rows: 4, placeholder: placeholder, disabled: disabled, required: metadata.requiredArgumentForInput, error: displayError, onChange: handleChange, onFocus: handleFocus, onBlur: handleBlur }));
});
