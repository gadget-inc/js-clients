...
exports.PolarisWCAutoPasswordInput = (0, AutoInput_js_1.autoInput)((props) => {
    ...
    if (!isEditing) {
        return (react_1.default.createElement("div", { style: { display: "flex", alignItems: "flex-end", gap: "8px" } },
            react_1.default.createElement(PolarisWCAutoEncryptedStringInput_js_1.PolarisWCAutoEncryptedStringInput, { placeholder: usePasswordController_js_1.existingPasswordPlaceholder, ...props, disabled: true }),
    ...
    return react_1.default.createElement(PolarisWCAutoEncryptedStringInput_js_1.PolarisWCAutoEncryptedStringInput, { placeholder: "Password", ...props });
});
