...
export type PolarisWCAutoTextInputProps = StringOnlyLabel<AutoTextInputProps> & Partial<ComponentProps<"s-text-field">> & Partial<Pick<ComponentProps<"input">, "step" | "min" | "type">>;
