...
exports.PolarisWCAutoFileInput = (0, AutoInput_js_1.autoInput)((props) => {
    ...
    return (react_1.default.createElement("div", { style: { position: "relative" } },
        react_1.default.createElement("s-drop-zone", { accept: validations.onlyImages?.acceptedTypes?.join(","), onChange: handleChange, disabled: disabled, label: label, error: errorMessage, required: metadata.requiredArgumentForInput }, !filePreview && actionHintParts ? (react_1.default.createElement(react_1.default.Fragment, null,
