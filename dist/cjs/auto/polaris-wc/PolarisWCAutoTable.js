...
const PolarisWCAutoTableComponent = (props) => {
    ...
    const { bulkActionOptions } = (0, useTableBulkActions_js_1.useTableBulkActions)({
        model: props.model,
        actions: props.actions,
        excludeActions: props.excludeActions,
    });
    const rawModalIdPrefix = (0, react_1.useId)();
    ...
    const actionModalIds = (0, react_1.useMemo)(() => {
        const ids = {};
    ...
    const gadgetBulkActionOptions = (0, react_1.useMemo)(() => bulkActionOptions.filter((option) => option.selectModelAction), [bulkActionOptions]);
    ...
    return (react_1.default.createElement(AutoTableContext_js_1.AutoTableContext.Provider, { value: [methods, refresh] },
        react_1.default.createElement("s-section", { padding: "none", accessibilityLabel: `${resourceName.plural} table section` },
                    ...
                    (showSearch || showBulkActions) && (react_1.default.createElement("s-grid", { slot: "filters" // Need to use filter slot to properly position this grid in the table container
                        ...
                        showBulkActions && (react_1.default.createElement("div", { style: {
                            ...
                            react_1.default.createElement("s-text", { tone: "neutral" },
                                ...
                                " selected"),
                            react_1.default.createElement(PolarisWCAutoTableBulkActionSelector_js_1.PolarisWCAutoTableBulkActionSelector, { bulkActionOptions: bulkActionOptions, selection: selection, rows: rows ?? [], rawRecords: rawRecords, actionModalIds: actionModalIds }))))),
            ...
            gadgetBulkActionOptions.map((option) => (react_1.default.createElement(PolarisWCAutoBulkActionModal_js_1.PolarisWCAutoBulkActionModal, { key: option.apiIdentifier, model: props.model, modelActionDetails: option.modelActionDetails, ids: selection.recordIds, clearSelection: selection.clearAll, modalId: actionModalIds[option.apiIdentifier] }))),
