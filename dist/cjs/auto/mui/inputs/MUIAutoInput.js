...
const LazyLoadedMUIAutoRichTextInput_js_1 = require("./LazyLoadedMUIAutoRichTextInput.js");
...
exports.MUIAutoInput = (0, AutoInput_js_1.autoInput)((props) => {
    const { metadata } = (0, useFieldMetadata_js_1.useFieldMetadata)(props.field);
    const config = metadata.configuration;
    switch (config.fieldType) {
        case metadata_js_1.FieldType.Id: {
            return react_1.default.createElement(MUIAutoIdInput_js_1.MUIAutoIdInput, { field: props.field, label: props.label });
        }
        ...
        case metadata_js_1.FieldType.Url: {
            return react_1.default.createElement(MUIAutoTextInput_js_1.MUIAutoTextInput, { field: props.field, label: props.label });
        }
        case metadata_js_1.FieldType.EncryptedString: {
            return react_1.default.createElement(MUIAutoEncryptedStringInput_js_1.MUIAutoEncryptedStringInput, { field: props.field, label: props.label });
        }
        case metadata_js_1.FieldType.Password: {
            return react_1.default.createElement(MUIAutoPasswordInput_js_1.MUIAutoPasswordInput, { field: props.field, label: props.label });
        }
        case metadata_js_1.FieldType.Boolean: {
            return react_1.default.createElement(MUIAutoBooleanInput_js_1.MUIAutoBooleanInput, { field: props.field, label: props.label });
        }
        case metadata_js_1.FieldType.DateTime: {
            return react_1.default.createElement(MUIAutoDateTimePicker_js_1.default, { field: props.field, label: props.label });
        }
        case metadata_js_1.FieldType.Json: {
            return react_1.default.createElement(MUIAutoJSONInput_js_1.MUIAutoJSONInput, { field: props.field, label: props.label });
        }
        case metadata_js_1.FieldType.Enum: {
            return react_1.default.createElement(MUIAutoEnumInput_js_1.MUIAutoEnumInput, { field: props.field, label: props.label });
        }
        case metadata_js_1.FieldType.File: {
            return react_1.default.createElement(MUIAutoFileInput_js_1.MUIAutoFileInput, { field: props.field, label: props.label });
        }
        case metadata_js_1.FieldType.RoleAssignments: {
            return react_1.default.createElement(MUIAutoRolesInput_js_1.MUIAutoRolesInput, { field: props.field, label: props.label });
        }
        case metadata_js_1.FieldType.BelongsTo: {
            return react_1.default.createElement(MUIAutoBelongsToInput_js_1.MUIAutoBelongsToInput, { field: props.field, label: props.label });
        }
        ...
        case metadata_js_1.FieldType.HasMany: {
            return react_1.default.createElement(MUIAutoHasManyInput_js_1.MUIAutoHasManyInput, { field: props.field, label: props.label });
        }
        ...
        case metadata_js_1.FieldType.RichText: {
            return react_1.default.createElement(LazyLoadedMUIAutoRichTextInput_js_1.MUIAutoRichTextInput, { field: props.field, label: props.label });
        }
