...
const MUIPasswordInput_js_1 = require("./MUIPasswordInput.js");
...
const MUIAutoInput = (props) => {
    ...
    switch (config.fieldType) {
        ...
        case metadata_js_1.FieldType.EncryptedString: {
            return react_1.default.createElement(MUIEncryptedStringInput_js_1.MUIEncryptedStringInput, { field: props.field });
        }
        case metadata_js_1.FieldType.Password: {
            return react_1.default.createElement(MUIPasswordInput_js_1.MUIPasswordInput, { field: props.field });
        }
        ...
        case metadata_js_1.FieldType.File: {
            return (react_1.default.createElement(exports.MUIAutoFormControl, { ...props },
                react_1.default.createElement(MUIAutoFileInput_js_1.MUIAutoFileInput, { field: props.field })));
        }
