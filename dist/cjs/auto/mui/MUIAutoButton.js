...
const MUIAutoButton = (props) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(lab_1.LoadingButton, { loading: fetching, disabled: fetching, color: isDestructive ? "error" : undefined, onClick: run, ...buttonProps }, label),
