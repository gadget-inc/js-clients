...
const MUIAutoButton = (props) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(lab_1.LoadingButton, { loading: running, disabled: fetching, color: isDestructive ? "error" : undefined, onClick: run, ...buttonProps }, props?.children ?? label),
