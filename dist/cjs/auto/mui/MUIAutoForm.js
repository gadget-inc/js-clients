...
const MUIAutoFormComponent = (props) => {
    ...
    const formContent = props.children ?? (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(material_1.Typography, { variant: "h5" }, humanizedOperationName),
        !props.onSuccess ? react_1.default.createElement(MUISubmitResultBanner_js_1.MUISubmitResultBanner, null) : react_1.default.createElement(MUISubmitResultBanner_js_1.MUISubmitErrorBanner, null),
