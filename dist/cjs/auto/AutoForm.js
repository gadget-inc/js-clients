...
const useAutoForm = (props) => {
    ...
    const isUpsertMetaAction = metadata && (0, metadata_js_1.isModelActionMetadata)(metadata) && fields.some((field) => field.metadata.fieldType === metadata_js_1.FieldType.Id);
