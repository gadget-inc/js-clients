...
const useAutoForm = (props) => {
    ...
    const { submit, error: formError, formState: { isSubmitSuccessful, isLoading, isReady, isSubmitting, touchedFields }, originalFormMethods, } = (0, useActionForm_js_1.useActionForm)(action, {
