...
const useAutoForm = (props) => {
    ...
    const { submit, error: formError, formState: { isSubmitSuccessful, isLoading, isReady, isSubmitting }, originalFormMethods, } = (0, useActionForm_js_1.useActionForm)(action, {
