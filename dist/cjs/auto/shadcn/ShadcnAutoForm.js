...
const makeAutoForm = (elements) => {
    ...
    const { AutoInput, AutoRolesInput, AutoEnumInput, AutoFileInput, AutoJSONInput, AutoDateTimePicker, AutoPasswordInput, AutoBooleanInput, AutoEncryptedStringInput, AutoStringInput, AutoNumberInput, AutoHiddenInput, AutoIdInput, AutoTextAreaInput, AutoBelongsToInput, AutoHasManyInput, AutoHasManyThroughInput, AutoHasOneInput, } = (0, ShadcnAutoInput_js_1.makeShadcnAutoInput)(elements);
