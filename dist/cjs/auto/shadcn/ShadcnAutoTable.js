...
const makeAutoTable = (elements) => {
    ...
    function AutoTableSelectAllCheckbox(props) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Checkbox, { id: "AutoTableSelectAllCheckbox", checked: selection.recordIds.length === rows?.length ? true : selection.recordIds.length > 0 ? "indeterminate" : false, onCheckedChange: (value) => selection.onSelectionChange(useSelectedRecordsController_js_1.SelectionType.Page, !!value), onClick: (e) => e.stopPropagation() })));
    }
    ...
    function AutoTableRowData(props) {
        ...
        return (React.createElement(React.Fragment, null, columns.map((column) => (React.createElement(TableCell, { key: column.identifier, style: { ...defaultTableCellStyle_js_1.defaultCellStyle, ...column.style } }, column.type == "CustomRenderer" ? row[column.identifier] : (React.createElement(ShadcnAutoTableCellRenderer, { column: column, value: row[column.identifier] })))))));
    }
    function ShadcnAutoTableComponent(props) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "sticky flex flex-col gap-2", ref: tableRef },
