    ...
    function ShadcnAutoTableComponent(props) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "sticky flex flex-col gap-2", ref: tableRef },
                ...
                hasSelectedRecords ? (React.createElement("div", { className: "absolute flex flex-row items-center w-[100%] pl-2 z-10" },
                    ...
                    React.createElement("div", { className: "flex flex-row ml-auto gap-2 items-center" },
                        React.createElement(ShadcnAutoTableBulkActionSelector, { bulkActionOptions: bulkActionOptions, selection: selection, rows: rows })))) : searchable ? (React.createElement(ShadcnAutoTableSearch, { search: search })) : null,
