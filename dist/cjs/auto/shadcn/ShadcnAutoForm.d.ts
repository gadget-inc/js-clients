import type { ActionFunction, GlobalActionFunction, OptionsType } from "@gadgetinc/api-client-core";
...
export declare const makeAutoForm: <Elements extends ShadcnElements>(elements: Elements) => {
    ...
    AutoHasManyThroughForm: import("./index.js").AutoInputComponent<import("./index.js").AutoHasManyThroughFormProps>;
