        ...
        return (react_1.default.createElement("div", { style: { maxWidth: "100%" }, ref: containerRef },
            react_1.default.createElement(TooltipProvider, null,
                react_1.default.createElement(Tooltip, null,
                    isOverflowed && (react_1.default.createElement(TooltipContent, { className: "max-w-[150px] max-h-[100px] overflow-y-auto overflow-x-hidden bg-background border border-neutral-300 shadow-md whitespace-normal break-words" }, stringifiedValue)),
