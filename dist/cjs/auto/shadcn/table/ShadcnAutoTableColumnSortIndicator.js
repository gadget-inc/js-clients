...
const makeShadcnAutoTableColumnSortIndicator = (elements) => {
    ...
    const AscendingIndicator = lucide_react_1.ChevronDown;
    const DescendingIndicator = lucide_react_1.ChevronUp;
    function ShadcnAutoTableColumnSortIndicator(props) {
        ...
        return (react_1.default.createElement("div", { onClick: handleSort, className: "cursor-pointer" },
            !isSorted && react_1.default.createElement(UnsortedIndicator, { className: `${iconSizeClass} ${isHovered ? "" : "opacity-0"}` }),
