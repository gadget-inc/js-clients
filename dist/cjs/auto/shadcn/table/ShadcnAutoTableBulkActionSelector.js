...
const makeShadcnAutoTableBulkActionSelector = (elements) => {
    ...
    function NonPromotedActionsActionSelector(props) {
        ...
        return (react_1.default.createElement(Popover, { open: open, onOpenChange: setOpen },
            react_1.default.createElement(PopoverTrigger, { asChild: true },
                react_1.default.createElement(Button, { variant: "outline", role: "combobox", "aria-expanded": open, className: `w-[200px] justify-between ${open ? "ring-ring/50 ring-3" : ""}`, "aria-label": "More actions", onClick: () => setOpen(!open) },
                    "Actions...",
            ...
            react_1.default.createElement(PopoverContent, { className: "w-[200px] p-0" },
                react_1.default.createElement(Command, null,
                    react_1.default.createElement(CommandList, null,
                        react_1.default.createElement(CommandGroup, null, nonPromotedActions.map((action, i) => (react_1.default.createElement(CommandItem, { key: i, className: "bg-background", onSelect: () => {
                                (0, useTableBulkActions_js_1.getBulkActionOptionCallback)({
                                    option: action,
                                    selectedRows,
    ...
    function ShadcnAutoTableBulkActionSelector(props) {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(PromotedActionsActionSelector, { promotedActions: promotedActions, selection: selection, rows: rows, rawRecords: rawRecords }),
            react_1.default.createElement(NonPromotedActionsActionSelector, { nonPromotedActions: nonPromotedActions, selection: selection, rows: rows, rawRecords: rawRecords })));
    }
