...
const makeShadcnAutoDateTimePicker = ({ Button, Calendar, Label, Popover, PopoverTrigger, PopoverContent, }) => {
    function ShadcnAutoDateTimePicker(props) {
        ...
        return (react_1.default.createElement(Popover, { open: isOpen, onOpenChange: setIsOpen },
            react_1.default.createElement(PopoverTrigger, { asChild: true, onClick: (e) => {
                    e.stopPropagation();
                } },
                react_1.default.createElement("div", null,
                    ...
                    react_1.default.createElement(Button, { id: props.id ? `${props.id}-date` : undefined, variant: "outline", type: "button", className: `w-full justify-start text-left font-normal ${!date ? "text-muted-foreground" : ""}` },
            ...
            react_1.default.createElement(PopoverContent, { className: "w-auto p-0" },
                react_1.default.createElement("div", { className: "flex flex-row flex-nowrap" },
                    react_1.default.createElement(Calendar, { mode: "single", defaultMonth: localTime ?? date, selected: localTime ?? date, onSelect: handleDateSelect, initialFocus: true, classNames: {
                            root: "bg-white",
                        } }),
