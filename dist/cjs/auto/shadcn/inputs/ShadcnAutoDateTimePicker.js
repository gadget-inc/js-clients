        ...
        return (react_1.default.createElement(Popover, { open: isOpen, onOpenChange: setIsOpen },
            react_1.default.createElement(PopoverTrigger, { asChild: true },
                react_1.default.createElement("div", { className: "flex flex-col gap-2" },
                    ...
                    react_1.default.createElement(Button, { id: props.id ? `${props.id}-date` : undefined, onClick: () => setIsOpen(!isOpen), variant: "outline", type: "button", className: `w-full justify-start text-left font-normal ${!localTime ? "text-muted-foreground" : ""} ${isOpen ? "ring-ring/50 ring-3" : ""}` },
            ...
            react_1.default.createElement(PopoverContent, { className: "w-auto p-0" },
                react_1.default.createElement("div", { className: "flex flex-row flex-nowrap" },
                    react_1.default.createElement("div", { className: "relative bg-background" },
                        react_1.default.createElement(Calendar, { mode: "single", defaultMonth: localTime, selected: localTime, onSelect: handleDateSelect, autoFocus: true })),
