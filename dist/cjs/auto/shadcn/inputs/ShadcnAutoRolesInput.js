...
const makeShadcnAutoRolesInput = ({ Badge, Button, Command, CommandItem, CommandInput, Label, CommandList, CommandEmpty, CommandGroup, Checkbox, ScrollArea, CommandLoading, Input, Popover, PopoverContent, PopoverTrigger, }) => {
    const { SelectedRecordTags } = (0, SelectedRelatedRecordTags_js_1.makeSelectedRecordTags)({ Badge, Button });
    const ComboInput = (0, ShadcnAutoComboInput_js_1.makeShadcnAutoComboInput)({
        Command,
        CommandInput,
        CommandLoading,
        Label,
    ...
    function AutoRolesInput(props) {
        ...
        return (react_1.default.createElement(ComboInput, { ...props, options: roleOptions, path: fieldProps.name, metadata: metadata, selectedRecordTag: react_1.default.createElement(SelectedRecordTags, { selectedRecords: selectedOptions, optionLabel: "label", onRemoveRecord: (option) => {
    ...
    return (0, AutoInput_js_1.autoInput)(AutoRolesInput);
};
