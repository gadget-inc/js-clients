                    ...
                    hasRecord && (react_1.default.createElement(DropdownMenu, { open: actionsOpen, onOpenChange: setActionsOpen },
                        ...
                        react_1.default.createElement(DropdownMenuContent, { className: "bg-white" },
                            ...
                            react_1.default.createElement(DropdownMenuItem, { value: "remove", onSelect: () => {
                                ...
                                "Remove ",
                                relatedModelName.toLocaleLowerCase()))))),
                hasRecord ? (react_1.default.createElement("div", { className: "flex flex-col gap-2" },
                    ...
                    recordOption.secondaryLabel && renderOptionLabel(recordOption.secondaryLabel, "secondary"))) : (react_1.default.createElement(SearchableSingleRelatedModelRecordSelector, { form: form, field: field }))),
