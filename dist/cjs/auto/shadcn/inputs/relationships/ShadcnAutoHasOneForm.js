...
const makeShadcnAutoHasOneForm = ({ Badge, Button, Command, CommandItem, CommandInput, Label, CommandList, CommandEmpty, CommandGroup, Checkbox, Accordion, AccordionItem, AccordionTrigger, }) => {
                ...
                hasRecord || isCreatingRecord ? (react_1.default.createElement(Accordion, { type: "single", collapsible: true, className: "w-full" }, !isEditing ? (react_1.default.createElement(AccordionItem, { value: `${pathPrefix}.${record?.id ? `update-${record.id}` : `create`}` },
                    react_1.default.createElement(AccordionTrigger, { onClick: (e) => {
                        ...
                        react_1.default.createElement("div", { className: "flex justify-between w-full items-center" },
                            ...
                            recordOption?.tertiaryLabel && (react_1.default.createElement("div", { className: "flex items-center" }, renderOptionLabel(recordOption?.tertiaryLabel, "tertiary"))))))) : (react_1.default.createElement(react_1.default.Fragment, null,
