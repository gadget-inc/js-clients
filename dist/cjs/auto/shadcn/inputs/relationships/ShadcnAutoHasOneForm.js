...
const makeShadcnAutoHasOneForm = ({ Badge, Button, Command, CommandItem, CommandInput, Label, CommandList, CommandEmpty, CommandGroup, Checkbox, }) => {
    ...
    function ButtonWithLabel(props) {
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(Button, { type: "button", variant: "outline", className: `flex w-full h-fit justify-start gap-2 border border-gray-300 rounded-md px-4 py-3 cursor-pointer`, onClick: props.onClick }, props.children)));
    }
