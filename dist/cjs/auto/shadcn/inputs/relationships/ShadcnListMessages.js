...
const makeShadcnListMessages = ({ CommandEmpty, CommandItem, Checkbox, Label, }) => {
    ...
    function ShadcnSelectableOption(props) {
        ...
        if (typeof label === "string") {
            return (react_1.default.createElement(CommandItem, { key: id, id: id, selected: selected, className: className, onMouseDown: (e) => {
                    e.preventDefault();
                    e.stopPropagation();
                }, onSelect: () => {
                    onSelect?.(id);
    ...
    function ListMessage(props) {
        ...
        return (react_1.default.createElement(CommandEmpty, { onMouseDown: (e) => {
                onSelect?.();
            } }, message));
    }
    return {
