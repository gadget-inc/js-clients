                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(Popover, { open: open, onOpenChange: setOpen },
                        react_1.default.createElement(PopoverTrigger, { asChild: true },
                            react_1.default.createElement("div", null,
                                react_1.default.createElement(Button, { type: "button", variant: "outline", role: "combobox", onClick: () => setOpen(!open), "aria-expanded": open, "aria-controls": listboxId, className: `w-[300px] flex flex-row items-center justify-between cursor-pointer ${open ? "bg-accent" : ""}` },
                                    react_1.default.createElement(Label, { className: "truncate flex-grow text-left cursor-pointer" },
                                        "Add ",
                    ...
                    react_1.default.createElement("div", { className: "flex flex-col w-full" },
                        react_1.default.createElement("div", { className: "flex-1 p-2" },
                            react_1.default.createElement("div", { className: "flex justify-between items-center w-full" },
                                ...
                                react_1.default.createElement(Button, { id: `deleteButton_${pathPrefix}.${idx}`, className: "ml-auto", variant: "ghost", type: "button", size: "icon", onClick: () => remove(idx) },
