...
const makeShadcnAutoHasManyThroughForm = ({ Badge, Button, Label, Command, CommandInput, CommandItem, CommandList, CommandEmpty, CommandGroup, Checkbox, Popover, PopoverContent, PopoverTrigger, }) => {
    ...
    const SiblingOption = (props) => {
        ...
        return (react_1.default.createElement(CommandItem, { onSelect: () => {
            ...
            react_1.default.createElement("div", { className: "flex justify-between items-center w-full cursor-pointer" },
                react_1.default.createElement("div", { className: "flex flex-row items-center gap-2 cursor-pointer" },
                    renderOptionLabel(option.primary, "primary", true),
                    option.secondary && renderOptionLabel(option.secondary, "secondary", true)),
                react_1.default.createElement(lucide_react_1.PlusIcon, { className: "w-4 h-4 shrink-0 cursor-pointer" }))));
    };
    function ShadcnAutoHasManyThroughForm(props) {
        const [open, setOpen] = (0, react_1.useState)(false);
        const { field, append, remove, joinRecords, metadata, listboxId, pathPrefix, metaDataPathPrefix, recordLabel, siblingModelName, siblingRecordsLoading, siblingRecords, siblingPagination, search, joinModelField, joinModelApiIdentifier, siblingModelOptions, inverseRelatedModelField, fieldArray, } = (0, useHasManyThroughForm_js_1.useHasManyThroughForm)(props);
        ...
        return (react_1.default.createElement("div", { className: "flex flex-col gap-2 " },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(Popover, { open: open, onOpenChange: setOpen },
                        react_1.default.createElement(PopoverTrigger, { asChild: true },
                            react_1.default.createElement("div", null,
                                react_1.default.createElement(Button, { type: "button", variant: "outline", role: "combobox", onClick: () => setOpen(!open), "aria-expanded": open, "aria-controls": listboxId, className: `w-[300px] flex flex-row items-center justify-between cursor-pointer ${open ? "bg-accent ring-ring/50 ring-3" : ""}` },
                                    react_1.default.createElement(Label, { className: "truncate grow text-left cursor-pointer" },
                                        "Add ",
                                        siblingModelName ?? "related model"),
                                    react_1.default.createElement(lucide_react_1.ChevronsUpDown, { className: "opacity-50 w-5 h-5 shrink-0" })))),
                        react_1.default.createElement(PopoverContent, { className: "w-[300px] bg-background p-0" },
            ...
            joinRecords.length > 0 ? (react_1.default.createElement("div", { className: "flex flex-col gap-3" }, joinRecords.map(([fieldKey, idx, record]) => {
                ...
                return (react_1.default.createElement("div", { className: "flex items-center w-full border rounded-md ", key: fieldKey },
                    react_1.default.createElement("div", { className: "flex flex-col w-full" },
                        react_1.default.createElement("div", { className: "flex-1 p-2" },
                            react_1.default.createElement("div", { className: "flex justify-between items-center w-full" },
                                ...
                                react_1.default.createElement("div", { className: "flex items-start self-start" },
                                    react_1.default.createElement(Button, { id: `deleteButton_${pathPrefix}.${idx}`, className: "p-0 h-4.5 w-4.5 rounded-sm shrink-0", variant: "ghost", type: "button", size: "icon", onClick: () => remove(idx) },
                                        react_1.default.createElement(lucide_react_1.X, { className: "w-4 h-4" }))))),
                        props.children && (react_1.default.createElement("div", { className: "flex-1 p-2 border-t", onClick: (e) => {
                                e.stopPropagation();
                                e.preventDefault();
                            } },
            ...
            }))) : (react_1.default.createElement("div", { className: "flex items-center justify-center border rounded-md p-2 mt-4" },
