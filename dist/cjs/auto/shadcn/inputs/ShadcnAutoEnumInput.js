...
const makeShadcnAutoEnumInput = ({ Badge, Button, Command, CommandItem, CommandInput, Label, CommandList, CommandEmpty, CommandGroup, Checkbox, }) => {
    ...
    function ShadcnAutoEnumInput(props) {
        ...
        return (react_1.default.createElement(ShadcnComboInput, { ...props, options: filteredOptions.map((option) => ({ id: option, label: option })), path: labelProp ?? label, metadata: metadata, label: labelProp ?? label, onChange: debouncedSearch, selectedRecordTag: selectedTagsElement, onSelect: (option) => {
