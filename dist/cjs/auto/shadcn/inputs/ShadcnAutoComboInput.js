        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("div", { className: `relative ${open ? "ring-1 ring-ring rounded-md border" : "border rounded-md"}` },
                ...
                react_1.default.createElement(Command, { className: "overflow-visible z-50 h-[300px]" },
                    react_1.default.createElement(CommandInput, { name: props.path, ref: inputRef, id: id, value: inputValue, onValueChange: setInputValue, onBlur: () => setOpen(false), onFocus: () => setOpen(true), placeholder: "Search", className: "ml-2 bg-transparent outline-none placeholder:text-muted-foreground flex-1" }),
