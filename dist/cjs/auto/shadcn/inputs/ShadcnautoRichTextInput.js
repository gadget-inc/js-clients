...
const AutoRichTextInput_js_1 = require("../../shared/AutoRichTextInput.js");
...
const AutoRichTextInput = react_1.default.lazy(() => Promise.resolve().then(() => tslib_1.__importStar(require("../../shared/AutoRichTextInput.js"))).catch((error) => {
