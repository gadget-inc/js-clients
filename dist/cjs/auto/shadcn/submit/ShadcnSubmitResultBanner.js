...
const makeSubmitResultBanner = ({ Alert, AlertTitle, AlertDescription, Button, }) => {
    ...
    const ShadcnSubmitSuccessfulBanner = (props) => {
    ...
    const ShadcnSubmitErrorBanner = (props) => {
    ...
    const ShadcnSubmitResultBanner = (props) => {
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(ShadcnSubmitSuccessfulBanner, { ...props.successBannerProps }),
            react_1.default.createElement(ShadcnSubmitErrorBanner, { ...props.errorBannerProps })));
    };
    return {
