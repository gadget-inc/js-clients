...
const PolarisAutoButton = (props) => {
    ...
    return (react_1.default.createElement(polaris_1.Button, { loading: fetching, disabled: fetching, tone: isDestructive ? "critical" : undefined, onClick: run, ...buttonProps }, label));
};
