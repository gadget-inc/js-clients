...
props) => {
    ...
    const humanizedOperationName = (0, react_1.useMemo)(() => (0, utils_js_1.humanizeCamelCase)(action.operationName), [action.operationName]);
    ...
    const formContent = props.children ?? (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(polaris_1.Text, { variant: "headingLg", as: "h5" }, humanizedOperationName),
        ...
        !metadataError && (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement("div", null,
                react_1.default.createElement(PolarisAutoSubmit_js_1.PolarisAutoSubmit, { isSubmitting: isSubmitting }, props.submitLabel ?? "Submit"))))));
    return (react_1.default.createElement(react_1.Suspense, { fallback: react_1.default.createElement(exports.PolarisFormSkeleton, null) },
        react_1.default.createElement(AutoFormContext_js_1.AutoFormMetadataContext.Provider, { value: autoFormMetadataContext },
