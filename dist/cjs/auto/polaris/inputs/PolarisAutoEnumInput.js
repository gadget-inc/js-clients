...
const PolarisAutoEnumInput = (props) => {
    ...
    return (react_1.default.createElement(polaris_1.Combobox, { allowMultiple: allowMultiple, activator: react_1.default.createElement(polaris_1.Combobox.TextField, { autoComplete: "off", prefix: react_1.default.createElement(polaris_1.Icon, { source: polaris_icons_1.SearchIcon }), label: inputLabel, value: searchValue, placeholder: "Search", verticalContent: selectedTagsElement, onChange: setSearchValue, id: `${props.field}-combobox-textfield`, error: isError, helpText: errorMessage }), ...comboboxProps }, listBoxElement));
};
