...
const PolarisAutoRolesInput = (props) => {
    ...
    return (react_1.default.createElement(PolarisFixedOptionsCombobox_js_1.PolarisFixedOptionsCombobox, { options: options, allowMultiple: true, label: metadata.name, ...fieldProps, value: selectedRoleKeys, loading: loading }));
};
