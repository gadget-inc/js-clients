...
const PolarisAutoRolesInput = (props) => {
    ...
    return (react_1.default.createElement(PolarisFixedOptionsCombobox_js_1.PolarisFixedOptionsCombobox, { options: options, allowMultiple: true, label: metadata.name, ...(0, utils_js_1.getPropsWithoutRef)(fieldProps), value: selectedRoleKeys }));
};
