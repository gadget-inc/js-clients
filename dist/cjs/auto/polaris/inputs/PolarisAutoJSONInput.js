...
const PolarisAutoJSONInput = (props) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(polaris_1.TextField, { multiline: 4, monospaced: true, error: !isFocused && errorMessage && `Invalid JSON: ${errorMessage}`, ...(0, utils_js_1.getPropsWithoutRef)(controller), ...(0, utils_js_1.getPropsWithoutRef)(focusProps), ...restOfProps })));
};
