...
const PolarisAutoTimePicker = (props) => {
    ...
    const [timeString, setTimeString] = (0, react_1.useState)(props.localTime ? (0, dateTimeUtils_js_1.getTimeString)((0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(props.localTime)) : "");
    ...
    const setHourSelected = (hour) => {
        if (valueProp) {
            props.onChange?.((0, dateTimeUtils_js_1.getDateFromDateTimeObject)({ ...(0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(valueProp), hour }));
            return;
        }
        props.fieldProps.onChange((0, dateTimeUtils_js_1.getDateFromDateTimeObject)({ ...(0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(props.fieldProps.value ?? new Date()), hour }));
    };
    const setMinSelected = (minute) => {
        if (valueProp) {
            props.onChange?.((0, dateTimeUtils_js_1.getDateFromDateTimeObject)({ ...(0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(valueProp), minute }));
            return;
        }
        props.fieldProps.onChange((0, dateTimeUtils_js_1.getDateFromDateTimeObject)({ ...(0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(props.fieldProps.value ?? new Date()), minute }));
    };
    const setAmpmSelected = (ampm) => {
        if (valueProp) {
            props.onChange?.((0, dateTimeUtils_js_1.getDateFromDateTimeObject)({ ...(0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(valueProp), ampm }));
            return;
        }
        props.fieldProps.onChange((0, dateTimeUtils_js_1.getDateFromDateTimeObject)({ ...(0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(props.fieldProps.value ?? new Date()), ampm }));
    };
    const onTimeStringChange = (value) => {
        ...
        (0, dateTimeUtils_js_1.copyTime)(date, parsedDate);
    ...
    const hourTimeFormatter = (value) => {
        ...
        return `${value}:${defaultValue ? (0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(defaultValue).minute.toString().padStart(2, "0") : minsArr[0]} ${defaultValue ? (0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(defaultValue).ampm : ampmArr[0]}`;
    };
    const minTimeFormatter = (value) => {
        const defaultValue = valueProp ?? props.fieldProps.value;
        return `${defaultValue ? (0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(defaultValue).hour : hoursArr[0]}:${value.padStart(2, "0")} ${defaultValue ? (0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(defaultValue).ampm : ampmArr[0]}`;
    };
    const ampmTimeFormatter = (value) => {
        const defaultValue = valueProp ?? props.fieldProps.value;
        return `${defaultValue ? (0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(defaultValue).hour : hoursArr[0]}:${defaultValue ? (0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(defaultValue).minute.toString().padStart(2, "0") : minsArr[0]} ${value}`;
    };
    const hourProps = {
        array: hoursArr,
    ...
    (0, react_1.useEffect)(() => {
        if (!props.fieldProps.value || valueProp)
            return;
        setTimeString((0, dateTimeUtils_js_1.getTimeString)((0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(new Date(props.fieldProps.value))));
            ...
            react_1.default.createElement(polaris_1.Popover.Pane, { fixed: true }, !props.hideTimePopover && (react_1.default.createElement("div", { style: { overflow: "hidden", padding: "15px 8px" } },
                react_1.default.createElement("div", { style: { display: "flex" } }, [hourProps, minProps, ampmProps].map((timeComponentProps, i) => (react_1.default.createElement(polaris_1.Scrollable, { key: i, style: { overflowY: "scroll", height: "250px" } },
                    react_1.default.createElement(polaris_1.Listbox, { onSelect: (value) => onTimeStringChange(timeComponentProps.formatter(value)) }, createMarkup(timeComponentProps.array, valueProp
                        ? `${(0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(valueProp)[timeComponentProps.key]}`
                        : props.fieldProps.value
                            ? `${(0, dateTimeUtils_js_1.getDateTimeObjectFromDate)(new Date(props.fieldProps.value))[timeComponentProps.key]}`
