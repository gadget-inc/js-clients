...
const PolarisHasManyInput = (props) => {
    ...
    const textField = (react_1.default.createElement(polaris_1.Autocomplete.TextField, { onChange: updateText, label: metadata.name, value: inputValue, verticalContent: verticalContentMarkup, autoComplete: "off" }));
