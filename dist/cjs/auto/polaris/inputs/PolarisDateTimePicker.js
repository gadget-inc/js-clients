...
const PolarisDateTimePicker = (props) => {
    ...
    return (react_1.default.createElement(polaris_1.InlineStack, { gap: "400" },
        ...
        (props.includeTime ?? config.includeTime) && (react_1.default.createElement(PolarisTimePicker_js_1.default, { field: props.field, dateTimeState: dateTimeState, setDateTimeState: setDateTimeState, id: props.id, localTime: localTime, onChange: onChange, hideTimePopover: props.hideTimePopover, localTz: localTz, timePickerProps: props.timePickerProps }))));
};
