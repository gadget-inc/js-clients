...
exports.PolarisAutoHasOneForm = (0, AutoInput_js_1.autoInput)((props) => {
    const { field } = props;
    const { pathPrefix, path, metadata } = (0, useAutoRelationship_js_1.useAutoRelationship)({ field });
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(polaris_1.BlockStack, { gap: "300" },
            react_1.default.createElement(polaris_1.InlineGrid, { columns: "1fr auto" },
                react_1.default.createElement(polaris_1.Text, { as: "h2", variant: "headingSm" }, childName),
            ...
            hasRecord ? (props.renderSelectedRecord ? (props.renderSelectedRecord(record)) : (react_1.default.createElement(polaris_1.InlineStack, { align: "space-between" },
                ...
                recordOption.tertiaryLabel && (0, utils_js_2.renderOptionLabel)(recordOption.tertiaryLabel, "tertiary")))) : (react_1.default.createElement(RelatedModelOptions_js_1.RelatedModelOptionsPopover, { active: searchOpen, activator: react_1.default.createElement(RelatedModelOptions_js_1.RelatedModelOptionsSearch, { modelName: childName, value: search.value, onChange: search.set, onFocus: () => setSearchOpen(true) }), onClose: () => setSearchOpen(false), onScrolledToBottom: pagination.loadNextPage, actions: [
