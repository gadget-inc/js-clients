...
const PolarisAutoBelongsToInput = (props) => {
    const { fieldMetadata: { path, metadata }, relatedModelOptions: { options, searchFilterOptions, pagination, search }, isLoading, errorMessage, selectedRecordId, retrievedSelectedRecordIdExists, onSelectRecord, onRemoveRecord, } = (0, useBelongsToInputController_js_1.useBelongsToInputController)(props);
    ...
    const selectedRecordTag = selectedRecordId ? (react_1.default.createElement(polaris_1.Tag, { onRemove: onRemoveRecord, key: `selectedRecordTag_${selectedRecordId}` },
        react_1.default.createElement("p", { style: { color: !retrievedSelectedRecordIdExists ? "red" : undefined }, id: `${selectedRecordId}_${selectedRecordLabel}` }, selectedRecordLabel))) : null;
