...
exports.PolarisAutoHasManyThroughRelationshipForm = void 0;
...
exports.PolarisAutoHasManyThroughRelationshipForm = (0, AutoInput_js_1.autoInput)((props) => {
    const { field, children } = props;
    const { pathPrefix, metadata } = (0, useAutoRelationship_js_1.useAutoRelationship)({ field });
    ...
    return (react_1.default.createElement(polaris_1.BlockStack, { gap: "200" },
        react_1.default.createElement(polaris_1.InlineGrid, { columns: "1fr auto" },
            react_1.default.createElement(polaris_1.Text, { as: "h2", variant: "headingSm" }, siblingModelName),
            react_1.default.createElement(RelatedModelOptions_js_1.RelatedModelOptionsPopover, { active: addingSibling, activator: react_1.default.createElement(polaris_1.Button, { onClick: () => setAddingSibling((prev) => !prev), disclosure: true },
                ...
                }, isLoading: siblingRecordsLoading, autoSelection: polaris_1.AutoSelection.None, renderOption: (option) => (react_1.default.createElement(polaris_1.Listbox.Action, { key: option.id, value: option.id },
                ...
                react_1.default.createElement(polaris_1.InlineGrid, { columns: "1fr auto", gap: "200", alignItems: "center" },
                    react_1.default.createElement(polaris_1.Box, { borderColor: "border", borderWidth: "025", borderRadius: "200" },
                        react_1.default.createElement(polaris_1.Box, { padding: "200" },
                            react_1.default.createElement(polaris_1.InlineGrid, { columns: "1fr 1fr 1fr" },
                    ...
                    react_1.default.createElement(polaris_1.Box, null,
                        react_1.default.createElement(polaris_1.Button, { variant: "tertiary", icon: polaris_icons_1.XCircleIcon, onClick: () => {
                                remove(idx);
                            } })))));
        }))) : (react_1.default.createElement(polaris_1.Box, { borderColor: "border", borderWidth: "025", borderRadius: "200" },
