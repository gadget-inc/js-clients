...
exports.PolarisAutoBelongsToForm = (0, AutoInput_js_1.autoInput)((props) => {
    const { field } = props;
    const { pathPrefix, path, metadata } = (0, useAutoRelationship_js_1.useAutoRelationship)({ field });
    const { setValue, getValues } = (0, useActionForm_js_1.useFormContext)();
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(polaris_1.BlockStack, { gap: "300" },
            ...
            hasRecord ? (props.renderParent ? (props.renderParent(record)) : (react_1.default.createElement(polaris_1.InlineStack, { align: "space-between" },
