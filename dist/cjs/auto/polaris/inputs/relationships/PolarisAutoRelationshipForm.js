...
exports.PolarisAutoRelationshipForm = (0, AutoInput_js_1.autoInput)((props) => {
    ...
    if (metadata.configuration.__typename === "GadgetBelongsToConfig") {
        ...
        return (react_1.default.createElement(PolarisAutoHasManyRelationshipForm, { field: field, pathPrefix: pathPrefix, primaryLabel: props.primaryLabel, secondaryLabel: props.secondaryLabel }, props.children));
    }
    else {
        return null;
    }
        ...
        react_1.default.createElement(polaris_1.BlockStack, { as: "ul" },
            fields.flatMap((field, idx) => {
                ...
                return (react_1.default.createElement(polaris_1.Box, { key: field._fieldArrayKey, borderColor: "border", borderBlockEndWidth: "025" }, editingIndex == idx ? (react_1.default.createElement(polaris_1.Box, { padding: "300" },
                    ...
                    react_1.default.createElement(polaris_1.Text, { variant: "bodyMd", as: "p", tone: "subdued" }, secondary ?? react_1.default.createElement("span", { style: { visibility: "hidden" } }, "\u00A0")))) : (react_1.default.createElement(polaris_1.Text, { variant: "bodyMd", as: "h3", tone: "subdued" }, "Click to edit..."))))));
            }),
