...
exports.PolarisAutoHasManyRelationshipForm = void 0;
...
exports.PolarisAutoHasManyRelationshipForm = (0, AutoInput_js_1.autoInput)((props) => {
    const { field } = props;
    ...
    const { fieldArray, fieldArrayPath } = (0, useHasManyController_js_1.useHasManyController)({ field });
                ...
                return (react_1.default.createElement(polaris_1.Box, { key: field._fieldArrayKey, borderColor: "border", borderBlockEndWidth: "025" }, editingIndex == idx ? (react_1.default.createElement(polaris_1.Box, { padding: "300" },
                    react_1.default.createElement(polaris_1.BlockStack, { gap: "300" },
                        ...
                        react_1.default.createElement(polaris_1.InlineStack, { align: "space-between" },
                            ...
                            react_1.default.createElement(polaris_1.Button, { variant: "primary", onClick: () => setEditingIndex(null) }, "Confirm"))))) : (react_1.default.createElement(polaris_1.ResourceItem, { id: option.id, name: option.label?.toString() ?? option.id, onClick: () => setEditingIndex(idx) }, option.label ? (react_1.default.createElement(polaris_1.InlineStack, { align: "space-between" },
