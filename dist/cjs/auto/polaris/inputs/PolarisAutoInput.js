...
const PolarisAutoRichTextInput_js_1 = tslib_1.__importDefault(require("./PolarisAutoRichTextInput.js"));
const PolarisAutoInput = (props) => {
    ...
    switch (config.fieldType) {
        ...
        case metadata_js_1.FieldType.RichText: {
            return react_1.default.createElement(PolarisAutoRichTextInput_js_1.default, { field: props.field });
        }
