...
const PolarisAutoRichTextInput = react_1.default.lazy(() => Promise.resolve().then(() => tslib_1.__importStar(require("./PolarisAutoRichTextInput.js"))));
const PolarisAutoInput = (props) => {
    ...
    switch (config.fieldType) {
        case metadata_js_1.FieldType.Id: {
            return react_1.default.createElement(PolarisAutoIdInput_js_1.PolarisAutoIdInput, { field: props.field });
        }
        ...
        case metadata_js_1.FieldType.Number: {
            return react_1.default.createElement(PolarisAutoNumberInput_js_1.PolarisAutoNumberInput, { field: props.field });
        }
        ...
        case metadata_js_1.FieldType.Enum: {
            return react_1.default.createElement(PolarisAutoEnumInput_js_1.PolarisAutoEnumInput, { field: props.field });
        }
        ...
        case metadata_js_1.FieldType.RoleAssignments: {
            return react_1.default.createElement(PolarisAutoRolesInput_js_1.PolarisAutoRolesInput, { field: props.field });
        }
        case metadata_js_1.FieldType.BelongsTo: {
            return react_1.default.createElement(PolarisAutoBelongsToInput_js_1.PolarisAutoBelongsToInput, { field: props.field });
        }
        ...
        case metadata_js_1.FieldType.HasMany: {
            return react_1.default.createElement(PolarisAutoHasManyInput_js_1.PolarisAutoHasManyInput, { field: props.field });
        }
        ...
        case metadata_js_1.FieldType.RichText: {
            return react_1.default.createElement(PolarisAutoRichTextInput, { field: props.field });
        }
