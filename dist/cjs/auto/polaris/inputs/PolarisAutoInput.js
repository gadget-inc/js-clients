...
const PolarisEncryptedStringInput_js_1 = require("./PolarisEncryptedStringInput.js");
const PolarisPasswordInput_js_1 = require("./PolarisPasswordInput.js");
const PolarisAutoInput = (props) => {
    ...
    switch (config.fieldType) {
        ...
        case metadata_js_1.FieldType.EncryptedString: {
            return react_1.default.createElement(PolarisEncryptedStringInput_js_1.PolarisEncryptedStringInput, { field: props.field });
        }
        case metadata_js_1.FieldType.Password: {
            return react_1.default.createElement(PolarisPasswordInput_js_1.PolarisPasswordInput, { field: props.field });
        }
        ...
        case metadata_js_1.FieldType.DateTime: {
            return react_1.default.createElement(PolarisDateTimePicker_js_1.PolarisDateTimePicker, { field: props.field });
        }
