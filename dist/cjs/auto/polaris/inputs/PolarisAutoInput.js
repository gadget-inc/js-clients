...
const PolarisAutoHasManyThroughInput_js_1 = require("./relationships/PolarisAutoHasManyThroughInput.js");
const PolarisAutoHasOneInput_js_1 = require("./relationships/PolarisAutoHasOneInput.js");
exports.PolarisAutoInput = (0, AutoInput_js_1.autoInput)((props) => {
    ...
    switch (config.fieldType) {
        ...
        case metadata_js_1.FieldType.HasOne: {
            return react_1.default.createElement(PolarisAutoHasOneInput_js_1.PolarisAutoHasOneInput, { field: props.field, label: props.label });
        }
        ...
        case metadata_js_1.FieldType.HasManyThrough: {
            return react_1.default.createElement(PolarisAutoHasManyThroughInput_js_1.PolarisAutoHasManyThroughInput, { field: props.field, label: props.label });
        }
