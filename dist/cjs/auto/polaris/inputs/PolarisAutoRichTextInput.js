...
require("../../shared/styles/mdxeditor/style.css");
function PolarisAutoRichTextInput(props) {
    ...
    return (react_1.default.createElement("div", { className: "Polaris-FormLayout__Item" },
        react_1.default.createElement("div", { className: "Polaris-Labelled__LabelWrapper" },
            react_1.default.createElement(polaris_1.Label, { id: controller.id, requiredIndicator: controller.metadata.requiredArgumentForInput }, controller.metadata.name)),
