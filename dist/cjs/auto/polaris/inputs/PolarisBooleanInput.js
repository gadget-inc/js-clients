...
const PolarisBooleanInput = (props) => {
    ...
    return (react_1.default.createElement(polaris_1.Checkbox, { label: metadata.name, checked: !!fieldProps.value, onChange: fieldProps.onChange, onBlur: fieldProps.onBlur, disabled: fieldProps.disabled, name: fieldProps.name, error: error?.message, ...rest }));
};
