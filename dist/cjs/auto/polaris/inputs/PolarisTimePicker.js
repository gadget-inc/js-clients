...
const PolarisTimePicker = (props) => {
    ...
    const [timeString, setTimeString] = (0, react_1.useState)(props.localTime ? (0, date_fns_1.format)(props.localTime, "K:m aa") : "");
