...
const PolarisTimePicker = (props) => {
    console.log("fieldProps", props.fieldProps.value);
    console.log("localTime", props.localTime);
    const [timeString, setTimeString] = (0, react_1.useState)(props.localTime ? getTimeString((0, PolarisDateTimePicker_js_1.getDateTimeObjectFromDate)(props.localTime)) : "");
    ...
    const hourTimeFormatter = (value) => {
        return `${value}:${props.fieldProps.value ? (0, PolarisDateTimePicker_js_1.getDateTimeObjectFromDate)(props.fieldProps.value).minute.toString().padStart(2, "0") : minsArr[0]} ${props.fieldProps.value ? (0, PolarisDateTimePicker_js_1.getDateTimeObjectFromDate)(props.fieldProps.value).ampm : ampmArr[0]}`;
    };
    const minTimeFormatter = (value) => {
        return `${props.fieldProps.value ? (0, PolarisDateTimePicker_js_1.getDateTimeObjectFromDate)(props.fieldProps.value).hour : hoursArr[0]}:${value.padStart(2, "0")} ${props.fieldProps.value ? (0, PolarisDateTimePicker_js_1.getDateTimeObjectFromDate)(props.fieldProps.value).ampm : ampmArr[0]}`;
    };
    const ampmTimeFormatter = (value) => {
        return `${props.fieldProps.value ? (0, PolarisDateTimePicker_js_1.getDateTimeObjectFromDate)(props.fieldProps.value).hour : hoursArr[0]}:${props.fieldProps.value ? (0, PolarisDateTimePicker_js_1.getDateTimeObjectFromDate)(props.fieldProps.value).minute.toString().padStart(2, "0") : minsArr[0]} ${value}`;
    };
        ...
        react_1.default.createElement(polaris_1.Popover, { active: timePopoverActive, onClose: () => setTimePopoverActive(false), activator: react_1.default.createElement(polaris_1.TextField, { prefix: react_1.default.createElement(polaris_1.Icon, { source: polaris_icons_1.ClockIcon }), id: props.id ? `${props.id}-time` : undefined, "data-testid": props.id ? `${props.id}-time` : undefined, label: props.timePickerProps?.label ?? "Time", autoComplete: "off", value: timeString, onChange: onTimeStringChange, onFocus: () => setTimePopoverActive(true), error: timeParseError && `Invalid time format`, ...props.timePickerProps }) }, !props.hideTimePopover && (react_1.default.createElement("div", { style: { overflow: "hidden", padding: "15px 8px" } },
            react_1.default.createElement("div", { style: { display: "flex" } }, [hourProps, minProps, ampmProps].map((timeComponentProps, i) => (react_1.default.createElement(polaris_1.Scrollable, { key: i, style: { overflowY: "scroll", height: "250px" } },
                react_1.default.createElement(polaris_1.Listbox, { onSelect: (value) => onTimeStringChange(timeComponentProps.formatter(value)) }, createMarkup(timeComponentProps.array, props.fieldProps.value
                    ? `${(0, PolarisDateTimePicker_js_1.getDateTimeObjectFromDate)(props.fieldProps.value)[timeComponentProps.key]}`
