...
const PolarisAutoJSONInput = (props) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(polaris_1.TextField, { multiline: 4, monospaced: true, ...(0, utils_js_1.getPropsWithoutRef)(restOfOriginalController), value: stringValue, onChange: onStringValueChange, error: !isFocused && error && `Invalid JSON: ${error.message}`, ...(0, utils_js_1.getPropsWithoutRef)(focusProps), ...restOfProps })));
};
