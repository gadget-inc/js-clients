...
const PolarisAutoTableComponent = (props) => {
    ...
    const [sortColumnApiIdentifier, setSortColumnApiIdentifier] = (0, react_1.useState)(props.initialSort ? Object.keys(props.initialSort)[0] : undefined);
    const [sortDirection, setSortDirection] = (0, react_1.useState)(props.initialSort ? Object.values(props.initialSort)[0] : undefined);
    ...
    return (react_1.default.createElement(polaris_1.BlockStack, null,
        ...
        react_1.default.createElement("button", { onClick: () => refresh }, "Refresh table")));
};
