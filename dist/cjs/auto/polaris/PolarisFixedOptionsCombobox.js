...
const PolarisFixedOptionsCombobox = (props) => {
    ...
    const textField = (react_1.default.createElement(polaris_1.Autocomplete.TextField, { onChange: updateText, label: label, value: inputValue, verticalContent: verticalContentMarkup, placeholder: placeholder, autoComplete: "off", id: `${label}_Autocomplete_Textfield` }));
    return (react_1.default.createElement(polaris_1.Autocomplete, { options: options, ...rest, selected: selectedValues, onSelect: updateSelection, textField: textField, id: `${label}_Autocomplete`, allowMultiple: allowMultiple }));
};
