...
const PolarisFixedOptionsCombobox = (props) => {
    ...
    const textField = (react_1.default.createElement(polaris_1.Autocomplete.TextField, { onChange: updateText, label: label, value: inputValue, verticalContent: verticalContentMarkup, placeholder: "Search", autoComplete: "off", id: `${label}_Autocomplete_Textfield` }));
