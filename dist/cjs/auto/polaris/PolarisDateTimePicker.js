...
const PolarisDateTimePicker = (props) => {
    ...
    return (react_1.default.createElement(polaris_1.InlineStack, { gap: "400" },
        ...
        props.includeTime && (react_1.default.createElement(polaris_1.TextField, { id: props.id ? `${props.id}-time` : undefined, label: props.timeLabel ?? "Time", prefix: react_1.default.createElement(polaris_1.Icon, { source: polaris_icons_1.ClockIcon }), autoComplete: "off", value: timeString, onChange: onTimeStringChange, ...timeInputFocusProps, error: !parseSuccess && !isTimeFocused && `Invalid time, please enter a value like "11:00 AM"` }))));
};
