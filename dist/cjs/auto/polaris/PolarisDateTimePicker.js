...
const PolarisDateTimePicker = (props) => {
    ...
    return (react_1.default.createElement(polaris_1.InlineStack, { gap: "400" },
        ...
        props.includeTime && (react_1.default.createElement(polaris_1.TextField, { type: "time", id: props.id ? `${props.id}-time` : undefined, label: props.timeLabel ?? "Time", 
            // prefix={<Icon source={ClockIcon} />}
            autoComplete: "off", value: timeString, onChange: onTimeStringChange, ...timeInputFocusProps, error: timeString && !parseSuccess && !isTimeFocused && `Invalid time, please enter a value like "11:00 AM"` }))));
};
