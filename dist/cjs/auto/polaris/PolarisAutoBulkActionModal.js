...
const PolarisAutoBulkActionModal = (props) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(polaris_1.Modal, { onClose: () => setShowModal(false), title: modalTitle, open: showModal }, isBulkGadgetAction ? (react_1.default.createElement(GadgetBulkActionModalContent, { model: model, modelActionDetails: modelActionDetails, ids: ids, close: closeModal })) : (react_1.default.createElement(CustomBulkActionModalContent, { modelActionDetails: modelActionDetails, ids: ids, close: closeModal, selectedRows: selectedRows })))));
};
...
const CustomBulkActionModalContent = (props) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(polaris_1.Modal.Section, null, modelActionDetails.render(ids, selectedRows)),
        react_1.default.createElement(polaris_1.Modal.Section, null,
            react_1.default.createElement("div", { style: { float: "right", paddingBottom: "16px" } },
                react_1.default.createElement(polaris_1.ButtonGroup, null,
                    react_1.default.createElement(polaris_1.Button, { variant: "secondary", onClick: close }, "Close"))))));
