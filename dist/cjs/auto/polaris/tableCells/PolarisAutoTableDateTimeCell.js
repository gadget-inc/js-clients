...
const PolarisAutoTableDateTimeCell = (props) => {
    const { value } = props;
    return value instanceof Date ? react_1.default.createElement(PolarisAutoTableTextCell_js_1.PolarisAutoTableTextCell, { value: (0, date_fns_1.format)(value, "LLL d, y K:mm a") }) : null;
};
