...
const PolarisAutoTableTextCell = (props) => {
    ...
    return (react_1.default.createElement(polaris_1.Tooltip, { content: stringifiedValue, hoverDelay: 500 },
        react_1.default.createElement(polaris_1.Scrollable, { shadow: true, style: { maxHeight: "460px" } }, polarisTextWithRef)));
};
