...
const PolarisFileInput = (props) => {
    ...
    const uploadedFiles = file && (react_1.default.createElement(polaris_1.InlineStack, null,
        react_1.default.createElement(polaris_1.Thumbnail, { size: "small", alt: file.name, source: validImageTypes.includes(file.type) ? window.URL.createObjectURL(file) : polaris_icons_1.NoteIcon }),
