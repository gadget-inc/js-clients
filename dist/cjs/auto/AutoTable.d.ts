import type { DefaultSelection, FindManyFunction, GadgetRecord, OptionsType, Select } from "@gadgetinc/api-client-core";
 ...
 **/
export type AutoTableProps<GivenOptions extends OptionsType, SchemaT, FinderFunction extends FindManyFunction<GivenOptions, any, SchemaT, any>, Options extends FinderFunction["optionsType"]> = {
    /**
     * The Gadget model with records that will be shown in the table.
     */
    model: {
        findMany: FinderFunction;
    };
    /**
     ...
     */
    onClick?: (row: TableRow, record: GadgetRecord<Select<Exclude<FinderFunction["schemaType"], null | undefined>, DefaultSelection<FinderFunction["selectionType"], Options, FinderFunction["defaultSelection"]>>>) => void;
    /**
