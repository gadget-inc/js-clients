...
const AutoEagerLoadedRichTextInput_js_1 = tslib_1.__importDefault(require("./AutoEagerLoadedRichTextInput.js"));
const AutoRichTextInput = (0, AutoInput_js_1.autoInput)((props) => {
    if (props.eagerLoad) {
        return react_1.default.createElement(AutoEagerLoadedRichTextInput_js_1.default, { ...props });
    }
    return react_1.default.createElement(AutoLazyLoadedRichTextInput, { ...props });
});
const AutoLazyLoadedRichTextInput = (0, AutoInput_js_1.autoInput)((props) => {
