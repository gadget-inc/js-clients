...
exports.MissingMdxEditorErrorMessage = void 0;
...
const AutoRichTextInput = (0, AutoInput_js_1.autoInput)((props) => {
    ...
    (0, utils_js_1.assertFieldType)({
        ...
        expectedFieldType: graphql_js_1.GadgetFieldType.RichText,
    });
    ...
    const refs = (0, utils_js_1.multiref)(innerRef, editorRef);
    return (react_1.default.createElement(MDXEditor, { plugins: [
            ...
            linkDialogPlugin(),
            toolbarPlugin({
                toolbarContents: () => (react_1.default.createElement(react_1.default.Fragment, null,
...
exports.MissingMdxEditorErrorMessage = `Failed to load AutoRichTextInput. This component requires "@mdxeditor/editor" in your package.json. See https://docs.gadget.dev/reference/react/auto#autorichtextinput-`;
