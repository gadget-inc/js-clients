...
const useHasManyThroughController = (props) => {
    ...
    const joinModelHasManyFieldApiIdentifier = (0, client_hooks_1.assert)(configuration.joinModelHasManyFieldApiIdentifier, "joinModelHasManyFieldApiIdentifier is required for hasManyThrough fields");
