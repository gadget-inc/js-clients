...
exports.getRecordsAsOptions = exports.getRecordAsOption = exports.useRelatedModelOptions = exports.useOptionLabelForField = exports.selectedRecordsToLoadCount = exports.optionRecordsToLoadCount = void 0;
...
const useRelatedModelOptions = (props) => {
    ...
    const getOptions = () => {
        const options = (0, utils_js_1.uniqByProperty)((0, exports.getRecordsAsOptions)(relatedModel.records, optionLabel, props.secondaryLabel, props.tertiaryLabel), "id");
        return options;
    };
...
const getRecordIdsAsString = (records) => records
    ...
    .sort()
    .join(",");
const getRecordAsOption = (record, optionLabel, secondaryLabel, tertiaryLabel) => {
    return {
        id: record.id,
...
const getRecordsAsOptions = (records, optionLabel, secondaryLabel, tertiaryLabel) => {
    return records?.map((record) => (0, exports.getRecordAsOption)(record, optionLabel, secondaryLabel, tertiaryLabel)) ?? [];
};
