...
const MUIAutoTable = (props) => {
    const [{ rows, columns, page, fetching, error }, refresh] = (0, useTable_1.useTable)(props.manager, {
        select: props.select,
    });
    ...
    if (error) {
        return react_1.default.createElement(MUIErrorDisplay_1.MUIErrorDisplay, { error: error, retry: refresh });
    }
