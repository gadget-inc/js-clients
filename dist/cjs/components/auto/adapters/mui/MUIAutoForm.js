...
const MUIErrorDisplay_1 = require("./MUIErrorDisplay");
const MUIFormInput_1 = require("./MUIFormInput");
...
const MUIAutoForm = (props) => {
    ...
    if (error && !error.validationErrors) {
        return react_1.default.createElement(MUIErrorDisplay_1.MUIErrorDisplay, { error: error });
    }
    ...
    return (react_1.default.createElement(material_1.Grid, { container: true, component: "form", spacing: 2, onSubmit: () => void submit(), ...rest },
        ...
        fields.map(([path, field]) => (react_1.default.createElement(material_1.Grid, { item: true, key: field.apiIdentifier, xs: 12 },
            react_1.default.createElement(MUIFormInput_1.MUIFormInput, { path: path, field: field, control: control })))),
