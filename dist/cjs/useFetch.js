...
let useFetchImpl = (0, createHooks_js_1.createHookStub)("useFetch");
...
const dispatchError = (wrapClientSideError, mounted, dispatch, abortController, error, response) => {
...
(0, createHooks_js_1.createHookStub)("useFetch", (adapter, coreHooks) => {
    useFetchImpl = (path, options) => {
...
exports.useFetch = ((...args) => useFetchImpl(...args));
