...
let useGlobalActionImpl = (0, createHooks_js_1.createHookStub)("useGlobalAction");
(0, createHooks_js_1.createHookStub)("useGlobalAction", (adapter, coreHooks) => {
...
const useGlobalAction = (action) => useGlobalActionImpl(action);
