...
exports.isModelActionMetadata = exports.useRolesMetadata = exports.acceptedAutoTableFieldTypes = exports.filterAutoTableFieldList = exports.filterAutoFormFieldList = exports.useActionMetadata = exports.useModelMetadata = exports.FieldType = void 0;
...
const useActionMetadata = (actionFunction) => {
    ...
    if (actionFunction.type === "globalAction") {
        ...
        if (!actionName) {
            ...
            try {
                actionName = actionFunction.functionName.slice(0, -actionFunction.modelApiIdentifier.length);
                if (!actionName)
