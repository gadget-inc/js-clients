...
const gql_1 = require("./internal/gql");
 ...
 * @internal
 */
exports.FieldType = graphql_1.GadgetFieldType;
const FieldMetadataFragment = (0, gql_1.graphql)(/* GraphQL */ `
...
`);
const ModelMetadataQuery = (0, gql_1.graphql)(/* GraphQL */ `
...
`);
const _SubFieldsFragment = (0, gql_1.graphql)(/* GraphQL */ `
...
`);
const ModelActionMetadataQuery = (0, gql_1.graphql)(/* GraphQL */ `
...
`);
const RolesMetadataQuery = (0, gql_1.graphql)(/* GraphQL */ `
  query RolesMetadata {
    gadgetMeta {
      roles {
        name
...
const useModelMetadata = (apiIdentifier) => {
    const [{ data, fetching, error }] = (0, useGadgetQuery_1.useGadgetQuery)({
    ...
    return {
        ...
        fetching,
        error: error ? utils_1.ErrorWrapper.forClientSideError(error) : undefined,
    };
};
