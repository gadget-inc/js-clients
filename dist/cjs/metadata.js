...
exports.isActionMetadata = exports.useRolesMetadata = exports.filterAutoTableFieldList = exports.filterAutoFormFieldList = exports.useActionMetadata = exports.useModelMetadata = exports.FieldType = void 0;
...
const filterAutoTableFieldList = (fields, options) => {
    if (!fields) {
        return [];
    }
    let subset = fields;
