...
const internalFindListVariables = (capitalizedApiIdentifier, options) => {
    return {
        ...
        sort: (options === null || options === void 0 ? void 0 : options.sort) ? (0, tiny_graphql_query_compiler_1.Var)({ value: options === null || options === void 0 ? void 0 : options.sort, type: `[${capitalizedApiIdentifier}Sort!]` }) : undefined,
        filter: (options === null || options === void 0 ? void 0 : options.filter) ? (0, tiny_graphql_query_compiler_1.Var)({ value: options === null || options === void 0 ? void 0 : options.filter, type: `[${capitalizedApiIdentifier}Filter!]` }) : undefined,
...
class InternalModelManager {
    ...
    async findOne(id, options, throwOnEmptyData = true) {
        ...
        return (0, support_js_1.hydrateRecord)(response, result, this);
    }
    /**
    ...
    async findMany(options) {
        ...
        const connection = (0, support_js_1.assertNullableOperationSuccess)(response, ["internal", `list${this.capitalizedApiIdentifier}`]);
        const records = (0, support_js_1.hydrateConnection)(response, connection, this);
    ...
    async findFirst(options, throwOnEmptyData = true) {
        ...
        if (throwOnEmptyData === false) {
            ...
            connection = (0, support_js_1.assertNullableOperationSuccess)(response, ["internal", `list${this.capitalizedApiIdentifier}`]);
        }
        else {
            ...
            connection = (0, support_js_1.assertOperationSuccess)(response, ["internal", `list${this.capitalizedApiIdentifier}`], throwOnEmptyData);
        }
        const records = (0, support_js_1.hydrateConnection)(response, connection, this);
    ...
    async create(record) {
        const response = await this.connection.currentClient
            ...
            .toPromise();
        const result = (0, support_js_1.assertMutationSuccess)(response, ["internal", `create${this.capitalizedApiIdentifier}`]);
        return (0, support_js_1.hydrateRecord)(response, result[this.apiIdentifier], this);
    }
    /**
    ...
    async bulkCreate(records) {
        ...
        const response = await this.connection.currentClient
            ...
            .toPromise();
        const result = (0, support_js_1.assertMutationSuccess)(response, ["internal", `bulkCreate${capitalizedPluralApiIdentifier}`]);
        return (0, support_js_1.hydrateRecordArray)(response, result[this.options.pluralApiIdentifier], this);
    }
    /**
    ...
    async update(id, record) {
        ...
        const response = await this.connection.currentClient
            ...
            .toPromise();
        const result = (0, support_js_1.assertMutationSuccess)(response, ["internal", `update${this.capitalizedApiIdentifier}`]);
        return (0, support_js_1.hydrateRecord)(response, result[this.apiIdentifier], this);
    }
    /**
    ...
    async delete(id) {
        ...
        const response = await this.connection.currentClient.mutation((0, exports.internalDeleteMutation)(this.apiIdentifier), { id }).toPromise();
        (0, support_js_1.assertMutationSuccess)(response, ["internal", `delete${this.capitalizedApiIdentifier}`]);
    }
    /**
    ...
    async deleteMany(options) {
        const response = await this.connection.currentClient.mutation((0, exports.internalDeleteManyMutation)(this.apiIdentifier), options).toPromise();
        (0, support_js_1.assertMutationSuccess)(response, ["internal", `deleteMany${this.capitalizedApiIdentifier}`]);
    }
}
