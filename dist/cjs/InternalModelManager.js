        ...
        fields: {
            internal: (0, support_js_1.namespacify)(namespace, {
                [`create${capitalizedApiIdentifier}`]: (0, tiny_graphql_query_compiler_1.Call)({
                    [apiIdentifier]: (0, tiny_graphql_query_compiler_1.Var)({ value: record, type: `Internal${capitalizedApiIdentifier}Input` }),
                }, {
                    success: true,
        ...
        fields: {
            internal: (0, support_js_1.namespacify)(namespace, {
                [`bulkCreate${capitalizedPluralApiIdentifier}`]: (0, tiny_graphql_query_compiler_1.Call)({
                    [pluralApiIdentifier]: (0, tiny_graphql_query_compiler_1.Var)({ value: records, type: `[Internal${capitalizedApiIdentifier}Input]!` }),
                }, {
                    success: true,
                    ...internalErrorsDetails,
        ...
        fields: {
            internal: (0, support_js_1.namespacify)(namespace, {
                [`deleteMany${capitalizedApiIdentifier}`]: (0, tiny_graphql_query_compiler_1.Call)({
                    search: (0, tiny_graphql_query_compiler_1.Var)({ value: options === null || options === void 0 ? void 0 : options.search, type: "String" }),
                    filter: (0, tiny_graphql_query_compiler_1.Var)({ value: options === null || options === void 0 ? void 0 : options.filter, type: `[${capitalizedApiIdentifier}Filter!]` }),
                }, {
                    success: true,
                    ...internalErrorsDetails,
                }),
