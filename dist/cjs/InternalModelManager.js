        ...
        fields: {
            internal: (0, support_js_1.namespacify)(namespace, {
                [`deleteMany${capitalizedApiIdentifier}`]: (0, tiny_graphql_query_compiler_1.Call)({
                    ...
                    filter: (0, tiny_graphql_query_compiler_1.Var)({ value: options === null || options === void 0 ? void 0 : options.filter, type: `[${(0, support_js_1.filterTypeName)(apiIdentifier, namespace)}!]` }),
                }, {
                    success: true,
                    ...support_js_1.ErrorsSelection,
                }),
