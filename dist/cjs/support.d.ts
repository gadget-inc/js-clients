...
export declare const searchableFieldTypeName: (modelApiIdentifier: string, namespace: string | string[] | null | undefined) => string;
...
export declare const jsSearchFieldsToGqlSearchFields: (searchFields: AnySearchableFieldConfig) => Record<string, SearchableFieldConfig>;
export {};
