...
export declare const hydrateRecordArray: <Shape extends RecordShape = any>(response: Result, records: Array<any>, modelManager?: AnyModelManager) => (import("./GadgetRecord.js").GadgetRecordImplementation<Shape> & Shape)[];
export declare const hydrateConnection: <Shape extends RecordShape = any>(response: Result, connection: {
    edges: {
        node: Node;
    }[];
}, modelManager?: AnyModelManager) => (import("./GadgetRecord.js").GadgetRecordImplementation<Shape> & Shape)[];
