...
let useBulkActionImpl = (0, createHooks_js_1.createHookStub)("useBulkAction");
(0, createHooks_js_1.createHookStub)("useBulkAction", (adapter, coreHooks) => {
...
const useBulkAction = (action, options) => useBulkActionImpl(action, options);
