...
const assertNullableOperationSuccess = (response, dataPath) => {
    var _a;
    if (response.error) {
        if ("networkError" in response.error && ((_a = response.error.networkError) === null || _a === void 0 ? void 0 : _a.length)) {
...
const processBulkActionResponse = (defaultSelection, response, records, modelSelectionField, hasReturnType) => {
    if (defaultSelection == null)
        return;
    if (!hasReturnType) {
        return (0, exports.hydrateRecordArray)(response, records[modelSelectionField]);
    }
        ...
        return Object.entries(hasReturnType).flatMap(([returnTypeField, innerHasReturnType]) => {
            ...
            return results.map((result) => {
                ...
                if (!returnTypeForResult) {
                    return (0, exports.hydrateRecord)(response, result);
                }
                else {
...
exports.processBulkActionResponse = processBulkActionResponse;
const processActionResponse = (defaultSelection, response, record, modelSelectionField, hasReturnType) => {
    ...
    if (defaultSelection == null)
        return;
    if (!hasReturnType) {
        return (0, exports.hydrateRecord)(response, record[modelSelectionField]);
    }
    else if (typeof hasReturnType == "boolean") {
