...
const combineNamespacesAndApiIdentifier = (givenNamespaces, apiIdentifier) => {
    const namespaces = Array.isArray(givenNamespaces) ? givenNamespaces : givenNamespaces ? [givenNamespaces] : [];
    const combinedNamespaces = namespaces.map((segment, index) => (index === 0 ? segment : (0, exports.camelize)(segment))).join("");
    return namespaces.length > 0 ? `${combinedNamespaces}${(0, exports.camelize)(apiIdentifier)}` : apiIdentifier;
};
exports.combineNamespacesAndApiIdentifier = combineNamespacesAndApiIdentifier;
const sortTypeName = (modelApiIdentifier, namespace) => `${(0, exports.camelize)((0, exports.combineNamespacesAndApiIdentifier)(namespace, modelApiIdentifier))}Sort`;
exports.sortTypeName = sortTypeName;
const filterTypeName = (modelApiIdentifier, namespace) => `${(0, exports.camelize)((0, exports.combineNamespacesAndApiIdentifier)(namespace, modelApiIdentifier))}Filter`;
