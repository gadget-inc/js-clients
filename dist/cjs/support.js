...
const hydrateAllModels = (response, allModels) => {
    var _a, _b;
    const hydrator = (_b = (_a = response.data) === null || _a === void 0 ? void 0 : _a.gadgetMeta) === null || _b === void 0 ? void 0 : _b.allHydrations;
    if (!hydrator) {
        return allModels;
    }
...
exports.hydrateAllModels = hydrateAllModels;
