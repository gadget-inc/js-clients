...
class Ma {
  constructor(t) {
    var n, r, i, a, s;
    if (this.options = t, this.currentTransaction = null, this.authenticationMode = ve.Anonymous, this.transaction = async (o, u) => {
      let l, c;
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof window < "u" && window.fetch ? this._fetchImplementation = window.fetch.bind(window) : this._fetchImplementation = async (...o) => {
      const { fetch: u } = await import("./browser-ponyfill-e75a5550.js").then((l) => l.b);
      return await u(...o);
