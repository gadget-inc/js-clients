...
const ue = Symbol.for("g/fields"), mt = Symbol.for("g/instantiatedFields"), bt = Symbol.for("g/persistedFields"), vt = Symbol.for("g/fieldKeys"), yr = Symbol.for("g/touched"), D = Symbol.for("g/self");
class Uo {
  constructor(t) {
    var r, n;
...
class Pa {
  constructor(t) {
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof xr < "u" && xr.fetch ? this._fetchImplementation = xr.fetch.bind(xr) : this._fetchImplementation = async (...u) => {
      let l = await import("./browser-ponyfill-ebdeff20.js").then((f) => f.b);
