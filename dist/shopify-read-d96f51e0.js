...
import oe, { useMemo as li, useContext as Uc, useRef as fd, memo as dd, useState as Fc, useEffect as ii, createContext as pd } from "react";
...
` + x[$e].replace(" at new ", " at ");
      ...
      var An = A ? A.displayName || A.name : "", Yu = An ? je(An) : "";
      return typeof A == "function" && Fe.set(A, Yu), Yu;
    }
    function Vr(A, C, R) {
      return Bt(A, !1);
    }
    ...
    var en = Object.prototype.hasOwnProperty, gn = {}, $r = m.ReactDebugCurrentFrame;
    function tn(A) {
      if (A) {
    ...
    function k(A, C, R, W, fe) {
      {
        ...
        for (var ne in A)
          if (_e(A, ne)) {
            ...
            x && !(x instanceof Error) && (tn(fe), b("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", W || "React class", R, ne, typeof x), tn(null)), x instanceof Error && !(x.message in gn) && (gn[x.message] = !0, tn(fe), b("Failed %s type: %s", R, x.message), tn(null));
          }
      }
    }
    var N = Array.isArray;
    ...
    function ed(A, C) {
      {
        var R = function() {
          _n || (_n = !0, b("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", C));
        };
    ...
    function nd(A, C, R, W, fe) {
      {
        ...
        for (_e in C)
          en.call(C, _e) && !ye.hasOwnProperty(_e) && (ne[_e] = C[_e]);
        if (A && A.defaultProps) {
    ...
    var ia = m.ReactCurrentOwner, Gu = m.ReactDebugCurrentFrame;
    function On(A) {
      if (A) {
        var C = A._owner, R = qt(A.type, A._source, C ? C.type : null);
        Gu.setExtraStackFrame(R);
      } else
    ...
    function Hu(A, C) {
      {
        ...
        Wu[R] = !0;
        var W = "";
        A && A._owner && A._owner !== ia.current && (W = " It was passed a child from " + U(A._owner.type) + "."), On(A), b('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', R, W), On(null);
      }
    }
    function zu(A, C) {
      {
    ...
    function od(A) {
      {
        for (var C = Object.keys(A.props), R = 0; R < C.length; R++) {
          var W = C[R];
          if (W !== "children" && W !== "key") {
            On(A), b("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", W), On(null);
            break;
          }
        }
        A.ref !== null && (On(A), b("Invalid attribute `ref` supplied to `React.Fragment`."), On(null));
      }
    }
    function Qu(A, C, R, W, fe, _e) {
      {
        var ne = w(A);
        if (!ne) {
          var x = "";
...
process.env.NODE_ENV === "production" ? Ja.exports = hd() : Ja.exports = yd();
var fi = Ja.exports;
...
function Xa(e, n) {
  ...
  for (const i of e.body.matchAll(gd)) {
    if (typeof i.index == "number" || $c(!1), i.index >= n)
      break;
...
let ae = class qc extends Error {
  ...
  constructor(n, ...t) {
    ...
    super(n), this.name = "GraphQLError", this.path = u ?? void 0, this.originalError = c ?? void 0, this.nodes = Zu(
      Array.isArray(o) ? o : o ? [o] : void 0
    );
    const p = Zu(
      (r = this.nodes) === null || r === void 0 ? void 0 : r.map((d) => d.loc).filter((d) => d != null)
    );
    this.source = s ?? (p == null || (i = p[0]) === null || i === void 0 ? void 0 : i.source), this.positions = y ?? (p == null ? void 0 : p.map((d) => d.start)), this.locations = y && s ? y.map((d) => Xa(s, d)) : p == null ? void 0 : p.map((d) => Xa(d.source, d.start));
    const h = mr(
    ...
    this.extensions = (a = l ?? h) !== null && a !== void 0 ? a : /* @__PURE__ */ Object.create(null), Object.defineProperties(this, {
      ...
      writable: !0,
      configurable: !0
    }) : Error.captureStackTrace ? Error.captureStackTrace(this, qc) : Object.defineProperty(this, "stack", {
      value: Error().stack,
      writable: !0,
      configurable: !0
    });
...
function Ed(e) {
  return Hc(e) || Pd(e) || e === 95;
}
function Td(e, n) {
  const t = e.replace(/"""/g, '\\"""'), r = t.split(/\r\n|[\n\r]/g), i = r.length === 1, a = r.length > 1 && r.slice(1).every((h) => h.length === 0 || ts(h.charCodeAt(0))), o = t.endsWith('\\"""'), s = e.endsWith('"') && !o, y = e.endsWith("\\"), u = s || y, c = !(n != null && n.minimize) && // add leading and trailing new lines only if it improves readability
  (!i || e.length > 70 || u || a || o);
  let l = "";
  const p = i && ts(e.charCodeAt(0));
  return (c && !p || a) && (l += `
`), l += t, (c || u) && (l += `
`), '"""' + l + '"""';
}
...
function wd(e, n) {
  ...
  if (Cd(e)) {
    const r = e.toJSON();
    if (r !== e)
      return typeof r == "string" ? r : Mi(r, t);
...
function jd(e, n) {
  ...
  return t.length === 0 ? "{}" : n.length > zc ? "[" + Rd(e) + "]" : "{ " + t.map(
    ([i, a]) => i + ": " + Mi(a, n)
  ).join(", ") + " }";
}
function Nd(e, n) {
...
function Dd(e, n) {
  ...
  for (; t < e.length && r < n.length; ) {
    ...
    if (Gr(i) && Gr(a)) {
      let o = 0;
      do
        ++t, o = o * 10 + i - Za, i = e.charCodeAt(t);
      while (Gr(i) && o > 0);
      let s = 0;
      do
        ++r, s = s * 10 + a - Za, a = n.charCodeAt(r);
      while (Gr(a) && s > 0);
      if (o < s)
        return -1;
      if (o > s)
...
class Ud {
  constructor(n) {
    this._input = n, this._inputLowerCase = n.toLowerCase(), this._inputArray = rs(this._inputLowerCase), this._rows = [
...
function Wd(e, n, t = Wc) {
  ...
  do {
    ...
    if (!Array.isArray(u)) {
      var d, f;
      xu(u) || Le(!1, `Invalid AST Node: ${Oe(u)}.`);
...
function Qc(e) {
  return Yc(e) || Kd(e) || Jd(e) || Xd(e) || Kc(e) || Jc(e) || Xc(e) || Vt(e);
}
function Yc(e) {
  return Xt(e, Qn);
}
...
class xd {
  constructor(n) {
    Qc(n) || Le(!1, `Expected ${Oe(n)} to be a GraphQL type.`), this.ofType = n;
  }
  get [Symbol.toStringTag]() {
    return "GraphQLList";
  }
...
class tp {
  constructor(n) {
    var t;
    this.name = wt(n.name), this.description = n.description, this.isTypeOf = n.isTypeOf, this.extensions = It(n.extensions), this.astNode = n.astNode, this.extensionASTNodes = (t = n.extensionASTNodes) !== null && t !== void 0 ? t : [], this._fields = () => tl(n), this._interfaces = () => el(n), n.isTypeOf == null || typeof n.isTypeOf == "function" || Le(
      !1,
...
const ua = 2147483647, sa = -2147483648, cp = new Qn({
  name: "Int",
  ...
  parseLiteral(e) {
    if (e.kind !== ve.INT)
      throw new ae(
        `Int cannot represent non-integer value: ${Yt(e)}`,
        {
          nodes: e
        }
      );
...
new Qn({
  ...
  parseLiteral(e) {
    if (e.kind !== ve.FLOAT && e.kind !== ve.INT)
      throw new ae(
        `Float cannot represent non numeric value: ${Yt(e)}`,
        e
      );
    return parseFloat(e.value);
  }
...
const al = new Qn({
  ...
  parseLiteral(e) {
    if (e.kind !== ve.STRING)
      throw new ae(
        `String cannot represent a non string value: ${Yt(e)}`,
        {
          nodes: e
        }
      );
  ...
  parseLiteral(e) {
    if (e.kind !== ve.BOOLEAN)
      throw new ae(
        `Boolean cannot represent a non boolean value: ${Yt(e)}`,
        {
          nodes: e
        }
      );
...
new Qn({
  ...
  parseLiteral(e) {
    if (e.kind !== ve.STRING && e.kind !== ve.INT)
      throw new ae(
        "ID cannot represent a non-string and non-integer value: " + Yt(e),
        {
          nodes: e
        }
      );
...
function lr(e, n, t) {
  if (e) {
    ...
    $c(!1, "Unexpected input type: " + Oe(n));
  }
}
function as(e, n) {
...
function fp(e, n, t) {
  var r;
  const i = {}, a = (r = n.arguments) !== null && r !== void 0 ? r : [], o = Mo(a, (s) => s.name.value);
  for (const s of e.args) {
    ...
    if (h === void 0)
      throw new ae(
        `Argument "${y}" has invalid value ${Yt(l)}.`,
        {
          nodes: l
        }
      );
...
function Pp(e) {
  ...
  for (a = a.sort(us.numerically), n = a.length - 1; n >= 0; n--) {
    t = a[n];
  ...
  o = o.sort(us.numericallyBy("index"));
  let y = o.length;
  for (n = 0; n < y; n++) {
    let c = o[n];
...
var ca = 0, ss = 1, fn = 2, di = 3, no = 4, pi = 1024, hi = function() {
};
function Rn(e) {
...
function un(e, n) {
  ...
  return Promise.resolve(n).then(function(r) {
    return !t && e.state >= no ? Rn(e).then(function(i) {
      return {
        value: i,
        done: !0
      };
...
function Bo(e, n) {
  var t, r;
  if (!(e.state >= fn))
    if (e.state = fn, e.onnext(), e.onstop(), e.err == null && (e.err = n), e.pushes.length === 0 && (typeof e.buffer > "u" || e.buffer.empty))
      pr(e);
    else
      try {
...
function pr(e) {
  var n, t;
  if (!(e.state >= di)) {
    e.state < fn && Bo(e), e.state = di, e.buffer = void 0;
    try {
...
function cs(e) {
  e.state >= no || (e.state < di && pr(e), e.state = no);
}
function Ip(e, n) {
  if (to(n), e.pushes.length >= pi)
    throw new ul("No more than " + pi + " pending calls to push are allowed on a single repeater.");
  if (e.state >= fn)
  ...
  t = t.catch(function(y) {
    e.state < fn && (e.err = y), cs(e);
  });
  var r;
  if (e.nexts.length) {
    var i = e.nexts.shift();
    i.resolve(un(e, t)), e.nexts.length ? r = Promise.resolve(e.nexts[0].value) : r = new Promise(function(y) {
      return e.onnext = y;
    });
  } else
...
function wp(e) {
  var n = Bo.bind(null, e), t = new Promise(function(r) {
    return e.onstop = r;
  });
  ...
  function() {
    ...
    return e.prototype.next = function(n) {
      ...
      if (t.nexts.length >= pi)
        throw new ul("No more than " + pi + " pending calls to next are allowed on a single repeater.");
      if (t.state <= ca && Cp(t), t.onnext(n), typeof t.buffer < "u" && !t.buffer.empty) {
        var r = un(t, t.buffer.remove());
        if (t.pushes.length) {
        ...
        return t.onnext = a.resolve, un(t, a.value);
      } else if (t.state >= fn)
        return pr(t), un(t, Rn(t));
      ...
      if (t === void 0)
        throw new Error("WeakMap error");
      return t.state <= ca || t.state >= fn || typeof t.buffer < "u" && !t.buffer.empty ? (pr(t), t.err == null && (t.err = n), un(t, Rn(t))) : this.next(Promise.reject(n));
...
function jp(e) {
  var n = this, t = Bi(e, { returnValues: !0 });
...
function Np(e) {
  var n = this, t = Bi(e, { yieldValues: !0 });
  return new jr(function(r, i) {
    return kn(n, void 0, void 0, function() {
      var a, o, s, y = this;
...
function Lp() {
  ...
  const t = [];
  function r(o) {
    e.type === "running" && (t.push(o), n.resolve(), n = ls());
  }
...
var Te, J;
function ze(e) {
  return new ro(`Syntax Error: Unexpected token at ${J} in ${e}`);
}
function yt(e) {
...
var $p = /(?:null|true|false)/y, cl = /\$[_A-Za-z]\w*/y, Gp = /-?\d+/y, qp = /(?:\.\d+)?[eE][+-]?\d+|\.\d+/y, Wp = /\\/g, Hp = /"""(?:"""|(?:[\s\S]*?[^\\])""")/y, zp = /"(?:"|[^\r\n]*?[^\\]")/y;
function yi(e) {
  var n, t;
  if (t = yt($p))
    n = t === "null" ? {
...
function uh(e) {
  return e[Symbol.asyncIterator] ? yl(e) : (n) => {
...
function ps() {
  var e, n;
  return {
    source: _r(Vo((t) => (e = t.next, n = t.complete, Lo))),
    next(t) {
      e && e(t);
    },
    complete() {
...
var fh = (...e) => {
  for (var n = e[0], t = 1, r = e.length; t < r; t++)
    n = e[t](n);
  return n;
}, dh = (e) => e && e.message && (e.extensions || e.name === "GraphQLError") ? e : typeof e == "object" && e.message ? new ro(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : new ro(e);
...
var io = (e, n) => {
  ...
  return t;
}, ln = /* @__PURE__ */ new Set(), ys = /* @__PURE__ */ new WeakMap(), In = (e) => {
  if (e === null || ln.has(e))
    return "null";
  if (typeof e != "object")
    return JSON.stringify(e) || "";
  ...
  for (var o of r) {
    var s = In(e[o]);
    s && (a.length > 1 && (a += ","), a += In(o) + ":" + s);
  }
  return ln.delete(e), a += "}";
}, ao = (e, n, t) => {
  if (!(t == null || typeof t != "object" || t.toJSON || ln.has(t)))
    if (Array.isArray(t))
...
`) : e, vs = (e) => e.split(ph).map(yh).join("").trim(), ms = /* @__PURE__ */ new Map(), oi = /* @__PURE__ */ new Map(), Ui = (e) => {
  var n;
  return typeof e == "string" ? n = vs(e) : e.loc && oi.get(e.__key) === e ? n = e.loc.source.body : (n = ms.get(e) || vs(Ot(e)), ms.set(e, n)), typeof e != "string" && !e.loc && (e.loc = {
    start: 0,
    end: n.length,
    source: {
      body: n,
...
# ${t}`, n));
  ...
  var n, t;
  return typeof e == "string" ? (n = bs(e), t = oi.get(n) || th(e)) : (n = e.__key || bs(e), t = oi.get(n) || e), t.loc || Ui(t), t.__key = n, oi.set(n, t), t;
}, ui = (e, n, t) => {
  var r = n || {}, i = gi(e), a = vi(r), o = i.__key;
  return a !== "{}" && (o = io(a, o)), {
    key: o,
    query: i,
    variables: r,
  ...
  for (var n of e.definitions)
    if (n.kind === Ht.OPERATION_DEFINITION)
    ...
    for (var y of o) {
      ...
      if (y.items)
        for (var h = +u >= 0 ? u : 0, d = 0, f = y.items.length; d < f; d++)
          c[h + d] = uo(c[h + d], y.items[d]);
      else
        y.data !== void 0 && (c[u] = uo(c[u], y.data));
    }
  else
...
function bl(e) {
  return {
    query: e.extensions && e.extensions.persistedQuery && !e.extensions.persistedQuery.miss ? void 0 : Ui(e.query),
...
var mh = (e, n) => {
  ...
  if (n && !(e.kind === "query" && e.context.preferGetMethod)) {
    var t = vi(n), r = ((s) => {
      ...
      return (mi !== Un || bi !== Un) && (ln.clear(), ao(y, "variables", s)), y;
    })(n.variables);
    if (r.size) {
      var i = new FormData();
...
`)) {
    ...
    for await (var y of s)
      i = i ? so(i, y, a) : oo(e, y, a), r = !1, yield i, r = !0;
    i || (yield i = oo(e, {}, a));
  } catch (u) {
    if (!r)
      throw u;
...
function Sh(e, n, t) {
  var r;
  return typeof AbortController < "u" && (t.signal = (r = new AbortController()).signal), Uo(() => {
    r && r.abort();
  })(rt((i) => !!i)(yl(Ph(e, n, t))));
}
var co = (e, n) => {
  if (Array.isArray(e))
    ...
    for (var r in e)
      r === "__typename" && typeof e[r] == "string" ? n.add(e[r]) : co(e[r], n);
  return n;
}, lo = (e) => {
  var n = !1;
  if ("definitions" in e) {
    ...
    if (e.selectionSet) {
      for (var s of e.selectionSet.selections || []) {
        o = o || s.kind === Ht.FIELD && s.name.value === "__typename" && !s.alias;
        var y = lo(s);
        n = n || y !== s, a.push(y);
      }
      if (o || (n = !0, a.push({
  ...
  return e;
}, As = /* @__PURE__ */ new Map(), Eh = (e) => {
  var n = gi(e), t = As.get(n.__key);
  return t || (As.set(n.__key, t = lo(n)), Object.defineProperty(t, "__key", {
    value: n.__key,
    enumerable: !1
  })), t;
}, fo = (e, n) => {
...
function Ps(e) {
  var n = (t) => e(t);
  return n.toPromise = () => lh(pl(1)(rt((t) => !t.stale && !t.hasNext)(n))), n.then = (t, r) => n.toPromise().then(t, r), n.subscribe = (t) => dn(t)(n), n;
}
function Fn(e, n, t) {
  return {
    ...n,
...
function Ih(e) {
  for (var n = /* @__PURE__ */ new Map(), t = [], r = [], i = Array.isArray(e) ? e[0] : e || "", a = 1; a < arguments.length; a++) {
    var o = arguments[a];
    o && o.definitions ? r.push(o) : i += o, i += arguments[0][a];
  }
  r.unshift(gi(i));
  for (var s of r)
    for (var y of s.definitions)
      if (y.kind === Ht.FRAGMENT_DEFINITION) {
        var u = y.name.value, c = Ui(y);
        n.has(u) ? process.env.NODE_ENV !== "production" && n.get(u) !== c && console.warn("[WARNING: Duplicate Fragment] A fragment with name `" + u + "` already exists in this document.\nWhile fragment names may not be unique across your source, each name must be unique per document.") : (n.set(u, c), t.push(y));
      } else
        t.push(y);
  return gi({
    kind: Ht.DOCUMENT,
...
var la = ({ kind: e }) => e !== "mutation" && e !== "query", wh = ({ forward: e, client: n, dispatchDebug: t }) => {
  ...
  return (s) => {
    var y = Mn((c) => {
      ...
      return process.env.NODE_ENV !== "production" && (p = {
        ...p,
        operation: process.env.NODE_ENV !== "production" ? Ss(c, {
          cacheOutcome: l ? "hit" : "miss"
        }) : c
      }), c.context.requestPolicy === "cache-and-network" && (p.stale = !0, Es(n, c)), p;
    })(rt((c) => !la(c) && o(c))(s)), u = Ln((c) => {
      var { operation: l } = c;
      if (l) {
        var p = l.context.additionalTypenames || [];
        if (c.operation.kind !== "subscription" && (p = ((P) => [...co(P, /* @__PURE__ */ new Set())])(c.data).concat(p)), c.operation.kind === "mutation" || c.operation.kind === "subscription") {
          ...
          for (var b of h.values())
            r.has(b) && (l = r.get(b).operation, r.delete(b), Es(n, l));
    ...
    })(e(rt((c) => c.kind !== "query" || c.context.requestPolicy !== "cache-only")(Mn((c) => process.env.NODE_ENV !== "production" ? Ss(c, {
      cacheOutcome: "miss"
    }) : c)(Bn([Mn(a)(rt((c) => !la(c) && !o(c))(s)), rt((c) => la(c))(s)])))));
    return Bn([y, u]);
  };
}, Es = (e, n) => e.reexecuteOperation(Fn(n.kind, n, {
  requestPolicy: "network-only"
})), fa = ({ forwardSubscription: e, enableAllOperations: n, isSubscriptionOperation: t }) => ({ client: r, forward: i }) => {
        ...
        return Vo(({ next: d, complete: f }) => {
          ...
          return Promise.resolve().then(() => {
            v || (m = h.subscribe({
              ...
              complete() {
                v || (v = !0, p.kind === "subscription" && r.reexecuteOperation(Fn("teardown", p, p.context)), b && b.hasNext && d(so(b, {
                  hasNext: !1
                })), f());
              }
            }));
...
}, Ch = ({ forward: e, dispatchDebug: n }) => (t) => {
  var r = gr((a) => {
    ...
    var u = Fo(rt((c) => c.kind === "teardown" && c.key === a.key)(t))(Sh(a, s, y));
  ...
  return Bn([r, i]);
}, jh = (e) => ({ client: n, forward: t, dispatchDebug: r }) => e.reduceRight((i, a) => {
  var o = !1;
  return a({
    client: n,
    forward(s) {
  ...
  var o = n && n(a) || a;
  return "then" in o ? hs(o) : hr(o);
})(r(gr((a) => {
  var o = e && e(a) || a;
  return "then" in o ? hs(o) : hr(o);
})(i))), Nh = ({ dispatchDebug: e }) => (n) => (process.env.NODE_ENV !== "production" && (n = Ln((t) => {
  ...
  var p = (_) => {
    var T = Fo(rt((P) => P.kind === "teardown" && P.key === _.key)(y.source))(rt((P) => P.operation.kind === _.kind && P.operation.key === _.key && (!P.operation.context._instance || P.operation.context._instance === _.context._instance))(O));
    return _.kind !== "query" ? T = hl((P) => !!P.hasNext, !0)(T) : T = ds((P) => {
      var E = hr(P);
      return P.stale || P.hasNext ? E : Bn([E, Mn(() => (P.stale = !0, P))(pl(1)(rt((S) => S.key === _.key)(y.source)))]);
    })(T), _.kind !== "mutation" ? T = Uo(() => {
    ...
    executeRequestOperation(_) {
      return _.kind === "mutation" ? Ps(p(_)) : Ps(oh(() => {
        var T = i.get(_.key);
        T || i.set(_.key, T = p(_)), T = fs(() => {
          l(_);
        })(T);
        var P = r.get(_.key);
        return _.kind === "query" && P && (P.stale || P.hasNext) ? ds(hr)(Bn([T, rt((E) => E === r.get(_.key))(hr(P))])) : T;
      }));
    },
    executeQuery(_, T) {
  ...
  if (process.env.NODE_ENV !== "production") {
    var { next: v, source: m } = ps();
    d.subscribeToDebugTarget = (_) => dn(_)(m), f = v;
  }
  var b = jh(n.exchanges), O = _r(b({
    client: d,
    dispatchDebug: f,
    forward: Nh({
      dispatchDebug: f
...
function _l(e) {
  ...
  switch (e.type) {
    ...
    case Ge.Ping:
    case Ge.Pong: {
      if (e.payload != null && !on(e.payload))
    ...
    case Ge.Subscribe: {
      ...
      if (e.payload.variables != null && !on(e.payload.variables))
      ...
      if (e.payload.extensions != null && !on(e.payload.extensions))
...
function Dh(e) {
  ...
  async function B() {
    ...
    const [D, $] = await (P ?? (P = new Promise((X, me) => (async () => {
      ...
      _.emit("connecting");
      const z = new O(typeof n == "function" ? await n() : n, Mh);
      let Ie, Q;
      function re() {
      ...
      T((ce) => {
        ...
        try {
          ...
          _.emit("error", ce), z.close(ct.InternalClientError, Is(ce instanceof Error ? ce.message : new Error(ce).message, "Internal client error"));
        }
      };
      let be = !1;
      z.onmessage = ({ data: ce }) => {
        try {
          ...
          z.onmessage = null, _.emit("error", K), z.close(ct.BadResponse, Is(K instanceof Error ? K.message : new Error(K).message, "Bad response"));
        }
      };
    })())));
...
function zr(e) {
  return on(e) && "code" in e && "reason" in e;
}
function Bh(e) {
  return [
    1e3,
...
var wn = null;
typeof WebSocket < "u" ? wn = WebSocket : typeof MozWebSocket < "u" ? wn = MozWebSocket : typeof global < "u" ? wn = global.WebSocket || global.MozWebSocket : typeof window < "u" ? wn = window.WebSocket || window.MozWebSocket : typeof self < "u" && (wn = self.WebSocket || self.MozWebSocket);
const Uh = wn;
function dt(e) {
  if (typeof e != "object")
    return e;
...
class Fh {
  ...
  toJSON() {
    return yo({ ...this.__gadget.fields });
  }
  touch() {
...
class ws extends Error {
  constructor(n) {
    let t;
    ho(n) ? t = `GraphQL websocket closed unexpectedly by the server with error code ${n.code} and reason "${n.reason}"` : t = "GraphQL websocket closed unexpectedly by the server", super(t), Object.defineProperty(this, "code", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: "GGT_UNKNOWN"
...
}, ho = (e) => (e == null ? void 0 : e.type) == "close", kt = (e, n) => typeof e != "string" ? "" : Vi(e, n), js = (e) => {
  const n = e == null ? "" : String(e);
  return n.charAt(0).toUpperCase() + n.slice(1);
}, Vi = (e, n = !0) => {
  let t = "" + e;
  return n ? t = t.replace(/^[a-z\d]*/, (r) => js(r)) : t = t.replace(new RegExp("^(?:(?=\\b|[A-Z_])|\\w)"), (r) => r.toLowerCase()), t = t.replace(/(?:_|(\/))([a-z\d]*)/gi, (r, i, a, o, s) => (i || (i = ""), "" + i + js(a))), t;
}, Wh = (e) => `${Vi(e)}Sort`, Hh = (e) => `${Vi(e)}Filter`, zh = (e, n, t) => new Pl(`More than one record found for ${e}.${n} = ${t}. Please confirm your unique validation is not reporting an error.`), Qh = (e, n) => {
  if (e.fetching)
    return;
  const t = Vn(e.data, n);
  if (t === void 0)
...
`)), e.error;
  ...
  var n;
  return e.code == "GGT_INVALID_RECORD" ? new Gh(e.message, e.validationErrors, (n = e.model) === null || n === void 0 ? void 0 : n.apiIdentifier, e.record) : e.code == "GGT_UNKNOWN" && e.message.includes("duplicate key value violates unique constraint") ? new Pl(e.message) : new Fi(e.message, e.code);
}, sn = (e, n) => {
  const t = $t(e, n);
  if (!t.success) {
    const r = t.errors && t.errors[0];
    throw r ? $o(r) : new Fi("Gadget API operation not successful.", "GGT_UNKNOWN");
  }
  return t;
}, El = (e) => {
  var n, t, r, i;
  ...
  var t, r;
  const i = (r = (t = e.data) === null || t === void 0 ? void 0 : t.gadgetMeta) === null || r === void 0 ? void 0 : r.allHydrations;
  if (!i)
    return n;
  ...
  try {
    const n = window[e];
    return n.setItem(da, da), n.removeItem(da), !0;
  } catch {
    return !1;
  }
}, Rs = Object.prototype.toString, Ms = Object.getPrototypeOf, ks = Object.getOwnPropertySymbols ? (e) => Object.keys(e).concat(Object.getOwnPropertySymbols(e)) : Object.keys, fr = (e, n, t) => {
  if (e === n)
    return !0;
  if (e == null || n == null)
    return !1;
  if (t.indexOf(e) > -1 && t.indexOf(n) > -1)
    return !0;
  const r = Rs.call(e), i = Rs.call(n);
  let a, o, s;
  if (t.push(e, n), r != i || (a = ks(e), o = ks(n), a.length != o.length || a.some(function(y) {
    return !fr(e[y], n[y], t);
  })))
    return !1;
  switch (r.slice(8, -1)) {
...
const Xh = (e) => {
  ...
  onOperation: (e) => {
    var n, t;
    (n = (t = e.context).operationName) !== null && n !== void 0 || (t.operationName = Xh(e.query) || "unknown");
  }
}), Zh = gl({
  onOperation: (e) => {
...
const xh = 2, ey = 4800, ty = 1e4, ny = [ct.ConnectionAcknowledgementTimeout, ct.ConnectionInitialisationTimeout], Bs = Symbol.for("gadget/connection"), ry = "token", iy = typeof btoa < "u" ? btoa : (e) => Buffer.from(e).toString("base64");
var Ye;
(function(e) {
...
class Il {
  constructor(n) {
    ...
    if (Object.defineProperty(this, "options", {
      ...
      value: async (s, y) => {
        ...
        try {
          ...
          h[Bs] = this, p = new Kh(h, l), this.currentTransaction = p, await p.start();
          const d = await u(p);
      ...
      value: async (s, y = {}) => {
        var u;
        s = ay(s, (u = this.options.baseRouteURL) !== null && u !== void 0 ? u : this.options.endpoint), this.isGadgetRequest(s) && (y.headers = { ...this.requestHeaders(), ...y.headers }, this.authenticationMode == Ye.Custom && await this.options.authenticationMode.custom.processFetch(s, y));
    ...
    this.endpoint = n.endpoint, n.fetchImplementation ? this._fetchImplementation = n.fetchImplementation : typeof window < "u" && window.fetch ? this._fetchImplementation = window.fetch.bind(window) : this._fetchImplementation = async (...s) => {
      const { fetch: y } = await import("./browser-ponyfill-26b4f823.js").then((u) => u.b);
      return await y(...s);
    }, this.websocketImplementation = (r = (t = n.websocketImplementation) !== null && t !== void 0 ? t : globalThis == null ? void 0 : globalThis.WebSocket) !== null && r !== void 0 ? r : Uh, this.websocketsEndpoint = (i = n.websocketsEndpoint) !== null && i !== void 0 ? i : n.endpoint + "/batch", this.websocketsEndpoint = this.websocketsEndpoint.replace(/^http/, "ws"), this.environment = (a = n.environment) !== null && a !== void 0 ? a : "Development", this.requestPolicy = (o = n.requestPolicy) !== null && o !== void 0 ? o : "cache-and-network", this.exchanges = {
      beforeAll: [],
      beforeAsync: [],
      afterAll: [],
      ...n.exchanges
  ...
  async getCurrentModels() {
    if (Object.keys(this.allModels).length > 0)
      return this.allModels;
    try {
      const n = await this.currentClient.query(Ih`{
        gadgetMeta {
          allHydrations
        }
      }`, {});
      return this.allModels = Yh(n, this.allModels), this.allModels;
    } catch (n) {
      return console.error(n), this.allModels;
    }
  }
  ...
  enableSessionMode(n) {
    ...
    let r;
    t == dr.Durable && Ns("localStorage") ? r = window.localStorage : t == dr.Session && Ns("sessionStorage") ? r = window.sessionStorage : r = new Jh(), n !== null && typeof n == "object" && "initialToken" in n && n.initialToken && r.setItem(this.sessionStorageKey, n.initialToken), this.sessionTokenStore = r, this.resetClients();
  }
  close() {
  ...
  isGadgetRequest(n) {
    let t;
    if (typeof n == "string" ? t = n : typeof n == "object" && "url" in n ? t = n.url : t = String(n), mo(this.options.endpoint))
      return !!mo(t);
  ...
  newBaseClient() {
    const n = [...this.exchanges.beforeAll, Ds, Zh];
    typeof window < "u" && n.push(wh), n.push(
      ...this.exchanges.beforeAsync,
  ...
  requestHeaders() {
    ...
    if (this.authenticationMode == Ye.InternalAuthToken)
      t.authorization = "Basic " + iy("gadget-internal:" + this.options.authenticationMode.internalAuthToken);
  ...
  async waitForOpenedConnection(n) {
    ...
    const a = n.connectionGlobalTimeoutMs || ty, o = () => {
      r.forEach((s) => s()), r = [];
    };
    return await new Promise((s, y) => {
      const u = setTimeout(() => {
        this.disposeClient(t), l(new Vh("Timeout opening websocket connection to Gadget API"));
      }, a), c = (d) => {
        if (ho(d)) {
          if (d.code == vo.TooManyRequests)
            return o(), l(new $h(d.reason));
          if (ny.includes(d.code) && i > 0) {
            i -= 1, this.disposeClient(t), t = this.newSubscriptionClient(n), h();
            return;
          }
        }
        clearTimeout(u), y(new ws(d));
      }, l = (d) => {
        clearTimeout(u), y(d);
      }, p = () => {
        clearTimeout(u), s(t);
...
class $n extends Array {
  ...
  firstOrThrow() {
    if (!this[0])
      throw new Fi("No records found.", "GGT_RECORD_NOT_FOUND");
    return this[0];
  }
  toJSON() {
  ...
  async nextPage() {
    var n;
    if (!this.hasNextPage)
      throw new po("Cannot request next page because there isn't one, should check 'hasNextPage' to see if it exists");
  ...
  async previousPage() {
    ...
    if (!this.hasPreviousPage)
      throw new po("Cannot request previous page because there isn't one, should check 'hasPreviousPage' to see if it exists");
...
const bo = (e) => Object.entries(e).flatMap(([n, t]) => {
  if (typeof t == "boolean")
    return t ? n : !1;
  if (t instanceof Wo) {
    let r = "";
    const i = Object.entries(t.args).filter(([a, o]) => o != null).map(([a, o]) => {
      var s;
      return `${a}: ${o instanceof Ho ? `$${(s = o.name) !== null && s !== void 0 ? s : a}` : JSON.stringify(o)}`;
    });
    return i.length > 0 && (r = `(${i.join(", ")})`), t.subselection ? [`${n}${r} {`, ...bo(t.subselection), "}"] : `${n}${r}`;
  } else
    return [`${n} {`, ...bo(t), "}"];
}).filter((n) => !!n).map((n) => "  " + n), qo = (e) => {
  const n = {}, t = (r) => {
    let i = 1;
    if (n[r]) {
      for (; n[`${r}${i}`]; )
  ...
  return Object.entries(e).forEach(([r, i]) => {
    i instanceof Wo ? Object.entries(i.args).forEach(([a, o]) => {
      var s;
      o instanceof Ho && (n[(s = o.name) !== null && s !== void 0 ? s : t(a)] = o);
    }) : typeof i == "object" && i !== null && Object.assign(n, qo(i));
  }), n;
}, oy = (e) => {
  const n = qo(e.fields);
...
const Kn = (e, n) => new Wo(e, n), et = (e) => new Ho(e.type + (e.required ? "!" : ""), e.name, e.value), uy = (e) => {
  var n;
  const t = oy(e), r = e.directives && e.directives.length > 0 ? ` ${e.directives.join(" ")}` : "";
...
class Et {
  constructor(n, t, r) {
    Object.defineProperty(this, "apiIdentifier", {
      ...
      writable: !0,
      value: void 0
    }), this.capitalizedApiIdentifier = Vi(n);
  }
  validateRecord(n) {
  ...
  getRecordFromData(n, t) {
    ...
    if (!this.validateRecord(n))
      throw new Fi(`Invalid arguments found in variables. Did you mean to use ${t}({ ${this.apiIdentifier}: { ... } })?`, "GGT_INVALID_RECORD_DATA");
  ...
  async findOne(n, t, r = !0) {
    const i = await this.connection.currentClient.query(sy(this.apiIdentifier), { id: n, select: Cl(t == null ? void 0 : t.select) }).toPromise(), o = (r ? $t : yr)(i, ["internal", this.apiIdentifier]);
    return vr(i, o);
  }
  /**
   ...
   */
  async findMany(n) {
    const t = ly(this.apiIdentifier, n), r = await this.connection.currentClient.query(t.query, t.variables).toPromise(), i = yr(r, ["internal", `list${this.capitalizedApiIdentifier}`]), a = Or(r, i);
  ...
  async findFirst(n, t = !0) {
    const r = cy(this.apiIdentifier, n), i = await this.connection.currentClient.query(r.query, r.variables).toPromise();
    let a;
   ...
   */
  async create(n) {
    const t = await this.connection.currentClient.mutation(fy(this.apiIdentifier), {
      record: this.getRecordFromData(n, "create")
    }).toPromise(), r = sn(t, ["internal", `create${this.capitalizedApiIdentifier}`]);
  ...
  async bulkCreate(n) {
    ...
    if (!(!((t = this.options) === null || t === void 0) && t.pluralApiIdentifier))
      throw new po("Cannot perform bulkCreate without a pluralApiIdentifier");
    const r = kt(this.options.pluralApiIdentifier), i = await this.connection.currentClient.mutation(dy(this.apiIdentifier, this.options.pluralApiIdentifier), {
      records: n
    }).toPromise(), a = sn(i, ["internal", `bulkCreate${r}`]);
    return Go(i, a[this.options.pluralApiIdentifier]);
  }
  /**
   ...
   */
  async update(n, t) {
    Cs(n, "Can't update a record without an ID passed");
    const r = await this.connection.currentClient.mutation(py(this.apiIdentifier), {
      id: n,
      record: this.getRecordFromData(t, "update")
    }).toPromise(), i = sn(r, ["internal", `update${this.capitalizedApiIdentifier}`]);
   ...
   */
  async delete(n) {
    Cs(n, "Can't delete a record without an ID");
    const t = await this.connection.currentClient.mutation(hy(this.apiIdentifier), { id: n }).toPromise();
    sn(t, ["internal", `delete${this.capitalizedApiIdentifier}`]);
  }
  /**
   ...
   */
  async deleteMany(n) {
    const t = await this.connection.currentClient.mutation(yy(this.apiIdentifier), n).toPromise();
    sn(t, ["internal", `deleteMany${this.capitalizedApiIdentifier}`]);
  }
}
function Cl(e) {
  if (!e)
...
const zo = (e) => ({
  ...
  return typeof n < "u" && (a.id = et({ type: "GadgetID!", value: n })), Jn({
    ...
    name: e,
    fields: {
      [e]: Kn(a, Qo((i == null ? void 0 : i.select) || t, !0)),
      ...zo(r)
    },
    directives: $i(i)
  });
}, my = (e, n, t, r, i, a) => Yo(e, r, i, {
  ...a,
  first: 2,
  filter: {
    [n]: {
  ...
  fields: {
    [e]: Kn({
      ...
      sort: r != null && r.sort ? et({ value: r.sort, type: `[${Wh(t)}!]` }) : void 0,
      filter: r != null && r.filter ? et({ value: r.filter, type: `[${Hh(t)}!]` }) : void 0,
      search: r != null && r.search ? et({ value: r.search, type: "String" }) : void 0
    }, {
      pageInfo: { hasNextPage: !0, hasPreviousPage: !0, startCursor: !0, endCursor: !0 },
      edges: {
        cursor: !0,
        node: Qo((r == null ? void 0 : r.select) || n, !0)
      }
    }),
    ...zo(t)
  },
...
}, Nl = (e) => Object.fromEntries(Object.entries(e).map(([n, t]) => [n, et(t)])), by = (e, n, t, r, i, a, o, s, y) => {
  ...
  const s = vy(n, t, r, i, a), y = await e.connection.currentClient.query(s.query, s.variables).toPromise(), c = (o ? $t : yr)(y, [n]);
  return vr(y, c);
}, Gi = async (e, n, t, r, i, a, o) => {
  const s = my(n, t, r, i, a, o), y = await e.connection.currentClient.query(s.query, s.variables).toPromise(), u = $t(y, [n]), c = Or(y, u);
  if (c.length > 1)
    throw zh(a, t, r);
  return c[0];
}, ue = async (e, n, t, r, i, a) => {
  const o = Yo(n, t, r, i), s = await e.connection.currentClient.query(o.query, o.variables).toPromise();
  let y;
  a === !1 ? y = yr(s, [n]) : y = $t(s, [n], a);
  const u = Or(s, y);
  return $n.boot(e, u, { options: i, pageInfo: y.pageInfo });
}, M = async (e, n, t, r, i, a, o, s, y, u) => {
  const c = by(n, t, r, i, o, s, y, a, u), l = await e.connection.currentClient.mutation(c.query, c.variables).toPromise(), p = y ? [y, n] : [n];
  if (a) {
    const h = Vn(l.data, p), d = h[i] && t ? Go(l, h[i]) : void 0;
    if (h.errors) {
      const f = h.errors.map((v) => $o(v));
      throw new qh(f, d);
    }
    return d;
  } else {
  ...
  const i = gy(n, t, r), a = await e.currentClient.mutation(i.query, i.variables).toPromise();
  return sn(a, r ? [r, n] : [n]).result;
};
function q(e, n, t = {}) {
  var a;
...
var Rl;
const pa = "production", Yr = "development", yv = Symbol.for("gadget/modelRelationships"), vv = () => {
  try {
...
let mv = class {
  constructor(n) {
    ...
    const t = (n == null ? void 0 : n.environment) ?? vv() ?? Yr;
    let r = t.toLocaleLowerCase();
    r != Yr && r != pa && (console.warn("Invalid environment", t, "defaulting to development"), r = Yr);
    ...
    if (this.connection = new Il({
      endpoint: new URL("api/graphql", r == pa ? this.productionApiRoot : this.developmentApiRoot).toString(),
      applicationId: this.applicationId,
      authenticationMode: (n == null ? void 0 : n.authenticationMode) ?? (typeof window > "u" ? { anonymous: !0 } : { browserSession: !0 }),
      ...n,
      exchanges: i,
      environment: r == pa ? "Production" : "Development"
    ...
    this.user = new Sy(this.connection), this.session = new Iy(this.connection), this.productPairing = new Ny(this.connection), this.unambiguous = new Dy(this.connection), this.shopifyProduct = new Fy(this.connection), this.shopifyProductImage = new qy(this.connection), this.shopifyProductOption = new Qy(this.connection), this.shopifyProductVariant = new Xy(this.connection), this.shopifyShop = new rv(this.connection), this.shopifySync = new uv(this.connection), this.ambiguous = new fv(this.connection), this.currentSession = new hv(this.connection), this.internal = {
...
Rl = yv;
var Ml = {}, qi = Rt.createContext(Ml), bv = qi.Provider;
qi.Consumer;
qi.displayName = "UrqlContext";
var gv = () => {
  var e = Rt.useContext(qi);
  ...
  extensions: void 0,
  operation: void 0
}, Ov = (e, n) => e === n || !(!e || !n || e.key !== n.key), ha = (e, n) => {
  var t = {
    ...e,
    ...n,
  ...
  return ((r, i) => {
    for (var a in r)
      if (!(a in i))
        return !0;
    for (var o in i)
      if (o === "operation" ? !Ov(r[o], i[o]) : r[o] !== i[o])
        return !0;
    return !1;
  })(e, t) ? t : e;
}, Av = (e, n) => {
  for (var t = 0, r = n.length; t < r; t++)
    if (e[t] !== n[t])
      return !0;
  return !1;
}, ya = Rt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
function Us(e, n) {
  process.env.NODE_ENV !== "production" && ya && ya.ReactCurrentOwner && ya.ReactCurrentOwner.current ? Promise.resolve(n).then(e) : e(n);
}
function Pv(e, n) {
...
var Sv = (e) => {
  ...
  return e._react;
}, Ev = (e, n) => e.suspense && (!n || n.suspense !== !1);
function Tv(e) {
  var n = gv(), t = Sv(n), r = Ev(n, e.context), i = Pv(e.query, e.variables), a = Rt.useMemo(() => {
    if (e.pause)
      return null;
  ...
  }, [t, i]), s = [n, i, e.requestPolicy, e.context, e.pause], [y, u] = Rt.useState(() => [a, ha(_v, o(a, r)), s]), c = y[1];
  a !== y[0] && Av(y[2], s) && u([a, c = ha(y[1], o(a, r)), s]), Rt.useEffect(() => {
...
const kl = oe.createContext(void 0), Iv = oe.createContext(void 0), wv = "/", Cv = "signOut", jv = "/";
function Nv(e) {
  let n, t;
  if ("api" in e) {
    if (!vd(e.api))
  ...
  return oe.createElement(
    ...
    oe.createElement(
      ...
      oe.createElement(bv, { value: t }, e.children)
    )
  );
}
const Rv = "Could not find a client in the context of Provider. Please ensure you wrap the root component in a <Provider>", Mv = (e, n) => {
  let t = "";
  return e !== void 0 ? t = `[Network] ${e.message}` : n !== void 0 ? n.forEach((r) => {
    t += `[GraphQL] ${r.message}
`;
  }) : t = "Unknown error", t.trim();
}, kv = (e) => typeof e == "string" ? new ae(e) : e != null && e.message && !e.code ? new ae(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : e;
class cn extends Error {
  ...
  static errorIfDataAbsent(n, t, r = !1) {
    const i = Qh(n, t);
    let a = cn.forMaybeCombinedError(n.error);
    return !a && i && !r && (a = cn.forClientSideError(i)), a;
  }
  constructor({ networkError: n, executionErrors: t, response: r }) {
    const i = (t || []).map(kv), a = Mv(n, i);
...
var Lv = typeof Element < "u", Uv = typeof Map == "function", Fv = typeof Set == "function", Vv = typeof ArrayBuffer == "function" && !!ArrayBuffer.isView;
function si(e, n) {
  if (e === n)
    return !0;
  if (e && n && typeof e == "object" && typeof n == "object") {
    ...
    var a;
    if (Uv && e instanceof Map && n instanceof Map) {
      if (e.size !== n.size)
        return !1;
    ...
    if (Fv && e instanceof Set && n instanceof Set) {
      if (e.size !== n.size)
        return !1;
      for (a = e.entries(); !(r = a.next()).done; )
        if (!n.has(r.value[0]))
    ...
    if (Vv && ArrayBuffer.isView(e) && ArrayBuffer.isView(n)) {
      if (t = e.length, t != n.length)
        return !1;
      for (r = t; r-- !== 0; )
        if (e[r] !== n[r])
...
const Gv = /* @__PURE__ */ Vc($v), qv = (e) => {
  const n = fd();
  return e ? (n.current === void 0 || !Gv(e, n.current)) && (n.current = e) : n.current = void 0, n.current;
}, Wv = (e, n) => {
  const t = qv(n), r = li(() => Yo(e.findMany.operationName, e.findMany.defaultSelection, e.findMany.modelApiIdentifier, t), [e, t]), [i, a] = Dl(Bv(r, n));
  return [li(() => {
    ...
    const u = cn.errorIfDataAbsent(i, s, n == null ? void 0 : n.pause);
    return { ...i, data: y, error: u };
  }, [e, n == null ? void 0 : n.pause, i]), a];
};
var Bl = {}, jt = {};
Object.defineProperty(jt, "__esModule", { value: !0 });
var Ll = jt.AppBridgeContext = void 0, Hv = oe;
Ll = jt.AppBridgeContext = Hv.createContext(null);
var tt = {};
Object.defineProperty(tt, "__esModule", { value: !0 });
tt.useAppBridge = void 0;
var zv = oe, Qv = jt;
function Yv() {
  var e = zv.useContext(Qv.AppBridgeContext);
  if (!e)
...
var Zt = {};
const Kv = "@shopify/app-bridge", Jv = "3.7.7", Xv = "index.d.ts", Zv = "index.js", xv = "umd/index.js", em = "umd/index.js", tm = [
  "/actions/",
  "/client/",
  "/umd/",
  "/utilities/",
...
}, rm = "git@github.com:Shopify/app-bridge.git", im = "https://shopify.dev/tools/app-bridge", am = "Shopify Inc.", om = "MIT", um = {
...
var Jt = {};
Object.defineProperty(Jt, "__esModule", { value: !0 });
Jt.removeFromCollection = Jt.addAndRemoveFromCollection = void 0;
function dm(e, n, t) {
  return e.push(n), function() {
    return Vl(e, n, t);
  };
}
Jt.addAndRemoveFromCollection = dm;
function Vl(e, n, t) {
...
}, hm = g && g.__spreadArray || function(e, n) {
...
var vm = Gn, _o = Jt, Kr = Ar, mm = le, bm = ym(Zn), va = se, Gl = (
  /** @class */
  function() {
    function e(n, t, r, i) {
      var a = this;
      this.app = n, this.type = t, this.group = r, this.subgroups = [], this.subscriptions = [], n || Kr.throwError(Kr.Action.INVALID_ACTION, "Missing required `app`"), this.id = i || bm.default(), this.defaultGroup = r;
      var o = this.set;
      this.set = function() {
        for (var s, y = [], u = 0; u < arguments.length; u++)
          y[u] = arguments[u];
        return a.app.hooks ? (s = a.app.hooks).run.apply(s, hm([vm.LifecycleHook.UpdateAction, o, a], y)) : o.apply(a, y);
      };
    }
    return e.prototype.set = function() {
      ...
      var t = this, r = [];
      return va.forEachInEnum(Kr.Action, function(i) {
        ...
        i.forEach(function(a) {
          _o.removeFromCollection(t.subscriptions, a, function(o) {
            o.unsubscribe();
          });
        });
      };
      ...
      Kr.isErrorEventName(n) ? u = va.getEventNameSpace(mm.Group.Error, n, _i(_i({}, o), { type: "" })) : u = va.getEventNameSpace(this.group, n, o);
      ...
      return n === void 0 && (n = !1), xo(this.subscriptions, this.defaultGroup, n), this;
    }, e;
  }()
);
de.ActionSet = Gl;
var gm = (
  ...
  function(e) {
    ...
    return n.prototype.unsubscribe = function(t, r) {
      return t === void 0 && (t = !0), r === void 0 && (r = !1), xo(this.subscriptions, this.defaultGroup, r), this.children.forEach(function(i) {
      ...
      var r = this;
      return _o.removeFromCollection(this.children, this.getChild(t), function() {
        var i = r.subscriptions.filter(function(a) {
          return a.component.id === t;
        });
        i.forEach(function(a) {
          _o.removeFromCollection(r.subscriptions, a, function(o) {
            o.unsubscribe();
          });
        });
      }), this;
...
vn.getSingleButton = void 0;
var _m = Gt;
function Om(e, n, t, r) {
  return e.addChild(n, e.group, t), e.subscribeToChild(n, _m.Action.UPDATE, r), n.payload;
}
vn.getSingleButton = Om;
(function(e) {
  var n = g && g.__extends || function() {
    var d = function(f, v) {
...
Hi.Features = void 0;
var Pm = se, Sm = de, ma = le, Fs = iu, Em = (
  /** @class */
  function(e) {
    Am(n, e);
    function n(t, r) {
      return e.call(this, t, ma.Group.Features, ma.Group.Features, r ? r.id : void 0) || this;
    }
    return n.prototype.dispatch = function(t, r) {
      switch (t) {
        case Fs.Action.REQUEST:
          this.dispatchFeaturesAction(Fs.Action.REQUEST, r);
          break;
      }
      return this;
    }, n.prototype.dispatchFeaturesAction = function(t, r) {
      this.app.dispatch(Pm.actionWrapper({
        group: ma.Group.Features,
        type: t,
        payload: Oi(Oi({}, r || {}), { id: this.id })
      }));
    }, n;
  }(Sm.ActionSet)
);
...
(function(e) {
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), t(Hi, e), t(iu, e);
})(ru);
(function(e) {
...
(function(e) {
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), t(Ql, e), t(au, e);
})(nu);
var Yl = {}, ou = {};
(function(e) {
  var n = g && g.__extends || function() {
...
(function(e) {
  ...
  var r = vn, i = se, a = de, o = le, s = Gt, y;
  (function(P) {
...
function Im(e, n, t, r) {
  ...
  return e.subscribeToChild(n, Tm.Action.UPDATE, r), { id: i, label: a, buttons: s, disabled: o, plain: y };
}
Ki.getGroupedButton = Im;
(function(e) {
  var n = g && g.__extends || function() {
    var m = function(b, O) {
  ...
  var r = de, i = Gt, a = hn, o = Ki, s = vn, y = se, u = le, c;
  (function(m) {
...
(function(e, n) {
  (function(t, r) {
    ...
    var r, i, a, o, s, y = -1, u = function(k) {
        ...
        var V, Y = p("CLS", 0), G = 0, te = [], Ne = function(ye) {
          ye.forEach(function(Ve) {
            if (!Ve.hadRecentInput) {
              var _n = te[0], Wt = te[te.length - 1];
              G && Ve.startTime - Wt.startTime < 1e3 && Ve.startTime - _n.startTime < 5e3 ? (G += Ve.value, te.push(Ve)) : (G = Ve.value, te = [Ve]);
            }
      ...
      N = N || {}, S(function() {
        ...
        var V, Y = p("INP"), G = function(Ne) {
          Ne.forEach(function(Ve) {
            Ve.interactionId && Bt(Ve), Ve.entryType === "first-input" && !Fe.some(function(_n) {
              return _n.entries.some(function(Wt) {
    ...
    }, tr = [2500, 4e3], qt = {}, en = function(k, N) {
      N = N || {}, S(function() {
      ...
      N = N || {};
      var V = p("TTFB"), Y = d(k, V, gn, N.reportAllChanges);
      $r(function() {
        var G = c();
        if (G) {
          ...
          V.value = Math.max(te - l(), 0), V.entries = [G], Y(!0), u(function() {
            V = p("TTFB", 0), (Y = d(k, V, gn, N.reportAllChanges))(!0);
          });
        }
      });
    };
    t.CLSThresholds = j, t.FCPThresholds = I, t.FIDThresholds = me, t.INPThresholds = Qe, t.LCPThresholds = tr, t.TTFBThresholds = gn, t.getCLS = B, t.getFCP = w, t.getFID = z, t.getINP = Vr, t.getLCP = en, t.getTTFB = tn, t.onCLS = B, t.onFCP = w, t.onFID = z, t.onINP = Vr, t.onLCP = en, t.onTTFB = tn, Object.defineProperty(t, "__esModule", { value: !0 });
  });
})(To, To.exports);
var wm = To.exports, pf = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 }), e.Action = void 0, function(n) {
...
At.isMobile = Cm;
function jm() {
  return Vs.isClient && window.top !== window.self || Vs.isUnframed;
}
At.isShopifyEmbedded = jm;
function hf() {
...
vt.isPerformanceOrWebVitalsAction = Dm;
function bf(e) {
...
var Jr = oe, gf = Dt, Lm = tt, Xr = gf.ContextualSaveBar.Action, Um = gf.ContextualSaveBar.create;
function Fm(e) {
  var n = e.discardAction, t = n === void 0 ? { onAction: function() {
    return null;
  } } : n, r = e.saveAction, i = r === void 0 ? { onAction: function() {
    return null;
  } } : r, a = e.fullWidth, o = e.leaveConfirmationDisable, s = e.visible, y = Lm.useAppBridge(), u = i.onAction, c = $s(i, ["onAction"]), l = t.onAction, p = $s(t, ["onAction"]), h = Jr.useMemo(function() {
    return Um(y, {
      saveAction: c,
      discardAction: p,
      fullWidth: a,
...
var $m = Vm(Jo);
Ko.default = $m.default;
var gu = {}, _u = {}, Gm = g && g.__extends || function() {
  var e = function(n, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
}(), qm = g && g.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(_u, "__esModule", { value: !0 });
var Wm = qm(oe), ba = Dt, Hm = jt, zm = (
  /** @class */
  function(e) {
    Gm(n, e);
    function n() {
    ...
    return n.prototype.componentDidMount = function() {
      var t = this.context;
      this.loading = ba.Loading.create(t), this.loading != null && this.loading.dispatch(ba.Loading.Action.START);
    }, n.prototype.componentWillUnmount = function() {
      this.loading != null && this.loading.dispatch(ba.Loading.Action.STOP);
    }, n.prototype.render = function() {
      return null;
    }, n.contextType = Hm.AppBridgeContext, n;
  }(Wm.default.Component)
);
_u.default = zm;
var Qm = g && g.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(gu, "__esModule", { value: !0 });
var Ym = Qm(_u);
gu.default = Ym.default;
var _f = {}, Ou = {}, yn = {}, Km = g && g.__createBinding || (Object.create ? function(e, n, t, r) {
  r === void 0 && (r = t), Object.defineProperty(e, r, { enumerable: !0, get: function() {
    return n[t];
  } });
} : function(e, n, t, r) {
  r === void 0 && (r = t), e[r] = n[t];
}), Jm = g && g.__setModuleDefault || (Object.create ? function(e, n) {
  Object.defineProperty(e, "default", { enumerable: !0, value: n });
} : function(e, n) {
  e.default = n;
}), Au = g && g.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var n = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && Km(n, e, t);
  return Jm(n, e), n;
}, ji = g && g.__spreadArray || function(e, n) {
  for (var t = 0, r = n.length, i = e.length; t < r; t++, i++)
    e[i] = n[t];
  return e;
};
Object.defineProperty(yn, "__esModule", { value: !0 });
yn.transformActions = yn.generateRedirect = void 0;
var Zr = Au(kr), Xm = Au(Wi), Io = Au(Qi);
function Of(e, n, t, r) {
  if (t === void 0 && (t = "APP"), n != null) {
    var i = Io.create(e), a = r === !0 ? {
      url: n,
      newContext: !0
    } : n;
    return function() {
...
yn.generateRedirect = Of;
function Zm(e, n) {
  return n === !0 ? Io.Action.REMOTE : Io.Action[e];
}
function xm(e, n) {
  var t = n.primaryAction, r = n.secondaryActions, i = n.actionGroups, a = eb(e, t), o = ji(ji([], tb(e, r)), nb(e, i));
  return {
    primary: a,
    secondary: o
  };
}
yn.transformActions = xm;
function Pu(e, n) {
...
function nb(e, n) {
  ...
  var t = ji([], n.map(function(r) {
    ...
    return Xm.create(e, { label: r.title, plain: r.plain, buttons: i });
  }));
  return t;
}
var Ni = g && g.__assign || function() {
...
var En = oe, Cn = zi, ib = yn, ab = tt;
function ob(e) {
  var n = ab.useAppBridge(), t = En.useRef(null), r = En.useRef({ open: !1 }), i = e.open, a = En.useRef(!1), o = En.useMemo(function() {
    e.primaryAction, e.secondaryActions;
    var s = rb(e, ["primaryAction", "secondaryActions"]);
    return Cn.create(n, Gs(n, s));
  }, [n]);
  return En.useEffect(function() {
    ...
    return y && (i ? (o.dispatch(Cn.Action.OPEN), t.current = document.activeElement) : (o.dispatch(Cn.Action.CLOSE), t.current != null && document.contains(t.current) && (t.current.focus(), t.current = null))), e.onClose != null && o.subscribe(Cn.Action.CLOSE, e.onClose), r.current = e, function() {
      o.unsubscribe();
    };
  }, [e, i]), En.useEffect(function() {
    return function() {
      r.current.open && o.dispatch(Cn.Action.CLOSE);
    };
  }, [o]), null;
}
function ub(e) {
...
function Gs(e, n, t) {
  var r = n.title, i = n.size, a = n.message, o = n.src, s = n.primaryAction, y = n.secondaryActions, u = n.loading, c = i == null ? void 0 : Cn.Size[i], l = {};
  return o != null && (o.match("^https?://") ? l.url = o : l.path = o), Ni(Ni({ title: r, message: a, size: c }, l), { footer: {
    buttons: ib.transformActions(e, {
      primaryAction: s,
      secondaryActions: y
    })
  }, loading: t ? void 0 : u });
...
Ou.default = ob;
var Su = {}, Eu = {}, sb = g && g.__extends || function() {
  var e = function(n, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
}(), cb = g && g.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Eu, "__esModule", { value: !0 });
var lb = cb(oe), fb = Dt, db = jt, pb = (
  /** @class */
  function(e) {
    sb(n, e);
    function n() {
    ...
    return n.prototype.componentDidMount = function() {
      var t = this.context;
      this.modalContent = fb.ModalContent.create(t), this.syncLoadingStatus();
      ...
      return null;
    }, n.contextType = db.AppBridgeContext, n;
  }(lb.default.Component)
);
Eu.default = pb;
var hb = g && g.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Su, "__esModule", { value: !0 });
var yb = hb(Eu);
Su.default = yb.default;
(function(e) {
...
var xr = oe, vb = mu, mb = vu, bb = tt;
function gb(e, n) {
  return e.destination.replace(/\/$/, "") === n.pathname.replace(/\/$/, "");
}
function _b(e) {
  var n = e.navigationLinks, t = e.matcher, r = t === void 0 ? gb : t, i = bb.useAppBridge(), a = xr.useState(), o = a[0], s = a[1];
  xr.useEffect(function() {
    var u = n.map(function(c) {
      return vb.create(i, c);
    });
    s(u);
  }, [i, JSON.stringify(n)]);
  ...
  return xr.useEffect(function() {
    o && mb.create(i, { items: o, active: y });
  }, [o, y]), null;
}
Iu.default = _b;
var Ob = g && g.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Tu, "__esModule", { value: !0 });
var Ab = Ob(Iu);
Tu.default = Ab.default;
var wu = {}, Af = {}, wo = { exports: {} }, ga = {}, _a = {}, Oa = {}, xn = {}, Pf = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 }), e.createTransportListener = e.fromWindow = e.fromFrame = e.Context = void 0;
  var n = Ar, t = vt, r = Gn, i = Jt, a = Ci;
  (function(c) {
...
function Sf() {
  if (qs)
    return nn;
  qs = 1, Object.defineProperty(nn, "__esModule", { value: !0 }), nn.mockAppBridge = nn.serverAppBridge = void 0;
  var e = mn, n = function() {
  }, t = new Promise(function() {
  });
  return nn.serverAppBridge = {
    dispatch: function() {
      return {};
    },
    error: function() {
...
function Cu() {
  if (Ws)
    return Tt;
  Ws = 1, Object.defineProperty(Tt, "__esModule", { value: !0 }), Tt.getWindow = Tt.getLocation = Tt.redirect = Tt.shouldRedirect = void 0;
  function e(a) {
    return a === window;
  }
  Tt.shouldRedirect = e;
...
function Pb() {
  if (Hs)
    return ar;
  Hs = 1, Object.defineProperty(ar, "__esModule", { value: !0 }), ar.handleAppPrint = void 0;
  var e = Cu();
  function n() {
...
function Eb() {
  if (Ys)
    return ei;
  Ys = 1, Object.defineProperty(ei, "__esModule", { value: !0 });
  var e = Sb(), n = (
    /** @class */
    function() {
      function t() {
...
function Js() {
  return Ks || (Ks = 1, function(e) {
    ...
    var i = Zt, a = Yi, o = mn, s = xn, y = Sf(), u = Dr, c = tu, l = bu, p = Pb(), h = Cu(), d = Ef(), f = r(Eb());
...
function Tr() {
  return Xs || (Xs = 1, function(e) {
    ...
    var r = Js();
    t(Ef(), e), t(Js(), e), e.default = r.createClientApp;
  }(_a)), _a;
}
var Zs;
function Tb() {
...
function jb() {
  if (uc)
    return rn;
  uc = 1, Object.defineProperty(rn, "__esModule", { value: !0 }), rn.validateAction = rn.validateProps = void 0;
  var e = Ti, n = Ii, t = ot(), r = ht(), i = se, a = If(), o = t.matchesObject({ id: t.matchesString(), options: a.linkPropsSchema });
  function s(p) {
    return [
      {
  ...
  return rn.validateAction = l, rn;
}
var Da = {}, or = {}, ur = {}, sc;
function Nb() {
  return sc || (sc = 1, Object.defineProperty(ur, "__esModule", { value: !0 }), ur.INTERNAL_PROTOCOL = void 0, ur.INTERNAL_PROTOCOL = "shopify:"), ur;
}
var cc;
function Rb() {
  if (cc)
    return or;
  cc = 1, Object.defineProperty(or, "__esModule", { value: !0 }), or.isSafe = void 0;
  var e = Nb(), n = /\/\/\//, t = /[/\\][/\\]/, r = ["https:", "http:"], i = "http://test.com";
  function a(y, u) {
...
function Bb() {
  return pc || (pc = 1, function(e) {
    ...
    var r = Gt, i = hn, a = ot(), o = ht(), s = Ji(), y = Tf(), u = a.composeSchemas(s.buttonSchema, a.matchesObject({
      id: a.matchesString()
    }));
...
function Vb() {
  return gc || (gc = 1, function(e) {
    ...
    var t = er(), r = bn(), i = t.matchesObject({
...
function zb() {
  return Ec || (Ec = 1, function(e) {
    ...
    var t = Tr(), r = xt, i = mn, a = Zt, o = Hb(), s = er(), y = bn();
    function u(f, v, m) {
      switch (v) {
        case r.Group.Button:
...
function Qb() {
  if (Tc)
    return ti;
  Tc = 1, Object.defineProperty(ti, "__esModule", { value: !0 });
  var e = zb();
...
function Yb() {
  return Ic || (Ic = 1, function(e) {
    ...
    var i = r(Qb()), a = bn(), o = Cu(), s = Tr(), y = Sf();
    function u(c) {
      var l = o.getWindow();
...
process.env.NODE_ENV === "production" ? wo.exports = Tb() : wo.exports = Yb();
var Kb = wo.exports, ju = {}, Nu = {}, Br = {};
Object.defineProperty(Br, "__esModule", { value: !0 });
Br.handleRouteChange = void 0;
var Jb = Dt;
function Xb(e, n) {
  return e.subscribe(Jb.Redirect.Action.APP, function(t) {
    var r = t.path;
    n.replace(r);
  });
}
Br.handleRouteChange = Xb;
var Zb = g && g.__extends || function() {
  var e = function(n, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
var eg = xb(oe), tg = jt, ng = Br, rg = (
  ...
  function(e) {
    ...
    return n.prototype.componentDidMount = function() {
      ...
      this.unsubscribe = ng.handleRouteChange(this.context, t);
    }, n.prototype.componentWillUnmount = function() {
      this.unsubscribe && this.unsubscribe();
    }, n.prototype.render = function() {
      return null;
    }, n.contextType = tg.AppBridgeContext, n;
  }(eg.default.Component)
);
Nu.default = rg;
var Ru = {};
Object.defineProperty(Ru, "__esModule", { value: !0 });
var ig = oe, ag = tt, og = Br;
function ug(e) {
  var n = ag.useAppBridge();
  ig.useEffect(function() {
    return og.handleRouteChange(n, e);
  }, [n, e]);
}
Ru.default = ug;
(function(e) {
...
Qt.getOrigin = Qt.getTopWindow = Qt.getSelfWindow = void 0;
function sg() {
  return window.self;
}
Qt.getSelfWindow = sg;
...
Qt.getOrigin = lg;
var fg = g && g.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, dg = g && g.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
function yg(e, n) {
  return fg(this, void 0, void 0, function() {
    ...
    return dg(this, function(l) {
      switch (l.label) {
        case 0:
          return t = Co.getSelfWindow(), r = Co.getTopWindow(), i = t === r, [4, e.getState("context").then(function(p) {
            return p === pg.Context.Main;
          })];
        case 1:
          return a = l.sent(), i || !a ? [
            2
            /*return*/
          ] : (o = vg(n), hg.forEach(function(p) {
            return o.searchParams.delete(p);
          }), s = o.pathname, y = o.search, u = o.hash, c = "" + s + y + u, wc.History.create(e).dispatch(wc.History.Action.REPLACE, c), [
            2
            /*return*/
          ]);
      }
...
}(), bg = g && g.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(ku, "__esModule", { value: !0 });
var gg = bg(oe), _g = jt, Cc = Lr, Og = (
  /** @class */
  function(e) {
    mg(n, e);
    function n() {
    ...
    return n.prototype.componentDidMount = function() {
      ...
      Cc.updateHistory(this.context, t);
    }, n.prototype.componentDidUpdate = function(t) {
      var r = t.location, i = this.props.location;
      i !== r && Cc.updateHistory(this.context, i);
    }, n.prototype.render = function() {
      return null;
    }, n.contextType = _g.AppBridgeContext, n;
  }(gg.default.Component)
);
ku.default = Og;
var Du = {};
Object.defineProperty(Du, "__esModule", { value: !0 });
var Ag = oe, Pg = tt, Sg = Lr;
function Eg(e) {
  var n = Pg.useAppBridge();
  Ag.useEffect(function() {
    Sg.updateHistory(n, e);
  }, [n, e]);
}
Du.default = Eg;
(function(e) {
...
const Tg = "@shopify/app-bridge-react", Ig = "3.0.0", wg = "index.d.ts", Cg = "index.js", jg = "umd/index.js", Ng = "umd/index.js", Rg = [
  "/components/",
  "/umd/",
  "/hooks/",
  "/utilities/",
  ...
  access: "public",
  "@shopify:registry": "https://registry.npmjs.org"
}, kg = "git@github.com:Shopify/app-bridge.git", Dg = "https://shopify.dev/tools/app-bridge/react-components", Bg = "Shopify Inc.", Lg = "MIT", Ug = {
...
}, qg = "7102c192814e6f3cf55daf81324b54a960ebe701", Wg = {
  name: Tg,
  version: Ig,
  types: wg,
  main: Cg,
...
(function(e) {
  ...
  var i = r(oe), a = r(Kb), o = jt, s = ju, y = Mu, u = Wg;
  function c(h) {
...
var Yg = Qg(wf);
Bu.default = Yg.default;
var Lu = {}, Uu = {};
Object.defineProperty(Uu, "__esModule", { value: !0 });
var Qa = oe, jo = kr, Kg = du, Cf = Wi, jf = yn, Jg = tt;
function Xg(e) {
  var n = e.title, t = Jg.useAppBridge(), r = Qa.useRef({ title: n }), i = Qa.useMemo(function() {
    return Kg.create(t, {});
  }, [t]);
  return Qa.useEffect(function() {
    ...
    if (r.current = e, o)
      ...
      Ir(l, i.options.breadcrumbs), Ir(s, (a = i.options.buttons) === null || a === void 0 ? void 0 : a.primary), Zg(i, y), xg(i, u);
    }
    return function() {
      i.unsubscribe();
    };
...
function Ir(e, n) {
  if (!(!e || !n)) {
    ...
    t && n.subscribe(jo.Action.CLICK, t, n), e != null && e.onAction && n.subscribe(jo.Action.CLICK, e.onAction, n);
  }
}
...
var i_ = g && g.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Fu, "__esModule", { value: !0 });
var a_ = i_(Nf);
Fu.default = a_.default;
(function(e) {
...
var Rf = {}, Mf = {}, Xi = {}, o_ = g && g.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, u_ = g && g.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
Xi.useAppBridgeState = void 0;
var sr = oe, s_ = tt, c_ = function(e) {
  var n = s_.useAppBridge(), t = sr.useState(), r = t[0], i = t[1], a = sr.useRef(!1), o = sr.useCallback(function() {
    return o_(void 0, void 0, void 0, function() {
      var s, y;
      return u_(this, function(u) {
        switch (u.label) {
          case 0:
...
(function(e) {
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), t(Xi, e);
})(Mf);
var kf = {}, Zi = {}, jc = g && g.__rest || function(e, n) {
  var t = {};
  for (var r in e)
    Object.prototype.hasOwnProperty.call(e, r) && n.indexOf(r) < 0 && (t[r] = e[r]);
  if (e != null && typeof Object.getOwnPropertySymbols == "function")
...
Zi.useContextualSaveBar = void 0;
var Nt = oe, an = hu, l_ = tt;
function f_() {
  var e = l_.useAppBridge(), n = Nt.useState(), t = n[0], r = n[1], i = Nt.useState(), a = i[0], o = i[1], s = Nt.useMemo(function() {
    return an.create(e);
  }, [e]), y = Nt.useCallback(function(p) {
    s.dispatch(an.Action.SHOW), p && s.set(p);
  }, [s]), u = Nt.useCallback(function() {
    s.dispatch(an.Action.HIDE);
  }, [s]), c = Nt.useMemo(function() {
    return {
      setOptions: function(p) {
        var h = p.onAction, d = jc(p, ["onAction"]);
        r(function() {
          return h;
  ...
  return Nt.useEffect(function() {
    return s.subscribe(an.Action.DISCARD, function() {
      s.dispatch(an.Action.HIDE), a == null || a();
    });
  }, [s, a]), Nt.useEffect(function() {
    return s.subscribe(an.Action.SAVE, function() {
      s.dispatch(an.Action.HIDE), t == null || t();
    });
  }, [s, t]), Nt.useEffect(function() {
    s.unsubscribe();
  }, [s, t]), { show: y, hide: u, saveAction: c, discardAction: l };
}
Zi.useContextualSaveBar = f_;
(function(e) {
...
var Vu = {}, xi = {}, d_ = g && g.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, p_ = g && g.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
var cr = oe, h_ = au, y_ = tt;
function v_() {
  for (var e = this, n = [], t = 0; t < arguments.length; t++)
    n[t] = arguments[t];
  var r = y_.useAppBridge(), i = cr.useState(), a = i[0], o = i[1], s = cr.useRef([]), y = cr.useCallback(function() {
    var u = !1;
    return function() {
      return d_(e, void 0, void 0, function() {
        var c;
        return p_(this, function(l) {
          switch (l.label) {
            case 0:
  ...
  return cr.useEffect(function() {
    ...
    var u, c = r.subscribe(h_.Action.UPDATE, function() {
      u = y();
    });
    return function() {
      c(), u == null || u();
...
ea.useFeatureRequest = void 0;
var ni = oe, Nc = nu, m_ = tt, b_ = Vu;
function g_(e, n) {
  var t = m_.useAppBridge(), r = b_.useFeaturesAvailable(), i = ni.useState(), a = i[0], o = i[1], s = ni.useCallback(function(y) {
  ...
  return ni.useEffect(function() {
    Nc.create(t).dispatch(Nc.Action.REQUEST, { feature: e, action: n });
  }, [t, e, n]), ni.useEffect(function() {
    s(r);
  }, [r, s]), a;
}
ea.useFeatureRequest = g_;
(function(e) {
  var n = g && g.__createBinding || (Object.create ? function(r, i, a, o) {
    o === void 0 && (o = a), Object.defineProperty(r, o, { enumerable: !0, get: function() {
      return i[a];
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), t(ea, e);
})(Df);
var Bf = {}, Wn = {}, $u = {}, ta = {};
Object.defineProperty(ta, "__esModule", { value: !0 });
ta.useNavigationHistory = void 0;
var __ = oe, Ya = Dt, O_ = tt;
function A_() {
  var e = O_.useAppBridge();
  return __.useMemo(function() {
    var n = Ya.History.create(e);
    function t(i) {
      n.dispatch(Ya.History.Action.PUSH, i.pathname);
    }
    function r(i) {
      n.dispatch(Ya.History.Action.REPLACE, i.pathname);
    }
    return { push: t, replace: r };
  }, []);
}
ta.useNavigationHistory = A_;
(function(e) {
...
}, P_ = g && g.__createBinding || (Object.create ? function(e, n, t, r) {
  r === void 0 && (r = t), Object.defineProperty(e, r, { enumerable: !0, get: function() {
    return n[t];
  } });
} : function(e, n, t, r) {
  r === void 0 && (r = t), e[r] = n[t];
}), S_ = g && g.__setModuleDefault || (Object.create ? function(e, n) {
  Object.defineProperty(e, "default", { enumerable: !0, value: n });
} : function(e, n) {
  e.default = n;
}), E_ = g && g.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var n = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && P_(n, e, t);
  return S_(n, e), n;
};
Object.defineProperty(Wn, "__esModule", { value: !0 });
Wn.isAdminSection = Wn.useNavigate = void 0;
var Ka = oe, Tn = E_(Qi), T_ = tt, I_ = $u;
function w_() {
  var e = T_.useAppBridge(), n = I_.useNavigationHistory(), t = Ka.useMemo(function() {
    return Tn.create(e);
  }, [e]), r = Ka.useCallback(function(i, a) {
    var o = C_(i), s = o.startsWith(e.localOrigin), y = o.startsWith(e.hostOrigin), u = o.startsWith("/");
    if (s || y || u) {
      var c = Uf(o);
      if (y || (a == null ? void 0 : a.target) === "new" || (a == null ? void 0 : a.target) === "host") {
        t.dispatch(Tn.Action.ADMIN_PATH, {
      ...
      t.dispatch(Tn.Action.APP, c);
      return;
    }
    t.dispatch(Tn.Action.REMOTE, {
      url: o,
      newContext: (a == null ? void 0 : a.target) === "new"
    });
  }, [t, n]);
  return Ka.useCallback(function(i, a) {
    if (Lf(i)) {
      var o = Hn(Hn({}, i), { name: Tn.ResourceType[i.name] });
      t.dispatch(Tn.Action.ADMIN_SECTION, {
        section: o,
        newContext: (a == null ? void 0 : a.target) === "new"
      });
      return;
...
mt.isShopifyPing = Wf;
var M_ = g && g.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, k_ = g && g.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
var D_ = zi, B_ = xn, L_ = mt, Ro = "app-bridge-utils-modal-auto-size", ri = U_();
function U_() {
  if (typeof document > "u")
    return null;
  var e = document.createElement("style");
  return e.type = "text/css", e.innerHTML = "." + Ro + " { overflow: hidden; height: auto; min-height: auto; }", e;
}
function F_(e, n) {
  if (!ri)
    return function() {
  ...
  t.appendChild(ri), r.add(Ro);
  var i = Hf(e, n);
  return function() {
    r.remove(Ro), t.contains(ri) && t.removeChild(ri), i && i.disconnect();
  };
}
function V_(e) {
  return M_(this, void 0, void 0, function() {
    ...
    function t(i) {
      ...
      return L_.isMobile() || a !== B_.Context.Modal ? (n(), n) : (r || (r = F_(e, o)), n);
    }
    var r;
    return k_(this, function(i) {
      switch (i.label) {
        case 0:
...
function Hf(e, n) {
  ...
  function s() {
    ...
    y !== t && (t = y, e.dispatch(D_.updateModalSize({ id: n, height: String(y) })));
  }
  return a;
}
zn.createMutationObserver = Hf;
var zf = {}, Ur = {}, $_ = g && g.__createBinding || (Object.create ? function(e, n, t, r) {
  r === void 0 && (r = t), Object.defineProperty(e, r, { enumerable: !0, get: function() {
    return n[t];
  } });
} : function(e, n, t, r) {
  r === void 0 && (r = t), e[r] = n[t];
}), G_ = g && g.__setModuleDefault || (Object.create ? function(e, n) {
  Object.defineProperty(e, "default", { enumerable: !0, value: n });
} : function(e, n) {
  e.default = n;
}), q_ = g && g.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var n = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && $_(n, e, t);
  return G_(n, e), n;
}, W_ = g && g.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, H_ = g && g.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
function z_(e) {
  return W_(this, void 0, void 0, function() {
    return H_(this, function(n) {
      return [2, new Promise(function(t, r) {
        var i = e.subscribe(kc.Action.RESPOND, function(a) {
          var o = a.sessionToken;
          o ? t(o) : r(Dc.fromAction("Failed to retrieve a session token", Dc.Action.FAILED_AUTHENTICATION)), i();
        });
        e.dispatch(kc.request());
      })];
    });
  });
}
Ur.getSessionToken = z_;
var na = {}, Ri = g && g.__assign || function() {
...
}, Q_ = g && g.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, Y_ = g && g.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
na.authenticatedFetch = void 0;
var K_ = Ur;
function J_(e, n) {
  var t = this;
  return n === void 0 && (n = fetch), function(r, i) {
    return i === void 0 && (i = {}), Q_(t, void 0, void 0, function() {
      var a, o, s;
      return Y_(this, function(y) {
        switch (y.label) {
          case 0:
            return [4, K_.getSessionToken(e)];
          case 1:
            return a = y.sent(), o = new Headers(i.headers), o.append("Authorization", "Bearer " + a), o.append("X-Requested-With", "XMLHttpRequest"), s = {}, o.forEach(function(u, c) {
              s[c] = u;
            }), [2, n(r, Ri(Ri({}, i), { headers: s }))];
        }
      });
    });
  };
}
na.authenticatedFetch = J_;
(function(e) {
  var n = g && g.__createBinding || (Object.create ? function(r, i, a, o) {
    o === void 0 && (o = a), Object.defineProperty(r, o, { enumerable: !0, get: function() {
      return i[a];
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), t(Ur, e), t(na, e);
})(zf);
var Qf = {}, Fr = {}, Yf = {};
(function(e) {
...
var X_ = g && g.__createBinding || (Object.create ? function(e, n, t, r) {
  r === void 0 && (r = t), Object.defineProperty(e, r, { enumerable: !0, get: function() {
    return n[t];
  } });
} : function(e, n, t, r) {
  r === void 0 && (r = t), e[r] = n[t];
}), Z_ = g && g.__setModuleDefault || (Object.create ? function(e, n) {
  Object.defineProperty(e, "default", { enumerable: !0, value: n });
} : function(e, n) {
  e.default = n;
  ...
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && X_(n, e, t);
  return Z_(n, e), n;
}, eO = g && g.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, tO = g && g.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
}, nO = g && g.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Fr, "__esModule", { value: !0 });
Fr.getAuthorizationCodePayload = void 0;
var Bc = x_(Xo), Lc = mn, rO = nO(Yf);
function iO(e) {
  return eO(this, void 0, void 0, function() {
    return tO(this, function(n) {
      return [2, new Promise(function(t, r) {
        var i = rO.default(), a = e.subscribe(Bc.Action.RESPOND, function(o) {
          switch (o == null ? void 0 : o.status) {
            case "needsExchange":
              t(o);
              break;
            default:
              r(Lc.fromAction("Failed to retrieve an authorization code", Lc.Action.FAILED_AUTHENTICATION));
          }
          a();
        }, i);
        e.dispatch(Bc.request(i));
      })];
    });
  });
}
Fr.getAuthorizationCodePayload = iO;
var ra = {}, aO = g && g.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, oO = g && g.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
ra.userAuthorizedFetch = void 0;
var uO = Fr, sO = "auth/shopify/callback";
function cO(e) {
  var n = e.headers.get("X-Shopify-API-Request-Failure-Unauthorized");
  return n ? n.toLowerCase() === "true" : !1;
}
function lO(e) {
  var n = this, t = e.app, r = e.callbackUri, i = r === void 0 ? sO : r, a = e.isAuthorizationCodeRequired, o = a === void 0 ? cO : a, s = e.fetchOperation;
  return function(y, u) {
    return aO(n, void 0, void 0, function() {
      var c, l, p, h, d, f, v, m;
      return oO(this, function(b) {
        switch (b.label) {
          case 0:
            return [4, s(y, u)];
          case 1:
            return c = b.sent(), o(c) ? [4, uO.getAuthorizationCodePayload(t)] : [2, c];
          case 2:
...
(function(e) {
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), t(Fr, e), t(ra, e);
})(Qf);
(function(e) {
  var n = g && g.__createBinding || (Object.create ? function(r, i, a, o) {
    o === void 0 && (o = a), Object.defineProperty(r, o, { enumerable: !0, get: function() {
...
`, dO = dd(({ children: e, forceRedirect: n, isEmbedded: t, gadgetAppUrl: r, originalQueryParams: i, api: a, isRootFrameRequest: o, type: s, isInstallRequest: y }) => {
  var b, O;
  const u = Uc(Ll), [c, l] = Fc({
    isAuthenticated: !1,
    isEmbedded: !1,
    canAuth: !1,
    loading: !0,
    ...
    a.connection.setAuthenticationMode({
      custom: {
        async processFetch(_, T) {
          ...
          P.append("Authorization", `ShopifySessionToken ${await No.getSessionToken(u)}`), T.headers ?? (T.headers = {}), P.forEach(function(E, S) {
            T.headers[S] = E;
          });
        },
        async processTransactionConnectionParams(_) {
          _.auth.shopifySessionToken = await No.getSessionToken(u);
        }
      }
  ...
  let _ = oe.createElement(
    Nv,
    { api: r },
    oe.createElement(dO, { forceRedirect: b, isEmbedded: f, gadgetAppUrl: O, api: r, originalQueryParams: l, isRootFrameRequest: m, type: c, isInstallRequest: !!p }, n)
  );
  ...
  }), T && (_ = oe.createElement(j_.Provider, { config: {
    apiKey: t,
    host: u,
    forceRedirect: b
  }, router: i }, _)), _;
  ...
  const [{ data: e }] = Wv(Kf.shopifyProduct);
  return /* @__PURE__ */ fi.jsx(fi.Fragment, { children: JSON.stringify(e) });
}, bO = () => /* @__PURE__ */ fi.jsx(pO, { api: Kf, shopifyApiKey: "deadbeef", children: /* @__PURE__ */ fi.jsx(yO, {}) });
export {
  bO as A,
  yO as R,
  g as c
