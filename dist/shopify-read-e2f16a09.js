...
import Ie, { useMemo as Sr, useContext as Qi, useRef as Nn, forwardRef as ja, useState as Mr, Children as Fa, useEffect as Me, memo as Ma, createContext as $a } from "react";
...
function Va() {
  return pi || (pi = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var W = _.ReactCurrentDispatcher, dt;
    function Ue(a, c, p) {
      {
        if (dt === void 0)
          try {
...
` + w[T].replace(" at new ", " at ");
                    return a.displayName && z.includes("<anonymous>") && (z = z.replace("<anonymous>", a.displayName)), typeof a == "function" && it.set(a, z), z;
                  }
                while (T >= 1 && C >= 0);
              break;
            }
      ...
      return typeof a == "function" && it.set(a, ur), ur;
    }
    function Hr(a, c, p) {
      return Jt(a, !1);
    }
    ...
    var ot = Object.prototype.hasOwnProperty, Qt = {}, Ht = _.ReactDebugCurrentFrame;
    function st(a) {
      if (a) {
        var c = a._owner, p = at(a.type, a._source, c ? c.type : null);
        Ht.setExtraStackFrame(p);
      } else
        Ht.setExtraStackFrame(null);
    }
    function Zr(a, c, p, v, O) {
      {
          ...
          if (A(a, k)) {
            ...
            try {
              if (typeof a[k] != "function") {
                var q = Error((v || "React class") + ": " + p + " type `" + k + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof a[k] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
            ...
            w && !(w instanceof Error) && (st(O), I("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", v || "React class", p, k, typeof w), st(null)), w instanceof Error && !(w.message in Qt) && (Qt[w.message] = !0, st(O), I("Failed %s type: %s", p, w.message), st(null));
          }
      }
    }
    ...
    function Zt(a) {
      if (rn(a))
        return I("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", tn(a)), Xt(a);
    }
    var Ve = _.ReactCurrentOwner, nn = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function dn(a, c, p, v, O) {
      {
        var A, k = {}, w = null, q = null;
        p !== void 0 && (Zt(p), w = "" + p), on(c) && (Zt(c.key), w = "" + c.key), an(c) && (q = c.ref, sn(c, O));
        for (A in c)
          ot.call(c, A) && !nn.hasOwnProperty(A) && (k[A] = c[A]);
        if (a && a.defaultProps) {
        ...
        return cn(a, w, q, O, v, Ve.current, k);
      }
    }
...
Check the top-level render call using <` + p + ">.");
    ...
    function ar(a, c) {
      {
        ...
        ir[p] = !0;
        var v = "";
        a && a._owner && a._owner !== Ot.current && (v = " It was passed a child from " + L(a._owner.type) + "."), Ee(a), I('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', p, v), Ee(null);
      }
    }
    function or(a, c) {
      {
    ...
    function hn(a) {
      {
        for (var c = Object.keys(a.props), p = 0; p < c.length; p++) {
          var v = c[p];
          if (v !== "children" && v !== "key") {
            Ee(a), I("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", v), Ee(null);
            break;
          }
        }
    ...
    var vn = bn, gn = mn;
    cr.Fragment = n, cr.jsx = vn, cr.jsxs = gn;
  }()), cr;
}
process.env.NODE_ENV === "production" ? En.exports = Ua() : En.exports = Va();
var $r = En.exports;
...
function Ka(e) {
  return e[Symbol.asyncIterator] ? Xi(e) : (t) => {
...
var Sn = {
  ...
  [Symbol.asyncIterator]() {
    var t = [], r = !1, n = ke, i;
    return e((o) => {
      r || (o === 0 ? (i && (i = i(Sn)), r = !0) : o.tag === 0 ? (n = o[0])(0) : i ? i = i({
        value: o[0],
        done: !1
      }) : t.push(o[0]));
    }), {
      async next() {
        return r && !t.length ? Sn : (!r && t.length <= 1 && n(0), t.length ? {
          value: t.shift(),
          done: !1
        } : new Promise((o) => i = o));
      },
      async return() {
        return r || (i = n(1)), r = !0, Sn;
      }
    };
  }
});
...
var Xa = /(?:null|true|false)/y, ea = /\$[_A-Za-z]\w*/y, Za = /-?\d+/y, eo = /(?:\.\d+)?[eE][+-]?\d+|\.\d+/y, to = /\\/g, ro = /"""(?:"""|(?:[\s\S]*?[^\\])""")/y, no = /"(?:"|[^\r\n]*?[^\\]")/y;
function qr(e) {
  var t, r;
  if (r = _e(Xa))
    t = r === "null" ? {
  ...
  (e = _e(co)) && (D(), t = nt(), r = function() {
    ...
    if (D(), K.charCodeAt(R) === 40) {
      for (R++, D(); s = _e(ea); ) {
        ...
        var l = ra(), f = void 0;
        if (K.charCodeAt(R) === 61 && (R++, D(), !(f = qr(!0))))
          throw ee("VariableDefinition");
        D(), u.push({
...
var Pn = (e, t) => {
  ...
  return r;
}, Dt = /* @__PURE__ */ new Set(), vi = /* @__PURE__ */ new WeakMap(), qt = (e) => {
  if (e === null || Dt.has(e))
    return "null";
  if (typeof e != "object")
    return JSON.stringify(e) || "";
  ...
  if (!(r == null || typeof r != "object" || r.toJSON || Dt.has(r)))
    if (Array.isArray(r))
      for (var n = 0, i = r.length; n < i; n++)
        Tn(e, `${t}.${n}`, r[n]);
    else if (r instanceof Ur || r instanceof Vr)
      e.set(t, r);
    else {
      Dt.add(r);
...
var Ur = typeof File < "u" ? File : Wt, Vr = typeof Blob < "u" ? Blob : Wt, bo = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g, vo = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g, go = (e, t) => t % 2 == 0 ? e.replace(vo, `
`) : e, gi = (e) => e.split(bo).map(go).join("").trim(), Si = /* @__PURE__ */ new Map(), Dr = /* @__PURE__ */ new Map(), Hn = (e) => {
  var t;
  return typeof e == "string" ? t = gi(e) : e.loc && Dr.get(e.__key) === e ? t = e.loc.source.body : (t = Si.get(e) || gi(Fe(e)), Si.set(e, t)), typeof e != "string" && !e.loc && (e.loc = {
    start: 0,
    end: t.length,
    source: {
      body: t,
...
# ${r}`, t));
  ...
  var n = t || {}, i = ia(e), o = Br(n), s = i.__key;
  return o !== "{}" && (s = Pn(o, s)), {
    key: s,
    query: i,
    variables: n,
    ...
    for (var l of s) {
      ...
      if (l.items)
        for (var m = +f >= 0 ? f : 0, g = 0, N = l.items.length; g < N; g++)
          d[m + g] = _n(d[m + g], l.items[g]);
      else
        l.data !== void 0 && (d[f] = _n(d[f], l.data));
    }
  else
...
var wo = (e, t) => {
  ...
  for (var i in t) {
    var o = t[i];
    o && n.searchParams.set(i, typeof o == "object" ? Br(o) : o);
  }
  var s = n.toString();
  ...
  if (t && !(e.kind === "query" && e.context.preferGetMethod)) {
    var r = Br(t), n = ((u) => {
      ...
      return (Ur !== Wt || Vr !== Wt) && (Dt.clear(), Tn(l, "variables", u)), l;
    })(t.variables);
    if (n.size) {
      var i = new FormData();
      i.append("operations", r), i.append("map", Br({
        ...[...n.keys()].map((u) => [u])
      }));
      var o = 0;
  ...
  try {
    ...
    if (/multipart\/mixed/i.test(s))
      u = async function* (d, y) {
        var h = d.match(Ao), m = "--" + (h ? h[1] : "-"), g = !0, N;
...
`)) {
    ...
    for await (var l of u)
      i = i ? Rn(i, l, o) : Cn(e, l, o), n = !1, yield i, n = !0;
    i || (yield i = Cn(e, {}, o));
  } catch (f) {
    if (!n)
      throw f;
    yield oa(e, o && (o.status < 200 || o.status >= 300) && o.statusText ? new Error(o.statusText) : f, o);
  }
}
function Po(e, t, r) {
  var n;
...
var xn = (e, t) => {
  if (Array.isArray(e))
    ...
    for (var n in e)
      n === "__typename" && typeof e[n] == "string" ? t.add(e[n]) : xn(e[n], t);
  return t;
}, Dn = (e) => {
  var t = !1;
  if ("definitions" in e) {
  ...
  var t = ia(e), r = Ai.get(t.__key);
  return r || (Ai.set(t.__key, r = Dn(t)), Object.defineProperty(r, "__key", {
    value: t.__key,
    enumerable: !1
  })), r;
}, jn = (e, t) => {
...
function Ni(e) {
  var t = (r) => e(r);
  return t.toPromise = () => Wr(Nr(1)(Z((r) => !r.stale && !r.hasNext)(t))), t.then = (r, n) => t.toPromise().then(r, n), t.subscribe = (r) => Ft(r)(t), t;
}
function zt(e, t, r) {
  return {
    ...t,
...
var Ei = (e, t) => zt(e.kind, e, {
...
}, wn = ({ kind: e }) => e !== "mutation" && e !== "query", _o = ({ forward: e, client: t, dispatchDebug: r }) => {
  ...
  return (u) => {
    var l = Vt((d) => {
    ...
    })(Z((d) => !wn(d) && s(d))(u)), f = jt((d) => {
      var { operation: y } = d;
      if (y) {
        var h = y.context.additionalTypenames || [];
        if (d.operation.kind !== "subscription" && (h = ((S) => [...xn(S, /* @__PURE__ */ new Set())])(d.data).concat(h)), d.operation.kind === "mutation" || d.operation.kind === "subscription") {
      ...
      cacheOutcome: "miss"
    }) : d)(Gt([Vt(o)(Z((d) => !wn(d) && !s(d))(u)), Z((d) => wn(d))(u)])))));
    return Gt([l, f]);
  };
}, Pi = (e, t) => e.reexecuteOperation(zt(t.kind, t, {
  requestPolicy: "network-only"
})), In = ({ forwardSubscription: e, enableAllOperations: t, isSubscriptionOperation: r }) => ({ client: n, forward: i }) => {
        ...
        return Jn(({ next: g, complete: N }) => {
          ...
          return Promise.resolve().then(() => {
            j || (_ = m.subscribe({
              ...
              complete() {
                j || (j = !0, h.kind === "subscription" && n.reexecuteOperation(zt("teardown", h, h.context)), I && I.hasNext && g(Rn(I, {
                  hasNext: !1
                })), N());
              }
            }));
...
}, r), ua = ({ onOperation: e, onResult: t, onError: r }) => ({ forward: n }) => (i) => wr((o) => {
  ...
  var h = (b) => {
    ...
    return b.kind !== "query" ? P = Hi((S) => !!S.hasNext, !0)(P) : P = hi((S) => {
      var U = hr(S);
    ...
    readQuery(b, P, S) {
      ...
      return Ft((Ae) => {
        U = Ae;
      })(g.query(b, P, S)).unsubscribe(), U;
    },
    query: (b, P, S) => g.executeQuery(mr(b, P), S),
    subscription: (b, P, S) => g.executeSubscription(mr(b, P), S),
    mutation: (b, P, S) => g.executeMutation(mr(b, P), S)
  }), N = Co;
  if (process.env.NODE_ENV !== "production") {
    var { next: j, source: _ } = mi();
    g.subscribeToDebugTarget = (b) => Ft(b)(_), N = j;
  }
...
const Fn = (e) => Object.entries(e).flatMap(([t, r]) => {
  if (typeof r == "boolean")
    return r ? t : !1;
  if (r instanceof Xn) {
    let n = "";
    ...
    return i.length > 0 && (n = `(${i.join(", ")})`), r.subselection ? [`${t}${n} {`, ...Fn(r.subselection), "}"] : `${t}${n}`;
  } else
    return [`${t} {`, ...Fn(r), "}"];
}).filter((t) => !!t).map((t) => "  " + t), Gr = (e) => {
  const t = {}, r = (n) => {
    let i = 1;
    if (t[n]) {
      for (; t[`${n}${i}`]; )
  ...
  return Object.entries(e).forEach(([n, i]) => {
    ...
    }), i.subselection && Object.assign(t, Gr(i.subselection))) : typeof i == "object" && i !== null && Object.assign(t, Gr(i));
  }), t;
}, jo = (e) => {
  const t = Gr(e.fields);
...
var la, ca, da, fa, pa, ye;
(function(e) {
  e[e.SinceLoaded = 0] = "SinceLoaded", e[e.SinceLastPersisted = 1] = "SinceLastPersisted";
})(ye || (ye = {}));
const se = Symbol.for("g/fields"), ht = Symbol.for("g/if"), mt = Symbol.for("g/pf"), bt = Symbol.for("g/fk"), pr = Symbol.for("g/t");
class qo {
  constructor(t) {
    var r, n;
    Object.defineProperty(this, la, {
      ...
      writable: !0,
      value: !1
    }), this[ht] = (r = Se(t)) !== null && r !== void 0 ? r : {}, this[mt] = (n = Se(t)) !== null && n !== void 0 ? n : {}, Object.assign(this[se], t), !t || Object.keys(t).length === 0 ? (this.empty = !0, this[bt] = /* @__PURE__ */ new Set()) : this[bt] = new Set(Object.keys(this[se]));
    const i = this, o = {
      get: (s, u) => {
        if (u in i || typeof u == "symbol") {
          let l = i[u];
          return typeof l == "function" && (l = l.bind(i)), l;
        } else if (u in s)
          return s[u];
      },
      set: (s, u, l) => (i.trackKey(u), s[u.toString()] = l, !0)
    };
    return new Proxy(this[se], o);
  }
  ...
  hasChanges(t = ye.SinceLoaded) {
    if (this[pr])
      return !0;
    const r = t == ye.SinceLoaded ? this[ht] : this[mt];
    return [...this[bt]].some((n) => !Cr(r[n], this[se][n]));
  }
  ...
  changes(t, r = ye.SinceLoaded) {
    const i = (typeof t == "string" ? r : t || r) == ye.SinceLoaded ? this[ht] : this[mt];
    if (t && typeof t == "string") {
      const o = i[t], s = this[se][t], u = !Cr(s, o);
      return u ? { changed: u, current: s, previous: o } : { changed: u };
    } else {
      const o = {};
      for (const s of this[bt])
        Cr(i[s], this[se][s]) || (o[s] = { current: this[se][s], previous: i[s] });
      return o;
    }
  }
  /** Returns all current values for fields that have changed */
  toChangedJSON(t = ye.SinceLoaded) {
    const r = t == ye.SinceLoaded ? this[ht] : this[mt], n = {};
    for (const i of this[bt])
      Cr(r[i], this[se][i]) || (n[i] = this[se][i]);
    return n;
  }
  ...
  flushChanges(t = ye.SinceLoaded) {
    t == ye.SinceLoaded ? this[ht] = Se(this[se]) : t == ye.SinceLastPersisted && (this[mt] = Se(this[se])), this[pr] = !1;
  }
  ...
  revertChanges(t = ye.SinceLoaded) {
    let r;
    t == ye.SinceLoaded ? r = Object.keys(this[ht]) : r = Object.keys(this[mt]);
    for (const n of this[bt])
      r.includes(n) || delete this[se][n];
    t == ye.SinceLoaded ? Object.assign(this[se], Se(this[ht])) : Object.assign(this[se], Se(this[mt])), this[pr] = !1;
  }
...
class Ci extends Error {
  constructor(t) {
    let r;
    qn(t) ? r = `GraphQL websocket closed unexpectedly by the server with error code ${t.code} and reason "${t.reason}"` : r = "GraphQL websocket closed unexpectedly by the server", super(r), Object.defineProperty(this, "code", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: "GGT_UNKNOWN"
...
}, qn = (e) => (e == null ? void 0 : e.type) == "close", ze = (e, t) => typeof e != "string" ? "" : Pr(e, t), _i = (e) => {
...
`)), e.error;
  ...
  var t;
  return e.code == "GGT_INVALID_RECORD" ? new Vo(e.message, e.validationErrors, (t = e.model) === null || t === void 0 ? void 0 : t.apiIdentifier, e.record) : e.code == "GGT_UNKNOWN" && e.message.includes("duplicate key value violates unique constraint") ? new ma(e.message) : new Kr(e.message, e.code);
}, vt = (e, t) => {
  const r = rt(e, t);
  return va(r);
}, va = (e) => {
  if (!e.success) {
    ...
    throw t ? ni(t) : new Kr("Gadget API operation not successful.", "GGT_UNKNOWN");
  }
  return e;
}, ga = (e) => {
  var t, r, n, i;
  ...
  return ii(e, r);
}, Bn = "[object Object]", Ri = "[object String]", Un = (e) => {
  if (e != null && typeof e.toJSON == "function" && (e = e.toJSON()), e !== void 0) {
    ...
    if (typeof e == "object") {
      ...
      if (Object.prototype.toString.call(e) === "[object Error]")
        return {};
      if (Object.prototype.toString.call(e) === Bn) {
        const t = {};
  ...
  try {
    const t = window[e];
    return t.setItem(kn, kn), t.removeItem(kn), !0;
  } catch {
    return !1;
  }
}, Di = Object.prototype.toString, ji = Object.getPrototypeOf, Fi = Object.getOwnPropertySymbols ? (e) => Object.keys(e).concat(Object.getOwnPropertySymbols(e)) : Object.keys, yr = (e, t, r) => {
  if (e === t)
    return !0;
  if (e == null || t == null)
    return !1;
  if (r.indexOf(e) > -1 && r.indexOf(t) > -1)
    return !0;
  const n = Di.call(e), i = Di.call(t);
  let o, s, u;
  if (r.push(e, t), n == Bn && i == Ri && "_link" in e && Object.keys(e).length == 1)
    return e._link === t;
  if (i == Bn && n == Ri && "_link" in t && Object.keys(t).length == 1)
    return t._link === e;
  if (n != i || (o = Fi(e), s = Fi(t), o.length != s.length || o.some(function(l) {
    return !yr(e[l], t[l], r);
  })))
    return !1;
  switch (n.slice(8, -1)) {
  ...
  for (const [n, i] of Object.entries(e))
    r[n] = { ...i, value: t[n] };
  return r;
}, St = (e, t) => (t && e.unshift(...Array.isArray(t) ? t : [t]), e), ct = (e, t) => {
...
class Yt extends Array {
  ...
  firstOrThrow() {
    if (!this[0])
      throw new Kr("No records found.", "GGT_RECORD_NOT_FOUND");
    return this[0];
  }
  toJSON() {
...
async function ns(e, t, r, n = {}) {
  ...
  try {
    const f = vt(u, l);
    return t.isBulk ? f.backgroundActions.map((d) => new jr(e, t, d.id)) : new jr(e, t, f.backgroundAction.id);
  } catch (f) {
    if ("code" in f && f.code == "GGT_DUPLICATE_BACKGROUND_ACTION_ID" && (n != null && n.id) && n.onDuplicateID == "ignore")
      return new jr(e, t, n.id);
    throw f;
  }
}
const is = async (e, t, r, n) => {
  ...
  }), Nr(1), Wr), u = rt(s, ["backgroundAction"]);
  switch (va(u.result), r.type) {
    case "action": {
    ...
    const [E, F] = await (S ?? (S = new Promise((G, Ne) => (async () => {
      ...
      P((J) => {
        ...
        try {
          ...
          b.emit("error", J), $.close(he.InternalClientError, Ui(J instanceof Error ? J.message : new Error(J).message, "Internal client error"));
        }
      };
      let Je = !1;
      $.onmessage = ({ data: J }) => {
        try {
          ...
          clearTimeout(De), Je = !0, b.emit("connected", $, W.payload), xe = !1, qe = 0, G([
            $,
            new Promise((dt, Ue) => P(Ue))
          ]);
        } catch (W) {
          $.onmessage = null, b.emit("error", W), $.close(he.BadResponse, Ui(W instanceof Error ? W.message : new Error(W).message, "Bad response"));
        }
      };
    })())));
...
const ms = 2, bs = 4800, vs = 1e4, gs = [he.ConnectionAcknowledgementTimeout, he.ConnectionInitialisationTimeout], Gi = Symbol.for("gadget/connection"), Ss = "token", ws = typeof btoa < "u" ? btoa : (e) => Buffer.from(e).toString("base64");
var ne;
(function(e) {
...
class Na {
  constructor(t) {
    ...
    if (Object.defineProperty(this, "options", {
      ...
      value: async (u, l) => {
        ...
        try {
          ...
          m[Gi] = this, h = new fs(m, y), this.currentTransaction = h, await h.start();
          const g = await f(h);
          ...
          try {
            ...
            g instanceof Aa || console.warn("Encountered another error while rolling back a Gadget transaction that errored. The other error:", g);
          }
          throw qn(m) ? new Ci(m) : m;
        } finally {
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof Rr < "u" && Rr.fetch ? this._fetchImplementation = Rr.fetch.bind(Rr) : this._fetchImplementation = async (...u) => {
      let l = await import("./browser-ponyfill-a8dc9816.js").then((f) => f.b);
  ...
  enableSessionMode(t) {
    ...
    const r = !t || typeof t == "boolean" ? gr.Durable : t.storageType;
    let n;
    r == gr.Durable && xi("localStorage") ? n = window.localStorage : r == gr.Session && xi("sessionStorage") ? n = window.sessionStorage : n = new ps(), t !== null && typeof t == "object" && "initialToken" in t && t.initialToken && n.setItem(this.sessionStorageKey, t.initialToken), this.sessionTokenStore = n, this.resetClients();
  }
  close() {
  ...
  newBaseClient() {
    const t = [...this.exchanges.beforeAll, Vi, hs];
  ...
  async waitForOpenedConnection(t) {
    ...
    const o = t.connectionGlobalTimeoutMs || vs, s = () => {
      n.forEach((u) => u()), n = [];
    };
    return await new Promise((u, l) => {
      const f = setTimeout(() => {
        ...
        if (qn(g)) {
          if (g.code == Vn.TooManyRequests)
            return s(), y(new Uo(g.reason));
          if (gs.includes(g.code) && i > 0) {
            i -= 1, this.disposeClient(r), r = this.newSubscriptionClient(t), m();
            return;
          }
        }
        clearTimeout(f), l(new Ci(g));
      }, y = (g) => {
        clearTimeout(f), l(g);
      }, h = () => {
        clearTimeout(f), u(r);
...
class Ge {
  ...
  getRecordFromData(t, r) {
    ...
    if (!this.validateRecord(t))
      throw new Kr(`Invalid arguments found in variables. Did you mean to use ${r}({ ${this.apiIdentifier}: { ... } })?`, "GGT_INVALID_RECORD_DATA");
  ...
  async findOne(t, r, n = !0) {
    const i = As(this.apiIdentifier, t, this.namespace, ci(r == null ? void 0 : r.select)), o = await this.connection.currentClient.query(i.query, i.variables).toPromise(), u = (n ? rt : br)(o, this.dataPath(this.apiIdentifier));
    return vr(o, u);
  }
  /**
   ...
   */
  async create(t) {
    const r = Ps(this.apiIdentifier, this.namespace, this.getRecordFromData(t, "create")), n = await this.connection.currentClient.mutation(r.query, r.variables).toPromise(), i = vt(n, this.dataPath(`create${this.capitalizedApiIdentifier}`));
    return vr(n, i[this.apiIdentifier]);
  }
  /**
  ...
  async bulkCreate(t) {
    ...
    const n = ze(this.options.pluralApiIdentifier), i = Ts(this.apiIdentifier, this.options.pluralApiIdentifier, this.namespace, t), o = await this.connection.currentClient.mutation(i.query, i.variables).toPromise(), s = vt(o, this.dataPath(`bulkCreate${n}`));
   ...
   */
  async update(t, r) {
    $n(t, "Can't update a record without an ID passed");
    const n = Cs(this.apiIdentifier, this.namespace, t, this.getRecordFromData(r, "update")), i = await this.connection.currentClient.mutation(n.query, n.variables).toPromise(), o = vt(i, this.dataPath(`update${this.capitalizedApiIdentifier}`));
    return vr(i, o[this.apiIdentifier]);
  }
  /**
   ...
   */
  async delete(t) {
    $n(t, "Can't delete a record without an ID");
    ...
    vt(n, this.dataPath(`delete${this.capitalizedApiIdentifier}`));
  }
  /**
  ...
  async deleteMany(t) {
    ...
    vt(n, this.dataPath(`deleteMany${this.capitalizedApiIdentifier}`));
  }
  dataPath(t) {
    ...
    switch (o.type) {
      ...
      case "get": {
        i.prototype.get = Object.assign(async function(s) {
          return await Mi(this, o.operationName, void 0, r, e, s);
        }, o);
        break;
      }
      case "action": {
...
const Te = {
  ...
  weightUnit: !0,
  zipCode: !0
}, Y = "shopifyShop", lt = "shopifyShops", Bs = $e(
  Y,
  lt,
  ve,
  [
  ...
  syncSince: !0,
  updatedAt: !0
}, ie = "shopifySync", ft = "shopifySyncs", Vs = $e(
  ie,
  ft,
  Ce,
  [
  ...
  createdAt: !0,
  updatedAt: !0
}, ae = "ambiguous", pt = "ambiguouss", Gs = $e(
  ae,
  pt,
  Le,
  [
  ...
  stringField: !0,
  updatedAt: !0
}, oe = "unambiguous", yt = "unambiguouss", Ls = $e(
  oe,
  yt,
  We,
  [
...
var Ta;
const zi = "production", Ks = "development", Ys = Symbol.for("gadget/modelRelationships"), Js = () => {
  try {
...
class Qs {
  constructor(t) {
    ...
    let r;
    this.apiRoots[this.environment] ? r = this.apiRoots[this.environment] : r = `https://related-products-example${this.environment == zi ? "" : `--${this.environment}`}.gadget.app`;
    const n = { ...t == null ? void 0 : t.exchanges };
    if (this.environment !== zi) {
      const o = ({ forward: s }) => (u) => {
        const l = s(u);
        return Qn(
          l,
  ...
  async enqueue(t, r, n) {
    $n(t, ".enqueue must be passed an action as the first argument but was passed undefined");
    let i, o;
   ...
   **/
  handle(t, r) {
    return new jr(this.connection, t, r);
  }
  toString() {
...
Ta = Ys;
var Ca = {}, Jr = we.createContext(Ca), Hs = Jr.Provider;
Jr.Consumer;
Jr.displayName = "UrqlContext";
var _a = () => {
  var e = we.useContext(Jr);
  ...
  extensions: void 0,
  operation: void 0
}, Xs = (e, t) => e === t || !(!e || !t || e.key !== t.key), On = (e, t) => {
  var r = {
    ...e,
    ...t,
  ...
  for (var r = 0, n = t.length; r < n; r++)
    if (e[r] !== t[r])
      return !0;
  return !1;
}, An = we.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
function Lr(e, t) {
  process.env.NODE_ENV !== "production" && An && An.ReactCurrentOwner && An.ReactCurrentOwner.current ? Promise.resolve(t).then(e) : e(t);
}
function eu(e) {
  var t = we.useRef(!0), r = _a(), [n, i] = we.useState(Ln), o = we.useCallback((s, u) => (Lr(i, {
    ...Ln,
    fetching: !0
  }), Wr(Nr(1)(Z((l) => !l.hasNext)(jt((l) => {
    t.current && Lr(i, {
      fetching: !1,
      stale: l.stale,
      data: l.data,
...
function iu(e) {
  ...
  }, [r, i]), u = [t, i, e.requestPolicy, e.context, e.pause], [l, f] = we.useState(() => [o, On(Ln, s(o, n)), u]), d = l[1];
  o !== l[0] && Zs(l[2], u) && f([o, d = On(l[1], s(o, n)), u]), we.useEffect(() => {
...
var hu = typeof Element < "u", mu = typeof Map == "function", bu = typeof Set == "function", vu = typeof ArrayBuffer == "function" && !!ArrayBuffer.isView;
function Fr(e, t) {
  if (e === t)
    return !0;
  if (e && t && typeof e == "object" && typeof t == "object") {
    ...
    if (mu && e instanceof Map && t instanceof Map) {
      ...
      for (o = e.entries(); !(n = o.next()).done; )
        if (!t.has(n.value[0]))
          return !1;
      for (o = e.entries(); !(n = o.next()).done; )
        if (!Fr(n.value[1], t.get(n.value[0])))
          return !1;
      return !0;
    }
    ...
    if (hu && e instanceof Element)
      return !1;
    for (n = r; n-- !== 0; )
      if (!((i[n] === "_owner" || i[n] === "__v" || i[n] === "__o") && e.$$typeof) && !Fr(e[i[n]], t[i[n]]))
        return !1;
    return !0;
  }
  return e !== e && t !== t;
...
`, Cu = Ma(({ children: e, gadgetAppUrl: t, originalQueryParams: r, api: n, type: i, host: o, isReady: s, isRootFrameRequest: u }) => {
  const l = Pu(), f = (r == null ? void 0 : r.has("hmac")) && (r == null ? void 0 : r.has("shop")), d = l.environment.embedded || l.environment.mobile, y = d && i === gt.Embedded, h = s && typeof o < "u" && !y, [m, g] = Mr({
    isAuthenticated: !1,
    isEmbedded: !1,
    canAuth: !1,
    loading: !0,
  ...
  let _ = !1, I = !1, B = Sr(() => [], []);
  const b = Nn(!1), P = Nn(!1), [{ data: S, fetching: U, error: Ae }, xe] = Iu(Tu);
  ...
  return Me(() => {
    ...
    return console.debug("[gadget-rsab] context changed", te), g(te);
  }, [qe, d, l, I, Ae, N, u]), Me(() => {
    if (B.length > 0 && !_) {
  ...
  const n = !!(globalThis && globalThis.shopify), [i, o] = Mr(null), s = !!i, { query: u } = i ?? {}, l = (u == null ? void 0 : u.get("host")) ?? void 0, f = e ?? gt.Embedded, d = Sr(() => u, [s]), y = !(u != null && u.has("hmac")) && !(u != null && u.has("shop")) && e == gt.Embedded, h = new URL(r.connection.options.endpoint).origin;
  if (Me(() => {
    o({
    ...
    coalescedType: f,
    isReady: s
  }), f == gt.Embedded && !n && globalThis.top && globalThis.top !== globalThis.self) {
    let m;
    try {
  ...
  if (f === gt.Embedded && globalThis.top === globalThis.self) {
    const m = new CustomEvent("gadget:devharness:rsab.embeddedInRootContext");
    globalThis.dispatchEvent(m);
  }
  return Ie.createElement(lu, { api: r }, f === gt.Embedded && n ? Ie.createElement(Cu, { gadgetAppUrl: h, api: r, originalQueryParams: d, type: f, host: l, isReady: s, isRootFrameRequest: y }, t) : Ie.createElement(_u, { isRootFrameRequest: y, query: u, type: f, gadgetAppUrl: h }, t));
}, xa = $a({
  loading: !0,
  isEmbedded: !1,
  isAuthenticated: !1,
  ...
  return /* @__PURE__ */ $r.jsx($r.Fragment, { children: JSON.stringify(e) });
}, Mu = () => /* @__PURE__ */ $r.jsx(Ru, { api: Da, shopifyApiKey: "deadbeef", children: /* @__PURE__ */ $r.jsx(xu, {}) });
export {
  Mu as A,
  xu as R,
  Fu as c,
