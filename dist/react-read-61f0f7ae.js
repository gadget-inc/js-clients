...
import Fn, { useMemo as sr, useContext as hs, useRef as ys } from "react";
...
function gs() {
  if (si)
    return Lt;
  si = 1;
  var e = Fn, t = Symbol.for("react.element"), n = Symbol.for("react.fragment"), r = Object.prototype.hasOwnProperty, i = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, a = { key: !0, ref: !0, __self: !0, __source: !0 };
  function s(o, u, l) {
    var c, p = {}, f = null, y = null;
    l !== void 0 && (f = "" + l), u.key !== void 0 && (f = "" + u.key), u.ref !== void 0 && (y = u.ref);
    for (c in u)
      r.call(u, c) && !a.hasOwnProperty(c) && (p[c] = u[c]);
    if (o && o.defaultProps)
      for (c in u = o.defaultProps, u)
        p[c] === void 0 && (p[c] = u[c]);
    return { $$typeof: t, type: o, key: f, ref: y, props: p, _owner: i.current };
  }
...
function vs() {
  return oi || (oi = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Fn, t = Symbol.for("react.element"), n = Symbol.for("react.portal"), r = Symbol.for("react.fragment"), i = Symbol.for("react.strict_mode"), a = Symbol.for("react.profiler"), s = Symbol.for("react.provider"), o = Symbol.for("react.context"), u = Symbol.for("react.forward_ref"), l = Symbol.for("react.suspense"), c = Symbol.for("react.suspense_list"), p = Symbol.for("react.memo"), f = Symbol.for("react.lazy"), y = Symbol.for("react.offscreen"), h = Symbol.iterator, v = "@@iterator";
    function E(d) {
    ...
    function O(d) {
      {
        for (var g = arguments.length, b = new Array(g > 1 ? g - 1 : 0), T = 1; T < g; T++)
          b[T - 1] = arguments[T];
        P("error", d, b);
      }
    }
    function P(d, g, b) {
      {
        ...
        U !== "" && (g += "%s", b = b.concat([U]));
        var Q = b.map(function(j) {
          return String(j);
        });
        Q.unshift("Warning: " + g), Function.prototype.apply.call(console[d], console, Q);
      }
    }
    var m = !1, N = !1, S = !1, W = !1, et = !1, yt;
    yt = Symbol.for("react.module.reference");
    function mt(d) {
      return !!(typeof d == "string" || typeof d == "function" || d === r || d === a || et || d === i || d === l || d === c || W || d === y || m || N || S || typeof d == "object" && d !== null && (d.$$typeof === f || d.$$typeof === p || d.$$typeof === s || d.$$typeof === o || d.$$typeof === u || // This needs to include all possible module reference object
    ...
    function Ve(d) {
      ...
      if (typeof d == "object")
        switch (d.$$typeof) {
          ...
          case u:
            return cn(d, d.render, "ForwardRef");
          case p:
            var T = d.displayName || null;
            return T !== null ? T : Ve(d.type) || "Memo";
          case f: {
            var U = d, Q = U._payload, j = U._init;
            try {
              return Ve(j(Q));
            } catch {
              return null;
    ...
    var _ = Object.assign, Y = 0, B, D, ee, ze, q, He, tt;
    function ot() {
    }
    ...
    function nt() {
      {
        if (Y === 0) {
          B = console.log, D = console.info, ee = console.warn, ze = console.error, q = console.group, He = console.groupCollapsed, tt = console.groupEnd;
          var d = {
            configurable: !0,
            enumerable: !0,
            value: ot,
    ...
    var ce = k.ReactCurrentDispatcher, dn;
    function gt(d, g, b) {
      {
        if (dn === void 0)
          try {
    ...
    function zr(d, g) {
      ...
      try {
        ...
        if (Ke && T && typeof Ke.stack == "string") {
          for (var R = Ke.stack.split(`
`), ke = T.stack.split(`
`), de = R.length - 1, pe = ke.length - 1; de >= 1 && pe >= 0 && R[de] !== ke[pe]; )
            pe--;
          for (; de >= 1 && pe >= 0; de--, pe--)
            if (R[de] !== ke[pe]) {
              if (de !== 1 || pe !== 1)
                do
                  if (de--, pe--, pe < 0 || R[de] !== ke[pe]) {
                    var Me = `
` + R[de].replace(" at new ", " at ");
                    return d.displayName && Me.includes("<anonymous>") && (Me = Me.replace("<anonymous>", d.displayName)), typeof d == "function" && fn.set(d, Me), Me;
                  }
                while (de >= 1 && pe >= 0);
              break;
            }
        ...
        Qn = !1, ce.current = Q, ge(), Error.prepareStackTrace = U;
      }
      var bt = d ? d.displayName || d.name : "", ai = bt ? gt(bt) : "";
      return typeof d == "function" && fn.set(d, ai), ai;
    }
    function za(d, g, b) {
      return zr(d, !1);
    }
      ...
      if (typeof d == "object")
        switch (d.$$typeof) {
          case u:
            return za(d.render);
          case p:
            return pn(d.type, g, b);
          case f: {
            var T = d, U = T._payload, Q = T._init;
            try {
              return pn(Q(U), g, b);
            } catch {
            }
    ...
    function yn(d) {
      if (d) {
        var g = d._owner, b = pn(d.type, d._source, g ? g.type : null);
        Jr.setExtraStackFrame(b);
      } else
        Jr.setExtraStackFrame(null);
    }
    function Ja(d, g, b, T, U) {
      {
          ...
          if (Q(d, j)) {
            ...
            try {
              if (typeof d[j] != "function") {
                var ke = Error((T || "React class") + ": " + b + " type `" + j + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof d[j] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw ke.name = "Invariant Violation", ke;
              }
              R = d[j](g, j, T, b, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (de) {
              R = de;
            }
            R && !(R instanceof Error) && (yn(U), O("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", T || "React class", b, j, typeof R), yn(null)), R instanceof Error && !(R.message in Wr) && (Wr[R.message] = !0, yn(U), O("Failed %s type: %s", b, R.message), yn(null));
          }
      }
    }
    ...
    function Hr(d) {
      if (Ka(d))
        return O("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Ha(d)), Yr(d);
    }
    ...
    function ts(d, g) {
      if (typeof d.ref == "string" && qt.current && g && qt.current.stateNode !== g) {
        var b = Ve(qt.current.type);
        Wn[b] || (O('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', Ve(qt.current.type), d.ref), Wn[b] = !0);
      }
    }
    function ns(d, g) {
      {
        var b = function() {
          Kr || (Kr = !0, O("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", g));
        };
    ...
    function rs(d, g) {
      {
        var b = function() {
          Xr || (Xr = !0, O("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", g));
        };
    ...
    function as(d, g, b, T, U) {
      {
        var Q, j = {}, R = null, ke = null;
        b !== void 0 && (Hr(b), R = "" + b), es(g) && (Hr(g.key), R = "" + g.key), Za(g) && (ke = g.ref, ts(g, U));
        for (Q in g)
          hn.call(g, Q) && !Xa.hasOwnProperty(Q) && (j[Q] = g[Q]);
        if (d && d.defaultProps) {
        ...
        if (R || ke) {
          ...
          R && ns(j, pe), ke && rs(j, pe);
        }
        return is(d, R, ke, U, T, qt.current, j);
      }
    }
...
Check the top-level render call using <` + b + ">.");
    ...
    function ni(d, g) {
      {
        ...
        ti[b] = !0;
        var T = "";
        d && d._owner && d._owner !== Jn.current && (T = " It was passed a child from " + Ve(d._owner.type) + "."), vt(d), O('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', b, T), vt(null);
      }
    }
    function ri(d, g) {
      {
        ...
        if (zn(d))
          ...
          if (typeof U == "function" && U !== d.entries)
            for (var Q = U.call(d), j; !(j = Q.next()).done; )
              Hn(j.value) && ni(j.value, g);
        }
      }
    }
    function us(d) {
      {
        ...
        if (b) {
          var T = Ve(g);
          Ja(b, d.props, "prop", T, d);
        } else if (g.PropTypes !== void 0 && !Yn) {
          Yn = !0;
          var U = Ve(g);
    ...
    function ls(d) {
      {
        for (var g = Object.keys(d.props), b = 0; b < g.length; b++) {
          var T = g[b];
          if (T !== "children" && T !== "key") {
            vt(d), O("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", T), vt(null);
            break;
          }
        }
        d.ref !== null && (vt(d), O("Invalid attribute `ref` supplied to `React.Fragment`."), vt(null));
      }
    }
    function ii(d, g, b, T, U, Q) {
      {
        var j = mt(d);
        if (!j) {
          var R = "";
          ...
          ke ? R += ke : R += ei();
          var de;
          d === null ? de = "null" : zn(d) ? de = "array" : d !== void 0 && d.$$typeof === t ? (de = "<" + (Ve(d.type) || "Unknown") + " />", R = " Did you accidentally export a JSX literal instead of a component?") : de = typeof d, O("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", de, R);
        }
        var pe = as(d, g, b, U, Q);
        if (pe == null)
          return pe;
    ...
    var fs = ds, ps = cs;
    Bt.Fragment = r, Bt.jsx = fs, Bt.jsxs = ps;
  }()), Bt;
}
process.env.NODE_ENV === "production" ? or.exports = gs() : or.exports = vs();
...
function ur(e, t) {
  let n = 0, r = 1;
  for (const i of e.body.matchAll(Is)) {
...
`, c = r.split(/\r\n|[\n\r]/g), p = c[i];
  if (p.length > 120) {
    const f = Math.floor(u / 80), y = u % 80, h = [];
    for (let v = 0; v < p.length; v += 80)
      h.push(p.slice(v, v + 80));
    return l + li([
      [`${s} |`, h[0]],
      ...h.slice(1, f + 1).map((v) => ["|", v]),
      ["|", "^".padStart(y)],
      ["|", h[f + 1]]
    ]);
  }
...
let M = class Zi extends Error {
  ...
  constructor(t, ...n) {
    ...
    this.source = o ?? (f == null || (i = f[0]) === null || i === void 0 ? void 0 : i.source), this.positions = u ?? (f == null ? void 0 : f.map((h) => h.start)), this.locations = u && o ? u.map((h) => ur(o, h)) : f == null ? void 0 : f.map((h) => ur(h.source, h.start));
    const y = Xt(
...
function _s(e, t) {
  ...
  if (xs(e)) {
    const r = e.toJSON();
    if (r !== e)
      return typeof r == "string" ? r : Dn(r, n);
...
function Cs(e, t) {
  ...
  return n.length === 0 ? "{}" : t.length > na ? "[" + Fs(e) + "]" : "{ " + n.map(
    ([i, a]) => i + ": " + Dn(a, t)
  ).join(", ") + " }";
}
function Rs(e, t) {
  ...
  if (t.length > na)
    return "[Array]";
  const n = Math.min(Ps, e.length), r = e.length - n, i = [];
  for (let a = 0; a < n; ++a)
    i.push(Dn(e[a], t));
...
class Us {
  ...
  measure(t, n) {
    ...
    for (let c = 0; c <= o; c++)
      u[0][c] = c;
    for (let c = 1; c <= s; c++) {
      const p = u[(c - 1) % 3], f = u[c % 3];
      let y = f[0] = c;
      for (let h = 1; h <= o; h++) {
        const v = i[c - 1] === a[h - 1] ? 0 : 1;
        let E = Math.min(
          p[h] + 1,
          // delete
          f[h - 1] + 1,
...
function zs(e, t, n = ea) {
  ...
  do {
    ...
    if (k) {
      if (c = y.length === 0 ? void 0 : f[f.length - 1], l = p, p = y.pop(), O)
        if (a) {
          l = l.slice();
          let m = 0;
          for (const [N, S] of u) {
    ...
    if (!Array.isArray(l)) {
      var h, v;
      di(l) || ue(!1, `Invalid AST Node: ${z(l)}.`);
      const m = k ? (h = r.get(l.kind)) === null || h === void 0 ? void 0 : h.leave : (v = r.get(l.kind)) === null || v === void 0 ? void 0 : v.enter;
      if (P = m == null ? void 0 : m.call(t, l, c, p, f, y), P === Qs)
        break;
      if (P === !1) {
        if (!k) {
          f.pop();
...
`)
  ...
  OperationDefinition: {
    leave(e) {
      const t = F("(", w(e.variableDefinitions, ", "), ")"), n = w(
        [
          e.operation,
          w([e.name, t]),
          w(e.directives, " ")
  ...
  VariableDefinition: {
    leave: ({ variable: e, type: t, defaultValue: n, directives: r }) => e + ": " + t + F(" = ", n) + F(" ", w(r, " "))
  },
  SelectionSet: {
...
`)), `
  ...
  // Fragments
  FragmentSpread: {
    leave: ({ name: e, directives: t }) => "..." + e + F(" ", w(t, " "))
  },
  InlineFragment: {
  ...
  // Directive
  Directive: {
    leave: ({ name: e, arguments: t }) => "@" + e + F("(", w(t, ", "), ")")
  },
  // Type
  NamedType: {
    leave: ({ name: e }) => e
...
`, On(w(n, `
`)), `
)`) : F("(", w(n, ", "), ")")) + (r ? " repeatable" : "") + " on " + w(i, " | ")
  },
  SchemaExtension: {
    leave: ({ directives: e, operationTypes: t }) => w(
      ["extend schema", w(e, " "), qe(t)],
      " "
    )
  },
  ScalarTypeExtension: {
  ...
  EnumTypeExtension: {
    leave: ({ name: e, directives: t, values: n }) => w(["extend enum", e, w(t, " "), qe(n)], " ")
  },
  InputObjectTypeExtension: {
    leave: ({ name: e, directives: t, fields: n }) => w(["extend input", e, w(t, " "), qe(n)], " ")
  }
};
function w(e, t = "") {
  var n;
...
class ro {
  constructor(t) {
    var n;
    this.name = Ge(t.name), this.description = t.description, this.isTypeOf = t.isTypeOf, this.extensions = Be(t.extensions), this.astNode = t.astNode, this.extensionASTNodes = (n = t.extensionASTNodes) !== null && n !== void 0 ? n : [], this._fields = () => da(t), this._interfaces = () => ca(t), t.isTypeOf == null || typeof t.isTypeOf == "function" || ue(
      !1,
...
class oo {
  ...
  constructor(t) {
    ...
    ), this._nameLookup = Pr(this._values, (r) => r.name);
  }
  get [Symbol.toStringTag]() {
...
const Kn = 2147483647, Xn = -2147483648, fo = new Dt({
  name: "Int",
...
function Qt(e, t, n) {
  if (e) {
    ...
    if (sa(t)) {
      if (e.kind !== G.OBJECT)
        return;
      const r = /* @__PURE__ */ Object.create(null), i = Pr(e.fields, (a) => a.name.value);
...
function ho(e, t, n) {
  var r;
  const i = {}, a = (r = t.arguments) !== null && r !== void 0 ? r : [], s = Pr(a, (o) => o.name.value);
...
function No(e) {
  ...
  for (a = a.sort(bi.numerically), t = a.length - 1; t >= 0; t--) {
    n = a[t];
  ...
  s = s.sort(bi.numericallyBy("index"));
  let u = s.length;
  for (t = 0; t < u; t++) {
    let c = s[t];
...
***************************************************************************** */
var dr = function(e, t) {
  return dr = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(n, r) {
    n.__proto__ = r;
  } || function(n, r) {
    for (var i in r)
...
function Po(e, t, n) {
  ...
  function u(f) {
    f.value instanceof Zt ? Promise.resolve(f.value.v).then(l, c) : p(a[0][2], f);
  }
  function l(f) {
    o("next", f);
  }
  ...
  function p(f, y) {
    f(y), a.shift(), a.length && o(a[0][0], a[0][1]);
  }
}
var ga = (
  /** @class */
...
function fr(e) {
  e != null && typeof e.then == "function" && e.then(Pn, Pn);
}
var Zn = 0, Si = 1, pt = 2, Tn = 3, pr = 4, kn = 1024, Pn = function() {
};
function At(e) {
...
function lt(e, t) {
  ...
  return Promise.resolve(t).then(function(r) {
    return !n && e.state >= pr ? At(e).then(function(i) {
      return {
        value: i,
        done: !0
      };
...
function Cr(e, t) {
  ...
  if (!(e.state >= pt))
    if (e.state = pt, e.onnext(), e.onstop(), e.err == null && (e.err = t), e.pushes.length === 0 && (typeof e.buffer > "u" || e.buffer.empty))
      ...
      try {
        for (var i = jt(e.pushes), a = i.next(); !a.done; a = i.next()) {
          var s = a.value;
          s.resolve();
        }
      } catch (o) {
...
function Jt(e) {
  var t, n;
  if (!(e.state >= Tn)) {
    e.state < pt && Cr(e), e.state = Tn, e.buffer = void 0;
    try {
      for (var r = jt(e.nexts), i = r.next(); !i.done; i = r.next()) {
        var a = i.value, s = e.pending === void 0 ? At(e) : e.pending.then(function() {
          return At(e);
        });
        a.resolve(lt(e, s));
      }
...
function Ii(e) {
  e.state >= pr || (e.state < Tn && Jt(e), e.state = pr);
}
function _o(e, t) {
  if (fr(t), e.pushes.length >= kn)
    throw new ga("No more than " + kn + " pending calls to push are allowed on a single repeater.");
  if (e.state >= pt)
...
function xo(e) {
  var t = Cr.bind(null, e), n = new Promise(function(r) {
    return e.onstop = r;
  });
...
var vn = /* @__PURE__ */ new WeakMap(), sn = (
  /** @class */
  function() {
    function e(t, n) {
      vn.set(this, {
    ...
    return e.prototype.next = function(t) {
      ...
      if (n.nexts.length >= kn)
        throw new ga("No more than " + kn + " pending calls to next are allowed on a single repeater.");
      if (n.state <= Zn && Co(n), n.onnext(t), typeof n.buffer < "u" && !n.buffer.empty) {
      ...
      if (n === void 0)
        throw new Error("WeakMap error");
      return n.state <= Zn || n.state >= pt || typeof n.buffer < "u" && !n.buffer.empty ? (Jt(n), n.err == null && (n.err = t), lt(n, At(n))) : this.next(Promise.reject(t));
    }, e.prototype[Symbol.asyncIterator] = function() {
      return this;
    }, e.race = Ro, e.merge = Fo, e.zip = Do, e.latest = jo, e;
  }()
);
function Mn(e, t) {
  ...
  try {
    for (var s = jt(e), o = s.next(); !o.done; o = s.next()) {
      var u = o.value;
      a(u);
    }
  } catch (l) {
      ...
      return at(this, function(p) {
        switch (p.label) {
              ...
              return at(this, function(O) {
                switch (O.label) {
                  case 0:
                    f = l;
                    try {
                      for (y = (E = void 0, jt(n)), h = y.next(); !h.done; h = y.next())
                        v = h.value, Promise.resolve(v.next()).then(function(P) {
                          P.done ? (i(), o === void 0 && (o = P)) : l === f && (l++, a(P));
                        }, function(P) {
                          return i(P);
                        });
                    } catch (P) {
          ...
          case 4:
            return [2, o && o.value];
          case 5:
            return i(), [4, Promise.race(n.map(function(f) {
        ...
        switch (l.label) {
          case 0:
            ...
            a = [], s = !1, i.then(function() {
              ...
              s = !0;
              try {
                for (var f = jt(a), y = f.next(); !y.done; y = f.next()) {
                  var h = y.value;
                  h();
                }
              } catch (v) {
          ...
          case 1:
            return l.trys.push([1, , 3, 4]), [4, Promise.all(n.map(function(c, p) {
              return Tt(u, void 0, void 0, function() {
                var f, y;
                return at(this, function(h) {
                  switch (h.label) {
                    ...
                    case 1:
                      return s ? [3, 5] : (Promise.resolve(c.next()).then(function(v) {
                        return a[p](v);
                      }, function(v) {
                        return i(v);
                    ...
                    case 2:
                      return f = h.sent(), f === void 0 ? [3, 4] : f.done ? (o = f, [
                        2
                        /*return*/
                      ]) : [4, r(f.value)];
                    case 3:
        ...
        switch (p.label) {
          case 0:
            ...
            s = [], o = !1, i.then(function() {
              ...
              a();
              try {
                for (var h = jt(s), v = h.next(); !v.done; v = h.next()) {
                  var E = v.value;
                  E();
                }
              } catch (k) {
          ...
          case 1:
            return p.trys.push([1, , 5, 7]), Promise.all(n.map(function(f) {
              return f.next();
            })).then(function(f) {
              return a(f);
            }, function(f) {
          ...
          case 3:
            return p.sent(), [4, Promise.all(n.map(function(f, y) {
                ...
                return at(this, function(v) {
                  switch (v.label) {
                    case 0:
                      ...
                      v.label = 1;
                    case 1:
                      return o ? [3, 4] : (Promise.resolve(f.next()).then(function(E) {
                        return s[y](E);
                      }, function(E) {
                        return i(E);
                    ...
                    case 2:
                      return h = v.sent(), h === void 0 ? [2, u[y].value] : h.done ? [2, h.value] : (l[y] = h.value, [4, r(l.slice())]);
                    case 3:
                      return v.sent(), [3, 1];
                    case 4:
                      return [
          ...
          case 4:
            return [2, p.sent()];
          case 5:
            return i(), [4, Promise.all(n.map(function(f) {
              return f.return && f.return();
            }))];
          case 6:
            return p.sent(), [
...
function Uo() {
  ...
  const n = [];
  function r(s) {
    e.type === "running" && (n.push(s), t.resolve(), t = wi());
  }
...
`), n = "", r = 0, i = 0, a = t.length - 1, s = 0; s < t.length; s++)
    bn.lastIndex = 0, bn.test(t[s]) && (s && (!r || bn.lastIndex < r) && (r = bn.lastIndex), i = i || s, a = s);
  for (var o = i; o <= a; o++)
    o !== i && (n += `
...
var Go = /(?:null|true|false)/y, ba = /\$[_A-Za-z]\w*/y, Qo = /-?\d+/y, zo = /(?:\.\d+)?[eE][+-]?\d+|\.\d+/y, Wo = /\\/g, Jo = /"""(?:"""|(?:[\s\S]*?[^\\])""")/y, Yo = /"(?:"|[^\r\n]*?[^\\]")/y;
function _n(e) {
  var t, n;
  if (n = De(Go))
    t = n === "null" ? {
...
function Ia() {
  ...
  if (C(), Z.charCodeAt(x) === 91) {
    ...
    throw me("NamedType");
  return C(), Z.charCodeAt(x) === 33 ? (x++, C(), {
    kind: "NonNullType",
    type: e
  }) : e;
}
  ...
  (e = De(nu)) && (C(), t = Je(), n = function() {
    ...
    if (C(), Z.charCodeAt(x) === 40) {
      for (x++, C(); s = De(ba); ) {
        ...
        var u = Ia(), l = void 0;
        if (Z.charCodeAt(x) === 61 && (x++, C(), !(l = _n(!0))))
          throw me("VariableDefinition");
        C(), o.push({
...
var $e = (e) => !(!e || !e.length), Ne = {
  OperationDefinition(e) {
    if (e.operation === "query" && !e.name && !$e(e.variableDefinitions) && !$e(e.directives))
      return Ne.SelectionSet(e.selectionSet);
    var t = e.operation;
    return e.name && (t += " " + e.name.value), $e(e.variableDefinitions) && (e.name || (t += " "), t += "(" + e.variableDefinitions.map(Ne.VariableDefinition).join(", ") + ")"), $e(e.directives) && (t += " " + e.directives.map(Ne.Directive).join(" ")), t + " " + Ne.SelectionSet(e.selectionSet);
  },
  VariableDefinition(e) {
    var t = Ne.Variable(e.variable) + ": " + Ue(e.type);
    return e.defaultValue && (t += " = " + Ue(e.defaultValue)), $e(e.directives) && (t += " " + e.directives.map(Ne.Directive).join(" ")), t;
  },
  Field(e) {
    var t = (e.alias ? e.alias.value + ": " : "") + e.name.value;
    if ($e(e.arguments)) {
      var n = e.arguments.map(Ne.Argument), r = t + "(" + n.join(", ") + ")";
      t = r.length > 80 ? t + `(
  ` + n.join(`
`).replace(/\n/g, `
  `) + `
    ...
    return $e(e.directives) && (t += " " + e.directives.map(Ne.Directive).join(" ")), e.selectionSet ? t + " " + Ne.SelectionSet(e.selectionSet) : t;
  },
  ...
  ObjectValue: (e) => "{" + e.fields.map(Ne.ObjectField).join(", ") + "}",
...
`).replace(/\n/g, `
  ...
  FragmentSpread(e) {
    var t = "..." + e.name.value;
    return $e(e.directives) && (t += " " + e.directives.map(Ne.Directive).join(" ")), t;
  },
  InlineFragment(e) {
    var t = "...";
    return e.typeCondition && (t += " on " + e.typeCondition.name.value), $e(e.directives) && (t += " " + e.directives.map(Ne.Directive).join(" ")), t + " " + Ue(e.selectionSet);
  },
  FragmentDefinition(e) {
    var t = "fragment " + e.name.value;
    return t += " on " + e.typeCondition.name.value, $e(e.directives) && (t += " " + e.directives.map(Ne.Directive).join(" ")), t + " " + Ue(e.selectionSet);
  },
  Directive(e) {
    var t = "@" + e.name.value;
    return $e(e.arguments) && (t += "(" + e.arguments.map(Ne.Argument).join(", ") + ")"), t;
  },
  ...
  return (t) => (n) => {
    ...
    t((o) => {
      s || (o === 0 ? (s = !0, r.length || n(0)) : o.tag === 0 ? i = o[0] : (a = !1, function(l) {
        ...
        l((p) => {
          if (p === 0) {
            if (r.length) {
              var f = r.indexOf(c);
              f > -1 && (r = r.slice()).splice(f, 1), r.length || (s ? n(0) : a || (a = !0, i(0)));
            }
          } else
      ...
      if (o === 1) {
        ...
        !s && !a ? (a = !0, i(0)) : a = !1;
        for (var p = 0, f = r, y = r.length; p < y; p++)
          f[p](0);
      }
    }));
  };
...
function Ei(e) {
  return (t) => (n) => {
    var r = je, i = je, a = !1, s = !1, o = !1, u = !1;
    t((l) => {
      u || (l === 0 ? (u = !0, o || n(0)) : l.tag === 0 ? r = l[0] : (o && (i(1), i = je), a ? a = !1 : (a = !0, r(0)), function(p) {
        o = !0, p((f) => {
          o && (f === 0 ? (o = !1, u ? n(0) : a || (a = !0, r(0))) : f.tag === 0 ? (s = !1, (i = f[0])(0)) : (n(f), s ? s = !1 : i(0)));
        });
      }(e(l[0]))));
    }), n(Qe((l) => {
...
function cu(e) {
  return e[Symbol.asyncIterator] ? Aa(e) : (t) => {
...
function Ai() {
  var e, t;
  return {
    source: tn(jr((n) => (e = n.next, t = n.complete, Rr))),
    next(n) {
      e && e(n);
    },
    complete() {
...
var yr = (e, t) => {
  ...
  return n;
}, ft = /* @__PURE__ */ new Set(), Ti = /* @__PURE__ */ new WeakMap(), St = (e) => {
  if (e === null || ft.has(e))
    return "null";
  if (typeof e != "object")
    return JSON.stringify(e) || "";
  ...
  if (Array.isArray(e)) {
    ...
    return t += "]";
  } else if (Cn !== xt && e instanceof Cn || Rn !== xt && e instanceof Rn)
    return "null";
  var r = Object.keys(e).sort();
  if (!r.length && e.constructor && e.constructor !== Object) {
    var i = Ti.get(e) || Math.random().toString(36).slice(2);
    return Ti.set(e, i), St({
      __key: i
    });
  }
  ft.add(e);
  ...
  if (!(n == null || typeof n != "object" || n.toJSON || ft.has(n)))
    if (Array.isArray(n))
      for (var r = 0, i = n.length; r < i; r++)
        mr(e, `${t}.${r}`, n[r]);
    else if (n instanceof Cn || n instanceof Rn)
      e.set(t, n);
    else {
      ft.add(n);
...
var Cn = typeof File < "u" ? File : xt, Rn = typeof Blob < "u" ? Blob : xt, mu = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g, gu = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g, vu = (e, t) => t % 2 == 0 ? e.replace(gu, `
`) : e, ki = (e) => e.split(mu).map(vu).join("").trim(), Pi = /* @__PURE__ */ new Map(), En = /* @__PURE__ */ new Map(), Vr = (e) => {
  var t;
  return typeof e == "string" ? t = ki(e) : e.loc && En.get(e.__key) === e ? t = e.loc.source.body : (t = Pi.get(e) || ki(Ue(e)), Pi.set(e, t)), typeof e != "string" && !e.loc && (e.loc = {
    start: 0,
    end: t.length,
    source: {
      body: t,
...
# ${n}`, t));
  ...
  var r = t || {}, i = Na(e), a = xn(r), s = i.__key;
  return a !== "{}" && (s = yr(a, s)), {
    key: s,
    query: i,
    variables: r,
  ...
  for (var t of e.definitions)
    if (t.kind === wt.OPERATION_DEFINITION)
  ...
  if (s)
    for (var u of s) {
      ...
      for (var l = "data", c = o, p = 0, f = u.path.length; p < f; l = u.path[p++])
        c = c[l] = Array.isArray(c[l]) ? [...c[l]] : {
          ...c[l]
        };
      if (u.items)
        for (var y = +l >= 0 ? l : 0, h = 0, v = u.items.length; h < v; h++)
          c[y + h] = vr(c[y + h], u.items[h]);
      else
        u.data !== void 0 && (c[l] = vr(c[l], u.data));
    }
  else
...
var Su = (e, t) => {
  ...
  if (t && !(e.kind === "query" && e.context.preferGetMethod)) {
    var n = xn(t), r = ((o) => {
      ...
      return (Cn !== xt || Rn !== xt) && (ft.clear(), mr(u, "variables", o)), u;
    })(t.variables);
    if (r.size) {
      var i = new FormData();
...
}, Ou = typeof TextDecoder < "u" ? new TextDecoder() : null, Eu = /boundary="?([^=";]+)"?/i, Au = /data: ?([^\n]+)/, xi = (e) => e.constructor.name === "Buffer" ? e.toString() : Ou.decode(e);
async function* Ci(e) {
  ...
  try {
    ...
    if (/multipart\/mixed/i.test(s))
      o = async function* (c, p) {
        var f = c.match(Eu), y = "--" + (f ? f[1] : "-"), h = !0, v;
        for await (var E of Ri(Ci(p), `\r
` + y)) {
          if (h) {
            h = !1;
            var k = E.indexOf(y);
          ...
          try {
            yield v = JSON.parse(E.slice(E.indexOf(`\r
\r
`) + 4));
          } catch (O) {
            if (!v)
...
`)) {
    ...
    for await (var u of o)
      i = i ? br(i, u, a) : gr(e, u, a), r = !1, yield i, r = !0;
    i || (yield i = gr(e, {}, a));
  } catch (l) {
    if (!r)
      throw l;
...
function Tu(e, t, n) {
  var r;
  return typeof AbortController < "u" && (n.signal = (r = new AbortController()).signal), Fr(() => {
    r && r.abort();
  })(Ae((i) => !!i)(Aa(Nu(e, t, n))));
}
var Sr = (e, t) => {
  ...
  if ("definitions" in e) {
    ...
    var a = [], s = e.kind === wt.OPERATION_DEFINITION;
    if (e.selectionSet) {
      for (var o of e.selectionSet.selections || []) {
        s = s || o.kind === wt.FIELD && o.name.value === "__typename" && !o.alias;
        var u = Ir(o);
        t = t || u !== o, a.push(u);
      }
      if (s || (t = !0, a.push({
  ...
  return e;
}, Fi = /* @__PURE__ */ new Map(), ku = (e) => {
  var t = Na(e), n = Fi.get(t.__key);
  return n || (Fi.set(t.__key, n = Ir(t)), Object.defineProperty(n, "__key", {
    value: t.__key,
    enumerable: !1
  })), n;
}, wr = (e, t) => {
...
function Di(e) {
  var t = (n) => e(n);
  return t.toPromise = () => pu(Oa(1)(Ae((n) => !n.stale && !n.hasNext)(t))), t.then = (n, r) => t.toPromise().then(n, r), t.subscribe = (n) => ht(n)(t), t;
}
function Ct(e, t, n) {
  return {
    ...t,
...
var ji = (e, t) => Ct(e.kind, e, {
  ...
  return (o) => {
    var u = Nt((c) => {
      ...
      }), c.context.requestPolicy === "cache-and-network" && (f.stale = !0, Vi(t, c)), f;
    })(Ae((c) => !er(c) && s(c))(o)), l = _t((c) => {
      var { operation: p } = c;
      if (p) {
        var f = p.context.additionalTypenames || [];
        if (c.operation.kind !== "subscription" && (f = ((S) => [...Sr(S, /* @__PURE__ */ new Set())])(c.data).concat(f)), c.operation.kind === "mutation" || c.operation.kind === "subscription") {
          ...
          for (var P = 0; P < f.length; P++) {
            var m = f[P], N = i.get(m);
            N || i.set(m, N = /* @__PURE__ */ new Set()), N.add(p.key);
          }
        }
      }
    })(e(Ae((c) => c.kind !== "query" || c.context.requestPolicy !== "cache-only")(Nt((c) => process.env.NODE_ENV !== "production" ? ji(c, {
      cacheOutcome: "miss"
    }) : c)(Pt([Nt(a)(Ae((c) => !er(c) && !s(c))(o)), Ae((c) => er(c))(o)])))));
    return Pt([u, l]);
  };
}, Vi = (e, t) => e.reexecuteOperation(Ct(t.kind, t, {
  ...
  return (s) => {
    var o = en((l) => {
      var { key: c } = l, p = Ae((f) => f.kind === "teardown" && f.key === c)(s);
      return Dr(p)(((f) => {
        var y = e(Pa(f), f);
        return jr(({ next: h, complete: v }) => {
          var E = !1, k, O;
          return Promise.resolve().then(() => {
            E || (k = y.subscribe({
              ...
              complete() {
                E || (E = !0, f.kind === "subscription" && r.reexecuteOperation(Ct("teardown", f, f.context)), O && O.hasNext && h(br(O, {
                  hasNext: !1
                })), v());
              }
            }));
    ...
    })(Ae((l) => l.kind !== "teardown" && a(l))(s)), u = i(Ae((l) => l.kind === "teardown" || !a(l))(s));
    return Pt([o, u]);
  };
}, xu = ({ forward: e, dispatchDebug: t }) => (n) => {
  var r = en((a) => {
    var s = Pa(a), o = Su(a, s), u = wu(a, s);
    ...
    var l = Dr(Ae((c) => c.kind === "teardown" && c.key === a.key)(n))(Tu(a, o, u));
  ...
  return Pt([r, i]);
}, Cu = (e) => ({ client: t, forward: n, dispatchDebug: r }) => e.reduceRight((i, a) => {
  var s = !1;
  return a({
    client: t,
    forward(o) {
  ...
  var s = t && t(a) || a;
  return "then" in s ? Ni(s) : Yt(s);
})(r(en((a) => {
  var s = e && e(a) || a;
  return "then" in s ? Ni(s) : Yt(s);
})(i))), Ru = ({ dispatchDebug: e }) => (t) => (process.env.NODE_ENV !== "production" && (t = _t((n) => {
  ...
  var f = (m) => {
    var N = Dr(Ae((S) => S.kind === "teardown" && S.key === m.key)(u.source))(Ae((S) => S.operation.kind === m.kind && S.operation.key === m.key && (!S.operation.context._instance || S.operation.context._instance === m.context._instance))(P));
    return m.kind !== "query" ? N = Ea((S) => !!S.hasNext, !0)(N) : N = Ei((S) => {
      var W = Yt(S);
      return S.stale || S.hasNext ? W : Pt([W, Nt(() => (S.stale = !0, S))(Oa(1)(Ae((et) => et.key === m.key)(u.source)))]);
    })(N), m.kind !== "mutation" ? N = Fr(() => {
      a.delete(m.key), r.delete(m.key), i.delete(m.key), c = !1;
      for (var S = s.length - 1; S >= 0; S--)
        s[S].key === m.key && s.splice(S, 1);
      l(Ct("teardown", m, m.context));
    })(_t((S) => {
      if (S.stale) {
        for (var W of s)
    ...
    createRequestOperation(m, N, S) {
      S || (S = {});
      var W;
      if (process.env.NODE_ENV !== "production" && m !== "teardown" && (W = bu(N.query)) !== m)
    ...
    executeRequestOperation(m) {
      return m.kind === "mutation" ? Di(f(m)) : Di(lu(() => {
        var N = i.get(m.key);
        N || i.set(m.key, N = f(m)), N = Oi(() => {
          p(m);
        })(N);
        var S = r.get(m.key);
        return m.kind === "query" && S && (S.stale || S.hasNext) ? Ei(Yt)(Pt([N, Ae((W) => W === r.get(m.key))(Yt(S))])) : N;
      }));
    },
    executeQuery(m, N) {
      var S = h.createRequestOperation("query", m, N);
      return h.executeRequestOperation(S);
    },
    executeSubscription(m, N) {
      var S = h.createRequestOperation("subscription", m, N);
      return h.executeRequestOperation(S);
    },
    executeMutation(m, N) {
      var S = h.createRequestOperation("mutation", m, N);
      return h.executeRequestOperation(S);
    },
    readQuery(m, N, S) {
      var W = null;
      return ht((et) => {
        W = et;
      })(h.query(m, N, S)).unsubscribe(), W;
    },
    query: (m, N, S) => h.executeQuery(An(m, N), S),
    subscription: (m, N, S) => h.executeSubscription(An(m, N), S),
    mutation: (m, N, S) => h.executeMutation(An(m, N), S)
  }), v = Pu;
  if (process.env.NODE_ENV !== "production") {
    var { next: E, source: k } = Ai();
    h.subscribeToDebugTarget = (m) => ht(m)(k), v = E;
  }
  var O = Cu(t.exchanges), P = tn(O({
    client: h,
    dispatchDebug: v,
    forward: Ru({
      dispatchDebug: v
...
function xa(e) {
  ...
  switch (e.type) {
    case fe.ConnectionInit:
    case fe.ConnectionAck:
    case fe.Ping:
    case fe.Pong: {
...
function Vu(e) {
  const {
    ...
    retryWait: c = async function(Y) {
      ...
      for (let D = 0; D < Y; D++)
        B *= 2;
      await new Promise((D) => setTimeout(D, B + // add random timeout from 300ms to 3s
  ...
  const P = O, m = (() => {
    const _ = (() => {
      ...
      return {
        ...
        emit(D) {
          var ee;
          "id" in D && ((ee = B[D.id]) === null || ee === void 0 || ee.call(B, D));
        }
      };
    })(), Y = {
  ...
  async function Ut() {
    ...
    const [_, Y] = await (S ?? (S = new Promise((ee, ze) => (async () => {
      ...
      m.emit("connecting");
      const q = new P(typeof t == "function" ? await t() : t, Du);
      let He, tt;
      function ot() {
        isFinite(s) && s > 0 && (clearTimeout(tt), tt = setTimeout(() => {
          q.readyState === P.OPEN && (q.send(Gt({ type: fe.Ping })), m.emit("ping", !1, void 0));
        }, s));
      }
      N((ge) => {
        S = void 0, clearTimeout(He), clearTimeout(tt), ze(ge), Sn(ge) && ge.code === 4499 && (q.close(4499, "Terminated"), q.onerror = null, q.onclose = null);
      }), q.onerror = (ge) => m.emit("error", ge), q.onclose = (ge) => m.emit("closed", ge), q.onopen = async () => {
        try {
          m.emit("opened", q);
          const ge = typeof n == "function" ? await n() : n;
          if (q.readyState !== P.OPEN)
            return;
          q.send(Gt(ge ? {
            type: fe.ConnectionInit,
            payload: ge
          } : {
            type: fe.ConnectionInit
          ...
          m.emit("error", ge), q.close(_e.InternalClientError, $i(ge instanceof Error ? ge.message : new Error(ge).message, "Internal client error"));
        }
      };
      let nt = !1;
      q.onmessage = ({ data: ge }) => {
    ...
    _.readyState === P.CLOSING && await Y;
    let B = () => {
    };
    const D = new Promise((ee) => B = ee);
    return [
      _,
      B,
      Promise.race([
          ...
          try {
            ...
            const ot = m.onMessage(B, (nt) => {
              switch (nt.type) {
                ...
                case fe.Error: {
                  ee = !0, D = !0, Y.error(nt.payload), ze();
                  return;
                }
                case fe.Complete: {
                  D = !0, ze();
            ...
            q.send(Gt({
              ...
              !D && q.readyState === P.OPEN && q.send(Gt({
                id: B,
                type: fe.Complete
              }, E)), W--, D = !0, He();
            }, await tt.finally(ot);
...
function Re(e) {
  ...
  if (r === "[object Object]") {
    if (e.constructor !== Object && typeof e.constructor == "function") {
      n = new e.constructor();
      for (t in e)
        e.hasOwnProperty(t) && n[t] !== e[t] && (n[t] = Re(e[t]));
    } else {
      n = {};
      for (t in e)
  ...
  return r === "[object Set]" ? (n = /* @__PURE__ */ new Set(), e.forEach(function(i) {
    ...
    n.set(Re(a), Re(i));
  }), n) : r === "[object Date]" ? /* @__PURE__ */ new Date(+e) : r === "[object RegExp]" ? (n = new RegExp(e.source, e.flags), n.lastIndex = e.lastIndex, n) : r === "[object DataView]" ? new e.constructor(Re(e.buffer)) : r === "[object ArrayBuffer]" ? e.slice(0) : r.slice(-6) === "Array]" ? new e.constructor(e) : e;
}
var Pe;
(function(e) {
...
class qu {
  constructor(t) {
    this.__gadget = {
      ...
      fieldKeysTracker: {},
      touched: !1
    }, this.empty = !1, this.__gadget.instantiatedFields = Re(t), this.__gadget.persistedFields = Re(t), Object.assign(this.__gadget.fields, t), !t || Object.keys(t).length === 0 ? this.empty = !0 : (this.__gadget.fieldKeys = Object.keys(this.__gadget.fields), this.__gadget.fieldKeys.forEach((r) => this.__gadget.fieldKeysTracker[r] = !0));
    const n = {
      get: (r, i) => {
        if (i in this)
          return this[i];
  ...
  hasChanges(t = Pe.SinceLoaded) {
    ...
    return this.__gadget.fieldKeys.some((r) => !In(n[r], this.__gadget.fields[r]));
  }
  ...
  changes(t, n = Pe.SinceLoaded) {
    ...
    if (t && typeof t == "string") {
      const a = i[t], s = this.__gadget.fields[t], o = !In(s, a);
      ...
      for (let s = 0; s < this.__gadget.fieldKeys.length; s++) {
        ...
        In(i[o], this.__gadget.fields[o]) || (a[o] = { current: this.__gadget.fields[o], previous: i[o] });
      }
      return a;
    }
  }
  ...
  toChangedJSON(t = Pe.SinceLoaded) {
    ...
    for (let i = 0; i < this.__gadget.fieldKeys.length; i++) {
      ...
      In(n[a], this.__gadget.fields[a]) || (r[a] = this.__gadget.fields[a]);
    }
    return r;
  }
  ...
  flushChanges(t = Pe.SinceLoaded) {
    t == Pe.SinceLoaded ? this.__gadget.instantiatedFields = Re(this.__gadget.fields) : t == Pe.SinceLastPersisted && (this.__gadget.persistedFields = Re(this.__gadget.fields)), this.__gadget.touched = !1;
  }
  ...
  revertChanges(t = Pe.SinceLoaded) {
    ...
    t == Pe.SinceLoaded ? Object.assign(this.__gadget.fields, Re(this.__gadget.instantiatedFields)) : Object.assign(this.__gadget.fields, Re(this.__gadget.persistedFields)), this.__gadget.touched = !1;
  }
  /** Returns a JSON representation of all fields on this record. */
  toJSON() {
    return Ar({ ...this.__gadget.fields });
  }
  touch() {
...
class Ui extends Error {
  constructor(t) {
    let n;
    Er(t) ? n = `GraphQL websocket closed unexpectedly by the server with error code ${t.code} and reason "${t.reason}"` : n = "GraphQL websocket closed unexpectedly by the server", super(n), this.code = "GGT_UNKNOWN", this.name = "UnexpectedCloseError", this.statusCode = 500, this.causedByClient = !1, this.event = t;
  }
}
...
class Gu extends Error {
  constructor(t, n, r, i) {
    ...
    super(t ?? `GGT_INVALID_RECORD: ${r ?? "Record"} is invalid and can't be saved. ${a.map(({ apiIdentifier: o, message: u }) => `${o} ${u}`).join(", ")}${s}.`), this.code = "GGT_INVALID_RECORD", this.name = "InvalidRecordError", this.statusCode = 422, this.causedByClient = !0, this.validationErrors = n, this.modelApiIdentifier = r, this.record = i;
  }
}
...
}, zu = (e) => `${qn(e)}Sort`, Wu = (e) => `${qn(e)}Filter`, Ju = (e, t, n) => new Fa(`More than one record found for ${e}.${t} = ${n}. Please confirm your unique validation is not reporting an error.`), Yu = (e, t) => {
  if (e.fetching)
    return;
  const n = Rt(e.data, t);
  if (n === void 0)
    return new Ra(`Internal Error: Gadget API didn't return expected data. Nothing found in response at ${t.join(".")}`);
  if (n === null)
    return new Da(`Record Not Found Error: Gadget API returned no data at ${t.join(".")}`);
}, Ze = (e, t, n = !1) => {
  var r;
  if (e.error)
...
`)), e.error;
  const i = Rt(e.data, t), a = Rt(i, ["edges"]), s = a ?? i;
  if (i === void 0)
    throw new Ra(`Internal Error: Gadget API didn't return expected data. Nothing found in response at ${t.join(".")}`);
  if (i === null || n && Array.isArray(s) && s.length === 0)
    throw new Da(`Record Not Found Error: Gadget API returned no data at ${t.join(".")}`);
  return i;
}, Ht = (e, t) => {
  var n;
  if (e.error)
...
`)), e.error;
  ...
  var t;
  return e.code == "GGT_INVALID_RECORD" ? new Gu(e.message, e.validationErrors, (t = e.model) === null || t === void 0 ? void 0 : t.apiIdentifier, e.record) : e.code == "GGT_UNKNOWN" && e.message.includes("duplicate key value violates unique constraint") ? new Fa(e.message) : new Un(e.message, e.code);
}, ct = (e, t) => {
  const n = Ze(e, t);
  if (!n.success) {
  ...
  const n = ja(e);
  return n && (t = n.apply(t)), new Ca(t);
}, $r = (e, t) => {
  const n = ja(e);
  return n && (t = n.apply(t)), t == null ? void 0 : t.map((r) => new Ca(r));
}, nn = (e, t) => {
...
class Ma {
  constructor(t) {
    var n, r, i, a, s;
    if (this.options = t, this.baseSubscriptionClient = void 0, this.currentTransaction = null, this.authenticationMode = ve.Anonymous, this.transaction = async (o, u) => {
      let l, c;
      ...
      try {
        ...
        y[Ji] = this, f = new Hu(y, p), this.currentTransaction = f, await f.start();
        const h = await l(f);
        return await f.commit(), h;
      } catch (y) {
        try {
    ...
    }, this.fetch = async (o, u = {}) => {
      var l;
      o = sl(o, (l = this.options.baseRouteURL) !== null && l !== void 0 ? l : this.options.endpoint), this.isGadgetRequest(o) && (u.headers = { ...this.requestHeaders(), ...u.headers }, this.authenticationMode == ve.Custom && await this.options.authenticationMode.custom.processFetch(o, u));
      const c = await this._fetchImplementation(o, u);
      if (this.authenticationMode == ve.BrowserSession) {
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof window < "u" && window.fetch ? this._fetchImplementation = window.fetch.bind(window) : this._fetchImplementation = async (...o) => {
      const { fetch: u } = await import("./browser-ponyfill-795a9c33.js").then((l) => l.b);
      return await u(...o);
  ...
  setAuthenticationMode(t) {
    var n;
    t && (t.browserSession ? this.enableSessionMode(t.browserSession) : t.internalAuthToken ? this.authenticationMode = ve.InternalAuthToken : t.apiKey ? this.authenticationMode = ve.APIKey : t.custom && (this.authenticationMode = ve.Custom), this.options.authenticationMode = t), (n = this.authenticationMode) !== null && n !== void 0 || (this.authenticationMode = ve.Anonymous);
  }
  enableSessionMode(t) {
    this.authenticationMode = ve.BrowserSession;
  ...
  isGadgetRequest(t) {
    let n;
    if (typeof t == "string" ? n = t : typeof t == "object" && "url" in t ? n = t.url : n = String(t), Tr(this.options.endpoint))
      return !!Tr(n);
  ...
  newSubscriptionClient(t) {
    ...
    return Vu({
      ...
      connectionParams: async () => {
        ...
        return this.authenticationMode == ve.APIKey ? a.auth.key = this.options.authenticationMode.apiKey : this.authenticationMode == ve.InternalAuthToken ? a.auth.token = this.options.authenticationMode.internalAuthToken : this.authenticationMode == ve.BrowserSession ? a.auth.sessionToken = this.sessionTokenStore.getItem(this.sessionStorageKey) : this.authenticationMode == ve.Custom && await ((i = (r = this.options.authenticationMode) === null || r === void 0 ? void 0 : r.custom) === null || i === void 0 ? void 0 : i.processTransactionConnectionParams(a)), a;
      },
      onNonLazyError: () => {
      },
      on: {
        connected: (r, i) => {
          var a, s, o, u, l, c;
          if (this.authenticationMode == ve.BrowserSession && (i != null && i.sessionToken)) {
  ...
  async waitForOpenedConnection(t) {
    ...
    return await new Promise((o, u) => {
      const l = setTimeout(() => {
        ...
        s(), r.push(n.on("connected", f)), r.push(n.on("closed", c)), r.push(n.on("error", p));
      };
      y();
    }).finally(s);
  }
...
class Lr {
  constructor(t, n, r) {
    this.type = t, this.name = n, this.value = r;
  }
  present() {
...
class Le {
  constructor(t, n, r) {
    this.apiIdentifier = t, this.connection = n, this.options = r, this.capitalizedApiIdentifier = qn(t);
  }
  validateRecord(t) {
   ...
   */
  async findMany(t) {
    const n = dl(this.apiIdentifier, t), r = await this.connection.currentClient.query(n.query, n.variables).toPromise(), i = Ht(r, ["internal", `list${this.capitalizedApiIdentifier}`]), a = nn(r, i);
    return Ft.boot(this, a, { options: t, pageInfo: i.pageInfo });
  }
  /**
  ...
  async findFirst(t, n = !0) {
    ...
    const s = nn(i, a);
    return Ft.boot(this, s, { options: t, pageInfo: a.pageInfo })[0];
  }
  /**
   ...
   */
  async create(t) {
    const n = await this.connection.currentClient.mutation(fl(this.apiIdentifier), {
...
const Br = (e) => ({
...
}, La = (e) => Object.fromEntries(Object.entries(e).map(([t, n]) => [t, Ee(n)])), bl = (e, t, n, r, i, a, s, o, u) => {
  ...
  const o = gl(t, n, r, i, a), u = await e.connection.currentClient.query(o.query, o.variables).toPromise(), c = (s ? Ze : Ht)(u, [t]);
  return Kt(u, c);
}, Bn = async (e, t, n, r, i, a, s) => {
  const o = vl(t, n, r, i, a, s), u = await e.connection.currentClient.query(o.query, o.variables).toPromise(), l = Ze(u, [t]), c = nn(u, l);
  if (c.length > 1)
    throw Ju(a, n, r);
  return c[0];
}, $ = async (e, t, n, r, i, a) => {
  ...
  const l = nn(o, u);
  return Ft.boot(e, l, { options: i, pageInfo: u.pageInfo });
}, I = async (e, t, n, r, i, a, s, o, u, l) => {
  const c = bl(t, n, r, i, s, o, u, a, l), p = await e.connection.currentClient.mutation(c.query, c.variables).toPromise(), f = u ? [u, t] : [t];
  if (a) {
    const y = Rt(p.data, f), h = y[i] && n ? $r(p, y[i]) : void 0;
    if (y.errors) {
      const v = y.errors.map((E) => Mr(E));
      throw new Qu(v, h);
    }
    return h;
  } else {
...
var Ba;
const rr = "production", wn = "development", mc = Symbol.for("gadget/modelRelationships"), gc = () => {
  try {
...
class vc {
  constructor(t) {
    ...
    const n = (t == null ? void 0 : t.environment) ?? gc() ?? wn;
    let r = n.toLocaleLowerCase();
    r != wn && r != rr && (console.warn("Invalid environment", n, "defaulting to development"), r = wn);
    ...
    }), typeof window < "u" && this.connection.authenticationMode == ve.APIKey && !((a = t == null ? void 0 : t.authenticationMode) != null && a.dangerouslyAllowBrowserApiKey))
      throw new Error("GGT_BROWSER_API_KEY_USAGE: Using a Gadget API key to authenticate this client object is insecure and will leak your API keys to attackers. Please use a different authentication mode.");
    this.user = new Al(this.connection), this.session = new kl(this.connection), this.productPairing = new Cl(this.connection), this.unambiguous = new jl(this.connection), this.shopifyProduct = new Ul(this.connection), this.shopifyProductImage = new Gl(this.connection), this.shopifyProductOption = new Jl(this.connection), this.shopifyProductVariant = new Xl(this.connection), this.shopifyShop = new ic(this.connection), this.shopifySync = new uc(this.connection), this.ambiguous = new fc(this.connection), this.currentSession = new yc(this.connection), this.internal = {
...
var bc = () => {
  ...
  extensions: void 0,
  operation: void 0
}, Ic = (e, t) => e === t || !(!e || !t || e.key !== t.key), ir = (e, t) => {
  var n = {
    ...e,
    ...t,
  ...
  return ((r, i) => {
    for (var a in r)
      if (!(a in i))
        return !0;
    for (var s in i)
      if (s === "operation" ? !Ic(r[s], i[s]) : r[s] !== i[s])
        return !0;
    return !1;
  })(e, n) ? n : e;
}, wc = (e, t) => {
...
var Ec = (e) => {
  ...
  return e._react;
}, Ac = (e, t) => e.suspense && (!t || t.suspense !== !1);
function Nc(e) {
  var t = bc(), n = Ec(t), r = Ac(t, e.context), i = Oc(e.query, e.variables), a = We.useMemo(() => {
    if (e.pause)
      return null;
    var f = t.executeQuery(i, {
  ...
  }, [n, t, i, r, e.pause, e.requestPolicy, e.context]), s = We.useCallback((f, y) => {
    if (!f)
      return {
        fetching: !1
      };
  ...
  a !== u[0] && wc(u[2], o) && l([a, c = ir(u[1], s(a, r)), o]), We.useEffect(() => {
    var f = u[0], y = u[2][1], h = !1, v = (k) => {
      h = !0, Hi(l, (O) => {
        var P = ir(O[1], k);
        return O[1] !== P ? [O[0], P, O[2]] : O;
      });
    };
    if (f) {
      var E = ht(v)(Fr(() => {
...
const Tc = Fn.createContext(void 0);
Fn.createContext(void 0);
const kc = "Could not find a client in the context of Provider. Please ensure you wrap the root component in a <Provider>", Pc = (e, t) => {
  let n = "";
...
class dt extends Error {
  ...
  constructor({ networkError: t, executionErrors: n, response: r }) {
    const i = (n || []).map(_c), a = Pc(t, i);
    super(a), this.message = a, this.executionErrors = i, this.graphQLErrors = i, this.networkError = t, this.response = r;
  }
...
var Fc = typeof Element < "u", Dc = typeof Map == "function", jc = typeof Set == "function", Vc = typeof ArrayBuffer == "function" && !!ArrayBuffer.isView;
function Nn(e, t) {
  if (e === t)
    return !0;
  if (e && t && typeof e == "object" && typeof t == "object") {
    ...
    var a;
    if (Dc && e instanceof Map && t instanceof Map) {
      if (e.size !== t.size)
        return !1;
      for (a = e.entries(); !(r = a.next()).done; )
        if (!t.has(r.value[0]))
          return !1;
      for (a = e.entries(); !(r = a.next()).done; )
        if (!Nn(r.value[1], t.get(r.value[0])))
          return !1;
      return !0;
    }
    ...
    for (r = n; r-- !== 0; )
      if (!Object.prototype.hasOwnProperty.call(t, i[r]))
        return !1;
    if (Fc && e instanceof Element)
      return !1;
    for (r = n; r-- !== 0; )
      if (!((i[r] === "_owner" || i[r] === "__v" || i[r] === "__o") && e.$$typeof) && !Nn(e[i[r]], t[i[r]]))
        return !1;
    return !0;
  }
  return e !== e && t !== t;
...
const $c = /* @__PURE__ */ ms(Mc), Uc = (e) => {
  ...
  const n = Uc(t), r = sr(() => Qr(e.findMany.operationName, e.findMany.defaultSelection, e.findMany.modelApiIdentifier, n), [e, n]), [i, a] = Rc(Cc(r, t));
  return [sr(() => {
    ...
    const l = dt.errorIfDataAbsent(i, o, t == null ? void 0 : t.pause);
