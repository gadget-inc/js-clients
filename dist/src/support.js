...
const hydrateRecord = (response, record, modelManager) => {
    ...
    return new GadgetRecord_1.GadgetRecord(record, modelManager);
};
...
const hydrateRecordArray = (response, records, modelManager) => {
    ...
    return records === null || records === void 0 ? void 0 : records.map((record) => new GadgetRecord_1.GadgetRecord(record, modelManager));
};
