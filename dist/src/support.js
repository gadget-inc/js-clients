...
class ConnectionOpenAwaiter {
    constructor() {
        ...
        Object.defineProperty(this, "opened", {
            ...
            configurable: true,
            writable: true,
            value: (0, exports.traceFunction)("api-client.await-websocket-open", async () => {
                await this._opened;
            })
        });
...
exports.ConnectionOpenAwaiter = ConnectionOpenAwaiter;
