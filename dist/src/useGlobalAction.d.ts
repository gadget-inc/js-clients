import { GlobalActionFunction } from "@gadgetinc/api-client-core";
 ...
 * }
 */
export declare const useGlobalAction: <F extends GlobalActionFunction<any>>(action: F) => UseMutationResponse<any, Exclude<F["variablesType"], null | undefined>>;
