...
const connectionOpen = async (subscriptionClient, isConnected) => {
    ...
    await new Promise((resolve, reject) => {
        ...
        const timeout = setTimeout(() => {
            if (isConnected()) {
                ...
                reject(new Error("Timeout opening batch connection to Gadget API"));
            }
        }, 5000);
        ...
        Object.defineProperty(this, "transaction", {
            ...
            value: async (optionsOrRun, maybeRun) => {
                ...
                const subscriptionClient = this.newSubscriptionClient({
                    ...
                    on: {
                        ...options.on,
                        // Immediately add a connected listener to ensure we always know when the connected event happens, because it could potentially happen
                        // before we subscribe to the connected event in `connectionOpen`.
                ...
                try {
                    ...
                    await (0, exports.connectionOpen)(subscriptionClient, () => connected);
