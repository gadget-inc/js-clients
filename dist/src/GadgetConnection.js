...
exports.GadgetConnection = exports.AuthenticationMode = exports.connectionOpened = exports.$transaction = void 0;
...
exports.connectionOpened = (0, support_1.traceFunction)("api-client.await-websocket-open", async (subscriptionClient, timeoutMs) => {
        ...
        Object.defineProperty(this, "transaction", {
            ...
            value: (0, support_1.traceFunction)("api-client.transaction", async (optionsOrRun, maybeRun) => {
                ...
                try {
                    ...
                    await (0, exports.connectionOpened)(subscriptionClient, options.connectionTimeoutMs ?? 10000);
