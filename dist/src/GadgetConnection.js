...
class GadgetConnection {
    constructor(options) {
        ...
        this.websocketImplementation = (_a = options.websocketImplementation) !== null && _a !== void 0 ? _a : isomorphic_ws_1.default;
        this.websocketsEndpoint = (_b = options.websocketsEndpoint) !== null && _b !== void 0 ? _b : options.endpoint + "/batch";
        this.websocketsEndpoint = this.websocketsEndpoint.replace(/^http/, "ws");
        this.environment = (_c = options.environment) !== null && _c !== void 0 ? _c : "Development";
        this.requestPolicy = (_d = options.requestPolicy) !== null && _d !== void 0 ? _d : "cache-and-network";
