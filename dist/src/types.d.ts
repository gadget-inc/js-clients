...
export declare type CurrencyAmount = string;
...
export declare type GadgetID = string;
...
export declare type RecordState = string | {
 ...
 **/
export declare type AnySort = FieldSort | FieldSort[];
export declare type AnyFieldFilter = IDFilter | DateTimeFilter | DateFilter | JSONFilter | StringFilter | SingleEnumFilter | MultiEnumFilter | IntFilter | FloatFilter | BooleanFilter;
 ...
 *
 **/
export declare type AnyFilter = FilterElement | FilterElement[];
/**
 * A list of fields to return from the backend
 * Is not specific to any backend model. Look for the backend specific types in the generated API client if you need strong type safety.
 */
export declare type AnySelection = {
    [key: string]: boolean | null | AnySelection;
};
...
/** The options a record find operation takes that can return many records */
export declare type FindFilteredOptions = {
    /** Return only the given fields on the backend record (and related records) */
    select?: AnySelection;
    /** Sort the returned records by the given critera */
    sort?: AnySort | null;
...
/**
 * Which fields to return from the backend during an internal API call.
 ...
 **/
export declare type InternalFieldSelection = string[];
/** The options an internal record find operation takes that can return many records */
export declare type InternalFindManyOptions = {
    /** Sort the returned records by the given critera */
    sort?: AnySort | null;
    /** Only return records which match the given set of filters */
    filter?: AnyFilter | null;
...
/** The options a record find operation takes that can return many records */
export declare type InternalFindFilteredOptions = {
    /** Sort the returned records by the given critera */
    sort?: AnySort | null;
    /** Only return records which match the given set of filters */
    filter?: AnyFilter | null;
...
export declare type InternalMutationOptions = {
    /**
     * Which fields to return from the backend
     * __Note__: This selection is different than the top level select option -- it just accepts a list of string fields, and not a nested selection. To use a nested selection, use the top level API.
     **/
