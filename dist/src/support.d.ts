...
export declare const assertOperationSuccess: (response: OperationResult<any>, dataPath: string[]) => any;
...
export declare const hydrateRecord: <Shape = any>(response: Result, record: any) => Shape;
export declare const hydrateRecordArray: <Shape = any>(response: Result, records: Array<any>) => (import("./GadgetRecord").GadgetRecordImplementation<Shape> & Shape)[];
export declare const hydrateConnection: <Shape = any>(response: Result, connection: {
    edges: {
        node: Node;
    }[];
...
export declare class ConnectionOpenAwaiter {
    private _opened;
    private _resolve;
    private _reject;
    constructor();
