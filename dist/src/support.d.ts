...
export declare const gadgetErrorFor: (error: Record<string, any>) => GadgetNonUniqueDataError | GadgetOperationError | InvalidRecordError;
...
export declare const hydrateRecord: <Shape extends RecordShape = RecordShape>(response: Result, record: any, modelManager?: AnyModelManager) => GadgetRecord<Shape>;
export declare const hydrateRecordArray: <Shape extends RecordShape = any>(response: Result, records: Array<any>, modelManager?: AnyModelManager) => (import("./GadgetRecord").GadgetRecordImplementation<Shape> & Shape)[];
export declare const hydrateConnection: <Shape extends RecordShape = any>(response: Result, connection: {
    edges: {
        node: Node;
    }[];
}, modelManager?: AnyModelManager) => (import("./GadgetRecord").GadgetRecordImplementation<Shape> & Shape)[];
