 ...
 * ```
 */
export declare const useFindMany: <GivenOptions extends OptionsType, SchemaT, F extends FindManyFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & Omit<UseQueryArgs, "variables" | "query">>(manager: {
    findMany: F;
} & AnyPublicModelManager, options?: (LimitToKnownKeys<Options, F["optionsType"]> & Omit<UseQueryArgs, "variables" | "query">) | undefined) => ReadHookResult<GadgetRecordList<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
