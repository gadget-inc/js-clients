...
exports.useApi = exports.useConnection = exports.Provider = exports.GadgetClientContext = exports.GadgetUrqlClientContext = void 0;
...
function Provider(props) {
    ...
    if ("auth" in props) {
        ...
        if (auth?.signOutPath)
            signOutPath = auth.signOutPath;
    }
    return (react_1.default.createElement(exports.GadgetUrqlClientContext.Provider, { value: urqlClient },
        react_1.default.createElement(exports.GadgetClientContext.Provider, { value: {
                api: gadgetClient,
                auth: {
                    signInPath,
                    signOutPath,
 ...
 **/
const useApi = () => {
    const gadgetContext = (0, react_1.useContext)(exports.GadgetClientContext);
    const urqlClient = (0, react_1.useContext)(exports.GadgetUrqlClientContext);
