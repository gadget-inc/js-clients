 ...
 * }
 */
export declare const useBulkAction: <GivenOptions extends OptionsType, SchemaT, F extends BulkActionFunction<GivenOptions, any, any, SchemaT, any>, Options extends F["optionsType"]>(action: F, options?: LimitToKnownKeys<Options, F["optionsType"]> | undefined) => UseMutationResponse<GadgetRecord<Select<Exclude<SchemaT, null | undefined>, Options["select"]>>[], Exclude<F["variablesType"], null | undefined>>;
