...
export declare class GadgetRecordImplementation<Shape extends RecordShape> {
    readonly modelManager: AnyModelManager | null;
    private __gadget;
    private empty;
    constructor(data: Shape, modelManager?: AnyModelManager | null);
...
export declare const GadgetRecord: new <Shape extends RecordShape>(data: Shape, modelManager?: AnyModelManager) => GadgetRecordImplementation<Shape> & Shape;
