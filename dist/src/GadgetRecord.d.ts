...
export declare const GadgetRecord: new <Shape extends RecordShape>(data?: Shape | null) => GadgetRecordImplementation<Shape> & Shape;
export declare type GadgetRecord<Shape extends RecordShape> = GadgetRecordImplementation<Shape> & Shape;
