...
import { AnyClient } from "./AnyClient";
...
export declare class GadgetRecordImplementation<Shape extends RecordShape> {
    ...
    modelName?: string;
    api?: AnyClient;
    constructor(data: Shape, modelName?: string, apiClient?: AnyClient);
...
export declare const GadgetRecord: new <Shape extends RecordShape>(data: Shape, modelName?: string, apiClient?: AnyClient) => GadgetRecordImplementation<Shape> & Shape;
