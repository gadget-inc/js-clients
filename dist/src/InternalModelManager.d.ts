...
/** Options for internal action API calls */
export interface InternalActionOptions {
    /**
     * What fields to retrieve on the returned record from this internal action
     **/
    select?: InternalFieldSelection;
}
...
export declare class InternalModelManager {
     ...
     */
    create(record: RecordData, options?: InternalActionOptions): Promise<GadgetRecord<RecordShape>>;
    /**
     ...
     */
    bulkCreate(records: RecordData[], options?: InternalActionOptions): Promise<GadgetRecord<RecordShape>[]>;
    /**
     ...
     */
    update(id: string, record: RecordData, options?: InternalActionOptions): Promise<GadgetRecord<RecordShape>>;
    /**
