...
export declare const internalFindManyQuery: (apiIdentifier: string, options?: RecordData) => {
    variables: any;
    query: string;
};
...
export declare class InternalModelManager {
    ...
    readonly pluralApiIdentifier: string;
    readonly connection: GadgetConnection;
    private readonly capitalizedApiIdentifier;
    constructor(apiIdentifier: string, pluralApiIdentifier: string, connection: GadgetConnection);
