...
export declare type AsyncRecord<T extends RecordShape> = Promise<GadgetRecord<T>>;
export declare type AsyncNullableRecord<T extends RecordShape> = Promise<GadgetRecord<T> | null>;
export declare type AsyncRecordList<T extends RecordShape> = Promise<GadgetRecordList<T>>;
...
export declare type BulkActionFunction<OptionsT, VariablesT, SelectionT, SchemaT, DefaultsT> = ActionFunctionMetadata<OptionsT, VariablesT, SelectionT, SchemaT, DefaultsT, true> & BulkActionWithIdsAndNoVariables<OptionsT>;
