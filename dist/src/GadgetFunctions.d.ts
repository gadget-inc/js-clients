import type { GadgetRecord, GadgetRecordList, LimitToKnownKeys, VariableOptions } from ".";
export declare type AsyncRecord<T> = Promise<GadgetRecord<T>>;
export declare type AsyncRecordList<T> = Promise<GadgetRecordList<T>>;
