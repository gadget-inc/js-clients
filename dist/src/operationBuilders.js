...
const findOneOperation = (operation, id, defaultSelection, modelApiIdentifier, options) => {
    ...
    return (0, gql_query_builder_1.query)([
        {
            operation,
            fields: (0, _1.fieldSelectionToGQLBuilderFields)(options?.select || defaultSelection),
            variables,
        },
    ...
    return (0, gql_query_builder_1.query)([
        {
            ...
            fields: [
                ...
                {
                    edges: ["cursor", { node: (0, _1.fieldSelectionToGQLBuilderFields)(options?.select || defaultSelection) }],
                },
            ],
            variables: {
...
const actionOperation = (operation, defaultSelection, modelApiIdentifier, modelSelectionField, variables, options, namespace) => {
    ...
    if (selection) {
        actionOperation.fields.push({ [modelSelectionField]: (0, _1.fieldSelectionToGQLBuilderFields)(selection) });
    }
    if (namespace) {
        actionOperation = {
            operation: namespace,
