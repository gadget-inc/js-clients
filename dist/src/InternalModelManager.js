...
class InternalModelManager {
    ...
    async findOne(id, options, throwOnEmptyData = true) {
        ...
        return (0, support_1.hydrateRecord)(response, result, this);
    }
    /**
    ...
    async findMany(options) {
        ...
        const records = (0, support_1.hydrateConnection)(response, connection, this);
    ...
    async create(record) {
        return await this.transaction(async (transaction) => {
            ...
            return (0, support_1.hydrateRecord)(response, result[this.apiIdentifier], this);
        });
    }
    /**
    ...
    async bulkCreate(records) {
        return await this.transaction(async (transaction) => {
            ...
            return (0, support_1.hydrateRecordArray)(response, result[this.options.pluralApiIdentifier], this);
        });
    }
    /**
