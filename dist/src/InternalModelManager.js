...
class InternalModelManager {
    constructor(apiIdentifier, pluralApiIdentifier, connection) {
        ...
        Object.defineProperty(this, "pluralApiIdentifier", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: pluralApiIdentifier
        });
    ...
    async bulkCreate(records) {
        return await this.transaction(async (transaction) => {
            const response = await transaction.client
                .mutation((0, exports.internalBulkCreateMutation)(this.apiIdentifier, this.pluralApiIdentifier), {
                records,
            })
                .toPromise();
            const result = (0, support_1.assertMutationSuccess)(response, ["internal", `bulkCreate${this.capitalizedApiIdentifier}`]);
            return (0, support_1.hydrateRecordArray)(response, result[this.pluralApiIdentifier]);
        });
    }
