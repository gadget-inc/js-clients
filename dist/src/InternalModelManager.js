...
const internalBulkCreateMutation = (apiIdentifier, pluralApiIdentifier) => {
    const capitalizedApiIdentifier = (0, support_1.capitalize)(apiIdentifier);
    const capitalizedPluralApiIdentifier = (0, support_1.capitalize)(pluralApiIdentifier);
    return `
    ${internalErrorsDetails}
...
class InternalModelManager {
    ...
    async bulkCreate(records) {
        return await this.transaction(async (transaction) => {
            ...
            const capitalizedPluralApiIdentifier = (0, support_1.capitalize)(this.options.pluralApiIdentifier);
            const response = await transaction.client
