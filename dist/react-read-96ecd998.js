...
const te = Symbol.for("g/fields"), Xe = Symbol.for("g/if"), et = Symbol.for("g/pf"), tt = Symbol.for("g/fk"), Mt = Symbol.for("g/t");
class vo {
  constructor(t) {
    var r, n;
...
class Li {
  constructor(t) {
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof ar < "u" && ar.fetch ? this._fetchImplementation = ar.fetch.bind(ar) : this._fetchImplementation = async (...s) => {
      let l = await import("./browser-ponyfill-b9b46652.js").then((d) => d.b);
