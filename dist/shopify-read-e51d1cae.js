...
class Il {
  constructor(n) {
    var t, r, i, a, o;
    if (this.options = n, this.currentTransaction = null, this.authenticationMode = Ye.Anonymous, this.transaction = async (s, y) => {
      let u, c;
    ...
    this.endpoint = n.endpoint, n.fetchImplementation ? this._fetchImplementation = n.fetchImplementation : typeof window < "u" && window.fetch ? this._fetchImplementation = window.fetch.bind(window) : this._fetchImplementation = async (...s) => {
      const { fetch: y } = await import("./browser-ponyfill-ad733692.js").then((u) => u.b);
      return await y(...s);
