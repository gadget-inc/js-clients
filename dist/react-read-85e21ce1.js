...
import xn, { useMemo as Zn, useContext as lo, useRef as co } from "react";
...
function po() {
  if (ei)
    return qt;
  ei = 1;
  var e = xn, t = Symbol.for("react.element"), n = Symbol.for("react.fragment"), r = Object.prototype.hasOwnProperty, i = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, a = { key: !0, ref: !0, __self: !0, __source: !0 };
  function o(s, l, d) {
...
function mo() {
  return ti || (ti = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Oe(u) {
      ...
      if (typeof u == "object")
        switch (u.$$typeof) {
          ...
          case l:
            return ln(u, u.render, "ForwardRef");
          case f:
            var A = u.displayName || null;
            return A !== null ? A : Oe(u.type) || "Memo";
          case p: {
            var j = u, B = j._payload, F = j._init;
            try {
              return Oe(F(B));
            } catch {
              return null;
    ...
    var O = Object.assign, q = 0, M, D, z, Me, $, Je, et;
    function ct() {
    }
    ...
    function tt() {
      {
        if (q === 0) {
          M = console.log, D = console.info, z = console.warn, Me = console.error, $ = console.group, Je = console.groupCollapsed, et = console.groupEnd;
          var u = {
            configurable: !0,
            enumerable: !0,
            value: ct,
    ...
    var J = k.ReactCurrentDispatcher, cn;
    function Nt(u, b, g) {
      {
        if (cn === void 0)
          try {
...
` + x[Y].replace(" at new ", " at ");
                    return u.displayName && Ee.includes("<anonymous>") && (Ee = Ee.replace("<anonymous>", u.displayName)), typeof u == "function" && dn.set(u, Ee), Ee;
                  }
                while (Y >= 1 && X >= 0);
              break;
            }
        ...
        Vn = !1, J.current = B, te(), Error.prepareStackTrace = j;
      }
      var Ot = u ? u.displayName || u.name : "", Zr = Ot ? Nt(Ot) : "";
      return typeof u == "function" && dn.set(u, Zr), Zr;
    }
    function La(u, b, g) {
      return Br(u, !1);
    }
    ...
    var pn = Object.prototype.hasOwnProperty, Lr = {}, Ur = k.ReactDebugCurrentFrame;
    function mn(u) {
      if (u) {
        var b = u._owner, g = fn(u.type, u._source, b ? b.type : null);
    ...
    function qa(u, b, g, A, j) {
      {
        var B = Function.call.bind(pn);
        for (var F in u)
          if (B(u, F)) {
            var x = void 0;
            try {
              if (typeof u[F] != "function") {
                var pe = Error((A || "React class") + ": " + g + " type `" + F + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof u[F] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw pe.name = "Invariant Violation", pe;
              }
              x = u[F](b, F, A, g, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (Y) {
              x = Y;
            }
            x && !(x instanceof Error) && (mn(j), w("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", A || "React class", g, F, typeof x), mn(null)), x instanceof Error && !(x.message in Lr) && (Lr[x.message] = !0, mn(j), w("Failed %s type: %s", g, x.message), mn(null));
          }
      }
    }
    ...
    function Ha(u, b) {
      if (typeof u.ref == "string" && Ut.current && b && Ut.current.stateNode !== b) {
        ...
        Ln[g] || (w('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', Oe(Ut.current.type), u.ref), Ln[g] = !0);
      }
    }
    function Ka(u, b) {
      {
    ...
    function eo(u, b, g, A, j) {
      {
        var B, F = {}, x = null, pe = null;
        g !== void 0 && (Gr(g), x = "" + g), Ya(b) && (Gr(b.key), x = "" + b.key), Ja(b) && (pe = b.ref, Ha(b, j));
        for (B in b)
          pn.call(b, B) && !Wa.hasOwnProperty(B) && (F[B] = b[B]);
        if (u && u.defaultProps) {
        ...
        return Za(u, x, pe, j, A, Ut.current, F);
      }
    }
    var Un = k.ReactCurrentOwner, Wr = k.ReactDebugCurrentFrame;
    function At(u) {
      if (u) {
        var b = u._owner, g = fn(u.type, u._source, b ? b.type : null);
    ...
    function Hr(u, b) {
      {
        ...
        Yr[g] = !0;
        var A = "";
        u && u._owner && u._owner !== Un.current && (A = " It was passed a child from " + Oe(u._owner.type) + "."), At(u), w('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', g, A), At(null);
      }
    }
    function Kr(u, b) {
      {
        ...
        if (Bn(u))
          ...
          if (typeof j == "function" && j !== u.entries)
            for (var B = j.call(u), F; !(F = B.next()).done; )
              Gn(F.value) && Hr(F.value, b);
        }
      }
    }
    function ro(u) {
    ...
    function Xr(u, b, g, A, j, B) {
      {
        ...
        if (!F) {
          ...
          pe ? x += pe : x += Jr();
          var Y;
          u === null ? Y = "null" : Bn(u) ? Y = "array" : u !== void 0 && u.$$typeof === t ? (Y = "<" + (Oe(u.type) || "Unknown") + " />", x = " Did you accidentally export a JSX literal instead of a component?") : Y = typeof u, w("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Y, x);
        }
        var X = eo(u, b, g, j, B);
        if (X == null)
          return X;
...
process.env.NODE_ENV === "production" ? er.exports = po() : er.exports = mo();
var ni = er.exports, vr = () => {
}, Ie = vr;
function Ce(e) {
  return {
    tag: 0,
...
var zn = {
  ...
  [Symbol.asyncIterator]() {
    var t = [], n = !1, r = Ie, i;
    return e((a) => {
      n || (a === 0 ? (i && (i = i(zn)), n = !0) : a.tag === 0 ? (r = a[0])(0) : i ? i = i({
        value: a[0],
        done: !1
      }) : t.push(a[0]));
    }), {
      async next() {
        return n && !t.length ? zn : (!n && t.length <= 1 && r(0), t.length ? {
          value: t.shift(),
          done: !1
        } : new Promise((a) => i = a));
      },
      async return() {
        return n || (i = r(1)), n = !0, zn;
      }
    };
  }
});
...
var G, T;
function ee(e) {
  return new en(`Syntax Error: Unexpected token at ${T} in ${e}`);
}
function Ae(e) {
...
`), n = "", r = 0, i = 0, a = t.length - 1, o = 0; o < t.length; o++)
    hn.lastIndex = 0, hn.test(t[o]) && (o && (!r || hn.lastIndex < r) && (r = hn.lastIndex), i = i || o, a = o);
  for (var s = i; s <= a; s++)
    s !== i && (n += `
  ...
  (e = Ae(Co)) && (_(), t = We(), n = function() {
    ...
    if (_(), G.charCodeAt(T) === 40) {
      for (T++, _(); o = Ae(Ji); ) {
        ...
        var l = Hi(), d = void 0;
        if (G.charCodeAt(T) === 61 && (T++, _(), !(d = En(!0))))
          throw ee("VariableDefinition");
        _(), s.push({
...
var Bo = (e) => e && e.message && (e.extensions || e.name === "GraphQLError") ? e : typeof e == "object" && e.message ? new en(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : new en(e);
...
var tr = (e, t) => {
  ...
  if (Array.isArray(e)) {
    ...
    return t += "]";
  } else if (kn !== Ct && e instanceof kn || _n !== Ct && e instanceof _n)
    return "null";
  ...
  if (!(n == null || typeof n != "object" || n.toJSON || gt.has(n)))
    if (Array.isArray(n))
      for (var r = 0, i = n.length; r < i; r++)
        nr(e, `${t}.${r}`, n[r]);
    else if (n instanceof kn || n instanceof _n)
      e.set(t, n);
    else {
      gt.add(n);
...
var kn = typeof File < "u" ? File : Ct, _n = typeof Blob < "u" ? Blob : Ct, Lo = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g, Uo = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g, qo = (e, t) => t % 2 == 0 ? e.replace(Uo, `
`) : e, ui = (e) => e.split(Lo).map(qo).join("").trim(), li = /* @__PURE__ */ new Map(), In = /* @__PURE__ */ new Map(), Or = (e) => {
  var t;
  return typeof e == "string" ? t = ui(e) : e.loc && In.get(e.__key) === e ? t = e.loc.source.body : (t = li.get(e) || ui(ke(e)), li.set(e, t)), typeof e != "string" && !e.loc && (e.loc = {
    start: 0,
    end: t.length,
    source: {
      body: t,
...
# ${n}`, t));
  ...
  var t, n;
  return typeof e == "string" ? (t = ci(e), n = In.get(t) || $o(e)) : (t = e.__key || ci(e), n = In.get(t) || e), n.loc || Or(n), n.__key = t, In.set(t, n), n;
}, wn = (e, t, n) => {
  var r = t || {}, i = Xi(e), a = Tn(r), o = i.__key;
  return a !== "{}" && (o = tr(a, o)), {
    key: o,
    query: i,
    variables: r,
  ...
  return {
    operation: e,
    data: t.data,
    error: Array.isArray(t.errors) ? new an({
...
var zo = (e, t) => {
  ...
  for (var i in t) {
    var a = t[i];
    a && r.searchParams.set(i, typeof a == "object" ? Tn(a) : a);
  }
  var o = r.toString();
  ...
  if (t && !(e.kind === "query" && e.context.preferGetMethod)) {
    var n = Tn(t), r = ((s) => {
      ...
      return (kn !== Ct || _n !== Ct) && (gt.clear(), nr(l, "variables", s)), l;
    })(t.variables);
    if (r.size) {
      var i = new FormData();
      i.append("operations", n), i.append("map", Tn({
        ...[...r.keys()].map((s) => [s])
      }));
      var a = 0;
...
function hi(e) {
  var t = (n) => e(n);
  return t.toPromise = () => Nr(Pn(1)(re((n) => !n.stale && !n.hasNext)(t))), t.then = (n, r) => t.toPromise().then(n, r), t.subscribe = (n) => vt(n)(t), t;
}
function jt(e, t, n) {
  return {
    ...t,
...
var yi = (e, t) => jt(e.kind, e, {
...
}, Qn = ({ kind: e }) => e !== "mutation" && e !== "query", ts = ({ forward: e, client: t, dispatchDebug: n }) => {
  ...
  return (s) => {
    var l = xt((c) => {
      ...
      cacheOutcome: "miss"
    }) : c)(Dt([xt(a)(re((c) => !Qn(c) && !o(c))(s)), re((c) => Qn(c))(s)])))));
    return Dt([l, d]);
  };
}, bi = (e, t) => e.reexecuteOperation(jt(t.kind, t, {
  requestPolicy: "network-only"
})), Wn = ({ forwardSubscription: e, enableAllOperations: t, isSubscriptionOperation: n }) => ({ client: r, forward: i }) => {
  ...
  var p = (y) => {
    ...
    return y.kind !== "query" ? N = zi((v) => !!v.hasNext, !0)(N) : N = ii((v) => {
      var U = Jt(v);
      return v.stale || v.hasNext ? U : Dt([U, xt(() => (v.stale = !0, v))(Pn(1)(re((Ze) => Ze.key === y.key)(l.source)))]);
    ...
    query: (y, N, v) => h.executeQuery(wn(y, N), v),
    subscription: (y, N, v) => h.executeSubscription(wn(y, N), v),
    mutation: (y, N, v) => h.executeMutation(wn(y, N), v)
  }), I = es;
  if (process.env.NODE_ENV !== "production") {
...
class ss {
  ...
  hasChanges(t = me.SinceLoaded) {
    ...
    return this.__gadget.fieldKeys.some((r) => !yn(n[r], this.__gadget.fields[r]));
  }
  ...
  changes(t, n = me.SinceLoaded) {
    ...
    if (t && typeof t == "string") {
      const a = i[t], o = this.__gadget.fields[t], s = !yn(o, a);
      ...
      for (let o = 0; o < this.__gadget.fieldKeys.length; o++) {
        ...
        yn(i[s], this.__gadget.fields[s]) || (a[s] = { current: this.__gadget.fields[s], previous: i[s] });
      }
      return a;
    }
  }
  ...
  toChangedJSON(t = me.SinceLoaded) {
    ...
    for (let i = 0; i < this.__gadget.fieldKeys.length; i++) {
      ...
      yn(n[a], this.__gadget.fields[a]) || (r[a] = this.__gadget.fields[a]);
    }
    return r;
  }
...
const $t = (e, t) => {
  ...
  var r;
  if (e.error)
    throw e.error instanceof an && (!((r = e.error.networkError) === null || r === void 0) && r.length) && (e.error.message = e.error.networkError.map((s) => "[Network] " + s.message).join(`
`)), e.error;
  ...
  var n;
  if (e.error)
    throw e.error instanceof an && (!((n = e.error.networkError) === null || n === void 0) && n.length) && (e.error.message = e.error.networkError.map((i) => "[Network] " + i.message).join(`
`)), e.error;
  const r = $t(e.data, t);
  return r ?? null;
}, Tr = (e) => {
  var t;
  return e.code == "GGT_INVALID_RECORD" ? new cs(e.message, e.validationErrors, (t = e.model) === null || t === void 0 ? void 0 : t.apiIdentifier, e.record) : e.code == "GGT_UNKNOWN" && e.message.includes("duplicate key value violates unique constraint") ? new aa(e.message) : new Fn(e.message, e.code);
}, at = (e, t) => {
  const n = Qe(e, t);
  return oa(n);
}, oa = (e) => {
  if (!e.success) {
    ...
    throw t ? Tr(t) : new Fn("Gadget API operation not successful.", "GGT_UNKNOWN");
  }
  return e;
}, sa = (e) => {
  var t, n, r, i;
  ...
  try {
    const t = window[e];
    return t.setItem(Jn, Jn), t.removeItem(Jn), !0;
  } catch {
    return !1;
  }
...
class Mt extends Array {
  ...
  firstOrThrow() {
    if (!this[0])
      throw new Fn("No records found.", "GGT_RECORD_NOT_FOUND");
    return this[0];
  }
  toJSON() {
...
function jr(e, t, n) {
  return n != null && n.live ? Ts(Io(e), t) : Ar(e, re((i) => !i.stale && !i.hasNext), Pn(1), Nr).then((i) => t(i));
}
...
async function _s(e, t, n, r = {}) {
  ...
  try {
    const d = at(s, l);
    return t.isBulk ? d.backgroundActions.map((c) => new Nn(e, t, c.id)) : new Nn(e, t, d.backgroundAction.id);
  } catch (d) {
    if ("code" in d && d.code == "GGT_DUPLICATE_BACKGROUND_ACTION_ID" && (r != null && r.id) && r.onDuplicateID == "ignore")
      return new Nn(e, t, r.id);
    throw d;
  }
}
const xs = async (e, t, n, r) => {
  ...
  }), Pn(1), Nr), s = Qe(o, ["backgroundAction"]);
...
function Bs(e, t) {
  ...
  if (Ls(e)) {
    const r = e.toJSON();
    if (r !== e)
      return typeof r == "string" ? r : Cn(r, n);
...
const Yn = 2147483647, Hn = -2147483648, Iu = new Vt({
  name: "Int",
...
new Vt({
  ...
  parseValue(e) {
    ...
    if (typeof e == "number" && Number.isInteger(e))
      return e.toString();
    throw new R(`ID cannot represent value: ${L(e)}`);
  },
  parseLiteral(e) {
...
function Fu(e) {
  const {
    ...
    retryWait: c = async function(q) {
      ...
      for (let D = 0; D < q; D++)
        M *= 2;
      await new Promise((D) => setTimeout(D, M + // add random timeout from 300ms to 3s
  ...
  const C = w, y = (() => {
    const O = (() => {
      ...
      return {
        ...
        emit(D) {
          var z;
          "id" in D && ((z = M[D.id]) === null || z === void 0 || z.call(M, D));
        }
      };
    })(), q = {
  ...
  async function Lt() {
    ...
    const [O, q] = await (v ?? (v = new Promise((z, Me) => (async () => {
      ...
      N((te) => {
        v = void 0, clearTimeout(Je), clearTimeout(et), Me(te), vn(te) && te.code === 4499 && ($.close(4499, "Terminated"), $.onerror = null, $.onclose = null);
...
const Sn = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : void 0;
class Ra {
  constructor(t) {
    var n, r, i, a, o;
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof Sn < "u" && Sn.fetch ? this._fetchImplementation = Sn.fetch.bind(Sn) : this._fetchImplementation = async (...s) => {
      let l = await import("./browser-ponyfill-c8c1794b.js").then((d) => d.b);
...
class Pe {
  ...
  getRecordFromData(t, n) {
    ...
    if (!this.validateRecord(t))
      throw new Fn(`Invalid arguments found in variables. Did you mean to use ${n}({ ${this.apiIdentifier}: { ... } })?`, "GGT_INVALID_RECORD_DATA");
   ...
   */
  async findMany(t) {
    const n = Hu(this.apiIdentifier, t), r = await this.connection.currentClient.query(n.query, n.variables).toPromise(), i = Yt(r, ["internal", `list${this.capitalizedApiIdentifier}`]), a = tn(r, i);
...
class vl {
   ...
   **/
  handle(t, n) {
    return new Nn(this.connection, t, n);
  }
  toString() {
...
Ma = bl;
var Va = {}, Mn = ze.createContext(Va);
Mn.Provider;
Mn.Consumer;
Mn.displayName = "UrqlContext";
var Sl = () => {
  var e = ze.useContext(Mn);
  ...
  extensions: void 0,
  operation: void 0
}, wl = (e, t) => e === t || !(!e || !t || e.key !== t.key), Kn = (e, t) => {
  var n = {
    ...e,
    ...t,
  ...
  for (var n = 0, r = t.length; n < r; n++)
    if (e[n] !== t[n])
      return !0;
  return !1;
}, Xn = ze.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
function Gi(e, t) {
  process.env.NODE_ENV !== "production" && Xn && Xn.ReactCurrentOwner && Xn.ReactCurrentOwner.current ? Promise.resolve(t).then(e) : e(t);
}
function Al(e, t) {
...
function Tl(e) {
  ...
  }, [n, i]), s = [t, i, e.requestPolicy, e.context, e.pause], [l, d] = ze.useState(() => [a, Kn(Il, o(a, r)), s]), c = l[1];
  a !== l[0] && Nl(l[2], s) && d([a, c = Kn(l[1], o(a, r)), s]), ze.useEffect(() => {
...
const kl = xn.createContext(void 0);
xn.createContext(void 0);
...
}, Pl = (e) => typeof e == "string" ? new en(e) : e != null && e.message && !e.code ? new en(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : e;
...
function On(e, t) {
  ...
  if (e && t && typeof e == "object" && typeof t == "object") {
    ...
    if (jl && e instanceof Map && t instanceof Map) {
      ...
      for (a = e.entries(); !(r = a.next()).done; )
        if (!t.has(r.value[0]))
          return !1;
      for (a = e.entries(); !(r = a.next()).done; )
        if (!On(r.value[1], t.get(r.value[0])))
          return !1;
      return !0;
    }
    ...
    if (Cl && e instanceof Element)
      return !1;
    for (r = n; r-- !== 0; )
      if (!((i[r] === "_owner" || i[r] === "__v" || i[r] === "__o") && e.$$typeof) && !On(e[i[r]], t[i[r]]))
        return !1;
    return !0;
  }
  return e !== e && t !== t;
...
const Bl = /* @__PURE__ */ fo(Vl), Ll = (e) => {
  ...
  const n = Ll(t), r = Zn(() => Rr(e.findMany.operationName, e.findMany.defaultSelection, e.findMany.modelApiIdentifier, n), [e, n]), [i, a] = Rl(Fl(r, t));
  return [Zn(() => {
