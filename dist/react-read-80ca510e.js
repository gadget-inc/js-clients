...
import hr, { useMemo as Dr, useContext as va, useRef as ga } from "react";
...
function Ia() {
  return Rn || (Rn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function $(u, p, v) {
      {
        var I = j.ReactDebugCurrentFrame, x = I.getStackAddendum();
        x !== "" && (p += "%s", v = v.concat([x]));
    ...
    var m = !1, A = !1, g = !1, V = !1, Ke = !1, mt;
    mt = Symbol.for("react.module.reference");
    function ht(u) {
      return !!(typeof u == "string" || typeof u == "function" || u === n || u === a || Ke || u === i || u === d || u === c || V || u === h || m || A || g || typeof u == "object" && u !== null && (u.$$typeof === y || u.$$typeof === f || u.$$typeof === o || u.$$typeof === s || u.$$typeof === l || // This needs to include all possible module reference object
    ...
    function Ie(u) {
      ...
      if (typeof u == "object")
        switch (u.$$typeof) {
          case s:
            var p = u;
            return _t(p) + ".Consumer";
          case o:
            var v = u;
            return _t(v._context) + ".Provider";
          case l:
          ...
          case y: {
            var x = u, F = x._payload, T = x._init;
            try {
              return Ie(T(F));
            } catch {
              return null;
    ...
    var k = Object.assign, M = 0, D, P, B, _e, _, Ge, Je;
    function it() {
    }
    ...
    function Ye() {
      {
        if (M === 0) {
          D = console.log, P = console.info, B = console.warn, _e = console.error, _ = console.group, Ge = console.groupCollapsed, Je = console.groupEnd;
          var u = {
            configurable: !0,
            enumerable: !0,
            value: it,
...
` + E[L].replace(" at new ", " at ");
        ...
        Ir = !1, G.current = F, J(), Error.prepareStackTrace = x;
      }
      var gt = u ? u.displayName || u.name : "", xn = gt ? bt(gt) : "";
      return typeof u == "function" && Zt.set(u, xn), xn;
    }
    function Yi(u, p, v) {
      return vn(u, !1);
    }
    ...
    function Xt(u, p, v) {
      ...
      if (typeof u == "object")
        switch (u.$$typeof) {
          ...
          case y: {
            var I = u, x = I._payload, F = I._init;
            try {
              return Xt(F(x), p, v);
            } catch {
            }
    ...
    function aa(u, p) {
      if (typeof u.ref == "string" && Rt.current && p && Rt.current.stateNode !== p) {
        ...
        kr[v] || (S('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', Ie(Rt.current.type), u.ref), kr[v] = !0);
      }
    }
    function oa(u, p) {
      {
    ...
    function la(u, p, v, I, x) {
      {
        var F, T = {}, E = null, ue = null;
        v !== void 0 && (In(v), E = "" + v), ia(p) && (In(p.key), E = "" + p.key), na(p) && (ue = p.ref, aa(p, x));
        for (F in p)
        ...
        return ua(u, E, ue, x, I, Rt.current, T);
      }
    }
    var Or = j.ReactCurrentOwner, On = j.ReactDebugCurrentFrame;
    function vt(u) {
      if (u) {
        var p = u._owner, v = Xt(u.type, u._source, p ? p.type : null);
    ...
    function Pn(u, p) {
      {
        ...
        En[v] = !0;
        var I = "";
        u && u._owner && u._owner !== Or.current && (I = " It was passed a child from " + Ie(u._owner.type) + "."), vt(u), S('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', v, I), vt(null);
      }
    }
    function Tn(u, p) {
      {
        ...
        if (Ar(u))
          ...
          if (typeof x == "function" && x !== u.entries)
            for (var F = x.call(u), T; !(T = F.next()).done; )
              Er(T.value) && Pn(T.value, p);
        }
      }
    }
    function fa(u) {
    ...
    function Cn(u, p, v, I, x, F) {
      {
        ...
        if (!T) {
          ...
          ue ? E += ue : E += Nn();
          var L;
          u === null ? L = "null" : Ar(u) ? L = "array" : u !== void 0 && u.$$typeof === t ? (L = "<" + (Ie(u.type) || "Unknown") + " />", E = " Did you accidentally export a JSX literal instead of a component?") : L = typeof u, S("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", L, E);
        }
        var Q = la(u, p, v, x, F);
        if (Q == null)
          return Q;
...
process.env.NODE_ENV === "production" ? Fr.exports = wa() : Fr.exports = Ia();
var Dn = Fr.exports, Hr = () => {
}, he = Hr;
function xe(e) {
  return {
    tag: 0,
...
function Na(e) {
  return e[Symbol.asyncIterator] ? mi(e) : (t) => {
...
var xa = /(?:null|true|false)/y, bi = /\$[_A-Za-z]\w*/y, _a = /-?\d+/y, Ra = /(?:\.\d+)?[eE][+-]?\d+|\.\d+/y, Da = /\\/g, Fa = /"""(?:"""|(?:[\s\S]*?[^\\])""")/y, ja = /"(?:"|[^\r\n]*?[^\\]")/y;
function dr(e) {
  var t, r;
  if (r = Se(xa))
    t = r === "null" ? {
  ...
  (e = Se(Ga)) && (N(), t = Ue(), r = function() {
    ...
    if (N(), q.charCodeAt(O) === 40) {
      for (O++, N(); o = Se(bi); ) {
        ...
        var l = gi(), d = void 0;
        if (q.charCodeAt(O) === 61 && (O++, N(), !(d = dr(!0))))
          throw K("VariableDefinition");
        N(), s.push({
...
var jr = (e, t) => {
  ...
  if (Array.isArray(e)) {
    ...
    return t += "]";
  } else if (pr !== Pt && e instanceof pr || yr !== Pt && e instanceof yr)
    return "null";
...
var pr = typeof File < "u" ? File : Pt, yr = typeof Blob < "u" ? Blob : Pt, Ja = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g, Ya = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g, Ha = (e, t) => t % 2 == 0 ? e.replace(Ya, `
...
# ${r}`, t));
  ...
  var n = t || {}, i = wi(e), a = fr(n), o = i.__key;
  return a !== "{}" && (o = jr(a, o)), {
    key: o,
    query: i,
    variables: n,
...
var Xa = (e, t) => {
  ...
  if (t && !(e.kind === "query" && e.context.preferGetMethod)) {
    var r = fr(t), n = ((s) => {
      ...
      return (pr !== Pt || yr !== Pt) && (ft.clear(), Mr(l, "variables", s)), l;
    })(t.variables);
    if (n.size) {
      var i = new FormData();
...
`)) {
    ...
    if (!n)
      throw d;
    yield Ai(e, a && (a.status < 200 || a.status >= 300) && a.statusText ? new Error(a.statusText) : d, a);
  }
}
function oo(e, t, r) {
  var n;
...
var Vr = (e, t) => {
  ...
  var t = wi(e), r = zn.get(t.__key);
  return r || (zn.set(t.__key, r = Ur(t)), Object.defineProperty(r, "__key", {
    value: t.__key,
    enumerable: !1
  })), r;
}, Gr = (e, t) => {
...
function Qn(e) {
  var t = (r) => e(r);
  return t.toPromise = () => tn(br(1)(H((r) => !r.stale && !r.hasNext)(t))), t.then = (r, n) => t.toPromise().then(r, n), t.subscribe = (r) => pt(r)(t), t;
}
function Tt(e, t, r) {
  return {
    ...t,
...
var Kn = (e, t) => Tt(e.kind, e, {
...
}, Tr = ({ kind: e }) => e !== "mutation" && e !== "query", lo = ({ forward: e, client: t, dispatchDebug: r }) => {
  ...
  return (s) => {
    var l = kt((c) => {
      ...
      cacheOutcome: "miss"
    }) : c)(Ot([kt(a)(H((c) => !Tr(c) && !o(c))(s)), H((c) => Tr(c))(s)])))));
    return Ot([l, d]);
  };
        ...
        return en(({ next: b, complete: w }) => {
          ...
          return Promise.resolve().then(() => {
            C || (j = h.subscribe({
              ...
              complete() {
                C || (C = !0, y.kind === "subscription" && n.reexecuteOperation(Tt("teardown", y, y.context)), S && S.hasNext && b($r(S, {
                  hasNext: !1
                })), w());
              }
            }));
...
}, r), Oi = ({ onOperation: e, onResult: t, onError: r }) => ({ forward: n }) => (i) => Gt((a) => {
  ...
  var y = (m) => {
    ...
    return m.kind !== "query" ? A = yi((g) => !!g.hasNext, !0)(A) : A = jn((g) => {
      var V = Bt(g);
      return g.stale || g.hasNext ? V : Ot([V, kt(() => (g.stale = !0, g))(br(1)(H((Ke) => Ke.key === m.key)(l.source)))]);
...
var Ni, Ei, Pi, Ti, Ci, xi, le;
(function(e) {
  e[e.SinceLoaded = 0] = "SinceLoaded", e[e.SinceLastPersisted = 1] = "SinceLastPersisted";
})(le || (le = {}));
const te = Symbol.for("g/fields"), et = Symbol.for("g/instantiatedFields"), tt = Symbol.for("g/persistedFields"), Be = Symbol.for("g/fieldKeys"), ur = Symbol.for("g/fieldKeysTracker"), Mt = Symbol.for("g/touched");
class vo {
  constructor(t) {
    Object.defineProperty(this, Ni, {
      ...
      writable: !0,
      value: !1
    }), this[et] = me(t), this[tt] = me(t), Object.assign(this[te], t), !t || Object.keys(t).length === 0 ? this.empty = !0 : (this[Be] = Object.keys(this[te]), this[Be].forEach((n) => this[ur][n] = !0));
    const r = {
      get: (n, i) => {
        if (i in this)
          return this[i];
  ...
  changes(t, r = le.SinceLoaded) {
    const i = (typeof t == "string" ? r : t || r) == le.SinceLoaded ? this[et] : this[tt];
    if (t && typeof t == "string") {
      const a = i[t], o = this[te][t], s = !nr(o, a);
      return s ? { changed: s, current: o, previous: a } : { changed: s };
    } else {
      const a = {};
      for (let o = 0; o < this[Be].length; o++) {
        const s = this[Be][o];
        nr(i[s], this[te][s]) || (a[s] = { current: this[te][s], previous: i[s] });
      }
      return a;
    }
  }
  ...
  toChangedJSON(t = le.SinceLoaded) {
    const r = t == le.SinceLoaded ? this[et] : this[tt], n = {};
    for (let i = 0; i < this[Be].length; i++) {
      const a = this[Be][i];
      nr(r[a], this[te][a]) || (n[a] = this[te][a]);
    }
    return n;
  }
  ...
  flushChanges(t = le.SinceLoaded) {
    t == le.SinceLoaded ? this[et] = me(this[te]) : t == le.SinceLastPersisted && (this[tt] = me(this[te])), this[Mt] = !1;
  }
  ...
  revertChanges(t = le.SinceLoaded) {
    let r;
    t == le.SinceLoaded ? r = Object.keys(this[et]) : r = Object.keys(this[tt]);
    for (const n of this[Be])
      r.includes(n) || delete this[te][n];
    t == le.SinceLoaded ? Object.assign(this[te], me(this[et])) : Object.assign(this[te], me(this[tt])), this[Mt] = !1;
  }
...
Ni = te, Ei = et, Pi = tt, Ti = Be, Ci = ur, xi = Mt;
const _i = vo;
...
}, Qr = (e) => (e == null ? void 0 : e.type) == "close", Ce = (e, t) => typeof e != "string" ? "" : Jt(e, t), Zn = (e) => {
...
`)), e.error;
  ...
  var t;
  return e.code == "GGT_INVALID_RECORD" ? new wo(e.message, e.validationErrors, (t = e.model) === null || t === void 0 ? void 0 : t.apiIdentifier, e.record) : e.code == "GGT_UNKNOWN" && e.message.includes("duplicate key value violates unique constraint") ? new Di(e.message) : new gr(e.message, e.code);
}, rt = (e, t) => {
  const r = Ve(e, t);
  return ji(r);
}, ji = (e) => {
  if (!e.success) {
    ...
    throw t ? cn(t) : new gr("Gadget API operation not successful.", "GGT_UNKNOWN");
  }
  return e;
}, Mi = (e) => {
  var t, r, n, i;
  ...
  const r = Mi(e);
  return r && (t = r.apply(t)), new _i(t);
}, dn = (e, t) => {
  const r = Mi(e);
  return r && (t = r.apply(t)), t == null ? void 0 : t.map((n) => new _i(n));
}, zt = (e, t) => {
  ...
  try {
    const t = window[e];
    return t.setItem(xr, xr), t.removeItem(xr), !0;
  } catch {
    return !1;
  }
}, ei = Object.prototype.toString, ti = Object.getPrototypeOf, ri = Object.getOwnPropertySymbols ? (e) => Object.keys(e).concat(Object.getOwnPropertySymbols(e)) : Object.keys, qt = (e, t, r) => {
  if (e === t)
    return !0;
  if (e == null || t == null)
    return !1;
  ...
  let a, o, s;
  if (r.push(e, t), n != i || (a = ri(e), o = ri(t), a.length != o.length || a.some(function(l) {
    return !qt(e[l], t[l], r);
  })))
    return !1;
  switch (n.slice(8, -1)) {
  ...
  for (const [n, i] of Object.entries(e))
    r[n] = { ...i, value: t[n] };
  return r;
}, nt = (e, t) => (t && e.unshift(...Array.isArray(t) ? t : [t]), e), Qe = (e, t) => {
...
const ni = (e, t, r, n, i, a, o = !0, s) => {
  ...
  return mn(l, (c) => {
    let f;
    a === !1 ? f = $t(c, d) : f = Ve(c, d, a);
    const y = zt(c, f);
    return xt.boot(e, y, { options: i, pageInfo: f.pageInfo });
  }, i);
}, ai = async (e, t, r, n, i, a, o, s, l, d) => {
  ...
  const i = xo(t, r, n), a = await e.currentClient.mutation(i.query, i.variables).toPromise(), o = nt([t], n);
...
const Mo = async (e, t, r, n) => {
  ...
  }), br(1), tn), s = Ve(o, ["backgroundAction"]);
...
function Vo(e) {
  ...
  let g, V = 0, Ke, mt = !1, ht = 0, Yt = !1;
  async function _t() {
    clearTimeout(Ke);
    const [k, M] = await (g ?? (g = new Promise((B, _e) => (async () => {
      if (mt) {
        if (await c(ht), !V)
          return g = void 0, _e({ code: 1e3, reason: "All Subscriptions Gone" });
        ht++;
      }
      m.emit("connecting");
      const _ = new $(typeof t == "function" ? await t() : t, Bo);
      let Ge, Je;
      function it() {
        isFinite(o) && o > 0 && (clearTimeout(Je), Je = setTimeout(() => {
          _.readyState === $.OPEN && (_.send(jt({ type: z.Ping })), m.emit("ping", !1, void 0));
        }, o));
      }
      A((J) => {
        g = void 0, clearTimeout(Ge), clearTimeout(Je), _e(J), ir(J) && J.code === 4499 && (_.close(4499, "Terminated"), _.onerror = null, _.onclose = null);
      }), _.onerror = (J) => m.emit("error", J), _.onclose = (J) => m.emit("closed", J), _.onopen = async () => {
        try {
          m.emit("opened", _);
          ...
          }, C)), isFinite(l) && l > 0 && (Ge = setTimeout(() => {
            _.close(ce.ConnectionAcknowledgementTimeout, "Connection acknowledgement timeout");
          }, l)), it();
        } catch (J) {
          m.emit("error", J), _.close(ce.InternalClientError, si(J instanceof Error ? J.message : new Error(J).message, "Internal client error"));
        }
      };
      let Ye = !1;
      _.onmessage = ({ data: J }) => {
        try {
          ...
          if (m.emit("message", G), G.type === "ping" || G.type === "pong") {
            m.emit(G.type, !0, G.payload), G.type === "pong" ? it() : s || (_.send(jt(G.payload ? {
              type: z.Pong,
              payload: G.payload
            } : {
              type: z.Pong
          ...
          clearTimeout(Ge), Ye = !0, m.emit("connected", _, G.payload), mt = !1, ht = 0, B([
            _,
            new Promise((Ht, bt) => A(bt))
          ]);
        } catch (G) {
          _.onmessage = null, m.emit("error", G), _.close(ce.BadResponse, si(G instanceof Error ? G.message : new Error(G).message, "Bad response"));
        }
      };
    })())));
  ...
  return n || (async () => {
    ...
    subscribe(k, M) {
      ...
      return (async () => {
        for (V++; ; )
          try {
            const [_, Ge, Je] = await _t();
            if (P)
              return Ge();
            const it = m.onMessage(D, (Ye) => {
              switch (Ye.type) {
                case z.Next: {
                  M.next(Ye.payload);
                  return;
...
const Jo = 2, Yo = 4800, Ho = 1e4, Zo = [ce.ConnectionAcknowledgementTimeout, ce.ConnectionInitialisationTimeout], li = Symbol.for("gadget/connection"), Xo = "token", es = typeof btoa < "u" ? btoa : (e) => Buffer.from(e).toString("base64");
var Y;
(function(e) {
...
class Li {
  constructor(t) {
    ...
    if (Object.defineProperty(this, "options", {
      ...
      value: async (s, l) => {
        ...
        try {
          ...
          h[li] = this, y = new Wo(h, f), this.currentTransaction = y, await y.start();
          const b = await d(y);
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof ar < "u" && ar.fetch ? this._fetchImplementation = ar.fetch.bind(ar) : this._fetchImplementation = async (...s) => {
      let l = await import("./browser-ponyfill-718b7f6c.js").then((d) => d.b);
  ...
  enableSessionMode(t) {
    ...
    let n;
    r == Ut.Durable && Xn("localStorage") ? n = window.localStorage : r == Ut.Session && Xn("sessionStorage") ? n = window.sessionStorage : n = new zo(), t !== null && typeof t == "object" && "initialToken" in t && t.initialToken && n.setItem(this.sessionStorageKey, t.initialToken), this.sessionTokenStore = n, this.resetClients();
  }
  close() {
  ...
  newBaseClient() {
    const t = [...this.exchanges.beforeAll, ui, Ko];
...
class Ee {
  ...
  async findOne(t, r, n = !0) {
    const i = is(this.apiIdentifier, t, this.namespace, bn(r == null ? void 0 : r.select)), a = await this.connection.currentClient.query(i.query, i.variables).toPromise(), s = (n ? Ve : $t)(a, this.dataPath(this.apiIdentifier));
    return Vt(a, s);
  }
  /**
    ...
    switch (a.type) {
      ...
      case "get": {
        i.prototype.get = Object.assign(async function(o) {
          return await ni(this, a.operationName, void 0, r, e, o);
        }, a);
        break;
      }
      case "action": {
...
const ve = {
  ...
  weightUnit: !0,
  zipCode: !0
}, U = "shopifyShop", ze = "shopifyShops", gs = Ne(
  U,
  ze,
  pe,
  [
  ...
  syncSince: !0,
  updatedAt: !0
}, Z = "shopifySync", He = "shopifySyncs", ws = Ne(
  Z,
  He,
  ge,
  [
  ...
  createdAt: !0,
  updatedAt: !0
}, X = "ambiguous", Ze = "ambiguouss", Is = Ne(
  X,
  Ze,
  Pe,
  [
  ...
  stringField: !0,
  updatedAt: !0
}, ee = "unambiguous", Xe = "unambiguouss", As = Ne(
  ee,
  Xe,
  Te,
  [
  ...
  [
    {
      ...
      defaultSelection: ci,
      modelApiIdentifier: di
    }
  ]
);
var Qi;
const fi = "production", Ns = "development", Es = Symbol.for("gadget/modelRelationships"), Ps = () => {
  try {
...
class Ts {
  constructor(t) {
    ...
    let r;
    this.apiRoots[this.environment] ? r = this.apiRoots[this.environment] : r = `https://related-products-example${this.environment == fi ? "" : `--${this.environment}`}.gadget.app`;
    const n = { ...t == null ? void 0 : t.exchanges };
    if (this.environment !== fi) {
      const a = ({ forward: o }) => (s) => {
        const l = o(s);
        return rn(
          l,
...
var Cs = () => {
  ...
  extensions: void 0,
  operation: void 0
}, _s = (e, t) => e === t || !(!e || !t || e.key !== t.key), _r = (e, t) => {
  var r = {
    ...e,
    ...t,
  ...
  return ((n, i) => {
    for (var a in n)
      if (!(a in i))
        return !0;
    for (var o in i)
      if (o === "operation" ? !_s(n[o], i[o]) : n[o] !== i[o])
        return !0;
    return !1;
  })(e, r) ? r : e;
}, Rs = (e, t) => {
...
function Ms(e) {
  var t = Cs(), r = Fs(t), n = js(t, e.context), i = Ds(e.query, e.variables), a = $e.useMemo(() => {
    if (e.pause)
      return null;
  ...
  }, [r, i]), s = [t, i, e.requestPolicy, e.context, e.pause], [l, d] = $e.useState(() => [a, _r(xs, o(a, n)), s]), c = l[1];
  a !== l[0] && Rs(l[2], s) && d([a, c = _r(l[1], o(a, n)), s]), $e.useEffect(() => {
...
const qs = hr.createContext(void 0);
...
const Ys = /* @__PURE__ */ Sa(Js), Hs = (e) => {
  ...
  const r = Hs(t), n = Dr(() => pn(e.findMany.operationName, e.findMany.defaultSelection, e.findMany.modelApiIdentifier, r, e.findMany.namespace), [e, r]), [i, a] = Ls(Gs(n, t));
  return [Dr(() => {
