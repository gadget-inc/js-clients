import type { AnyVariables, Client, CombinedError, DocumentInput, GraphQLRequestParams, Operation, OperationContext, OperationResult, RequestPolicy } from "@urql/core";
...
interface FrameworkBindings {
    ...
    useReducer: <S, I, A extends AnyActionArg>(reducer: (prevState: S, ...args: A) => S, initialArg: I, init?: (i: I) => S) => [S, ActionDispatch<A>];
    Fragment: unknown;
}
...
interface UrqlBindings {
    ...
    useQuery: <Data = any, Variables extends AnyVariables = AnyVariables>(args: UseQueryArgs<Variables, Data>) => UseQueryResponse<Data, Variables>;
    useMutation: <Data = any, Variables extends AnyVariables = AnyVariables>(query: DocumentInput<Data, Variables>) => UseMutationResponse<Data, Variables>;
}
