...
import { ErrorsSelection, GadgetClientError, GadgetOperationError, assert, assertMutationSuccess, assertNullableOperationSuccess, assertOperationSuccess, camelize, capitalizeIdentifier, hydrateConnection, hydrateRecord, hydrateRecordArray, hydrationSelection, namespaceDataPath, namespacify, } from "./support.js";
        ...
        fields: {
            internal: namespacify(namespace, {
                [`deleteMany${capitalizedApiIdentifier}`]: Call({
                    ...
                    filter: Var({ value: options === null || options === void 0 ? void 0 : options.filter, type: `[${capitalizedApiIdentifier}Filter!]` }),
                }, {
                    success: true,
                    ...ErrorsSelection,
                }),
