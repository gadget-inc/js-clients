    ...
    return compileWithVariableValues({
        ...
        fields: {
            internal: namespacify(namespace, {
                [`list${capitalizedApiIdentifier}`]: Call({
                    ...defaultVariables,
                    after: (options === null || options === void 0 ? void 0 : options.after) ? Var({ value: options.after, type: "String" }) : undefined,
                    before: (options === null || options === void 0 ? void 0 : options.before) ? Var({ value: options === null || options === void 0 ? void 0 : options.before, type: "String" }) : undefined,
                    first: (options === null || options === void 0 ? void 0 : options.first) ? Var({ value: options === null || options === void 0 ? void 0 : options.first, type: "Int" }) : undefined,
                    last: (options === null || options === void 0 ? void 0 : options.last) ? Var({ value: options === null || options === void 0 ? void 0 : options.last, type: "Int" }) : undefined,
                }, {
...
export const internalUpsertMutation = (apiIdentifier, namespace, on, record) => {
    const capitalizedApiIdentifier = capitalizeIdentifier(apiIdentifier);
    return compileWithVariableValues({
        type: "mutation",
