...
import { EnqueueHookResult } from "./utils.js";
export declare const createUseEnqueue: (adapter: RuntimeAdapter, coreHooks: CoreHooks) => {
    /**
     ...
     * }
     */
    useEnqueue: <SchemaT, Action extends AnyActionFunction>(action: Action, baseBackgroundOptions?: EnqueueBackgroundActionOptions<Action>) => EnqueueHookResult<SchemaT, Action>;
};
