import { ActionFunction } from "../GadgetFunctions.js";
...
import { type ActionHookResult, type OptionsType } from "./utils.js";
export declare const createUseAction: (adapter: RuntimeAdapter, coreHooks: CoreHooks) => {
    /**
