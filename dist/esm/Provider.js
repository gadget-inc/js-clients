...
export const Provider = ({ type, children, api, }) => {
    ...
    return (React.createElement(GadgetUrqlProvider, { api: api }, shopifyGlobalDefined && coalescedType === AppType.Embedded ? (React.createElement(InnerGadgetProvider, { gadgetAppUrl: gadgetAppUrl, api: api, originalQueryParams: originalQueryParams, type: coalescedType, host: host, isReady: isReady, isRootFrameRequest: isRootFrameRequest }, children)) : (React.createElement(GadgetAuthContext.Provider, { value: {
            isAuthenticated: false,
            isEmbedded: false,
            canAuth: false,
            loading: false,
