...
const InnerGadgetProvider = memo(({ children, gadgetAppUrl, originalQueryParams, api, type, host, isReady }) => {
...
export const Provider = ({ type, children, api, }) => {
    ...
    return (React.createElement(GadgetUrqlProvider, { api: api }, shopifyGlobalDefined ? (React.createElement(InnerGadgetProvider, { gadgetAppUrl: gadgetAppUrl, api: api, originalQueryParams: originalQueryParams, type: coalescedType, host: host, isReady: isReady }, children)) : (React.createElement(GadgetAuthContext.Provider, { value: {
            isAuthenticated: false,
            isEmbedded: false,
            canAuth: false,
            loading: false,
