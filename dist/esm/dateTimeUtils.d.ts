 ...
 * @returns
 */
export declare const getDateTimeObjectFromDate: (dateTime: Date, use24Hour?: boolean) => {
    month: number;
    year: number;
    day: number;
    hour: string;
...
export declare const formatDate: (date: Date, includeTime: boolean, use24Hour?: boolean) => string;
/**
 * Gets the time string from a date time object
 * @param dateTime
 * @returns
 */
export declare const getTimeString: (dateTime: DateTimeState, use24Hour?: boolean) => string;
