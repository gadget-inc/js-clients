...
export declare const makeAutoForm: <Elements extends ShadcnElements>(elements: Elements) => {
    AutoForm: <GivenOptions extends OptionsType, SchemaT, ActionFunc extends ActionFunction<GivenOptions, any, any, SchemaT, any>>(props: AutoFormProps<GivenOptions, SchemaT, ActionFunc> & Omit<React.FormHTMLAttributes<HTMLFormElement> & React.RefAttributes<HTMLFormElement>, "action">) => React.JSX.Element;
