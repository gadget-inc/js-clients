    ...
    function NonPromotedActionsActionSelector(props) {
        ...
        return (React.createElement(Popover, { open: open, onOpenChange: setOpen },
            React.createElement(PopoverTrigger, { asChild: true },
                React.createElement(Button, { variant: "outline", role: "combobox", "aria-expanded": open, className: "w-[200px] justify-between", "aria-label": "More actions", onClick: () => setOpen(!open) },
                    "Actions...",
