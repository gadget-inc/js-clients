    ...
    function GadgetBulkActionModalContent(props) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(DialogDescription, null,
                fetching && (React.createElement("div", { className: "flex items-center justify-center min-h-[32px]" },
            ...
            React.createElement(DialogDescription, { className: "flex flex-row gap-2 ml-auto" },
                React.createElement(Button, { onClick: close, variant: "secondary" }, "Close"),
