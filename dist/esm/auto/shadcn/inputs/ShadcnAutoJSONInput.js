...
export const makeShadcnAutoJSONInput = ({ Label, Textarea }) => {
    function ShadcnAutoJSONInput(props) {
        ...
        const requiredIndicator = controller.metadata.requiredArgumentForInput ? React.createElement("span", { className: "text-red-500" }, "*") : null;
        ...
        return (React.createElement("div", null,
            React.createElement(Label, { htmlFor: id },
                ...
                " ",
                requiredIndicator),
            React.createElement(Textarea, { ...getPropsWithoutRef(controller), ...getPropsWithoutRef(focusProps), ...restOfProps, onChange: (e) => {
