        ...
        return (React.createElement(Popover, { open: isOpen, onOpenChange: setIsOpen },
            React.createElement(PopoverTrigger, { asChild: true },
                React.createElement("div", null,
                    React.createElement(Label, { htmlFor: props.id ? `${props.id}-date` : undefined },
                        ...
                        metadata.requiredArgumentForInput && React.createElement("span", { className: "text-red-500 ml-1" }, "*")),
                    React.createElement(Button, { id: props.id ? `${props.id}-date` : undefined, variant: "outline", className: `w-full justify-start text-left font-normal ${!date ? "text-muted-foreground" : ""}` },
                        React.createElement(CalendarIcon, { className: "mr-2 h-4 w-4" }),
                        localTime ? (formatDate(localTime)) : (React.createElement("span", { className: "opacity-50" }, (props.includeTime ?? config.includeTime) ? "YYYY-MM-DD hh:mm aa" : "YYYY-MM-DD"))),
            ...
            React.createElement(PopoverContent, { className: "w-auto p-0" },
                React.createElement("div", { className: "flex flex-row flex-nowrap" },
                    React.createElement(Calendar, { mode: "single", defaultMonth: localTime ?? date, selected: localTime ?? date, onSelect: handleDateSelect, initialFocus: true }),
