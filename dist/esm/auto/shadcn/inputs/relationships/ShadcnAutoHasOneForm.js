...
export const makeShadcnAutoHasOneForm = ({ Badge, Button, Command, CommandItem, CommandInput, Label, CommandList, CommandEmpty, CommandGroup, Checkbox, Accordion, AccordionItem, AccordionTrigger, }) => {
                ...
                hasRecord || isCreatingRecord ? (React.createElement(Accordion, { type: "single", collapsible: true, className: "w-full" }, !isEditing ? (React.createElement(AccordionItem, { value: `${pathPrefix}.${record?.id ? `update-${record.id}` : `create`}` },
                    React.createElement(AccordionTrigger, { onClick: (e) => {
                        ...
                        React.createElement("div", { className: "flex justify-between w-full items-center" },
                            ...
                            recordOption?.tertiaryLabel && (React.createElement("div", { className: "flex items-center" }, renderOptionLabel(recordOption?.tertiaryLabel, "tertiary"))))))) : (React.createElement(React.Fragment, null,
