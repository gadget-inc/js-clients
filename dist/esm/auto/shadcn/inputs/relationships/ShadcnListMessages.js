...
export const makeShadcnListMessages = ({ CommandEmpty, CommandItem, Checkbox, Label, }) => {
    ...
    function ShadcnSelectableOption(props) {
        ...
        if (typeof label === "string") {
            return (React.createElement(CommandItem, { key: id, id: id, selected: selected, className: className, onMouseDown: (e) => {
                    e.preventDefault();
                    e.stopPropagation();
                }, onSelect: () => {
                    onSelect?.(id);
    ...
    function ListMessage(props) {
        ...
        return (React.createElement(CommandEmpty, { onMouseDown: (e) => {
                onSelect?.();
            } }, message));
    }
    return {
