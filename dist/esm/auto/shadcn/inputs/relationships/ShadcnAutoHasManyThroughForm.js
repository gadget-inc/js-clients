                ...
                React.createElement("div", null,
                    React.createElement(Popover, { open: open, onOpenChange: setOpen },
                        React.createElement(PopoverTrigger, { asChild: true },
                            React.createElement("div", null,
                                React.createElement(Button, { type: "button", variant: "outline", role: "combobox", onClick: () => setOpen(!open), "aria-expanded": open, "aria-controls": listboxId, className: `w-[300px] flex flex-row items-center justify-between cursor-pointer ${open ? "bg-accent" : ""}` },
                                    React.createElement(Label, { className: "truncate flex-grow text-left cursor-pointer" },
                                        "Add ",
                    ...
                    React.createElement("div", { className: "flex flex-col w-full" },
                        React.createElement("div", { className: "flex-1 p-2" },
                            React.createElement("div", { className: "flex justify-between items-center w-full" },
                                ...
                                React.createElement(Button, { id: `deleteButton_${pathPrefix}.${idx}`, className: "ml-auto", variant: "ghost", type: "button", size: "icon", onClick: () => remove(idx) },
