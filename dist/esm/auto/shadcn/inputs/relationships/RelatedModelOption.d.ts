...
export declare const makeRelatedModelOption: (elements: Pick<ShadcnElements, "CommandItem" | "CommandList" | "CommandEmpty" | "ScrollArea" | "CommandGroup" | "Checkbox" | "Label" | "CommandLoading">) => {
    RelatedModelOption: {
