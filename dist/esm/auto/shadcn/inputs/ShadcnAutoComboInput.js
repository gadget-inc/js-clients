        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: `relative ${open ? "ring-1 ring-ring rounded-md border" : "border rounded-md"}` },
                ...
                React.createElement(Command, { className: "overflow-visible z-50 h-[300px]" },
                    React.createElement(CommandInput, { name: props.path, ref: inputRef, "data-testid": id, value: inputValue, onValueChange: setInputValue, onBlur: () => setOpen(false), onFocus: () => setOpen(true), placeholder: "Search", className: "ml-2 bg-transparent outline-none placeholder:text-muted-foreground flex-1" }),
