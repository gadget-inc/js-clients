...
export const makeShadcnAutoEnumInput = ({ Badge, Button, Command, CommandItem, CommandInput, Label, CommandList, CommandEmpty, CommandGroup, Checkbox, }) => {
    ...
    function ShadcnAutoEnumInput(props) {
        ...
        return (React.createElement(ShadcnComboInput, { ...props, options: filteredOptions.map((option) => ({ id: option, label: option })), path: labelProp ?? label, metadata: metadata, label: labelProp ?? label, selectedRecordTag: selectedTagsElement, onSelect: (option) => {
