...
export const makeShadcnAutoEnumInput = ({ Badge, Button, Command, CommandItem, CommandLoading, CommandInput, Label, CommandList, CommandEmpty, CommandGroup, Checkbox, ScrollArea, }) => {
    ...
    function ShadcnAutoEnumInput(props) {
        ...
        return (React.createElement(ShadcnComboInput, { ...props, options: filteredOptions.map((option) => ({ id: option, label: option })), path: labelProp ?? label, metadata: metadata, label: labelProp ?? label, onChange: debouncedSearch, selectedRecordTag: selectedTagsElement, onSelect: (option) => {
