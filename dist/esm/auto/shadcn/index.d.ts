...
export declare const makeAutocomponents: (elements: ShadcnElements) => {
    AutoForm: <GivenOptions extends import("@gadgetinc/client-hooks").OptionsType, SchemaT, ActionFunc extends import("@gadgetinc/core").GlobalActionFunction<any> | import("@gadgetinc/core").ActionFunction<GivenOptions, any, any, SchemaT, any>>(props: import("./ShadcnAutoForm.js").ShadcnAutoFormProps<GivenOptions, SchemaT, ActionFunc>) => import("react").JSX.Element;
    ...
    AutoButton: <GivenOptions_1 extends import("@gadgetinc/client-hooks").OptionsType, SchemaT_1, ActionFunc_1 extends import("@gadgetinc/core").GlobalActionFunction<any> | import("@gadgetinc/core").ActionFunction<GivenOptions_1, any, any, SchemaT_1, any>>(props: import("../hooks/useAutoButtonController.js").AutoButtonProps<GivenOptions_1, SchemaT_1, ActionFunc_1> & import("./elements.js").ButtonProps) => import("react").JSX.Element;
    AutoTable: <GivenOptions_2 extends import("@gadgetinc/client-hooks").OptionsType, SchemaT_2, FinderFunction extends import("@gadgetinc/core").FindManyFunction<GivenOptions_2, any, SchemaT_2, any>, Options extends FinderFunction["optionsType"]>(props: import("./ShadcnAutoTable.js").ShadcnAutoTableProps<GivenOptions_2, SchemaT_2, FinderFunction, Options>) => import("react").JSX.Element;
};
