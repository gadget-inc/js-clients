...
export const makeAutoForm = (elements) => {
    ...
    const { AutoInput, AutoBelongsToInput, AutoHasManyInput, AutoHasOneInput, AutoHasManyThroughInput, AutoRolesInput, AutoEnumInput, AutoJSONInput, AutoDateTimePicker, AutoPasswordInput, AutoBooleanInput, AutoEncryptedStringInput, AutoStringInput, AutoNumberInput, AutoHiddenInput, AutoIdInput, AutoTextAreaInput, } = makeShadcnAutoInput(elements);
    ...
    function AutoFormInner(props) {
        ...
        return (React.createElement(AutoFormMetadataContext.Provider, { value: autoFormMetadataContext },
            React.createElement(FormProvider, { ...originalFormMethods },
                ...
                React.createElement(FormContainer, { hidden: isLoading, ...rest, onSubmit: submit }, formContent))));
    }
    return {
        AutoForm,
        AutoInput,
