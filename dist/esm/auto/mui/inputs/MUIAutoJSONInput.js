...
export const MUIAutoJSONInput = (props) => {
    ...
    return (React.createElement(TextField, { multiline: true, maxRows: 4, inputProps: { style: { fontFamily: "monospace" } }, error: inErrorState, helperText: inErrorState && `Invalid JSON: ${errorMessage}`, ...controller, ...focusProps, ...restOfProps, onChange: (event) => controller.onChange(event.target.value) }));
};
