...
export const MUIAutoHasManyInput = (props) => {
    ...
    return (React.createElement(Autocomplete, { multiple: true, renderOption: (props, option) => {
        ...
        }, options: [...options, showMoreHoverOption], onChange: (e, selectedValue) => selectedValue.forEach((id) => onSelectRecord(id)), onClose: () => search.set(), renderInput: (params) => (React.createElement(TextField, { ...params, value: search.value, label: metadata.name, onChange: (e) => search.set(e.target.value), name: path })) }));
};
