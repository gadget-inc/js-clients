            ...
            React.createElement("div", { style: { overflow: "hidden", padding: "15px 8px" } },
                React.createElement("div", { style: { display: "flex" } },
                    React.createElement("div", { style: { overflowY: "scroll", height: "250px" } },
                        React.createElement(Listbox, { onSelect: (value) => onTimeStringChange(`${value}:${minSelected} ${ampmSelected}`) }, createMarkup(hours, hourSelected))),
                    React.createElement("div", { style: { overflowY: "scroll", height: "250px" } },
                        React.createElement(Listbox, { onSelect: (value) => onTimeStringChange(`${hourSelected}:${value} ${ampmSelected}`) }, createMarkup(mins, minSelected))),
                    React.createElement("div", { style: { overflowY: "scroll", height: "250px" } },
                        React.createElement(Listbox, { onSelect: (value) => onTimeStringChange(`${hourSelected}:${minSelected} ${value}`) }, createMarkup(ampm, ampmSelected)))))))));
};
