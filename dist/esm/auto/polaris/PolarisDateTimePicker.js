...
export const PolarisDateTimePicker = (props) => {
    ...
    return (React.createElement(InlineStack, { gap: "400" },
        ...
        props.includeTime && (React.createElement(TextField, { id: props.id ? `${props.id}-time` : undefined, label: props.timeLabel ?? "Time", prefix: React.createElement(Icon, { source: ClockIcon }), autoComplete: "off", value: timeString, onChange: onTimeStringChange, ...timeInputFocusProps, error: !parseSuccess && !isTimeFocused && `Invalid time, please enter a value like "11:00 AM"` }))));
};
