...
export const PolarisAutoTableCellRenderer = (props) => {
    ...
    switch (column.fieldType) {
        ...
        case FieldType.EncryptedString: {
            return React.createElement(PolarisAutoTablePasswordCell, null);
        }
        ...
        case FieldType.HasOne: {
            ...
            if (!column.relatedField)
                return null;
            return React.createElement(PolarisAutoTableCellRenderer, { column: column.relatedField, value: rest[column.relatedField.apiIdentifier] });
        }
