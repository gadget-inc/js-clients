...
export const PolarisFormInput = (props) => {
    ...
    switch (config.fieldType) {
        ...
        case FieldType.HasManyThrough: {
            return React.createElement(PolarisHasManyInput, { field: props.field.apiIdentifier });
        }
        case FieldType.HasOne:
        case FieldType.BelongsTo: {
            // TODO: implement relationship field inputs
            return React.createElement(PolarisBelongsToInput, { field: props.field.apiIdentifier });
        }
