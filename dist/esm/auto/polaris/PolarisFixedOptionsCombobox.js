...
export const PolarisFixedOptionsCombobox = (props) => {
    ...
    const textField = (React.createElement(Autocomplete.TextField, { onChange: updateText, label: label, value: inputValue, verticalContent: verticalContentMarkup, placeholder: placeholder, autoComplete: "off", id: `${label}_Autocomplete_Textfield` }));
