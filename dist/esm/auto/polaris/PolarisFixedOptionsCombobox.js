...
export const PolarisFixedOptionsCombobox = (props) => {
    ...
    const textField = (React.createElement(Autocomplete.TextField, { onChange: updateText, label: label, value: inputValue, prefix: allowMultiple ? undefined : React.createElement(Icon, { source: SearchIcon, tone: "base" }), verticalContent: verticalContentMarkup, placeholder: "Search", autoComplete: "off" }));
