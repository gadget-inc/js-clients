import { BlockStack, DataTable, EmptySearchResult, IndexTable, Pagination, SkeletonBodyText } from "@shopify/polaris";
...
export const PolarisAutoTable = (props) => {
    ...
    return (React.createElement(BlockStack, null,
        React.createElement(IndexTable, { ...polarisTableProps, resourceName: resourceName, emptyState: React.createElement(EmptySearchResult, { title: `No ${resourceName.plural} yet`, description: "", withIllustration: true }), loading: fetching, hasMoreItems: page.hasNextPage, itemCount: rows?.length ?? 0 }, rows &&
            columns &&
        ...
        React.createElement(Pagination, { hasNext: page.hasNextPage, hasPrevious: page.hasPreviousPage, onNext: page.goToNextPage, onPrevious: page.goToPreviousPage })));
};
