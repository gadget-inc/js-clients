...
export const PolarisDateTimePicker = (props) => {
    ...
    return (React.createElement(InlineStack, { gap: "400" },
        ...
        (props.includeTime ?? config.includeTime) && (React.createElement(PolarisTimePicker, { ...props.timePickerProps, field: props.field, dateTimeState: dateTimeState, setDateTimeState: setDateTimeState, id: props.id, localTime: localTime, onChange: onChange, hideTimePopover: props.hideTimePopover, localTz: localTz }))));
};
