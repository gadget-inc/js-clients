...
const PolarisTimePicker = (props) => {
    const [timeString, setTimeString] = useState(getTimeString(getDateTimeObjectFromDate(props.fieldProps.value)));
        ...
        React.createElement(Popover, { active: timePopoverActive, onClose: () => setTimePopoverActive(false), activator: React.createElement(TextField, { prefix: React.createElement(Icon, { source: ClockIcon }), id: props.id ? `${props.id}-time` : undefined, "data-testid": props.id ? `${props.id}-time` : undefined, label: props.timeLabel ?? "Time", autoComplete: "off", value: timeString, onChange: onTimeStringChange, onFocus: () => setTimePopoverActive(true), error: timeParseError && `Invalid time format`, ...props.timePickerProps }) }, !props.hideTimePopover && (React.createElement("div", { style: { overflow: "hidden", padding: "15px 8px" } },
            React.createElement("div", { style: { display: "flex" } },
                React.createElement(Scrollable, { style: { overflowY: "scroll", height: "250px" } },
                    React.createElement(Listbox, { onSelect: (value) => onTimeStringChange(`${value}:${getDateTimeObjectFromDate(props.fieldProps.value).minute.toString().padStart(2, "0")} ${getDateTimeObjectFromDate(props.fieldProps.value).ampm}`) }, createMarkup(hoursArr, getDateTimeObjectFromDate(props.fieldProps.value).hour.toString()))),
                React.createElement("div", { style: { overflowY: "scroll", height: "250px" } },
                    React.createElement(Listbox, { onSelect: (value) => onTimeStringChange(`${getDateTimeObjectFromDate(props.fieldProps.value).hour}:${value.padStart(2, "0")} ${getDateTimeObjectFromDate(props.fieldProps.value).ampm}`) }, createMarkup(minsArr, getDateTimeObjectFromDate(props.fieldProps.value).minute.toString().padStart(2, "0")))),
                React.createElement("div", { style: { overflowY: "scroll", height: "250px" } },
                    React.createElement(Listbox, { onSelect: (value) => onTimeStringChange(`${getDateTimeObjectFromDate(props.fieldProps.value).hour}:${getDateTimeObjectFromDate(props.fieldProps.value)
                            .minute.toString()
                            .padStart(2, "0")} ${value}`) }, createMarkup(ampmArr, getDateTimeObjectFromDate(props.fieldProps.value).ampm)))))))));
};
