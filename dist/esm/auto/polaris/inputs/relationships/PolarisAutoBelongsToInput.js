...
export const PolarisAutoBelongsToInput = autoInput((props) => {
    ...
    const selectedRecordTag = selectedOption && selectedOption.id ? (React.createElement(Tag, { onRemove: onRemoveRecord, key: `selectedRecordTag_${selectedOption.id}` },
        React.createElement("p", { id: `${selectedOption.id}_${selectedOption.label}` }, selectedOption.label))) : danglingSelectedRecordId ? (React.createElement(Tag, { onRemove: onRemoveRecord, key: `selectedRecordTag_${danglingSelectedRecordId}` },
