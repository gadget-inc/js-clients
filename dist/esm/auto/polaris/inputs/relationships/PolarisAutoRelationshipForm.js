...
export const PolarisAutoRelationshipForm = autoInput((props) => {
    ...
    if (metadata.configuration.__typename === "GadgetBelongsToConfig") {
        ...
        return (React.createElement(PolarisAutoHasManyRelationshipForm, { field: field, pathPrefix: pathPrefix, primaryLabel: props.primaryLabel, secondaryLabel: props.secondaryLabel }, props.children));
    }
    else {
        return null;
    }
        ...
        React.createElement(BlockStack, { as: "ul" },
            fields.flatMap((field, idx) => {
                ...
                return (React.createElement(Box, { key: field._fieldArrayKey, borderColor: "border", borderBlockEndWidth: "025" }, editingIndex == idx ? (React.createElement(Box, { padding: "300" },
                    ...
                    React.createElement(Text, { variant: "bodyMd", as: "p", tone: "subdued" }, secondary ?? React.createElement("span", { style: { visibility: "hidden" } }, "\u00A0")))) : (React.createElement(Text, { variant: "bodyMd", as: "h3", tone: "subdued" }, "Click to edit..."))))));
            }),
