...
export const PolarisAutoHasOneInput = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Combobox, { activator: React.createElement(Combobox.TextField, { prefix: React.createElement(Icon, { source: SearchIcon }), onChange: search.set, onBlur: pagination.resetPagination, value: search.value, label: metadata.name, name: path, placeholder: "Search", autoComplete: "off", verticalContent: getSelectedRelatedRecordTags({
                    selectedRecordIds,
                    onRemoveRecord,
                    options,
