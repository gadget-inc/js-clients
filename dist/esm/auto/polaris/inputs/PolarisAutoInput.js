...
import PolarisAutoRichTextInput from "./PolarisAutoRichTextInput.js";
export const PolarisAutoInput = (props) => {
    ...
    switch (config.fieldType) {
        ...
        case FieldType.Number: {
            return React.createElement(PolarisAutoNumberInput, { field: props.field });
        }
        ...
        case FieldType.RichText: {
            return React.createElement(PolarisAutoRichTextInput, { field: props.field });
        }
