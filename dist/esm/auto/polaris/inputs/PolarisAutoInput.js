...
export const PolarisAutoInput = (props) => {
    ...
    switch (config.fieldType) {
        ...
        case FieldType.EncryptedString: {
            return React.createElement(PolarisEncryptedStringInput, { field: props.field });
        }
        case FieldType.Password: {
            return React.createElement(PolarisPasswordInput, { field: props.field });
        }
        case FieldType.Boolean: {
            return React.createElement(PolarisBooleanInput, { field: props.field });
        }
        case FieldType.DateTime: {
            return React.createElement(PolarisDateTimePicker, { field: props.field });
        }
        case FieldType.Json: {
