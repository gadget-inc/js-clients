...
export const PolarisAutoInput = (props) => {
    ...
    switch (config.fieldType) {
        ...
        case FieldType.DateTime: {
            // TODO: If a user sets the value of the DateTimePicker, and does not provide a custom onChange function
            // the value will never be updated.
            // Should an error be thrown in this case? I.e. value && !onChange => throw error
