...
export const PolarisAutoJSONInput = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(TextField, { multiline: 4, monospaced: true, ...getPropsWithoutRef(restOfOriginalController), value: stringValue, onChange: onStringValueChange, error: !isFocused && error && `Invalid JSON: ${error.message}`, ...getPropsWithoutRef(focusProps), ...restOfProps })));
};
