...
export const PolarisHasManyInput = (props) => {
    ...
    const textField = (React.createElement(Autocomplete.TextField, { onChange: updateText, label: fieldMetadata.name, value: inputValue, verticalContent: verticalContentMarkup, autoComplete: "off" }));
