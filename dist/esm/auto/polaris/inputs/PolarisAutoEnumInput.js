...
export const PolarisAutoEnumInput = (props) => {
    ...
    return (React.createElement(Combobox, { allowMultiple: allowMultiple, activator: React.createElement(Combobox.TextField, { autoComplete: "off", prefix: React.createElement(Icon, { source: SearchIcon }), label: inputLabel, value: searchValue, placeholder: "Search", verticalContent: selectedTagsElement, onChange: setSearchValue, id: `${props.field}-combobox-textfield`, error: isError, helpText: errorMessage }), ...comboboxProps }, listBoxElement));
};
