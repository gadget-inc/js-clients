...
export const PolarisAutoJSONInput = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(TextField, { multiline: 4, monospaced: true, error: !isFocused && errorMessage && `Invalid JSON: ${errorMessage}`, ...getPropsWithoutRef(controller), ...getPropsWithoutRef(focusProps), ...restOfProps })));
};
