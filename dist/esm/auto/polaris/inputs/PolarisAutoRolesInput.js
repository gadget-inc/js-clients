...
export const PolarisAutoRolesInput = (props) => {
    ...
    return (React.createElement(PolarisFixedOptionsCombobox, { options: options, allowMultiple: true, label: metadata.name, ...getPropsWithoutRef(fieldProps), value: selectedRoleKeys }));
};
