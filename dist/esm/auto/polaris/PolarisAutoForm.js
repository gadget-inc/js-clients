...
props) => {
    ...
    const { metadata, fetchingMetadata, isLoading, metadataError, fields, submit, formError, isSubmitting, isSubmitSuccessful, pauseExistingRecordLookup, originalFormMethods, } = useAutoForm(props);
    ...
    return (React.createElement(AutoFormMetadataContext.Provider, { value: autoFormMetadataContext },
        React.createElement(FormProvider, { ...originalFormMethods },
            isLoading && React.createElement(PolarisAutoFormSkeleton, null),
