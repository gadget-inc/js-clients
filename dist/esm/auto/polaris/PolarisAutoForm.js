...
props) => {
    ...
    return (React.createElement(Suspense, { fallback: React.createElement(PolarisFormSkeleton, null) },
        React.createElement(AutoFormMetadataContext.Provider, { value: autoFormMetadataContext },
