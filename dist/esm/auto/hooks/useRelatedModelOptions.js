...
export const useLinkedParentModelRelatedModelRecords = (props) => {
    const { currentModel, relatedModel, findBy, relatedModelFilters } = props;
    ...
    const [{ data: selectedRecords, fetching: fetchingSelected, error: fetchSelectedRecordError }] = useFindMany(relatedModelManager, {
        ...
        filter: { [filterField]: { equals: currentRecordId, ...relatedModelFilters } }, // Filter by the inverse field belongsTo field value
        // TODO: Add custom filter options HERE
    });
    return {
        selected: {
