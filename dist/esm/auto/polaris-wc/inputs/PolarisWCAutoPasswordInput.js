...
export const PolarisWCAutoPasswordInput = autoInput((props) => {
    ...
    if (!isEditing) {
        return (React.createElement("div", { style: { display: "flex", alignItems: "flex-end", gap: "8px" } },
            React.createElement(PolarisWCAutoEncryptedStringInput, { ...props, placeholder: existingPasswordPlaceholder, disabled: true }),
    ...
    return React.createElement(PolarisWCAutoEncryptedStringInput, { ...props, placeholder: "Password" });
});
