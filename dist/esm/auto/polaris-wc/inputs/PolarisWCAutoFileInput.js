...
export const PolarisWCAutoFileInput = autoInput((props) => {
    ...
    return (React.createElement("div", { style: { position: "relative" } },
        React.createElement("s-drop-zone", { accept: validations.onlyImages?.acceptedTypes?.join(","), onChange: handleChange, disabled: disabled, label: label, error: errorMessage, required: metadata.requiredArgumentForInput }, !filePreview && actionHintParts ? (React.createElement(React.Fragment, null,
