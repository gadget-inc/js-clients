...
export const PolarisWCAutoJSONInput = autoInput((props) => {
    ...
    return (React.createElement("s-text-area", { id: id, label: label, value: value ?? "", rows: 4, placeholder: placeholder, disabled: disabled, required: metadata.requiredArgumentForInput, error: displayError, onChange: handleChange, onFocus: handleFocus, onBlur: handleBlur }));
});
