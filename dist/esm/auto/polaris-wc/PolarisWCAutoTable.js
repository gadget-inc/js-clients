...
const PolarisWCAutoTableComponent = (props) => {
    ...
    return (React.createElement(AutoTableContext.Provider, { value: [methods, refresh] },
        React.createElement("s-section", { padding: "none", accessibilityLabel: `${resourceName.plural} table section` },
                    ...
                    (showSearch || showBulkActions) && (React.createElement("s-grid", { slot: "filters" // Need to use filter slot to properly position this grid in the table container
                        ...
                        showBulkActions && (React.createElement("div", { style: {
                            ...
                            React.createElement("s-text", { tone: "neutral" },
                                ...
                                " selected"),
                            React.createElement(PolarisWCAutoTableBulkActionSelector, { bulkActionOptions: bulkActionOptions, selection: selection, rows: rows ?? [], rawRecords: rawRecords, actionModalIds: actionModalIds }))))),
            ...
            gadgetBulkActionOptions.map((option) => (React.createElement(PolarisWCAutoBulkActionModal, { key: option.apiIdentifier, model: props.model, modelActionDetails: option.modelActionDetails, ids: selection.recordIds, clearSelection: selection.clearAll, modalId: actionModalIds[option.apiIdentifier] }))),
