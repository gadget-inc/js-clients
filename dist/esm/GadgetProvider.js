 ...
 *
 **/
export const GadgetUrqlClientContext = globalThis.__gadgetUrqlClientContext || React.createContext(undefined);
/**
...
try {
    if (!globalThis.__gadgetUrqlClientContext) {
        globalThis.__gadgetUrqlClientContext = React.createContext(undefined);
    }
}
catch (error) {
