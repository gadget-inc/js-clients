...
export const computedViewOperation = (operation, variables, defaultSelection, namespace) => {
    let fields = {
        [operation]: Call(variableOptionsToVariables(variables), fieldSelectionToQueryCompilerFields(defaultSelection, true)),
    };
    if (namespace) {
        fields = namespacify(namespace, fields);
    }
