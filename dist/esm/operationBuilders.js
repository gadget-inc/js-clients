...
export const computedViewOperation = (operation, variables, defaultSelection, selection, namespace) => {
    let fields = {
        [operation]: Call(variableOptionsToVariables(variables), fieldSelectionToQueryCompilerFields(selection !== null && selection !== void 0 ? selection : defaultSelection, true)),
    };
    if (namespace) {
        fields = namespacify(namespace, fields);
    }
