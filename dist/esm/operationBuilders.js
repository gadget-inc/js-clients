...
import { ErrorsSelection, camelize, capitalizeIdentifier, filterTypeName, hydrationSelection, jsSearchFieldsToGqlSearchFields, namespacify, searchableFieldTypeName, sortTypeName, } from "./support.js";
/**
...
export const cancelBackgroundActionOperation = (id) => {
    const fields = {
