...
export const computedViewOperation = (operation, variables, defaultSelections, selections, namespace) => {
    let fields = {
        [operation]: Call(variableOptionsToVariables(variables), fieldSelectionToQueryCompilerFields(selections !== null && selections !== void 0 ? selections : defaultSelections, true)),
    };
    if (namespace) {
        fields = namespacify(namespace, fields);
    }
