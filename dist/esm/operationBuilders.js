...
export const computedViewOperation = (operation, defaultSelection, variables, selection, namespace) => {
    let fields = {
        [operation]: Call(variables ? variableOptionsToVariables(variables) : {}, fieldSelectionToQueryCompilerFields(selection !== null && selection !== void 0 ? selection : defaultSelection, true)),
    };
    if (namespace) {
        fields = namespacify(namespace, fields);
    }
