...
export const searchableFieldTypeName = (modelApiIdentifier, namespace) => `${namespacedGraphQLTypeName(modelApiIdentifier, namespace)}SearchFields`;
...
export const jsSearchFieldsToGqlSearchFields = (searchFields) => {
    const result = {};
