...
export const combineNamespacesAndApiIdentifier = (givenNamespaces, apiIdentifier) => {
...
export const sortTypeName = (modelApiIdentifier, namespace) => `${camelize(combineNamespacesAndApiIdentifier(namespace, modelApiIdentifier))}Sort`;
export const filterTypeName = (modelApiIdentifier, namespace) => `${camelize(combineNamespacesAndApiIdentifier(namespace, modelApiIdentifier))}Filter`;
