...
/** Options for configuring a concurrency group for a background action */
export interface BackgroundActionConcurrencyGroup {
    /**
     * The name of the group to put this background action in. If more than the `maxConcurrency` number of actions are enqueued into a group, they will wait to execute until one of the earlier ones has finished.
     */
    key: string;
    /**
     * The maximum number of actions in this group that can be running at once
     */
...
export type EnqueueBackgroundActionOptions<Action extends AnyActionFunction> = {
    ...
    id?: string;
    /**
     * Which backend queue to enqueue this action into. If not set, the `default` queue will be used.
     */
    queue?: string;
    /**
     * A group to put this background action in that limits the maximum concurrency of all actions in the group. If not set, the action won't be concurrency limited.
     */
    concurrencyGroup?: string | BackgroundActionConcurrencyGroup;
    /**
