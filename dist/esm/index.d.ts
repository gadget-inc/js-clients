...
export declare class Variable {
    ...
    readonly value?: any;
    constructor(type: string, required?: boolean, name?: string | undefined, value?: any);
    present(): boolean;
}
...
export declare const compile: (operation: BuilderOperation, onlyPresentVariableValues?: boolean) => string;
