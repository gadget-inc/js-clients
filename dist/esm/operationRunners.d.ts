...
export declare const computedViewRunner: (connection: GadgetConnection, operation: string, variables: VariablesOptions, defaultSelection: FieldSelection, namespace?: string | string[] | null) => Promise<any>;
