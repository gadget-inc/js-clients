...
export declare const computedViewRunner: (connection: GadgetConnection, operation: string, variables: VariablesOptions, selections: FieldSelection, namespace?: string | string[] | null) => Promise<any>;
