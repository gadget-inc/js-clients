...
export declare const computedViewRunner: (connection: GadgetConnection, operation: string, variables: VariablesOptions, defaultSelections: FieldSelection, selections?: FieldSelection, namespace?: string | string[] | null) => Promise<any>;
