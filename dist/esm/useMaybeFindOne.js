...
let useMaybeFindOneImpl = createHookStub("useMaybeFindOne");
createHookStub("useMaybeFindOne", (adapter, coreHooks) => {
...
export const useMaybeFindOne = (manager, id, options) => useMaybeFindOneImpl(manager, id, options);
