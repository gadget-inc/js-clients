...
let useViewImpl = createHookStub("useView");
createHookStub("useView", (adapter, coreHooks) => {
...
export const useView = ((view, variablesOrOptions, maybeOptions) => useViewImpl(view, variablesOrOptions, maybeOptions));
