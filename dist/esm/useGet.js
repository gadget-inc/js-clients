...
export const useGet = (manager, options) => {
    ...
    const plan = useMemo(() => {
        return findOneOperation(manager.get.operationName, undefined, manager.get.defaultSelection, manager.get.modelApiIdentifier, memoizedOptions, manager.get.namespace);
