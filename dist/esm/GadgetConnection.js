...
export class GadgetConnection {
    ...
    newBaseClient() {
        ...
        client.reexecuteOperation = (operation) => {
            var _a;
            console.log("reexecuteOperation", operation);
            if (operation.query.definitions.some(isLiveQueryOperationDefinitionNode) && ((_a = operation.context.meta) === null || _a === void 0 ? void 0 : _a.cacheOutcome) === "miss") {
