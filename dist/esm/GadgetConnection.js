import { Client, cacheExchange, fetchExchange, makeOperation, subscriptionExchange } from "@urql/core";
...
export class GadgetConnection {
    ...
    newBaseClient() {
        ...
        client.reexecuteOperation = (operation) => {
            console.trace("reexecuteOperation", operation);
            if (operation.query.definitions.some(isLiveQueryOperationDefinitionNode)) {
                console.log("tearing down");
                reexecuteOperation(makeOperation('teardown', operation, operation.context));
            }
            console.log("reexecuting original operation");
