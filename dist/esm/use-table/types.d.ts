import type { ErrorWrapper, GadgetRecord, SortOrder } from "@gadgetinc/api-client-core";
...
export type TableSpec = {
    ...
    fieldMetadataTree: Record<string, FieldMetadata | {
        $field: FieldMetadata;
    }>;
...
export type FieldMetadataWithRelationshipConfig = FieldMetadata & {
    configuration: Extract<FieldMetadata["configuration"], {
