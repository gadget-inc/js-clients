...
export async function transformDataRedux(modelManager, defaultValues, data) {
    ...
    function transform(input, updates, depth = 0, path = undefined, fieldType = null, fieldRelationships = null) {
