 ...
 * @returns
 */
export const getDateTimeObjectFromDate = (dateTime, use24Hour = false) => {
    return {
...
export const formatDate = (date, includeTime, use24Hour = false) => {
 ...
 * @returns
 */
export const getTimeString = (dateTime, use24Hour = false) => {
    if (use24Hour) {
