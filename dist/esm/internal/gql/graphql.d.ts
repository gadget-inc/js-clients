...
export type Scalars = {
    ...
    InternalHasManyThroughBaseModelRecord: {
        input: any;
        output: any;
    };
    ...
    InternalHasManyThroughJoinerModelRecord: {
        input: any;
        output: any;
    };
    ...
    InternalHasManyThroughSiblingModelRecord: {
        input: any;
        output: any;
    };
    ...
    InternalUniqueFieldsParentModelRecord: {
        input: any;
        output: any;
    };
...
export type BackgroundActionResult = AbortShopifySyncResult | AddInventoryWidgetResult | AlwaysThrowErrorWidgetResult | CompleteShopifySyncResult | CreateAutoTableTestRelatedModelResult | CreateAutoTableTestResult | CreateGameCityResult | CreateGamePlayerResult | CreateGameRoundResult | CreateGameStadiumResult | CreateGizmoResult | CreateHasManyThroughBaseModelResult | CreateHasManyThroughJoinerModelResult | CreateHasManyThroughSiblingModelResult | CreateModelAResult | CreatePartResult | CreateSectionResult | CreateTestDataResult | CreateUniqueFieldsChildModelResult | CreateUniqueFieldsMainModelResult | CreateUniqueFieldsParentModelResult | CreateWidgetResult | CustomActionAutoTableTestResult | CustomActionWithParamsAutoTableTestResult | CustomObjectParamsGameCityResult | DeleteAutoTableTestRelatedModelResult | DeleteAutoTableTestResult | DeleteGameCityResult | DeleteGamePlayerResult | DeleteGameRoundResult | DeleteGameStadiumResult | DeleteGizmoResult | DeleteHasManyThroughBaseModelResult | DeleteHasManyThroughJoinerModelResult | DeleteHasManyThroughSiblingModelResult | DeleteModelAResult | DeletePartResult | DeleteSectionResult | DeleteUniqueFieldsChildModelResult | DeleteUniqueFieldsMainModelResult | DeleteUniqueFieldsParentModelResult | DeleteUserResult | DeleteWidgetResult | ErrorShopifySyncResult | FlipAllResult | NameSpacedActionAResult | NameSpacedCustomObjectParamsResult | RunShopifySyncResult | SignInUserResult | SignOutUserResult | SignUpUserResult | UpdateAutoTableTestRelatedModelResult | UpdateAutoTableTestResult | UpdateGameCityResult | UpdateGamePlayerResult | UpdateGameRoundResult | UpdateGameStadiumResult | UpdateGizmoResult | UpdateHasManyThroughBaseModelResult | UpdateHasManyThroughJoinerModelResult | UpdateHasManyThroughSiblingModelResult | UpdateModelAResult | UpdatePartResult | UpdateSectionResult | UpdateUniqueFieldsChildModelResult | UpdateUniqueFieldsMainModelResult | UpdateUniqueFieldsParentModelResult | UpdateUserResult | UpdateWidgetResult | UpdateWithCustomParamsAutoTableTestResult;
...
export type UpsertError = UpsertAutoTableTestRelatedModelResult & UpsertAutoTableTestResult & UpsertGameCityResult & UpsertGamePlayerResult & UpsertGameRoundResult & UpsertGameStadiumResult & UpsertGizmoResult & UpsertHasManyThroughBaseModelResult & UpsertHasManyThroughJoinerModelResult & UpsertHasManyThroughSiblingModelResult & UpsertModelAResult & UpsertPartResult & UpsertSectionResult & UpsertShopifyGdprRequestResult & UpsertShopifyProductImageResult & UpsertShopifyProductOptionResult & UpsertShopifyProductResult & UpsertShopifyProductVariantResult & UpsertShopifyShopResult & UpsertShopifySyncResult & UpsertUniqueFieldsChildModelResult & UpsertUniqueFieldsMainModelResult & UpsertUniqueFieldsParentModelResult & UpsertUserResult & UpsertWidgetResult & {
