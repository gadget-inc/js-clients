...
export const computedViewRunner = async (connection, operation, variables, defaultSelections, selections, namespace) => {
    const plan = computedViewOperation(operation, variables, defaultSelections, selections, namespace);
