...
export const actionResultRunner = async (connection, id, action, options) => {
    ...
    const response = await pipe(subscription, filter((operation) => { var _a, _b; return (_b = (_a = operation.data) === null || _a === void 0 ? void 0 : _a.backgroundAction) === null || _b === void 0 ? void 0 : _b.outcome; }), take(1), toPromise);
