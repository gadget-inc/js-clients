...
export const actionResultRunner = (connection, id, action, options) => {
    ...
    return new Promise((resolve) => {
        ...
        subscription.subscribe((response) => {
            ...
            if (!response.data)
                return;
            const backgroundAction = assertOperationSuccess(response, ["data", "backgroundAction"]);
            ...
            if (backgroundAction.outcome) {
                ...
                switch (action.type) {
                    case "action": {
                        backgroundAction.result = processActionResponse(action.defaultSelection, response, get(backgroundAction.result, [action.modelSelectionField]), action.hasReturnType);
                        break;
                    }
                    case "globalAction": {
