import type { AnyPublicModelManager, DefaultSelection, FindManyFunction, FindOneFunction, LimitToKnownKeys, Select } from "@gadgetinc/api-client-core";
...
export declare const useFindMany: <GivenOptions extends OptionsType, SchemaT, F extends FindManyFunction<GivenOptions, any, SchemaT, any>, Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findMany: F;
} & AnyPublicModelManager<FindOneFunction<any, any, any, any>, F>, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions>) => ReadHookResult<GadgetRecordList<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
