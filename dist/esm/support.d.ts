...
export declare const processBulkActionResponse: <Shape extends RecordShape = any>(defaultSelection: FieldSelection | null, response: any, records: any, modelSelectionField: string, hasReturnType?: HasReturnType | null) => any;
