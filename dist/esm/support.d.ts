...
export declare const availableAuthenticationModes: readonly ["apiKey", "browserSession", "anonymous", "internalAuthToken", "internal", "custom"];
export declare const maybeGetAuthenticationModeOptionsFromConnectionOptions: (options: GadgetConnectionOptions | ClientOptions) => AuthenticationModeOptions | undefined;
export {};
