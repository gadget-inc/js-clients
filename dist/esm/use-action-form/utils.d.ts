import type { AnyClient, AnyCoreImplementation, AnyErrorWrapper, AnyModelManager, GadgetRecord } from "@gadgetinc/core";
...
export declare const disambiguateDefaultValues: (coreImplementation: AnyCoreImplementation, data: any, initialData: any, action: any) => {
    [k: string]: unknown;
};
