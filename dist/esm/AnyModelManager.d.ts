 ...
 **/
export interface AnyPublicModelManager<FindOneFunc extends AnyFindOneFunc = AnyFindOneFunc, FindManyFunc extends AnyFindManyFunc = AnyFindManyFunc, FindFirstFunc extends AnyFindFirstFunc = AnyFindFirstFunc> {
...
export declare function isPublicModelManager(manager: AnyModelManager): manager is AnyPublicModelManager;
export declare function isPublicSingletonModelManager(manager: AnyModelManager): manager is AnyPublicSingletonModelManager;
