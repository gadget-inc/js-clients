...
export const useActionMetadata = (actionFunction) => {
    ...
    if (actionFunction.type === "globalAction") {
        ...
        const modelManager = assert(getModelManager(api, coreImplementation, actionFunction.modelApiIdentifier, actionFunction.namespace), "no model manager found for action function");
        let actionName;
