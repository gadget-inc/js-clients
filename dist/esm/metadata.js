...
import { graphql } from "./internal/gql/index.js";
 ...
 * @internal
 */
export const useModelMetadata = (apiIdentifier) => {
...
export const useActionMetadata = (actionFunction) => {
    const api = useApi();
    const modelManager = assert(api[actionFunction.modelApiIdentifier], "no model manager found for action function");
    let actionName;
