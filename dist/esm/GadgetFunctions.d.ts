...
export type ProcessResultFunction<InT = any, OutT = InT> = (data: InT, error: CombinedError | undefined, pause?: boolean) => {
    data: OutT;
...
export interface ActionFunctionMetadata<OptionsT, VariablesT, SelectionT, SchemaT, DefaultsT, IsBulk> {
    ...
    plan: <Options extends OptionsT>(options?: LimitToKnownKeys<Options, OptionsT>) => GQLBuilderResult;
    processResult: <InT = any, OutT = InT>(data: InT, error: CombinedError | undefined, pause?: boolean) => {
        data: OutT;
        error: AnyErrorWrapper | undefined;
    };
    /** @deprecated */
