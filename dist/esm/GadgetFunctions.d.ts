...
import type { DefaultSelection, LimitToKnownKeys, Select, VariablesOptions } from "./types.js";
...
export interface ComputedViewFunction<VariablesT, DefaultSelectionsT extends FieldSelection, SelectionsT extends DefaultSelectionsT, ResultT> {
    (variables: VariablesT, options?: {
        select?: SelectionsT;
    }): Promise<Select<ResultT, DefaultSelection<DefaultSelectionsT, {
        select?: SelectionsT | null;
    }, DefaultSelectionsT>>>;
    type: "computedView";
    operationName: string;
    namespace: string | string[] | null;
    variables: VariablesOptions;
    variablesType: VariablesT;
    defaultSelections: FieldSelection;
    selections?: FieldSelection;
    selectionsType: SelectionsT;
    resultType: ResultT;
}
