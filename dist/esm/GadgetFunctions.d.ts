...
export type FunctionResult<Data = any> = {
    data?: Data;
    error?: CombinedError | undefined;
    fetching?: boolean;
    stale?: boolean;
};
export type ProcessResultFunction<OptionsT = Record<string, never>, DataIn = any, DataOut = DataIn> = (result: FunctionResult<DataIn>, opts?: {
    pause?: boolean;
} & OptionsT) => {
    data: DataOut | null | undefined;
