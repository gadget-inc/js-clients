...
import type { DefaultSelection, LimitToKnownKeys, Select, Selectable, VariablesOptions, AllFieldsSelected } from "./types.js";
...
export interface ComputedViewFunction<Variables, AvailableSelection extends FieldSelection, Result> {
    ...
    }): Promise<Select<Result, DefaultSelection<AvailableSelection, Selectable<AvailableSelection>, AllFieldsSelected<AvailableSelection>>>>;
    type: "computedView";
    operationName: string;
    namespace: string | string[] | null;
    variables: VariablesOptions;
