...
export type UseActionFormResult<GivenOptions extends OptionsType, SchemaT, ActionFunc extends ActionFunction<GivenOptions, any, any, SchemaT, any>, FormVariables extends FieldValues, FormContext = any> = Omit<UseFormReturn<FormVariables, FormContext>, "handleSubmit"> & {
    /**
 ...
 */
export declare const useActionForm: <GivenOptions extends OptionsType, SchemaT, ActionFunc extends ActionFunction<GivenOptions, any, any, SchemaT, any>, ExtraFormVariables = {}, FormContext = any, FormVariables extends FieldValues = ActionFunc["variablesType"] & ExtraFormVariables>(action: ActionFunc, options?: (Omit<Partial<{
    ...
    defaultValues?: DeepPartial<FormVariables> | undefined;
    /**
