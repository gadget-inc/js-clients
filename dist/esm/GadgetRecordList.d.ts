...
export declare class GadgetRecordList<Shape extends RecordShape> extends Array<GadgetRecord<Shape>> {
    ...
    static boot<Shape extends RecordShape>(modelManager: AnyModelManager | AnyInternalModelManager<Shape>, records: GadgetRecord<Shape>[], pagination: PaginationConfig): GadgetRecordList<Shape>;
