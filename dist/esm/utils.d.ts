...
export declare const noProviderErrorMessage = "Could not find a wrapping Gadget <Provider/> component. Please ensure you wrap the root component in a <Provider/> from @gadget-inc/react. If you suspect this is a bug, try running Restart App in the command palette to clear your app's Vite cache.";
/**
