import type { ActionFunction, AnyClient, BulkActionFunction, FieldSelection, GadgetError, InvalidFieldError } from "@gadgetinc/api-client-core";
...
export declare function transformData(client: AnyClient, defaultValues: any, data: any): Promise<any>;
export {};
