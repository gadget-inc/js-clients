...
import { isPublicModelManager, isPublicSingletonModelManager } from "./AnyModelManager.js";
...
export class GadgetRecord_ {
    constructor(data, modelManager) {
        ...
        this[kInstantiatedFields] = (_g = cloneDeep(data)) !== null && _g !== void 0 ? _g : {};
        this[kPersistedFields] = (_h = cloneDeep(data)) !== null && _h !== void 0 ? _h : {};
