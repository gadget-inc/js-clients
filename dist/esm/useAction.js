import { actionOperation, capitalizeIdentifier, disambiguateActionVariables, get, hydrateRecord, namespaceDataPath, } from "@gadgetinc/api-client-core";
...
export const useAction = (action, options) => {
    ...
    console.log("where - action:", action, action.type, action.reason);
