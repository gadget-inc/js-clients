import { actionOperation, capitalizeIdentifier, disambiguateActionVariables, get, namespaceDataPath, processActionResponse, } from "@gadgetinc/api-client-core";
    ...
    if (result.data) {
        ...
        if (mutationData) {
            ...
            if (errors && errors[0]) {
                ...
                data = processActionResponse(action.defaultSelection, result, mutationData, action.modelSelectionField, action.hasReturnType, action.modelManager);
            }
        }
    }
