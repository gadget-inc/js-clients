import type { DefinitionNode } from "@0no-co/graphql.web";
...
export declare class GadgetConnection {
    ...
    static version: "0.15.47";
    static availableAuthenticationModes: readonly ["apiKey", "browserSession", "anonymous", "internalAuthToken", "internal", "custom"];
     ...
     */
    private authenticationModeOptions?;
