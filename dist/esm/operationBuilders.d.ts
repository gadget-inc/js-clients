...
export declare const actionOperation: (operation: string, defaultSelection: FieldSelection | null, modelApiIdentifier: string, modelSelectionField: string, variables: VariablesOptions, options?: SelectionOptions | null, namespace?: string | null, hasReturnType?: boolean | null) => {
    query: string;
    variables: Record<string, any>;
};
