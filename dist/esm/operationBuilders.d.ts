...
export declare const enqueueActionOperation: (operation: string, variables: VariablesOptions, namespace?: string | null, options?: EnqueueBackgroundActionOptions<any> | null, isBulk?: boolean) => {
    query: string;
    variables: Record<string, any>;
};
