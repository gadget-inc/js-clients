...
/**
 * ARE YOU MAKING IT TO CODE MIRROR DUDE - HEY
 ...
 * }
 */
export declare const useGlobalAction: <F extends GlobalActionFunction<any>>(action: F) => ActionHookResultWithOptionalCallbackVariables<any, Exclude<F["variablesType"], null | undefined>>;
