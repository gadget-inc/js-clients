...
import Fn, { useMemo as ur, useContext as hs, useRef as ys } from "react";
...
function gs() {
  return ui || (ui = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function bt(f) {
      ...
      // with.
      f.$$typeof === mt || f.getModuleId !== void 0));
    }
    function cn(f, b, v) {
      var N = f.displayName;
      if (N)
      ...
      if (typeof f == "object")
        switch (f.$$typeof) {
          ...
          case p:
            ...
            return N !== null ? N : Me(f.type) || "Memo";
          case d: {
...
` + C[fe].replace(" at new ", " at ");
                    return f.displayName && Ve.includes("<anonymous>") && (Ve = Ve.replace("<anonymous>", f.displayName)), typeof f == "function" && dn.set(f, Ve), Ve;
                  }
                while (fe >= 1 && pe >= 0);
              break;
            }
        ...
        Wn = !1, ce.current = Q, be(), Error.prepareStackTrace = U;
      }
      var St = f ? f.displayName || f.name : "", si = St ? gt(St) : "";
      return typeof f == "function" && dn.set(f, si), si;
    }
    function za(f, b, v) {
      return Wr(f, !1);
    }
    ...
    var hn = Object.prototype.hasOwnProperty, Jr = {}, Yr = k.ReactDebugCurrentFrame;
    function yn(f) {
      if (f) {
    ...
    function Ja(f, b, v, N, U) {
      {
        ...
        for (var D in f)
          if (Q(f, D)) {
            ...
            C && !(C instanceof Error) && (yn(U), O("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", N || "React class", v, D, typeof C), yn(null)), C instanceof Error && !(C.message in Jr) && (Jr[C.message] = !0, yn(U), O("Failed %s type: %s", v, C.message), yn(null));
          }
      }
    }
    ...
    function Kr(f) {
      if (Ka(f))
        return O("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Ha(f)), Hr(f);
    }
    ...
    function ts(f, b) {
      if (typeof f.ref == "string" && qt.current && b && qt.current.stateNode !== b) {
        var v = Me(qt.current.type);
        Yn[v] || (O('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', Me(qt.current.type), f.ref), Yn[v] = !0);
      }
    }
    function ns(f, b) {
      {
        var v = function() {
          Xr || (Xr = !0, O("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", b));
        };
    ...
    function rs(f, b) {
      {
        var v = function() {
          Zr || (Zr = !0, O("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", b));
        };
    ...
    function as(f, b, v, N, U) {
      {
        ...
        v !== void 0 && (Kr(v), C = "" + v), es(b) && (Kr(b.key), C = "" + b.key), Za(b) && (ke = b.ref, ts(b, U));
        for (Q in b)
    ...
    var Hn = k.ReactCurrentOwner, ei = k.ReactDebugCurrentFrame;
    function vt(f) {
      if (f) {
        var b = f._owner, v = pn(f.type, f._source, b ? b.type : null);
        ei.setExtraStackFrame(v);
      } else
    ...
    function ri(f, b) {
      {
        ...
        ni[v] = !0;
        var N = "";
        f && f._owner && f._owner !== Hn.current && (N = " It was passed a child from " + Me(f._owner.type) + "."), vt(f), O('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', v, N), vt(null);
      }
    }
    function ii(f, b) {
      {
    ...
    function ls(f) {
      {
        for (var b = Object.keys(f.props), v = 0; v < b.length; v++) {
          var N = b[v];
          if (N !== "children" && N !== "key") {
            vt(f), O("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", N), vt(null);
            break;
          }
        }
        f.ref !== null && (vt(f), O("Invalid attribute `ref` supplied to `React.Fragment`."), vt(null));
      }
    }
    function ai(f, b, v, N, U, Q) {
      {
        var D = bt(f);
        if (!D) {
          var C = "";
          ...
          ke ? C += ke : C += ti();
          var fe;
          f === null ? fe = "null" : Jn(f) ? fe = "array" : f !== void 0 && f.$$typeof === t ? (fe = "<" + (Me(f.type) || "Unknown") + " />", C = " Did you accidentally export a JSX literal instead of a component?") : fe = typeof f, O("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", fe, C);
        }
        var pe = as(f, b, v, U, Q);
        if (pe == null)
          return pe;
...
process.env.NODE_ENV === "production" ? lr.exports = bs() : lr.exports = gs();
var li = lr.exports, Wt;
(function(e) {
...
function cr(e, t) {
  ...
  for (const i of e.body.matchAll(ws)) {
    if (typeof i.index == "number" || Xi(!1), i.index >= t)
      break;
...
let V = class ea extends Error {
  ...
  constructor(t, ...n) {
    ...
    super(t), this.name = "GraphQLError", this.path = l ?? void 0, this.originalError = c ?? void 0, this.nodes = fi(
      Array.isArray(s) ? s : s ? [s] : void 0
    );
    const d = fi(
      (r = this.nodes) === null || r === void 0 ? void 0 : r.map((h) => h.loc).filter((h) => h != null)
    );
    this.source = o ?? (d == null || (i = d[0]) === null || i === void 0 ? void 0 : i.source), this.positions = u ?? (d == null ? void 0 : d.map((h) => h.start)), this.locations = u && o ? u.map((h) => cr(o, h)) : d == null ? void 0 : d.map((h) => cr(h.source, h.start));
    const y = Xt(
...
function Ns(e) {
  return na(e) || Ps(e) || e === 95;
}
function ks(e, t) {
  const n = e.replace(/"""/g, '\\"""'), r = n.split(/\r\n|[\n\r]/g), i = r.length === 1, a = r.length > 1 && r.slice(1).every((y) => y.length === 0 || hi(y.charCodeAt(0))), s = n.endsWith('\\"""'), o = e.endsWith('"') && !s, u = e.endsWith("\\"), l = o || u, c = !(t != null && t.minimize) && // add leading and trailing new lines only if it improves readability
  (!i || e.length > 70 || l || a || s);
  let p = "";
  const d = i && hi(e.charCodeAt(0));
  return (c && !d || a) && (p += `
`), p += n, (c || l) && (p += `
`), '"""' + p + '"""';
}
...
function js(e, t) {
  ...
  return n.length === 0 ? "{}" : t.length > ra ? "[" + Rs(e) + "]" : "{ " + n.map(
    ([i, a]) => i + ": " + Dn(a, t)
  ).join(", ") + " }";
}
function Cs(e, t) {
...
function Ms(e, t) {
  ...
  for (; n < e.length && r < t.length; ) {
    ...
    if (mn(i) && mn(a)) {
      let s = 0;
      do
        ++n, s = s * 10 + i - fr, i = e.charCodeAt(n);
      while (mn(i) && s > 0);
      let o = 0;
      do
        ++r, o = o * 10 + a - fr, a = t.charCodeAt(r);
      while (mn(a) && o > 0);
      if (s < o)
        return -1;
      if (s > o)
...
class Us {
  constructor(t) {
    this._input = t, this._inputLowerCase = t.toLowerCase(), this._inputArray = mi(this._inputLowerCase), this._rows = [
...
function ia(e) {
  return aa(e) || Ks(e) || Xs(e) || Zs(e) || sa(e) || oa(e) || ua(e) || Xe(e);
}
function aa(e) {
  return ot(e, Ft);
}
...
class to {
  constructor(t) {
    ia(t) || ue(!1, `Expected ${z(t)} to be a GraphQL type.`), this.ofType = t;
  }
  get [Symbol.toStringTag]() {
    return "GraphQLList";
  }
...
class Ft {
  constructor(t) {
    var n, r, i, a;
    const s = (n = t.parseValue) !== null && n !== void 0 ? n : yi;
    this.name = Ge(t.name), this.description = t.description, this.specifiedByURL = t.specifiedByURL, this.serialize = (r = t.serialize) !== null && r !== void 0 ? r : yi, this.parseValue = s, this.parseLiteral = (i = t.parseLiteral) !== null && i !== void 0 ? i : (o, u) => s(dr(o, u)), this.extensions = Be(t.extensions), this.astNode = t.astNode, this.extensionASTNodes = (a = t.extensionASTNodes) !== null && a !== void 0 ? a : [], t.specifiedByURL == null || typeof t.specifiedByURL == "string" || ue(
      !1,
...
class ro {
  constructor(t) {
    var n;
    this.name = Ge(t.name), this.description = t.description, this.isTypeOf = t.isTypeOf, this.extensions = Be(t.extensions), this.astNode = t.astNode, this.extensionASTNodes = (n = t.extensionASTNodes) !== null && n !== void 0 ? n : [], this._fields = () => da(t), this._interfaces = () => fa(t), t.isTypeOf == null || typeof t.isTypeOf == "function" || ue(
      !1,
...
class oo {
  ...
  constructor(t) {
    ...
    ), this._nameLookup = xr(this._values, (r) => r.name);
  }
  get [Symbol.toStringTag]() {
...
const Zn = 2147483647, er = -2147483648, fo = new Ft({
  name: "Int",
  ...
  parseLiteral(e) {
    if (e.kind !== G.INT)
      throw new V(
        `Int cannot represent non-integer value: ${at(e)}`,
        {
          nodes: e
        }
      );
...
new Ft({
  ...
  parseLiteral(e) {
    if (e.kind !== G.FLOAT && e.kind !== G.INT)
      throw new V(
        `Float cannot represent non numeric value: ${at(e)}`,
        e
      );
    return parseFloat(e.value);
  }
...
const ma = new Ft({
  ...
  parseLiteral(e) {
    if (e.kind !== G.STRING)
      throw new V(
        `String cannot represent a non string value: ${at(e)}`,
        {
          nodes: e
        }
      );
  ...
  parseLiteral(e) {
    if (e.kind !== G.BOOLEAN)
      throw new V(
        `Boolean cannot represent a non boolean value: ${at(e)}`,
        {
          nodes: e
        }
      );
...
new Ft({
  ...
  parseValue(e) {
    ...
    if (typeof e == "number" && Number.isInteger(e))
      return e.toString();
    throw new V(`ID cannot represent value: ${z(e)}`);
  },
  parseLiteral(e) {
    if (e.kind !== G.STRING && e.kind !== G.INT)
      throw new V(
        "ID cannot represent a non-string and non-integer value: " + at(e),
        {
          nodes: e
        }
      );
...
function Qt(e, t, n) {
  if (e) {
    ...
    if (oa(t)) {
      if (e.kind !== G.OBJECT)
        return;
      const r = /* @__PURE__ */ Object.create(null), i = xr(e.fields, (a) => a.name.value);
    ...
    Xi(!1, "Unexpected input type: " + z(t));
  }
}
function gi(e, t) {
...
function ho(e, t, n) {
  var r;
  const i = {}, a = (r = t.arguments) !== null && r !== void 0 ? r : [], s = xr(a, (o) => o.name.value);
  for (const o of e.args) {
    ...
    if (y === void 0)
      throw new V(
        `Argument "${u}" has invalid value ${at(p)}.`,
        {
          nodes: p
        }
      );
...
var tr = 0, wi = 1, ht = 2, Nn = 3, yr = 4, kn = 1024, Tn = function() {
};
function Pt(e) {
...
function ct(e, t) {
  ...
  return Promise.resolve(t).then(function(r) {
    return !n && e.state >= yr ? Pt(e).then(function(i) {
      return {
        value: i,
        done: !0
      };
...
function Rr(e, t) {
  var n, r;
  if (!(e.state >= ht))
    if (e.state = ht, e.onnext(), e.onstop(), e.err == null && (e.err = t), e.pushes.length === 0 && (typeof e.buffer > "u" || e.buffer.empty))
      Jt(e);
    else
      try {
...
function Jt(e) {
  var t, n;
  if (!(e.state >= Nn)) {
    e.state < ht && Rr(e), e.state = Nn, e.buffer = void 0;
    try {
...
function Ii(e) {
  e.state >= yr || (e.state < Nn && Jt(e), e.state = yr);
}
function _o(e, t) {
  if (hr(t), e.pushes.length >= kn)
  ...
  n = n.catch(function(u) {
    e.state < ht && (e.err = u), Ii(e);
  });
  var r;
  if (e.nexts.length) {
    var i = e.nexts.shift();
    i.resolve(ct(e, n)), e.nexts.length ? r = Promise.resolve(e.nexts[0].value) : r = new Promise(function(u) {
      return e.onnext = u;
    });
  } else
...
function xo(e) {
  var t = Rr.bind(null, e), n = new Promise(function(r) {
    return e.onstop = r;
  });
...
var gn = /* @__PURE__ */ new WeakMap(), sn = (
  ...
  function() {
    ...
    return e.prototype.next = function(t) {
      ...
      if (n.state <= tr && jo(n), n.onnext(t), typeof n.buffer < "u" && !n.buffer.empty) {
        var r = ct(n, n.buffer.remove());
        if (n.pushes.length) {
        ...
        return n.onnext = a.resolve, ct(n, a.value);
      } else if (n.state >= ht)
        return Jt(n), ct(n, Pt(n));
      ...
      if (n === void 0)
        throw new Error("WeakMap error");
      return n.state <= tr || n.state >= ht || typeof n.buffer < "u" && !n.buffer.empty ? (Jt(n), n.err == null && (n.err = t), ct(n, Pt(n))) : this.next(Promise.reject(t));
...
function Co(e) {
  var t = this, n = $n(e, { returnValues: !0 });
...
function Ro(e) {
  var t = this, n = $n(e, { yieldValues: !0 });
  return new sn(function(r, i) {
    return Nt(t, void 0, void 0, function() {
      var a, s, o, u = this;
...
function Uo() {
  ...
  const n = [];
  function r(s) {
    e.type === "running" && (n.push(s), t.resolve(), t = Oi());
  }
...
var Z, x;
function me(e) {
  return new mr(`Syntax Error: Unexpected token at ${x} in ${e}`);
}
function Fe(e) {
...
var Go = /(?:null|true|false)/y, Sa = /\$[_A-Za-z]\w*/y, Qo = /-?\d+/y, zo = /(?:\.\d+)?[eE][+-]?\d+|\.\d+/y, Wo = /\\/g, Jo = /"""(?:"""|(?:[\s\S]*?[^\\])""")/y, Yo = /"(?:"|[^\r\n]*?[^\\]")/y;
function _n(e) {
  var t, n;
  if (n = Fe(Go))
    t = n === "null" ? {
...
function Ai() {
  var e, t;
  return {
    source: tn(Vr((n) => (e = n.next, t = n.complete, Fr))),
    next(n) {
      e && e(n);
    },
    complete() {
...
var hu = (...e) => {
  for (var t = e[0], n = 1, r = e.length; n < r; n++)
    t = e[n](t);
  return t;
}, yu = (e) => e && e.message && (e.extensions || e.name === "GraphQLError") ? e : typeof e == "object" && e.message ? new mr(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : new mr(e);
...
var br = (e, t) => {
  ...
  return n;
}, pt = /* @__PURE__ */ new Set(), ki = /* @__PURE__ */ new WeakMap(), wt = (e) => {
  if (e === null || pt.has(e))
    return "null";
  if (typeof e != "object")
    return JSON.stringify(e) || "";
...
`) : e, Ti = (e) => e.split(mu).map(gu).join("").trim(), _i = /* @__PURE__ */ new Map(), En = /* @__PURE__ */ new Map(), qn = (e) => {
  var t;
  return typeof e == "string" ? t = Ti(e) : e.loc && En.get(e.__key) === e ? t = e.loc.source.body : (t = _i.get(e) || Ti(Ue(e)), _i.set(e, t)), typeof e != "string" && !e.loc && (e.loc = {
    start: 0,
    end: t.length,
    source: {
      body: t,
...
# ${n}`, t));
  ...
  var t, n;
  return typeof e == "string" ? (t = xi(e), n = En.get(t) || iu(e)) : (t = e.__key || xi(e), n = En.get(t) || e), n.loc || qn(n), n.__key = t, En.set(t, n), n;
}, Pn = (e, t, n) => {
  var r = t || {}, i = Rn(e), a = xn(r), s = i.__key;
  return a !== "{}" && (s = br(a, s)), {
    key: s,
    query: i,
    variables: r,
...
function Ta(e) {
  return {
    query: e.extensions && e.extensions.persistedQuery && !e.extensions.persistedQuery.miss ? void 0 : qn(e.query),
...
var Su = (e, t) => {
  ...
  if (t && !(e.kind === "query" && e.context.preferGetMethod)) {
    var n = xn(t), r = ((o) => {
      ...
      return (jn !== xt || Cn !== xt) && (pt.clear(), gr(u, "variables", o)), u;
    })(t.variables);
    if (r.size) {
      var i = new FormData();
...
`)) {
    ...
    for await (var u of o)
      i = i ? wr(i, u, a) : vr(e, u, a), r = !1, yield i, r = !0;
    i || (yield i = vr(e, {}, a));
  } catch (l) {
    if (!r)
      throw l;
...
function Nu(e, t, n) {
  var r;
  return typeof AbortController < "u" && (n.signal = (r = new AbortController()).signal), Dr(() => {
    r && r.abort();
  })(Pe((i) => !!i)(Aa(Au(e, t, n))));
}
var Ir = (e, t) => {
  if (Array.isArray(e))
    ...
    for (var r in e)
      r === "__typename" && typeof e[r] == "string" ? t.add(e[r]) : Ir(e[r], t);
  return t;
}, Or = (e) => {
  var t = !1;
  if ("definitions" in e) {
    ...
    var a = [], s = e.kind === rt.OPERATION_DEFINITION;
    if (e.selectionSet) {
      for (var o of e.selectionSet.selections || []) {
        s = s || o.kind === rt.FIELD && o.name.value === "__typename" && !o.alias;
        var u = Or(o);
        t = t || u !== o, a.push(u);
      }
      if (s || (t = !0, a.push({
  ...
  var t = Rn(e), n = Fi.get(t.__key);
  return n || (Fi.set(t.__key, n = Or(t)), Object.defineProperty(n, "__key", {
    value: t.__key,
    enumerable: !1
  })), n;
}, Er = (e, t) => {
...
function Di(e) {
  var t = (n) => e(n);
  return t.toPromise = () => pu(Ea(1)(Pe((n) => !n.stale && !n.hasNext)(t))), t.then = (n, r) => t.toPromise().then(n, r), t.subscribe = (n) => yt(n)(t), t;
}
function jt(e, t, n) {
  return {
    ...t,
...
function _u(e) {
  for (var t = /* @__PURE__ */ new Map(), n = [], r = [], i = Array.isArray(e) ? e[0] : e || "", a = 1; a < arguments.length; a++) {
    var s = arguments[a];
    s && s.definitions ? r.push(s) : i += s, i += arguments[0][a];
  }
  r.unshift(Rn(i));
  for (var o of r)
    for (var u of o.definitions)
      if (u.kind === rt.FRAGMENT_DEFINITION) {
        var l = u.name.value, c = qn(u);
        t.has(l) ? process.env.NODE_ENV !== "production" && t.get(l) !== c && console.warn("[WARNING: Duplicate Fragment] A fragment with name `" + l + "` already exists in this document.\nWhile fragment names may not be unique across your source, each name must be unique per document.") : (t.set(l, c), n.push(u));
      } else
        n.push(u);
  return Rn({
    kind: rt.DOCUMENT,
...
var nr = ({ kind: e }) => e !== "mutation" && e !== "query", xu = ({ forward: e, client: t, dispatchDebug: n }) => {
  ...
  return (o) => {
    var u = At((c) => {
      ...
      return process.env.NODE_ENV !== "production" && (d = {
        ...d,
        operation: process.env.NODE_ENV !== "production" ? Mi(c, {
          cacheOutcome: p ? "hit" : "miss"
        }) : c
      }), c.context.requestPolicy === "cache-and-network" && (d.stale = !0, Vi(t, c)), d;
    })(Pe((c) => !nr(c) && s(c))(o)), l = _t((c) => {
      var { operation: p } = c;
      if (p) {
        var d = p.context.additionalTypenames || [];
        if (c.operation.kind !== "subscription" && (d = ((S) => [...Ir(S, /* @__PURE__ */ new Set())])(c.data).concat(d)), c.operation.kind === "mutation" || c.operation.kind === "subscription") {
    ...
    })(e(Pe((c) => c.kind !== "query" || c.context.requestPolicy !== "cache-only")(At((c) => process.env.NODE_ENV !== "production" ? Mi(c, {
      cacheOutcome: "miss"
    }) : c)(Tt([At(a)(Pe((c) => !nr(c) && !s(c))(o)), Pe((c) => nr(c))(o)])))));
    return Tt([u, l]);
  };
}, Vi = (e, t) => e.reexecuteOperation(jt(t.kind, t, {
  requestPolicy: "network-only"
})), rr = ({ forwardSubscription: e, enableAllOperations: t, isSubscriptionOperation: n }) => ({ client: r, forward: i }) => {
        ...
        return Vr(({ next: h, complete: g }) => {
          ...
          return Promise.resolve().then(() => {
            E || (k = y.subscribe({
              ...
              complete() {
                E || (E = !0, d.kind === "subscription" && r.reexecuteOperation(jt("teardown", d, d.context)), O && O.hasNext && h(wr(O, {
                  hasNext: !1
                })), g());
              }
            }));
...
}, ju = ({ forward: e, dispatchDebug: t }) => (n) => {
  var r = en((a) => {
    ...
    var l = Mr(Pe((c) => c.kind === "teardown" && c.key === a.key)(n))(Nu(a, o, u));
  ...
  var d = (m) => {
    var A = Mr(Pe((S) => S.kind === "teardown" && S.key === m.key)(u.source))(Pe((S) => S.operation.kind === m.kind && S.operation.key === m.key && (!S.operation.context._instance || S.operation.context._instance === m.context._instance))(T));
    return m.kind !== "query" ? A = Pa((S) => !!S.hasNext, !0)(A) : A = Pi((S) => {
      var W = Yt(S);
      return S.stale || S.hasNext ? W : Tt([W, At(() => (S.stale = !0, S))(Ea(1)(Pe((et) => et.key === m.key)(u.source)))]);
    })(A), m.kind !== "mutation" ? A = Dr(() => {
    ...
    executeRequestOperation(m) {
      return m.kind === "mutation" ? Di(d(m)) : Di(lu(() => {
        var A = i.get(m.key);
        A || i.set(m.key, A = d(m)), A = Ei(() => {
          p(m);
        })(A);
        var S = r.get(m.key);
        return m.kind === "query" && S && (S.stale || S.hasNext) ? Pi(Yt)(Tt([A, Pe((W) => W === r.get(m.key))(Yt(S))])) : A;
      }));
    },
    executeQuery(m, A) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    h.subscribeToDebugTarget = (m) => yt(m)(k), g = E;
  }
  var O = Cu(t.exchanges), T = tn(O({
    client: h,
    dispatchDebug: g,
    forward: Ru({
      dispatchDebug: g
...
function xa(e) {
  ...
  switch (e.type) {
    ...
    case de.Ping:
    case de.Pong: {
      if (e.payload != null && !lt(e.payload))
    ...
    case de.Subscribe: {
      ...
      if (e.payload.variables != null && !lt(e.payload.variables))
      ...
      if (e.payload.extensions != null && !lt(e.payload.extensions))
...
function Vu(e) {
  ...
  async function Ut() {
    ...
    const [_, Y] = await (S ?? (S = new Promise((ee, ze) => (async () => {
      ...
      m.emit("connecting");
      const q = new T(typeof t == "function" ? await t() : t, Du);
      let He, tt;
      function ut() {
      ...
      A((be) => {
        ...
        try {
          ...
          m.emit("error", be), q.close(_e.InternalClientError, Ui(be instanceof Error ? be.message : new Error(be).message, "Internal client error"));
        }
      };
      let nt = !1;
      q.onmessage = ({ data: be }) => {
        try {
          ...
          if (m.emit("message", ce), ce.type === "ping" || ce.type === "pong") {
            m.emit(ce.type, !0, ce.payload), ce.type === "pong" ? ut() : o || (q.send(Gt(ce.payload ? {
              type: de.Pong,
              payload: ce.payload
            } : {
              type: de.Pong
          ...
          clearTimeout(He), nt = !0, m.emit("connected", q, ce.payload), mt = !1, bt = 0, ee([
            q,
            new Promise((fn, gt) => A(gt))
          ]);
        } catch (ce) {
          q.onmessage = null, m.emit("error", ce), q.close(_e.BadResponse, Ui(ce instanceof Error ? ce.message : new Error(ce).message, "Bad response"));
        }
      };
    })())));
...
function Sn(e) {
  return lt(e) && "code" in e && "reason" in e;
}
function $u(e) {
  return [
    1e3,
...
class Lu {
  ...
  toJSON() {
    return Nr({ ...this.__gadget.fields });
  }
  touch() {
...
class qi extends Error {
  constructor(t) {
    let n;
    Ar(t) ? n = `GraphQL websocket closed unexpectedly by the server with error code ${t.code} and reason "${t.reason}"` : n = "GraphQL websocket closed unexpectedly by the server", super(n), Object.defineProperty(this, "code", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: "GGT_UNKNOWN"
...
}, Ar = (e) => (e == null ? void 0 : e.type) == "close", Ye = (e, t) => typeof e != "string" ? "" : Bn(e, t), Bi = (e) => {
  const t = e == null ? "" : String(e);
  return t.charAt(0).toUpperCase() + t.slice(1);
}, Bn = (e, t = !0) => {
  let n = "" + e;
  return t ? n = n.replace(/^[a-z\d]*/, (r) => Bi(r)) : n = n.replace(new RegExp("^(?:(?=\\b|[A-Z_])|\\w)"), (r) => r.toLowerCase()), n = n.replace(/(?:_|(\/))([a-z\d]*)/gi, (r, i, a, s, o) => (i || (i = ""), "" + i + Bi(a))), n;
}, Wu = (e) => `${Bn(e)}Sort`, Ju = (e) => `${Bn(e)}Filter`, Yu = (e, t, n) => new Ra(`More than one record found for ${e}.${t} = ${n}. Please confirm your unique validation is not reporting an error.`), Hu = (e, t) => {
  if (e.fetching)
    return;
  const n = Ct(e.data, t);
  if (n === void 0)
...
`)), e.error;
  ...
  var t;
  return e.code == "GGT_INVALID_RECORD" ? new Qu(e.message, e.validationErrors, (t = e.model) === null || t === void 0 ? void 0 : t.apiIdentifier, e.record) : e.code == "GGT_UNKNOWN" && e.message.includes("duplicate key value violates unique constraint") ? new Ra(e.message) : new Ln(e.message, e.code);
}, ft = (e, t) => {
  const n = Ze(e, t);
  if (!n.success) {
    const r = n.errors && n.errors[0];
    throw r ? $r(r) : new Ln("Gadget API operation not successful.", "GGT_UNKNOWN");
  }
  return n;
}, Da = (e) => {
  var t, n, r, i;
  ...
  var n, r;
  const i = (r = (n = e.data) === null || n === void 0 ? void 0 : n.gadgetMeta) === null || r === void 0 ? void 0 : r.allHydrations;
  if (!i)
    return t;
  ...
  try {
    const t = window[e];
    return t.setItem(ir, ir), t.removeItem(ir), !0;
  } catch {
    return !1;
  }
}, Qi = Object.prototype.toString, zi = Object.getPrototypeOf, Wi = Object.getOwnPropertySymbols ? (e) => Object.keys(e).concat(Object.getOwnPropertySymbols(e)) : Object.keys, zt = (e, t, n) => {
  if (e === t)
    return !0;
  if (e == null || t == null)
    return !1;
  if (n.indexOf(e) > -1 && n.indexOf(t) > -1)
    return !0;
  const r = Qi.call(e), i = Qi.call(t);
  let a, s, o;
  if (n.push(e, t), r != i || (a = Wi(e), s = Wi(t), a.length != s.length || a.some(function(u) {
    return !zt(e[u], t[u], n);
  })))
    return !1;
  switch (r.slice(8, -1)) {
...
class Xu {
  ...
  async rollback() {
    throw Ze(await this.client.mutation("mutation RollbackTransaction { internal { rollbackTransaction }}", {}).toPromise(), [
      "internal",
      "rollbackTransaction"
    ]), this.open = !1, new Ma("Transaction rolled back.");
  }
  /**
   * @private
   */
...
const el = (e) => {
  ...
  onOperation: (e) => {
    var t, n;
    (t = (n = e.context).operationName) !== null && t !== void 0 || (n.operationName = el(e.query) || "unknown");
  }
}), tl = _a({
  onOperation: (e) => {
...
const nl = 2, rl = 4800, il = 1e4, al = [_e.ConnectionAcknowledgementTimeout, _e.ConnectionInitialisationTimeout], Yi = Symbol.for("gadget/connection"), sl = "token", ol = typeof btoa < "u" ? btoa : (e) => Buffer.from(e).toString("base64");
var ge;
(function(e) {
...
class Va {
  constructor(t) {
    ...
    if (Object.defineProperty(this, "options", {
      ...
      value: async (o, u) => {
        ...
        try {
          ...
          y[Yi] = this, d = new Xu(y, p), this.currentTransaction = d, await d.start();
          const h = await l(d);
          ...
          try {
            ...
            h instanceof Ma || console.warn("Encountered another error while rolling back a Gadget transaction that errored. The other error:", h);
          }
          throw Ar(y) ? new qi(y) : y;
        } finally {
      ...
      value: async (o, u = {}) => {
        var l;
        o = ul(o, (l = this.options.baseRouteURL) !== null && l !== void 0 ? l : this.options.endpoint), this.isGadgetRequest(o) && (u.headers = { ...this.requestHeaders(), ...u.headers }, this.authenticationMode == ge.Custom && await this.options.authenticationMode.custom.processFetch(o, u));
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof window < "u" && window.fetch ? this._fetchImplementation = window.fetch.bind(window) : this._fetchImplementation = async (...o) => {
      const { fetch: u } = await import("./browser-ponyfill-1367abfe.js").then((l) => l.b);
      return await u(...o);
    }, this.websocketImplementation = (r = (n = t.websocketImplementation) !== null && n !== void 0 ? n : globalThis == null ? void 0 : globalThis.WebSocket) !== null && r !== void 0 ? r : qu, this.websocketsEndpoint = (i = t.websocketsEndpoint) !== null && i !== void 0 ? i : t.endpoint + "/batch", this.websocketsEndpoint = this.websocketsEndpoint.replace(/^http/, "ws"), this.environment = (a = t.environment) !== null && a !== void 0 ? a : "Development", this.requestPolicy = (s = t.requestPolicy) !== null && s !== void 0 ? s : "cache-and-network", this.exchanges = {
      beforeAll: [],
      beforeAsync: [],
      afterAll: [],
      ...t.exchanges
  ...
  async getCurrentModels() {
    ...
    try {
      const t = await this.currentClient.query(_u`{
        gadgetMeta {
          allHydrations
        }
      }`, {});
      return this.allModels = Ku(t, this.allModels), this.allModels;
    } catch (t) {
  ...
  enableSessionMode(t) {
    ...
    let r;
    n == Wt.Durable && Gi("localStorage") ? r = window.localStorage : n == Wt.Session && Gi("sessionStorage") ? r = window.sessionStorage : r = new Zu(), t !== null && typeof t == "object" && "initialToken" in t && t.initialToken && r.setItem(this.sessionStorageKey, t.initialToken), this.sessionTokenStore = r, this.resetClients();
  }
  close() {
  ...
  newBaseClient() {
    const t = [...this.exchanges.beforeAll, Ji, tl];
    typeof window < "u" && t.push(xu), t.push(
      ...this.exchanges.beforeAsync,
      ...
      rr({
        ...
        forwardSubscription: (r) => ({
          subscribe: (i) => {
            const a = { ...r, query: r.query || "" };
            return {
              unsubscribe: Lo(Vo(qo((s) => this.getBaseSubscriptionClient().subscribe(a, s))), i)
            };
          }
        })
      }),
  ...
  requestHeaders() {
    ...
    if (this.authenticationMode == ge.InternalAuthToken)
      n.authorization = "Basic " + ol("gadget-internal:" + this.options.authenticationMode.internalAuthToken);
  ...
  async waitForOpenedConnection(t) {
    let n = this.newSubscriptionClient(t), r = [], i = t.connectionAttempts || nl;
    const a = t.connectionGlobalTimeoutMs || il, s = () => {
      r.forEach((o) => o()), r = [];
    };
    return await new Promise((o, u) => {
      const l = setTimeout(() => {
        this.disposeClient(n), p(new Bu("Timeout opening websocket connection to Gadget API"));
      }, a), c = (h) => {
        if (Ar(h)) {
          if (h.code == kr.TooManyRequests)
            return s(), p(new Gu(h.reason));
          if (al.includes(h.code) && i > 0) {
            i -= 1, this.disposeClient(n), n = this.newSubscriptionClient(t), y();
            return;
          }
        }
        clearTimeout(l), u(new qi(h));
      }, p = (h) => {
        clearTimeout(l), u(h);
      }, d = () => {
        clearTimeout(l), o(n);
...
Object.defineProperty(Va, "version", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: "0.15.12"
...
class Rt extends Array {
  ...
  async nextPage() {
    var t;
    if (!this.hasNextPage)
      throw new Pr("Cannot request next page because there isn't one, should check 'hasNextPage' to see if it exists");
  ...
  async previousPage() {
    ...
    if (!this.hasPreviousPage)
      throw new Pr("Cannot request previous page because there isn't one, should check 'hasPreviousPage' to see if it exists");
...
const _r = (e) => Object.entries(e).flatMap(([t, n]) => {
  if (typeof n == "boolean")
    return n ? t : !1;
  if (n instanceof Lr) {
    let r = "";
    const i = Object.entries(n.args).filter(([a, s]) => s != null).map(([a, s]) => {
      var o;
      return `${a}: ${s instanceof Br ? `$${(o = s.name) !== null && o !== void 0 ? o : a}` : JSON.stringify(s)}`;
    });
    return i.length > 0 && (r = `(${i.join(", ")})`), n.subselection ? [`${t}${r} {`, ..._r(n.subselection), "}"] : `${t}${r}`;
  } else
    return [`${t} {`, ..._r(n), "}"];
}).filter((t) => !!t).map((t) => "  " + t), qr = (e) => {
  const t = {}, n = (r) => {
    let i = 1;
    if (t[r]) {
      for (; t[`${r}${i}`]; )
  ...
  return Object.entries(e).forEach(([r, i]) => {
    i instanceof Lr ? Object.entries(i.args).forEach(([a, s]) => {
      var o;
      s instanceof Br && (t[(o = s.name) !== null && o !== void 0 ? o : n(a)] = s);
    }) : typeof i == "object" && i !== null && Object.assign(t, qr(i));
  }), t;
}, ll = (e) => {
  const t = qr(e.fields);
...
const Mt = (e, t) => new Lr(e, t), Ee = (e) => new Br(e.type + (e.required ? "!" : ""), e.name, e.value), cl = (e) => {
  var t;
  const n = ll(e), r = e.directives && e.directives.length > 0 ? ` ${e.directives.join(" ")}` : "";
...
class Le {
  constructor(t, n, r) {
    Object.defineProperty(this, "apiIdentifier", {
      ...
      writable: !0,
      value: void 0
    }), this.capitalizedApiIdentifier = Bn(t);
  }
  validateRecord(t) {
  ...
  async findOne(t, n, r = !0) {
    const i = await this.connection.currentClient.query(fl(this.apiIdentifier), { id: t, select: Ua(n == null ? void 0 : n.select) }).toPromise(), s = (r ? Ze : Ht)(i, ["internal", this.apiIdentifier]);
    return Kt(i, s);
  }
  /**
   ...
   */
  async findMany(t) {
    const n = pl(this.apiIdentifier, t), r = await this.connection.currentClient.query(n.query, n.variables).toPromise(), i = Ht(r, ["internal", `list${this.capitalizedApiIdentifier}`]), a = nn(r, i);
  ...
  async findFirst(t, n = !0) {
    const r = dl(this.apiIdentifier, t), i = await this.connection.currentClient.query(r.query, r.variables).toPromise();
    let a;
   ...
   */
  async create(t) {
    const n = await this.connection.currentClient.mutation(hl(this.apiIdentifier), {
      record: this.getRecordFromData(t, "create")
    }).toPromise(), r = ft(n, ["internal", `create${this.capitalizedApiIdentifier}`]);
  ...
  async bulkCreate(t) {
    ...
    if (!(!((n = this.options) === null || n === void 0) && n.pluralApiIdentifier))
      throw new Pr("Cannot perform bulkCreate without a pluralApiIdentifier");
    const r = Ye(this.options.pluralApiIdentifier), i = await this.connection.currentClient.mutation(yl(this.apiIdentifier, this.options.pluralApiIdentifier), {
      records: t
    }).toPromise(), a = ft(i, ["internal", `bulkCreate${r}`]);
    return Ur(i, a[this.options.pluralApiIdentifier]);
  }
  /**
   ...
   */
  async update(t, n) {
    Li(t, "Can't update a record without an ID passed");
    const r = await this.connection.currentClient.mutation(ml(this.apiIdentifier), {
      id: t,
      record: this.getRecordFromData(n, "update")
    }).toPromise(), i = ft(r, ["internal", `update${this.capitalizedApiIdentifier}`]);
   ...
   */
  async delete(t) {
    Li(t, "Can't delete a record without an ID");
    const n = await this.connection.currentClient.mutation(bl(this.apiIdentifier), { id: t }).toPromise();
    ft(n, ["internal", `delete${this.capitalizedApiIdentifier}`]);
  }
  /**
   ...
   */
  async deleteMany(t) {
    const n = await this.connection.currentClient.mutation(gl(this.apiIdentifier), t).toPromise();
    ft(n, ["internal", `deleteMany${this.capitalizedApiIdentifier}`]);
  }
}
function Ua(e) {
  if (!e)
...
const Gr = (e) => ({
  ...
  const a = {};
  return typeof t < "u" && (a.id = Ee({ type: "GadgetID!", value: t })), Vt({
    type: "query",
    name: e,
    fields: {
      [e]: Mt(a, Qr((i == null ? void 0 : i.select) || n, !0)),
      ...Gr(r)
    },
    directives: Gn(i)
  });
}, Sl = (e, t, n, r, i, a) => zr(e, r, i, {
  ...a,
  first: 2,
  filter: {
    [t]: {
  ...
  fields: {
    [e]: Mt({
      ...
      sort: r != null && r.sort ? Ee({ value: r.sort, type: `[${Wu(n)}!]` }) : void 0,
      filter: r != null && r.filter ? Ee({ value: r.filter, type: `[${Ju(n)}!]` }) : void 0,
      search: r != null && r.search ? Ee({ value: r.search, type: "String" }) : void 0
    }, {
      pageInfo: { hasNextPage: !0, hasPreviousPage: !0, startCursor: !0, endCursor: !0 },
      edges: {
        cursor: !0,
        node: Qr((r == null ? void 0 : r.select) || t, !0)
      }
    }),
    ...Gr(n)
  },
...
}, La = (e) => Object.fromEntries(Object.entries(e).map(([t, n]) => [t, Ee(n)])), wl = (e, t, n, r, i, a, s, o, u) => {
  ...
  const o = vl(t, n, r, i, a), u = await e.connection.currentClient.query(o.query, o.variables).toPromise(), c = (s ? Ze : Ht)(u, [t]);
  return Kt(u, c);
}, Qn = async (e, t, n, r, i, a, s) => {
  const o = Sl(t, n, r, i, a, s), u = await e.connection.currentClient.query(o.query, o.variables).toPromise(), l = Ze(u, [t]), c = nn(u, l);
  if (c.length > 1)
    throw Yu(a, n, r);
  return c[0];
}, $ = async (e, t, n, r, i, a) => {
  const s = zr(t, n, r, i), o = await e.connection.currentClient.query(s.query, s.variables).toPromise();
  let u;
  a === !1 ? u = Ht(o, [t]) : u = Ze(o, [t], a);
  const l = nn(o, u);
  return Rt.boot(e, l, { options: i, pageInfo: u.pageInfo });
}, w = async (e, t, n, r, i, a, s, o, u, l) => {
  const c = wl(t, n, r, i, s, o, u, a, l), p = await e.connection.currentClient.mutation(c.query, c.variables).toPromise(), d = u ? [u, t] : [t];
  if (a) {
    const y = Ct(p.data, d), h = y[i] && n ? Ur(p, y[i]) : void 0;
    if (y.errors) {
      const g = y.errors.map((E) => $r(E));
      throw new zu(g, h);
    }
    return h;
  } else {
...
var Ba;
const ar = "production", In = "development", gc = Symbol.for("gadget/modelRelationships"), vc = () => {
  try {
...
class Sc {
  constructor(t) {
    ...
    const n = (t == null ? void 0 : t.environment) ?? vc() ?? In;
    let r = n.toLocaleLowerCase();
    r != In && r != ar && (console.warn("Invalid environment", n, "defaulting to development"), r = In);
    ...
    if (this.connection = new Va({
      endpoint: new URL("api/graphql", r == ar ? this.productionApiRoot : this.developmentApiRoot).toString(),
      applicationId: this.applicationId,
      authenticationMode: (t == null ? void 0 : t.authenticationMode) ?? (typeof window > "u" ? { anonymous: !0 } : { browserSession: !0 }),
      ...t,
      exchanges: i,
      environment: r == ar ? "Production" : "Development"
    ...
    this.user = new Nl(this.connection), this.session = new _l(this.connection), this.productPairing = new Rl(this.connection), this.unambiguous = new Vl(this.connection), this.shopifyProduct = new Ll(this.connection), this.shopifyProductImage = new zl(this.connection), this.shopifyProductOption = new Hl(this.connection), this.shopifyProductVariant = new ec(this.connection), this.shopifyShop = new sc(this.connection), this.shopifySync = new cc(this.connection), this.ambiguous = new hc(this.connection), this.currentSession = new bc(this.connection), this.internal = {
...
Ba = gc;
var Ga = {}, zn = We.createContext(Ga);
zn.Provider;
zn.Consumer;
zn.displayName = "UrqlContext";
var wc = () => {
  var e = We.useContext(zn);
  ...
  extensions: void 0,
  operation: void 0
}, Oc = (e, t) => e === t || !(!e || !t || e.key !== t.key), sr = (e, t) => {
  var n = {
    ...e,
    ...t,
  ...
  return ((r, i) => {
    for (var a in r)
      if (!(a in i))
        return !0;
    for (var s in i)
      if (s === "operation" ? !Oc(r[s], i[s]) : r[s] !== i[s])
        return !0;
    return !1;
  })(e, n) ? n : e;
}, Ec = (e, t) => {
  for (var n = 0, r = t.length; n < r; n++)
    if (e[n] !== t[n])
      return !0;
  return !1;
}, or = We.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
function Ki(e, t) {
...
var Ac = (e) => {
  ...
  return e._react;
}, Nc = (e, t) => e.suspense && (!t || t.suspense !== !1);
function kc(e) {
  var t = wc(), n = Ac(t), r = Nc(t, e.context), i = Pc(e.query, e.variables), a = We.useMemo(() => {
    if (e.pause)
      return null;
  ...
  }, [n, i]), o = [t, i, e.requestPolicy, e.context, e.pause], [u, l] = We.useState(() => [a, sr(Ic, s(a, r)), o]), c = u[1];
  a !== u[0] && Ec(u[2], o) && l([a, c = sr(u[1], s(a, r)), o]), We.useEffect(() => {
...
const _c = "Could not find a client in the context of Provider. Please ensure you wrap the root component in a <Provider>", xc = (e, t) => {
  let n = "";
  return e !== void 0 ? n = `[Network] ${e.message}` : t !== void 0 ? t.forEach((r) => {
    n += `[GraphQL] ${r.message}
`;
  }) : n = "Unknown error", n.trim();
}, jc = (e) => typeof e == "string" ? new V(e) : e != null && e.message && !e.code ? new V(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : e;
...
const Cc = (e) => {
  const { context: t, suspense: n, ...r } = e ?? {}, i = ur(() => ({
...
var Dc = typeof Element < "u", Mc = typeof Map == "function", Vc = typeof Set == "function", $c = typeof ArrayBuffer == "function" && !!ArrayBuffer.isView;
function An(e, t) {
  if (e === t)
    return !0;
  if (e && t && typeof e == "object" && typeof t == "object") {
    ...
    var a;
    if (Mc && e instanceof Map && t instanceof Map) {
      if (e.size !== t.size)
        return !1;
    ...
    if (Vc && e instanceof Set && t instanceof Set) {
      if (e.size !== t.size)
        return !1;
      for (a = e.entries(); !(r = a.next()).done; )
        if (!t.has(r.value[0]))
...
const qc = /* @__PURE__ */ ms(Uc), Lc = (e) => {
  const t = ys();
  return e ? (t.current === void 0 || !qc(e, t.current)) && (t.current = e) : t.current = void 0, t.current;
}, Bc = (e, t) => {
  const n = Lc(t), r = ur(() => zr(e.findMany.operationName, e.findMany.defaultSelection, e.findMany.modelApiIdentifier, n), [e, n]), [i, a] = Fc(Rc(r, t));
  return [ur(() => {
  ...
  const [{ data: e }] = Bc(Gc.shopifyProduct);
  return /* @__PURE__ */ li.jsx(li.Fragment, { children: JSON.stringify(e) });
};
export {
  Wc as R,
  zc as c
