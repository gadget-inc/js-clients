    ...
    function A(O, C, R) {
      {
        ...
        _e.unshift("Warning: " + C), Function.prototype.apply.call(console[O], console, _e);
      }
    }
    var _ = !1, T = !1, P = !1, E = !1, S = !1, I;
    I = Symbol.for("react.module.reference");
    function w(O) {
      return !!(typeof O == "string" || typeof O == "function" || O === r || O === a || S || O === i || O === u || O === c || E || O === h || _ || T || P || typeof O == "object" && O !== null && (O.$$typeof === p || O.$$typeof === l || O.$$typeof === o || O.$$typeof === s || O.$$typeof === y || // This needs to include all possible module reference object
      ...
      if (typeof O == "object")
        switch (O.$$typeof) {
          ...
          case l:
            ...
            return W !== null ? W : U(O.type) || "Memo";
          case p: {
            var fe = O, _e = fe._payload, ne = fe._init;
            try {
              return U(ne(_e));
            } catch {
              return null;
...
` + Qe + O;
    ...
    function Bt(O, C) {
      ...
      var _e;
      _e = K.current, K.current = null, ge();
      try {
        if (C) {
          var ne = function() {
            throw Error();
...
` + x[$e].replace(" at new ", " at ");
                    return O.displayName && bt.includes("<anonymous>") && (bt = bt.replace("<anonymous>", O.displayName)), typeof O == "function" && Fe.set(O, bt), bt;
                  }
                while ($e >= 1 && qe >= 0);
              break;
            }
      ...
      var An = O ? O.displayName || O.name : "", Qu = An ? Ne(An) : "";
      return typeof O == "function" && Fe.set(O, Qu), Qu;
    }
    function Vr(O, C, R) {
      return Bt(O, !1);
    }
      ...
      if (typeof O == "object")
        switch (O.$$typeof) {
          case y:
            return Vr(O.render);
          case l:
            return qt(O.type, C, R);
          case p: {
            var W = O, fe = W._payload, _e = W._init;
            try {
              return qt(_e(fe), C, R);
            } catch {
            }
    ...
    var xt = Object.prototype.hasOwnProperty, gn = {}, $r = m.ReactDebugCurrentFrame;
    function en(O) {
      if (O) {
        var C = O._owner, R = qt(O.type, O._source, C ? C.type : null);
        $r.setExtraStackFrame(R);
      } else
        $r.setExtraStackFrame(null);
    }
    function k(O, C, R, W, fe) {
      {
          ...
          if (_e(O, ne)) {
            ...
            try {
              if (typeof O[ne] != "function") {
                var ut = Error((W || "React class") + ": " + R + " type `" + ne + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof O[ne] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw ut.name = "Invariant Violation", ut;
              }
              x = O[ne](C, ne, W, R, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch ($e) {
              x = $e;
            }
            x && !(x instanceof Error) && (en(fe), g("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", W || "React class", R, ne, typeof x), en(null)), x instanceof Error && !(x.message in gn) && (gn[x.message] = !0, en(fe), g("Failed %s type: %s", R, x.message), en(null));
          }
      }
    }
    var j = Array.isArray;
    ...
    function Y(O) {
      {
        var C = typeof Symbol == "function" && Symbol.toStringTag, R = C && O[Symbol.toStringTag] || O.constructor.name || "Object";
        return R;
      }
    }
    function G(O) {
    ...
    function je(O) {
      if (G(O))
        return g("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Y(O)), te(O);
    }
    var be = m.ReactCurrentOwner, ye = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Zf(O, C) {
      if (typeof O.ref == "string" && be.current && C && be.current.stateNode !== C) {
        var R = U(be.current.type);
        Wt[R] || (g('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', U(be.current.type), O.ref), Wt[R] = !0);
      }
    }
    function xf(O, C) {
      {
        var R = function() {
          Ve || (Ve = !0, g("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", C));
        };
    ...
    function ed(O, C) {
      {
        var R = function() {
          bn || (bn = !0, g("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", C));
        };
    ...
    var td = function(O, C, R, W, fe, _e, ne) {
      var x = {
    ...
    function nd(O, C, R, W, fe) {
      {
        var _e, ne = {}, x = null, ut = null;
        R !== void 0 && (je(R), x = "" + R), Xf(C) && (je(C.key), x = "" + C.key), Jf(C) && (ut = C.ref, Zf(C, fe));
        for (_e in C)
          xt.call(C, _e) && !ye.hasOwnProperty(_e) && (ne[_e] = C[_e]);
        if (O && O.defaultProps) {
          var $e = O.defaultProps;
          for (_e in $e)
            ne[_e] === void 0 && (ne[_e] = $e[_e]);
        }
        if (x || ut) {
          var qe = typeof O == "function" ? O.displayName || O.name || "Unknown" : O;
          x && xf(ne, qe), ut && ed(ne, qe);
        }
        return td(O, x, ut, fe, W, be.current, ne);
      }
    }
...
Check the render method of \`` + O + "`.";
    ...
    function rd(O) {
      {
        if (O !== void 0) {
          var C = O.fileName.replace(/^.*[\\\/]/, ""), R = O.lineNumber;
          return `
...
Check the top-level render call using <` + R + ">.");
    ...
    function Wu(O, C) {
      {
        ...
        qu[R] = !0;
        var W = "";
        O && O._owner && O._owner !== na.current && (W = " It was passed a child from " + U(O._owner.type) + "."), _n(O), g('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', R, W), _n(null);
      }
    }
    function Hu(O, C) {
      {
        ...
        if (V(O))
          ...
          var fe = v(O);
          if (typeof fe == "function" && fe !== O.entries)
            for (var _e = fe.call(O), ne; !(ne = _e.next()).done; )
    ...
    function od(O) {
      {
        for (var C = Object.keys(O.props), R = 0; R < C.length; R++) {
          var W = C[R];
          if (W !== "children" && W !== "key") {
            _n(O), g("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", W), _n(null);
            break;
          }
        }
        O.ref !== null && (_n(O), g("Invalid attribute `ref` supplied to `React.Fragment`."), _n(null));
      }
    }
    function zu(O, C, R, W, fe, _e) {
      {
        var ne = w(O);
        if (!ne) {
          var x = "";
          ...
          ut ? x += ut : x += Gu();
          var $e;
          O === null ? $e = "null" : V(O) ? $e = "array" : O !== void 0 && O.$$typeof === n ? ($e = "<" + (U(O.type) || "Unknown") + " />", x = " Did you accidentally export a JSX literal instead of a component?") : $e = typeof O, g("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", $e, x);
        }
        var qe = nd(O, C, R, fe, _e);
        if (qe == null)
          return qe;
        if (ne) {
          var bt = C.children;
...
function Ka(e, n) {
  let t = 0, r = 1;
  for (const i of e.body.matchAll(bd)) {
...
let ae = class Gc extends Error {
  ...
  constructor(n, ...t) {
    var r, i, a;
    const { nodes: o, source: s, positions: y, path: u, originalError: c, extensions: l } = Ad(t);
...
}, Od = new Set(Object.keys(qc));
function Zu(e) {
  const n = e == null ? void 0 : e.kind;
  return typeof n == "string" && Od.has(n);
}
var xu;
(function(e) {
...
class xd {
  constructor(n) {
    zc(n) || Le(!1, `Expected ${Ae(n)} to be a GraphQL type.`), this.ofType = n;
  }
  get [Symbol.toStringTag]() {
    return "GraphQLList";
  }
...
class ki {
  constructor(n) {
    ep(n) || Le(
      !1,
      `Expected ${Ae(n)} to be a GraphQL nullable type.`
    ), this.ofType = n;
  }
  get [Symbol.toStringTag]() {
...
class Qn {
  constructor(n) {
    ...
    this.name = wt(n.name), this.description = n.description, this.specifiedByURL = n.specifiedByURL, this.serialize = (r = n.serialize) !== null && r !== void 0 ? r : ts, this.parseValue = o, this.parseLiteral = (i = n.parseLiteral) !== null && i !== void 0 ? i : (s, y) => o(Xa(s, y)), this.extensions = It(n.extensions), this.astNode = n.astNode, this.extensionASTNodes = (a = n.extensionASTNodes) !== null && a !== void 0 ? a : [], n.specifiedByURL == null || typeof n.specifiedByURL == "string" || Le(
      !1,
      `${this.name} must provide "specifiedByURL" as a string, but got: ${Ae(n.specifiedByURL)}.`
...
class tp {
  constructor(n) {
    ...
    this.name = wt(n.name), this.description = n.description, this.isTypeOf = n.isTypeOf, this.extensions = It(n.extensions), this.astNode = n.astNode, this.extensionASTNodes = (t = n.extensionASTNodes) !== null && t !== void 0 ? t : [], this._fields = () => el(n), this._interfaces = () => xc(n), n.isTypeOf == null || typeof n.isTypeOf == "function" || Le(
      !1,
      `${this.name} must provide "isTypeOf" as a function, but got: ${Ae(n.isTypeOf)}.`
    );
  }
  get [Symbol.toStringTag]() {
...
function el(e) {
  ...
  return jn(n) || Le(
    ...
    jn(t) || Le(
      ...
      !1,
      `${e.name}.${r} field resolver must be a function if provided, but got: ${Ae(t.resolve)}.`
    );
...
class np {
  constructor(n) {
    ...
    this.name = wt(n.name), this.description = n.description, this.resolveType = n.resolveType, this.extensions = It(n.extensions), this.astNode = n.astNode, this.extensionASTNodes = (t = n.extensionASTNodes) !== null && t !== void 0 ? t : [], this._fields = el.bind(void 0, n), this._interfaces = xc.bind(void 0, n), n.resolveType == null || typeof n.resolveType == "function" || Le(
      !1,
      `${this.name} must provide "resolveType" as a function, but got: ${Ae(n.resolveType)}.`
    );
  }
  get [Symbol.toStringTag]() {
...
class ap {
  ...
  constructor(n) {
    ...
    ), this._nameLookup = jo(this._values, (r) => r.name);
  }
  get [Symbol.toStringTag]() {
  ...
  serialize(n) {
    ...
    if (t === void 0)
      throw new ae(
        `Enum "${this.name}" cannot represent value: ${Ae(n)}`
      );
    return t.name;
  }
  parseValue(n) {
...
function op(e, n) {
  ...
  ), Object.entries(n).map(([t, r]) => (jn(r) || Le(
    !1,
    `${e}.${t} must refer to an object with a "value" key representing an internal value but got: ${Ae(r)}.`
  ), {
    name: Yd(t),
...
const aa = 2147483647, oa = -2147483648, cp = new Qn({
  ...
  serialize(e) {
    ...
    if (typeof n == "string" && n !== "" && (t = Number(n)), typeof t != "number" || !Number.isInteger(t))
      throw new ae(
        `Int cannot represent non-integer value: ${Ae(n)}`
      );
    if (t > aa || t < oa)
      throw new ae(
        "Int cannot represent non 32-bit signed integer value: " + Ae(n)
      );
    return t;
  },
  parseValue(e) {
    if (typeof e != "number" || !Number.isInteger(e))
      throw new ae(
        `Int cannot represent non-integer value: ${Ae(e)}`
      );
    if (e > aa || e < oa)
      throw new ae(
...
new Qn({
  ...
  serialize(e) {
    ...
    if (typeof n == "string" && n !== "" && (t = Number(n)), typeof t != "number" || !Number.isFinite(t))
      throw new ae(
        `Float cannot represent non numeric value: ${Ae(n)}`
      );
    return t;
  },
  parseValue(e) {
    if (typeof e != "number" || !Number.isFinite(e))
      throw new ae(
        `Float cannot represent non numeric value: ${Ae(e)}`
      );
    return e;
  },
  parseLiteral(e) {
...
const il = new Qn({
  ...
  serialize(e) {
    ...
    if (typeof n == "number" && Number.isFinite(n))
      return n.toString();
    throw new ae(
      `String cannot represent value: ${Ae(e)}`
    );
  },
  parseValue(e) {
    if (typeof e != "string")
      throw new ae(
        `String cannot represent a non string value: ${Ae(e)}`
      );
    return e;
  },
  parseLiteral(e) {
  ...
  serialize(e) {
    ...
    if (Number.isFinite(n))
      return n !== 0;
    throw new ae(
      `Boolean cannot represent a non boolean value: ${Ae(n)}`
    );
  },
  parseValue(e) {
    if (typeof e != "boolean")
      throw new ae(
        `Boolean cannot represent a non boolean value: ${Ae(e)}`
      );
    return e;
  },
  parseLiteral(e) {
...
new Qn({
  ...
  serialize(e) {
    ...
    if (Number.isInteger(n))
      return String(n);
    throw new ae(
      `ID cannot represent value: ${Ae(e)}`
    );
  },
  parseValue(e) {
    if (typeof e == "string")
    ...
    if (typeof e == "number" && Number.isInteger(e))
      return e.toString();
    throw new ae(`ID cannot represent value: ${Ae(e)}`);
  },
  parseLiteral(e) {
...
function lr(e, n, t) {
  if (e) {
    ...
    if (Kc(n)) {
      if (e.kind !== ve.OBJECT)
        return;
      const r = /* @__PURE__ */ Object.create(null), i = jo(e.fields, (a) => a.name.value);
    ...
    Vc(!1, "Unexpected input type: " + Ae(n));
  }
}
function is(e, n) {
...
function fp(e, n, t) {
  var r;
  const i = {}, a = (r = n.arguments) !== null && r !== void 0 ? r : [], o = jo(a, (s) => s.name.value);
  for (const s of e.args) {
    ...
    if (!c) {
      if (s.defaultValue !== void 0)
        ...
        throw new ae(
          `Argument "${y}" of required type "${Ae(u)}" was not provided.`,
          {
            nodes: n
          }
        );
    ...
    if (l.kind === ve.VARIABLE) {
      ...
      if (t == null || !pp(t, d)) {
        if (s.defaultValue !== void 0)
          ...
          throw new ae(
            `Argument "${y}" of required type "${Ae(u)}" was provided the variable "$${d}" which was not provided a runtime value.`,
            {
              nodes: l
            }
          );
    ...
    if (p && Vt(u))
      throw new ae(
        `Argument "${y}" of non-null type "${Ae(u)}" must not be null.`,
        {
          nodes: l
        }
      );
...
function Tp(e, n, t) {
  ...
  function y(p) {
    p.value instanceof gr ? Promise.resolve(p.value.v).then(u, c) : l(a[0][2], p);
  }
  function u(p) {
    s("next", p);
  }
...
var Wr = /* @__PURE__ */ new WeakMap(), Nr = (
  /** @class */
  function() {
    function e(n, t) {
      Wr.set(this, {
    ...
    return e.prototype.next = function(n) {
      ...
      return this;
    }, e.race = Np, e.merge = jp, e.zip = Rp, e.latest = Mp, e;
  }()
);
function Di(e, n) {
    ...
    u != null && typeof u[Symbol.asyncIterator] == "function" ? i.push(u[Symbol.asyncIterator]()) : u != null && typeof u[Symbol.iterator] == "function" ? i.push(u[Symbol.iterator]()) : i.push(function() {
      return Tp(this, arguments, function() {
        return Yt(this, function(p) {
          switch (p.label) {
            case 0:
              return n.yieldValues ? [4, gr(u)] : [3, 3];
            case 1:
              return [4, p.sent()];
            case 2:
              p.sent(), p.label = 3;
            case 3:
              return n.returnValues ? [4, gr(u)] : [3, 5];
            case 4:
              return [2, p.sent()];
            case 5:
              return [
        ...
        switch (l.label) {
          ...
          case 1:
            l.trys.push([1, , 5, 7]), y = void 0, u = 0, c = function() {
              var p, h, d, f, v, m;
              return Yt(this, function(g) {
                switch (g.label) {
                  case 0:
                    p = u;
                    try {
                      for (h = (v = void 0, Yn(t)), d = h.next(); !d.done; d = h.next())
                        f = d.value, Promise.resolve(f.next()).then(function(A) {
                          A.done ? (i(), s === void 0 && (s = A)) : u === p && (u++, a(A));
                        }, function(A) {
                          return i(A);
                        });
                    } catch (A) {
...
var _t = (e) => !(!e || !e.length), it = {
  ...
  VariableDefinition(e) {
    var n = it.Variable(e.variable) + ": " + At(e.type);
    return e.defaultValue && (n += " = " + At(e.defaultValue)), _t(e.directives) && (n += " " + e.directives.map(it.Directive).join(" ")), n;
  },
  Field(e) {
...
`).replace(/\n/g, `
  ...
  Document: (e) => _t(e.definitions) ? e.definitions.map(At).join(`
...
`).replace(/\n/g, `
  ...
  InlineFragment(e) {
    var n = "...";
    return e.typeCondition && (n += " on " + e.typeCondition.name.value), _t(e.directives) && (n += " " + e.directives.map(it.Directive).join(" ")), n + " " + At(e.selectionSet);
  },
  FragmentDefinition(e) {
    var n = "fragment " + e.name.value;
    return n += " on " + e.typeCondition.name.value, _t(e.directives) && (n += " " + e.directives.map(it.Directive).join(" ")), n + " " + At(e.selectionSet);
  },
  Directive(e) {
    var n = "@" + e.name.value;
...
function fs(e) {
  return (n) => (t) => {
    var r = gt, i = gt, a = !1, o = !1, s = !1, y = !1;
    n((u) => {
      y || (u === 0 ? (y = !0, s || t(0)) : u.tag === 0 ? r = u[0] : (s && (i(1), i = gt), a ? a = !1 : (a = !0, r(0)), function(l) {
        s = !0, l((p) => {
...
var no = (e, n) => {
  ...
  if (Array.isArray(e)) {
    ...
    return n += "]";
  } else if (mi !== Un && e instanceof mi || gi !== Un && e instanceof gi)
    return "null";
  ...
  if (!(t == null || typeof t != "object" || t.toJSON || cn.has(t)))
    if (Array.isArray(t))
      for (var r = 0, i = t.length; r < i; r++)
        ro(e, `${n}.${r}`, t[r]);
    else if (t instanceof mi || t instanceof gi)
      e.set(n, t);
    else {
      cn.add(t);
...
var mi = typeof File < "u" ? File : Un, gi = typeof Blob < "u" ? Blob : Un, ph = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g, hh = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g, yh = (e, n) => n % 2 == 0 ? e.replace(hh, `
`) : e, ys = (e) => e.split(ph).map(yh).join("").trim(), vs = /* @__PURE__ */ new Map(), oi = /* @__PURE__ */ new Map(), Fo = (e) => {
  var n;
  return typeof e == "string" ? n = ys(e) : e.loc && oi.get(e.__key) === e ? n = e.loc.source.body : (n = vs.get(e) || ys(At(e)), vs.set(e, n)), typeof e != "string" && !e.loc && (e.loc = {
    start: 0,
    end: n.length,
    source: {
      body: n,
...
var mh = (e, n) => {
  ...
  if (n && !(e.kind === "query" && e.context.preferGetMethod)) {
    var t = vi(n), r = ((s) => {
      ...
      return (mi !== Un || gi !== Un) && (cn.clear(), ro(y, "variables", s)), y;
    })(n.variables);
    if (r.size) {
      var i = new FormData();
...
}, _h = typeof TextDecoder < "u" ? new TextDecoder() : null, Ah = /boundary="?([^=";]+)"?/i, Oh = /data: ?([^\n]+)/, gs = (e) => e.constructor.name === "Buffer" ? e.toString() : _h.decode(e);
async function* bs(e) {
  ...
  try {
    ...
    if (/multipart\/mixed/i.test(o))
      s = async function* (c, l) {
        var p = c.match(Ah), h = "--" + (p ? p[1] : "-"), d = !0, f;
        for await (var v of _s(bs(l), `\r
` + h)) {
          if (d) {
            d = !1;
            var m = v.indexOf(h);
...
var uo = (e, n) => {
  ...
  var n = yl(e), t = As.get(n.__key);
  return t || (As.set(n.__key, t = so(n)), Object.defineProperty(t, "__key", {
    value: n.__key,
    enumerable: !1
  })), t;
}, co = (e, n) => {
...
var Ps = (e, n) => Fn(e.kind, e, {
      ...
      if (l) {
        ...
        if (c.operation.kind !== "subscription" && (p = ((P) => [...uo(P, /* @__PURE__ */ new Set())])(c.data).concat(p)), c.operation.kind === "mutation" || c.operation.kind === "subscription") {
          ...
          for (var g of h.values())
            r.has(g) && (l = r.get(g).operation, r.delete(g), Ss(n, l));
        ...
        return Uo(({ next: d, complete: f }) => {
          ...
          return Promise.resolve().then(() => {
            v || (m = h.subscribe({
              ...
              complete() {
                v || (v = !0, p.kind === "subscription" && r.reexecuteOperation(Fn("teardown", p, p.context)), g && g.hasNext && d(oo(g, {
                  hasNext: !1
                })), f());
              }
            }));
...
}, t), bl = ({ onOperation: e, onResult: n, onError: t }) => ({ forward: r }) => (i) => br((a) => {
  ...
  var p = (_) => {
    var T = Lo(rt((P) => P.kind === "teardown" && P.key === _.key)(y.source))(rt((P) => P.operation.kind === _.kind && P.operation.key === _.key && (!P.operation.context._instance || P.operation.context._instance === _.context._instance))(A));
    ...
    executeRequestOperation(_) {
      return _.kind === "mutation" ? Os(p(_)) : Os(oh(() => {
        var T = i.get(_.key);
...
function kh(e) {
  ...
  async function B() {
    ...
    const [D, $] = await (P ?? (P = new Promise((X, me) => (async () => {
      ...
      _.emit("connecting");
      const z = new A(typeof n == "function" ? await n() : n, Rh);
      let Ie, Q;
      function re() {
        isFinite(o) && o > 0 && (clearTimeout(Q), Q = setTimeout(() => {
          z.readyState === A.OPEN && (z.send(ir({ type: Ge.Ping })), _.emit("ping", !1, void 0));
        }, o));
      }
      T((ce) => {
      ...
      z.onmessage = ({ data: ce }) => {
        try {
          ...
          clearTimeout(Ie), ge = !0, _.emit("connected", z, K.payload), I = !1, w = 0, X([
            z,
            new Promise((Qe, Ne) => T(Ne))
          ]);
        } catch (K) {
        ...
        for (E++; ; )
          try {
            ...
            z.send(ir({
              ...
              !F && z.readyState === A.OPEN && z.send(ir({
                id: H,
                type: Ge.Complete
              }, v)), E--, F = !0, Ie();
            }, await Q.finally(re);
...
class Uh {
  constructor(n) {
    this.__gadget = {
      ...
      fieldKeysTracker: {},
      touched: !1
    }, this.empty = !1, this.__gadget.instantiatedFields = dt(n), this.__gadget.persistedFields = dt(n), Object.assign(this.__gadget.fields, n), !n || Object.keys(n).length === 0 ? this.empty = !0 : (this.__gadget.fieldKeys = Object.keys(this.__gadget.fields), this.__gadget.fieldKeys.forEach((r) => this.__gadget.fieldKeysTracker[r] = !0));
    const t = {
      get: (r, i) => {
        if (i in this)
          return this[i];
...
class Li extends Error {
  constructor(n, t) {
    super(n.startsWith("GGT_") ? n : `${t}: ${n}`), this.code = t;
  }
}
class Is extends Error {
  constructor(n) {
    let t;
    fo(n) ? t = `GraphQL websocket closed unexpectedly by the server with error code ${n.code} and reason "${n.reason}"` : t = "GraphQL websocket closed unexpectedly by the server", super(t), this.code = "GGT_UNKNOWN", this.name = "UnexpectedCloseError", this.statusCode = 500, this.causedByClient = !1, this.event = n;
  }
}
...
class $h extends Error {
  constructor(n, t, r, i) {
    ...
    super(n ?? `GGT_INVALID_RECORD: ${r ?? "Record"} is invalid and can't be saved. ${a.map(({ apiIdentifier: s, message: y }) => `${s} ${y}`).join(", ")}${o}.`), this.code = "GGT_INVALID_RECORD", this.name = "InvalidRecordError", this.statusCode = 422, this.causedByClient = !0, this.validationErrors = t, this.modelApiIdentifier = r, this.record = i;
  }
}
...
class Gh extends Error {
  constructor(n, t) {
    super(n.length > 1 ? "Multiple errors occurred" : n[0].message), this.errors = n, this.results = t, this.name = "ErrorGroup";
  }
  get code() {
...
const Vn = (e, n) => {
  ...
  const t = Vn(e.data, n);
  if (t === void 0)
    return new Ol(`Internal Error: Gadget API didn't return expected data. Nothing found in response at ${n.join(".")}`);
  if (t === null)
...
`)), e.error;
  ...
  if (i === void 0)
    throw new Ol(`Internal Error: Gadget API didn't return expected data. Nothing found in response at ${n.join(".")}`);
...
`)), e.error;
  ...
  if (!((t = (n = e.data) === null || n === void 0 ? void 0 : n.gadgetMeta) === null || t === void 0) && t.hydrations)
    return new gd((i = (r = e.data) === null || r === void 0 ? void 0 : r.gadgetMeta) === null || i === void 0 ? void 0 : i.hydrations);
}, vr = (e, n) => {
  const t = El(e);
  return t && (n = t.apply(n)), new Al(n);
}, $o = (e, n) => {
  const t = El(e);
  return t && (n = t.apply(n)), n == null ? void 0 : n.map((r) => new Al(r));
}, Ar = (e, n) => {
...
}, js = Object.prototype.toString, Rs = Object.getPrototypeOf, Ms = Object.getOwnPropertySymbols ? (e) => Object.keys(e).concat(Object.getOwnPropertySymbols(e)) : Object.keys, fr = (e, n, t) => {
  if (e === n)
    return !0;
  if (e == null || n == null)
    return !1;
...
class Qh {
  constructor(n, t) {
    this.client = n, this.subscriptionClient = t, this.open = !1;
  }
...
class Il {
  constructor(n) {
    var t, r, i, a, o;
    if (this.options = n, this.baseSubscriptionClient = void 0, this.currentTransaction = null, this.authenticationMode = Ye.Anonymous, this.transaction = async (s, y) => {
      let u, c;
    ...
    this.endpoint = n.endpoint, n.fetchImplementation ? this._fetchImplementation = n.fetchImplementation : typeof window < "u" && window.fetch ? this._fetchImplementation = window.fetch.bind(window) : this._fetchImplementation = async (...s) => {
      const { fetch: y } = await import("./browser-ponyfill-e1062537.js").then((u) => u.b);
      return await y(...s);
  ...
  enableSessionMode(n) {
    ...
    let r;
    t == dr.Durable && Ns("localStorage") ? r = window.localStorage : t == dr.Session && Ns("sessionStorage") ? r = window.sessionStorage : r = new Yh(), n !== null && typeof n == "object" && "initialToken" in n && n.initialToken && r.setItem(this.sessionStorageKey, n.initialToken), this.sessionTokenStore = r, this.resetClients();
  }
  close() {
...
class qo {
  constructor(n, t) {
    this.args = n, this.subselection = t;
  }
}
class Wo {
  constructor(n, t, r) {
    this.type = n, this.name = t, this.value = r;
  }
  present() {
...
class Et {
  constructor(n, t, r) {
    this.apiIdentifier = n, this.connection = t, this.options = r, this.capitalizedApiIdentifier = Ui(n);
  }
  validateRecord(n) {
   ...
   */
  async findMany(n) {
    const t = sy(this.apiIdentifier, n), r = await this.connection.currentClient.query(t.query, t.variables).toPromise(), i = yr(r, ["internal", `list${this.capitalizedApiIdentifier}`]), a = Ar(r, i);
...
const Ho = (e) => ({
...
}, jl = (e) => Object.fromEntries(Object.entries(e).map(([n, t]) => [n, et(t)])), vy = (e, n, t, r, i, a, o, s, y) => {
  ...
  const s = yy(n, t, r, i, a, o), y = await e.connection.currentClient.query(s.query, s.variables).toPromise(), u = $t(y, [n]), c = Ar(y, u);
  if (c.length > 1)
    throw Hh(a, t, r);
  return c[0];
...
var mv = () => {
  ...
  extensions: void 0,
  operation: void 0
}, bv = (e, n) => e === n || !(!e || !n || e.key !== n.key), da = (e, n) => {
  var t = {
    ...e,
    ...n,
  ...
  return ((r, i) => {
    for (var a in r)
      if (!(a in i))
        return !0;
    for (var o in i)
      if (o === "operation" ? !bv(r[o], i[o]) : r[o] !== i[o])
        return !0;
    return !1;
  })(e, t) ? t : e;
}, _v = (e, n) => {
...
function Sv(e) {
  var n = mv(), t = Ov(n), r = Pv(n, e.context), i = Av(e.query, e.variables), a = Rt.useMemo(() => {
    if (e.pause)
      return null;
  ...
  }, [t, i]), s = [n, i, e.requestPolicy, e.context, e.pause], [y, u] = Rt.useState(() => [a, da(gv, o(a, r)), s]), c = y[1];
  a !== y[0] && _v(y[2], s) && u([a, c = da(y[1], o(a, r)), s]), Rt.useEffect(() => {
    var p = y[0], h = y[2][1], d = !1, f = (m) => {
      d = !0, Ls(u, (g) => {
        var A = da(g[1], m);
        return g[1] !== A ? [g[0], A, g[2]] : g;
      });
    };
    if (p) {
      var v = fn(f)(Bo(() => {
...
const Nv = "Could not find a client in the context of Provider. Please ensure you wrap the root component in a <Provider>", jv = (e, n) => {
  let t = "";
...
class sn extends Error {
  ...
  constructor({ networkError: n, executionErrors: t, response: r }) {
    const i = (t || []).map(Rv), a = jv(n, i);
    super(a), this.message = a, this.executionErrors = i, this.graphQLErrors = i, this.networkError = n, this.response = r;
  }
...
var Ll = Nt.AppBridgeContext = void 0, qv = oe;
Ll = Nt.AppBridgeContext = qv.createContext(null);
var tt = {};
...
(function(e) {
  var n = b && b.__importDefault || function(f) {
  ...
  function y(f, v, m) {
    ...
    var g = s(f);
    if (m) {
      var A = m.subgroups, _ = m.type;
      A && A.length > 0 && (g += g.length > 0 ? r.SEPARATOR : "", A.forEach(function(T, P) {
        g += "" + T.toUpperCase() + (P < A.length - 1 ? r.SEPARATOR : "");
    ...
    return e.prototype.set = function() {
      ...
      return ha.forEachInEnum(Kr.Action, function(i) {
        ...
        i.forEach(function(a) {
          go.removeFromCollection(t.subscriptions, a, function(o) {
            o.unsubscribe();
          });
        });
      };
      ...
      Kr.isErrorEventName(n) ? u = ha.getEventNameSpace(ym.Group.Error, n, bi(bi({}, o), { type: "" })) : u = ha.getEventNameSpace(this.group, n, o);
...
var mm = (
  ...
  function(e) {
    ...
    return n.prototype.unsubscribe = function(t, r) {
      ...
      var r = this;
      return go.removeFromCollection(this.children, this.getChild(t), function() {
        var i = r.subscriptions.filter(function(a) {
          return a.component.id === t;
        });
        i.forEach(function(a) {
          go.removeFromCollection(r.subscriptions, a, function(o) {
            o.unsubscribe();
          });
        });
      }), this;
  ...
  var u = (
    ...
    function(c) {
      ...
      return Object.defineProperty(l.prototype, "options", {
        ...
        h === void 0 && (h = !0);
        var d = r.getMergedProps(this.options, p), f = d.label, v = d.disabled, m = d.icon, g = d.style, A = d.loading, _ = d.plain;
        return this.label = f, this.disabled = !!v, this.icon = m, this.style = g, this.loading = !!A, this.plain = !!_, h && this.dispatch(o.UPDATE), this;
...
var gm = Gt;
function bm(e, n, t, r) {
  return e.addChild(n, e.group, t), e.subscribeToChild(n, gm.Action.UPDATE, r), n.payload;
}
yn.getSingleButton = bm;
(function(e) {
  var n = b && b.__extends || function() {
    var d = function(f, v) {
      return d = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(m, g) {
        ...
        for (var A in g)
          Object.prototype.hasOwnProperty.call(g, A) && (m[A] = g[A]);
      }, d(f, v);
    };
    return function(f, v) {
  ...
  var l = (
    ...
    function(d) {
      ...
      return Object.defineProperty(f.prototype, "options", {
        ...
        m === void 0 && (m = !0);
        var g = i.getMergedProps(this.options, v), A = g.label, _ = g.disabled, T = g.buttons, P = g.plain;
        return this.label = A, this.disabled = !!_, this.buttons = this.getButtons(T), this.plain = !!P, m && this.dispatch(s.UPDATE), this;
        ...
        if (!(!this.buttons || this.buttons.length === 0)) {
          for (var m, g = 0, A = this.buttons; g < A.length; g++) {
            var _ = A[g];
        ...
        var m = this, g = [];
        return v ? (v.forEach(function(A) {
          var _ = r.getSingleButton(m, A, m.subgroups, m.updateButtons);
          g.push(_);
  ...
  function h(d, f, v, m, g) {
    var A = f.id, _ = m.label, T = i.getEventNameSpace(d, v, f), P = t(t({}, m), { id: A, label: _, payload: g });
...
(function(e) {
  var n = b && b.__extends || function() {
    var E = function(S, I) {
      return E = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(w, N) {
        w.__proto__ = N;
      } || function(w, N) {
        for (var B in N)
          Object.prototype.hasOwnProperty.call(N, B) && (w[B] = N[B]);
      }, E(S, I);
    };
    return function(S, I) {
...
qi.Features = void 0;
var Am = se, Om = de, ya = le, Us = ru, Pm = (
  /** @class */
  function(e) {
    _m(n, e);
    function n(t, r) {
    ...
    return n.prototype.dispatch = function(t, r) {
      ...
      this.app.dispatch(Am.actionWrapper({
  ...
  var n = b && b.__extends || function() {
    var P = function(E, S) {
      return P = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(I, w) {
        ...
        for (var N in w)
          Object.prototype.hasOwnProperty.call(w, N) && (I[N] = w[N]);
      }, P(E, S);
    };
    return function(E, S) {
      if (typeof S != "function" && S !== null)
  ...
  var A = (
    ...
    function(P) {
      ...
      return Object.defineProperty(E.prototype, "footer", {
        ...
        var w = this, N = c.subgroups;
        this.footerPrimaryOptions = this.getChildButton(S, this.footerPrimaryOptions), this.footerPrimary = this.footerPrimaryOptions ? r.getSingleButton(this, this.footerPrimaryOptions, N, function(B) {
          w.updatePrimaryFooterButton(B, I);
        }) : void 0;
      }, E.prototype.setFooterSecondaryButtons = function(S, I) {
        var w = this, N = c.subgroups, B = S || [], U = this.footerOptions && this.footerOptions.buttons.secondary || [];
        this.footerSecondaryOptions = this.getUpdatedChildActions(B, U), this.footerSecondary = this.footerSecondaryOptions ? this.footerSecondaryOptions.map(function(D) {
          return r.getSingleButton(w, D, N, function($) {
            w.updateSecondaryFooterButton($, I);
          });
        }) : void 0;
      }, E.prototype.getChildButton = function(S, I) {
        var w = S ? [S] : [], N = I ? [I] : [], B = this.getUpdatedChildActions(w, N);
        return B ? B[0] : void 0;
        ...
        if (!(!this.footer || !this.footer.buttons || !this.footer.buttons.secondary)) {
          for (var w, N = 0, B = this.footer.buttons.secondary; N < B.length; N++) {
            var U = B[N];
  ...
  var _ = (
    ...
    function(P) {
      ...
      return Object.defineProperty(E.prototype, "payload", {
        ...
        var w = this;
        I === void 0 && (I = !0);
        var N = i.getMergedProps(this.options, S), B = N.title, U = N.footer, D = N.message, $ = N.size;
  ...
  var T = (
    ...
    function(P) {
      ...
      return Object.defineProperty(E.prototype, "payload", {
        ...
        var w = this;
        I === void 0 && (I = !0);
        var N = i.getMergedProps(this.options, S), B = N.title, U = N.footer, D = N.path, $ = N.url, H = N.size, F = N.loading;
...
(function(e) {
  var n = b && b.__extends || function() {
    ...
    return new (h || (h = Promise))(function(v, m) {
      ...
      function _(T) {
        T.done ? v(T.value) : f(T.value).then(g, A);
      }
...
(function(e) {
  var n = b && b.__extends || function() {
    var S = function(I, w) {
      return S = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(N, B) {
        N.__proto__ = B;
      } || function(N, B) {
        for (var U in B)
          Object.prototype.hasOwnProperty.call(B, U) && (N[U] = B[U]);
      }, S(I, w);
    };
    return function(I, w) {
      ...
      I.prototype = w === null ? Object.create(w) : (N.prototype = w.prototype, new N());
    };
  }(), t = b && b.__assign || function() {
    return t = Object.assign || function(S) {
      for (var I, w = 1, N = arguments.length; w < N; w++) {
        I = arguments[w];
        for (var B in I)
  ...
  e.toDestination = p;
  function h(S) {
    var I = S.pathname, w = S.search, N = S.hash;
    return "" + I + (w || "") + (N || "");
  }
  ...
  var E = (
    ...
    function(S) {
      ...
      return Object.defineProperty(I.prototype, "payload", {
        ...
        enumerable: !1,
        configurable: !0
      }), I.prototype.dispatch = function(w, N) {
        var B = p(w, N, this.payload.id);
  ...
  var n = b && b.__extends || function() {
    var f = function(v, m) {
      return f = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(g, A) {
        ...
        for (var _ in A)
          Object.prototype.hasOwnProperty.call(A, _) && (g[_] = A[_]);
      }, f(v, m);
    };
    return function(v, m) {
    ...
    return t = Object.assign || function(f) {
      for (var v, m = 1, g = arguments.length; m < g; m++) {
        v = arguments[m];
        for (var A in v)
          Object.prototype.hasOwnProperty.call(v, A) && (f[A] = v[A]);
      }
      return f;
    }, t.apply(this, arguments);
  };
  ...
  var d = (
    ...
    function(f) {
      ...
      function v(m, g, A) {
        ...
        return _.initialSelectionIds = [], _.selection = [], _.resourceType = A, _.set(g, !1), _;
      }
      return Object.defineProperty(v.prototype, "payload", {
        ...
        g === void 0 && (g = !0);
        var A = r.getMergedProps(this.options, m), _ = A.initialQuery, T = A.initialSelectionIds, P = T === void 0 ? [] : T, E = A.showHidden, S = E === void 0 ? !0 : E, I = A.showVariants, w = I === void 0 ? !0 : I, N = A.showDraft, B = N === void 0 ? !0 : N, U = A.showArchived, D = U === void 0 ? !0 : U, $ = A.showDraftBadge, H = $ === void 0 ? !1 : $, F = A.showArchivedBadge, X = F === void 0 ? !1 : F, me = A.selectMultiple, z = me === void 0 ? !0 : me, Ie = A.actionVerb, Q = Ie === void 0 ? y.Add : Ie;
        return this.initialQuery = _, this.initialSelectionIds = P, this.showHidden = S, this.showVariants = w, this.showDraft = B, this.showArchived = D, this.showDraftBadge = H, this.showArchivedBadge = X, this.selectMultiple = z, this.actionVerb = Q, g && this.update(), this;
...
(function(e) {
  var n = b && b.__extends || function() {
    ...
    return function(g, A) {
      ...
      g.prototype = A === null ? Object.create(A) : (_.prototype = A.prototype, new _());
    };
  }(), t = b && b.__assign || function() {
    return t = Object.assign || function(m) {
      for (var g, A = 1, _ = arguments.length; A < _; A++) {
        g = arguments[A];
        for (var T in g)
  ...
  function h(m, g) {
    var A = u.ComponentType.Button, _ = t({ id: m, type: A }, l);
    return i.clickButton(u.Group.TitleBar, _, g);
  }
  e.clickActionButton = h;
  function d(m, g) {
    var A = t({ id: m }, p);
    return i.clickButton(u.Group.TitleBar, A, g);
  }
  e.clickBreadcrumb = d;
  function f(m) {
  ...
  var v = (
    ...
    function(m) {
      n(g, m);
      function g(A, _) {
        var T = m.call(this, A, u.Group.TitleBar, u.Group.TitleBar) || this;
      ...
      return Object.defineProperty(g.prototype, "buttons", {
        ...
        enumerable: !1,
        configurable: !0
      }), g.prototype.set = function(A, _) {
        _ === void 0 && (_ = !0);
        var T = y.getMergedProps(this.options, A), P = T.title, E = T.buttons, S = T.breadcrumbs;
        ...
        return this;
      }, g.prototype.getButton = function(A, _, T) {
        return A instanceof a.ButtonGroup ? o.getGroupedButton(this, A, _, T) : s.getSingleButton(this, A, _, T);
      }, g.prototype.updatePrimaryButton = function(A) {
        this.primary && y.updateActionFromPayload(this.primary, A) && this.dispatch(c.UPDATE);
      }, g.prototype.updateSecondaryButtons = function(A) {
        if (this.secondary) {
          ...
          if (_) {
            var T = !1;
            a.isGroupedButtonPayload(A), T = y.updateActionFromPayload(_, A), T && this.dispatch(c.UPDATE);
          }
        }
      }, g.prototype.updateBreadcrumbButton = function(A) {
        this.breadcrumb && y.updateActionFromPayload(this.breadcrumb, A) && this.dispatch(c.UPDATE);
      }, g.prototype.setPrimaryButton = function(A) {
        this.primaryOptions = this.getChildButton(A, this.primaryOptions), this.primary = this.primaryOptions ? this.getButton(this.primaryOptions, l.subgroups, this.updatePrimaryButton) : void 0;
      }, g.prototype.setSecondaryButton = function(A) {
        var _ = this, T = A || [], P = this.secondaryOptions || [];
      ...
      }, g.prototype.setBreadcrumbs = function(A) {
        this.breadcrumbsOption = this.getChildButton(A, this.breadcrumbsOption), this.breadcrumb = this.breadcrumbsOption ? this.getButton(this.breadcrumbsOption, p.subgroups, this.updateBreadcrumbButton) : void 0;
      }, g.prototype.getChildButton = function(A, _) {
        var T = A ? [A] : [], P = _ ? [_] : [], E = this.getUpdatedChildActions(T, P);
        return E ? E[0] : void 0;
      }, g;
  ...
  var p = (
    ...
    function(d) {
      ...
      return Object.defineProperty(f.prototype, "buttons", {
        ...
        m === void 0 && (m = !0);
        var g = o.getMergedProps(this.options, v), A = g.title, _ = g.buttons, T = g.saved, P = g.saving, E = g.status;
        return this.title = A, this.saving = P, this.saved = T, this.status = E, this.setPrimaryButton(_ ? _.primary : void 0), this.setSecondaryButtons(_ ? _.secondary : void 0), m && this.dispatch(r.Action.UPDATE), this;
      }, f.prototype.dispatch = function(v) {
        switch (v) {
        ...
        if (this.secondary) {
          var m = this.secondary.find(function(A) {
            return A.id === v.id;
          });
          if (m) {
        ...
        var m = this, g = v || [], A = this.secondaryOptions || [];
        this.secondaryOptions = this.getUpdatedChildActions(g, A), this.secondary = this.secondaryOptions ? this.secondaryOptions.map(function(_) {
        ...
        var g = v ? [v] : [], A = m ? [m] : [], _ = this.getUpdatedChildActions(g, A);
        return _ ? _[0] : void 0;
      }, f;
  ...
  var h = (
    ...
    function(d) {
      ...
      return Object.defineProperty(f.prototype, "payload", {
        ...
        m === void 0 && (m = !0);
        var g = r.getMergedProps(this.options, v), A = g.selectedItems, _ = A === void 0 ? [] : A, T = g.maxSelectable, P = T === void 0 ? 0 : T, E = g.items, S = E === void 0 ? [] : E, I = g.loading, w = I === void 0 ? !1 : I, N = g.title, B = g.searchQuery, U = g.searchQueryPlaceholder, D = g.primaryActionLabel, $ = g.secondaryActionLabel, H = g.emptySearchLabel, F = g.canLoadMore, X = F === void 0 ? !1 : F, me = g.loadingMore, z = me === void 0 ? !1 : me, Ie = g.verticalAlignment, Q = g.allowEmptySelection, re = g.resourceName;
        return this.title = N, this.items = S, this.selectedItems = _, this.maxSelectable = P, this.loading = w, this.searchQuery = B, this.searchQueryPlaceholder = U, this.primaryActionLabel = D, this.secondaryActionLabel = $, this.emptySearchLabel = H, this.canLoadMore = X, this.loadingMore = z, this.verticalAlignment = Ie, this.allowEmptySelection = Q, this.resourceName = re, m && this.update(), this;
...
(function(e, n) {
  (function(t, r) {
    ...
    var r, i, a, o, s, y = -1, u = function(k) {
      addEventListener("pageshow", function(j) {
        j.persisted && (y = j.timeStamp, k(j));
      }, !0);
    }, c = function() {
      ...
      var V = c(), Y = "navigate";
      return y >= 0 ? Y = "back-forward-cache" : V && (document.prerendering || l() > 0 ? Y = "prerender" : document.wasDiscarded ? Y = "restore" : V.type && (Y = V.type.replace(/_/g, "-"))), { name: k, value: j === void 0 ? -1 : j, rating: "good", delta: 0, entries: [], id: "v3-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12), navigationType: Y };
    }, h = function(k, j, V) {
      try {
      ...
      var G, te;
      return function(je) {
        j.value >= 0 && (je || Y) && ((te = j.value - (G || 0)) || G === void 0) && (G = j.value, j.delta = te, j.rating = function(be, ye) {
          return be > ye[1] ? "poor" : be > ye[0] ? "needs-improvement" : "good";
        }(j.value, V), k(j));
      };
    }, f = function(k) {
      ...
      addEventListener("visibilitychange", j, !0), addEventListener("pagehide", j, !0);
    }, m = function(k) {
      var j = !1;
      return function(V) {
        j || (k(V), j = !0);
      ...
      document.visibilityState === "hidden" && g > -1 && (g = k.type === "visibilitychange" ? k.timeStamp : 0, P());
    }, T = function() {
    ...
    }, I = [1800, 3e3], w = function(k, j) {
      j = j || {}, S(function() {
        var V, Y = E(), G = p("FCP"), te = h("paint", function(je) {
          je.forEach(function(be) {
            be.name === "first-contentful-paint" && (te.disconnect(), be.startTime < Y.firstHiddenTime && (G.value = Math.max(be.startTime - l(), 0), G.entries.push(be), V(!0)));
          });
        });
        te && (V = d(k, G, I, j.reportAllChanges), u(function(je) {
          G = p("FCP"), V = d(k, G, I, j.reportAllChanges), f(function() {
            G.value = performance.now() - je.timeStamp, V(!0);
          });
        }));
      });
    }, N = [0.1, 0.25], B = function(k, j) {
      j = j || {}, w(m(function() {
        var V, Y = p("CLS", 0), G = 0, te = [], je = function(ye) {
          ye.forEach(function(Ve) {
            if (!Ve.hadRecentInput) {
              var bn = te[0], Wt = te[te.length - 1];
              G && Ve.startTime - Wt.startTime < 1e3 && Ve.startTime - bn.startTime < 5e3 ? (G += Ve.value, te.push(Ve)) : (G = Ve.value, te = [Ve]);
            }
          }), G > Y.value && (Y.value = G, Y.entries = te, V());
        }, be = h("layout-shift", je);
        be && (V = d(k, Y, N, j.reportAllChanges), v(function() {
          je(be.takeRecords()), V(!0);
        }), u(function() {
          G = 0, Y = p("CLS", 0), V = d(k, Y, N, j.reportAllChanges), f(function() {
            return V();
          });
        }), setTimeout(V, 0));
      }));
    }, U = { passive: !0, capture: !0 }, D = /* @__PURE__ */ new Date(), $ = function(k, j) {
      r || (r = j, i = k, a = /* @__PURE__ */ new Date(), X(removeEventListener), H());
    }, H = function() {
      if (i >= 0 && i < a - D) {
      ...
      if (k.cancelable) {
        var j = (k.timeStamp > 1e12 ? /* @__PURE__ */ new Date() : performance.now()) - k.timeStamp;
      ...
      ["mousedown", "keydown", "touchstart", "pointerdown"].forEach(function(j) {
        return k(j, F, U);
      });
    }, me = [100, 300], z = function(k, j) {
      j = j || {}, S(function() {
        ...
        V = d(k, G, me, j.reportAllChanges), be && v(m(function() {
          je(be.takeRecords()), be.disconnect();
        })), be && u(function() {
          var ye;
          G = p("FID"), V = d(k, G, me, j.reportAllChanges), o = [], i = -1, r = null, X(addEventListener), ye = te, o.push(ye), H();
        });
      });
    }, Ie = 0, Q = 1 / 0, re = 0, ge = function(k) {
      k.forEach(function(j) {
        j.interactionId && (Q = Math.min(Q, j.interactionId), re = Math.max(re, j.interactionId), Ie = re ? (re - Q) / 7 + 1 : 0);
      });
    }, ce = function() {
      return s ? Ie : performance.interactionCount || 0;
    }, K = function() {
      "interactionCount" in performance || s || (s = h("event", ge, { type: "event", buffered: !0, durationThreshold: 0 }));
    }, Qe = [200, 500], Ne = 0, nt = function() {
      return ce() - Ne;
    }, Fe = [], Pt = {}, Bt = function(k) {
      var j = Fe[Fe.length - 1], V = Pt[k.interactionId];
      if (V || Fe.length < 10 || k.duration > j.latency) {
        if (V)
      ...
      j = j || {}, S(function() {
        K();
        var V, Y = p("INP"), G = function(je) {
          je.forEach(function(Ve) {
            Ve.interactionId && Bt(Ve), Ve.entryType === "first-input" && !Fe.some(function(bn) {
              return bn.entries.some(function(Wt) {
                return Ve.duration === Wt.duration && Ve.startTime === Wt.startTime;
              });
            }) && Bt(Ve);
          });
          var be, ye = (be = Math.min(Fe.length - 1, Math.floor(nt() / 50)), Fe[be]);
          ye && ye.latency !== Y.value && (Y.value = ye.latency, Y.entries = ye.entries, V());
        }, te = h("event", G, { durationThreshold: j.durationThreshold || 40 });
        V = d(k, Y, Qe, j.reportAllChanges), te && (te.observe({ type: "first-input", buffered: !0 }), v(function() {
          G(te.takeRecords()), Y.value < 0 && nt() > 0 && (Y.value = 0, Y.entries = []), V(!0);
        }), u(function() {
          Fe = [], Ne = ce(), Y = p("INP"), V = d(k, Y, Qe, j.reportAllChanges);
        }));
      });
    }, tr = [2500, 4e3], qt = {}, xt = function(k, j) {
      j = j || {}, S(function() {
        ...
        }, je = h("largest-contentful-paint", te);
        if (je) {
          V = d(k, G, tr, j.reportAllChanges);
          var be = m(function() {
            qt[G.id] || (te(je.takeRecords()), je.disconnect(), qt[G.id] = !0, V(!0));
          });
          ["keydown", "click"].forEach(function(ye) {
            addEventListener(ye, be, !0);
          }), v(be), u(function(ye) {
            G = p("LCP"), V = d(k, G, tr, j.reportAllChanges), f(function() {
              G.value = performance.now() - ye.timeStamp, qt[G.id] = !0, V(!0);
            });
          });
        }
      });
    }, gn = [800, 1800], $r = function k(j) {
      ...
      j = j || {};
      var V = p("TTFB"), Y = d(k, V, gn, j.reportAllChanges);
      $r(function() {
        var G = c();
        if (G) {
          ...
          V.value = Math.max(te - l(), 0), V.entries = [G], Y(!0), u(function() {
            V = p("TTFB", 0), (Y = d(k, V, gn, j.reportAllChanges))(!0);
          });
        }
      });
    };
    t.CLSThresholds = N, t.FCPThresholds = I, t.FIDThresholds = me, t.INPThresholds = Qe, t.LCPThresholds = tr, t.TTFBThresholds = gn, t.getCLS = B, t.getFCP = w, t.getFID = z, t.getINP = Vr, t.getLCP = xt, t.getTTFB = en, t.onCLS = B, t.onFCP = w, t.onFID = z, t.onINP = Vr, t.onLCP = xt, t.onTTFB = en, Object.defineProperty(t, "__esModule", { value: !0 });
  });
})(So, So.exports);
...
(function(e) {
  ...
  function h(d) {
    function f(m) {
      return function(g) {
        var A = g.id, _ = g.name, T = g.value, P = { id: A, metricName: _, value: T }, E = m(P);
        d.dispatch(E);
      };
    }
    var v = window;
...
(function(e) {
  var n = b && b.__createBinding || (Object.create ? function(Q, re, ge, ce) {
    ce === void 0 && (ce = ge), Object.defineProperty(Q, ce, { enumerable: !0, get: function() {
      return re[ge];
    } });
  } : function(Q, re, ge, ce) {
    ce === void 0 && (ce = ge), Q[ce] = re[ge];
  }), t = b && b.__setModuleDefault || (Object.create ? function(Q, re) {
    Object.defineProperty(Q, "default", { enumerable: !0, value: re });
  } : function(Q, re) {
    Q.default = re;
  }), r = b && b.__importStar || function(Q) {
    if (Q && Q.__esModule)
      return Q;
    var re = {};
    if (Q != null)
      for (var ge in Q)
        ge !== "default" && Object.prototype.hasOwnProperty.call(Q, ge) && n(re, Q, ge);
    return t(re, Q), re;
  }, i = b && b.__exportStar || function(Q, re) {
    for (var ge in Q)
      ge !== "default" && !Object.prototype.hasOwnProperty.call(re, ge) && n(re, Q, ge);
  };
...
var Vs = b && b.__rest || function(e, n) {
  var t = {};
  for (var r in e)
...
var Jr = oe, bf = Dt, Dm = tt, Xr = bf.ContextualSaveBar.Action, Bm = bf.ContextualSaveBar.create;
function Lm(e) {
...
Ko.default = Lm;
var Um = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Yo, "__esModule", { value: !0 });
var Fm = Um(Ko);
Yo.default = Fm.default;
var gu = {}, bu = {}, Vm = b && b.__extends || function() {
  var e = function(n, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
}(), $m = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(bu, "__esModule", { value: !0 });
var Gm = $m(oe), va = Dt, qm = Nt, Wm = (
  /** @class */
  function(e) {
    Vm(n, e);
    function n() {
...
bu.default = Wm;
var Hm = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(gu, "__esModule", { value: !0 });
var zm = Hm(bu);
gu.default = zm.default;
var _f = {}, _u = {}, hn = {}, Qm = b && b.__createBinding || (Object.create ? function(e, n, t, r) {
  r === void 0 && (r = t), Object.defineProperty(e, r, { enumerable: !0, get: function() {
    return n[t];
  } });
} : function(e, n, t, r) {
  r === void 0 && (r = t), e[r] = n[t];
}), Ym = b && b.__setModuleDefault || (Object.create ? function(e, n) {
  Object.defineProperty(e, "default", { enumerable: !0, value: n });
} : function(e, n) {
  e.default = n;
}), Au = b && b.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var n = {};
  if (e != null)
  ...
  return Ym(n, e), n;
}, Ci = b && b.__spreadArray || function(e, n) {
  for (var t = 0, r = n.length, i = e.length; t < r; t++, i++)
    e[i] = n[t];
  return e;
};
...
var Zr = Au(kr), Km = Au(Gi), Eo = Au(Hi);
function Af(e, n, t, r) {
...
hn.generateRedirect = Af;
function Jm(e, n) {
  return n === !0 ? Eo.Action.REMOTE : Eo.Action[e];
}
function Xm(e, n) {
  var t = n.primaryAction, r = n.secondaryActions, i = n.actionGroups, a = Zm(e, t), o = Ci(Ci([], xm(e, r)), eg(e, i));
  return {
    primary: a,
    secondary: o
  };
...
function Ou(e, n) {
  ...
  var i = Af(e, n.url, n.target, n.external);
...
var Sn = oe, wn = Wi, ng = hn, rg = tt;
function ig(e) {
  var n = rg.useAppBridge(), t = Sn.useRef(null), r = Sn.useRef({ open: !1 }), i = e.open, a = Sn.useRef(!1), o = Sn.useMemo(function() {
    e.primaryAction, e.secondaryActions;
    var s = tg(e, ["primaryAction", "secondaryActions"]);
...
_u.default = ig;
var Pu = {}, Su = {}, og = b && b.__extends || function() {
  var e = function(n, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
}(), ug = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Su, "__esModule", { value: !0 });
var sg = ug(oe), cg = Dt, lg = Nt, fg = (
  /** @class */
  function(e) {
    og(n, e);
    function n() {
    ...
    return n.prototype.componentDidMount = function() {
      var t = this.context;
      this.modalContent = cg.ModalContent.create(t), this.syncLoadingStatus();
      ...
      return null;
    }, n.contextType = lg.AppBridgeContext, n;
  }(sg.default.Component)
);
Su.default = fg;
var dg = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Pu, "__esModule", { value: !0 });
var pg = dg(Su);
Pu.default = pg.default;
(function(e) {
...
var xr = oe, hg = vu, yg = yu, vg = tt;
function mg(e, n) {
  return e.destination.replace(/\/$/, "") === n.pathname.replace(/\/$/, "");
}
function gg(e) {
  var n = e.navigationLinks, t = e.matcher, r = t === void 0 ? mg : t, i = vg.useAppBridge(), a = xr.useState(), o = a[0], s = a[1];
  xr.useEffect(function() {
    var u = n.map(function(c) {
      return hg.create(i, c);
    });
    s(u);
  }, [i, JSON.stringify(n)]);
  ...
  return xr.useEffect(function() {
    o && yg.create(i, { items: o, active: y });
  }, [o, y]), null;
}
Tu.default = gg;
var bg = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Eu, "__esModule", { value: !0 });
var _g = bg(Tu);
Eu.default = _g.default;
var Iu = {}, Of = {}, To = { exports: {} }, ma = {}, ga = {}, ba = {}, xn = {}, Pf = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 }), e.createTransportListener = e.fromWindow = e.fromFrame = e.Context = void 0;
  var n = Or, t = vt, r = Gn, i = Kt, a = wi;
  (function(c) {
  ...
  function o(c, l, p) {
    ...
    return a.isUnframed && window.MobileWebView && Object.assign(window.MobileWebView, {
      ...
      updateIframeUrl: function(v) {
        ...
        try {
          var A = new URL(v).origin;
          A === l && g ? g.replace(v) : m.href = v;
        } catch {
        }
      }
      ...
      if (!(v.source === d || !t.isAppMessage(v))) {
        if (v.origin !== l) {
          var m = "Message origin '" + v.origin + "' does not match app origin '" + l + "'.", g = n.invalidOriginAction(m), A = {
            type: "dispatch",
            payload: g
          };
          f == null || f.postMessage(A, v.origin);
          return;
        }
  ...
  function y() {
    ...
    function p(h) {
      function d() {
        ...
        var f = Array.from(arguments), v = f[0], m = f[1], g = f[2], A = { callback: m, id: g }, _ = { type: v, id: g };
        return Object.prototype.hasOwnProperty.call(l, v) || (l[v] = []), h && h(r.MessageType.Subscribe, _), i.addAndRemoveFromCollection(l[v], A, function() {
      ...
      handleActionDispatch: function(h) {
        ...
        if (Object.prototype.hasOwnProperty.call(l, d))
          for (var m = 0, g = l[d]; m < g.length; m++) {
            var A = g[m], _ = A.id, T = A.callback, P = f && f.id === _;
            (P || !_) && (T(f), v = !0);
          }
        return v;
      }
  ...
  return Ys || (Ys = 1, function(e) {
    var n = b && b.__assign || function() {
      return n = Object.assign || function(I) {
        for (var w, N = 1, B = arguments.length; N < B; N++) {
          w = arguments[N];
          for (var U in w)
    ...
    }, t = b && b.__spreadArray || function(I, w) {
      for (var N = 0, B = w.length, U = I.length; N < B; N++, U++)
        I[U] = w[N];
      return I;
    }, r = b && b.__importDefault || function(I) {
      return I && I.__esModule ? I : { default: I };
    };
    ...
    var i = Xt, a = zi, o = vn, s = xn, y = Sf(), u = Dr, c = eu, l = mu, p = Ag(), h = wu(), d = Ef(), f = r(Pg());
    e.WINDOW_UNDEFINED_MESSAGE = "window is not defined. Running an app outside a browser is not supported";
    function v(I, w) {
      var N = w.apiKey, B = w.host, U = w.forceRedirect, D = U === void 0 ? !u.isDevelopmentClient : U, $ = h.getLocation();
      if (u.isUnframed || !$ || !N || !B || !D || !h.shouldRedirect(I))
        return !1;
      var H = "https://" + B + "/apps/" + N + $.pathname + ($.search || "");
    ...
    var _ = function(I, w) {
      w === void 0 && (w = []);
      var N = [], B = s.createTransportListener(), U = function(D) {
        ...
        for (var z = new URL("https://" + $.host).origin, Ie = new f.default(), Q = {
          ...
          featuresAvailable: function() {
            for (var K = [], Qe = 0; Qe < arguments.length; Qe++)
              K[Qe] = arguments[Qe];
            var Ne = K[0], nt = Array.isArray(Ne) ? t([], Ne) : K;
          ...
          getState: function(K) {
            return K && typeof K != "string" ? Promise.resolve(void 0) : new Promise(function(Qe) {
              N.push(Qe), F(d.MessageType.GetState);
            }).then(function(Qe) {
              var Ne = Qe;
              if (K)
                for (var nt = 0, Fe = K.split("."); nt < Fe.length; nt++) {
                  var Pt = Fe[nt];
                  if (Ne == null || typeof Ne != "object" || Array.isArray(Ne) || !Object.keys(Ne).includes(Pt))
                    return;
                  Ne = Ne[Pt];
                }
              return Ne;
    ...
    function T(I) {
      ...
      try {
        var N = atob((w = I.host) === null || w === void 0 ? void 0 : w.replace(/_/g, "/").replace(/-/g, "+"));
        return n(n({}, I), { host: N });
      } catch {
    ...
    function P(I, w, N) {
      ...
      var D = s.fromWindow(I, U), $ = e.createClientApp(D, t([g], N));
      return $;
    }
...
function Tr() {
  return Js || (Js = 1, function(e) {
    var n = b && b.__createBinding || (Object.create ? function(i, a, o, s) {
...
function ot() {
  return Zs || (Zs = 1, function(e) {
    ...
    }, t = b && b.__spreadArray || function(f, v) {
      for (var m = 0, g = v.length, A = f.length; m < g; m++, A++)
        f[A] = v[m];
      return f;
    };
    ...
    function r() {
      for (var f = [], v = 0; v < arguments.length; v++)
        f[v] = arguments[v];
      return function(m) {
        for (var g, A = 0, _ = f.length; !g && A < _; ) {
          if (g = f[A](m), g)
            return g;
          A++;
        }
    ...
    function i(f, v) {
      return function(m) {
        var g = Object.keys(f).map(function(_) {
          return f[_];
        }), A = v && v.message || "expected:" + g.map(function(_) {
          return "`" + _ + "`";
        }).join(" or ");
        return g.includes(m) ? void 0 : s(m, "invalid_enum_value", n(n({}, v), { message: A }));
      };
    }
    e.matchesEnum = i;
    function a(f, v) {
    ...
    function o() {
      for (var f = [], v = 0; v < arguments.length; v++)
        f[v] = arguments[v];
      return function(m) {
        for (var g = [], A = 0, _ = f; A < _.length; A++) {
          var T = _[A], P = T(m);
          if (P == null)
            return P;
          g.push.apply(g, P);
    ...
    function y(f, v, m) {
      var g = m ? f[m] : f, A = m ? "['" + m + "']" : void 0, _ = v(g);
      if (_)
        return _.map(function(T) {
          return n(n({}, T), { path: "" + (A || "") + (T.path || "") || void 0 });
        });
    }
    e.getErrors = y;
    function u(f, v) {
      return function(m) {
        ...
        var g = Object.keys(f).reduce(function(A, _) {
          return t(t([], A), y(m, f[_], _) || []);
        }, []);
...
function Ng() {
  ...
  var e = Cg(), n = /\/\/\//, t = /[/\\][/\\]/, r = ["https:", "http:"], i = "http://test.com";
  function a(y, u) {
    ...
    return g && A.protocol === e.INTERNAL_PROTOCOL ? !0 : !(!r.includes(A.protocol) || m && A.protocol !== "https:" || A.username || A.password || f && !s(A, y, f) || !o(A, p, d));
  }
  or.isSafe = a;
  function o(y, u, c) {
...
function Rg() {
  ...
  }, n = b && b.__createBinding || (Object.create ? function(l, p, h, d) {
    d === void 0 && (d = h), Object.defineProperty(l, d, { enumerable: !0, get: function() {
      return p[h];
    } });
  } : function(l, p, h, d) {
    d === void 0 && (d = h), l[d] = p[h];
  }), t = b && b.__setModuleDefault || (Object.create ? function(l, p) {
...
function Lg() {
  if (yc)
    return he;
  yc = 1;
  var e = b && b.__createBinding || (Object.create ? function(v, m, g, A) {
    A === void 0 && (A = g), Object.defineProperty(v, A, { enumerable: !0, get: function() {
      return m[g];
    } });
  } : function(v, m, g, A) {
    A === void 0 && (A = g), v[A] = m[g];
...
function Ug() {
  return gc || (gc = 1, function(e) {
    ...
    }), h = t.composeSchemas(t.matchesObject({}), function(A) {
      var _ = t.matchesString(), T = Object.keys(A).reduce(function(P, E) {
        return P[E] = _, P;
      }, {});
      return t.validate(A, t.matchesObject(T));
    }), d = t.matchesArray(t.matchesString());
    function f(A) {
      return r.createActionValidator(n.Action, A ? t.matchesObject({ data: A }) : void 0, !0, !0);
    }
    function v(A) {
      var _ = t.matchesObject({ index: t.matchesPositiveInteger() });
      if (A) {
        var T = t.matchesObject({ data: A });
...
function qg() {
  return Pc || (Pc = 1, function(e) {
    var n = b && b.__createBinding || (Object.create ? function(c, l, p, h) {
      h === void 0 && (h = p), Object.defineProperty(c, h, { enumerable: !0, get: function() {
        return l[p];
      } });
    } : function(c, l, p, h) {
      h === void 0 && (h = p), c[h] = l[p];
    }), t = b && b.__setModuleDefault || (Object.create ? function(c, l) {
...
function Wg() {
  return Sc || (Sc = 1, function(e) {
    var n = b && b.__spreadArray || function(f, v) {
      for (var m = 0, g = v.length, A = f.length; m < g; m++, A++)
        f[A] = v[m];
      return f;
    };
    ...
    var t = Tr(), r = Zt, i = vn, a = Xt, o = qg(), s = er(), y = mn();
    function u(f, v, m) {
      switch (v) {
        case r.Group.Button:
    ...
    var p = function(f) {
      return function(v) {
        for (var m = [], g = 1; g < arguments.length; g++)
          m[g - 1] = arguments[g];
        var A = a.getMergedProps(this.options, v), _ = u(this.app.localOrigin, this.defaultGroup, A);
        if (_)
...
function zg() {
  return Tc || (Tc = 1, function(e) {
    var n = b && b.__createBinding || (Object.create ? function(c, l, p, h) {
      ...
      h === void 0 && (h = p), c[h] = l[p];
    }), t = b && b.__exportStar || function(c, l) {
      for (var p in c)
    ...
    var i = r(Hg()), a = mn(), o = wu(), s = Tr(), y = Sf();
    function u(c) {
      var l = o.getWindow();
...
process.env.NODE_ENV === "production" ? To.exports = Sg() : To.exports = zg();
var Qg = To.exports, Cu = {}, Nu = {}, Br = {};
Object.defineProperty(Br, "__esModule", { value: !0 });
Br.handleRouteChange = void 0;
var Yg = Dt;
function Kg(e, n) {
  return e.subscribe(Yg.Redirect.Action.APP, function(t) {
    var r = t.path;
    n.replace(r);
  });
}
Br.handleRouteChange = Kg;
var Jg = b && b.__extends || function() {
  var e = function(n, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
var Zg = Xg(oe), xg = Nt, eb = Br, tb = (
  ...
  function(e) {
    ...
    return n.prototype.componentDidMount = function() {
      ...
      this.unsubscribe = eb.handleRouteChange(this.context, t);
    }, n.prototype.componentWillUnmount = function() {
      this.unsubscribe && this.unsubscribe();
    }, n.prototype.render = function() {
      return null;
    }, n.contextType = xg.AppBridgeContext, n;
  }(Zg.default.Component)
);
Nu.default = tb;
var ju = {};
Object.defineProperty(ju, "__esModule", { value: !0 });
var nb = oe, rb = tt, ib = Br;
function ab(e) {
  var n = rb.useAppBridge();
  nb.useEffect(function() {
    return ib.handleRouteChange(n, e);
  }, [n, e]);
}
ju.default = ab;
(function(e) {
...
zt.getOrigin = sb;
var cb = b && b.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, lb = b && b.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
      ...
      switch (l.label) {
        case 0:
          return t = Io.getSelfWindow(), r = Io.getTopWindow(), i = t === r, [4, e.getState("context").then(function(p) {
            return p === fb.Context.Main;
          })];
        case 1:
          return a = l.sent(), i || !a ? [
            2
            /*return*/
          ] : (o = hb(n), db.forEach(function(p) {
...
}(), vb = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Mu, "__esModule", { value: !0 });
var mb = vb(oe), gb = Nt, wc = Lr, bb = (
  /** @class */
  function(e) {
    yb(n, e);
    function n() {
    ...
    return n.prototype.componentDidMount = function() {
      ...
      return null;
    }, n.contextType = gb.AppBridgeContext, n;
  }(mb.default.Component)
);
Mu.default = bb;
var ku = {};
Object.defineProperty(ku, "__esModule", { value: !0 });
var _b = oe, Ab = tt, Ob = Lr;
function Pb(e) {
  var n = Ab.useAppBridge();
  _b.useEffect(function() {
    Ob.updateHistory(n, e);
  }, [n, e]);
}
ku.default = Pb;
(function(e) {
...
const Sb = "@shopify/app-bridge-react", Eb = "3.0.0", Tb = "index.d.ts", Ib = "index.js", wb = "umd/index.js", Cb = "umd/index.js", Nb = [
  "/components/",
  "/umd/",
  "/hooks/",
  "/utilities/",
  ...
  access: "public",
  "@shopify:registry": "https://registry.npmjs.org"
}, Rb = "git@github.com:Shopify/app-bridge.git", Mb = "https://shopify.dev/tools/app-bridge/react-components", kb = "Shopify Inc.", Db = "MIT", Bb = {
...
}, $b = "7102c192814e6f3cf55daf81324b54a960ebe701", Gb = {
  name: Sb,
  version: Eb,
  types: Tb,
  main: Ib,
...
(function(e) {
  var n = b && b.__createBinding || (Object.create ? function(h, d, f, v) {
    v === void 0 && (v = f), Object.defineProperty(h, v, { enumerable: !0, get: function() {
      return d[f];
    } });
  } : function(h, d, f, v) {
    v === void 0 && (v = f), h[v] = d[f];
  }), t = b && b.__setModuleDefault || (Object.create ? function(h, d) {
  ...
  var i = r(oe), a = r(Qg), o = Nt, s = Cu, y = Ru, u = Gb;
  function c(h) {
...
var qb = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Iu, "__esModule", { value: !0 });
var Wb = qb(Of);
Iu.default = Wb.default;
var Du = {}, wf = {};
(function(e) {
  var n = b && b.__assign || function() {
  ...
  function o(s) {
    ...
    if (s.resourceType === "Product") {
      var v = s.showVariants, m = s.showDraft, g = s.showArchived, A = s.showDraftBadge, _ = s.showArchivedBadge, T = {
        showVariants: v,
        showDraft: m,
        showArchived: g,
        showDraftBadge: A,
...
var Hb = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Du, "__esModule", { value: !0 });
var zb = Hb(wf);
Du.default = zb.default;
var Bu = {}, Lu = {};
Object.defineProperty(Lu, "__esModule", { value: !0 });
var Ha = oe, wo = kr, Qb = fu, Cf = Gi, Nf = hn, Yb = tt;
function Kb(e) {
  var n = e.title, t = Yb.useAppBridge(), r = Ha.useRef({ title: n }), i = Ha.useMemo(function() {
    return Qb.create(t, {});
  }, [t]);
  return Ha.useEffect(function() {
    ...
    if (r.current = e, o)
      ...
      Ir(l, i.options.breadcrumbs), Ir(s, (a = i.options.buttons) === null || a === void 0 ? void 0 : a.primary), Jb(i, y), Xb(i, u);
    }
    return function() {
      i.unsubscribe();
    };
...
function Zb(e, n) {
  ...
  return {
    title: o,
    buttons: Nf.transformActions(e, {
      primaryAction: i,
      secondaryActions: a,
      actionGroups: t
    }),
    breadcrumbs: s ? xb(e, s) : void 0
  };
}
function xb(e, n, t) {
  var r = t || wo.create(e, {
...
function Ir(e, n) {
  if (!(!e || !n)) {
    var t = Nf.generateRedirect(n.app, e.url, e.target, e.external);
    t && n.subscribe(wo.Action.CLICK, t, n), e != null && e.onAction && n.subscribe(wo.Action.CLICK, e.onAction, n);
  }
}
var e_ = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Bu, "__esModule", { value: !0 });
var t_ = e_(Lu);
...
var n_ = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
...
(function(e) {
  var n = b && b.__createBinding || (Object.create ? function(p, h, d, f) {
    f === void 0 && (f = d), Object.defineProperty(p, f, { enumerable: !0, get: function() {
      return h[d];
    } });
  } : function(p, h, d, f) {
    f === void 0 && (f = d), p[f] = h[d];
  }), t = b && b.__exportStar || function(p, h) {
    for (var d in p)
...
var Rf = {}, Mf = {}, Ki = {}, i_ = b && b.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, a_ = b && b.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
var kf = {}, Ji = {}, Cc = b && b.__rest || function(e, n) {
  var t = {};
  for (var r in e)
    Object.prototype.hasOwnProperty.call(e, r) && n.indexOf(r) < 0 && (t[r] = e[r]);
  if (e != null && typeof Object.getOwnPropertySymbols == "function")
...
var jt = oe, rn = pu, s_ = tt;
function c_() {
  var e = s_.useAppBridge(), n = jt.useState(), t = n[0], r = n[1], i = jt.useState(), a = i[0], o = i[1], s = jt.useMemo(function() {
    return rn.create(e);
  }, [e]), y = jt.useCallback(function(p) {
    s.dispatch(rn.Action.SHOW), p && s.set(p);
  }, [s]), u = jt.useCallback(function() {
    s.dispatch(rn.Action.HIDE);
  }, [s]), c = jt.useMemo(function() {
    return {
...
var Fu = {}, Xi = {}, l_ = b && b.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, f_ = b && b.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
var g_ = oe, za = Dt, b_ = tt;
function __() {
  var e = b_.useAppBridge();
  return g_.useMemo(function() {
...
}, A_ = b && b.__createBinding || (Object.create ? function(e, n, t, r) {
  r === void 0 && (r = t), Object.defineProperty(e, r, { enumerable: !0, get: function() {
    return n[t];
  } });
} : function(e, n, t, r) {
  r === void 0 && (r = t), e[r] = n[t];
}), O_ = b && b.__setModuleDefault || (Object.create ? function(e, n) {
  Object.defineProperty(e, "default", { enumerable: !0, value: n });
} : function(e, n) {
  e.default = n;
}), P_ = b && b.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var n = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && A_(n, e, t);
  return O_(n, e), n;
};
...
(function(e) {
  var n = b && b.__createBinding || (Object.create ? function(a, o, s, y) {
...
mt.isShopifyPing = Wf;
var j_ = b && b.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, R_ = b && b.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
var M_ = Wi, k_ = xn, D_ = mt, No = "app-bridge-utils-modal-auto-size", ri = B_();
function B_() {
  if (typeof document > "u")
    return null;
  var e = document.createElement("style");
  return e.type = "text/css", e.innerHTML = "." + No + " { overflow: hidden; height: auto; min-height: auto; }", e;
}
function L_(e, n) {
  if (!ri)
    return function() {
  ...
  t.appendChild(ri), r.add(No);
  var i = Hf(e, n);
  return function() {
    r.remove(No), t.contains(ri) && t.removeChild(ri), i && i.disconnect();
  };
}
function U_(e) {
...
var zf = {}, Ur = {}, F_ = b && b.__createBinding || (Object.create ? function(e, n, t, r) {
  r === void 0 && (r = t), Object.defineProperty(e, r, { enumerable: !0, get: function() {
    return n[t];
  } });
} : function(e, n, t, r) {
  r === void 0 && (r = t), e[r] = n[t];
}), V_ = b && b.__setModuleDefault || (Object.create ? function(e, n) {
  Object.defineProperty(e, "default", { enumerable: !0, value: n });
} : function(e, n) {
  e.default = n;
}), $_ = b && b.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var n = {};
  if (e != null)
  ...
  return V_(n, e), n;
}, G_ = b && b.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, q_ = b && b.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
var ea = {}, ji = b && b.__assign || function() {
...
}, H_ = b && b.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, z_ = b && b.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
var K_ = b && b.__createBinding || (Object.create ? function(e, n, t, r) {
  r === void 0 && (r = t), Object.defineProperty(e, r, { enumerable: !0, get: function() {
    return n[t];
  } });
} : function(e, n, t, r) {
  r === void 0 && (r = t), e[r] = n[t];
}), J_ = b && b.__setModuleDefault || (Object.create ? function(e, n) {
  Object.defineProperty(e, "default", { enumerable: !0, value: n });
} : function(e, n) {
  e.default = n;
}), X_ = b && b.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var n = {};
  if (e != null)
  ...
  return J_(n, e), n;
}, Z_ = b && b.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, x_ = b && b.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
}, eA = b && b.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Fr, "__esModule", { value: !0 });
Fr.getAuthorizationCodePayload = void 0;
var Dc = X_(Jo), Bc = vn, tA = eA(Yf);
function nA(e) {
  return Z_(this, void 0, void 0, function() {
    return x_(this, function(n) {
      return [2, new Promise(function(t, r) {
        var i = tA.default(), a = e.subscribe(Dc.Action.RESPOND, function(o) {
...
Fr.getAuthorizationCodePayload = nA;
var ta = {}, rA = b && b.__awaiter || function(e, n, t, r) {
  function i(a) {
    return a instanceof t ? a : new t(function(o) {
      o(a);
    });
...
}, iA = b && b.__generator || function(e, n) {
  var t = { label: 0, sent: function() {
    if (a[0] & 1)
      throw a[1];
    return a[1];
...
var aA = Fr, oA = "auth/shopify/callback";
function uA(e) {
  var n = e.headers.get("X-Shopify-API-Request-Failure-Unauthorized");
  return n ? n.toLowerCase() === "true" : !1;
}
function sA(e) {
  var n = this, t = e.app, r = e.callbackUri, i = r === void 0 ? oA : r, a = e.isAuthorizationCodeRequired, o = a === void 0 ? uA : a, s = e.fetchOperation;
  return function(y, u) {
    return rA(n, void 0, void 0, function() {
      var c, l, p, h, d, f, v, m;
      return iA(this, function(g) {
        switch (g.label) {
          case 0:
            return [4, s(y, u)];
          case 1:
            return c = g.sent(), o(c) ? [4, aA.getAuthorizationCodePayload(t)] : [2, c];
          case 2:
...
`, lA = dd(({ children: e, forceRedirect: n, isEmbedded: t, gadgetAppUrl: r, originalQueryParams: i, api: a, isRootFrameRequest: o, type: s, isInstallRequest: y }) => {
  var g, A;
  ...
  d ? (p = (g = d.shopifyConnection) == null ? void 0 : g.requiresReauthentication, d.currentSession && (d.currentSession.shop ? h = !((A = d.shopifyConnection) != null && A.requiresReauthentication) : p = !0)) : s == Ft.Standalone && y && (p = !0), ii(() => {
    if (!p || o)
      return;
  ...
  }, [m, t, u, h, v, o]), oe.createElement(dA.Provider, { value: c }, e);
}), fA = ({ type: e, children: n, shopifyApiKey: t, api: r, router: i }) => {
  const [a, o] = Uc(null), s = !!a, { query: y } = a ?? {}, u = (y == null ? void 0 : y.get("host")) ?? void 0, c = e ?? Ft.Embedded, l = li(() => y, [s]), p = (y == null ? void 0 : y.has("hmac")) && (y == null ? void 0 : y.has("shop")), h = typeof window < "u" ? window.top !== window.self : !1, d = typeof window < "u" && !!window.MobileWebView, f = h || d, v = f == (c == Ft.Embedded) && (c == Ft.Standalone ? !p : !0), m = !(y != null && y.has("hmac")) && !(y != null && y.has("shop")) && c == Ft.Embedded, g = s && typeof u < "u" && !v, A = new URL(r.connection.options.endpoint).origin;
  ii(() => {
    o({
  ...
  let _ = oe.createElement(
    Cv,
    { api: r },
    oe.createElement(lA, { forceRedirect: g, isEmbedded: f, gadgetAppUrl: A, api: r, originalQueryParams: l, isRootFrameRequest: m, type: c, isInstallRequest: !!p }, n)
  );
...
}, vA = () => /* @__PURE__ */ fi.jsx(fA, { api: Kf, shopifyApiKey: "deadbeef", children: /* @__PURE__ */ fi.jsx(pA, {}) });
export {
  vA as A,
  pA as R,
  b as c
