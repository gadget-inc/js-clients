...
const se = Symbol.for("g/f"), ht = Symbol.for("g/if"), mt = Symbol.for("g/pf"), bt = Symbol.for("g/fk"), pr = Symbol.for("g/t");
class qo {
  constructor(t) {
    var r, n;
...
class Na {
  constructor(t) {
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof Rr < "u" && Rr.fetch ? this._fetchImplementation = Rr.fetch.bind(Rr) : this._fetchImplementation = async (...u) => {
      let l = await import("./browser-ponyfill-eb3ca39a.js").then((f) => f.b);
