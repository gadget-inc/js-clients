...
import Ae, { useMemo as Zn, useContext as Oa, useRef as Aa, forwardRef as To, useState as On, Children as ko, useEffect as Le, memo as _o, createContext as xo } from "react";
...
function Co() {
  return Ci || (Ci = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var b = !1, T = !1, S = !1, L = !1, Ce = !1, Fe;
    Fe = Symbol.for("react.module.reference");
    function Ue(o) {
      return !!(typeof o == "string" || typeof o == "function" || o === r || o === a || Ce || o === i || o === d || o === c || L || o === y || b || T || S || typeof o == "object" && o !== null && (o.$$typeof === m || o.$$typeof === p || o.$$typeof === s || o.$$typeof === u || o.$$typeof === l || // This needs to include all possible module reference object
    ...
    var _ = Object.assign, V = 0, U, j, Q, ke, B, je, Be;
    function Ze() {
    }
    ...
    function et() {
      {
        if (V === 0) {
          U = console.log, j = console.info, Q = console.warn, ke = console.error, B = console.group, je = console.groupCollapsed, Be = console.groupEnd;
          var o = {
            configurable: !0,
            enumerable: !0,
            value: Ze,
...
` + I[R].replace(" at new ", " at ");
    ...
    function ln(o) {
      if (Sr(o))
        return w("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", vr(o)), un(o);
    }
    var Ge = x.ReactCurrentOwner, Ir = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function kr(o, f, h, v, O) {
      {
        var k, N = {}, I = null, G = null;
        h !== void 0 && (ln(h), I = "" + h), Nr(f) && (ln(f.key), I = "" + f.key), wr(f) && (G = f.ref, Er(f, O));
        for (k in f)
          ft.call(f, k) && !Ir.hasOwnProperty(k) && (N[k] = f[k]);
        if (o && o.defaultProps) {
        ...
        return Tr(o, I, G, O, v, Ge.current, N);
      }
    }
...
Check the top-level render call using <` + h + ">.");
    ...
    var Fr = Cr, jr = Dr;
    Sn.Fragment = r, Sn.jsx = Fr, Sn.jsxs = jr;
  }()), Sn;
}
process.env.NODE_ENV === "production" ? zr.exports = Do() : zr.exports = Co();
var er = zr.exports;
...
var $r = {
  ...
  [Symbol.asyncIterator]() {
    var t = [], n = !1, r = Te, i;
    return e((a) => {
      n || (a === 0 ? (i && (i = i($r)), n = !0) : a.tag === 0 ? (r = a[0])(0) : i ? i = i({
        value: a[0],
        done: !1
      }) : t.push(a[0]));
    }), {
      async next() {
        return n && !t.length ? $r : (!n && t.length <= 1 && r(0), t.length ? {
          value: t.shift(),
          done: !1
        } : new Promise((a) => i = a));
      },
      async return() {
        return n || (i = r(1)), n = !0, $r;
      }
    };
  }
});
...
var K, F;
function oe(e) {
  return new Dn(`Syntax Error: Unexpected token at ${F} in ${e}`);
}
function De(e) {
...
var ss = (e) => e && e.message && (e.extensions || e.name === "GraphQLError") ? e : typeof e == "object" && e.message ? new Dn(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : new Dn(e);
...
var Wr = (e, t) => {
  ...
  if (Array.isArray(e)) {
    ...
    return t += "]";
  } else if (rr !== Xt && e instanceof rr || ir !== Xt && e instanceof ir)
    return "null";
  ...
  if (!(n == null || typeof n != "object" || n.toJSON || Vt.has(n)))
    if (Array.isArray(n))
      for (var r = 0, i = n.length; r < i; r++)
        Qr(e, `${t}.${r}`, n[r]);
    else if (n instanceof rr || n instanceof ir)
      e.set(t, n);
    else {
      Vt.add(n);
...
var rr = typeof File < "u" ? File : Xt, ir = typeof Blob < "u" ? Blob : Xt, us = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g, ls = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g, cs = (e, t) => t % 2 == 0 ? e.replace(ls, `
`) : e, Vi = (e) => e.split(us).map(cs).join("").trim(), Ui = /* @__PURE__ */ new Map(), Yn = /* @__PURE__ */ new Map(), gi = (e) => {
  var t;
  return typeof e == "string" ? t = Vi(e) : e.loc && Yn.get(e.__key) === e ? t = e.loc.source.body : (t = Ui.get(e) || Vi(Me(e)), Ui.set(e, t)), typeof e != "string" && !e.loc && (e.loc = {
    start: 0,
    end: t.length,
    source: {
      body: t,
...
# ${n}`, t));
  ...
  var t, n;
  return typeof e == "string" ? (t = Bi(e), n = Yn.get(t) || is(e)) : (t = e.__key || Bi(e), n = Yn.get(t) || e), n.loc || gi(n), n.__key = t, Yn.set(t, n), n;
}, Tn = (e, t, n) => {
  var r = t || {}, i = Ca(e), a = nr(r), s = i.__key;
  return a !== "{}" && (s = Wr(a, s)), {
    key: s,
    query: i,
    variables: r,
...
var fs = (e, t) => {
  ...
  for (var i in t) {
    var a = t[i];
    a && r.searchParams.set(i, typeof a == "object" ? nr(a) : a);
  }
  var s = r.toString();
  ...
  if (t && !(e.kind === "query" && e.context.preferGetMethod)) {
    var n = nr(t), r = ((u) => {
      ...
      return (rr !== Xt || ir !== Xt) && (Vt.clear(), Qr(l, "variables", u)), l;
    })(t.variables);
    if (r.size) {
      var i = new FormData();
      i.append("operations", n), i.append("map", nr({
        ...[...r.keys()].map((u) => [u])
      }));
      var a = 0;
...
function Qi(e) {
  var t = (n) => e(n);
  return t.toPromise = () => or($n(1)(ae((n) => !n.stale && !n.hasNext)(t))), t.then = (n, r) => t.toPromise().then(n, r), t.subscribe = (n) => Bt(n)(t), t;
}
function Zt(e, t, n) {
  return {
    ...t,
...
var Ji = (e, t) => Zt(e.kind, e, {
...
}, Mr = ({ kind: e }) => e !== "mutation" && e !== "query", ws = ({ forward: e, client: t, dispatchDebug: n }) => {
  ...
  return (u) => {
    var l = Jt((c) => {
      ...
      cacheOutcome: "miss"
    }) : c)(Ht([Jt(a)(ae((c) => !Mr(c) && !s(c))(u)), ae((c) => Mr(c))(u)])))));
    return Ht([l, d]);
  };
}, Yi = (e, t) => e.reexecuteOperation(Zt(t.kind, t, {
  requestPolicy: "network-only"
})), Lr = ({ forwardSubscription: e, enableAllOperations: t, isSubscriptionOperation: n }) => ({ client: r, forward: i }) => {
  ...
  var m = (b) => {
    ...
    return b.kind !== "query" ? T = Ta((S) => !!S.hasNext, !0)(T) : T = ji((S) => {
      var L = An(S);
      return S.stale || S.hasNext ? L : Ht([L, Jt(() => (S.stale = !0, S))($n(1)(ae((Ce) => Ce.key === b.key)(l.source)))]);
    ...
    createRequestOperation(b, T, S) {
      S || (S = {});
      var L;
      if (process.env.NODE_ENV !== "production" && b !== "teardown" && (L = ds(T.query)) !== b)
        throw new Error(`Expected operation of type "${b}" but found "${L}"`);
      return Zt(b, T, {
    ...
    executeRequestOperation(b) {
      return b.kind === "mutation" ? Qi(m(b)) : Qi(Mo(() => {
        ...
        var S = r.get(b.key);
        return b.kind === "query" && S && (S.stale || S.hasNext) ? ji(An)(Ht([T, ae((L) => L === r.get(b.key))(An(S))])) : T;
      }));
    },
    executeQuery(b, T) {
...
class ks {
  ...
  hasChanges(t = be.SinceLoaded) {
    ...
    return this.__gadget.fieldKeys.some((r) => !qn(n[r], this.__gadget.fields[r]));
  }
  ...
  changes(t, n = be.SinceLoaded) {
    ...
    if (t && typeof t == "string") {
      const a = i[t], s = this.__gadget.fields[t], u = !qn(s, a);
      ...
      for (let s = 0; s < this.__gadget.fieldKeys.length; s++) {
        ...
        qn(i[u], this.__gadget.fields[u]) || (a[u] = { current: this.__gadget.fields[u], previous: i[u] });
      }
      return a;
    }
  }
  ...
  toChangedJSON(t = be.SinceLoaded) {
    ...
    for (let i = 0; i < this.__gadget.fieldKeys.length; i++) {
      ...
      qn(n[a], this.__gadget.fields[a]) || (r[a] = this.__gadget.fields[a]);
    }
    return r;
  }
...
const en = (e, t) => {
  ...
  var r;
  if (e.error)
    throw e.error instanceof Mn && (!((r = e.error.networkError) === null || r === void 0) && r.length) && (e.error.message = e.error.networkError.map((u) => "[Network] " + u.message).join(`
`)), e.error;
  ...
  var n;
  if (e.error)
    throw e.error instanceof Mn && (!((n = e.error.networkError) === null || n === void 0) && n.length) && (e.error.message = e.error.networkError.map((i) => "[Network] " + i.message).join(`
`)), e.error;
  const r = en(e.data, t);
  return r ?? null;
}, vi = (e) => {
  var t;
  return e.code == "GGT_INVALID_RECORD" ? new Ps(e.message, e.validationErrors, (t = e.model) === null || t === void 0 ? void 0 : t.apiIdentifier, e.record) : e.code == "GGT_UNKNOWN" && e.message.includes("duplicate key value violates unique constraint") ? new Ua(e.message) : new ur(e.message, e.code);
}, It = (e, t) => {
  const n = st(e, t);
  return Ba(n);
}, Ba = (e) => {
  if (!e.success) {
    ...
    throw t ? vi(t) : new ur("Gadget API operation not successful.", "GGT_UNKNOWN");
  }
  return e;
}, qa = (e) => {
  var t, n, r, i;
  ...
  try {
    const t = window[e];
    return t.setItem(Vr, Vr), t.removeItem(Vr), !0;
  } catch {
    return !1;
  }
...
class tn extends Array {
  ...
  firstOrThrow() {
    if (!this[0])
      throw new ur("No records found.", "GGT_RECORD_NOT_FOUND");
    return this[0];
  }
  toJSON() {
...
function ki(e, t, n) {
  return n != null && n.live ? Js(Bo(e), t) : yi(e, ae((i) => !i.stale && !i.hasNext), $n(1), or).then((i) => t(i));
}
...
async function Hs(e, t, n, r = {}) {
  ...
  try {
    const d = It(u, l);
    return t.isBulk ? d.backgroundActions.map((c) => new Hn(e, t, c.id)) : new Hn(e, t, d.backgroundAction.id);
  } catch (d) {
    if ("code" in d && d.code == "GGT_DUPLICATE_BACKGROUND_ACTION_ID" && (r != null && r.id) && r.onDuplicateID == "ignore")
      return new Hn(e, t, r.id);
    throw d;
  }
}
const Ks = async (e, t, n, r) => {
  ...
  }), $n(1), or), u = st(s, ["backgroundAction"]);
...
function su(e, t) {
  ...
  if (uu(e)) {
    const r = e.toJSON();
    if (r !== e)
      return typeof r == "string" ? r : cr(r, n);
...
class Mu {
  ...
  parseValue(t) {
    if (typeof t != "string") {
      const r = J(t);
      throw new q(
        `Enum "${this.name}" cannot represent non-string value: ${r}.` + zn(this, r)
      );
    }
  ...
  parseLiteral(t, n) {
    if (t.kind !== W.ENUM) {
      const i = Nt(t);
      throw new q(
        `Enum "${this.name}" cannot represent non-enum value: ${i}.` + zn(this, i),
        {
          nodes: t
        }
      );
    ...
    if (r == null) {
      const i = Nt(t);
      throw new q(
        `Value "${i}" does not exist in "${this.name}" enum.` + zn(this, i),
        {
          nodes: t
        }
      );
...
const Ur = 2147483647, Br = -2147483648, Bu = new nn({
  name: "Int",
...
new nn({
  ...
  parseValue(e) {
    ...
    if (typeof e == "number" && Number.isInteger(e))
      return e.toString();
    throw new q(`ID cannot represent value: ${J(e)}`);
  },
  parseLiteral(e) {
...
function el(e) {
  const {
    ...
    retryWait: c = async function(V) {
      ...
      for (let j = 0; j < V; j++)
        U *= 2;
      await new Promise((j) => setTimeout(j, U + // add random timeout from 300ms to 3s
  ...
  const D = w, b = (() => {
    const _ = (() => {
      ...
      return {
        ...
        emit(j) {
          var Q;
          "id" in j && ((Q = U[j.id]) === null || Q === void 0 || Q.call(U, j));
        }
      };
    })(), V = {
  ...
  let S, L = 0, Ce, Fe = !1, Ue = 0, lt = !1;
  async function ee() {
    clearTimeout(Ce);
    const [_, V] = await (S ?? (S = new Promise((Q, ke) => (async () => {
      if (Fe) {
        if (await c(Ue), !L)
      ...
      b.emit("connecting");
      const B = new D(typeof t == "function" ? await t() : t, Xu);
      let je, Be;
      function Ze() {
        isFinite(s) && s > 0 && (clearTimeout(Be), Be = setTimeout(() => {
          B.readyState === D.OPEN && (B.send(In({ type: re.Ping })), b.emit("ping", !1, void 0));
        }, s));
      }
      T((te) => {
        S = void 0, clearTimeout(je), clearTimeout(Be), ke(te), Wn(te) && te.code === 4499 && (B.close(4499, "Terminated"), B.onerror = null, B.onclose = null);
      }), B.onerror = (te) => b.emit("error", te), B.onclose = (te) => b.emit("closed", te), B.onopen = async () => {
        try {
          b.emit("opened", B);
          const te = typeof n == "function" ? await n() : n;
          if (B.readyState !== D.OPEN)
            return;
          B.send(In(te ? {
            ...
            B.close(ve.ConnectionAcknowledgementTimeout, "Connection acknowledgement timeout");
          }, l)), Ze();
        } catch (te) {
          b.emit("error", te), B.close(ve.InternalClientError, ya(te instanceof Error ? te.message : new Error(te).message, "Internal client error"));
        }
      };
      let et = !1;
      B.onmessage = ({ data: te }) => {
        try {
          ...
          if (b.emit("message", Y), Y.type === "ping" || Y.type === "pong") {
            b.emit(Y.type, !0, Y.payload), Y.type === "pong" ? Ze() : u || (B.send(In(Y.payload ? {
              type: re.Pong,
              payload: Y.payload
            } : {
              type: re.Pong
          ...
          clearTimeout(je), et = !0, b.emit("connected", B, Y.payload), Fe = !1, Ue = 0, Q([
            B,
            new Promise((gt, qe) => T(qe))
          ]);
        } catch (Y) {
          B.onmessage = null, b.emit("error", Y), B.close(ve.BadResponse, ya(Y instanceof Error ? Y.message : new Error(Y).message, "Bad response"));
        }
      };
    })())));
    _.readyState === D.CLOSING && await V;
    let U = () => {
    };
    const j = new Promise((Q) => U = Q);
    return [
      _,
      U,
      Promise.race([
  ...
  return r || (async () => {
    ...
    subscribe(_, V) {
      ...
      return (async () => {
        for (L++; ; )
          try {
            const [B, je, Be] = await ee();
            if (j)
              return je();
            const Ze = b.onMessage(U, (et) => {
              switch (et.type) {
                case re.Next: {
                  V.next(et.payload);
                  return;
            ...
            B.send(In({
              ...
              !j && B.readyState === D.OPEN && B.send(In({
                id: U,
                type: re.Complete
              }, P)), L--, j = !0, je();
            }, await Be.finally(Ze);
...
const Qn = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : void 0;
class go {
  constructor(t) {
    var n, r, i, a, s;
    ...
    this.endpoint = t.endpoint, t.fetchImplementation ? this._fetchImplementation = t.fetchImplementation : typeof Qn < "u" && Qn.fetch ? this._fetchImplementation = Qn.fetch.bind(Qn) : this._fetchImplementation = async (...u) => {
      let l = await import("./browser-ponyfill-22219694.js").then((d) => d.b);
...
class We {
  ...
  getRecordFromData(t, n) {
    ...
    if (!this.validateRecord(t))
      throw new ur(`Invalid arguments found in variables. Did you mean to use ${n}({ ${this.apiIdentifier}: { ... } })?`, "GGT_INVALID_RECORD_DATA");
   ...
   */
  async findMany(t) {
    const n = gl(this.apiIdentifier, t), r = await this.connection.currentClient.query(n.query, n.variables).toPromise(), i = kn(r, ["internal", `list${this.capitalizedApiIdentifier}`]), a = Cn(r, i);
...
class Vl {
   ...
   **/
  handle(t, n) {
    return new Hn(this.connection, t, n);
  }
  toString() {
...
Io = Ml;
var wo = {}, pr = Ee.createContext(wo), Ul = pr.Provider;
pr.Consumer;
pr.displayName = "UrqlContext";
var No = () => {
  var e = Ee.useContext(pr);
  ...
  extensions: void 0,
  operation: void 0
}, Bl = (e, t) => e === t || !(!e || !t || e.key !== t.key), qr = (e, t) => {
  var n = {
    ...e,
    ...t,
  ...
  for (var n = 0, r = t.length; n < r; n++)
    if (e[n] !== t[n])
      return !0;
  return !1;
}, Gr = Ee.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
function ar(e, t) {
  process.env.NODE_ENV !== "production" && Gr && Gr.ReactCurrentOwner && Gr.ReactCurrentOwner.current ? Promise.resolve(t).then(e) : e(t);
}
function Gl(e) {
  var t = Ee.useRef(!0), n = No(), [r, i] = Ee.useState(ci), a = Ee.useCallback((s, u) => (ar(i, {
    ...ci,
    fetching: !0
  }), or($n(1)(ae((l) => !l.hasNext)(Ut((l) => {
    t.current && ar(i, {
      fetching: !1,
      stale: l.stale,
      data: l.data,
...
function Jl(e) {
  ...
  }, [n, i]), u = [t, i, e.requestPolicy, e.context, e.pause], [l, d] = Ee.useState(() => [a, qr(ci, s(a, r)), u]), c = l[1];
  a !== l[0] && ql(l[2], u) && d([a, c = qr(l[1], s(a, r)), u]), Ee.useEffect(() => {
...
}, tc = (e) => typeof e == "string" ? new Dn(e) : e != null && e.message && !e.code ? new Dn(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {}) : e;
...
const nc = (e) => {
  const { context: t, suspense: n, ...r } = e ?? {}, i = Zn(() => ({
...
function Xn(e, t) {
  ...
  if (e && t && typeof e == "object" && typeof t == "object") {
    ...
    if (oc && e instanceof Map && t instanceof Map) {
      ...
      for (a = e.entries(); !(r = a.next()).done; )
        if (!t.has(r.value[0]))
          return !1;
      for (a = e.entries(); !(r = a.next()).done; )
        if (!Xn(r.value[1], t.get(r.value[0])))
          return !1;
      return !0;
    }
    ...
    if (ac && e instanceof Element)
      return !1;
    for (r = n; r-- !== 0; )
      if (!((i[r] === "_owner" || i[r] === "__v" || i[r] === "__o") && e.$$typeof) && !Xn(e[i[r]], t[i[r]]))
        return !1;
    return !0;
  }
  return e !== e && t !== t;
...
const cc = /* @__PURE__ */ Ro(lc), dc = (e) => {
  ...
  const n = dc(t), r = Zn(() => Ai(e.findMany.operationName, e.findMany.defaultSelection, e.findMany.modelApiIdentifier, n), [e, n]), [i, a] = ic(rc(r, t));
  return [Zn(() => {
...
Check the top-level render call using <` + h + ">.");
    ...
    var Fr = Cr, jr = Dr;
    Jn.Fragment = r, Jn.jsx = Fr, Jn.jsxs = jr;
  }()), Jn;
}
...
`, Sc = _o(({ children: e, gadgetAppUrl: t, originalQueryParams: n, api: r, type: i, host: a, isReady: s, isRootFrameRequest: u }) => {
    ...
    r.connection.setAuthenticationMode({
      custom: {
        async processFetch(ee, z) {
          ...
          _.append("Authorization", `ShopifySessionToken ${E}`), z.headers ?? (z.headers = {}), _.forEach(function(V, U) {
            z.headers[U] = V;
          });
        },
  ...
  let D = !1, b = !1, T = [];
  const S = Aa(!1), [{ data: L, fetching: Ce, error: Fe }, Ue] = fc(vc);
  L && (console.debug({ fetchOrInstallShopData: L }, "[gadget-rsab] fetched or installed shop data"), D = L.shopifyConnection.fetchOrInstallShop.redirectToOauth, b = L.shopifyConnection.fetchOrInstallShop.isAuthenticated, T = L.shopifyConnection.fetchOrInstallShop.missingScopes ?? []), Le(() => {
  ...
  const r = !!(globalThis && globalThis.shopify), [i, a] = On(null), s = !!i, { query: u } = i ?? {}, l = (u == null ? void 0 : u.get("host")) ?? void 0, d = e ?? wt.Embedded, c = Zn(() => u, [s]), p = !(u != null && u.has("hmac")) && !(u != null && u.has("shop")) && e == wt.Embedded, m = new URL(n.connection.options.endpoint).origin;
  if (Le(() => {
    a({
  ...
  return /* @__PURE__ */ er.jsx(er.Fragment, { children: JSON.stringify(e) });
}, kc = () => /* @__PURE__ */ er.jsx(wc, { api: Ao, shopifyApiKey: "deadbeef", children: /* @__PURE__ */ er.jsx(Nc, {}) });
export {
  kc as A,
  Nc as R,
  Ac as c,
